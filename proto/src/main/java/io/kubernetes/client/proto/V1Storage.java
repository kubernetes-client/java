...
public final class V1Storage {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              spec_ = input.readMessage(io.kubernetes.client.proto.V1Storage.CSIDriverSpec.PARSER, extensionRegistry);
              if (subBuilder != null) {
      ...
      public Builder mergeSpec(io.kubernetes.client.proto.V1Storage.CSIDriverSpec value) {
        if (specBuilder_ == null) {
          if (((bitField0_ & 0x00000002) == 0x00000002) &&
            ...
            spec_ =
              io.kubernetes.client.proto.V1Storage.CSIDriverSpec.newBuilder(spec_).mergeFrom(value).buildPartial();
          } else {
            spec_ = value;
          }
          onChanged();
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<CSIDriver>
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                items_ = new java.util.ArrayList<io.kubernetes.client.proto.V1Storage.CSIDriver>();
                mutable_bitField0_ |= 0x00000002;
              }
              items_.add(
                  input.readMessage(io.kubernetes.client.proto.V1Storage.CSIDriver.PARSER, extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (io.kubernetes.client.proto.V1Storage.CSIDriverList) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<CSIDriverList>
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 50: {
              if (!((mutable_bitField0_ & 0x00000020) == 0x00000020)) {
                tokenRequests_ = new java.util.ArrayList<io.kubernetes.client.proto.V1Storage.TokenRequest>();
                mutable_bitField0_ |= 0x00000020;
              }
              tokenRequests_.add(
                  input.readMessage(io.kubernetes.client.proto.V1Storage.TokenRequest.PARSER, extensionRegistry));
              break;
            }
            case 56: {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < volumeLifecycleModes_.size(); i++) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 3, volumeLifecycleModes_.getRaw(i));
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasAttachRequired()) {
        result = result && (getAttachRequired()
            == other.getAttachRequired());
      }
      result = result && (hasPodInfoOnMount() == other.hasPodInfoOnMount());
      if (hasPodInfoOnMount()) {
        result = result && (getPodInfoOnMount()
            == other.getPodInfoOnMount());
      }
      result = result && getVolumeLifecycleModesList()
          .equals(other.getVolumeLifecycleModesList());
      result = result && (hasStorageCapacity() == other.hasStorageCapacity());
      if (hasStorageCapacity()) {
        result = result && (getStorageCapacity()
            == other.getStorageCapacity());
      }
      result = result && (hasFsGroupPolicy() == other.hasFsGroupPolicy());
      if (hasFsGroupPolicy()) {
        result = result && getFsGroupPolicy()
            .equals(other.getFsGroupPolicy());
      }
      result = result && getTokenRequestsList()
          .equals(other.getTokenRequestsList());
      result = result && (hasRequiresRepublish() == other.hasRequiresRepublish());
      if (hasRequiresRepublish()) {
        result = result && (getRequiresRepublish()
            == other.getRequiresRepublish());
      }
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (io.kubernetes.client.proto.V1Storage.CSIDriverSpec) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private com.google.protobuf.LazyStringList volumeLifecycleModes_ = com.google.protobuf.LazyStringArrayList.EMPTY;
  ...
  bitField0_ |= 0x00000010;
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          ...
          getTokenRequestsFieldBuilder() {
        if (tokenRequestsBuilder_ == null) {
          tokenRequestsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              io.kubernetes.client.proto.V1Storage.TokenRequest, io.kubernetes.client.proto.V1Storage.TokenRequest.Builder, io.kubernetes.client.proto.V1Storage.TokenRequestOrBuilder>(
                  tokenRequests_,
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<CSIDriverSpec>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              spec_ = input.readMessage(io.kubernetes.client.proto.V1Storage.CSINodeSpec.PARSER, extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(spec_);
                spec_ = subBuilder.buildPartial();
              }
      ...
      public Builder mergeSpec(io.kubernetes.client.proto.V1Storage.CSINodeSpec value) {
        if (specBuilder_ == null) {
          if (((bitField0_ & 0x00000002) == 0x00000002) &&
            ...
            spec_ =
              io.kubernetes.client.proto.V1Storage.CSINodeSpec.newBuilder(spec_).mergeFrom(value).buildPartial();
          } else {
            spec_ = value;
          }
          onChanged();
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<CSINode>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              allocatable_ = input.readMessage(io.kubernetes.client.proto.V1Storage.VolumeNodeResources.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && getTopologyKeysList()
          .equals(other.getTopologyKeysList());
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (io.kubernetes.client.proto.V1Storage.CSINodeDriver) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000002;
      ...
      private com.google.protobuf.LazyStringList topologyKeys_ = com.google.protobuf.LazyStringArrayList.EMPTY;
  ...
  ensureTopologyKeysIsMutable();
      ...
      public Builder mergeAllocatable(io.kubernetes.client.proto.V1Storage.VolumeNodeResources value) {
        if (allocatableBuilder_ == null) {
          if (((bitField0_ & 0x00000008) == 0x00000008) &&
            ...
            allocatable_ =
              io.kubernetes.client.proto.V1Storage.VolumeNodeResources.newBuilder(allocatable_).mergeFrom(value).buildPartial();
          } else {
            allocatable_ = value;
          }
          onChanged();
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<CSINodeDriver>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              items_.add(
                  input.readMessage(io.kubernetes.client.proto.V1Storage.CSINode.PARSER, extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (io.kubernetes.client.proto.V1Storage.CSINodeList) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<CSINodeList>
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                drivers_ = new java.util.ArrayList<io.kubernetes.client.proto.V1Storage.CSINodeDriver>();
                mutable_bitField0_ |= 0x00000001;
              }
              drivers_.add(
                  input.readMessage(io.kubernetes.client.proto.V1Storage.CSINodeDriver.PARSER, extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      boolean result = true;
      result = result && getDriversList()
          .equals(other.getDriversList());
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (io.kubernetes.client.proto.V1Storage.CSINodeSpec) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<CSINodeSpec>
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (io.kubernetes.client.proto.V1Storage.TokenRequest) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              inlineVolumeSpec_ = input.readMessage(io.kubernetes.client.proto.V1.PersistentVolumeSpec.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasInlineVolumeSpec()) {
        result = result && getInlineVolumeSpec()
            .equals(other.getInlineVolumeSpec());
      }
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
  ...
  bitField0_ |= 0x00000001;
      ...
      public Builder mergeInlineVolumeSpec(io.kubernetes.client.proto.V1.PersistentVolumeSpec value) {
        if (inlineVolumeSpecBuilder_ == null) {
          if (((bitField0_ & 0x00000002) == 0x00000002) &&
            ...
            inlineVolumeSpec_ =
              io.kubernetes.client.proto.V1.PersistentVolumeSpec.newBuilder(inlineVolumeSpec_).mergeFrom(value).buildPartial();
          } else {
            inlineVolumeSpec_ = value;
          }
          onChanged();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          ...
          getInlineVolumeSpecFieldBuilder() {
        if (inlineVolumeSpecBuilder_ == null) {
          inlineVolumeSpecBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              io.kubernetes.client.proto.V1.PersistentVolumeSpec, io.kubernetes.client.proto.V1.PersistentVolumeSpec.Builder, io.kubernetes.client.proto.V1.PersistentVolumeSpecOrBuilder>(
                  getInlineVolumeSpec(),
                  getParentForChildren(),
                  isClean());
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (io.kubernetes.client.proto.V1Storage.VolumeNodeResources) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    @java.lang.Deprecated public static final com.google.protobuf.Parser<VolumeNodeResources>
  ...
  static {
    ...
    internal_static_k8s_io_api_storage_v1_CSIDriverSpec_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_k8s_io_api_storage_v1_CSIDriverSpec_descriptor,
        new java.lang.String[] { "AttachRequired", "PodInfoOnMount", "VolumeLifecycleModes", "StorageCapacity", "FsGroupPolicy", "TokenRequests", "RequiresRepublish", });
    internal_static_k8s_io_api_storage_v1_CSINode_descriptor =
