...
io.kubernetes.client.proto.V1Certificates.ExtraValue defaultValue) {
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec result) {
        if (((bitField0_ & 0x00000008) != 0)) {
...
io.kubernetes.client.proto.V1Certificates.ExtraValue defaultValue) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(io.kubernetes.client.proto.V1Certificates.ExtraValue result) {
        if (((bitField0_ & 0x00000001) != 0)) {
