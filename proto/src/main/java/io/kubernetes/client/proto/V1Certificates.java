...
public final class V1Certificates {
  ...
  public static final class CertificateSigningRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return io.kubernetes.client.proto.V1Certificates
          ...
          .ensureFieldAccessorsInitialized(
              io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest.class,
              io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest other =
          (io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest) obj;
    ...
    public static Builder newBuilder(
        io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest prototype) {
    ...
    public static final class Builder
      ...
      // Construct using
      // io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest.newBuilder()
      private Builder() {
      ...
      public io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest
        ...
        return io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest
            .getDefaultInstance();
      }
      ...
      public io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest buildPartial() {
        io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest result =
            new io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest(this);
       ...
       * </pre>
       *
       * <code>optional .k8s.io.api.certificates.v1.CertificateSigningRequestStatus status = 3;
       * </code>
       */
      public boolean hasStatus() {
        return ((bitField0_ & 0x00000004) == 0x00000004);
  ...
  public static final class CertificateSigningRequestCondition
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return io.kubernetes.client.proto.V1Certificates
          ...
          .ensureFieldAccessorsInitialized(
              io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestCondition.class,
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestCondition other =
          (io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestCondition) obj;
    ...
    public static Builder newBuilder(
        io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestCondition prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
      ...
      // Construct using
      // io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestCondition.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestCondition
          getDefaultInstanceForType() {
        return io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestCondition
            .getDefaultInstance();
      }
  ...
  public static final class CertificateSigningRequestList
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return io.kubernetes.client.proto.V1Certificates
          ...
          .ensureFieldAccessorsInitialized(
              io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestList.class,
    ...
    private java.util.List<io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest>
        items_;
    /**
     *
     *
     ...
     * <code>repeated .k8s.io.api.certificates.v1.CertificateSigningRequest items = 2;</code>
     */
    public java.util.List<io.kubernetes.client.proto.V1Certificates.CertificateSigningRequest>
        getItemsList() {
      return items_;
    }
    /**
    ...
    public static final class Builder
      ...
      public io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestList
          getDefaultInstanceForType() {
        return io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestList
            .getDefaultInstance();
      }
      ...
      public io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestList
          buildPartial() {
        io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestList result =
            new io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestList(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
  ...
  public static final class CertificateSigningRequestSpec
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec other =
          (io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec) obj;
    ...
    public static final class Builder
      ...
      public io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec
          getDefaultInstanceForType() {
        return io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec
            .getDefaultInstance();
      }
      ...
      public io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec
          buildPartial() {
        io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec result =
            new io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestSpec parsedMessage =
            null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
  ...
  public interface CertificateSigningRequestStatusOrBuilder
     ...
     * </pre>
     *
     * <code>repeated .k8s.io.api.certificates.v1.CertificateSigningRequestCondition conditions = 1;
     * </code>
     */
  ...
  public static final class CertificateSigningRequestStatus
    ...
    private static final io.kubernetes.client.proto.V1Certificates.CertificateSigningRequestStatus
        DEFAULT_INSTANCE;
  ...
  public static final class ExtraValue extends com.google.protobuf.GeneratedMessageV3
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return io.kubernetes.client.proto.V1Certificates
          ...
          .ensureFieldAccessorsInitialized(
              io.kubernetes.client.proto.V1Certificates.ExtraValue.class,
              io.kubernetes.client.proto.V1Certificates.ExtraValue.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      io.kubernetes.client.proto.V1Certificates.ExtraValue other =
          (io.kubernetes.client.proto.V1Certificates.ExtraValue) obj;
    ...
    public static Builder newBuilder(
        io.kubernetes.client.proto.V1Certificates.ExtraValue prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
      ...
      public io.kubernetes.client.proto.V1Certificates.ExtraValue buildPartial() {
        io.kubernetes.client.proto.V1Certificates.ExtraValue result =
            new io.kubernetes.client.proto.V1Certificates.ExtraValue(this);
        int from_bitField0_ = bitField0_;
        if (((bitField0_ & 0x00000001) == 0x00000001)) {
          items_ = items_.getUnmodifiableView();
          bitField0_ = (bitField0_ & ~0x00000001);
      ...
      public Builder mergeFrom(io.kubernetes.client.proto.V1Certificates.ExtraValue other) {
        if (other == io.kubernetes.client.proto.V1Certificates.ExtraValue.getDefaultInstance())
          return this;
        if (!other.items_.isEmpty()) {
          if (items_.isEmpty()) {
            items_ = other.items_;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        io.kubernetes.client.proto.V1Certificates.ExtraValue parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage =
              (io.kubernetes.client.proto.V1Certificates.ExtraValue) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n*k8s.io/api/certificates/v1/generated.p"
          ...
          + "\"\033\n\nExtraValue\022\r\n\005items\030\001 \003(\tB0\n\032io.kube"
          + "rnetes.client.protoB\016V1CertificatesZ\002v1"
    };
