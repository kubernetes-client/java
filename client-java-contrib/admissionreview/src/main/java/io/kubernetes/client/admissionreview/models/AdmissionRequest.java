...
import io.kubernetes.client.admissionreview.models.UserInfo;
...
public class AdmissionRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "RequestSubResource is the name of the subresource of the original API request, if any (for example, \"status\" or \"scale\") If this is specified and differs from the value in \"subResource\", an equivalent match and conversion was performed. See documentation for the \"matchPolicy\" field in the webhook configuration type.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "SubResource is the subresource being requested, if any (for example, \"status\" or \"scale\")")
