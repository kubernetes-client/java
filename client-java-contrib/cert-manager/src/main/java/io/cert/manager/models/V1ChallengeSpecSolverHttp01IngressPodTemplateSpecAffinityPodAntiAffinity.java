...
public class V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity {
  ...
  public V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity() {
  }

  public V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity preferredDuringSchedulingIgnoredDuringExecution(List<V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionInner> preferredDuringSchedulingIgnoredDuringExecution) {
    
    this.preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution;
    return this;
  }

  public V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity addPreferredDuringSchedulingIgnoredDuringExecutionItem(V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionInner preferredDuringSchedulingIgnoredDuringExecutionItem) {
  ...
  **/
  ...
  public V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity requiredDuringSchedulingIgnoredDuringExecution(List<V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionInner> requiredDuringSchedulingIgnoredDuringExecution) {
    
    this.requiredDuringSchedulingIgnoredDuringExecution = requiredDuringSchedulingIgnoredDuringExecution;
    return this;
  }

  public V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity addRequiredDuringSchedulingIgnoredDuringExecutionItem(V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionInner requiredDuringSchedulingIgnoredDuringExecutionItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity v1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity = (V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity) o;
    return Objects.equals(this.preferredDuringSchedulingIgnoredDuringExecution, v1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution) &&
        Objects.equals(this.requiredDuringSchedulingIgnoredDuringExecution, v1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity is not found in the empty JSON string", V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.class));

       return (TypeAdapter<T>) new TypeAdapter<V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity>() {
           @Override
           public void write(JsonWriter out, V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity
  * @throws IOException if the JSON string is invalid with respect to V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity
  */
  public static V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity.class);
  }

 /**
  * Convert an instance of V1ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity to an JSON string
  *
  * @return JSON string
  */
