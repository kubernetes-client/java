...
public class V1beta1CertificateRequest implements io.kubernetes.client.common.KubernetesObject {
  ...
  private V1beta1CertificateRequestSpec spec;
  ...
  public V1beta1CertificateRequest apiVersion(String apiVersion) {
  ...
  public V1beta1CertificateRequest kind(String kind) {
  ...
  public V1beta1CertificateRequest metadata(V1ObjectMeta metadata) {
  ...
  public V1beta1CertificateRequest spec(V1beta1CertificateRequestSpec spec) {
  ...
  public V1beta1CertificateRequestSpec getSpec() {
    return spec;
  }

  public void setSpec(V1beta1CertificateRequestSpec spec) {
    this.spec = spec;
  }

  public V1beta1CertificateRequest status(V1beta1CertificateRequestStatus status) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1CertificateRequest v1beta1CertificateRequest = (V1beta1CertificateRequest) o;
    return Objects.equals(this.apiVersion, v1beta1CertificateRequest.apiVersion)
        && Objects.equals(this.kind, v1beta1CertificateRequest.kind)
        && Objects.equals(this.metadata, v1beta1CertificateRequest.metadata)
        && Objects.equals(this.spec, v1beta1CertificateRequest.spec)
        && Objects.equals(this.status, v1beta1CertificateRequest.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1CertificateRequest {\n");
