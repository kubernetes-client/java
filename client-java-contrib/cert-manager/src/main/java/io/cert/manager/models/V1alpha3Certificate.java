...
public class V1alpha3Certificate implements io.kubernetes.client.common.KubernetesObject {
  ...
  private V1alpha3CertificateSpec spec;
  ...
  public V1alpha3Certificate apiVersion(String apiVersion) {
  ...
  public V1alpha3Certificate kind(String kind) {
  ...
  public V1alpha3Certificate metadata(V1ObjectMeta metadata) {
  ...
  public V1alpha3Certificate spec(V1alpha3CertificateSpec spec) {
  ...
  public void setSpec(V1alpha3CertificateSpec spec) {
    this.spec = spec;
  }

  public V1alpha3Certificate status(V1beta1CertificateStatus status) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha3Certificate v1alpha3Certificate = (V1alpha3Certificate) o;
    return Objects.equals(this.apiVersion, v1alpha3Certificate.apiVersion)
        && Objects.equals(this.kind, v1alpha3Certificate.kind)
        && Objects.equals(this.metadata, v1alpha3Certificate.metadata)
        && Objects.equals(this.spec, v1alpha3Certificate.spec)
        && Objects.equals(this.status, v1alpha3Certificate.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha3Certificate {\n");
