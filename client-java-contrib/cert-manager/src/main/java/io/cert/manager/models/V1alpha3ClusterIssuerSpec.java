...
public class V1alpha3ClusterIssuerSpec {
  ...
  public V1alpha3ClusterIssuerSpec acme(V1alpha2IssuerSpecAcme acme) {
  ...
  public V1alpha3ClusterIssuerSpec ca(V1alpha2IssuerSpecCa ca) {
  ...
  public V1alpha3ClusterIssuerSpec selfSigned(V1alpha2IssuerSpecSelfSigned selfSigned) {
  ...
  public V1alpha3ClusterIssuerSpec vault(V1alpha2IssuerSpecVault vault) {
  ...
  public V1alpha3ClusterIssuerSpec venafi(V1alpha2IssuerSpecVenafi venafi) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha3ClusterIssuerSpec v1alpha3ClusterIssuerSpec = (V1alpha3ClusterIssuerSpec) o;
    return Objects.equals(this.acme, v1alpha3ClusterIssuerSpec.acme)
        && Objects.equals(this.ca, v1alpha3ClusterIssuerSpec.ca)
        && Objects.equals(this.selfSigned, v1alpha3ClusterIssuerSpec.selfSigned)
        && Objects.equals(this.vault, v1alpha3ClusterIssuerSpec.vault)
        && Objects.equals(this.venafi, v1alpha3ClusterIssuerSpec.venafi);
  }
