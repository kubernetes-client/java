...
public class V1beta1IssuerSpec {
  ...
  public V1beta1IssuerSpec acme(V1beta1IssuerSpecAcme acme) {
  ...
  public V1beta1IssuerSpec ca(V1alpha2IssuerSpecCa ca) {
  ...
  public V1beta1IssuerSpec selfSigned(V1alpha2IssuerSpecSelfSigned selfSigned) {
  ...
  public V1beta1IssuerSpec vault(V1alpha2IssuerSpecVault vault) {
  ...
  public V1beta1IssuerSpec venafi(V1alpha2IssuerSpecVenafi venafi) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1IssuerSpec v1beta1IssuerSpec = (V1beta1IssuerSpec) o;
    return Objects.equals(this.acme, v1beta1IssuerSpec.acme)
        && Objects.equals(this.ca, v1beta1IssuerSpec.ca)
        && Objects.equals(this.selfSigned, v1beta1IssuerSpec.selfSigned)
        && Objects.equals(this.vault, v1beta1IssuerSpec.vault)
        && Objects.equals(this.venafi, v1beta1IssuerSpec.venafi);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1IssuerSpec {\n");
