...
/**
 * The SecretAccessKey is used for authentication. If not set we fall-back to using env vars, shared
...
public class V1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef {
  ...
  public V1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef key(String key) {
  ...
  public V1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef name(String name) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef
        v1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef =
            (V1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef) o;
    return Objects.equals(this.key, v1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef.key)
        && Objects.equals(
            this.name, v1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2IssuerSpecAcmeDns01Route53SecretAccessKeySecretRef {\n");
