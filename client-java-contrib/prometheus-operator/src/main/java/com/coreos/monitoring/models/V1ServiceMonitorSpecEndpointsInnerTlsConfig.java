...
public class V1ServiceMonitorSpecEndpointsInnerTlsConfig {
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig() {
  }

  public V1ServiceMonitorSpecEndpointsInnerTlsConfig ca(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCa ca) {
  ...
  **/
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig caFile(String caFile) {
  ...
  **/
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig cert(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCert cert) {
  ...
  **/
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig certFile(String certFile) {
  ...
  **/
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig insecureSkipVerify(Boolean insecureSkipVerify) {
  ...
  **/
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig keyFile(String keyFile) {
  ...
  **/
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig keySecret(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigKeySecret keySecret) {
  ...
  **/
  ...
  public V1ServiceMonitorSpecEndpointsInnerTlsConfig serverName(String serverName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ServiceMonitorSpecEndpointsInnerTlsConfig v1ServiceMonitorSpecEndpointsInnerTlsConfig = (V1ServiceMonitorSpecEndpointsInnerTlsConfig) o;
    return Objects.equals(this.ca, v1ServiceMonitorSpecEndpointsInnerTlsConfig.ca) &&
        Objects.equals(this.caFile, v1ServiceMonitorSpecEndpointsInnerTlsConfig.caFile) &&
        Objects.equals(this.cert, v1ServiceMonitorSpecEndpointsInnerTlsConfig.cert) &&
        Objects.equals(this.certFile, v1ServiceMonitorSpecEndpointsInnerTlsConfig.certFile) &&
        Objects.equals(this.insecureSkipVerify, v1ServiceMonitorSpecEndpointsInnerTlsConfig.insecureSkipVerify) &&
        Objects.equals(this.keyFile, v1ServiceMonitorSpecEndpointsInnerTlsConfig.keyFile) &&
        Objects.equals(this.keySecret, v1ServiceMonitorSpecEndpointsInnerTlsConfig.keySecret) &&
        Objects.equals(this.serverName, v1ServiceMonitorSpecEndpointsInnerTlsConfig.serverName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ServiceMonitorSpecEndpointsInnerTlsConfig {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1ServiceMonitorSpecEndpointsInnerTlsConfig
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1ServiceMonitorSpecEndpointsInnerTlsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1ServiceMonitorSpecEndpointsInnerTlsConfig is not found in the empty JSON string", V1ServiceMonitorSpecEndpointsInnerTlsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1ServiceMonitorSpecEndpointsInnerTlsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1ServiceMonitorSpecEndpointsInnerTlsConfig` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1ServiceMonitorSpecEndpointsInnerTlsConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1ServiceMonitorSpecEndpointsInnerTlsConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1ServiceMonitorSpecEndpointsInnerTlsConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1ServiceMonitorSpecEndpointsInnerTlsConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<V1ServiceMonitorSpecEndpointsInnerTlsConfig>() {
           @Override
           public void write(JsonWriter out, V1ServiceMonitorSpecEndpointsInnerTlsConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1ServiceMonitorSpecEndpointsInnerTlsConfig read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1ServiceMonitorSpecEndpointsInnerTlsConfig given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1ServiceMonitorSpecEndpointsInnerTlsConfig
  * @throws IOException if the JSON string is invalid with respect to V1ServiceMonitorSpecEndpointsInnerTlsConfig
  */
  public static V1ServiceMonitorSpecEndpointsInnerTlsConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1ServiceMonitorSpecEndpointsInnerTlsConfig.class);
  }

 /**
  * Convert an instance of V1ServiceMonitorSpecEndpointsInnerTlsConfig to an JSON string
  *
  * @return JSON string
  */
