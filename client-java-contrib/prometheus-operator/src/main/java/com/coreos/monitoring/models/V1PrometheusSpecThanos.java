...
public class V1PrometheusSpecThanos {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "SHA of Thanos container image to be deployed. Defaults to the value of `version`. Similar to a tag, but the SHA explicitly deploys an immutable container image. Version and Tag are ignored if SHA is set.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Tag of Thanos sidecar container image to be deployed. Defaults to the value of `version`. Version is ignored if Tag is set.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseImage, grpcServerTlsConfig, image, listenLocal, objectStorageConfig, resources, sha, tag, tracingConfig, version);
  }
