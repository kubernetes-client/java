...
import com.coreos.monitoring.models.V1PrometheusSpecTlsConfig;
...
public class V1PrometheusSpecRemoteRead {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteRead putRequiredMatchersItem(String key, String requiredMatchersItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(basicAuth, bearerToken, bearerTokenFile, proxyUrl, readRecent, remoteTimeout, requiredMatchers, tlsConfig, url);
  }
