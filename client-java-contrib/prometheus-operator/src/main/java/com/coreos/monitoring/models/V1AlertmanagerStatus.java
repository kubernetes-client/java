...
public class V1AlertmanagerStatus {
  ...
  **/
  ...
  public V1AlertmanagerStatus conditions(List<V1AlertmanagerStatusConditionsInner> conditions) {
    
    this.conditions = conditions;
    return this;
  }

  public V1AlertmanagerStatus addConditionsItem(V1AlertmanagerStatusConditionsInner conditionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availableReplicas, v1AlertmanagerStatus.availableReplicas) &&
        Objects.equals(this.conditions, v1AlertmanagerStatus.conditions) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1AlertmanagerStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1AlertmanagerStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1AlertmanagerStatus is not found in the empty JSON string", V1AlertmanagerStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1AlertmanagerStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1AlertmanagerStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1AlertmanagerStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1AlertmanagerStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1AlertmanagerStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1AlertmanagerStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1AlertmanagerStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V1AlertmanagerStatus>() {
           @Override
           public void write(JsonWriter out, V1AlertmanagerStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1AlertmanagerStatus read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1AlertmanagerStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1AlertmanagerStatus
  * @throws IOException if the JSON string is invalid with respect to V1AlertmanagerStatus
  */
  public static V1AlertmanagerStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1AlertmanagerStatus.class);
  }

 /**
  * Convert an instance of V1AlertmanagerStatus to an JSON string
  *
  * @return JSON string
  */
