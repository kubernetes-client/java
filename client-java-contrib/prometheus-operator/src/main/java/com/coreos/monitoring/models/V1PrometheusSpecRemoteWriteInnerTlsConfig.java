...
public class V1PrometheusSpecRemoteWriteInnerTlsConfig {
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig() {
  }

  public V1PrometheusSpecRemoteWriteInnerTlsConfig ca(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCa ca) {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig caFile(String caFile) {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig cert(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCert cert) {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig certFile(String certFile) {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig insecureSkipVerify(Boolean insecureSkipVerify) {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig keyFile(String keyFile) {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig keySecret(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigKeySecret keySecret) {
  ...
  **/
  ...
  public V1PrometheusSpecRemoteWriteInnerTlsConfig serverName(String serverName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1PrometheusSpecRemoteWriteInnerTlsConfig v1PrometheusSpecRemoteWriteInnerTlsConfig = (V1PrometheusSpecRemoteWriteInnerTlsConfig) o;
    return Objects.equals(this.ca, v1PrometheusSpecRemoteWriteInnerTlsConfig.ca) &&
        Objects.equals(this.caFile, v1PrometheusSpecRemoteWriteInnerTlsConfig.caFile) &&
        Objects.equals(this.cert, v1PrometheusSpecRemoteWriteInnerTlsConfig.cert) &&
        Objects.equals(this.certFile, v1PrometheusSpecRemoteWriteInnerTlsConfig.certFile) &&
        Objects.equals(this.insecureSkipVerify, v1PrometheusSpecRemoteWriteInnerTlsConfig.insecureSkipVerify) &&
        Objects.equals(this.keyFile, v1PrometheusSpecRemoteWriteInnerTlsConfig.keyFile) &&
        Objects.equals(this.keySecret, v1PrometheusSpecRemoteWriteInnerTlsConfig.keySecret) &&
        Objects.equals(this.serverName, v1PrometheusSpecRemoteWriteInnerTlsConfig.serverName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1PrometheusSpecRemoteWriteInnerTlsConfig {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1PrometheusSpecRemoteWriteInnerTlsConfig
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1PrometheusSpecRemoteWriteInnerTlsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1PrometheusSpecRemoteWriteInnerTlsConfig is not found in the empty JSON string", V1PrometheusSpecRemoteWriteInnerTlsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1PrometheusSpecRemoteWriteInnerTlsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1PrometheusSpecRemoteWriteInnerTlsConfig` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1PrometheusSpecRemoteWriteInnerTlsConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1PrometheusSpecRemoteWriteInnerTlsConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1PrometheusSpecRemoteWriteInnerTlsConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1PrometheusSpecRemoteWriteInnerTlsConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<V1PrometheusSpecRemoteWriteInnerTlsConfig>() {
           @Override
           public void write(JsonWriter out, V1PrometheusSpecRemoteWriteInnerTlsConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1PrometheusSpecRemoteWriteInnerTlsConfig read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1PrometheusSpecRemoteWriteInnerTlsConfig given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1PrometheusSpecRemoteWriteInnerTlsConfig
  * @throws IOException if the JSON string is invalid with respect to V1PrometheusSpecRemoteWriteInnerTlsConfig
  */
  public static V1PrometheusSpecRemoteWriteInnerTlsConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1PrometheusSpecRemoteWriteInnerTlsConfig.class);
  }

 /**
  * Convert an instance of V1PrometheusSpecRemoteWriteInnerTlsConfig to an JSON string
  *
  * @return JSON string
  */
