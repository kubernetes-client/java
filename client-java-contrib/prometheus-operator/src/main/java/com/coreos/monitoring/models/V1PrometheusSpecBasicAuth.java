...
public class V1PrometheusSpecBasicAuth {
  ...
  public V1PrometheusSpecBasicAuth password(V1ServiceMonitorSpecBasicAuthPassword password) {
  ...
  public V1PrometheusSpecBasicAuth username(V1ServiceMonitorSpecBasicAuthUsername username) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PrometheusSpecBasicAuth v1PrometheusSpecBasicAuth = (V1PrometheusSpecBasicAuth) o;
    return Objects.equals(this.password, v1PrometheusSpecBasicAuth.password)
        && Objects.equals(this.username, v1PrometheusSpecBasicAuth.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1PrometheusSpecBasicAuth {\n");
