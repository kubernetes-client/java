...
public class V1ThanosRulerSpecProjectedConfigMap {
  ...
  public V1ThanosRulerSpecProjectedConfigMap items(List<V1ThanosRulerSpecConfigMapItems> items) {

    this.items = items;
    return this;
  }

  public V1ThanosRulerSpecProjectedConfigMap addItemsItem(
      V1ThanosRulerSpecConfigMapItems itemsItem) {
    if (this.items == null) {
  ...
  public V1ThanosRulerSpecProjectedConfigMap name(String name) {
  ...
  public V1ThanosRulerSpecProjectedConfigMap optional(Boolean optional) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ThanosRulerSpecProjectedConfigMap v1ThanosRulerSpecProjectedConfigMap =
        (V1ThanosRulerSpecProjectedConfigMap) o;
    return Objects.equals(this.items, v1ThanosRulerSpecProjectedConfigMap.items)
        && Objects.equals(this.name, v1ThanosRulerSpecProjectedConfigMap.name)
        && Objects.equals(this.optional, v1ThanosRulerSpecProjectedConfigMap.optional);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ThanosRulerSpecProjectedConfigMap {\n");
