...
public class V1PrometheusSpecApiserverConfigTlsConfig {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig() {
  }

  public V1PrometheusSpecApiserverConfigTlsConfig ca(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCa ca) {
  ...
  **/
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig cert(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCert cert) {
  ...
  **/
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig keySecret(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigKeySecret keySecret) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1PrometheusSpecApiserverConfigTlsConfig v1PrometheusSpecApiserverConfigTlsConfig = (V1PrometheusSpecApiserverConfigTlsConfig) o;
    return Objects.equals(this.ca, v1PrometheusSpecApiserverConfigTlsConfig.ca) &&
        ...
        Objects.equals(this.insecureSkipVerify, v1PrometheusSpecApiserverConfigTlsConfig.insecureSkipVerify) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1PrometheusSpecApiserverConfigTlsConfig
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1PrometheusSpecApiserverConfigTlsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1PrometheusSpecApiserverConfigTlsConfig is not found in the empty JSON string", V1PrometheusSpecApiserverConfigTlsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1PrometheusSpecApiserverConfigTlsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1PrometheusSpecApiserverConfigTlsConfig` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1PrometheusSpecApiserverConfigTlsConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1PrometheusSpecApiserverConfigTlsConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1PrometheusSpecApiserverConfigTlsConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1PrometheusSpecApiserverConfigTlsConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<V1PrometheusSpecApiserverConfigTlsConfig>() {
           @Override
           public void write(JsonWriter out, V1PrometheusSpecApiserverConfigTlsConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1PrometheusSpecApiserverConfigTlsConfig read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1PrometheusSpecApiserverConfigTlsConfig given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1PrometheusSpecApiserverConfigTlsConfig
  * @throws IOException if the JSON string is invalid with respect to V1PrometheusSpecApiserverConfigTlsConfig
  */
  public static V1PrometheusSpecApiserverConfigTlsConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1PrometheusSpecApiserverConfigTlsConfig.class);
  }

 /**
  * Convert an instance of V1PrometheusSpecApiserverConfigTlsConfig to an JSON string
  *
  * @return JSON string
  */
