...
public class V1PrometheusSpecApiserverConfigTlsConfig {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig ca(V1ServiceMonitorSpecTlsConfigCa ca) {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig caFile(String caFile) {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig cert(V1ServiceMonitorSpecTlsConfigCert cert) {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig certFile(String certFile) {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig insecureSkipVerify(Boolean insecureSkipVerify) {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig keyFile(String keyFile) {
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig keySecret(
  ...
  public V1PrometheusSpecApiserverConfigTlsConfig serverName(String serverName) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PrometheusSpecApiserverConfigTlsConfig v1PrometheusSpecApiserverConfigTlsConfig =
        (V1PrometheusSpecApiserverConfigTlsConfig) o;
    return Objects.equals(this.ca, v1PrometheusSpecApiserverConfigTlsConfig.ca)
        && Objects.equals(this.caFile, v1PrometheusSpecApiserverConfigTlsConfig.caFile)
        && Objects.equals(this.cert, v1PrometheusSpecApiserverConfigTlsConfig.cert)
        && Objects.equals(this.certFile, v1PrometheusSpecApiserverConfigTlsConfig.certFile)
        && Objects.equals(
            this.insecureSkipVerify, v1PrometheusSpecApiserverConfigTlsConfig.insecureSkipVerify)
        && Objects.equals(this.keyFile, v1PrometheusSpecApiserverConfigTlsConfig.keyFile)
        && Objects.equals(this.keySecret, v1PrometheusSpecApiserverConfigTlsConfig.keySecret)
        && Objects.equals(this.serverName, v1PrometheusSpecApiserverConfigTlsConfig.serverName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1PrometheusSpecApiserverConfigTlsConfig {\n");
