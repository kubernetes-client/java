...
public class V1PrometheusSpecTlsConfig1 {
  ...
  public V1PrometheusSpecTlsConfig1 ca(V1ServiceMonitorSpecTlsConfigCa ca) {
  ...
  public V1PrometheusSpecTlsConfig1 caFile(String caFile) {
  ...
  public V1PrometheusSpecTlsConfig1 cert(V1ServiceMonitorSpecTlsConfigCert cert) {
  ...
  public V1PrometheusSpecTlsConfig1 certFile(String certFile) {
  ...
  public V1PrometheusSpecTlsConfig1 insecureSkipVerify(Boolean insecureSkipVerify) {
  ...
  public V1PrometheusSpecTlsConfig1 keyFile(String keyFile) {
  ...
  public V1PrometheusSpecTlsConfig1 keySecret(V1ServiceMonitorSpecTlsConfigKeySecret keySecret) {
  ...
  public V1PrometheusSpecTlsConfig1 serverName(String serverName) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PrometheusSpecTlsConfig1 v1PrometheusSpecTlsConfig1 = (V1PrometheusSpecTlsConfig1) o;
    return Objects.equals(this.ca, v1PrometheusSpecTlsConfig1.ca)
        && Objects.equals(this.caFile, v1PrometheusSpecTlsConfig1.caFile)
        && Objects.equals(this.cert, v1PrometheusSpecTlsConfig1.cert)
        && Objects.equals(this.certFile, v1PrometheusSpecTlsConfig1.certFile)
        && Objects.equals(this.insecureSkipVerify, v1PrometheusSpecTlsConfig1.insecureSkipVerify)
        && Objects.equals(this.keyFile, v1PrometheusSpecTlsConfig1.keyFile)
        && Objects.equals(this.keySecret, v1PrometheusSpecTlsConfig1.keySecret)
        && Objects.equals(this.serverName, v1PrometheusSpecTlsConfig1.serverName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1PrometheusSpecTlsConfig1 {\n");
