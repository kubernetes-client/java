...
/**
 * A selector to select which PrometheusRules to mount for loading alerting rules from. Until
 * (excluding) Prometheus Operator v0.24.0 Prometheus Operator will migrate any legacy rule
 * ConfigMaps to PrometheusRule custom resources selected by RuleSelector. Make sure it does not
 * match any config maps that you do not want to be migrated.
 */
@ApiModel(
    description =
...
public class V1PrometheusSpecRuleSelector {
  ...
  public V1PrometheusSpecRuleSelector matchExpressions(
  ...
  public V1PrometheusSpecRuleSelector addMatchExpressionsItem(
  ...
  public V1PrometheusSpecRuleSelector matchLabels(Map<String, String> matchLabels) {

    this.matchLabels = matchLabels;
    return this;
  }

  public V1PrometheusSpecRuleSelector putMatchLabelsItem(String key, String matchLabelsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PrometheusSpecRuleSelector v1PrometheusSpecRuleSelector = (V1PrometheusSpecRuleSelector) o;
    return Objects.equals(this.matchExpressions, v1PrometheusSpecRuleSelector.matchExpressions)
        && Objects.equals(this.matchLabels, v1PrometheusSpecRuleSelector.matchLabels);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1PrometheusSpecRuleSelector {\n");
