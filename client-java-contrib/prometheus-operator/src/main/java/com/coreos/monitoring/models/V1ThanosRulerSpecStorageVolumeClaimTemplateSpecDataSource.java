 ...
 */
@ApiModel(description = "This field requires the VolumeSnapshotDataSource alpha feature gate to be enabled and currently VolumeSnapshot is the only supported data source. If the provisioner can support VolumeSnapshot data source, it will create a new volume and data will be restored to the volume at the same time. If the provisioner does not support VolumeSnapshot data source, volume will not be created and the failure will be reported as an event. In the future, we plan to support more data source types and the behavior of the provisioner may change.")
...
public class V1ThanosRulerSpecStorageVolumeClaimTemplateSpecDataSource {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ThanosRulerSpecStorageVolumeClaimTemplateSpecDataSource v1ThanosRulerSpecStorageVolumeClaimTemplateSpecDataSource = (V1ThanosRulerSpecStorageVolumeClaimTemplateSpecDataSource) o;
    return Objects.equals(this.apiGroup, v1ThanosRulerSpecStorageVolumeClaimTemplateSpecDataSource.apiGroup) &&
        Objects.equals(this.kind, v1ThanosRulerSpecStorageVolumeClaimTemplateSpecDataSource.kind) &&
        Objects.equals(this.name, v1ThanosRulerSpecStorageVolumeClaimTemplateSpecDataSource.name);
  }
