...
public class V1ThanosRulerSpecGrpcServerTlsConfig {
  ...
  public V1ThanosRulerSpecGrpcServerTlsConfig() {
  }

  public V1ThanosRulerSpecGrpcServerTlsConfig ca(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCa ca) {
  ...
  **/
  ...
  public V1ThanosRulerSpecGrpcServerTlsConfig cert(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigCert cert) {
  ...
  **/
  ...
  public V1ThanosRulerSpecGrpcServerTlsConfig keySecret(V1AlertmanagerSpecAlertmanagerConfigurationGlobalHttpConfigTlsConfigKeySecret keySecret) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ThanosRulerSpecGrpcServerTlsConfig v1ThanosRulerSpecGrpcServerTlsConfig = (V1ThanosRulerSpecGrpcServerTlsConfig) o;
    return Objects.equals(this.ca, v1ThanosRulerSpecGrpcServerTlsConfig.ca) &&
        ...
        Objects.equals(this.insecureSkipVerify, v1ThanosRulerSpecGrpcServerTlsConfig.insecureSkipVerify) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1ThanosRulerSpecGrpcServerTlsConfig
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1ThanosRulerSpecGrpcServerTlsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1ThanosRulerSpecGrpcServerTlsConfig is not found in the empty JSON string", V1ThanosRulerSpecGrpcServerTlsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1ThanosRulerSpecGrpcServerTlsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1ThanosRulerSpecGrpcServerTlsConfig` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1ThanosRulerSpecGrpcServerTlsConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1ThanosRulerSpecGrpcServerTlsConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1ThanosRulerSpecGrpcServerTlsConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1ThanosRulerSpecGrpcServerTlsConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<V1ThanosRulerSpecGrpcServerTlsConfig>() {
           @Override
           public void write(JsonWriter out, V1ThanosRulerSpecGrpcServerTlsConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1ThanosRulerSpecGrpcServerTlsConfig read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1ThanosRulerSpecGrpcServerTlsConfig given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1ThanosRulerSpecGrpcServerTlsConfig
  * @throws IOException if the JSON string is invalid with respect to V1ThanosRulerSpecGrpcServerTlsConfig
  */
  public static V1ThanosRulerSpecGrpcServerTlsConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1ThanosRulerSpecGrpcServerTlsConfig.class);
  }

 /**
  * Convert an instance of V1ThanosRulerSpecGrpcServerTlsConfig to an JSON string
  *
  * @return JSON string
  */
