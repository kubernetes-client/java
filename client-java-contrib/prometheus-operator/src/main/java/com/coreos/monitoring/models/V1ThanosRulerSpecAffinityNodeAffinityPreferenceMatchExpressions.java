...
public class V1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions {
  ...
  **/
  ...
  public V1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions values(List<String> values) {
    
    this.values = values;
    return this;
  }

  public V1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions addValuesItem(String valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions v1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions = (V1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions) o;
    return Objects.equals(this.key, v1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions.key) &&
        Objects.equals(this.operator, v1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions.operator) &&
        Objects.equals(this.values, v1ThanosRulerSpecAffinityNodeAffinityPreferenceMatchExpressions.values);
  }
