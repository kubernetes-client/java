...
/**
 * Namespaces to be selected for Rules discovery. If unspecified, only the same namespace as the
 * ThanosRuler object is in is used.
 */
@ApiModel(
    description =
...
public class V1ThanosRulerSpecRuleNamespaceSelector {
  ...
  public V1ThanosRulerSpecRuleNamespaceSelector matchExpressions(
  ...
  public V1ThanosRulerSpecRuleNamespaceSelector addMatchExpressionsItem(
  ...
  public V1ThanosRulerSpecRuleNamespaceSelector matchLabels(Map<String, String> matchLabels) {

    this.matchLabels = matchLabels;
    return this;
  }

  public V1ThanosRulerSpecRuleNamespaceSelector putMatchLabelsItem(
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ThanosRulerSpecRuleNamespaceSelector v1ThanosRulerSpecRuleNamespaceSelector =
        (V1ThanosRulerSpecRuleNamespaceSelector) o;
    return Objects.equals(
            this.matchExpressions, v1ThanosRulerSpecRuleNamespaceSelector.matchExpressions)
        && Objects.equals(this.matchLabels, v1ThanosRulerSpecRuleNamespaceSelector.matchLabels);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ThanosRulerSpecRuleNamespaceSelector {\n");
