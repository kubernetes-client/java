...
public class LegacyJSON {
     ...
     * @return JSON
     */
    public LegacyJSON setGson(Gson gson) {
        this.gson = gson;
        return this;
    }

    public LegacyJSON setLenientOnJson(boolean lenientOnJson) {
    ...
    public LegacyJSON setOffsetDateTimeFormat(DateTimeFormatter dateFormat) {
        offsetDateTimeTypeAdapter.setFormat(dateFormat);
        return this;
    }

    public LegacyJSON setLocalDateFormat(DateTimeFormatter dateFormat) {
    ...
    public LegacyJSON setDateFormat(DateFormat dateFormat) {
        dateTypeAdapter.setFormat(dateFormat);
        return this;
    }

    public LegacyJSON setSqlDateFormat(DateFormat dateFormat) {
