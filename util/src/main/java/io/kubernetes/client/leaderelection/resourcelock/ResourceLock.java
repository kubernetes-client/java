...
public class ResourceLock implements Lock {
    ...
    public ResourceLock(String name, String namespace, ApiClient client, String apiVersion, String kind, String type,
    ...
    public LeaderElectionRecord get() throws ApiException {
        ...
        try {
            ApiResponse<JsonObject> response = client.execute(call, new TypeToken<JsonObject>(){}.getType());
