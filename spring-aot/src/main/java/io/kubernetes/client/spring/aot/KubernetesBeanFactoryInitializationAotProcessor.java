...
/**
 * GraalVM native images need to know about when you might reflectively work with types at runtime. The Kubernetes Java
 * client works with several types reflectively at runtime. This code uses the third-party Reflections library to
 * reflect upon all the code in your Spring Boot application or in the official Kubernetes Java client that has
 * {@link ApiModel}, {@link JsonAdapter}, and registers them. It also registers a few other specific handful of
 * classes that should be accounted for, in specific cases.
 *
 * @author Josh Long
 */
