...
public class Example {
  public static void main(String[] args) {
    ...
    ApiextensionsV1beta1Api apiInstance = new ApiextensionsV1beta1Api(defaultClient);
...
> V1beta1CustomResourceDefinitionList listCustomResourceDefinition(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1beta1CustomResourceDefinitionList result = apiInstance.listCustomResourceDefinition(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
      System.out.println(result);
    } catch (ApiException e) {
