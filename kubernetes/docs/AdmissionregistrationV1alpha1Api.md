...
> V1Status deleteCollectionExternalAdmissionHookConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch)
...
> V1Status deleteCollectionInitializerConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch)
...
> V1alpha1ExternalAdmissionHookConfigurationList listExternalAdmissionHookConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch)
...
> V1alpha1InitializerConfigurationList listInitializerConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch)
