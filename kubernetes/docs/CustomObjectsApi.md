...
> Object createNamespacedCustomObject(group, version, namespace, plural, body).pretty(pretty).dryRun(dryRun).fieldManager(fieldManager).execute();
...
> Object replaceNamespacedCustomObject(group, version, namespace, plural, name, body).dryRun(dryRun).fieldManager(fieldManager).execute();
...
> Object replaceNamespacedCustomObjectScale(group, version, namespace, plural, name, body).dryRun(dryRun).fieldManager(fieldManager).execute();
...
> Object replaceNamespacedCustomObjectStatus(group, version, namespace, plural, name, body).dryRun(dryRun).fieldManager(fieldManager).execute();
