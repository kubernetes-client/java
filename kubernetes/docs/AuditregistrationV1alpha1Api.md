...
# **createAuditSink**
> V1alpha1AuditSink createAuditSink(body, includeUninitialized, pretty, dryRun)
...
try {
    V1alpha1AuditSink result = apiInstance.createAuditSink(body, includeUninitialized, pretty, dryRun);
...
> V1Status deleteCollectionAuditSink(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch)
...
try {
    V1Status result = apiInstance.deleteCollectionAuditSink(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    System.out.println(result);
} catch (ApiException e) {
...
# **listAuditSink**
> V1alpha1AuditSinkList listAuditSink(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch)
...
Boolean watch = true; // Boolean | Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
try {
    V1alpha1AuditSinkList result = apiInstance.listAuditSink(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    System.out.println(result);
} catch (ApiException e) {
...
# **patchAuditSink**
> V1alpha1AuditSink patchAuditSink(name, body, pretty, dryRun)
...
String dryRun = "dryRun_example"; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
try {
    V1alpha1AuditSink result = apiInstance.patchAuditSink(name, body, pretty, dryRun);
    System.out.println(result);
} catch (ApiException e) {
...
# **replaceAuditSink**
> V1alpha1AuditSink replaceAuditSink(name, body, pretty, dryRun)
...
String dryRun = "dryRun_example"; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
try {
    V1alpha1AuditSink result = apiInstance.replaceAuditSink(name, body, pretty, dryRun);
    System.out.println(result);
} catch (ApiException e) {
