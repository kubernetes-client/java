...
|------------ | ------------- | ------------- | -------------|
|**forNodes** | [**List&lt;V1ForNode&gt;**](V1ForNode.md) | forNodes indicates the node(s) this endpoint should be consumed by when using topology aware routing. May contain a maximum of 8 entries. |  [optional] |
