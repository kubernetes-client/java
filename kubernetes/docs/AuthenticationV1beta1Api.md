...
> V1beta1SelfSubjectReview createSelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1beta1SelfSubjectReview result = apiInstance.createSelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty);
