...
# **createTokenReview**
> V1beta1TokenReview createTokenReview(body, dryRun, fieldManager, pretty)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1beta1TokenReview result = apiInstance.createTokenReview(body, dryRun, fieldManager, pretty);
