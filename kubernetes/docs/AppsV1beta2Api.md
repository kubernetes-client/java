...
> V1beta2ControllerRevision createNamespacedControllerRevision(namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2DaemonSet createNamespacedDaemonSet(namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2Deployment createNamespacedDeployment(namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2ReplicaSet createNamespacedReplicaSet(namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2StatefulSet createNamespacedStatefulSet(namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2ControllerRevision patchNamespacedControllerRevision(name, namespace, body, pretty, dryRun, fieldManager, force)
...
> V1beta2DaemonSet patchNamespacedDaemonSet(name, namespace, body, pretty, dryRun, fieldManager, force)
...
> V1beta2DaemonSet patchNamespacedDaemonSetStatus(name, namespace, body, pretty, dryRun, fieldManager, force)
...
> V1beta2Scale patchNamespacedDeploymentScale(name, namespace, body, pretty, dryRun, fieldManager, force)
...
> V1beta2Scale patchNamespacedReplicaSetScale(name, namespace, body, pretty, dryRun, fieldManager, force)
...
> V1beta2ControllerRevision replaceNamespacedControllerRevision(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2DaemonSet replaceNamespacedDaemonSet(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2DaemonSet replaceNamespacedDaemonSetStatus(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2Deployment replaceNamespacedDeployment(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2Scale replaceNamespacedDeploymentScale(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2Deployment replaceNamespacedDeploymentStatus(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2ReplicaSet replaceNamespacedReplicaSet(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2Scale replaceNamespacedReplicaSetScale(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2ReplicaSet replaceNamespacedReplicaSetStatus(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2StatefulSet replaceNamespacedStatefulSet(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2Scale replaceNamespacedStatefulSetScale(name, namespace, body, pretty, dryRun, fieldManager)
...
> V1beta2StatefulSet replaceNamespacedStatefulSetStatus(name, namespace, body, pretty, dryRun, fieldManager)
