...
# **createPriorityClass**
> V1beta1PriorityClass createPriorityClass(body, pretty)
...
try {
    V1beta1PriorityClass result = apiInstance.createPriorityClass(body, pretty);
...
# **listPriorityClass**
> V1beta1PriorityClassList listPriorityClass(pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch)
...
Boolean watch = true; // Boolean | Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
try {
    V1beta1PriorityClassList result = apiInstance.listPriorityClass(pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    System.out.println(result);
} catch (ApiException e) {
...
# **patchPriorityClass**
> V1beta1PriorityClass patchPriorityClass(name, body, pretty)
...
String pretty = "pretty_example"; // String | If 'true', then the output is pretty printed.
try {
    V1beta1PriorityClass result = apiInstance.patchPriorityClass(name, body, pretty);
    System.out.println(result);
} catch (ApiException e) {
...
> V1beta1PriorityClass replacePriorityClass(name, body, pretty)
...
String pretty = "pretty_example"; // String | If 'true', then the output is pretty printed.
try {
    V1beta1PriorityClass result = apiInstance.replacePriorityClass(name, body, pretty);
    System.out.println(result);
} catch (ApiException e) {
