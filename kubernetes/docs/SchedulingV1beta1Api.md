...
# **createPriorityClass**
> V1beta1PriorityClass createPriorityClass(body, pretty, dryRun, fieldManager)
...
public class Example {
  public static void main(String[] args) {
    ...
    SchedulingV1beta1Api apiInstance = new SchedulingV1beta1Api(defaultClient);
    ...
    try {
      V1beta1PriorityClass result = apiInstance.createPriorityClass(body, pretty, dryRun, fieldManager);
...
# **listPriorityClass**
> V1beta1PriorityClassList listPriorityClass(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1beta1PriorityClassList result = apiInstance.listPriorityClass(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
      System.out.println(result);
    } catch (ApiException e) {
...
# **patchPriorityClass**
> V1beta1PriorityClass patchPriorityClass(name, body, pretty, dryRun, fieldManager, force)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1beta1PriorityClass result = apiInstance.patchPriorityClass(name, body, pretty, dryRun, fieldManager, force);
      System.out.println(result);
    } catch (ApiException e) {
...
> V1beta1PriorityClass replacePriorityClass(name, body, pretty, dryRun, fieldManager)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fieldManager = "fieldManager_example"; // String | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    try {
      V1beta1PriorityClass result = apiInstance.replacePriorityClass(name, body, pretty, dryRun, fieldManager);
      System.out.println(result);
    } catch (ApiException e) {
