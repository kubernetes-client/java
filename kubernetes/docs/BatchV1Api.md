...
# **deleteNamespacedJob**
> V1Status deleteNamespacedJob(name, namespace, body, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy)
...
try {
    V1Status result = apiInstance.deleteNamespacedJob(name, namespace, body, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy);
    System.out.println(result);
} catch (ApiException e) {
