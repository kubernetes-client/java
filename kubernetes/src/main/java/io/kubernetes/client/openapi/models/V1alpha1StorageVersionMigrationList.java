...
public class V1alpha1StorageVersionMigrationList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  public V1alpha1StorageVersionMigrationList apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1alpha1StorageVersionMigrationList items(@jakarta.annotation.Nonnull List<V1alpha1StorageVersionMigration> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@jakarta.annotation.Nonnull List<V1alpha1StorageVersionMigration> items) {
    this.items = items;
  }


  public V1alpha1StorageVersionMigrationList kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1alpha1StorageVersionMigrationList metadata(@jakarta.annotation.Nullable V1ListMeta metadata) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1StorageVersionMigrationList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1alpha1StorageVersionMigrationList is not found in the empty JSON string", V1alpha1StorageVersionMigrationList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1StorageVersionMigrationList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha1StorageVersionMigrationList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
