...
public class V2CrossVersionObjectReference {
  ...
  public V2CrossVersionObjectReference apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V2CrossVersionObjectReference kind(@jakarta.annotation.Nonnull String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V2CrossVersionObjectReference name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("apiVersion", "kind", "name"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V2CrossVersionObjectReference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V2CrossVersionObjectReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V2CrossVersionObjectReference is not found in the empty JSON string", V2CrossVersionObjectReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V2CrossVersionObjectReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V2CrossVersionObjectReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
