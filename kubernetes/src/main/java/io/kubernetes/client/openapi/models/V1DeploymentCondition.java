...
public class V1DeploymentCondition {
  ...
  public V1DeploymentCondition lastUpdateTime(@jakarta.annotation.Nullable OffsetDateTime lastUpdateTime) {
  ...
  public V1DeploymentCondition message(@jakarta.annotation.Nullable String message) {
  ...
  public V1DeploymentCondition reason(@jakarta.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public V1DeploymentCondition status(@jakarta.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public V1DeploymentCondition type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lastTransitionTime", "lastUpdateTime", "message", "reason", "status", "type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1DeploymentCondition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1DeploymentCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1DeploymentCondition is not found in the empty JSON string", V1DeploymentCondition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1DeploymentCondition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1DeploymentCondition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
