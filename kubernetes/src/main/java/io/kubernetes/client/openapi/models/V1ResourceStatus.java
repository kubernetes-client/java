...
public class V1ResourceStatus {
  ...
  public V1ResourceStatus name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1ResourceStatus resources(@jakarta.annotation.Nullable List<V1ResourceHealth> resources) {
  ...
  public void setResources(@jakarta.annotation.Nullable List<V1ResourceHealth> resources) {
    this.resources = resources;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "resources"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ResourceStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ResourceStatus is not found in the empty JSON string", V1ResourceStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ResourceStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ResourceStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
