...
public class V1ValidatingWebhookConfiguration implements io.kubernetes.client.common.KubernetesObject {
  ...
  @jakarta.annotation.Nullable
  private List<V1ValidatingWebhook> webhooks = new ArrayList<>();

  public V1ValidatingWebhookConfiguration() {
  }

  public V1ValidatingWebhookConfiguration apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1ValidatingWebhookConfiguration kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1ValidatingWebhookConfiguration metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1ValidatingWebhookConfiguration webhooks(@jakarta.annotation.Nullable List<V1ValidatingWebhook> webhooks) {
  ...
  public void setWebhooks(@jakarta.annotation.Nullable List<V1ValidatingWebhook> webhooks) {
    this.webhooks = webhooks;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("apiVersion", "kind", "metadata", "webhooks"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ValidatingWebhookConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ValidatingWebhookConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ValidatingWebhookConfiguration is not found in the empty JSON string", V1ValidatingWebhookConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ValidatingWebhookConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ValidatingWebhookConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("webhooks") != null && !jsonObj.get("webhooks").isJsonNull()) {
        ...
        if (jsonArraywebhooks != null) {
          ...
          for (int i = 0; i < jsonArraywebhooks.size(); i++) {
            V1ValidatingWebhook.validateJsonElement(jsonArraywebhooks.get(i));
          };
        }
      }
  }
