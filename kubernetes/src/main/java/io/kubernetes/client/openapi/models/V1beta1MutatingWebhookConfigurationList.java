...
public class V1beta1MutatingWebhookConfigurationList
  ...
  private List<V1beta1MutatingWebhookConfiguration> items =
      new ArrayList<V1beta1MutatingWebhookConfiguration>();
  ...
  public V1beta1MutatingWebhookConfigurationList items(
      List<V1beta1MutatingWebhookConfiguration> items) {

    this.items = items;
    return this;
  }

  public V1beta1MutatingWebhookConfigurationList addItemsItem(
      V1beta1MutatingWebhookConfiguration itemsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1MutatingWebhookConfigurationList v1beta1MutatingWebhookConfigurationList =
        (V1beta1MutatingWebhookConfigurationList) o;
