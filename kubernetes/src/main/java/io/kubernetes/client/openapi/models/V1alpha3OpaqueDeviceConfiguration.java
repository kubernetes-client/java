...
public class V1alpha3OpaqueDeviceConfiguration {
  ...
  public V1alpha3OpaqueDeviceConfiguration driver(@jakarta.annotation.Nonnull String driver) {
    this.driver = driver;
    return this;
  }
  ...
  public V1alpha3OpaqueDeviceConfiguration parameters(@jakarta.annotation.Nonnull Object parameters) {
