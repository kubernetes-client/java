...
public class V1MatchResources {
  ...
  public V1MatchResources excludeResourceRules(@jakarta.annotation.Nullable List<V1NamedRuleWithOperations> excludeResourceRules) {
  ...
  public void setExcludeResourceRules(@jakarta.annotation.Nullable List<V1NamedRuleWithOperations> excludeResourceRules) {
    this.excludeResourceRules = excludeResourceRules;
  }


  public V1MatchResources matchPolicy(@jakarta.annotation.Nullable String matchPolicy) {
  ...
  public V1MatchResources namespaceSelector(@jakarta.annotation.Nullable V1LabelSelector namespaceSelector) {
  ...
  public V1MatchResources objectSelector(@jakarta.annotation.Nullable V1LabelSelector objectSelector) {
  ...
  public V1MatchResources resourceRules(@jakarta.annotation.Nullable List<V1NamedRuleWithOperations> resourceRules) {
  ...
  public void setResourceRules(@jakarta.annotation.Nullable List<V1NamedRuleWithOperations> resourceRules) {
    this.resourceRules = resourceRules;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1MatchResources
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1MatchResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1MatchResources is not found in the empty JSON string", V1MatchResources.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1MatchResources.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1MatchResources` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("excludeResourceRules") != null && !jsonObj.get("excludeResourceRules").isJsonNull()) {
        ...
        if (jsonArrayexcludeResourceRules != null) {
          ...
          if (!jsonObj.get("excludeResourceRules").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `excludeResourceRules` to be an array in the JSON string but got `%s`", jsonObj.get("excludeResourceRules").toString()));
          }

          // validate the optional field `excludeResourceRules` (array)
          for (int i = 0; i < jsonArrayexcludeResourceRules.size(); i++) {
            V1NamedRuleWithOperations.validateJsonElement(jsonArrayexcludeResourceRules.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("resourceRules") != null && !jsonObj.get("resourceRules").isJsonNull()) {
        ...
        if (jsonArrayresourceRules != null) {
          ...
          if (!jsonObj.get("resourceRules").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `resourceRules` to be an array in the JSON string but got `%s`", jsonObj.get("resourceRules").toString()));
          }

          // validate the optional field `resourceRules` (array)
          for (int i = 0; i < jsonArrayresourceRules.size(); i++) {
            V1NamedRuleWithOperations.validateJsonElement(jsonArrayresourceRules.get(i));
          };
        }
      }
  }
