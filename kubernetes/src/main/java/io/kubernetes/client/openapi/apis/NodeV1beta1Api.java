...
public class NodeV1beta1Api {
   ...
   * </table>
   */
  public ApiResponse<V1beta1RuntimeClass> readRuntimeClassWithHttpInfo(String name, String pretty)
      throws ApiException {
  ...
  public okhttp3.Call readRuntimeClassAsync(
      String name, String pretty, final ApiCallback<V1beta1RuntimeClass> _callback)
      throws ApiException {
