...
public class V1beta2ResourceClaimStatus {
  ...
  public V1beta2ResourceClaimStatus allocation(@jakarta.annotation.Nullable V1beta2AllocationResult allocation) {
  ...
  public void setAllocation(@jakarta.annotation.Nullable V1beta2AllocationResult allocation) {
    this.allocation = allocation;
  }


  public V1beta2ResourceClaimStatus devices(@jakarta.annotation.Nullable List<V1beta2AllocatedDeviceStatus> devices) {
  ...
  public void setDevices(@jakarta.annotation.Nullable List<V1beta2AllocatedDeviceStatus> devices) {
    this.devices = devices;
  }


  public V1beta2ResourceClaimStatus reservedFor(@jakarta.annotation.Nullable List<V1beta2ResourceClaimConsumerReference> reservedFor) {
  ...
  public void setReservedFor(@jakarta.annotation.Nullable List<V1beta2ResourceClaimConsumerReference> reservedFor) {
    this.reservedFor = reservedFor;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta2ResourceClaimStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta2ResourceClaimStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1beta2ResourceClaimStatus is not found in the empty JSON string", V1beta2ResourceClaimStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta2ResourceClaimStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta2ResourceClaimStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `allocation`
      if (jsonObj.get("allocation") != null && !jsonObj.get("allocation").isJsonNull()) {
        V1beta2AllocationResult.validateJsonElement(jsonObj.get("allocation"));
      }
      if (jsonObj.get("devices") != null && !jsonObj.get("devices").isJsonNull()) {
        ...
        if (jsonArraydevices != null) {
          ...
          for (int i = 0; i < jsonArraydevices.size(); i++) {
            V1beta2AllocatedDeviceStatus.validateJsonElement(jsonArraydevices.get(i));
          };
        }
      }
      if (jsonObj.get("reservedFor") != null && !jsonObj.get("reservedFor").isJsonNull()) {
        ...
        if (jsonArrayreservedFor != null) {
          ...
          if (!jsonObj.get("reservedFor").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `reservedFor` to be an array in the JSON string but got `%s`", jsonObj.get("reservedFor").toString()));
          }

          // validate the optional field `reservedFor` (array)
          for (int i = 0; i < jsonArrayreservedFor.size(); i++) {
            V1beta2ResourceClaimConsumerReference.validateJsonElement(jsonArrayreservedFor.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta2ResourceClaimStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta2ResourceClaimStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta2ResourceClaimStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta2ResourceClaimStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta2ResourceClaimStatus>() {
           @Override
           public void write(JsonWriter out, V1beta2ResourceClaimStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta2ResourceClaimStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta2ResourceClaimStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta2ResourceClaimStatus
   * @throws IOException if the JSON string is invalid with respect to V1beta2ResourceClaimStatus
   */
  public static V1beta2ResourceClaimStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta2ResourceClaimStatus.class);
  }

  /**
   * Convert an instance of V1beta2ResourceClaimStatus to an JSON string
   *
   * @return JSON string
   */
