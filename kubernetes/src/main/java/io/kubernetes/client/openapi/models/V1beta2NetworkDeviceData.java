...
public class V1beta2NetworkDeviceData {
  ...
  public V1beta2NetworkDeviceData hardwareAddress(String hardwareAddress) {
  ...
  **/
  ...
  public V1beta2NetworkDeviceData interfaceName(String interfaceName) {
  ...
  **/
  ...
  public V1beta2NetworkDeviceData ips(List<String> ips) {
