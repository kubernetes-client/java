...
public class V1alpha1StorageVersion implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1alpha1StorageVersion apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1alpha1StorageVersion kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1StorageVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1alpha1StorageVersion is not found in the empty JSON string", V1alpha1StorageVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1StorageVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha1StorageVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
