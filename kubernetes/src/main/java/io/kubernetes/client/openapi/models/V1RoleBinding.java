...
public class V1RoleBinding implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1RoleBinding apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1RoleBinding kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1RoleBinding metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1RoleBinding roleRef(@jakarta.annotation.Nonnull V1RoleRef roleRef) {
  ...
  public V1RoleBinding subjects(@jakarta.annotation.Nullable List<RbacV1Subject> subjects) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("apiVersion", "kind", "metadata", "roleRef", "subjects"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("roleRef"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1RoleBinding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1RoleBinding is not found in the empty JSON string", V1RoleBinding.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1RoleBinding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1RoleBinding` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
