...
public class V1StorageOSVolumeSource {
  ...
  public V1StorageOSVolumeSource fsType(@jakarta.annotation.Nullable String fsType) {
    this.fsType = fsType;
    return this;
  }
  ...
  public V1StorageOSVolumeSource readOnly(@jakarta.annotation.Nullable Boolean readOnly) {
  ...
  public V1StorageOSVolumeSource secretRef(@jakarta.annotation.Nullable V1LocalObjectReference secretRef) {
  ...
  public V1StorageOSVolumeSource volumeName(@jakarta.annotation.Nullable String volumeName) {
  ...
  public V1StorageOSVolumeSource volumeNamespace(@jakarta.annotation.Nullable String volumeNamespace) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fsType", "readOnly", "secretRef", "volumeName", "volumeNamespace"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1StorageOSVolumeSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1StorageOSVolumeSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1StorageOSVolumeSource is not found in the empty JSON string", V1StorageOSVolumeSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1StorageOSVolumeSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1StorageOSVolumeSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("volumeNamespace") != null && !jsonObj.get("volumeNamespace").isJsonNull()) && !jsonObj.get("volumeNamespace").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `volumeNamespace` to be a primitive type in the JSON string but got `%s`", jsonObj.get("volumeNamespace").toString()));
      }
  }
