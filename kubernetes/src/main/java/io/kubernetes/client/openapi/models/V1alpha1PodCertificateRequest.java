...
public class V1alpha1PodCertificateRequest implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1alpha1PodCertificateRequest apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PodCertificateRequest kind(String kind) {
  ...
  **/
  ...
  public V1alpha1PodCertificateRequest metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1alpha1PodCertificateRequest spec(V1alpha1PodCertificateRequestSpec spec) {
  ...
  **/
  ...
  public void setSpec(V1alpha1PodCertificateRequestSpec spec) {
    this.spec = spec;
  }


  public V1alpha1PodCertificateRequest status(V1alpha1PodCertificateRequestStatus status) {
  ...
  **/
  ...
  public void setStatus(V1alpha1PodCertificateRequestStatus status) {
    this.status = status;
  }
