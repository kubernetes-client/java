...
public class V1StatefulSetSpec {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(minReadySeconds, podManagementPolicy, replicas, revisionHistoryLimit, selector, serviceName, template, updateStrategy, volumeClaimTemplates);
  }
