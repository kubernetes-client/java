...
public class V1beta1CapacityRequestPolicyRange {
  ...
  public V1beta1CapacityRequestPolicyRange max(Quantity max) {
  ...
  **/
  ...
  public V1beta1CapacityRequestPolicyRange min(Quantity min) {
  ...
  **/
  ...
  public V1beta1CapacityRequestPolicyRange step(Quantity step) {
