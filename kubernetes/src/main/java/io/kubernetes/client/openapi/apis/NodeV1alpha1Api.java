...
public class NodeV1alpha1Api {
   ...
   * </table>
   */
  public okhttp3.Call readRuntimeClassCall(String name, String pretty, final ApiCallback _callback)
      throws ApiException {
    Object localVarPostBody = null;
   ...
   * </table>
   */
  public ApiResponse<V1alpha1RuntimeClass> readRuntimeClassWithHttpInfo(String name, String pretty)
      throws ApiException {
  ...
  public okhttp3.Call readRuntimeClassAsync(
      String name, String pretty, final ApiCallback<V1alpha1RuntimeClass> _callback)
      throws ApiException {
