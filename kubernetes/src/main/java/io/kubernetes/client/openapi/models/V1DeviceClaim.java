...
public class V1DeviceClaim {
  ...
  private List<V1DeviceClaimConfiguration> config = null;

  public static final String SERIALIZED_NAME_CONSTRAINTS = "constraints";
  @SerializedName(SERIALIZED_NAME_CONSTRAINTS)
  private List<V1DeviceConstraint> constraints = null;

  public static final String SERIALIZED_NAME_REQUESTS = "requests";
  @SerializedName(SERIALIZED_NAME_REQUESTS)
  private List<V1DeviceRequest> requests = null;


  public V1DeviceClaim config(List<V1DeviceClaimConfiguration> config) {
  ...
  **/
  ...
  public void setConfig(List<V1DeviceClaimConfiguration> config) {
    this.config = config;
  }


  public V1DeviceClaim constraints(List<V1DeviceConstraint> constraints) {
  ...
  **/
  ...
  public void setConstraints(List<V1DeviceConstraint> constraints) {
    this.constraints = constraints;
  }


  public V1DeviceClaim requests(List<V1DeviceRequest> requests) {
  ...
  **/
  ...
  public void setRequests(List<V1DeviceRequest> requests) {
    this.requests = requests;
  }
