...
public class V1beta2PolicyRulesWithSubjects {
  ...
  public V1beta2PolicyRulesWithSubjects nonResourceRules(
  ...
  public V1beta2PolicyRulesWithSubjects addNonResourceRulesItem(
      V1beta2NonResourcePolicyRule nonResourceRulesItem) {
  ...
  public V1beta2PolicyRulesWithSubjects resourceRules(
      List<V1beta2ResourcePolicyRule> resourceRules) {

    this.resourceRules = resourceRules;
    return this;
  }

  public V1beta2PolicyRulesWithSubjects addResourceRulesItem(
      V1beta2ResourcePolicyRule resourceRulesItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta2PolicyRulesWithSubjects v1beta2PolicyRulesWithSubjects =
        (V1beta2PolicyRulesWithSubjects) o;
