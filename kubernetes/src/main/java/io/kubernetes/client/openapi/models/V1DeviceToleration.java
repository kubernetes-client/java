...
public class V1DeviceToleration {
  ...
  public V1DeviceToleration effect(String effect) {
  ...
  **/
  ...
  public V1DeviceToleration key(String key) {
  ...
  **/
  ...
  public V1DeviceToleration operator(String operator) {
  ...
  **/
  ...
  public V1DeviceToleration tolerationSeconds(Long tolerationSeconds) {
  ...
  **/
  ...
  public V1DeviceToleration value(String value) {
