...
public class V1beta1NetworkDeviceData {
  ...
  public V1beta1NetworkDeviceData hardwareAddress(@jakarta.annotation.Nullable String hardwareAddress) {
  ...
  public V1beta1NetworkDeviceData interfaceName(@jakarta.annotation.Nullable String interfaceName) {
  ...
  public V1beta1NetworkDeviceData ips(@jakarta.annotation.Nullable List<String> ips) {
    this.ips = ips;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1NetworkDeviceData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1NetworkDeviceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1NetworkDeviceData is not found in the empty JSON string", V1beta1NetworkDeviceData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1NetworkDeviceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1NetworkDeviceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1NetworkDeviceData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1NetworkDeviceData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1NetworkDeviceData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1NetworkDeviceData.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1NetworkDeviceData>() {
           @Override
           public void write(JsonWriter out, V1beta1NetworkDeviceData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1NetworkDeviceData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1NetworkDeviceData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1NetworkDeviceData
   * @throws IOException if the JSON string is invalid with respect to V1beta1NetworkDeviceData
   */
  public static V1beta1NetworkDeviceData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1NetworkDeviceData.class);
  }

  /**
   * Convert an instance of V1beta1NetworkDeviceData to an JSON string
   *
   * @return JSON string
   */
