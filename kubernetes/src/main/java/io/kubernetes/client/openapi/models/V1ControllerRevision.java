...
public class V1ControllerRevision implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1ControllerRevision apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1ControllerRevision data(@jakarta.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public V1ControllerRevision kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1ControllerRevision metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1ControllerRevision revision(@jakarta.annotation.Nonnull Long revision) {
  ...
  public void setRevision(@jakarta.annotation.Nonnull Long revision) {
    this.revision = revision;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("apiVersion", "data", "kind", "metadata", "revision"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("revision"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ControllerRevision.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ControllerRevision is not found in the empty JSON string", V1ControllerRevision.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ControllerRevision.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ControllerRevision` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
