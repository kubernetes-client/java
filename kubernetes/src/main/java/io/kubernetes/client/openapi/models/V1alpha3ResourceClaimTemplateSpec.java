...
public class V1alpha3ResourceClaimTemplateSpec {
  ...
  public V1alpha3ResourceClaimTemplateSpec metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1alpha3ResourceClaimTemplateSpec spec(@jakarta.annotation.Nonnull V1alpha3ResourceClaimSpec spec) {
    this.spec = spec;
    return this;
  }
