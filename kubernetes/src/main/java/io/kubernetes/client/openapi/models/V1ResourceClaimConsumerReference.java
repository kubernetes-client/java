...
public class V1ResourceClaimConsumerReference {
  ...
  public V1ResourceClaimConsumerReference apiGroup(String apiGroup) {
  ...
  **/
  ...
  public V1ResourceClaimConsumerReference name(String name) {
  ...
  **/
  ...
  public V1ResourceClaimConsumerReference uid(String uid) {
