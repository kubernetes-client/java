...
public class V1CapacityRequestPolicy {
  ...
  public V1CapacityRequestPolicy _default(Quantity _default) {
  ...
  **/
  ...
  public V1CapacityRequestPolicy validRange(V1CapacityRequestPolicyRange validRange) {
  ...
  **/
  ...
  public void setValidRange(V1CapacityRequestPolicyRange validRange) {
    this.validRange = validRange;
  }


  public V1CapacityRequestPolicy validValues(List<Quantity> validValues) {
