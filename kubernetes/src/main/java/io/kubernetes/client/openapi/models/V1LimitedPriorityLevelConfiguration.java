...
public class V1LimitedPriorityLevelConfiguration {
  ...
  public V1LimitedPriorityLevelConfiguration borrowingLimitPercent(Integer borrowingLimitPercent) {
  ...
  **/
  ...
  public V1LimitedPriorityLevelConfiguration lendablePercent(Integer lendablePercent) {
  ...
  **/
  ...
  public V1LimitedPriorityLevelConfiguration limitResponse(V1LimitResponse limitResponse) {
  ...
  **/
  ...
  public void setLimitResponse(V1LimitResponse limitResponse) {
    this.limitResponse = limitResponse;
  }


  public V1LimitedPriorityLevelConfiguration nominalConcurrencyShares(Integer nominalConcurrencyShares) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1LimitedPriorityLevelConfiguration
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1LimitedPriorityLevelConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1LimitedPriorityLevelConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1LimitedPriorityLevelConfiguration` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `limitResponse`
      if (jsonObj.get("limitResponse") != null && !jsonObj.get("limitResponse").isJsonNull()) {
        V1LimitResponse.validateJsonObject(jsonObj.getAsJsonObject("limitResponse"));
      }
  }
