...
public class V1Job implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1Job apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1Job kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1Job metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1Job spec(@jakarta.annotation.Nullable V1JobSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public V1Job status(@jakarta.annotation.Nullable V1JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V1JobStatus status) {
    this.status = status;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1Job
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1Job.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1Job is not found in the empty JSON string", V1Job.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1Job.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1Job` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        V1JobSpec.validateJsonElement(jsonObj.get("spec"));
      }
      // validate the optional field `status`
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        V1JobStatus.validateJsonElement(jsonObj.get("status"));
      }
  }
