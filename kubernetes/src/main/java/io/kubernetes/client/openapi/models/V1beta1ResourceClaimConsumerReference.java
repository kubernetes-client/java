...
public class V1beta1ResourceClaimConsumerReference {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiGroup, v1beta1ResourceClaimConsumerReference.apiGroup) &&
        Objects.equals(this.name, v1beta1ResourceClaimConsumerReference.name) &&
        Objects.equals(this.resource, v1beta1ResourceClaimConsumerReference.resource) &&
        Objects.equals(this.uid, v1beta1ResourceClaimConsumerReference.uid);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1ResourceClaimConsumerReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1beta1ResourceClaimConsumerReference is not found in the empty JSON string", V1beta1ResourceClaimConsumerReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1ResourceClaimConsumerReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1ResourceClaimConsumerReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1ResourceClaimConsumerReference.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1ResourceClaimConsumerReference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1ResourceClaimConsumerReference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1ResourceClaimConsumerReference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1ResourceClaimConsumerReference.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1ResourceClaimConsumerReference>() {
           @Override
