...
public class V1ValidationRule {
  ...
  public V1ValidationRule fieldPath(@jakarta.annotation.Nullable String fieldPath) {
  ...
  public V1ValidationRule message(@jakarta.annotation.Nullable String message) {
  ...
  public V1ValidationRule messageExpression(@jakarta.annotation.Nullable String messageExpression) {
  ...
  public V1ValidationRule optionalOldSelf(@jakarta.annotation.Nullable Boolean optionalOldSelf) {
   ...
   */
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "optionalOldSelf is used to opt a transition rule into evaluation even when the object is first created, or if the old object is missing the value.  When enabled `oldSelf` will be a CEL optional whose value will be `None` if there is no old value, or when the object is initially created.  You may check for presence of oldSelf using `oldSelf.hasValue()` and unwrap it after checking using `oldSelf.value()`. Check the CEL documentation for Optional types for more information: https://pkg.go.dev/github.com/google/cel-go/cel#OptionalTypes  May not be set unless `oldSelf` is used in `rule`.")
  public Boolean getOptionalOldSelf() {
    return optionalOldSelf;
  }

  public void setOptionalOldSelf(@jakarta.annotation.Nullable Boolean optionalOldSelf) {
    this.optionalOldSelf = optionalOldSelf;
  }


  public V1ValidationRule reason(@jakarta.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public V1ValidationRule rule(@jakarta.annotation.Nonnull String rule) {
    this.rule = rule;
    return this;
  }
  ...
  public void setRule(@jakarta.annotation.Nonnull String rule) {
    this.rule = rule;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fieldPath", "message", "messageExpression", "optionalOldSelf", "reason", "rule"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("rule"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ValidationRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ValidationRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1ValidationRule is not found in the empty JSON string", V1ValidationRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ValidationRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ValidationRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("fieldPath") != null && !jsonObj.get("fieldPath").isJsonNull()) && !jsonObj.get("fieldPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `fieldPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fieldPath").toString()));
      }
      ...
      if ((jsonObj.get("messageExpression") != null && !jsonObj.get("messageExpression").isJsonNull()) && !jsonObj.get("messageExpression").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `messageExpression` to be a primitive type in the JSON string but got `%s`", jsonObj.get("messageExpression").toString()));
      }
      ...
      if (!jsonObj.get("rule").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `rule` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rule").toString()));
      }
  }
