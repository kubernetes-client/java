...
public class V1NetworkDeviceData {
  ...
  public V1NetworkDeviceData hardwareAddress(String hardwareAddress) {
  ...
  **/
  ...
  public V1NetworkDeviceData interfaceName(String interfaceName) {
  ...
  **/
  ...
  public V1NetworkDeviceData ips(List<String> ips) {
