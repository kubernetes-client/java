...
public class V1MutatingWebhook {
  ...
  public V1MutatingWebhook admissionReviewVersions(@jakarta.annotation.Nonnull List<String> admissionReviewVersions) {
  ...
  public V1MutatingWebhook clientConfig(@jakarta.annotation.Nonnull AdmissionregistrationV1WebhookClientConfig clientConfig) {
  ...
  public V1MutatingWebhook failurePolicy(@jakarta.annotation.Nullable String failurePolicy) {
  ...
  public V1MutatingWebhook matchConditions(@jakarta.annotation.Nullable List<V1MatchCondition> matchConditions) {
  ...
  public V1MutatingWebhook matchPolicy(@jakarta.annotation.Nullable String matchPolicy) {
  ...
  public V1MutatingWebhook name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1MutatingWebhook objectSelector(@jakarta.annotation.Nullable V1LabelSelector objectSelector) {
  ...
  public V1MutatingWebhook reinvocationPolicy(@jakarta.annotation.Nullable String reinvocationPolicy) {
  ...
  public V1MutatingWebhook rules(@jakarta.annotation.Nullable List<V1RuleWithOperations> rules) {
    this.rules = rules;
    return this;
  }
  ...
  public V1MutatingWebhook sideEffects(@jakarta.annotation.Nonnull String sideEffects) {
  ...
  public V1MutatingWebhook timeoutSeconds(@jakarta.annotation.Nullable Integer timeoutSeconds) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("admissionReviewVersions", "clientConfig", "failurePolicy", "matchConditions", "matchPolicy", "name", "namespaceSelector", "objectSelector", "reinvocationPolicy", "rules", "sideEffects", "timeoutSeconds"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("admissionReviewVersions", "clientConfig", "name", "sideEffects"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1MutatingWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1MutatingWebhook is not found in the empty JSON string", V1MutatingWebhook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1MutatingWebhook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1MutatingWebhook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("admissionReviewVersions") == null) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `admissionReviewVersions` to be an array in the JSON string but got `%s`", jsonObj.get("admissionReviewVersions").toString()));
      }
      ...
      if ((jsonObj.get("matchPolicy") != null && !jsonObj.get("matchPolicy").isJsonNull()) && !jsonObj.get("matchPolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `matchPolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("matchPolicy").toString()));
      }
      ...
      if (!jsonObj.get("sideEffects").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sideEffects` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sideEffects").toString()));
      }
  }
