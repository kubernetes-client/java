...
import io.kubernetes.client.openapi.models.V1NodeAllocatableResourceMapping;
...
public class V1Device {
  ...
  @jakarta.annotation.Nullable
  private Map<String, V1NodeAllocatableResourceMapping> nodeAllocatableResourceMappings = new HashMap<>();
  ...
  public V1Device nodeAllocatableResourceMappings(@jakarta.annotation.Nullable Map<String, V1NodeAllocatableResourceMapping> nodeAllocatableResourceMappings) {
    this.nodeAllocatableResourceMappings = nodeAllocatableResourceMappings;
    return this;
  }

  public V1Device putNodeAllocatableResourceMappingsItem(String key, V1NodeAllocatableResourceMapping nodeAllocatableResourceMappingsItem) {
  ...
  public Map<String, V1NodeAllocatableResourceMapping> getNodeAllocatableResourceMappings() {
    return nodeAllocatableResourceMappings;
  }

  public void setNodeAllocatableResourceMappings(@jakarta.annotation.Nullable Map<String, V1NodeAllocatableResourceMapping> nodeAllocatableResourceMappings) {
    this.nodeAllocatableResourceMappings = nodeAllocatableResourceMappings;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allNodes, v1Device.allNodes) &&
        ...
        Objects.equals(this.nodeAllocatableResourceMappings, v1Device.nodeAllocatableResourceMappings) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1Device.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1Device is not found in the empty JSON string", V1Device.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1Device.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1Device` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
