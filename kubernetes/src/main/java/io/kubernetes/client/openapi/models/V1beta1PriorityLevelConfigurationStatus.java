...
public class V1beta1PriorityLevelConfigurationStatus {
  ...
  public V1beta1PriorityLevelConfigurationStatus conditions(
      List<V1beta1PriorityLevelConfigurationCondition> conditions) {

    this.conditions = conditions;
    return this;
  }

  public V1beta1PriorityLevelConfigurationStatus addConditionsItem(
      V1beta1PriorityLevelConfigurationCondition conditionsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1PriorityLevelConfigurationStatus v1beta1PriorityLevelConfigurationStatus =
        (V1beta1PriorityLevelConfigurationStatus) o;
