...
public class V1beta2ResourceClaimConsumerReference {
  ...
  public V1beta2ResourceClaimConsumerReference apiGroup(String apiGroup) {
  ...
  **/
  ...
  public V1beta2ResourceClaimConsumerReference name(String name) {
  ...
  **/
  ...
  public V1beta2ResourceClaimConsumerReference resource(String resource) {
  ...
  **/
  ...
  public V1beta2ResourceClaimConsumerReference uid(String uid) {
