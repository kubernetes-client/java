...
public class V1JobStatus {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of pods which have a Ready condition.  This field is alpha-level. The job controller populates the field when the feature gate JobReadyPods is enabled (disabled by default).")
