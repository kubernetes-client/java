...
public class V1CustomResourceDefinition implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1CustomResourceDefinition apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1CustomResourceDefinition kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1CustomResourceDefinition metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1CustomResourceDefinition spec(@jakarta.annotation.Nonnull V1CustomResourceDefinitionSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nonnull V1CustomResourceDefinitionSpec spec) {
    this.spec = spec;
  }


  public V1CustomResourceDefinition status(@jakarta.annotation.Nullable V1CustomResourceDefinitionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V1CustomResourceDefinitionStatus status) {
    this.status = status;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1CustomResourceDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1CustomResourceDefinition is not found in the empty JSON string", V1CustomResourceDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1CustomResourceDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1CustomResourceDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
