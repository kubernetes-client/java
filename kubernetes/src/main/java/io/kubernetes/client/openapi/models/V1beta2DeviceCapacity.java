...
public class V1beta2DeviceCapacity {
  ...
  public V1beta2DeviceCapacity requestPolicy(V1beta2CapacityRequestPolicy requestPolicy) {
  ...
  **/
  ...
  public void setRequestPolicy(V1beta2CapacityRequestPolicy requestPolicy) {
    this.requestPolicy = requestPolicy;
  }


  public V1beta2DeviceCapacity value(Quantity value) {
