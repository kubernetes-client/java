...
import io.kubernetes.client.openapi.models.V1VolumeStatus;
...
public class V1VolumeMountStatus {
  ...
  @jakarta.annotation.Nullable
  private V1VolumeStatus volumeStatus;
  ...
  public V1VolumeMountStatus volumeStatus(@jakarta.annotation.Nullable V1VolumeStatus volumeStatus) {
  ...
  public V1VolumeStatus getVolumeStatus() {
    return volumeStatus;
  }

  public void setVolumeStatus(@jakarta.annotation.Nullable V1VolumeStatus volumeStatus) {
    this.volumeStatus = volumeStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mountPath, v1VolumeMountStatus.mountPath) &&
        ...
        Objects.equals(this.volumeStatus, v1VolumeMountStatus.volumeStatus);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mountPath", "name", "readOnly", "recursiveReadOnly", "volumeStatus"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1VolumeMountStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1VolumeMountStatus is not found in the empty JSON string", V1VolumeMountStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1VolumeMountStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1VolumeMountStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("volumeStatus") != null && !jsonObj.get("volumeStatus").isJsonNull()) {
        V1VolumeStatus.validateJsonElement(jsonObj.get("volumeStatus"));
      }
  }
