...
public class V1Node implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1Node apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1Node kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1Node metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1Node spec(@jakarta.annotation.Nullable V1NodeSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1NodeSpec spec) {
    this.spec = spec;
  }


  public V1Node status(@jakarta.annotation.Nullable V1NodeStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V1NodeStatus status) {
    this.status = status;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1Node.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1Node is not found in the empty JSON string", V1Node.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1Node.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1Node` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
