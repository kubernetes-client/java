...
public class ExtensionsV1beta1PodSecurityPolicySpec {
  ...
  **/
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec allowedCSIDrivers(List<ExtensionsV1beta1AllowedCSIDriver> allowedCSIDrivers) {
    
    this.allowedCSIDrivers = allowedCSIDrivers;
    return this;
  }

  public ExtensionsV1beta1PodSecurityPolicySpec addAllowedCSIDriversItem(ExtensionsV1beta1AllowedCSIDriver allowedCSIDriversItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes.")
  ...
  **/
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec runAsGroup(ExtensionsV1beta1RunAsGroupStrategyOptions runAsGroup) {
  ...
  **/
  ...
  public ExtensionsV1beta1PodSecurityPolicySpec runtimeClass(ExtensionsV1beta1RuntimeClassStrategyOptions runtimeClass) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.allowPrivilegeEscalation, extensionsV1beta1PodSecurityPolicySpec.allowPrivilegeEscalation) &&
        Objects.equals(this.allowedCSIDrivers, extensionsV1beta1PodSecurityPolicySpec.allowedCSIDrivers) &&
