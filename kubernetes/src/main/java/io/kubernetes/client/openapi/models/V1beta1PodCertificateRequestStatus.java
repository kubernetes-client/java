...
public class V1beta1PodCertificateRequestStatus {
  ...
  public V1beta1PodCertificateRequestStatus() {
  }

  public V1beta1PodCertificateRequestStatus beginRefreshAt(@jakarta.annotation.Nullable OffsetDateTime beginRefreshAt) {
  ...
  public V1beta1PodCertificateRequestStatus certificateChain(@jakarta.annotation.Nullable String certificateChain) {
  ...
  public V1beta1PodCertificateRequestStatus conditions(@jakarta.annotation.Nullable List<V1Condition> conditions) {
    this.conditions = conditions;
    return this;
  }

  public V1beta1PodCertificateRequestStatus addConditionsItem(V1Condition conditionsItem) {
  ...
  public V1beta1PodCertificateRequestStatus notAfter(@jakarta.annotation.Nullable OffsetDateTime notAfter) {
  ...
  public V1beta1PodCertificateRequestStatus notBefore(@jakarta.annotation.Nullable OffsetDateTime notBefore) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1PodCertificateRequestStatus v1beta1PodCertificateRequestStatus = (V1beta1PodCertificateRequestStatus) o;
    return Objects.equals(this.beginRefreshAt, v1beta1PodCertificateRequestStatus.beginRefreshAt) &&
        Objects.equals(this.certificateChain, v1beta1PodCertificateRequestStatus.certificateChain) &&
        Objects.equals(this.conditions, v1beta1PodCertificateRequestStatus.conditions) &&
        Objects.equals(this.notAfter, v1beta1PodCertificateRequestStatus.notAfter) &&
        Objects.equals(this.notBefore, v1beta1PodCertificateRequestStatus.notBefore);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1PodCertificateRequestStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1PodCertificateRequestStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1PodCertificateRequestStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1PodCertificateRequestStatus is not found in the empty JSON string", V1beta1PodCertificateRequestStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1PodCertificateRequestStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1PodCertificateRequestStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("certificateChain") != null && !jsonObj.get("certificateChain").isJsonNull()) && !jsonObj.get("certificateChain").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `certificateChain` to be a primitive type in the JSON string but got `%s`", jsonObj.get("certificateChain").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1PodCertificateRequestStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1PodCertificateRequestStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1PodCertificateRequestStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1PodCertificateRequestStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1PodCertificateRequestStatus>() {
           @Override
           public void write(JsonWriter out, V1beta1PodCertificateRequestStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1PodCertificateRequestStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1PodCertificateRequestStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1PodCertificateRequestStatus
   * @throws IOException if the JSON string is invalid with respect to V1beta1PodCertificateRequestStatus
   */
  public static V1beta1PodCertificateRequestStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1PodCertificateRequestStatus.class);
  }

  /**
   * Convert an instance of V1beta1PodCertificateRequestStatus to an JSON string
   *
   * @return JSON string
   */
