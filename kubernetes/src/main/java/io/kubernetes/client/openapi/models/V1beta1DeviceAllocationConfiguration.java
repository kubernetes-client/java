...
public class V1beta1DeviceAllocationConfiguration {
  ...
  public V1beta1DeviceAllocationConfiguration opaque(@jakarta.annotation.Nullable V1beta1OpaqueDeviceConfiguration opaque) {
    this.opaque = opaque;
    return this;
  }
  ...
  public V1beta1DeviceAllocationConfiguration requests(@jakarta.annotation.Nullable List<String> requests) {
  ...
  public V1beta1DeviceAllocationConfiguration source(@jakarta.annotation.Nonnull String source) {
    this.source = source;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1DeviceAllocationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1DeviceAllocationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1beta1DeviceAllocationConfiguration is not found in the empty JSON string", V1beta1DeviceAllocationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1DeviceAllocationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1DeviceAllocationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1DeviceAllocationConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1DeviceAllocationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1DeviceAllocationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1DeviceAllocationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1DeviceAllocationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1DeviceAllocationConfiguration>() {
           @Override
  ...
  /**
   * Create an instance of V1beta1DeviceAllocationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1DeviceAllocationConfiguration
   * @throws IOException if the JSON string is invalid with respect to V1beta1DeviceAllocationConfiguration
   */
  public static V1beta1DeviceAllocationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1DeviceAllocationConfiguration.class);
  }

  /**
   * Convert an instance of V1beta1DeviceAllocationConfiguration to an JSON string
   *
   * @return JSON string
   */
