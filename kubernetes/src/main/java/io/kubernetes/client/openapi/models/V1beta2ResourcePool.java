...
public class V1beta2ResourcePool {
  ...
  public V1beta2ResourcePool generation(@jakarta.annotation.Nonnull Long generation) {
  ...
  public V1beta2ResourcePool name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1beta2ResourcePool resourceSliceCount(@jakarta.annotation.Nonnull Long resourceSliceCount) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta2ResourcePool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta2ResourcePool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta2ResourcePool is not found in the empty JSON string", V1beta2ResourcePool.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta2ResourcePool.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta2ResourcePool` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta2ResourcePool.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta2ResourcePool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta2ResourcePool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta2ResourcePool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta2ResourcePool.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta2ResourcePool>() {
           @Override
  ...
  /**
   * Create an instance of V1beta2ResourcePool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta2ResourcePool
   * @throws IOException if the JSON string is invalid with respect to V1beta2ResourcePool
   */
  public static V1beta2ResourcePool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta2ResourcePool.class);
  }

  /**
   * Convert an instance of V1beta2ResourcePool to an JSON string
   *
   * @return JSON string
   */
