...
public class EventsV1Api {
   ...
   * </table>
   */
  public EventsV1Event readNamespacedEvent(String name, String namespace, String pretty)
      throws ApiException {
    ApiResponse<EventsV1Event> localVarResp =
  ...
  public okhttp3.Call readNamespacedEventAsync(
      String name, String namespace, String pretty, final ApiCallback<EventsV1Event> _callback)
      throws ApiException {
