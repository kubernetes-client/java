...
public class V1alpha1VolumeAttributesClass implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1alpha1VolumeAttributesClass apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1alpha1VolumeAttributesClass driverName(@jakarta.annotation.Nonnull String driverName) {
  ...
  public V1alpha1VolumeAttributesClass kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1alpha1VolumeAttributesClass metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1alpha1VolumeAttributesClass parameters(@jakarta.annotation.Nullable Map<String, String> parameters) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1alpha1VolumeAttributesClass
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1VolumeAttributesClass.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1alpha1VolumeAttributesClass is not found in the empty JSON string", V1alpha1VolumeAttributesClass.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1VolumeAttributesClass.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha1VolumeAttributesClass` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
