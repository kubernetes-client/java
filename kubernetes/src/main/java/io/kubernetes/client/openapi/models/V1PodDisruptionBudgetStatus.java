...
public class V1PodDisruptionBudgetStatus {
  ...
  public V1PodDisruptionBudgetStatus conditions(@jakarta.annotation.Nullable List<V1Condition> conditions) {
  ...
  public V1PodDisruptionBudgetStatus disruptedPods(@jakarta.annotation.Nullable Map<String, OffsetDateTime> disruptedPods) {
  ...
  public void setDisruptedPods(@jakarta.annotation.Nullable Map<String, OffsetDateTime> disruptedPods) {
    this.disruptedPods = disruptedPods;
  }
  ...
  public V1PodDisruptionBudgetStatus observedGeneration(@jakarta.annotation.Nullable Long observedGeneration) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1PodDisruptionBudgetStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1PodDisruptionBudgetStatus is not found in the empty JSON string", V1PodDisruptionBudgetStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1PodDisruptionBudgetStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1PodDisruptionBudgetStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
