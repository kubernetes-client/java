...
public class V1alpha3ResourceClaimSpec {
  ...
  public V1alpha3ResourceClaimSpec devices(@jakarta.annotation.Nullable V1alpha3DeviceClaim devices) {
  ...
  public void setDevices(@jakarta.annotation.Nullable V1alpha3DeviceClaim devices) {
    this.devices = devices;
  }
