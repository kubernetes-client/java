...
public class RbacV1beta1Subject {
  ...
  public RbacV1beta1Subject apiGroup(String apiGroup) {
  ...
  public RbacV1beta1Subject kind(String kind) {
  ...
  public RbacV1beta1Subject name(String name) {
  ...
  public RbacV1beta1Subject namespace(String namespace) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RbacV1beta1Subject rbacV1beta1Subject = (RbacV1beta1Subject) o;
    return Objects.equals(this.apiGroup, rbacV1beta1Subject.apiGroup)
        && Objects.equals(this.kind, rbacV1beta1Subject.kind)
        && Objects.equals(this.name, rbacV1beta1Subject.name)
        && Objects.equals(this.namespace, rbacV1beta1Subject.namespace);
  }
