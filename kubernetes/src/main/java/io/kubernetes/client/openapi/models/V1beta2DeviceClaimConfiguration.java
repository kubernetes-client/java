...
public class V1beta2DeviceClaimConfiguration {
  ...
  public V1beta2DeviceClaimConfiguration opaque(V1beta2OpaqueDeviceConfiguration opaque) {
  ...
  **/
  ...
  public V1beta2DeviceClaimConfiguration requests(List<String> requests) {
