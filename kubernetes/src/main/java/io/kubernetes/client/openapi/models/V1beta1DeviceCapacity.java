...
public class V1beta1DeviceCapacity {
  ...
  public V1beta1DeviceCapacity requestPolicy(@jakarta.annotation.Nullable V1beta1CapacityRequestPolicy requestPolicy) {
  ...
  public void setRequestPolicy(@jakarta.annotation.Nullable V1beta1CapacityRequestPolicy requestPolicy) {
    this.requestPolicy = requestPolicy;
  }


  public V1beta1DeviceCapacity value(@jakarta.annotation.Nonnull Quantity value) {
    this.value = value;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1DeviceCapacity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1DeviceCapacity is not found in the empty JSON string", V1beta1DeviceCapacity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1DeviceCapacity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1DeviceCapacity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("requestPolicy") != null && !jsonObj.get("requestPolicy").isJsonNull()) {
        V1beta1CapacityRequestPolicy.validateJsonElement(jsonObj.get("requestPolicy"));
      }
