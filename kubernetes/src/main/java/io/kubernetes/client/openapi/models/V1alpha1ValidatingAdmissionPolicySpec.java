...
public class V1alpha1ValidatingAdmissionPolicySpec {
  ...
  * @throws IOException if the JSON Element is invalid with respect to V1alpha1ValidatingAdmissionPolicySpec
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1ValidatingAdmissionPolicySpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
