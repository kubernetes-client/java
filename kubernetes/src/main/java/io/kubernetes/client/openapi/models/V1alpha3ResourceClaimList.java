...
public class V1alpha3ResourceClaimList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  public V1alpha3ResourceClaimList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha3ResourceClaimList items(List<V1alpha3ResourceClaim> items) {
    this.items = items;
    return this;
  }
  ...
  **/
  ...
  public void setItems(List<V1alpha3ResourceClaim> items) {
    this.items = items;
  }


  public V1alpha3ResourceClaimList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1alpha3ResourceClaimList metadata(V1ListMeta metadata) {
