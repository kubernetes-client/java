...
import io.kubernetes.client.openapi.models.V1NodeAllocatableResourceClaimStatus;
...
public class V1PodStatus {
  ...
  public static final String SERIALIZED_NAME_NODE_ALLOCATABLE_RESOURCE_CLAIM_STATUSES = "nodeAllocatableResourceClaimStatuses";
  @SerializedName(SERIALIZED_NAME_NODE_ALLOCATABLE_RESOURCE_CLAIM_STATUSES)
  @jakarta.annotation.Nullable
  private List<V1NodeAllocatableResourceClaimStatus> nodeAllocatableResourceClaimStatuses = new ArrayList<>();
  ...
  public V1PodStatus nodeAllocatableResourceClaimStatuses(@jakarta.annotation.Nullable List<V1NodeAllocatableResourceClaimStatus> nodeAllocatableResourceClaimStatuses) {
    this.nodeAllocatableResourceClaimStatuses = nodeAllocatableResourceClaimStatuses;
    return this;
  }

  public V1PodStatus addNodeAllocatableResourceClaimStatusesItem(V1NodeAllocatableResourceClaimStatus nodeAllocatableResourceClaimStatusesItem) {
    if (this.nodeAllocatableResourceClaimStatuses == null) {
      this.nodeAllocatableResourceClaimStatuses = new ArrayList<>();
    }
    this.nodeAllocatableResourceClaimStatuses.add(nodeAllocatableResourceClaimStatusesItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "NodeAllocatableResourceClaimStatuses contains the status of node-allocatable resources that were allocated for this pod through DRA claims. This includes resources currently reported in v1.Node `status.allocatable` that are not extended resources (see https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#extended-resources). Examples include \"cpu\", \"memory\", \"ephemeral-storage\", and hugepages.")
  public List<V1NodeAllocatableResourceClaimStatus> getNodeAllocatableResourceClaimStatuses() {
    return nodeAllocatableResourceClaimStatuses;
  }

  public void setNodeAllocatableResourceClaimStatuses(@jakarta.annotation.Nullable List<V1NodeAllocatableResourceClaimStatus> nodeAllocatableResourceClaimStatuses) {
    this.nodeAllocatableResourceClaimStatuses = nodeAllocatableResourceClaimStatuses;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allocatedResources, v1PodStatus.allocatedResources) &&
        ...
        Objects.equals(this.nodeAllocatableResourceClaimStatuses, v1PodStatus.nodeAllocatableResourceClaimStatuses) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("nodeAllocatableResourceClaimStatuses") != null && !jsonObj.get("nodeAllocatableResourceClaimStatuses").isJsonNull()) {
        JsonArray jsonArraynodeAllocatableResourceClaimStatuses = jsonObj.getAsJsonArray("nodeAllocatableResourceClaimStatuses");
        if (jsonArraynodeAllocatableResourceClaimStatuses != null) {
          // ensure the json data is an array
          if (!jsonObj.get("nodeAllocatableResourceClaimStatuses").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nodeAllocatableResourceClaimStatuses` to be an array in the JSON string but got `%s`", jsonObj.get("nodeAllocatableResourceClaimStatuses").toString()));
          }

          // validate the optional field `nodeAllocatableResourceClaimStatuses` (array)
          for (int i = 0; i < jsonArraynodeAllocatableResourceClaimStatuses.size(); i++) {
            V1NodeAllocatableResourceClaimStatus.validateJsonElement(jsonArraynodeAllocatableResourceClaimStatuses.get(i));
          };
        }
      }
