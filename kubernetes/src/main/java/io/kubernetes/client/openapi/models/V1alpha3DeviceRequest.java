...
public class V1alpha3DeviceRequest {
  ...
  @jakarta.annotation.Nullable
  private List<V1alpha3DeviceSubRequest> firstAvailable = new ArrayList<>();
  ...
  public V1alpha3DeviceRequest adminAccess(@jakarta.annotation.Nullable Boolean adminAccess) {
  ...
  public V1alpha3DeviceRequest allocationMode(@jakarta.annotation.Nullable String allocationMode) {
  ...
  public V1alpha3DeviceRequest count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public V1alpha3DeviceRequest deviceClassName(@jakarta.annotation.Nullable String deviceClassName) {
  ...
  public V1alpha3DeviceRequest firstAvailable(@jakarta.annotation.Nullable List<V1alpha3DeviceSubRequest> firstAvailable) {
  ...
  public void setFirstAvailable(@jakarta.annotation.Nullable List<V1alpha3DeviceSubRequest> firstAvailable) {
    this.firstAvailable = firstAvailable;
  }


  public V1alpha3DeviceRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1alpha3DeviceRequest selectors(@jakarta.annotation.Nullable List<V1alpha3DeviceSelector> selectors) {
  ...
  public V1alpha3DeviceRequest tolerations(@jakarta.annotation.Nullable List<V1alpha3DeviceToleration> tolerations) {
      ...
      if (jsonObj.get("firstAvailable") != null && !jsonObj.get("firstAvailable").isJsonNull()) {
        ...
        if (jsonArrayfirstAvailable != null) {
          ...
          for (int i = 0; i < jsonArrayfirstAvailable.size(); i++) {
            V1alpha3DeviceSubRequest.validateJsonElement(jsonArrayfirstAvailable.get(i));
          };
        }
      }
