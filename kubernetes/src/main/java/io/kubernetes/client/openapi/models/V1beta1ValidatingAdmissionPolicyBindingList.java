...
public class V1beta1ValidatingAdmissionPolicyBindingList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  private List<V1beta1ValidatingAdmissionPolicyBinding> items = new ArrayList<>();
  ...
  public V1beta1ValidatingAdmissionPolicyBindingList apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1beta1ValidatingAdmissionPolicyBindingList items(@jakarta.annotation.Nonnull List<V1beta1ValidatingAdmissionPolicyBinding> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@jakarta.annotation.Nonnull List<V1beta1ValidatingAdmissionPolicyBinding> items) {
    this.items = items;
  }


  public V1beta1ValidatingAdmissionPolicyBindingList kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1beta1ValidatingAdmissionPolicyBindingList metadata(@jakarta.annotation.Nullable V1ListMeta metadata) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1ValidatingAdmissionPolicyBindingList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1ValidatingAdmissionPolicyBindingList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1ValidatingAdmissionPolicyBindingList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1ValidatingAdmissionPolicyBindingList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1ValidatingAdmissionPolicyBindingList.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        V1beta1ValidatingAdmissionPolicyBinding.validateJsonElement(jsonArrayitems.get(i));
      };
