...
public class V1beta1ParentReference {
  ...
  public V1beta1ParentReference group(@jakarta.annotation.Nullable String group) {
    this.group = group;
    return this;
  }
  ...
  public V1beta1ParentReference name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1beta1ParentReference namespace(@jakarta.annotation.Nullable String namespace) {
  ...
  public V1beta1ParentReference resource(@jakarta.annotation.Nonnull String resource) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1ParentReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1ParentReference is not found in the empty JSON string", V1beta1ParentReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1ParentReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1ParentReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
