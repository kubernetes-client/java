...
public class V1beta1Validation {
  ...
  public V1beta1Validation() {
  }

  public V1beta1Validation expression(@jakarta.annotation.Nonnull String expression) {
  ...
  public V1beta1Validation message(@jakarta.annotation.Nullable String message) {
  ...
  public V1beta1Validation messageExpression(@jakarta.annotation.Nullable String messageExpression) {
  ...
  public V1beta1Validation reason(@jakarta.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1Validation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1Validation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1Validation is not found in the empty JSON string", V1beta1Validation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1Validation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1Validation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1Validation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1Validation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1Validation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1Validation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1Validation.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1Validation>() {
           @Override
           public void write(JsonWriter out, V1beta1Validation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1Validation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1Validation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1Validation
   * @throws IOException if the JSON string is invalid with respect to V1beta1Validation
   */
  public static V1beta1Validation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1Validation.class);
  }

  /**
   * Convert an instance of V1beta1Validation to an JSON string
   *
   * @return JSON string
   */
