...
public class V1beta1ValidatingAdmissionPolicyBindingSpec {
  ...
  public V1beta1ValidatingAdmissionPolicyBindingSpec matchResources(@jakarta.annotation.Nullable V1beta1MatchResources matchResources) {
  ...
  public V1beta1ValidatingAdmissionPolicyBindingSpec paramRef(@jakarta.annotation.Nullable V1beta1ParamRef paramRef) {
  ...
  public V1beta1ValidatingAdmissionPolicyBindingSpec policyName(@jakarta.annotation.Nullable String policyName) {
  ...
  public V1beta1ValidatingAdmissionPolicyBindingSpec validationActions(@jakarta.annotation.Nullable List<String> validationActions) {
