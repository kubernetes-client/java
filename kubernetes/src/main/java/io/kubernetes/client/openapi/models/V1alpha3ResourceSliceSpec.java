...
public class V1alpha3ResourceSliceSpec {
  ...
  @jakarta.annotation.Nullable
  private List<V1alpha3CounterSet> sharedCounters = new ArrayList<>();

  public V1alpha3ResourceSliceSpec() {
  }

  public V1alpha3ResourceSliceSpec allNodes(@jakarta.annotation.Nullable Boolean allNodes) {
  ...
  public V1alpha3ResourceSliceSpec devices(@jakarta.annotation.Nullable List<V1alpha3Device> devices) {
  ...
  public void setDevices(@jakarta.annotation.Nullable List<V1alpha3Device> devices) {
    this.devices = devices;
  }


  public V1alpha3ResourceSliceSpec driver(@jakarta.annotation.Nonnull String driver) {
    this.driver = driver;
    return this;
  }
  ...
  public V1alpha3ResourceSliceSpec nodeName(@jakarta.annotation.Nullable String nodeName) {
  ...
  public V1alpha3ResourceSliceSpec nodeSelector(@jakarta.annotation.Nullable V1NodeSelector nodeSelector) {
  ...
  public V1alpha3ResourceSliceSpec perDeviceNodeSelection(@jakarta.annotation.Nullable Boolean perDeviceNodeSelection) {
  ...
  public V1alpha3ResourceSliceSpec pool(@jakarta.annotation.Nonnull V1alpha3ResourcePool pool) {
    this.pool = pool;
    return this;
  }
  ...
  public void setPool(@jakarta.annotation.Nonnull V1alpha3ResourcePool pool) {
    this.pool = pool;
  }


  public V1alpha3ResourceSliceSpec sharedCounters(@jakarta.annotation.Nullable List<V1alpha3CounterSet> sharedCounters) {
  ...
  public void setSharedCounters(@jakarta.annotation.Nullable List<V1alpha3CounterSet> sharedCounters) {
    this.sharedCounters = sharedCounters;
  }
      ...
      if (jsonObj.get("sharedCounters") != null && !jsonObj.get("sharedCounters").isJsonNull()) {
        ...
        if (jsonArraysharedCounters != null) {
          ...
          for (int i = 0; i < jsonArraysharedCounters.size(); i++) {
            V1alpha3CounterSet.validateJsonElement(jsonArraysharedCounters.get(i));
          };
        }
      }
  }
