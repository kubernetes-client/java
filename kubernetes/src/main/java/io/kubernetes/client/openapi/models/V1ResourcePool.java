...
public class V1ResourcePool {
  ...
  public V1ResourcePool() {
  }

  public V1ResourcePool generation(@jakarta.annotation.Nonnull Long generation) {
  ...
  public V1ResourcePool name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1ResourcePool resourceSliceCount(@jakarta.annotation.Nonnull Long resourceSliceCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.generation, v1ResourcePool.generation) &&
        Objects.equals(this.name, v1ResourcePool.name) &&
        Objects.equals(this.resourceSliceCount, v1ResourcePool.resourceSliceCount);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("generation", "name", "resourceSliceCount"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("generation", "name", "resourceSliceCount"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ResourcePool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ResourcePool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ResourcePool is not found in the empty JSON string", V1ResourcePool.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ResourcePool.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ResourcePool` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1ResourcePool.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1ResourcePool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1ResourcePool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1ResourcePool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1ResourcePool.class));

       return (TypeAdapter<T>) new TypeAdapter<V1ResourcePool>() {
           @Override
           public void write(JsonWriter out, V1ResourcePool value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1ResourcePool read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1ResourcePool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1ResourcePool
   * @throws IOException if the JSON string is invalid with respect to V1ResourcePool
   */
  public static V1ResourcePool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1ResourcePool.class);
  }

  /**
   * Convert an instance of V1ResourcePool to an JSON string
   *
   * @return JSON string
   */
