...
public class V1CSIDriver implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1CSIDriver apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1CSIDriver kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1CSIDriver metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1CSIDriver spec(@jakarta.annotation.Nonnull V1CSIDriverSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nonnull V1CSIDriverSpec spec) {
    this.spec = spec;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1CSIDriver.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1CSIDriver is not found in the empty JSON string", V1CSIDriver.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1CSIDriver.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1CSIDriver` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
