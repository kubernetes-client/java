...
public class V1ScaleStatus {
  ...
  public V1ScaleStatus replicas(@jakarta.annotation.Nonnull Integer replicas) {
  ...
  public V1ScaleStatus selector(@jakarta.annotation.Nullable String selector) {
  ...
  public void setSelector(@jakarta.annotation.Nullable String selector) {
    this.selector = selector;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("replicas", "selector"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("replicas"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ScaleStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ScaleStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ScaleStatus is not found in the empty JSON string", V1ScaleStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ScaleStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ScaleStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
