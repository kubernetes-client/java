...
import io.kubernetes.client.openapi.models.V1beta2NetworkDeviceData;
...
public class V1beta2AllocatedDeviceStatus {
  ...
  @jakarta.annotation.Nullable
  private V1beta2NetworkDeviceData networkData;
  ...
  public V1beta2AllocatedDeviceStatus conditions(@jakarta.annotation.Nullable List<V1Condition> conditions) {
  ...
  public V1beta2AllocatedDeviceStatus data(@jakarta.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public V1beta2AllocatedDeviceStatus device(@jakarta.annotation.Nonnull String device) {
    this.device = device;
    return this;
  }
  ...
  public V1beta2AllocatedDeviceStatus driver(@jakarta.annotation.Nonnull String driver) {
    this.driver = driver;
    return this;
  }
  ...
  public V1beta2AllocatedDeviceStatus networkData(@jakarta.annotation.Nullable V1beta2NetworkDeviceData networkData) {
  ...
  public void setNetworkData(@jakarta.annotation.Nullable V1beta2NetworkDeviceData networkData) {
    this.networkData = networkData;
  }


  public V1beta2AllocatedDeviceStatus pool(@jakarta.annotation.Nonnull String pool) {
    this.pool = pool;
    return this;
  }
  ...
  public V1beta2AllocatedDeviceStatus shareID(@jakarta.annotation.Nullable String shareID) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2AllocatedDeviceStatus v1beta2AllocatedDeviceStatus = (V1beta2AllocatedDeviceStatus) o;
    return Objects.equals(this.conditions, v1beta2AllocatedDeviceStatus.conditions) &&
        Objects.equals(this.data, v1beta2AllocatedDeviceStatus.data) &&
  ...
  public String toString() {
    ...
    sb.append("class V1beta2AllocatedDeviceStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta2AllocatedDeviceStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta2AllocatedDeviceStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta2AllocatedDeviceStatus is not found in the empty JSON string", V1beta2AllocatedDeviceStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta2AllocatedDeviceStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta2AllocatedDeviceStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta2AllocatedDeviceStatus.openapiRequiredFields) {
      ...
      if (jsonObj.get("networkData") != null && !jsonObj.get("networkData").isJsonNull()) {
        V1beta2NetworkDeviceData.validateJsonElement(jsonObj.get("networkData"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta2AllocatedDeviceStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta2AllocatedDeviceStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta2AllocatedDeviceStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta2AllocatedDeviceStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta2AllocatedDeviceStatus>() {
           @Override
           public void write(JsonWriter out, V1beta2AllocatedDeviceStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta2AllocatedDeviceStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta2AllocatedDeviceStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta2AllocatedDeviceStatus
   * @throws IOException if the JSON string is invalid with respect to V1beta2AllocatedDeviceStatus
   */
  public static V1beta2AllocatedDeviceStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta2AllocatedDeviceStatus.class);
  }

  /**
   * Convert an instance of V1beta2AllocatedDeviceStatus to an JSON string
   *
   * @return JSON string
   */
