...
public class V1CSIStorageCapacityList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  public V1CSIStorageCapacityList apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1CSIStorageCapacityList items(@jakarta.annotation.Nonnull List<V1CSIStorageCapacity> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@jakarta.annotation.Nonnull List<V1CSIStorageCapacity> items) {
    this.items = items;
  }


  public V1CSIStorageCapacityList kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1CSIStorageCapacityList metadata(@jakarta.annotation.Nullable V1ListMeta metadata) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1CSIStorageCapacityList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1CSIStorageCapacityList is not found in the empty JSON string", V1CSIStorageCapacityList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1CSIStorageCapacityList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1CSIStorageCapacityList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
