...
public class V1beta2DeviceClassSpec {
  ...
  public V1beta2DeviceClassSpec extendedResourceName(@jakarta.annotation.Nullable String extendedResourceName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta2DeviceClassSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta2DeviceClassSpec is not found in the empty JSON string", V1beta2DeviceClassSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta2DeviceClassSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta2DeviceClassSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("extendedResourceName") != null && !jsonObj.get("extendedResourceName").isJsonNull()) && !jsonObj.get("extendedResourceName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `extendedResourceName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("extendedResourceName").toString()));
      }
