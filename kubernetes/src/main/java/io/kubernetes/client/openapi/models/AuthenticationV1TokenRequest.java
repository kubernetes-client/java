...
public class AuthenticationV1TokenRequest implements io.kubernetes.client.common.KubernetesObject {
  ...
  public AuthenticationV1TokenRequest apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public AuthenticationV1TokenRequest kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public AuthenticationV1TokenRequest metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public AuthenticationV1TokenRequest status(@jakarta.annotation.Nullable V1TokenRequestStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V1TokenRequestStatus status) {
    this.status = status;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationV1TokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AuthenticationV1TokenRequest is not found in the empty JSON string", AuthenticationV1TokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationV1TokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthenticationV1TokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
