...
public class V1alpha3DeviceToleration {
  ...
  public V1alpha3DeviceToleration effect(@jakarta.annotation.Nullable String effect) {
    this.effect = effect;
    return this;
  }
  ...
  public V1alpha3DeviceToleration key(@jakarta.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public V1alpha3DeviceToleration operator(@jakarta.annotation.Nullable String operator) {
  ...
  public V1alpha3DeviceToleration tolerationSeconds(@jakarta.annotation.Nullable Long tolerationSeconds) {
  ...
  public V1alpha3DeviceToleration value(@jakarta.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3DeviceToleration v1alpha3DeviceToleration = (V1alpha3DeviceToleration) o;
    return Objects.equals(this.effect, v1alpha3DeviceToleration.effect) &&
        Objects.equals(this.key, v1alpha3DeviceToleration.key) &&
        Objects.equals(this.operator, v1alpha3DeviceToleration.operator) &&
        Objects.equals(this.tolerationSeconds, v1alpha3DeviceToleration.tolerationSeconds) &&
        Objects.equals(this.value, v1alpha3DeviceToleration.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha3DeviceToleration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1alpha3DeviceToleration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha3DeviceToleration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha3DeviceToleration is not found in the empty JSON string", V1alpha3DeviceToleration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha3DeviceToleration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha3DeviceToleration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha3DeviceToleration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha3DeviceToleration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha3DeviceToleration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha3DeviceToleration.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha3DeviceToleration>() {
           @Override
           public void write(JsonWriter out, V1alpha3DeviceToleration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha3DeviceToleration read(JsonReader in) throws IOException {
   ...
   * @return An instance of V1alpha3DeviceToleration
   * @throws IOException if the JSON string is invalid with respect to V1alpha3DeviceToleration
   */
  public static V1alpha3DeviceToleration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1alpha3DeviceToleration.class);
  }
