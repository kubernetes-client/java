...
public class V1alpha3DeviceToleration {
  ...
  public V1alpha3DeviceToleration effect(String effect) {
  ...
  **/
  ...
  public V1alpha3DeviceToleration key(String key) {
  ...
  **/
  ...
  public V1alpha3DeviceToleration operator(String operator) {
  ...
  **/
  ...
  public V1alpha3DeviceToleration tolerationSeconds(Long tolerationSeconds) {
  ...
  **/
  ...
  public V1alpha3DeviceToleration value(String value) {
