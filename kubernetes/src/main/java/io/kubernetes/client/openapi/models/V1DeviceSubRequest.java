...
public class V1DeviceSubRequest {
  ...
  public V1DeviceSubRequest allocationMode(String allocationMode) {
  ...
  **/
  ...
  public V1DeviceSubRequest capacity(V1CapacityRequirements capacity) {
  ...
  **/
  ...
  public V1DeviceSubRequest count(Long count) {
  ...
  **/
  ...
  public V1DeviceSubRequest deviceClassName(String deviceClassName) {
  ...
  **/
  ...
  public V1DeviceSubRequest name(String name) {
  ...
  **/
  ...
  public V1DeviceSubRequest selectors(List<V1DeviceSelector> selectors) {
  ...
  **/
  ...
  public V1DeviceSubRequest tolerations(List<V1DeviceToleration> tolerations) {
