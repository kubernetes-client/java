...
public class V1beta3NonResourcePolicyRule {
  ...
  * @throws IOException if the JSON Element is invalid with respect to V1beta3NonResourcePolicyRule
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta3NonResourcePolicyRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta3NonResourcePolicyRule is not found in the empty JSON string", V1beta3NonResourcePolicyRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta3NonResourcePolicyRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta3NonResourcePolicyRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta3NonResourcePolicyRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta3NonResourcePolicyRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta3NonResourcePolicyRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta3NonResourcePolicyRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta3NonResourcePolicyRule.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta3NonResourcePolicyRule>() {
           @Override
           public void write(JsonWriter out, V1beta3NonResourcePolicyRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta3NonResourcePolicyRule read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta3NonResourcePolicyRule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta3NonResourcePolicyRule
  * @throws IOException if the JSON string is invalid with respect to V1beta3NonResourcePolicyRule
  */
  public static V1beta3NonResourcePolicyRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta3NonResourcePolicyRule.class);
  }

 /**
  * Convert an instance of V1beta3NonResourcePolicyRule to an JSON string
  *
  * @return JSON string
  */
