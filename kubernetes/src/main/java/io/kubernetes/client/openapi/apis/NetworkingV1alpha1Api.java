...
public class NetworkingV1alpha1Api {
   ...
   * </table>
   */
  public okhttp3.Call createClusterCIDRCall(
  ...
  private okhttp3.Call createClusterCIDRValidateBeforeCall(
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
      String fieldManager,
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createClusterCIDR(Async)");
    }

    okhttp3.Call localVarCall =
        createClusterCIDRCall(body, pretty, dryRun, fieldManager, fieldValidation, _callback);
    return localVarCall;
  }
   ...
   * </table>
   */
  public V1alpha1ClusterCIDR createClusterCIDR(
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
      String fieldManager,
      String fieldValidation)
      throws ApiException {
    ApiResponse<V1alpha1ClusterCIDR> localVarResp =
        createClusterCIDRWithHttpInfo(body, pretty, dryRun, fieldManager, fieldValidation);
   ...
   * </table>
   */
  public ApiResponse<V1alpha1ClusterCIDR> createClusterCIDRWithHttpInfo(
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
      String fieldManager,
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        createClusterCIDRValidateBeforeCall(
  ...
  /**
   * (asynchronously) create a ClusterCIDR
   *
   * @param body (required)
   * @param pretty If &#39;true&#39;, then the output is pretty printed. (optional)
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or
   ...
   * </table>
   */
  public okhttp3.Call createClusterCIDRAsync(
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
      String fieldManager,
      String fieldValidation,
      final ApiCallback<V1alpha1ClusterCIDR> _callback)
      throws ApiException {
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call deleteClusterCIDRValidateBeforeCall(
      String name,
      String pretty,
      String dryRun,
      Integer gracePeriodSeconds,
    ...
    if (name == null) {
      throw new ApiException(
          "Missing the required parameter 'name' when calling deleteClusterCIDR(Async)");
    }

    okhttp3.Call localVarCall =
        deleteClusterCIDRCall(
            name,
            pretty,
            dryRun,
            gracePeriodSeconds,
   ...
   * </table>
   */
  public V1Status deleteClusterCIDR(
      String name,
      String pretty,
      String dryRun,
      Integer gracePeriodSeconds,
   ...
   * </table>
   */
  public ApiResponse<V1Status> deleteClusterCIDRWithHttpInfo(
      String name,
      String pretty,
      String dryRun,
      Integer gracePeriodSeconds,
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        deleteClusterCIDRValidateBeforeCall(
            name,
            pretty,
            dryRun,
            gracePeriodSeconds,
  ...
  /**
   * (asynchronously) delete a ClusterCIDR
   *
   * @param name name of the ClusterCIDR (required)
   * @param pretty If &#39;true&#39;, then the output is pretty printed. (optional)
   * @param dryRun When present, indicates that modifications should not be persisted. An invalid or
   ...
   * </table>
   */
  public okhttp3.Call deleteClusterCIDRAsync(
      String name,
      String pretty,
      String dryRun,
      Integer gracePeriodSeconds,
   ...
   * </table>
   */
  public okhttp3.Call deleteCollectionClusterCIDRCall(
      String pretty,
      String _continue,
      String dryRun,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call deleteCollectionClusterCIDRValidateBeforeCall(
      String pretty,
      String _continue,
      String dryRun,
      String fieldSelector,
    ...
    okhttp3.Call localVarCall =
        deleteCollectionClusterCIDRCall(
            pretty,
            _continue,
            dryRun,
            fieldSelector,
   ...
   * </table>
   */
  public V1Status deleteCollectionClusterCIDR(
      String pretty,
      String _continue,
      String dryRun,
      String fieldSelector,
   ...
   * </table>
   */
  public ApiResponse<V1Status> deleteCollectionClusterCIDRWithHttpInfo(
      String pretty,
      String _continue,
      String dryRun,
      String fieldSelector,
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        deleteCollectionClusterCIDRValidateBeforeCall(
            pretty,
            _continue,
            dryRun,
            fieldSelector,
  ...
  /**
   * (asynchronously) delete collection of ClusterCIDR
   *
   * @param pretty If &#39;true&#39;, then the output is pretty printed. (optional)
   * @param _continue The continue option should be set when retrieving more results from the
   *     server. Since this value is server defined, clients may only use the continue value from a
   ...
   * </table>
   */
  public okhttp3.Call listClusterCIDRCall(
      String pretty,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call listClusterCIDRValidateBeforeCall(
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
   ...
   * </table>
   */
  public V1alpha1ClusterCIDRList listClusterCIDR(
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
      ...
      Boolean watch)
      throws ApiException {
    ApiResponse<V1alpha1ClusterCIDRList> localVarResp =
        listClusterCIDRWithHttpInfo(
            pretty,
            allowWatchBookmarks,
            _continue,
            fieldSelector,
   ...
   * </table>
   */
  public ApiResponse<V1alpha1ClusterCIDRList> listClusterCIDRWithHttpInfo(
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        listClusterCIDRValidateBeforeCall(
            pretty,
            allowWatchBookmarks,
            _continue,
            fieldSelector,
  ...
  /**
   * (asynchronously) list or watch objects of kind ClusterCIDR
   *
   * @param pretty If &#39;true&#39;, then the output is pretty printed. (optional)
   * @param allowWatchBookmarks allowWatchBookmarks requests watch events with type
   *     \&quot;BOOKMARK\&quot;. Servers that do not implement bookmarks may ignore this flag and
  ...
  public okhttp3.Call listClusterCIDRAsync(
      ...
      Integer timeoutSeconds,
      Boolean watch,
      final ApiCallback<V1alpha1ClusterCIDRList> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call patchClusterCIDRCall(
      String name,
      V1Patch body,
      String pretty,
      String dryRun,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call patchClusterCIDRValidateBeforeCall(
      String name,
      V1Patch body,
      String pretty,
      String dryRun,
    ...
    if (name == null) {
      throw new ApiException(
          "Missing the required parameter 'name' when calling patchClusterCIDR(Async)");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling patchClusterCIDR(Async)");
    }

    okhttp3.Call localVarCall =
        patchClusterCIDRCall(
   ...
   * </table>
   */
  public V1alpha1ClusterCIDR patchClusterCIDR(
      String name,
      V1Patch body,
      String pretty,
      String dryRun,
   ...
   * </table>
   */
  public ApiResponse<V1alpha1ClusterCIDR> patchClusterCIDRWithHttpInfo(
      String name,
      V1Patch body,
      String pretty,
      String dryRun,
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        patchClusterCIDRValidateBeforeCall(
   ...
   * </table>
   */
  public okhttp3.Call patchClusterCIDRAsync(
      String name,
      V1Patch body,
      String pretty,
      String dryRun,
   ...
   * </table>
   */
  public okhttp3.Call readClusterCIDRCall(String name, String pretty, final ApiCallback _callback)
      throws ApiException {
    Object localVarPostBody = null;
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call readClusterCIDRValidateBeforeCall(
      String name, String pretty, final ApiCallback _callback) throws ApiException {

    // verify the required parameter 'name' is set
    if (name == null) {
      throw new ApiException(
          "Missing the required parameter 'name' when calling readClusterCIDR(Async)");
    }
   ...
   * </table>
   */
  public ApiResponse<V1alpha1ClusterCIDR> readClusterCIDRWithHttpInfo(String name, String pretty)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call readClusterCIDRAsync(
      String name, String pretty, final ApiCallback<V1alpha1ClusterCIDR> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call replaceClusterCIDRCall(
      String name,
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call replaceClusterCIDRValidateBeforeCall(
      String name,
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
    ...
    if (name == null) {
      throw new ApiException(
          "Missing the required parameter 'name' when calling replaceClusterCIDR(Async)");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling replaceClusterCIDR(Async)");
    }

    okhttp3.Call localVarCall =
        replaceClusterCIDRCall(
   ...
   * </table>
   */
  public V1alpha1ClusterCIDR replaceClusterCIDR(
      String name,
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
      ...
      throws ApiException {
    ApiResponse<V1alpha1ClusterCIDR> localVarResp =
        replaceClusterCIDRWithHttpInfo(name, body, pretty, dryRun, fieldManager, fieldValidation);
    return localVarResp.getData();
  }
   ...
   * </table>
   */
  public ApiResponse<V1alpha1ClusterCIDR> replaceClusterCIDRWithHttpInfo(
      String name,
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        replaceClusterCIDRValidateBeforeCall(
   ...
   * </table>
   */
  public okhttp3.Call replaceClusterCIDRAsync(
      String name,
      V1alpha1ClusterCIDR body,
      String pretty,
      String dryRun,
