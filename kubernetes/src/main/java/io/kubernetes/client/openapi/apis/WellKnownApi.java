...
public class WellKnownApi {
   ...
   * </table>
   */
  public okhttp3.Call getServiceAccountIssuerOpenIDConfigurationCall(final ApiCallback _callback)
      throws ApiException {
  ...
  private okhttp3.Call getServiceAccountIssuerOpenIDConfigurationValidateBeforeCall(
   ...
   * </table>
   */
  public ApiResponse<String> getServiceAccountIssuerOpenIDConfigurationWithHttpInfo()
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getServiceAccountIssuerOpenIDConfigurationAsync(
      final ApiCallback<String> _callback) throws ApiException {

    okhttp3.Call localVarCall =
        getServiceAccountIssuerOpenIDConfigurationValidateBeforeCall(_callback);
    Type localVarReturnType = new TypeToken<String>() {}.getType();
