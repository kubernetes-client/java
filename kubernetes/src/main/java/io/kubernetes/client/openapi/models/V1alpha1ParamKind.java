...
public class V1alpha1ParamKind {
  ...
  public V1alpha1ParamKind apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1alpha1ParamKind kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1alpha1ParamKind
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1ParamKind.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1alpha1ParamKind is not found in the empty JSON string", V1alpha1ParamKind.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1ParamKind.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha1ParamKind` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
