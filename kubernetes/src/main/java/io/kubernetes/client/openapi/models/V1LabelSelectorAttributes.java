...
public class V1LabelSelectorAttributes {
  ...
  public V1LabelSelectorAttributes rawSelector(@jakarta.annotation.Nullable String rawSelector) {
  ...
  public V1LabelSelectorAttributes requirements(@jakarta.annotation.Nullable List<V1LabelSelectorRequirement> requirements) {
  ...
  public void setRequirements(@jakarta.annotation.Nullable List<V1LabelSelectorRequirement> requirements) {
    this.requirements = requirements;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("rawSelector", "requirements"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1LabelSelectorAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1LabelSelectorAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1LabelSelectorAttributes is not found in the empty JSON string", V1LabelSelectorAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1LabelSelectorAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1LabelSelectorAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("rawSelector") != null && !jsonObj.get("rawSelector").isJsonNull()) && !jsonObj.get("rawSelector").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `rawSelector` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rawSelector").toString()));
      }
      if (jsonObj.get("requirements") != null && !jsonObj.get("requirements").isJsonNull()) {
        ...
        if (jsonArrayrequirements != null) {
          ...
          if (!jsonObj.get("requirements").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `requirements` to be an array in the JSON string but got `%s`", jsonObj.get("requirements").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1LabelSelectorAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1LabelSelectorAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1LabelSelectorAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1LabelSelectorAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<V1LabelSelectorAttributes>() {
           @Override
  ...
  /**
   * Create an instance of V1LabelSelectorAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1LabelSelectorAttributes
   * @throws IOException if the JSON string is invalid with respect to V1LabelSelectorAttributes
   */
  public static V1LabelSelectorAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1LabelSelectorAttributes.class);
  }

  /**
   * Convert an instance of V1LabelSelectorAttributes to an JSON string
   *
   * @return JSON string
   */
