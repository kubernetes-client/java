 ...
 */
@ApiModel(description = "NamedResourcesAttribute is a combination of an attribute name and its value.")
...
public class V1alpha2NamedResourcesAttribute {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "IntValue is a 64-bit integer.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "StringValue is a string.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "VersionValue is a semantic version according to semver.org spec 2.0.0.")
