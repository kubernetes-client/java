...
public class V1NodeCondition {
  ...
  public V1NodeCondition lastHeartbeatTime(@jakarta.annotation.Nullable OffsetDateTime lastHeartbeatTime) {
  ...
  public void setLastHeartbeatTime(@jakarta.annotation.Nullable OffsetDateTime lastHeartbeatTime) {
    this.lastHeartbeatTime = lastHeartbeatTime;
  }
  ...
  public V1NodeCondition message(@jakarta.annotation.Nullable String message) {
  ...
  public V1NodeCondition reason(@jakarta.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public V1NodeCondition status(@jakarta.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public V1NodeCondition type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lastHeartbeatTime", "lastTransitionTime", "message", "reason", "status", "type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1NodeCondition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1NodeCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1NodeCondition is not found in the empty JSON string", V1NodeCondition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1NodeCondition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1NodeCondition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
