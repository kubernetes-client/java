...
public class V1beta2DeviceTaint {
  ...
  public V1beta2DeviceTaint effect(@jakarta.annotation.Nonnull String effect) {
    this.effect = effect;
    return this;
  }
  ...
  public V1beta2DeviceTaint key(@jakarta.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public V1beta2DeviceTaint timeAdded(@jakarta.annotation.Nullable OffsetDateTime timeAdded) {
  ...
  public V1beta2DeviceTaint value(@jakarta.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta2DeviceTaint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta2DeviceTaint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta2DeviceTaint is not found in the empty JSON string", V1beta2DeviceTaint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta2DeviceTaint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta2DeviceTaint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta2DeviceTaint.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta2DeviceTaint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta2DeviceTaint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta2DeviceTaint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta2DeviceTaint.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta2DeviceTaint>() {
           @Override
  ...
  /**
   * Create an instance of V1beta2DeviceTaint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta2DeviceTaint
   * @throws IOException if the JSON string is invalid with respect to V1beta2DeviceTaint
   */
  public static V1beta2DeviceTaint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta2DeviceTaint.class);
  }

  /**
   * Convert an instance of V1beta2DeviceTaint to an JSON string
   *
   * @return JSON string
   */
