...
public class V1alpha3DeviceClaim {
  ...
  public V1alpha3DeviceClaim config(@jakarta.annotation.Nullable List<V1alpha3DeviceClaimConfiguration> config) {
    this.config = config;
    return this;
  }
  ...
  public void setConfig(@jakarta.annotation.Nullable List<V1alpha3DeviceClaimConfiguration> config) {
    this.config = config;
  }


  public V1alpha3DeviceClaim constraints(@jakarta.annotation.Nullable List<V1alpha3DeviceConstraint> constraints) {
  ...
  public void setConstraints(@jakarta.annotation.Nullable List<V1alpha3DeviceConstraint> constraints) {
    this.constraints = constraints;
  }


  public V1alpha3DeviceClaim requests(@jakarta.annotation.Nullable List<V1alpha3DeviceRequest> requests) {
  ...
  public void setRequests(@jakarta.annotation.Nullable List<V1alpha3DeviceRequest> requests) {
    this.requests = requests;
  }
