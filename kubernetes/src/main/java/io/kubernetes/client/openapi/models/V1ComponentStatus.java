...
public class V1ComponentStatus implements io.kubernetes.client.common.KubernetesObject {
  ...
  @jakarta.annotation.Nullable
  private List<V1ComponentCondition> conditions = new ArrayList<>();
  ...
  public V1ComponentStatus apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1ComponentStatus conditions(@jakarta.annotation.Nullable List<V1ComponentCondition> conditions) {
  ...
  public void setConditions(@jakarta.annotation.Nullable List<V1ComponentCondition> conditions) {
    this.conditions = conditions;
  }


  public V1ComponentStatus kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1ComponentStatus metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("apiVersion", "conditions", "kind", "metadata"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ComponentStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ComponentStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ComponentStatus is not found in the empty JSON string", V1ComponentStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ComponentStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ComponentStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonNull()) {
        ...
        if (jsonArrayconditions != null) {
          ...
          for (int i = 0; i < jsonArrayconditions.size(); i++) {
            V1ComponentCondition.validateJsonElement(jsonArrayconditions.get(i));
          };
        }
      }
