...
public class V1PodDisruptionBudget implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1PodDisruptionBudget apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1PodDisruptionBudget kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1PodDisruptionBudget metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1PodDisruptionBudget spec(@jakarta.annotation.Nullable V1PodDisruptionBudgetSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1PodDisruptionBudgetSpec spec) {
    this.spec = spec;
  }


  public V1PodDisruptionBudget status(@jakarta.annotation.Nullable V1PodDisruptionBudgetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V1PodDisruptionBudgetStatus status) {
    this.status = status;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1PodDisruptionBudget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1PodDisruptionBudget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1PodDisruptionBudget is not found in the empty JSON string", V1PodDisruptionBudget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1PodDisruptionBudget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1PodDisruptionBudget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        V1PodDisruptionBudgetSpec.validateJsonElement(jsonObj.get("spec"));
      }
      // validate the optional field `status`
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        V1PodDisruptionBudgetStatus.validateJsonElement(jsonObj.get("status"));
      }
  }
