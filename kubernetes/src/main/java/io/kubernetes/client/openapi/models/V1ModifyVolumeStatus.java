...
public class V1ModifyVolumeStatus {
  ...
  public V1ModifyVolumeStatus status(@jakarta.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public V1ModifyVolumeStatus targetVolumeAttributesClassName(@jakarta.annotation.Nullable String targetVolumeAttributesClassName) {
  ...
  public void setTargetVolumeAttributesClassName(@jakarta.annotation.Nullable String targetVolumeAttributesClassName) {
    this.targetVolumeAttributesClassName = targetVolumeAttributesClassName;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "targetVolumeAttributesClassName"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ModifyVolumeStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ModifyVolumeStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ModifyVolumeStatus is not found in the empty JSON string", V1ModifyVolumeStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ModifyVolumeStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ModifyVolumeStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("targetVolumeAttributesClassName") != null && !jsonObj.get("targetVolumeAttributesClassName").isJsonNull()) && !jsonObj.get("targetVolumeAttributesClassName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `targetVolumeAttributesClassName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetVolumeAttributesClassName").toString()));
      }
  }
