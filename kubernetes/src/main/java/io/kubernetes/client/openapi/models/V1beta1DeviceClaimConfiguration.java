...
public class V1beta1DeviceClaimConfiguration {
  ...
  public V1beta1DeviceClaimConfiguration opaque(@jakarta.annotation.Nullable V1beta1OpaqueDeviceConfiguration opaque) {
    this.opaque = opaque;
    return this;
  }
  ...
  public V1beta1DeviceClaimConfiguration requests(@jakarta.annotation.Nullable List<String> requests) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1DeviceClaimConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1beta1DeviceClaimConfiguration is not found in the empty JSON string", V1beta1DeviceClaimConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1DeviceClaimConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1DeviceClaimConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
