...
public class V1LinuxContainerUser {
  ...
  public V1LinuxContainerUser gid(@jakarta.annotation.Nonnull Long gid) {
    this.gid = gid;
    return this;
  }
  ...
  public void setGid(@jakarta.annotation.Nonnull Long gid) {
    this.gid = gid;
  }


  public V1LinuxContainerUser supplementalGroups(@jakarta.annotation.Nullable List<Long> supplementalGroups) {
  ...
  public V1LinuxContainerUser uid(@jakarta.annotation.Nonnull Long uid) {
    this.uid = uid;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1LinuxContainerUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1LinuxContainerUser is not found in the empty JSON string", V1LinuxContainerUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1LinuxContainerUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1LinuxContainerUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
