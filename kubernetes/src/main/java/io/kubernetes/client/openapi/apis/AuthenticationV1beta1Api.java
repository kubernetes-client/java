...
public class AuthenticationV1beta1Api {
    ...
    private ApiResponse<V1beta1SelfSubjectReview> createSelfSubjectReviewWithHttpInfo(V1beta1SelfSubjectReview body, String dryRun, String fieldManager, String fieldValidation, String pretty) throws ApiException {
    ...
    private okhttp3.Call createSelfSubjectReviewAsync(V1beta1SelfSubjectReview body, String dryRun, String fieldManager, String fieldValidation, String pretty, final ApiCallback<V1beta1SelfSubjectReview> _callback) throws ApiException {
    ...
    public class APIcreateSelfSubjectReviewRequest {
         ...
         */
        public ApiResponse<V1beta1SelfSubjectReview> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<V1beta1SelfSubjectReview> _callback) throws ApiException {
