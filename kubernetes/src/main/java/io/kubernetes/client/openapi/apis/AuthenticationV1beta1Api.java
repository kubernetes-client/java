...
public class AuthenticationV1beta1Api {
     ...
     */
    public okhttp3.Call createSelfSubjectReviewCall(V1beta1SelfSubjectReview body, String dryRun, String fieldManager, String fieldValidation, String pretty, final ApiCallback _callback) throws ApiException {
     ...
     */
    public V1beta1SelfSubjectReview createSelfSubjectReview(V1beta1SelfSubjectReview body, String dryRun, String fieldManager, String fieldValidation, String pretty) throws ApiException {
        ApiResponse<V1beta1SelfSubjectReview> localVarResp = createSelfSubjectReviewWithHttpInfo(body, dryRun, fieldManager, fieldValidation, pretty);
     ...
     */
    public ApiResponse<V1beta1SelfSubjectReview> createSelfSubjectReviewWithHttpInfo(V1beta1SelfSubjectReview body, String dryRun, String fieldManager, String fieldValidation, String pretty) throws ApiException {
        okhttp3.Call localVarCall = createSelfSubjectReviewValidateBeforeCall(body, dryRun, fieldManager, fieldValidation, pretty, null);
        Type localVarReturnType = new TypeToken<V1beta1SelfSubjectReview>(){}.getType();
     ...
     */
    public okhttp3.Call createSelfSubjectReviewAsync(V1beta1SelfSubjectReview body, String dryRun, String fieldManager, String fieldValidation, String pretty, final ApiCallback<V1beta1SelfSubjectReview> _callback) throws ApiException {
