...
public class V1NetworkPolicyPort {
  ...
  public V1NetworkPolicyPort endPort(@jakarta.annotation.Nullable Integer endPort) {
  ...
  public void setEndPort(@jakarta.annotation.Nullable Integer endPort) {
    this.endPort = endPort;
  }


  public V1NetworkPolicyPort port(@jakarta.annotation.Nullable IntOrString port) {
    this.port = port;
    return this;
  }
  ...
  public void setPort(@jakarta.annotation.Nullable IntOrString port) {
    this.port = port;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("endPort", "port", "protocol"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1NetworkPolicyPort
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1NetworkPolicyPort.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1NetworkPolicyPort is not found in the empty JSON string", V1NetworkPolicyPort.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1NetworkPolicyPort.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1NetworkPolicyPort` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
