...
public class V1beta1CapacityRequestPolicy {
  ...
  public V1beta1CapacityRequestPolicy _default(Quantity _default) {
  ...
  **/
  ...
  public V1beta1CapacityRequestPolicy validRange(V1beta1CapacityRequestPolicyRange validRange) {
  ...
  **/
  ...
  public void setValidRange(V1beta1CapacityRequestPolicyRange validRange) {
    this.validRange = validRange;
  }


  public V1beta1CapacityRequestPolicy validValues(List<Quantity> validValues) {
