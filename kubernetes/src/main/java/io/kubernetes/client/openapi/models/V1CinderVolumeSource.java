...
public class V1CinderVolumeSource {
  ...
  public V1CinderVolumeSource fsType(@jakarta.annotation.Nullable String fsType) {
    this.fsType = fsType;
    return this;
  }
  ...
  public V1CinderVolumeSource readOnly(@jakarta.annotation.Nullable Boolean readOnly) {
  ...
  public V1CinderVolumeSource secretRef(@jakarta.annotation.Nullable V1LocalObjectReference secretRef) {
  ...
  public V1CinderVolumeSource volumeID(@jakarta.annotation.Nonnull String volumeID) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fsType", "readOnly", "secretRef", "volumeID"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1CinderVolumeSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1CinderVolumeSource is not found in the empty JSON string", V1CinderVolumeSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1CinderVolumeSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1CinderVolumeSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("volumeID").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `volumeID` to be a primitive type in the JSON string but got `%s`", jsonObj.get("volumeID").toString()));
      }
  }
