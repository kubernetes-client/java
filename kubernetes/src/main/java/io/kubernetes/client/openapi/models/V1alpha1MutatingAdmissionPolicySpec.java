...
public class V1alpha1MutatingAdmissionPolicySpec {
  ...
  public V1alpha1MutatingAdmissionPolicySpec failurePolicy(@jakarta.annotation.Nullable String failurePolicy) {
  ...
  public V1alpha1MutatingAdmissionPolicySpec matchConditions(@jakarta.annotation.Nullable List<V1alpha1MatchCondition> matchConditions) {
  ...
  public void setMatchConditions(@jakarta.annotation.Nullable List<V1alpha1MatchCondition> matchConditions) {
    this.matchConditions = matchConditions;
  }


  public V1alpha1MutatingAdmissionPolicySpec matchConstraints(@jakarta.annotation.Nullable V1alpha1MatchResources matchConstraints) {
  ...
  public void setMatchConstraints(@jakarta.annotation.Nullable V1alpha1MatchResources matchConstraints) {
    this.matchConstraints = matchConstraints;
  }


  public V1alpha1MutatingAdmissionPolicySpec mutations(@jakarta.annotation.Nullable List<V1alpha1Mutation> mutations) {
  ...
  public void setMutations(@jakarta.annotation.Nullable List<V1alpha1Mutation> mutations) {
    this.mutations = mutations;
  }


  public V1alpha1MutatingAdmissionPolicySpec paramKind(@jakarta.annotation.Nullable V1alpha1ParamKind paramKind) {
  ...
  public void setParamKind(@jakarta.annotation.Nullable V1alpha1ParamKind paramKind) {
    this.paramKind = paramKind;
  }


  public V1alpha1MutatingAdmissionPolicySpec reinvocationPolicy(@jakarta.annotation.Nullable String reinvocationPolicy) {
  ...
  public V1alpha1MutatingAdmissionPolicySpec variables(@jakarta.annotation.Nullable List<V1alpha1Variable> variables) {
  ...
  public void setVariables(@jakarta.annotation.Nullable List<V1alpha1Variable> variables) {
    this.variables = variables;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1MutatingAdmissionPolicySpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1alpha1MutatingAdmissionPolicySpec is not found in the empty JSON string", V1alpha1MutatingAdmissionPolicySpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1MutatingAdmissionPolicySpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha1MutatingAdmissionPolicySpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
