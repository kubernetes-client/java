...
public class V1beta1ValidatingAdmissionPolicySpec {
  ...
  public V1beta1ValidatingAdmissionPolicySpec auditAnnotations(@jakarta.annotation.Nullable List<V1beta1AuditAnnotation> auditAnnotations) {
  ...
  public void setAuditAnnotations(@jakarta.annotation.Nullable List<V1beta1AuditAnnotation> auditAnnotations) {
    this.auditAnnotations = auditAnnotations;
  }


  public V1beta1ValidatingAdmissionPolicySpec failurePolicy(@jakarta.annotation.Nullable String failurePolicy) {
  ...
  public V1beta1ValidatingAdmissionPolicySpec matchConditions(@jakarta.annotation.Nullable List<V1beta1MatchCondition> matchConditions) {
  ...
  public V1beta1ValidatingAdmissionPolicySpec matchConstraints(@jakarta.annotation.Nullable V1beta1MatchResources matchConstraints) {
  ...
  public V1beta1ValidatingAdmissionPolicySpec paramKind(@jakarta.annotation.Nullable V1beta1ParamKind paramKind) {
  ...
  public V1beta1ValidatingAdmissionPolicySpec validations(@jakarta.annotation.Nullable List<V1beta1Validation> validations) {
  ...
  public void setValidations(@jakarta.annotation.Nullable List<V1beta1Validation> validations) {
    this.validations = validations;
  }


  public V1beta1ValidatingAdmissionPolicySpec variables(@jakarta.annotation.Nullable List<V1beta1Variable> variables) {
