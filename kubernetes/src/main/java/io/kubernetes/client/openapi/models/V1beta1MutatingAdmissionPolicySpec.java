...
public class V1beta1MutatingAdmissionPolicySpec {
  ...
  @jakarta.annotation.Nullable
  private List<V1beta1Mutation> mutations = new ArrayList<>();
  ...
  public V1beta1MutatingAdmissionPolicySpec() {
  }

  public V1beta1MutatingAdmissionPolicySpec failurePolicy(@jakarta.annotation.Nullable String failurePolicy) {
  ...
  public V1beta1MutatingAdmissionPolicySpec matchConditions(@jakarta.annotation.Nullable List<V1beta1MatchCondition> matchConditions) {
  ...
  public void setMatchConditions(@jakarta.annotation.Nullable List<V1beta1MatchCondition> matchConditions) {
    this.matchConditions = matchConditions;
  }


  public V1beta1MutatingAdmissionPolicySpec matchConstraints(@jakarta.annotation.Nullable V1beta1MatchResources matchConstraints) {
  ...
  public void setMatchConstraints(@jakarta.annotation.Nullable V1beta1MatchResources matchConstraints) {
    this.matchConstraints = matchConstraints;
  }


  public V1beta1MutatingAdmissionPolicySpec mutations(@jakarta.annotation.Nullable List<V1beta1Mutation> mutations) {
  ...
  public void setMutations(@jakarta.annotation.Nullable List<V1beta1Mutation> mutations) {
    this.mutations = mutations;
  }


  public V1beta1MutatingAdmissionPolicySpec paramKind(@jakarta.annotation.Nullable V1beta1ParamKind paramKind) {
  ...
  public void setParamKind(@jakarta.annotation.Nullable V1beta1ParamKind paramKind) {
    this.paramKind = paramKind;
  }


  public V1beta1MutatingAdmissionPolicySpec reinvocationPolicy(@jakarta.annotation.Nullable String reinvocationPolicy) {
  ...
  public void setReinvocationPolicy(@jakarta.annotation.Nullable String reinvocationPolicy) {
    this.reinvocationPolicy = reinvocationPolicy;
  }


  public V1beta1MutatingAdmissionPolicySpec variables(@jakarta.annotation.Nullable List<V1beta1Variable> variables) {
  ...
  public void setVariables(@jakarta.annotation.Nullable List<V1beta1Variable> variables) {
    this.variables = variables;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1MutatingAdmissionPolicySpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1MutatingAdmissionPolicySpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1beta1MutatingAdmissionPolicySpec is not found in the empty JSON string", V1beta1MutatingAdmissionPolicySpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1MutatingAdmissionPolicySpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1MutatingAdmissionPolicySpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("failurePolicy") != null && !jsonObj.get("failurePolicy").isJsonNull()) && !jsonObj.get("failurePolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `failurePolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("failurePolicy").toString()));
      }
      if (jsonObj.get("matchConditions") != null && !jsonObj.get("matchConditions").isJsonNull()) {
        ...
        if (jsonArraymatchConditions != null) {
          ...
          if (!jsonObj.get("matchConditions").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `matchConditions` to be an array in the JSON string but got `%s`", jsonObj.get("matchConditions").toString()));
          }
      ...
      if (jsonObj.get("mutations") != null && !jsonObj.get("mutations").isJsonNull()) {
        ...
        if (jsonArraymutations != null) {
          ...
          if (!jsonObj.get("mutations").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `mutations` to be an array in the JSON string but got `%s`", jsonObj.get("mutations").toString()));
          }

          // validate the optional field `mutations` (array)
          for (int i = 0; i < jsonArraymutations.size(); i++) {
            V1beta1Mutation.validateJsonElement(jsonArraymutations.get(i));
          };
        }
      }
      ...
      if ((jsonObj.get("reinvocationPolicy") != null && !jsonObj.get("reinvocationPolicy").isJsonNull()) && !jsonObj.get("reinvocationPolicy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `reinvocationPolicy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reinvocationPolicy").toString()));
      }
      if (jsonObj.get("variables") != null && !jsonObj.get("variables").isJsonNull()) {
        ...
        if (jsonArrayvariables != null) {
          ...
          if (!jsonObj.get("variables").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `variables` to be an array in the JSON string but got `%s`", jsonObj.get("variables").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1MutatingAdmissionPolicySpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1MutatingAdmissionPolicySpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1MutatingAdmissionPolicySpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1MutatingAdmissionPolicySpec.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1MutatingAdmissionPolicySpec>() {
           @Override
           public void write(JsonWriter out, V1beta1MutatingAdmissionPolicySpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1MutatingAdmissionPolicySpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1MutatingAdmissionPolicySpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1MutatingAdmissionPolicySpec
   * @throws IOException if the JSON string is invalid with respect to V1beta1MutatingAdmissionPolicySpec
   */
  public static V1beta1MutatingAdmissionPolicySpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1MutatingAdmissionPolicySpec.class);
  }

  /**
   * Convert an instance of V1beta1MutatingAdmissionPolicySpec to an JSON string
   *
   * @return JSON string
   */
