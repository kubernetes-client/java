...
public class V1beta1NodeAllocatableResourceMapping {
  ...
  public V1beta1NodeAllocatableResourceMapping allocationMultiplier(@jakarta.annotation.Nullable Quantity allocationMultiplier) {
  ...
  public V1beta1NodeAllocatableResourceMapping capacityKey(@jakarta.annotation.Nullable String capacityKey) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1NodeAllocatableResourceMapping v1beta1NodeAllocatableResourceMapping = (V1beta1NodeAllocatableResourceMapping) o;
    return Objects.equals(this.allocationMultiplier, v1beta1NodeAllocatableResourceMapping.allocationMultiplier) &&
        Objects.equals(this.capacityKey, v1beta1NodeAllocatableResourceMapping.capacityKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1NodeAllocatableResourceMapping {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1NodeAllocatableResourceMapping
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1NodeAllocatableResourceMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1NodeAllocatableResourceMapping is not found in the empty JSON string", V1beta1NodeAllocatableResourceMapping.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1NodeAllocatableResourceMapping.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1NodeAllocatableResourceMapping` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1NodeAllocatableResourceMapping.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1NodeAllocatableResourceMapping' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1NodeAllocatableResourceMapping> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1NodeAllocatableResourceMapping.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1NodeAllocatableResourceMapping>() {
           @Override
           public void write(JsonWriter out, V1beta1NodeAllocatableResourceMapping value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1NodeAllocatableResourceMapping read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1NodeAllocatableResourceMapping given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1NodeAllocatableResourceMapping
   * @throws IOException if the JSON string is invalid with respect to V1beta1NodeAllocatableResourceMapping
   */
  public static V1beta1NodeAllocatableResourceMapping fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1NodeAllocatableResourceMapping.class);
  }

  /**
   * Convert an instance of V1beta1NodeAllocatableResourceMapping to an JSON string
   *
   * @return JSON string
   */
