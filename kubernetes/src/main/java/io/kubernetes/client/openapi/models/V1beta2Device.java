...
import io.kubernetes.client.openapi.models.V1beta2NodeAllocatableResourceMapping;
...
public class V1beta2Device {
  ...
  @jakarta.annotation.Nullable
  private Map<String, V1beta2NodeAllocatableResourceMapping> nodeAllocatableResourceMappings = new HashMap<>();
  ...
  public V1beta2Device allowMultipleAllocations(@jakarta.annotation.Nullable Boolean allowMultipleAllocations) {
  ...
  public V1beta2Device bindingConditions(@jakarta.annotation.Nullable List<String> bindingConditions) {
    this.bindingConditions = bindingConditions;
    return this;
  }

  public V1beta2Device addBindingConditionsItem(String bindingConditionsItem) {
  ...
  public V1beta2Device bindingFailureConditions(@jakarta.annotation.Nullable List<String> bindingFailureConditions) {
    this.bindingFailureConditions = bindingFailureConditions;
    return this;
  }

  public V1beta2Device addBindingFailureConditionsItem(String bindingFailureConditionsItem) {
  ...
  public V1beta2Device bindsToNode(@jakarta.annotation.Nullable Boolean bindsToNode) {
   ...
   */
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "ConsumesCounters defines a list of references to sharedCounters and the set of counters that the device will consume from those counter sets.  There can only be a single entry per counterSet.  The maximum number of device counter consumptions per device is 2.")
  ...
  public V1beta2Device nodeAllocatableResourceMappings(@jakarta.annotation.Nullable Map<String, V1beta2NodeAllocatableResourceMapping> nodeAllocatableResourceMappings) {
    this.nodeAllocatableResourceMappings = nodeAllocatableResourceMappings;
    return this;
  }

  public V1beta2Device putNodeAllocatableResourceMappingsItem(String key, V1beta2NodeAllocatableResourceMapping nodeAllocatableResourceMappingsItem) {
  ...
  public void setNodeAllocatableResourceMappings(@jakarta.annotation.Nullable Map<String, V1beta2NodeAllocatableResourceMapping> nodeAllocatableResourceMappings) {
    this.nodeAllocatableResourceMappings = nodeAllocatableResourceMappings;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allNodes, v1beta2Device.allNodes) &&
        Objects.equals(this.allowMultipleAllocations, v1beta2Device.allowMultipleAllocations) &&
        Objects.equals(this.attributes, v1beta2Device.attributes) &&
        Objects.equals(this.bindingConditions, v1beta2Device.bindingConditions) &&
        Objects.equals(this.bindingFailureConditions, v1beta2Device.bindingFailureConditions) &&
        Objects.equals(this.bindsToNode, v1beta2Device.bindsToNode) &&
        ...
        Objects.equals(this.nodeAllocatableResourceMappings, v1beta2Device.nodeAllocatableResourceMappings) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("allNodes", "allowMultipleAllocations", "attributes", "bindingConditions", "bindingFailureConditions", "bindsToNode", "capacity", "consumesCounters", "name", "nodeAllocatableResourceMappings", "nodeName", "nodeSelector", "taints"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta2Device.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta2Device is not found in the empty JSON string", V1beta2Device.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta2Device.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta2Device` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("consumesCounters") != null && !jsonObj.get("consumesCounters").isJsonNull()) {
        ...
        if (jsonArrayconsumesCounters != null) {
          ...
          if (!jsonObj.get("consumesCounters").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `consumesCounters` to be an array in the JSON string but got `%s`", jsonObj.get("consumesCounters").toString()));
          }
