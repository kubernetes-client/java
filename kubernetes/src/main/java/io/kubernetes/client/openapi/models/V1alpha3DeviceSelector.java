...
public class V1alpha3DeviceSelector {
  ...
  public V1alpha3DeviceSelector cel(@jakarta.annotation.Nullable V1alpha3CELDeviceSelector cel) {
    this.cel = cel;
    return this;
  }
  ...
  public void setCel(@jakarta.annotation.Nullable V1alpha3CELDeviceSelector cel) {
    this.cel = cel;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha3DeviceSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1alpha3DeviceSelector is not found in the empty JSON string", V1alpha3DeviceSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha3DeviceSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha3DeviceSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
