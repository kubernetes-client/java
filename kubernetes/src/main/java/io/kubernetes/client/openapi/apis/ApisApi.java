...
public class ApisApi {
    ...
    private ApiResponse<V1APIGroupList> getAPIVersionsWithHttpInfo() throws ApiException {
    ...
    private okhttp3.Call getAPIVersionsAsync(final ApiCallback<V1APIGroupList> _callback) throws ApiException {
    ...
    public class APIgetAPIVersionsRequest {
         ...
         */
        public V1APIGroupList execute() throws ApiException {
         ...
         */
        public ApiResponse<V1APIGroupList> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<V1APIGroupList> _callback) throws ApiException {
