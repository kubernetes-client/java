...
public class V1beta1ValidatingAdmissionPolicyBinding implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1beta1ValidatingAdmissionPolicyBinding apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1beta1ValidatingAdmissionPolicyBinding kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1beta1ValidatingAdmissionPolicyBinding metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1beta1ValidatingAdmissionPolicyBinding spec(@jakarta.annotation.Nullable V1beta1ValidatingAdmissionPolicyBindingSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1beta1ValidatingAdmissionPolicyBindingSpec spec) {
    this.spec = spec;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1ValidatingAdmissionPolicyBinding
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1ValidatingAdmissionPolicyBinding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1ValidatingAdmissionPolicyBinding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1ValidatingAdmissionPolicyBinding` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        V1beta1ValidatingAdmissionPolicyBindingSpec.validateJsonElement(jsonObj.get("spec"));
      }
  }
