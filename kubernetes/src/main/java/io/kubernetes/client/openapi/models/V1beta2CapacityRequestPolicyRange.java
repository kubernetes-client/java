...
public class V1beta2CapacityRequestPolicyRange {
  ...
  public V1beta2CapacityRequestPolicyRange max(Quantity max) {
  ...
  **/
  ...
  public V1beta2CapacityRequestPolicyRange min(Quantity min) {
  ...
  **/
  ...
  public V1beta2CapacityRequestPolicyRange step(Quantity step) {
