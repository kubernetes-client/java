...
public class V1alpha3NetworkDeviceData {
  ...
  public V1alpha3NetworkDeviceData hardwareAddress(@jakarta.annotation.Nullable String hardwareAddress) {
  ...
  public V1alpha3NetworkDeviceData interfaceName(@jakarta.annotation.Nullable String interfaceName) {
  ...
  public V1alpha3NetworkDeviceData ips(@jakarta.annotation.Nullable List<String> ips) {
    this.ips = ips;
    return this;
  }
