...
public class V1PersistentVolumeClaimList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  public V1PersistentVolumeClaimList apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1PersistentVolumeClaimList items(@jakarta.annotation.Nonnull List<V1PersistentVolumeClaim> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@jakarta.annotation.Nonnull List<V1PersistentVolumeClaim> items) {
    this.items = items;
  }


  public V1PersistentVolumeClaimList kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1PersistentVolumeClaimList metadata(@jakarta.annotation.Nullable V1ListMeta metadata) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1PersistentVolumeClaimList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1PersistentVolumeClaimList is not found in the empty JSON string", V1PersistentVolumeClaimList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1PersistentVolumeClaimList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1PersistentVolumeClaimList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
