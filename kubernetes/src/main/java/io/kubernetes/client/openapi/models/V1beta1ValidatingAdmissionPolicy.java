...
public class V1beta1ValidatingAdmissionPolicy implements io.kubernetes.client.common.KubernetesObject {
  ...
  @jakarta.annotation.Nullable
  private V1beta1ValidatingAdmissionPolicySpec spec;
  ...
  public V1beta1ValidatingAdmissionPolicy apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1beta1ValidatingAdmissionPolicy kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1beta1ValidatingAdmissionPolicy metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1beta1ValidatingAdmissionPolicy spec(@jakarta.annotation.Nullable V1beta1ValidatingAdmissionPolicySpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1beta1ValidatingAdmissionPolicySpec spec) {
    this.spec = spec;
  }


  public V1beta1ValidatingAdmissionPolicy status(@jakarta.annotation.Nullable V1beta1ValidatingAdmissionPolicyStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V1beta1ValidatingAdmissionPolicyStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    V1beta1ValidatingAdmissionPolicy v1beta1ValidatingAdmissionPolicy = (V1beta1ValidatingAdmissionPolicy) o;
    return Objects.equals(this.apiVersion, v1beta1ValidatingAdmissionPolicy.apiVersion) &&
        Objects.equals(this.kind, v1beta1ValidatingAdmissionPolicy.kind) &&
        Objects.equals(this.metadata, v1beta1ValidatingAdmissionPolicy.metadata) &&
        Objects.equals(this.spec, v1beta1ValidatingAdmissionPolicy.spec) &&
        Objects.equals(this.status, v1beta1ValidatingAdmissionPolicy.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1ValidatingAdmissionPolicy {\n");
