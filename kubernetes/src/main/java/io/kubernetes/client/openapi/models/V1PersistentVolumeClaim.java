...
public class V1PersistentVolumeClaim implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1PersistentVolumeClaim apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1PersistentVolumeClaim kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1PersistentVolumeClaim metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1PersistentVolumeClaim spec(@jakarta.annotation.Nullable V1PersistentVolumeClaimSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1PersistentVolumeClaimSpec spec) {
    this.spec = spec;
  }


  public V1PersistentVolumeClaim status(@jakarta.annotation.Nullable V1PersistentVolumeClaimStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V1PersistentVolumeClaimStatus status) {
    this.status = status;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1PersistentVolumeClaim
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1PersistentVolumeClaim.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1PersistentVolumeClaim is not found in the empty JSON string", V1PersistentVolumeClaim.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1PersistentVolumeClaim.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1PersistentVolumeClaim` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        V1PersistentVolumeClaimStatus.validateJsonElement(jsonObj.get("status"));
      }
  }
