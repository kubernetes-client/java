...
public class NodeV1Api {
   ...
   * </table>
   */
  public ApiResponse<V1RuntimeClass> readRuntimeClassWithHttpInfo(String name, String pretty)
      throws ApiException {
  ...
  public okhttp3.Call readRuntimeClassAsync(
      String name, String pretty, final ApiCallback<V1RuntimeClass> _callback) throws ApiException {
