...
public class NodeV1Api {
   ...
   * </table>
   */
  public V1RuntimeClass createRuntimeClass(
      V1RuntimeClass body, String pretty, String dryRun, String fieldManager) throws ApiException {
    ApiResponse<V1RuntimeClass> localVarResp =
  ...
  public okhttp3.Call createRuntimeClassAsync(
      ...
      String dryRun,
      String fieldManager,
      final ApiCallback<V1RuntimeClass> _callback)
      throws ApiException {
  ...
  public V1RuntimeClassList listRuntimeClass(
      ...
      Boolean watch)
      throws ApiException {
    ApiResponse<V1RuntimeClassList> localVarResp =
   ...
   * </table>
   */
  public ApiResponse<V1RuntimeClassList> listRuntimeClassWithHttpInfo(
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
  ...
  public okhttp3.Call listRuntimeClassAsync(
      ...
      Integer timeoutSeconds,
      Boolean watch,
      final ApiCallback<V1RuntimeClassList> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public V1RuntimeClass patchRuntimeClass(
   ...
   * </table>
   */
  public ApiResponse<V1RuntimeClass> patchRuntimeClassWithHttpInfo(
      String name, V1Patch body, String pretty, String dryRun, String fieldManager, Boolean force)
      throws ApiException {
    okhttp3.Call localVarCall =
   ...
   * </table>
   */
  public V1RuntimeClass readRuntimeClass(String name, String pretty, Boolean exact, Boolean export)
      throws ApiException {
    ApiResponse<V1RuntimeClass> localVarResp =
   ...
   * </table>
   */
  public ApiResponse<V1RuntimeClass> readRuntimeClassWithHttpInfo(
   ...
   * </table>
   */
  public V1RuntimeClass replaceRuntimeClass(
   ...
   * </table>
   */
  public ApiResponse<V1RuntimeClass> replaceRuntimeClassWithHttpInfo(
      String name, V1RuntimeClass body, String pretty, String dryRun, String fieldManager)
      throws ApiException {
    okhttp3.Call localVarCall =
