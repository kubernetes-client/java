...
public class V1ConfigMapProjection {
  ...
  public V1ConfigMapProjection items(@jakarta.annotation.Nullable List<V1KeyToPath> items) {
    this.items = items;
    return this;
  }
  ...
  public V1ConfigMapProjection name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public V1ConfigMapProjection optional(@jakarta.annotation.Nullable Boolean optional) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("items", "name", "optional"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1ConfigMapProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ConfigMapProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ConfigMapProjection is not found in the empty JSON string", V1ConfigMapProjection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ConfigMapProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ConfigMapProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
