...
public class V1DeviceClaimConfiguration {
  ...
  public V1DeviceClaimConfiguration opaque(@jakarta.annotation.Nullable V1OpaqueDeviceConfiguration opaque) {
    this.opaque = opaque;
    return this;
  }
  ...
  public V1DeviceClaimConfiguration requests(@jakarta.annotation.Nullable List<String> requests) {
  ...
  public boolean equals(Object o) {
    ...
    V1DeviceClaimConfiguration v1DeviceClaimConfiguration = (V1DeviceClaimConfiguration) o;
    return Objects.equals(this.opaque, v1DeviceClaimConfiguration.opaque) &&
        Objects.equals(this.requests, v1DeviceClaimConfiguration.requests);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1DeviceClaimConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1DeviceClaimConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1DeviceClaimConfiguration is not found in the empty JSON string", V1DeviceClaimConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1DeviceClaimConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1DeviceClaimConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1DeviceClaimConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1DeviceClaimConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1DeviceClaimConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1DeviceClaimConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<V1DeviceClaimConfiguration>() {
           @Override
           public void write(JsonWriter out, V1DeviceClaimConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1DeviceClaimConfiguration read(JsonReader in) throws IOException {
   ...
   * @return An instance of V1DeviceClaimConfiguration
   * @throws IOException if the JSON string is invalid with respect to V1DeviceClaimConfiguration
   */
  public static V1DeviceClaimConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1DeviceClaimConfiguration.class);
  }
