...
public class CoordinationV1Api {
   ...
   * </table>
   */
  public V1LeaseList listLeaseForAllNamespaces(
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
      String labelSelector,
      ...
      Boolean watch)
      throws ApiException {
    ApiResponse<V1LeaseList> localVarResp =
   ...
   * </table>
   */
  public ApiResponse<V1LeaseList> listLeaseForAllNamespacesWithHttpInfo(
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
      String labelSelector,
  ...
  public okhttp3.Call listLeaseForAllNamespacesAsync(
      ...
      Integer timeoutSeconds,
      Boolean watch,
      final ApiCallback<V1LeaseList> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public V1LeaseList listNamespacedLease(
      String namespace,
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
   ...
   * </table>
   */
  public ApiResponse<V1LeaseList> listNamespacedLeaseWithHttpInfo(
      String namespace,
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
   ...
   * </table>
   */
  public V1Lease patchNamespacedLease(
      String name,
      String namespace,
      V1Patch body,
      String pretty,
   ...
   * </table>
   */
  public V1Lease readNamespacedLease(String name, String namespace, String pretty)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<V1Lease> readNamespacedLeaseWithHttpInfo(
      String name, String namespace, String pretty) throws ApiException {
    okhttp3.Call localVarCall =
        readNamespacedLeaseValidateBeforeCall(name, namespace, pretty, null);
    Type localVarReturnType = new TypeToken<V1Lease>() {}.getType();
    return localVarApiClient.execute(localVarCall, localVarReturnType);
  }
  ...
  public okhttp3.Call readNamespacedLeaseAsync(
      String name, String namespace, String pretty, final ApiCallback<V1Lease> _callback)
      throws ApiException {

    okhttp3.Call localVarCall =
        readNamespacedLeaseValidateBeforeCall(name, namespace, pretty, _callback);
    Type localVarReturnType = new TypeToken<V1Lease>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
   ...
   * </table>
   */
  public V1Lease replaceNamespacedLease(
      String name,
      String namespace,
      V1Lease body,
      String pretty,
   ...
   * </table>
   */
  public ApiResponse<V1Lease> replaceNamespacedLeaseWithHttpInfo(
      String name,
      String namespace,
      V1Lease body,
      String pretty,
