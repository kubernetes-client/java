...
public class V1SelfSubjectAccessReview implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1SelfSubjectAccessReview apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1SelfSubjectAccessReview kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1SelfSubjectAccessReview metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1SelfSubjectAccessReview spec(@jakarta.annotation.Nonnull V1SelfSubjectAccessReviewSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nonnull V1SelfSubjectAccessReviewSpec spec) {
    this.spec = spec;
  }


  public V1SelfSubjectAccessReview status(@jakarta.annotation.Nullable V1SubjectAccessReviewStatus status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1SelfSubjectAccessReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1SelfSubjectAccessReview is not found in the empty JSON string", V1SelfSubjectAccessReview.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1SelfSubjectAccessReview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1SelfSubjectAccessReview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
