...
public class V1NetworkPolicy implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1NetworkPolicy apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1NetworkPolicy kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1NetworkPolicy metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1NetworkPolicy spec(@jakarta.annotation.Nullable V1NetworkPolicySpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1NetworkPolicySpec spec) {
    this.spec = spec;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1NetworkPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1NetworkPolicy is not found in the empty JSON string", V1NetworkPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1NetworkPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1NetworkPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
