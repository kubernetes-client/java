...
public class V1beta1DeviceConstraint {
  ...
  public V1beta1DeviceConstraint distinctAttribute(@jakarta.annotation.Nullable String distinctAttribute) {
  ...
  public V1beta1DeviceConstraint matchAttribute(@jakarta.annotation.Nullable String matchAttribute) {
  ...
  public V1beta1DeviceConstraint requests(@jakarta.annotation.Nullable List<String> requests) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1DeviceConstraint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1DeviceConstraint is not found in the empty JSON string", V1beta1DeviceConstraint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1DeviceConstraint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1DeviceConstraint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
