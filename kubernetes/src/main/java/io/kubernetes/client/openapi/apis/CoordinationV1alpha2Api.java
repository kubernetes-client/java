...
public class CoordinationV1alpha2Api {
    ...
    private okhttp3.Call listLeaseCandidateForAllNamespacesAsync(@jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback<V1alpha2LeaseCandidateList> _callback) throws ApiException {
    ...
    public class APIlistLeaseCandidateForAllNamespacesRequest {
       ...
       <caption>Response Details</caption>
        ...
        public V1alpha2LeaseCandidateList execute() throws ApiException {
            ApiResponse<V1alpha2LeaseCandidateList> localVarResp = listLeaseCandidateForAllNamespacesWithHttpInfo(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch);
            return localVarResp.getData();
        }
    ...
    private okhttp3.Call listNamespacedLeaseCandidateAsync(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback<V1alpha2LeaseCandidateList> _callback) throws ApiException {
    ...
    public class APIlistNamespacedLeaseCandidateRequest {
       ...
       <caption>Response Details</caption>
         ...
         */
        public V1alpha2LeaseCandidateList execute() throws ApiException {
            ApiResponse<V1alpha2LeaseCandidateList> localVarResp = listNamespacedLeaseCandidateWithHttpInfo(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch);
            return localVarResp.getData();
        }
