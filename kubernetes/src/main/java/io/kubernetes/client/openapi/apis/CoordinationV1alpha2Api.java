...
public class CoordinationV1alpha2Api {
    ...
    private okhttp3.Call createNamespacedLeaseCandidateCall(String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNamespacedLeaseCandidateValidateBeforeCall(String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<V1alpha2LeaseCandidate> createNamespacedLeaseCandidateWithHttpInfo(String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation) throws ApiException {
    ...
    private okhttp3.Call createNamespacedLeaseCandidateAsync(String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback<V1alpha2LeaseCandidate> _callback) throws ApiException {
    ...
    public class APIcreateNamespacedLeaseCandidateRequest {
        ...
        private APIcreateNamespacedLeaseCandidateRequest(String namespace, V1alpha2LeaseCandidate body) {
     ...
     */
    public APIcreateNamespacedLeaseCandidateRequest createNamespacedLeaseCandidate(String namespace, V1alpha2LeaseCandidate body) {
    ...
    public class APIdeleteCollectionNamespacedLeaseCandidateRequest {
         ...
         * @return APIdeleteCollectionNamespacedLeaseCandidateRequest
         */
        public APIdeleteCollectionNamespacedLeaseCandidateRequest ignoreStoreReadErrorWithClusterBreakingPotential(Boolean ignoreStoreReadErrorWithClusterBreakingPotential) {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteNamespacedLeaseCandidateValidateBeforeCall(String name, String namespace, String pretty, String dryRun, Integer gracePeriodSeconds, Boolean ignoreStoreReadErrorWithClusterBreakingPotential, Boolean orphanDependents, String propagationPolicy, V1DeleteOptions body, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<V1Status> deleteNamespacedLeaseCandidateWithHttpInfo(String name, String namespace, String pretty, String dryRun, Integer gracePeriodSeconds, Boolean ignoreStoreReadErrorWithClusterBreakingPotential, Boolean orphanDependents, String propagationPolicy, V1DeleteOptions body) throws ApiException {
    ...
    private okhttp3.Call deleteNamespacedLeaseCandidateAsync(String name, String namespace, String pretty, String dryRun, Integer gracePeriodSeconds, Boolean ignoreStoreReadErrorWithClusterBreakingPotential, Boolean orphanDependents, String propagationPolicy, V1DeleteOptions body, final ApiCallback<V1Status> _callback) throws ApiException {
    ...
    public class APIdeleteNamespacedLeaseCandidateRequest {
         ...
         * @return APIdeleteNamespacedLeaseCandidateRequest
         */
        public APIdeleteNamespacedLeaseCandidateRequest ignoreStoreReadErrorWithClusterBreakingPotential(Boolean ignoreStoreReadErrorWithClusterBreakingPotential) {
            this.ignoreStoreReadErrorWithClusterBreakingPotential = ignoreStoreReadErrorWithClusterBreakingPotential;
            return this;
        }
    ...
    private okhttp3.Call listLeaseCandidateForAllNamespacesAsync(Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String pretty, String resourceVersion, String resourceVersionMatch, Boolean sendInitialEvents, Integer timeoutSeconds, Boolean watch, final ApiCallback<V1alpha2LeaseCandidateList> _callback) throws ApiException {
    ...
    private okhttp3.Call listNamespacedLeaseCandidateAsync(String namespace, String pretty, Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String resourceVersion, String resourceVersionMatch, Boolean sendInitialEvents, Integer timeoutSeconds, Boolean watch, final ApiCallback<V1alpha2LeaseCandidateList> _callback) throws ApiException {
    ...
    private ApiResponse<V1alpha2LeaseCandidate> patchNamespacedLeaseCandidateWithHttpInfo(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force) throws ApiException {
    ...
    private okhttp3.Call patchNamespacedLeaseCandidateAsync(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force, final ApiCallback<V1alpha2LeaseCandidate> _callback) throws ApiException {
    ...
    private ApiResponse<V1alpha2LeaseCandidate> readNamespacedLeaseCandidateWithHttpInfo(String name, String namespace, String pretty) throws ApiException {
        okhttp3.Call localVarCall = readNamespacedLeaseCandidateValidateBeforeCall(name, namespace, pretty, null);
        Type localVarReturnType = new TypeToken<V1alpha2LeaseCandidate>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call readNamespacedLeaseCandidateAsync(String name, String namespace, String pretty, final ApiCallback<V1alpha2LeaseCandidate> _callback) throws ApiException {
    ...
    private okhttp3.Call replaceNamespacedLeaseCandidateCall(String name, String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceNamespacedLeaseCandidateValidateBeforeCall(String name, String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
    ...
    private ApiResponse<V1alpha2LeaseCandidate> replaceNamespacedLeaseCandidateWithHttpInfo(String name, String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation) throws ApiException {
    ...
    private okhttp3.Call replaceNamespacedLeaseCandidateAsync(String name, String namespace, V1alpha2LeaseCandidate body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback<V1alpha2LeaseCandidate> _callback) throws ApiException {
    ...
    public class APIreplaceNamespacedLeaseCandidateRequest {
        ...
        private APIreplaceNamespacedLeaseCandidateRequest(String name, String namespace, V1alpha2LeaseCandidate body) {
            this.name = name;
            this.namespace = namespace;
            this.body = body;
        }
     ...
     */
    public APIreplaceNamespacedLeaseCandidateRequest replaceNamespacedLeaseCandidate(String name, String namespace, V1alpha2LeaseCandidate body) {
