...
public class V1alpha1MatchResources {
  ...
  public V1alpha1MatchResources excludeResourceRules(@jakarta.annotation.Nullable List<V1alpha1NamedRuleWithOperations> excludeResourceRules) {
  ...
  public void setExcludeResourceRules(@jakarta.annotation.Nullable List<V1alpha1NamedRuleWithOperations> excludeResourceRules) {
    this.excludeResourceRules = excludeResourceRules;
  }


  public V1alpha1MatchResources matchPolicy(@jakarta.annotation.Nullable String matchPolicy) {
  ...
  public V1alpha1MatchResources objectSelector(@jakarta.annotation.Nullable V1LabelSelector objectSelector) {
  ...
  public V1alpha1MatchResources resourceRules(@jakarta.annotation.Nullable List<V1alpha1NamedRuleWithOperations> resourceRules) {
  ...
  public void setResourceRules(@jakarta.annotation.Nullable List<V1alpha1NamedRuleWithOperations> resourceRules) {
    this.resourceRules = resourceRules;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1MatchResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1alpha1MatchResources is not found in the empty JSON string", V1alpha1MatchResources.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1MatchResources.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha1MatchResources` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
