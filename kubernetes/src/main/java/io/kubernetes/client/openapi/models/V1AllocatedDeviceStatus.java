...
public class V1AllocatedDeviceStatus {
  ...
  public V1AllocatedDeviceStatus() {
  }

  public V1AllocatedDeviceStatus conditions(@jakarta.annotation.Nullable List<V1Condition> conditions) {
  ...
  public V1AllocatedDeviceStatus data(@jakarta.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public V1AllocatedDeviceStatus device(@jakarta.annotation.Nonnull String device) {
    this.device = device;
    return this;
  }
  ...
  public V1AllocatedDeviceStatus driver(@jakarta.annotation.Nonnull String driver) {
    this.driver = driver;
    return this;
  }
  ...
  public V1AllocatedDeviceStatus networkData(@jakarta.annotation.Nullable V1NetworkDeviceData networkData) {
  ...
  public void setNetworkData(@jakarta.annotation.Nullable V1NetworkDeviceData networkData) {
    this.networkData = networkData;
  }


  public V1AllocatedDeviceStatus pool(@jakarta.annotation.Nonnull String pool) {
    this.pool = pool;
    return this;
  }
  ...
  public V1AllocatedDeviceStatus shareID(@jakarta.annotation.Nullable String shareID) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1AllocatedDeviceStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1AllocatedDeviceStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1AllocatedDeviceStatus is not found in the empty JSON string", V1AllocatedDeviceStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1AllocatedDeviceStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1AllocatedDeviceStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1AllocatedDeviceStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1AllocatedDeviceStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1AllocatedDeviceStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1AllocatedDeviceStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V1AllocatedDeviceStatus>() {
           @Override
  ...
  /**
   * Create an instance of V1AllocatedDeviceStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1AllocatedDeviceStatus
   * @throws IOException if the JSON string is invalid with respect to V1AllocatedDeviceStatus
   */
  public static V1AllocatedDeviceStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1AllocatedDeviceStatus.class);
  }

  /**
   * Convert an instance of V1AllocatedDeviceStatus to an JSON string
   *
   * @return JSON string
   */
