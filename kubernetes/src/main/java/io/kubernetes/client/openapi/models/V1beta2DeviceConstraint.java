...
public class V1beta2DeviceConstraint {
  ...
  public V1beta2DeviceConstraint distinctAttribute(String distinctAttribute) {
  ...
  **/
  ...
  public V1beta2DeviceConstraint matchAttribute(String matchAttribute) {
  ...
  **/
  ...
  public V1beta2DeviceConstraint requests(List<String> requests) {
