...
public class V1alpha3ResourceSlice implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1alpha3ResourceSlice apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1alpha3ResourceSlice kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1alpha3ResourceSlice metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1alpha3ResourceSlice spec(@jakarta.annotation.Nonnull V1alpha3ResourceSliceSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nonnull V1alpha3ResourceSliceSpec spec) {
    this.spec = spec;
  }
