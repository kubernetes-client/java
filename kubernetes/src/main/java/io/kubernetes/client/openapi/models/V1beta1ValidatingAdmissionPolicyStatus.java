...
public class V1beta1ValidatingAdmissionPolicyStatus {
  ...
  public V1beta1ValidatingAdmissionPolicyStatus conditions(@jakarta.annotation.Nullable List<V1Condition> conditions) {
  ...
  public V1beta1ValidatingAdmissionPolicyStatus observedGeneration(@jakarta.annotation.Nullable Long observedGeneration) {
  ...
  public V1beta1ValidatingAdmissionPolicyStatus typeChecking(@jakarta.annotation.Nullable V1beta1TypeChecking typeChecking) {
  ...
  public void setTypeChecking(@jakarta.annotation.Nullable V1beta1TypeChecking typeChecking) {
    this.typeChecking = typeChecking;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1ValidatingAdmissionPolicyStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1ValidatingAdmissionPolicyStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1ValidatingAdmissionPolicyStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1ValidatingAdmissionPolicyStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("typeChecking") != null && !jsonObj.get("typeChecking").isJsonNull()) {
        V1beta1TypeChecking.validateJsonElement(jsonObj.get("typeChecking"));
      }
  }
