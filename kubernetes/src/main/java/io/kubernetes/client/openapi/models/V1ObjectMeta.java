...
public class V1ObjectMeta {
  ...
  public V1ObjectMeta annotations(@jakarta.annotation.Nullable Map<String, String> annotations) {
  ...
  public V1ObjectMeta creationTimestamp(@jakarta.annotation.Nullable OffsetDateTime creationTimestamp) {
  ...
  public void setCreationTimestamp(@jakarta.annotation.Nullable OffsetDateTime creationTimestamp) {
    this.creationTimestamp = creationTimestamp;
  }


  public V1ObjectMeta deletionGracePeriodSeconds(@jakarta.annotation.Nullable Long deletionGracePeriodSeconds) {
  ...
  public void setDeletionGracePeriodSeconds(@jakarta.annotation.Nullable Long deletionGracePeriodSeconds) {
    this.deletionGracePeriodSeconds = deletionGracePeriodSeconds;
  }


  public V1ObjectMeta deletionTimestamp(@jakarta.annotation.Nullable OffsetDateTime deletionTimestamp) {
  ...
  public void setDeletionTimestamp(@jakarta.annotation.Nullable OffsetDateTime deletionTimestamp) {
    this.deletionTimestamp = deletionTimestamp;
  }


  public V1ObjectMeta finalizers(@jakarta.annotation.Nullable List<String> finalizers) {
  ...
  public V1ObjectMeta generateName(@jakarta.annotation.Nullable String generateName) {
  ...
  public void setGenerateName(@jakarta.annotation.Nullable String generateName) {
    this.generateName = generateName;
  }


  public V1ObjectMeta generation(@jakarta.annotation.Nullable Long generation) {
  ...
  public void setGeneration(@jakarta.annotation.Nullable Long generation) {
    this.generation = generation;
  }


  public V1ObjectMeta labels(@jakarta.annotation.Nullable Map<String, String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public V1ObjectMeta managedFields(@jakarta.annotation.Nullable List<V1ManagedFieldsEntry> managedFields) {
  ...
  public void setManagedFields(@jakarta.annotation.Nullable List<V1ManagedFieldsEntry> managedFields) {
    this.managedFields = managedFields;
  }


  public V1ObjectMeta name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public V1ObjectMeta namespace(@jakarta.annotation.Nullable String namespace) {
  ...
  public V1ObjectMeta ownerReferences(@jakarta.annotation.Nullable List<V1OwnerReference> ownerReferences) {
  ...
  public void setOwnerReferences(@jakarta.annotation.Nullable List<V1OwnerReference> ownerReferences) {
    this.ownerReferences = ownerReferences;
  }


  public V1ObjectMeta resourceVersion(@jakarta.annotation.Nullable String resourceVersion) {
  ...
  public V1ObjectMeta selfLink(@jakarta.annotation.Nullable String selfLink) {
  ...
  public V1ObjectMeta uid(@jakarta.annotation.Nullable String uid) {
    this.uid = uid;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("annotations", "creationTimestamp", "deletionGracePeriodSeconds", "deletionTimestamp", "finalizers", "generateName", "generation", "labels", "managedFields", "name", "namespace", "ownerReferences", "resourceVersion", "selfLink", "uid"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ObjectMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1ObjectMeta is not found in the empty JSON string", V1ObjectMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ObjectMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ObjectMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("finalizers") != null && !jsonObj.get("finalizers").isJsonNull() && !jsonObj.get("finalizers").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `finalizers` to be an array in the JSON string but got `%s`", jsonObj.get("finalizers").toString()));
      }
      if ((jsonObj.get("generateName") != null && !jsonObj.get("generateName").isJsonNull()) && !jsonObj.get("generateName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `generateName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("generateName").toString()));
      }
      if (jsonObj.get("managedFields") != null && !jsonObj.get("managedFields").isJsonNull()) {
        ...
        if (jsonArraymanagedFields != null) {
          ...
          if (!jsonObj.get("managedFields").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `managedFields` to be an array in the JSON string but got `%s`", jsonObj.get("managedFields").toString()));
          }
      ...
      if (jsonObj.get("ownerReferences") != null && !jsonObj.get("ownerReferences").isJsonNull()) {
        ...
        if (jsonArrayownerReferences != null) {
          ...
          if (!jsonObj.get("ownerReferences").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ownerReferences` to be an array in the JSON string but got `%s`", jsonObj.get("ownerReferences").toString()));
          }
      ...
      if ((jsonObj.get("resourceVersion") != null && !jsonObj.get("resourceVersion").isJsonNull()) && !jsonObj.get("resourceVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `resourceVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("resourceVersion").toString()));
      }
      if ((jsonObj.get("selfLink") != null && !jsonObj.get("selfLink").isJsonNull()) && !jsonObj.get("selfLink").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `selfLink` to be a primitive type in the JSON string but got `%s`", jsonObj.get("selfLink").toString()));
      }
