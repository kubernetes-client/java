...
public class V1alpha3AllocationResult {
  ...
  public V1alpha3AllocationResult devices(@jakarta.annotation.Nullable V1alpha3DeviceAllocationResult devices) {
  ...
  public void setDevices(@jakarta.annotation.Nullable V1alpha3DeviceAllocationResult devices) {
    this.devices = devices;
  }


  public V1alpha3AllocationResult nodeSelector(@jakarta.annotation.Nullable V1NodeSelector nodeSelector) {
