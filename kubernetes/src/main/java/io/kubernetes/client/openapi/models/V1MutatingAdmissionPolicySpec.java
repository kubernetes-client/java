...
import io.kubernetes.client.openapi.models.V1Mutation;
 ...
 */
@ApiModel(description = "MutatingAdmissionPolicySpec defines the desired behavior of the admission policy.")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-06-26T22:35:15.319369Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class V1MutatingAdmissionPolicySpec {
  ...
  @jakarta.annotation.Nullable
  private List<V1Mutation> mutations = new ArrayList<>();
  ...
  public V1MutatingAdmissionPolicySpec() {
  }

  public V1MutatingAdmissionPolicySpec failurePolicy(@jakarta.annotation.Nullable String failurePolicy) {
  ...
  public V1MutatingAdmissionPolicySpec matchConditions(@jakarta.annotation.Nullable List<V1MatchCondition> matchConditions) {
    this.matchConditions = matchConditions;
    return this;
  }

  public V1MutatingAdmissionPolicySpec addMatchConditionsItem(V1MatchCondition matchConditionsItem) {
  ...
  public V1MutatingAdmissionPolicySpec matchConstraints(@jakarta.annotation.Nullable V1MatchResources matchConstraints) {
  ...
  public V1MutatingAdmissionPolicySpec mutations(@jakarta.annotation.Nullable List<V1Mutation> mutations) {
    this.mutations = mutations;
    return this;
  }

  public V1MutatingAdmissionPolicySpec addMutationsItem(V1Mutation mutationsItem) {
  ...
  public List<V1Mutation> getMutations() {
    return mutations;
  }

  public void setMutations(@jakarta.annotation.Nullable List<V1Mutation> mutations) {
    this.mutations = mutations;
  }


  public V1MutatingAdmissionPolicySpec paramKind(@jakarta.annotation.Nullable V1ParamKind paramKind) {
  ...
  public V1MutatingAdmissionPolicySpec reinvocationPolicy(@jakarta.annotation.Nullable String reinvocationPolicy) {
  ...
  public V1MutatingAdmissionPolicySpec variables(@jakarta.annotation.Nullable List<V1Variable> variables) {
    this.variables = variables;
    return this;
  }

  public V1MutatingAdmissionPolicySpec addVariablesItem(V1Variable variablesItem) {
  ...
  public boolean equals(Object o) {
    ...
    V1MutatingAdmissionPolicySpec v1MutatingAdmissionPolicySpec = (V1MutatingAdmissionPolicySpec) o;
    return Objects.equals(this.failurePolicy, v1MutatingAdmissionPolicySpec.failurePolicy) &&
        Objects.equals(this.matchConditions, v1MutatingAdmissionPolicySpec.matchConditions) &&
        Objects.equals(this.matchConstraints, v1MutatingAdmissionPolicySpec.matchConstraints) &&
        Objects.equals(this.mutations, v1MutatingAdmissionPolicySpec.mutations) &&
        Objects.equals(this.paramKind, v1MutatingAdmissionPolicySpec.paramKind) &&
        Objects.equals(this.reinvocationPolicy, v1MutatingAdmissionPolicySpec.reinvocationPolicy) &&
        Objects.equals(this.variables, v1MutatingAdmissionPolicySpec.variables);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1MutatingAdmissionPolicySpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1MutatingAdmissionPolicySpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1MutatingAdmissionPolicySpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1MutatingAdmissionPolicySpec is not found in the empty JSON string", V1MutatingAdmissionPolicySpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1MutatingAdmissionPolicySpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1MutatingAdmissionPolicySpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("mutations") != null && !jsonObj.get("mutations").isJsonNull()) {
        ...
        if (jsonArraymutations != null) {
          ...
          for (int i = 0; i < jsonArraymutations.size(); i++) {
            V1Mutation.validateJsonElement(jsonArraymutations.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1MutatingAdmissionPolicySpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1MutatingAdmissionPolicySpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1MutatingAdmissionPolicySpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1MutatingAdmissionPolicySpec.class));

       return (TypeAdapter<T>) new TypeAdapter<V1MutatingAdmissionPolicySpec>() {
           @Override
           public void write(JsonWriter out, V1MutatingAdmissionPolicySpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1MutatingAdmissionPolicySpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1MutatingAdmissionPolicySpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1MutatingAdmissionPolicySpec
   * @throws IOException if the JSON string is invalid with respect to V1MutatingAdmissionPolicySpec
   */
  public static V1MutatingAdmissionPolicySpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1MutatingAdmissionPolicySpec.class);
  }

  /**
   * Convert an instance of V1MutatingAdmissionPolicySpec to an JSON string
   *
   * @return JSON string
   */
