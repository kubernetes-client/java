...
public class V1HorizontalPodAutoscalerList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  public V1HorizontalPodAutoscalerList apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1HorizontalPodAutoscalerList items(@jakarta.annotation.Nonnull List<V1HorizontalPodAutoscaler> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@jakarta.annotation.Nonnull List<V1HorizontalPodAutoscaler> items) {
    this.items = items;
  }


  public V1HorizontalPodAutoscalerList kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1HorizontalPodAutoscalerList metadata(@jakarta.annotation.Nullable V1ListMeta metadata) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1HorizontalPodAutoscalerList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1HorizontalPodAutoscalerList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1HorizontalPodAutoscalerList is not found in the empty JSON string", V1HorizontalPodAutoscalerList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1HorizontalPodAutoscalerList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1HorizontalPodAutoscalerList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        V1HorizontalPodAutoscaler.validateJsonElement(jsonArrayitems.get(i));
      };
