...
public class V1beta1SubjectRulesReviewStatus {
  ...
  public V1beta1SubjectRulesReviewStatus nonResourceRules(
      List<V1beta1NonResourceRule> nonResourceRules) {

    this.nonResourceRules = nonResourceRules;
    return this;
  }

  public V1beta1SubjectRulesReviewStatus addNonResourceRulesItem(
      V1beta1NonResourceRule nonResourceRulesItem) {
  ...
  public V1beta1SubjectRulesReviewStatus addResourceRulesItem(
      V1beta1ResourceRule resourceRulesItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1SubjectRulesReviewStatus v1beta1SubjectRulesReviewStatus =
        (V1beta1SubjectRulesReviewStatus) o;
