...
public class V1beta1DeviceSubRequest {
  ...
  public V1beta1DeviceSubRequest allocationMode(String allocationMode) {
  ...
  **/
  ...
  public V1beta1DeviceSubRequest capacity(V1beta1CapacityRequirements capacity) {
  ...
  **/
  ...
  public V1beta1DeviceSubRequest count(Long count) {
  ...
  **/
  ...
  public V1beta1DeviceSubRequest deviceClassName(String deviceClassName) {
  ...
  **/
  ...
  public V1beta1DeviceSubRequest name(String name) {
  ...
  **/
  ...
  public V1beta1DeviceSubRequest selectors(List<V1beta1DeviceSelector> selectors) {
  ...
  **/
  ...
  public V1beta1DeviceSubRequest tolerations(List<V1beta1DeviceToleration> tolerations) {
