...
public class V1beta1DeviceSubRequest {
  ...
  public V1beta1DeviceSubRequest() {
  }

  public V1beta1DeviceSubRequest allocationMode(@jakarta.annotation.Nullable String allocationMode) {
  ...
  public V1beta1DeviceSubRequest capacity(@jakarta.annotation.Nullable V1beta1CapacityRequirements capacity) {
  ...
  public V1beta1DeviceSubRequest count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public V1beta1DeviceSubRequest deviceClassName(@jakarta.annotation.Nonnull String deviceClassName) {
  ...
  public V1beta1DeviceSubRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1beta1DeviceSubRequest selectors(@jakarta.annotation.Nullable List<V1beta1DeviceSelector> selectors) {
    this.selectors = selectors;
    return this;
  }

  public V1beta1DeviceSubRequest addSelectorsItem(V1beta1DeviceSelector selectorsItem) {
  ...
  public V1beta1DeviceSubRequest tolerations(@jakarta.annotation.Nullable List<V1beta1DeviceToleration> tolerations) {
    this.tolerations = tolerations;
    return this;
  }

  public V1beta1DeviceSubRequest addTolerationsItem(V1beta1DeviceToleration tolerationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1DeviceSubRequest v1beta1DeviceSubRequest = (V1beta1DeviceSubRequest) o;
    return Objects.equals(this.allocationMode, v1beta1DeviceSubRequest.allocationMode) &&
        Objects.equals(this.capacity, v1beta1DeviceSubRequest.capacity) &&
        Objects.equals(this.count, v1beta1DeviceSubRequest.count) &&
        Objects.equals(this.deviceClassName, v1beta1DeviceSubRequest.deviceClassName) &&
        Objects.equals(this.name, v1beta1DeviceSubRequest.name) &&
        Objects.equals(this.selectors, v1beta1DeviceSubRequest.selectors) &&
        Objects.equals(this.tolerations, v1beta1DeviceSubRequest.tolerations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1DeviceSubRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1DeviceSubRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1DeviceSubRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1DeviceSubRequest is not found in the empty JSON string", V1beta1DeviceSubRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1DeviceSubRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1DeviceSubRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1DeviceSubRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1DeviceSubRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1DeviceSubRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1DeviceSubRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1DeviceSubRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1DeviceSubRequest>() {
           @Override
           public void write(JsonWriter out, V1beta1DeviceSubRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1DeviceSubRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1DeviceSubRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1DeviceSubRequest
   * @throws IOException if the JSON string is invalid with respect to V1beta1DeviceSubRequest
   */
  public static V1beta1DeviceSubRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1DeviceSubRequest.class);
  }

  /**
   * Convert an instance of V1beta1DeviceSubRequest to an JSON string
   *
   * @return JSON string
   */
