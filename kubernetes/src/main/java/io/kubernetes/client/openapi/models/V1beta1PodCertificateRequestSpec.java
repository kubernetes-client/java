...
public class V1beta1PodCertificateRequestSpec {
  ...
  public V1beta1PodCertificateRequestSpec pkixPublicKey(@jakarta.annotation.Nonnull byte[] pkixPublicKey) {
  ...
  public V1beta1PodCertificateRequestSpec proofOfPossession(@jakarta.annotation.Nonnull byte[] proofOfPossession) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maxExpirationSeconds, nodeName, nodeUID, Arrays.hashCode(pkixPublicKey), podName, podUID, Arrays.hashCode(proofOfPossession), serviceAccountName, serviceAccountUID, signerName, unverifiedUserAnnotations);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("maxExpirationSeconds", "nodeName", "nodeUID", "pkixPublicKey", "podName", "podUID", "proofOfPossession", "serviceAccountName", "serviceAccountUID", "signerName", "unverifiedUserAnnotations"));
