...
public class V1beta1PodCertificateRequestSpec {
  ...
  public static final String SERIALIZED_NAME_STUB_P_K_C_S10_REQUEST = "stubPKCS10Request";
  @SerializedName(SERIALIZED_NAME_STUB_P_K_C_S10_REQUEST)
  @jakarta.annotation.Nonnull
  private byte[] stubPKCS10Request;

  public static final String SERIALIZED_NAME_UNVERIFIED_USER_ANNOTATIONS = "unverifiedUserAnnotations";
  @SerializedName(SERIALIZED_NAME_UNVERIFIED_USER_ANNOTATIONS)
  @jakarta.annotation.Nullable
  private Map<String, String> unverifiedUserAnnotations = new HashMap<>();

  public V1beta1PodCertificateRequestSpec() {
  }

  public V1beta1PodCertificateRequestSpec maxExpirationSeconds(@jakarta.annotation.Nullable Integer maxExpirationSeconds) {
  ...
  public V1beta1PodCertificateRequestSpec nodeName(@jakarta.annotation.Nonnull String nodeName) {
  ...
  public V1beta1PodCertificateRequestSpec nodeUID(@jakarta.annotation.Nonnull String nodeUID) {
  ...
  public V1beta1PodCertificateRequestSpec pkixPublicKey(@jakarta.annotation.Nullable byte[] pkixPublicKey) {
   ...
   */
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "The PKIX-serialized public key the signer will issue the certificate to.  The key must be one of RSA3072, RSA4096, ECDSAP256, ECDSAP384, ECDSAP521, or ED25519. Note that this list may be expanded in the future.  Signer implementations do not need to support all key types supported by kube-apiserver and kubelet.  If a signer does not support the key type used for a given PodCertificateRequest, it must deny the request by setting a status.conditions entry with a type of \"Denied\" and a reason of \"UnsupportedKeyType\". It may also suggest a key type that it does support in the message field.  Deprecated: This field is replaced by StubPKCS10Request. If StubPKCS10Request is set, this field must be empty.  Signer implementations should extract the public key from the StubPKCS10Request field.")
  public byte[] getPkixPublicKey() {
    return pkixPublicKey;
  }

  public void setPkixPublicKey(@jakarta.annotation.Nullable byte[] pkixPublicKey) {
    this.pkixPublicKey = pkixPublicKey;
  }


  public V1beta1PodCertificateRequestSpec podName(@jakarta.annotation.Nonnull String podName) {
  ...
  public V1beta1PodCertificateRequestSpec podUID(@jakarta.annotation.Nonnull String podUID) {
    this.podUID = podUID;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "A proof that the requesting kubelet holds the private key corresponding to pkixPublicKey.  It is contructed by signing the ASCII bytes of the pod's UID using `pkixPublicKey`.  kube-apiserver validates the proof of possession during creation of the PodCertificateRequest.  If the key is an RSA key, then the signature is over the ASCII bytes of the pod UID, using RSASSA-PSS from RFC 8017 (as implemented by the golang function crypto/rsa.SignPSS with nil options).  If the key is an ECDSA key, then the signature is as described by [SEC 1, Version 2.0](https://www.secg.org/sec1-v2.pdf) (as implemented by the golang library function crypto/ecdsa.SignASN1)  If the key is an ED25519 key, the the signature is as described by the [ED25519 Specification](https://ed25519.cr.yp.to/) (as implemented by the golang library crypto/ed25519.Sign).  Deprecated: This field is replaced by StubPKCS10Request. If StubPKCS10Request is set, this field must be empty.")
  ...
  public V1beta1PodCertificateRequestSpec serviceAccountName(@jakarta.annotation.Nonnull String serviceAccountName) {
  ...
  public V1beta1PodCertificateRequestSpec serviceAccountUID(@jakarta.annotation.Nonnull String serviceAccountUID) {
  ...
  public V1beta1PodCertificateRequestSpec signerName(@jakarta.annotation.Nonnull String signerName) {
  ...
  public V1beta1PodCertificateRequestSpec stubPKCS10Request(@jakarta.annotation.Nonnull byte[] stubPKCS10Request) {
   ...
   */
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A PKCS#10 certificate signing request (DER-serialized) generated by Kubelet using the subject private key.  Most signer implementations will ignore the contents of the CSR except to extract the subject public key. The API server automatically verifies the CSR signature during admission, so the signer does not need to repeat the verification.  CSRs generated by kubelet are completely empty.  The subject public key must be one of RSA3072, RSA4096, ECDSAP256, ECDSAP384, ECDSAP521, or ED25519. Note that this list may be expanded in the future.  Signer implementations do not need to support all key types supported by kube-apiserver and kubelet.  If a signer does not support the key type used for a given PodCertificateRequest, it must deny the request by setting a status.conditions entry with a type of \"Denied\" and a reason of \"UnsupportedKeyType\". It may also suggest a key type that it does support in the message field.")
  public byte[] getStubPKCS10Request() {
    return stubPKCS10Request;
  }

  public void setStubPKCS10Request(@jakarta.annotation.Nonnull byte[] stubPKCS10Request) {
    this.stubPKCS10Request = stubPKCS10Request;
  }


  public V1beta1PodCertificateRequestSpec unverifiedUserAnnotations(@jakarta.annotation.Nullable Map<String, String> unverifiedUserAnnotations) {
  ...
  public V1beta1PodCertificateRequestSpec putUnverifiedUserAnnotationsItem(String key, String unverifiedUserAnnotationsItem) {
    if (this.unverifiedUserAnnotations == null) {
      this.unverifiedUserAnnotations = new HashMap<>();
    }
    this.unverifiedUserAnnotations.put(key, unverifiedUserAnnotationsItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "unverifiedUserAnnotations allow pod authors to pass additional information to the signer implementation.  Kubernetes does not restrict or validate this metadata in any way.  Entries are subject to the same validation as object metadata annotations, with the addition that all keys must be domain-prefixed. No restrictions are placed on values, except an overall size limitation on the entire field.  Signers should document the keys and values they support.  Signers should deny requests that contain keys they do not recognize.")
  public Map<String, String> getUnverifiedUserAnnotations() {
    return unverifiedUserAnnotations;
  }

  public void setUnverifiedUserAnnotations(@jakarta.annotation.Nullable Map<String, String> unverifiedUserAnnotations) {
    this.unverifiedUserAnnotations = unverifiedUserAnnotations;
  }
  ...
  public boolean equals(Object o) {
    ...
    V1beta1PodCertificateRequestSpec v1beta1PodCertificateRequestSpec = (V1beta1PodCertificateRequestSpec) o;
    return Objects.equals(this.maxExpirationSeconds, v1beta1PodCertificateRequestSpec.maxExpirationSeconds) &&
        Objects.equals(this.nodeName, v1beta1PodCertificateRequestSpec.nodeName) &&
        Objects.equals(this.nodeUID, v1beta1PodCertificateRequestSpec.nodeUID) &&
        Arrays.equals(this.pkixPublicKey, v1beta1PodCertificateRequestSpec.pkixPublicKey) &&
        Objects.equals(this.podName, v1beta1PodCertificateRequestSpec.podName) &&
        Objects.equals(this.podUID, v1beta1PodCertificateRequestSpec.podUID) &&
        Arrays.equals(this.proofOfPossession, v1beta1PodCertificateRequestSpec.proofOfPossession) &&
        Objects.equals(this.serviceAccountName, v1beta1PodCertificateRequestSpec.serviceAccountName) &&
        Objects.equals(this.serviceAccountUID, v1beta1PodCertificateRequestSpec.serviceAccountUID) &&
        Objects.equals(this.signerName, v1beta1PodCertificateRequestSpec.signerName) &&
        Arrays.equals(this.stubPKCS10Request, v1beta1PodCertificateRequestSpec.stubPKCS10Request) &&
        Objects.equals(this.unverifiedUserAnnotations, v1beta1PodCertificateRequestSpec.unverifiedUserAnnotations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxExpirationSeconds, nodeName, nodeUID, Arrays.hashCode(pkixPublicKey), podName, podUID, Arrays.hashCode(proofOfPossession), serviceAccountName, serviceAccountUID, signerName, Arrays.hashCode(stubPKCS10Request), unverifiedUserAnnotations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1beta1PodCertificateRequestSpec {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("maxExpirationSeconds", "nodeName", "nodeUID", "pkixPublicKey", "podName", "podUID", "proofOfPossession", "serviceAccountName", "serviceAccountUID", "signerName", "stubPKCS10Request", "unverifiedUserAnnotations"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("nodeName", "nodeUID", "podName", "podUID", "serviceAccountName", "serviceAccountUID", "signerName", "stubPKCS10Request"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1PodCertificateRequestSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1PodCertificateRequestSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1PodCertificateRequestSpec is not found in the empty JSON string", V1beta1PodCertificateRequestSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1PodCertificateRequestSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1PodCertificateRequestSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1PodCertificateRequestSpec.openapiRequiredFields) {
      ...
      if (!jsonObj.get("nodeUID").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nodeUID` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nodeUID").toString()));
      }
      if (!jsonObj.get("podName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `podName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("podName").toString()));
      }
      if (!jsonObj.get("podUID").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `podUID` to be a primitive type in the JSON string but got `%s`", jsonObj.get("podUID").toString()));
      }
      if (!jsonObj.get("serviceAccountName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `serviceAccountName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("serviceAccountName").toString()));
      }
      if (!jsonObj.get("serviceAccountUID").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `serviceAccountUID` to be a primitive type in the JSON string but got `%s`", jsonObj.get("serviceAccountUID").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1PodCertificateRequestSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1PodCertificateRequestSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1PodCertificateRequestSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1PodCertificateRequestSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1PodCertificateRequestSpec>() {
           @Override
           public void write(JsonWriter out, V1beta1PodCertificateRequestSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1PodCertificateRequestSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1PodCertificateRequestSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1PodCertificateRequestSpec
   * @throws IOException if the JSON string is invalid with respect to V1beta1PodCertificateRequestSpec
   */
  public static V1beta1PodCertificateRequestSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1PodCertificateRequestSpec.class);
  }

  /**
   * Convert an instance of V1beta1PodCertificateRequestSpec to an JSON string
   *
   * @return JSON string
   */
