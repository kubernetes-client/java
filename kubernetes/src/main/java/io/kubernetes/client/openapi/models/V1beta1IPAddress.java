...
public class V1beta1IPAddress implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1beta1IPAddress spec(@jakarta.annotation.Nullable V1beta1IPAddressSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1beta1IPAddressSpec spec) {
    this.spec = spec;
  }
