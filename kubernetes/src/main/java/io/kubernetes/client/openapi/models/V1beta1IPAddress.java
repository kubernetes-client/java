...
public class V1beta1IPAddress implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1beta1IPAddress apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1beta1IPAddress kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1beta1IPAddress metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1beta1IPAddress spec(@jakarta.annotation.Nonnull V1beta1IPAddressSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nonnull V1beta1IPAddressSpec spec) {
    this.spec = spec;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1IPAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1IPAddress is not found in the empty JSON string", V1beta1IPAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1IPAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1IPAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1IPAddress.openapiRequiredFields) {
