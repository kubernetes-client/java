...
public class V1APIResource {
  ...
  public V1APIResource categories(@jakarta.annotation.Nullable List<String> categories) {
  ...
  public V1APIResource group(@jakarta.annotation.Nullable String group) {
    this.group = group;
    return this;
  }
  ...
  public V1APIResource kind(@jakarta.annotation.Nonnull String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1APIResource name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1APIResource namespaced(@jakarta.annotation.Nonnull Boolean namespaced) {
  ...
  public void setNamespaced(@jakarta.annotation.Nonnull Boolean namespaced) {
    this.namespaced = namespaced;
  }


  public V1APIResource shortNames(@jakarta.annotation.Nullable List<String> shortNames) {
  ...
  public V1APIResource singularName(@jakarta.annotation.Nonnull String singularName) {
  ...
  public void setSingularName(@jakarta.annotation.Nonnull String singularName) {
    this.singularName = singularName;
  }
  ...
  public void setStorageVersionHash(@jakarta.annotation.Nullable String storageVersionHash) {
    this.storageVersionHash = storageVersionHash;
  }


  public V1APIResource verbs(@jakarta.annotation.Nonnull List<String> verbs) {
    this.verbs = verbs;
    return this;
  }
  ...
  public V1APIResource version(@jakarta.annotation.Nullable String version) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1APIResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1APIResource is not found in the empty JSON string", V1APIResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1APIResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1APIResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("shortNames") != null && !jsonObj.get("shortNames").isJsonNull() && !jsonObj.get("shortNames").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `shortNames` to be an array in the JSON string but got `%s`", jsonObj.get("shortNames").toString()));
      }
      if (!jsonObj.get("singularName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `singularName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("singularName").toString()));
      }
      if ((jsonObj.get("storageVersionHash") != null && !jsonObj.get("storageVersionHash").isJsonNull()) && !jsonObj.get("storageVersionHash").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `storageVersionHash` to be a primitive type in the JSON string but got `%s`", jsonObj.get("storageVersionHash").toString()));
      }
      // ensure the required json array is present
      if (jsonObj.get("verbs") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("verbs").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `verbs` to be an array in the JSON string but got `%s`", jsonObj.get("verbs").toString()));
      }
