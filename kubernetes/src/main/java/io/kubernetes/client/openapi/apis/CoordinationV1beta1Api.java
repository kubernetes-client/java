...
import io.kubernetes.client.openapi.models.V1beta1LeaseCandidate;
import io.kubernetes.client.openapi.models.V1beta1LeaseCandidateList;
...
public class CoordinationV1beta1Api {
    ...
    private okhttp3.Call createNamespacedLeaseCandidateCall(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable String fieldManager, @jakarta.annotation.Nullable String fieldValidation, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leasecandidates"
    ...
    private okhttp3.Call createNamespacedLeaseCandidateValidateBeforeCall(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable String fieldManager, @jakarta.annotation.Nullable String fieldValidation, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<V1beta1LeaseCandidate> createNamespacedLeaseCandidateWithHttpInfo(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable String fieldManager, @jakarta.annotation.Nullable String fieldValidation) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<V1beta1LeaseCandidate>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNamespacedLeaseCandidateAsync(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable String fieldManager, @jakarta.annotation.Nullable String fieldValidation, final ApiCallback<V1beta1LeaseCandidate> _callback) throws ApiException {
    ...
    public class APIcreateNamespacedLeaseCandidateRequest {
        ...
        @jakarta.annotation.Nonnull
        private final V1beta1LeaseCandidate body;
        ...
        private APIcreateNamespacedLeaseCandidateRequest(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body) {
       ...
       <caption>Response Details</caption>
         ...
         */
        public V1beta1LeaseCandidate execute() throws ApiException {
            ApiResponse<V1beta1LeaseCandidate> localVarResp = createNamespacedLeaseCandidateWithHttpInfo(namespace, body, pretty, dryRun, fieldManager, fieldValidation);
            return localVarResp.getData();
        }

        /**
         * Execute createNamespacedLeaseCandidate request with HTTP info returned
         * @return ApiResponse&lt;V1beta1LeaseCandidate&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<V1beta1LeaseCandidate> executeWithHttpInfo() throws ApiException {
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<V1beta1LeaseCandidate> _callback) throws ApiException {
     ...
     */
    public APIcreateNamespacedLeaseCandidateRequest createNamespacedLeaseCandidate(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body) {
    ...
    public class APIdeleteCollectionNamespacedLeaseCandidateRequest {
         ...
         * @return APIdeleteCollectionNamespacedLeaseCandidateRequest
         */
        public APIdeleteCollectionNamespacedLeaseCandidateRequest shardSelector(@jakarta.annotation.Nullable String shardSelector) {
    ...
    private okhttp3.Call deleteNamespacedLeaseCandidateCall(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable Integer gracePeriodSeconds, @jakarta.annotation.Nullable Boolean ignoreStoreReadErrorWithClusterBreakingPotential, @jakarta.annotation.Nullable Boolean orphanDependents, @jakarta.annotation.Nullable String propagationPolicy, @jakarta.annotation.Nullable V1DeleteOptions body, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leasecandidates/{name}"
    ...
    private okhttp3.Call listLeaseCandidateForAllNamespacesCall(@jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/apis/coordination.k8s.io/v1beta1/leasecandidates";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listLeaseCandidateForAllNamespacesValidateBeforeCall(@jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback _callback) throws ApiException {
        return listLeaseCandidateForAllNamespacesCall(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, _callback);

    }


    private ApiResponse<V1beta1LeaseCandidateList> listLeaseCandidateForAllNamespacesWithHttpInfo(@jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch) throws ApiException {
        okhttp3.Call localVarCall = listLeaseCandidateForAllNamespacesValidateBeforeCall(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, null);
        Type localVarReturnType = new TypeToken<V1beta1LeaseCandidateList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listLeaseCandidateForAllNamespacesAsync(@jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback<V1beta1LeaseCandidateList> _callback) throws ApiException {

        okhttp3.Call localVarCall = listLeaseCandidateForAllNamespacesValidateBeforeCall(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, _callback);
        Type localVarReturnType = new TypeToken<V1beta1LeaseCandidateList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIlistLeaseCandidateForAllNamespacesRequest {
         ...
         * @return APIlistLeaseCandidateForAllNamespacesRequest
         */
        public APIlistLeaseCandidateForAllNamespacesRequest shardSelector(@jakarta.annotation.Nullable String shardSelector) {
            this.shardSelector = shardSelector;
            return this;
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public V1beta1LeaseCandidateList execute() throws ApiException {
            ApiResponse<V1beta1LeaseCandidateList> localVarResp = listLeaseCandidateForAllNamespacesWithHttpInfo(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch);
            return localVarResp.getData();
        }

        /**
         * Execute listLeaseCandidateForAllNamespaces request with HTTP info returned
         * @return ApiResponse&lt;V1beta1LeaseCandidateList&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<V1beta1LeaseCandidateList> executeWithHttpInfo() throws ApiException {
            return listLeaseCandidateForAllNamespacesWithHttpInfo(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch);
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<V1beta1LeaseCandidateList> _callback) throws ApiException {
            return listLeaseCandidateForAllNamespacesAsync(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, _callback);
        }
    }
    ...
    private okhttp3.Call listNamespacedLeaseCandidateCall(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listNamespacedLeaseCandidateValidateBeforeCall(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'namespace' is set
        if (namespace == null) {
            throw new ApiException("Missing the required parameter 'namespace' when calling listNamespacedLeaseCandidate(Async)");
        }

        return listNamespacedLeaseCandidateCall(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, _callback);
    ...
    private ApiResponse<V1beta1LeaseCandidateList> listNamespacedLeaseCandidateWithHttpInfo(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch) throws ApiException {
        okhttp3.Call localVarCall = listNamespacedLeaseCandidateValidateBeforeCall(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, null);
        Type localVarReturnType = new TypeToken<V1beta1LeaseCandidateList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listNamespacedLeaseCandidateAsync(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable Boolean allowWatchBookmarks, @jakarta.annotation.Nullable String _continue, @jakarta.annotation.Nullable String fieldSelector, @jakarta.annotation.Nullable String labelSelector, @jakarta.annotation.Nullable Integer limit, @jakarta.annotation.Nullable String resourceVersion, @jakarta.annotation.Nullable String resourceVersionMatch, @jakarta.annotation.Nullable Boolean sendInitialEvents, @jakarta.annotation.Nullable String shardSelector, @jakarta.annotation.Nullable Integer timeoutSeconds, @jakarta.annotation.Nullable Boolean watch, final ApiCallback<V1beta1LeaseCandidateList> _callback) throws ApiException {

        okhttp3.Call localVarCall = listNamespacedLeaseCandidateValidateBeforeCall(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, _callback);
        Type localVarReturnType = new TypeToken<V1beta1LeaseCandidateList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIlistNamespacedLeaseCandidateRequest {
         ...
         * @return APIlistNamespacedLeaseCandidateRequest
         */
        public APIlistNamespacedLeaseCandidateRequest shardSelector(@jakarta.annotation.Nullable String shardSelector) {
            this.shardSelector = shardSelector;
            return this;
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public V1beta1LeaseCandidateList execute() throws ApiException {
            ApiResponse<V1beta1LeaseCandidateList> localVarResp = listNamespacedLeaseCandidateWithHttpInfo(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch);
            return localVarResp.getData();
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<V1beta1LeaseCandidateList> executeWithHttpInfo() throws ApiException {
            return listNamespacedLeaseCandidateWithHttpInfo(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch);
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<V1beta1LeaseCandidateList> _callback) throws ApiException {
            return listNamespacedLeaseCandidateAsync(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, shardSelector, timeoutSeconds, watch, _callback);
        }
    }
    ...
    private ApiResponse<V1beta1LeaseCandidate> patchNamespacedLeaseCandidateWithHttpInfo(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1Patch body, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable String fieldManager, @jakarta.annotation.Nullable String fieldValidation, @jakarta.annotation.Nullable Boolean force) throws ApiException {
    ...
    public class APIpatchNamespacedLeaseCandidateRequest {
       ...
       <caption>Response Details</caption>
         ...
         */
        public V1beta1LeaseCandidate execute() throws ApiException {
            ApiResponse<V1beta1LeaseCandidate> localVarResp = patchNamespacedLeaseCandidateWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
            return localVarResp.getData();
        }
    ...
    private ApiResponse<V1beta1LeaseCandidate> readNamespacedLeaseCandidateWithHttpInfo(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty) throws ApiException {
        okhttp3.Call localVarCall = readNamespacedLeaseCandidateValidateBeforeCall(name, namespace, pretty, null);
        Type localVarReturnType = new TypeToken<V1beta1LeaseCandidate>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call readNamespacedLeaseCandidateAsync(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nullable String pretty, final ApiCallback<V1beta1LeaseCandidate> _callback) throws ApiException {
    ...
    public class APIreadNamespacedLeaseCandidateRequest {
       ...
       <caption>Response Details</caption>
         ...
         */
        public V1beta1LeaseCandidate execute() throws ApiException {
            ApiResponse<V1beta1LeaseCandidate> localVarResp = readNamespacedLeaseCandidateWithHttpInfo(name, namespace, pretty);
            return localVarResp.getData();
        }
    ...
    private ApiResponse<V1beta1LeaseCandidate> replaceNamespacedLeaseCandidateWithHttpInfo(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable String fieldManager, @jakarta.annotation.Nullable String fieldValidation) throws ApiException {
    ...
    private okhttp3.Call replaceNamespacedLeaseCandidateAsync(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body, @jakarta.annotation.Nullable String pretty, @jakarta.annotation.Nullable String dryRun, @jakarta.annotation.Nullable String fieldManager, @jakarta.annotation.Nullable String fieldValidation, final ApiCallback<V1beta1LeaseCandidate> _callback) throws ApiException {
    ...
    public class APIreplaceNamespacedLeaseCandidateRequest {
        ...
        private APIreplaceNamespacedLeaseCandidateRequest(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body) {
            this.name = name;
            this.namespace = namespace;
            this.body = body;
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public V1beta1LeaseCandidate execute() throws ApiException {
            ApiResponse<V1beta1LeaseCandidate> localVarResp = replaceNamespacedLeaseCandidateWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
            return localVarResp.getData();
        }
     ...
     */
    public APIreplaceNamespacedLeaseCandidateRequest replaceNamespacedLeaseCandidate(@jakarta.annotation.Nonnull String name, @jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull V1beta1LeaseCandidate body) {
