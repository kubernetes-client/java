...
public class V1ReplicaSetCondition {
  ...
  public V1ReplicaSetCondition message(@jakarta.annotation.Nullable String message) {
  ...
  public V1ReplicaSetCondition reason(@jakarta.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public V1ReplicaSetCondition status(@jakarta.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public V1ReplicaSetCondition type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1ReplicaSetCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1ReplicaSetCondition is not found in the empty JSON string", V1ReplicaSetCondition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1ReplicaSetCondition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1ReplicaSetCondition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
