...
public class V1CapacityRequestPolicyRange {
  ...
  public V1CapacityRequestPolicyRange max(Quantity max) {
  ...
  **/
  ...
  public V1CapacityRequestPolicyRange min(Quantity min) {
  ...
  **/
  ...
  public V1CapacityRequestPolicyRange step(Quantity step) {
