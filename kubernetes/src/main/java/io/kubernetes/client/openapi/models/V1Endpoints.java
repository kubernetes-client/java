...
public class V1Endpoints implements io.kubernetes.client.common.KubernetesObject {
  ...
  @jakarta.annotation.Nullable
  private List<V1EndpointSubset> subsets = new ArrayList<>();

  public V1Endpoints() {
  }

  public V1Endpoints apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1Endpoints kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1Endpoints metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1Endpoints subsets(@jakarta.annotation.Nullable List<V1EndpointSubset> subsets) {
  ...
  public void setSubsets(@jakarta.annotation.Nullable List<V1EndpointSubset> subsets) {
    this.subsets = subsets;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("apiVersion", "kind", "metadata", "subsets"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1Endpoints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1Endpoints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1Endpoints is not found in the empty JSON string", V1Endpoints.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1Endpoints.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1Endpoints` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("subsets") != null && !jsonObj.get("subsets").isJsonNull()) {
        ...
        if (jsonArraysubsets != null) {
          ...
          if (!jsonObj.get("subsets").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `subsets` to be an array in the JSON string but got `%s`", jsonObj.get("subsets").toString()));
          }

          // validate the optional field `subsets` (array)
          for (int i = 0; i < jsonArraysubsets.size(); i++) {
            V1EndpointSubset.validateJsonElement(jsonArraysubsets.get(i));
          };
        }
      }
  }
