...
public class V1EndpointHints {
   ...
   */
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "forNodes indicates the node(s) this endpoint should be consumed by when using topology aware routing. May contain a maximum of 8 entries.")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1EndpointHints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1EndpointHints is not found in the empty JSON string", V1EndpointHints.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1EndpointHints.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1EndpointHints` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("forNodes") != null && !jsonObj.get("forNodes").isJsonNull()) {
        ...
        if (jsonArrayforNodes != null) {
          ...
          if (!jsonObj.get("forNodes").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `forNodes` to be an array in the JSON string but got `%s`", jsonObj.get("forNodes").toString()));
          }
      ...
      if (jsonObj.get("forZones") != null && !jsonObj.get("forZones").isJsonNull()) {
        ...
        if (jsonArrayforZones != null) {
          ...
          if (!jsonObj.get("forZones").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `forZones` to be an array in the JSON string but got `%s`", jsonObj.get("forZones").toString()));
          }
