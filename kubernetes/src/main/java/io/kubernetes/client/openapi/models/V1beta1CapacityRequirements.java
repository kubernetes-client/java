...
public class V1beta1CapacityRequirements {
  ...
  public V1beta1CapacityRequirements requests(@jakarta.annotation.Nullable Map<String, Quantity> requests) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1CapacityRequirements
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1CapacityRequirements.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1CapacityRequirements is not found in the empty JSON string", V1beta1CapacityRequirements.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1CapacityRequirements.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1CapacityRequirements` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1CapacityRequirements.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1CapacityRequirements' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1CapacityRequirements> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1CapacityRequirements.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1CapacityRequirements>() {
           @Override
           public void write(JsonWriter out, V1beta1CapacityRequirements value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1CapacityRequirements read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1CapacityRequirements given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1CapacityRequirements
   * @throws IOException if the JSON string is invalid with respect to V1beta1CapacityRequirements
   */
  public static V1beta1CapacityRequirements fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1CapacityRequirements.class);
  }

  /**
   * Convert an instance of V1beta1CapacityRequirements to an JSON string
   *
   * @return JSON string
   */
