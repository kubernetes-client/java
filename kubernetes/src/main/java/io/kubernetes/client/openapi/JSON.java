...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1ClusterCIDR.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1ClusterCIDRList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1ClusterCIDRSpec.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2ExemptPriorityLevelConfiguration.CustomTypeAdapterFactory());
