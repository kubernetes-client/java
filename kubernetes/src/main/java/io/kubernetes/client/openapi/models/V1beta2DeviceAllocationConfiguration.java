...
public class V1beta2DeviceAllocationConfiguration {
  ...
  public V1beta2DeviceAllocationConfiguration opaque(V1beta2OpaqueDeviceConfiguration opaque) {
  ...
  **/
  ...
  public void setOpaque(V1beta2OpaqueDeviceConfiguration opaque) {
    this.opaque = opaque;
  }


  public V1beta2DeviceAllocationConfiguration requests(List<String> requests) {
  ...
  **/
  ...
  public V1beta2DeviceAllocationConfiguration source(String source) {
