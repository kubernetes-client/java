...
public class V2MetricValueStatus {
  ...
  public V2MetricValueStatus averageUtilization(@jakarta.annotation.Nullable Integer averageUtilization) {
  ...
  public V2MetricValueStatus averageValue(@jakarta.annotation.Nullable Quantity averageValue) {
  ...
  public V2MetricValueStatus value(@jakarta.annotation.Nullable Quantity value) {
    this.value = value;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("averageUtilization", "averageValue", "value"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V2MetricValueStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V2MetricValueStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V2MetricValueStatus is not found in the empty JSON string", V2MetricValueStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V2MetricValueStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V2MetricValueStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("averageValue") != null && !jsonObj.get("averageValue").isJsonNull()) && !jsonObj.get("averageValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `averageValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("averageValue").toString()));
      }
