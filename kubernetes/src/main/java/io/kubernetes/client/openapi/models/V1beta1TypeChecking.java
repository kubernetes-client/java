...
public class V1beta1TypeChecking {
  ...
  public V1beta1TypeChecking expressionWarnings(@jakarta.annotation.Nullable List<V1beta1ExpressionWarning> expressionWarnings) {
  ...
  public void setExpressionWarnings(@jakarta.annotation.Nullable List<V1beta1ExpressionWarning> expressionWarnings) {
    this.expressionWarnings = expressionWarnings;
  }
