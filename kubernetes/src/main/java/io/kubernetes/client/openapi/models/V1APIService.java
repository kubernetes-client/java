...
public class V1APIService implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1APIService apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V1APIService kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V1APIService metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V1APIService spec(@jakarta.annotation.Nullable V1APIServiceSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V1APIServiceSpec spec) {
    this.spec = spec;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1APIService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1APIService is not found in the empty JSON string", V1APIService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1APIService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1APIService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
