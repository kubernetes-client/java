...
public class V1beta2ExactDeviceRequest {
  ...
  public V1beta2ExactDeviceRequest adminAccess(Boolean adminAccess) {
  ...
  **/
  ...
  public V1beta2ExactDeviceRequest allocationMode(String allocationMode) {
  ...
  **/
  ...
  public V1beta2ExactDeviceRequest count(Long count) {
  ...
  **/
  ...
  public V1beta2ExactDeviceRequest deviceClassName(String deviceClassName) {
  ...
  **/
  ...
  public V1beta2ExactDeviceRequest selectors(List<V1beta2DeviceSelector> selectors) {
  ...
  **/
  ...
  public V1beta2ExactDeviceRequest tolerations(List<V1beta2DeviceToleration> tolerations) {
