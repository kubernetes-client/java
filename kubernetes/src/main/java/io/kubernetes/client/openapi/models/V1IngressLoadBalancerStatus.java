...
public class V1IngressLoadBalancerStatus {
  ...
  public V1IngressLoadBalancerStatus ingress(@jakarta.annotation.Nullable List<V1IngressLoadBalancerIngress> ingress) {
  ...
  public void setIngress(@jakarta.annotation.Nullable List<V1IngressLoadBalancerIngress> ingress) {
    this.ingress = ingress;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ingress"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1IngressLoadBalancerStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1IngressLoadBalancerStatus is not found in the empty JSON string", V1IngressLoadBalancerStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1IngressLoadBalancerStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1IngressLoadBalancerStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
