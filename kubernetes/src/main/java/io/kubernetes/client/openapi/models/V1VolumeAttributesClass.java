...
public class V1VolumeAttributesClass implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1VolumeAttributesClass apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1VolumeAttributesClass driverName(String driverName) {
  ...
  **/
  ...
  public V1VolumeAttributesClass kind(String kind) {
  ...
  **/
  ...
  public V1VolumeAttributesClass metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1VolumeAttributesClass parameters(Map<String, String> parameters) {
