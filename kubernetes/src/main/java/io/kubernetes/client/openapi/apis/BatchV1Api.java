...
public class BatchV1Api {
  ...
  private okhttp3.Call createNamespacedJobValidateBeforeCall(
    ...
    okhttp3.Call localVarCall =
        createNamespacedJobCall(namespace, body, pretty, dryRun, fieldManager, _callback);
    return localVarCall;
  }
  ...
  public V1Job createNamespacedJob(
    ...
    ApiResponse<V1Job> localVarResp =
        createNamespacedJobWithHttpInfo(namespace, body, pretty, dryRun, fieldManager);
  ...
  public ApiResponse<V1Job> createNamespacedJobWithHttpInfo(
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        createNamespacedJobValidateBeforeCall(namespace, body, pretty, dryRun, fieldManager, null);
  ...
  public V1Job patchNamespacedJob(
      ...
      throws ApiException {
    ApiResponse<V1Job> localVarResp =
        patchNamespacedJobWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, force);
    return localVarResp.getData();
  }
  ...
  private okhttp3.Call readNamespacedJobValidateBeforeCall(
    ...
    okhttp3.Call localVarCall =
        readNamespacedJobCall(name, namespace, pretty, exact, export, _callback);
    return localVarCall;
  }
   ...
   * </table>
   */
  public V1Job readNamespacedJob(
      String name, String namespace, String pretty, Boolean exact, Boolean export)
      throws ApiException {
    ApiResponse<V1Job> localVarResp =
        readNamespacedJobWithHttpInfo(name, namespace, pretty, exact, export);
    return localVarResp.getData();
  }
  ...
  public ApiResponse<V1Job> readNamespacedJobWithHttpInfo(
      ...
      throws ApiException {
    okhttp3.Call localVarCall =
        readNamespacedJobValidateBeforeCall(name, namespace, pretty, exact, export, null);
    Type localVarReturnType = new TypeToken<V1Job>() {}.getType();
    return localVarApiClient.execute(localVarCall, localVarReturnType);
  }
  ...
  public okhttp3.Call readNamespacedJobAsync(
    ...
    okhttp3.Call localVarCall =
        readNamespacedJobValidateBeforeCall(name, namespace, pretty, exact, export, _callback);
    Type localVarReturnType = new TypeToken<V1Job>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
  ...
  private okhttp3.Call replaceNamespacedJobValidateBeforeCall(
    ...
    okhttp3.Call localVarCall =
        replaceNamespacedJobCall(name, namespace, body, pretty, dryRun, fieldManager, _callback);
    return localVarCall;
  }
  ...
  public V1Job replaceNamespacedJob(
      ...
      throws ApiException {
    ApiResponse<V1Job> localVarResp =
        replaceNamespacedJobWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager);
    return localVarResp.getData();
  }
  ...
  public V1Job replaceNamespacedJobStatus(
      ...
      throws ApiException {
    ApiResponse<V1Job> localVarResp =
        replaceNamespacedJobStatusWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager);
    return localVarResp.getData();
  }
