...
public class V1beta1DeviceToleration {
  ...
  public V1beta1DeviceToleration effect(String effect) {
  ...
  **/
  ...
  public V1beta1DeviceToleration key(String key) {
  ...
  **/
  ...
  public V1beta1DeviceToleration operator(String operator) {
  ...
  **/
  ...
  public V1beta1DeviceToleration tolerationSeconds(Long tolerationSeconds) {
  ...
  **/
  ...
  public V1beta1DeviceToleration value(String value) {
