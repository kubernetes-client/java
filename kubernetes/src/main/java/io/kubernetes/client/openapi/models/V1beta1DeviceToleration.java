...
public class V1beta1DeviceToleration {
  ...
  public V1beta1DeviceToleration() {
  }

  public V1beta1DeviceToleration effect(@jakarta.annotation.Nullable String effect) {
    this.effect = effect;
    return this;
  }
  ...
  public V1beta1DeviceToleration key(@jakarta.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public V1beta1DeviceToleration operator(@jakarta.annotation.Nullable String operator) {
  ...
  public V1beta1DeviceToleration tolerationSeconds(@jakarta.annotation.Nullable Long tolerationSeconds) {
  ...
  public V1beta1DeviceToleration value(@jakarta.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    V1beta1DeviceToleration v1beta1DeviceToleration = (V1beta1DeviceToleration) o;
    return Objects.equals(this.effect, v1beta1DeviceToleration.effect) &&
        Objects.equals(this.key, v1beta1DeviceToleration.key) &&
        Objects.equals(this.operator, v1beta1DeviceToleration.operator) &&
        Objects.equals(this.tolerationSeconds, v1beta1DeviceToleration.tolerationSeconds) &&
        Objects.equals(this.value, v1beta1DeviceToleration.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1DeviceToleration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta1DeviceToleration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1DeviceToleration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1DeviceToleration is not found in the empty JSON string", V1beta1DeviceToleration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1DeviceToleration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1DeviceToleration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1DeviceToleration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1DeviceToleration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1DeviceToleration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1DeviceToleration.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1DeviceToleration>() {
           @Override
           public void write(JsonWriter out, V1beta1DeviceToleration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1DeviceToleration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1beta1DeviceToleration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1beta1DeviceToleration
   * @throws IOException if the JSON string is invalid with respect to V1beta1DeviceToleration
   */
  public static V1beta1DeviceToleration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1DeviceToleration.class);
  }

  /**
   * Convert an instance of V1beta1DeviceToleration to an JSON string
   *
   * @return JSON string
   */
