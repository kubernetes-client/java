...
public class V2HorizontalPodAutoscaler implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V2HorizontalPodAutoscaler apiVersion(@jakarta.annotation.Nullable String apiVersion) {
  ...
  public V2HorizontalPodAutoscaler kind(@jakarta.annotation.Nullable String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public V2HorizontalPodAutoscaler metadata(@jakarta.annotation.Nullable V1ObjectMeta metadata) {
  ...
  public V2HorizontalPodAutoscaler spec(@jakarta.annotation.Nonnull V2HorizontalPodAutoscalerSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nonnull V2HorizontalPodAutoscalerSpec spec) {
    this.spec = spec;
  }


  public V2HorizontalPodAutoscaler status(@jakarta.annotation.Nullable V2HorizontalPodAutoscalerStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@jakarta.annotation.Nullable V2HorizontalPodAutoscalerStatus status) {
    this.status = status;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V2HorizontalPodAutoscaler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V2HorizontalPodAutoscaler is not found in the empty JSON string", V2HorizontalPodAutoscaler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V2HorizontalPodAutoscaler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V2HorizontalPodAutoscaler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V2HorizontalPodAutoscaler.openapiRequiredFields) {
