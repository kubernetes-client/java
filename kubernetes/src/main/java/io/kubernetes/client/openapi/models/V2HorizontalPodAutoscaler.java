...
public class V2HorizontalPodAutoscaler implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V2HorizontalPodAutoscaler spec(@jakarta.annotation.Nullable V2HorizontalPodAutoscalerSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public void setSpec(@jakarta.annotation.Nullable V2HorizontalPodAutoscalerSpec spec) {
    this.spec = spec;
  }
