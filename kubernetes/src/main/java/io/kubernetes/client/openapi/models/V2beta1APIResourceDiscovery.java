...
import io.kubernetes.client.openapi.models.V2beta1APISubresourceDiscovery;
...
public class V2beta1APIResourceDiscovery {
  ...
  @jakarta.annotation.Nullable
  private List<V2beta1APISubresourceDiscovery> subresources = new ArrayList<>();

  public V2beta1APIResourceDiscovery() {
  }

  public V2beta1APIResourceDiscovery resource(@jakarta.annotation.Nonnull String resource) {
  ...
  public V2beta1APIResourceDiscovery responseKind(@jakarta.annotation.Nullable V1GroupVersionKind responseKind) {
  ...
  public V2beta1APIResourceDiscovery scope(@jakarta.annotation.Nonnull String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public V2beta1APIResourceDiscovery singularResource(@jakarta.annotation.Nonnull String singularResource) {
  ...
  public V2beta1APIResourceDiscovery verbs(@jakarta.annotation.Nonnull List<String> verbs) {
    this.verbs = verbs;
    return this;
  }

  public V2beta1APIResourceDiscovery addVerbsItem(String verbsItem) {
    if (this.verbs == null) {
  ...
  public V2beta1APIResourceDiscovery shortNames(@jakarta.annotation.Nullable List<String> shortNames) {
    this.shortNames = shortNames;
    return this;
  }

  public V2beta1APIResourceDiscovery addShortNamesItem(String shortNamesItem) {
  ...
  public V2beta1APIResourceDiscovery categories(@jakarta.annotation.Nullable List<String> categories) {
    this.categories = categories;
    return this;
  }

  public V2beta1APIResourceDiscovery addCategoriesItem(String categoriesItem) {
  ...
  public V2beta1APIResourceDiscovery subresources(@jakarta.annotation.Nullable List<V2beta1APISubresourceDiscovery> subresources) {
  ...
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "")
  public List<V2beta1APISubresourceDiscovery> getSubresources() {
    return subresources;
  }

  public void setSubresources(@jakarta.annotation.Nullable List<V2beta1APISubresourceDiscovery> subresources) {
    this.subresources = subresources;
  }
  ...
  public boolean equals(Object o) {
    ...
    V2beta1APIResourceDiscovery v2beta1APIResourceDiscovery = (V2beta1APIResourceDiscovery) o;
    return Objects.equals(this.resource, v2beta1APIResourceDiscovery.resource) &&
        Objects.equals(this.responseKind, v2beta1APIResourceDiscovery.responseKind) &&
        Objects.equals(this.scope, v2beta1APIResourceDiscovery.scope) &&
        Objects.equals(this.singularResource, v2beta1APIResourceDiscovery.singularResource) &&
        Objects.equals(this.verbs, v2beta1APIResourceDiscovery.verbs) &&
        Objects.equals(this.shortNames, v2beta1APIResourceDiscovery.shortNames) &&
        Objects.equals(this.categories, v2beta1APIResourceDiscovery.categories) &&
        Objects.equals(this.subresources, v2beta1APIResourceDiscovery.subresources);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2beta1APIResourceDiscovery {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V2beta1APIResourceDiscovery
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V2beta1APIResourceDiscovery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V2beta1APIResourceDiscovery is not found in the empty JSON string", V2beta1APIResourceDiscovery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V2beta1APIResourceDiscovery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V2beta1APIResourceDiscovery` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V2beta1APIResourceDiscovery.openapiRequiredFields) {
      ...
      if (jsonObj.get("subresources") != null && !jsonObj.get("subresources").isJsonNull()) {
        ...
        if (jsonArraysubresources != null) {
          ...
          for (int i = 0; i < jsonArraysubresources.size(); i++) {
            V2beta1APISubresourceDiscovery.validateJsonElement(jsonArraysubresources.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V2beta1APIResourceDiscovery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V2beta1APIResourceDiscovery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V2beta1APIResourceDiscovery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V2beta1APIResourceDiscovery.class));

       return (TypeAdapter<T>) new TypeAdapter<V2beta1APIResourceDiscovery>() {
           @Override
           public void write(JsonWriter out, V2beta1APIResourceDiscovery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V2beta1APIResourceDiscovery read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V2beta1APIResourceDiscovery given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V2beta1APIResourceDiscovery
   * @throws IOException if the JSON string is invalid with respect to V2beta1APIResourceDiscovery
   */
  public static V2beta1APIResourceDiscovery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V2beta1APIResourceDiscovery.class);
  }

  /**
   * Convert an instance of V2beta1APIResourceDiscovery to an JSON string
   *
   * @return JSON string
   */
