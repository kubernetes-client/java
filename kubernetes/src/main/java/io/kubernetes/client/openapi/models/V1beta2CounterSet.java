...
public class V1beta2CounterSet {
  ...
  public V1beta2CounterSet counters(@jakarta.annotation.Nonnull Map<String, V1beta2Counter> counters) {
  ...
  public V1beta2CounterSet name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1beta2CounterSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta2CounterSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta2CounterSet is not found in the empty JSON string", V1beta2CounterSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta2CounterSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta2CounterSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta2CounterSet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta2CounterSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta2CounterSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta2CounterSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta2CounterSet.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta2CounterSet>() {
           @Override
           public void write(JsonWriter out, V1beta2CounterSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta2CounterSet read(JsonReader in) throws IOException {
   ...
   * @return An instance of V1beta2CounterSet
   * @throws IOException if the JSON string is invalid with respect to V1beta2CounterSet
   */
  public static V1beta2CounterSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta2CounterSet.class);
  }
