...
public class V1PodAntiAffinity {
  ...
  public V1PodAntiAffinity preferredDuringSchedulingIgnoredDuringExecution(
  ...
  public V1PodAntiAffinity addPreferredDuringSchedulingIgnoredDuringExecutionItem(
      V1WeightedPodAffinityTerm preferredDuringSchedulingIgnoredDuringExecutionItem) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {
      this.preferredDuringSchedulingIgnoredDuringExecution =
          new ArrayList<V1WeightedPodAffinityTerm>();
    }
  ...
  public V1PodAntiAffinity addRequiredDuringSchedulingIgnoredDuringExecutionItem(
