...
public class V1NamedRuleWithOperations {
  ...
  public V1NamedRuleWithOperations apiGroups(@jakarta.annotation.Nullable List<String> apiGroups) {
  ...
  public V1NamedRuleWithOperations apiVersions(@jakarta.annotation.Nullable List<String> apiVersions) {
  ...
  public V1NamedRuleWithOperations operations(@jakarta.annotation.Nullable List<String> operations) {
  ...
  public V1NamedRuleWithOperations resourceNames(@jakarta.annotation.Nullable List<String> resourceNames) {
  ...
  public V1NamedRuleWithOperations resources(@jakarta.annotation.Nullable List<String> resources) {
  ...
  public V1NamedRuleWithOperations scope(@jakarta.annotation.Nullable String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1NamedRuleWithOperations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1NamedRuleWithOperations is not found in the empty JSON string", V1NamedRuleWithOperations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1NamedRuleWithOperations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1NamedRuleWithOperations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
