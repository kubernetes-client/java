...
public class SchedulingV1Api {
   ...
   * </table>
   */
  public V1PriorityClassList listPriorityClass(
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
      ...
      Boolean watch)
      throws ApiException {
    ApiResponse<V1PriorityClassList> localVarResp =
   ...
   * </table>
   */
  public ApiResponse<V1PriorityClassList> listPriorityClassWithHttpInfo(
      String pretty,
      Boolean allowWatchBookmarks,
      String _continue,
      String fieldSelector,
  ...
  public okhttp3.Call listPriorityClassAsync(
      ...
      Integer timeoutSeconds,
      Boolean watch,
      final ApiCallback<V1PriorityClassList> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call readPriorityClassCall(String name, String pretty, final ApiCallback _callback)
      throws ApiException {
    Object localVarPostBody = null;
   ...
   * </table>
   */
  public ApiResponse<V1PriorityClass> readPriorityClassWithHttpInfo(String name, String pretty)
      throws ApiException {
  ...
  public okhttp3.Call readPriorityClassAsync(
      String name, String pretty, final ApiCallback<V1PriorityClass> _callback)
      throws ApiException {
