...
public class V1alpha1NamedRuleWithOperations {
  ...
  public V1alpha1NamedRuleWithOperations apiGroups(@jakarta.annotation.Nullable List<String> apiGroups) {
  ...
  public V1alpha1NamedRuleWithOperations apiVersions(@jakarta.annotation.Nullable List<String> apiVersions) {
  ...
  public V1alpha1NamedRuleWithOperations operations(@jakarta.annotation.Nullable List<String> operations) {
  ...
  public V1alpha1NamedRuleWithOperations resourceNames(@jakarta.annotation.Nullable List<String> resourceNames) {
  ...
  public V1alpha1NamedRuleWithOperations resources(@jakarta.annotation.Nullable List<String> resources) {
  ...
  public V1alpha1NamedRuleWithOperations scope(@jakarta.annotation.Nullable String scope) {
    this.scope = scope;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("apiGroups", "apiVersions", "operations", "resourceNames", "resources", "scope"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1alpha1NamedRuleWithOperations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha1NamedRuleWithOperations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1alpha1NamedRuleWithOperations is not found in the empty JSON string", V1alpha1NamedRuleWithOperations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1NamedRuleWithOperations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha1NamedRuleWithOperations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("apiGroups") != null && !jsonObj.get("apiGroups").isJsonNull() && !jsonObj.get("apiGroups").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `apiGroups` to be an array in the JSON string but got `%s`", jsonObj.get("apiGroups").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("apiVersions") != null && !jsonObj.get("apiVersions").isJsonNull() && !jsonObj.get("apiVersions").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `apiVersions` to be an array in the JSON string but got `%s`", jsonObj.get("apiVersions").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("resourceNames") != null && !jsonObj.get("resourceNames").isJsonNull() && !jsonObj.get("resourceNames").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `resourceNames` to be an array in the JSON string but got `%s`", jsonObj.get("resourceNames").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1NamedRuleWithOperations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1NamedRuleWithOperations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1NamedRuleWithOperations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1NamedRuleWithOperations.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1NamedRuleWithOperations>() {
           @Override
           public void write(JsonWriter out, V1alpha1NamedRuleWithOperations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1NamedRuleWithOperations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1alpha1NamedRuleWithOperations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1alpha1NamedRuleWithOperations
   * @throws IOException if the JSON string is invalid with respect to V1alpha1NamedRuleWithOperations
   */
  public static V1alpha1NamedRuleWithOperations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1alpha1NamedRuleWithOperations.class);
  }

  /**
   * Convert an instance of V1alpha1NamedRuleWithOperations to an JSON string
   *
   * @return JSON string
   */
