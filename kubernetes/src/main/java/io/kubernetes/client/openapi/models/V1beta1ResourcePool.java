...
public class V1beta1ResourcePool {
  ...
  public V1beta1ResourcePool generation(@jakarta.annotation.Nonnull Long generation) {
  ...
  public V1beta1ResourcePool name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public V1beta1ResourcePool resourceSliceCount(@jakarta.annotation.Nonnull Long resourceSliceCount) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1ResourcePool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1beta1ResourcePool is not found in the empty JSON string", V1beta1ResourcePool.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1ResourcePool.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1ResourcePool` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
