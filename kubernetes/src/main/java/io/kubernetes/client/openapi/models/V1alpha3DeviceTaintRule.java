...
import io.kubernetes.client.openapi.models.V1alpha3DeviceTaintRuleStatus;
...
public class V1alpha3DeviceTaintRule implements io.kubernetes.client.common.KubernetesObject {
  ...
  @jakarta.annotation.Nullable
  private V1alpha3DeviceTaintRuleStatus status;
  ...
  public V1alpha3DeviceTaintRule status(@jakarta.annotation.Nullable V1alpha3DeviceTaintRuleStatus status) {
    this.status = status;
    return this;
  }
  ...
  @jakarta.annotation.Nullable
  @ApiModelProperty(value = "")
  public V1alpha3DeviceTaintRuleStatus getStatus() {
    return status;
  }

  public void setStatus(@jakarta.annotation.Nullable V1alpha3DeviceTaintRuleStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiVersion, v1alpha3DeviceTaintRule.apiVersion) &&
        ...
        Objects.equals(this.status, v1alpha3DeviceTaintRule.status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1alpha3DeviceTaintRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in V1alpha3DeviceTaintRule is not found in the empty JSON string", V1alpha3DeviceTaintRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1alpha3DeviceTaintRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1alpha3DeviceTaintRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        V1alpha3DeviceTaintRuleStatus.validateJsonElement(jsonObj.get("status"));
      }
  }
