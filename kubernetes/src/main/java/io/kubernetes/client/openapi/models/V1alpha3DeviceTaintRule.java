...
public class V1alpha3DeviceTaintRule implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1alpha3DeviceTaintRule apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha3DeviceTaintRule kind(String kind) {
  ...
  **/
  ...
  public V1alpha3DeviceTaintRule metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1alpha3DeviceTaintRule spec(V1alpha3DeviceTaintRuleSpec spec) {
  ...
  **/
  ...
  public void setSpec(V1alpha3DeviceTaintRuleSpec spec) {
    this.spec = spec;
  }
