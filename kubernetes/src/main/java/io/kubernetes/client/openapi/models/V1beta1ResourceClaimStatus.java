...
public class V1beta1ResourceClaimStatus {
  ...
  public V1beta1ResourceClaimStatus allocation(@jakarta.annotation.Nullable V1beta1AllocationResult allocation) {
  ...
  public void setAllocation(@jakarta.annotation.Nullable V1beta1AllocationResult allocation) {
    this.allocation = allocation;
  }


  public V1beta1ResourceClaimStatus devices(@jakarta.annotation.Nullable List<V1beta1AllocatedDeviceStatus> devices) {
  ...
  public void setDevices(@jakarta.annotation.Nullable List<V1beta1AllocatedDeviceStatus> devices) {
    this.devices = devices;
  }


  public V1beta1ResourceClaimStatus reservedFor(@jakarta.annotation.Nullable List<V1beta1ResourceClaimConsumerReference> reservedFor) {
  ...
  public void setReservedFor(@jakarta.annotation.Nullable List<V1beta1ResourceClaimConsumerReference> reservedFor) {
    this.reservedFor = reservedFor;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1beta1ResourceClaimStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in V1beta1ResourceClaimStatus is not found in the empty JSON string", V1beta1ResourceClaimStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1beta1ResourceClaimStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `V1beta1ResourceClaimStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
