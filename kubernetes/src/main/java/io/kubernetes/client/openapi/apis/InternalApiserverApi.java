...
public class InternalApiserverApi {
  ...
  public InternalApiserverApi() {
    this(Configuration.getDefaultApiClient());
  }

  public InternalApiserverApi(ApiClient apiClient) {
  ...
  public okhttp3.Call getAPIGroupCall(final ApiCallback _callback) throws ApiException {
    ...
    String localVarPath = "/apis/internal.apiserver.k8s.io/";
  ...
  private okhttp3.Call getAPIGroupValidateBeforeCall(final ApiCallback _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getAPIGroupAsync(final ApiCallback<V1APIGroup> _callback)
      throws ApiException {
