...
public class VersionApi {
  ...
  private Call getCodeValidateBeforeCall(
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {

    Call call = getCodeCall(progressListener, progressRequestListener);
    return call;
  }
  ...
  public ApiResponse<VersionInfo> getCodeWithHttpInfo() throws ApiException {
    Call call = getCodeValidateBeforeCall(null, null);
   ...
   */
  public Call getCodeAsync(final ApiCallback<VersionInfo> callback) throws ApiException {
    ...
    Call call = getCodeValidateBeforeCall(progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<VersionInfo>() {}.getType();
