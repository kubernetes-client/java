...
public class ApiextensionsV1beta1Api {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call patchCustomResourceDefinitionStatusCall(String name, Object body, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call patchCustomResourceDefinitionStatusValidateBeforeCall(String name, Object body, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = patchCustomResourceDefinitionStatusCall(name, body, pretty, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V1beta1CustomResourceDefinition patchCustomResourceDefinitionStatus(String name, Object body, String pretty) throws ApiException {
        ApiResponse<V1beta1CustomResourceDefinition> resp = patchCustomResourceDefinitionStatusWithHttpInfo(name, body, pretty);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1beta1CustomResourceDefinition> patchCustomResourceDefinitionStatusWithHttpInfo(String name, Object body, String pretty) throws ApiException {
        com.squareup.okhttp.Call call = patchCustomResourceDefinitionStatusValidateBeforeCall(name, body, pretty, null, null);
        Type localVarReturnType = new TypeToken<V1beta1CustomResourceDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call patchCustomResourceDefinitionStatusAsync(String name, Object body, String pretty, final ApiCallback<V1beta1CustomResourceDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = patchCustomResourceDefinitionStatusValidateBeforeCall(name, body, pretty, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1beta1CustomResourceDefinition>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
