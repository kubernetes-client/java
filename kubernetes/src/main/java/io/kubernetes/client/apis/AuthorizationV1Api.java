...
public class AuthorizationV1Api {
   ...
   */
  public Call createNamespacedLocalSubjectAccessReviewCall(
      String namespace,
  ...
  public V1LocalSubjectAccessReview createNamespacedLocalSubjectAccessReview(
      ...
      String pretty)
      throws ApiException {
    ApiResponse<V1LocalSubjectAccessReview> resp =
        createNamespacedLocalSubjectAccessReviewWithHttpInfo(
            namespace, body, dryRun, includeUninitialized, pretty);
    return resp.getData();
  }
   ...
   */
  public Call createNamespacedLocalSubjectAccessReviewAsync(
      String namespace,
      V1LocalSubjectAccessReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
      final ApiCallback<V1LocalSubjectAccessReview> callback)
      throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call createSelfSubjectAccessReviewCall(
  ...
  @SuppressWarnings("rawtypes")
  private Call createSelfSubjectAccessReviewValidateBeforeCall(
      V1SelfSubjectAccessReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
    ...
    Call call =
        createSelfSubjectAccessReviewCall(
            body, dryRun, includeUninitialized, pretty, progressListener, progressRequestListener);
    return call;
  }
  ...
  public V1SelfSubjectAccessReview createSelfSubjectAccessReview(
      V1SelfSubjectAccessReview body, String dryRun, Boolean includeUninitialized, String pretty)
      throws ApiException {
    ApiResponse<V1SelfSubjectAccessReview> resp =
        createSelfSubjectAccessReviewWithHttpInfo(body, dryRun, includeUninitialized, pretty);
    return resp.getData();
  }
  ...
  public ApiResponse<V1SelfSubjectAccessReview> createSelfSubjectAccessReviewWithHttpInfo(
    ...
    Call call =
        createSelfSubjectAccessReviewValidateBeforeCall(
            body, dryRun, includeUninitialized, pretty, null, null);
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call createSelfSubjectAccessReviewAsync(
      V1SelfSubjectAccessReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
      final ApiCallback<V1SelfSubjectAccessReview> callback)
      throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call createSelfSubjectRulesReviewCall(
  ...
  @SuppressWarnings("rawtypes")
  private Call createSelfSubjectRulesReviewValidateBeforeCall(
      V1SelfSubjectRulesReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
  ...
  public V1SelfSubjectRulesReview createSelfSubjectRulesReview(
      V1SelfSubjectRulesReview body, String dryRun, Boolean includeUninitialized, String pretty)
      throws ApiException {
    ApiResponse<V1SelfSubjectRulesReview> resp =
        createSelfSubjectRulesReviewWithHttpInfo(body, dryRun, includeUninitialized, pretty);
    return resp.getData();
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call createSelfSubjectRulesReviewAsync(
      V1SelfSubjectRulesReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
      final ApiCallback<V1SelfSubjectRulesReview> callback)
      throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call createSubjectAccessReviewCall(
  ...
  @SuppressWarnings("rawtypes")
  private Call createSubjectAccessReviewValidateBeforeCall(
      V1SubjectAccessReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
  ...
  public V1SubjectAccessReview createSubjectAccessReview(
      V1SubjectAccessReview body, String dryRun, Boolean includeUninitialized, String pretty)
      throws ApiException {
    ApiResponse<V1SubjectAccessReview> resp =
        createSubjectAccessReviewWithHttpInfo(body, dryRun, includeUninitialized, pretty);
    return resp.getData();
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call createSubjectAccessReviewAsync(
      V1SubjectAccessReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
      final ApiCallback<V1SubjectAccessReview> callback)
      throws ApiException {
