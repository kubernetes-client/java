...
public class CoreApi {
   ...
   */
  public Call getAPIVersionsCall(
  ...
  private Call getAPIVersionsValidateBeforeCall(
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {

    Call call = getAPIVersionsCall(progressListener, progressRequestListener);
    return call;
  }
   ...
   */
  public Call getAPIVersionsAsync(final ApiCallback<V1APIVersions> callback) throws ApiException {
