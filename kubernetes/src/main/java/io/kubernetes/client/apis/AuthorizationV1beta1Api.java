...
public class AuthorizationV1beta1Api {
    ...
    private com.squareup.okhttp.Call createNamespacedLocalSubjectAccessReviewCall(String namespace, V1beta1LocalSubjectAccessReview body, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public V1beta1LocalSubjectAccessReview createNamespacedLocalSubjectAccessReview(String namespace, V1beta1LocalSubjectAccessReview body, String pretty) throws ApiException {
        ApiResponse<V1beta1LocalSubjectAccessReview> resp = createNamespacedLocalSubjectAccessReviewWithHttpInfo(namespace, body, pretty);
        return resp.getData();
    }
