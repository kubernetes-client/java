...
public class AuthorizationV1beta1Api {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V1beta1SelfSubjectRulesReview createSelfSubjectRulesReview(V1beta1SelfSubjectRulesReview body, String pretty) throws ApiException {
        ApiResponse<V1beta1SelfSubjectRulesReview> resp = createSelfSubjectRulesReviewWithHttpInfo(body, pretty);
        return resp.getData();
    }
