...
public class AuthenticationV1beta1Api {
   ...
   */
  public Call createTokenReviewCall(
  ...
  private Call createTokenReviewValidateBeforeCall(
      V1beta1TokenReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
  ...
  public V1beta1TokenReview createTokenReview(
      V1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty)
      throws ApiException {
    ApiResponse<V1beta1TokenReview> resp =
        createTokenReviewWithHttpInfo(body, dryRun, includeUninitialized, pretty);
    return resp.getData();
  }
  ...
  public ApiResponse<V1beta1TokenReview> createTokenReviewWithHttpInfo(
      ...
      throws ApiException {
    Call call =
        createTokenReviewValidateBeforeCall(body, dryRun, includeUninitialized, pretty, null, null);
   ...
   */
  public Call createTokenReviewAsync(
      V1beta1TokenReview body,
      String dryRun,
      Boolean includeUninitialized,
      String pretty,
      final ApiCallback<V1beta1TokenReview> callback)
      throws ApiException {
