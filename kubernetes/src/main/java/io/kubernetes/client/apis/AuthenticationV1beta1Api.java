...
public class AuthenticationV1beta1Api {
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewCall(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createTokenReviewValidateBeforeCall(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createTokenReviewCall(body, dryRun, fieldManager, pretty, progressListener, progressRequestListener);
        return call;
    ...
    public V1beta1TokenReview createTokenReview(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty) throws ApiException {
        ApiResponse<V1beta1TokenReview> resp = createTokenReviewWithHttpInfo(body, dryRun, fieldManager, pretty);
        return resp.getData();
    }
    ...
    public ApiResponse<V1beta1TokenReview> createTokenReviewWithHttpInfo(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty) throws ApiException {
        com.squareup.okhttp.Call call = createTokenReviewValidateBeforeCall(body, dryRun, fieldManager, pretty, null, null);
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewAsync(V1beta1TokenReview body, String dryRun, String fieldManager, String pretty, final ApiCallback<V1beta1TokenReview> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createTokenReviewValidateBeforeCall(body, dryRun, fieldManager, pretty, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1beta1TokenReview>(){}.getType();
