...
public class AuthenticationV1beta1Api {
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewCall(V1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public V1beta1TokenReview createTokenReview(V1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty) throws ApiException {
        ApiResponse<V1beta1TokenReview> resp = createTokenReviewWithHttpInfo(body, dryRun, includeUninitialized, pretty);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1beta1TokenReview> createTokenReviewWithHttpInfo(V1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewAsync(V1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ApiCallback<V1beta1TokenReview> callback) throws ApiException {
