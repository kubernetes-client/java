...
public class AuthenticationV1Api {
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewCall(V1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createTokenReviewValidateBeforeCall(V1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createTokenReviewCall(body, dryRun, includeUninitialized, pretty, progressListener, progressRequestListener);
        return call;
     ...
     */
    public V1TokenReview createTokenReview(V1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty) throws ApiException {
        ApiResponse<V1TokenReview> resp = createTokenReviewWithHttpInfo(body, dryRun, includeUninitialized, pretty);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1TokenReview> createTokenReviewWithHttpInfo(V1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty) throws ApiException {
        com.squareup.okhttp.Call call = createTokenReviewValidateBeforeCall(body, dryRun, includeUninitialized, pretty, null, null);
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewAsync(V1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ApiCallback<V1TokenReview> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createTokenReviewValidateBeforeCall(body, dryRun, includeUninitialized, pretty, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1TokenReview>(){}.getType();
