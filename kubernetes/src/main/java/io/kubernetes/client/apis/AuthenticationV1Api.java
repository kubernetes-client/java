...
public class AuthenticationV1Api {
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewCall(V1TokenReview body, String dryRun, String fieldManager, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createTokenReviewValidateBeforeCall(V1TokenReview body, String dryRun, String fieldManager, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public V1TokenReview createTokenReview(V1TokenReview body, String dryRun, String fieldManager, String pretty) throws ApiException {
        ApiResponse<V1TokenReview> resp = createTokenReviewWithHttpInfo(body, dryRun, fieldManager, pretty);
        return resp.getData();
    }
     ...
     */
    public com.squareup.okhttp.Call createTokenReviewAsync(V1TokenReview body, String dryRun, String fieldManager, String pretty, final ApiCallback<V1TokenReview> callback) throws ApiException {
