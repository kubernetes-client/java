...
public class AuthenticationV1Api {
     ...
     */
    public okhttp3.Call createTokenReviewCall(V1TokenReview body, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call createTokenReviewValidateBeforeCall(V1TokenReview body, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = createTokenReviewCall(body, pretty, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<V1TokenReview> createTokenReviewWithHttpInfo(V1TokenReview body, String pretty) throws ApiException {
        okhttp3.Call call = createTokenReviewValidateBeforeCall(body, pretty, null, null);
     ...
     */
    public okhttp3.Call createTokenReviewAsync(V1TokenReview body, String pretty, final ApiCallback<V1TokenReview> callback) throws ApiException {
        ...
        okhttp3.Call call = createTokenReviewValidateBeforeCall(body, pretty, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1TokenReview>(){}.getType();
