...
public class SchedulingV1alpha1Api {
   ...
   */
  public Call createPriorityClassCall(
  ...
  private Call createPriorityClassValidateBeforeCall(
      V1alpha1PriorityClass body,
      Boolean includeUninitialized,
      String pretty,
      String dryRun,
  ...
  public V1alpha1PriorityClass createPriorityClass(
      V1alpha1PriorityClass body, Boolean includeUninitialized, String pretty, String dryRun)
      throws ApiException {
    ApiResponse<V1alpha1PriorityClass> resp =
        createPriorityClassWithHttpInfo(body, includeUninitialized, pretty, dryRun);
    return resp.getData();
  }
   ...
   */
  public Call createPriorityClassAsync(
      V1alpha1PriorityClass body,
      Boolean includeUninitialized,
      String pretty,
      String dryRun,
      final ApiCallback<V1alpha1PriorityClass> callback)
      throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call deleteCollectionPriorityClassCall(
      Boolean includeUninitialized,
      String pretty,
      String _continue,
  ...
  @SuppressWarnings("rawtypes")
  private Call deleteCollectionPriorityClassValidateBeforeCall(
      Boolean includeUninitialized,
      String pretty,
      String _continue,
      String fieldSelector,
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call deleteCollectionPriorityClassAsync(
      Boolean includeUninitialized,
      String pretty,
      String _continue,
      String fieldSelector,
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call deletePriorityClassCall(
      String name,
  ...
  @SuppressWarnings("rawtypes")
  private Call deletePriorityClassValidateBeforeCall(
      String name,
      V1DeleteOptions body,
      String pretty,
      String dryRun,
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling deletePriorityClass(Async)");
    }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call deletePriorityClassAsync(
      String name,
      V1DeleteOptions body,
      String pretty,
      String dryRun,
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call listPriorityClassCall(
      Boolean includeUninitialized,
      String pretty,
      String _continue,
      String fieldSelector,
  ...
  @SuppressWarnings("rawtypes")
  private Call listPriorityClassValidateBeforeCall(
      Boolean includeUninitialized,
      String pretty,
      String _continue,
      String fieldSelector,
  ...
  public V1alpha1PriorityClassList listPriorityClass(
      ...
      Boolean watch)
      throws ApiException {
    ApiResponse<V1alpha1PriorityClassList> resp =
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call listPriorityClassAsync(
      Boolean includeUninitialized,
      String pretty,
      String _continue,
      String fieldSelector,
      ...
      Integer timeoutSeconds,
      Boolean watch,
      final ApiCallback<V1alpha1PriorityClassList> callback)
      throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call patchPriorityClassCall(
      String name,
      Object body,
      String pretty,
      String dryRun,
  ...
  @SuppressWarnings("rawtypes")
  private Call patchPriorityClassValidateBeforeCall(
      String name,
      Object body,
      String pretty,
      String dryRun,
  ...
  public V1alpha1PriorityClass patchPriorityClass(
    ...
    ApiResponse<V1alpha1PriorityClass> resp =
        patchPriorityClassWithHttpInfo(name, body, pretty, dryRun);
    return resp.getData();
  }
  ...
  public ApiResponse<V1alpha1PriorityClass> patchPriorityClassWithHttpInfo(
      String name, Object body, String pretty, String dryRun) throws ApiException {
    Call call = patchPriorityClassValidateBeforeCall(name, body, pretty, dryRun, null, null);
    Type localVarReturnType = new TypeToken<V1alpha1PriorityClass>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call patchPriorityClassAsync(
      String name,
      Object body,
      String pretty,
      String dryRun,
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call readPriorityClassCall(
      String name,
      String pretty,
      Boolean exact,
      Boolean export,
  ...
  @SuppressWarnings("rawtypes")
  private Call readPriorityClassValidateBeforeCall(
      String name,
      String pretty,
      Boolean exact,
      Boolean export,
  ...
  public ApiResponse<V1alpha1PriorityClass> readPriorityClassWithHttpInfo(
      String name, String pretty, Boolean exact, Boolean export) throws ApiException {
    Call call = readPriorityClassValidateBeforeCall(name, pretty, exact, export, null, null);
    Type localVarReturnType = new TypeToken<V1alpha1PriorityClass>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call readPriorityClassAsync(
      String name,
      String pretty,
      Boolean exact,
      Boolean export,
    ...
    Call call =
        readPriorityClassValidateBeforeCall(
            name, pretty, exact, export, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<V1alpha1PriorityClass>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Call replacePriorityClassCall(
      String name,
      V1alpha1PriorityClass body,
      String pretty,
      String dryRun,
  ...
  @SuppressWarnings("rawtypes")
  private Call replacePriorityClassValidateBeforeCall(
      String name,
      V1alpha1PriorityClass body,
      String pretty,
      String dryRun,
  ...
  public V1alpha1PriorityClass replacePriorityClass(
      String name, V1alpha1PriorityClass body, String pretty, String dryRun) throws ApiException {
    ApiResponse<V1alpha1PriorityClass> resp =
        replacePriorityClassWithHttpInfo(name, body, pretty, dryRun);
    return resp.getData();
  }
  ...
  public ApiResponse<V1alpha1PriorityClass> replacePriorityClassWithHttpInfo(
      String name, V1alpha1PriorityClass body, String pretty, String dryRun) throws ApiException {
    Call call = replacePriorityClassValidateBeforeCall(name, body, pretty, dryRun, null, null);
    Type localVarReturnType = new TypeToken<V1alpha1PriorityClass>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call replacePriorityClassAsync(
      String name,
      V1alpha1PriorityClass body,
      String pretty,
      String dryRun,
