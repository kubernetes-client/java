...
public class V1ResourceQuotaList {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "Items is a list of ResourceQuota objects. More info: http://releases.k8s.io/HEAD/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota")
