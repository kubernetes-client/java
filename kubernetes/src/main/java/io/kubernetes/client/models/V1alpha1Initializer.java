...
public class V1alpha1Initializer {
  ...
  /**
   * Rules describes what resources/subresources the initializer cares about. The initializer cares
   * about an operation if it matches _any_ Rule. Rule.Resources must not include subresources.
   *
   * @return rules
   */
  @ApiModelProperty(
