...
public class V1beta1NetworkPolicyPeer {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Selects Namespaces using cluster scoped-labels.  This matches all pods in all namespaces selected by this label selector. This field follows standard label selector semantics. If present but empty, this selector selects all namespaces.")
   ...
   * @return podSelector
  **/
  @ApiModelProperty(example = "null", value = "This is a label selector which selects Pods in this namespace. This field follows standard label selector semantics. If present but empty, this selector selects all pods in this namespace.")
