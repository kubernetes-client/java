...
public class V1beta1StatefulSet {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(example = "null", value = "Spec defines the desired identities of pods in this set.")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.")
