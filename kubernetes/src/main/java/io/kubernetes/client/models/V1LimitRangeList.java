...
public class V1LimitRangeList {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "Items is a list of LimitRange objects. More info: http://releases.k8s.io/HEAD/docs/design/admission_control_limit_range.md")
