...
public class V1Affinity {
   ...
   * @return nodeAffinity
  **/
  @ApiModelProperty(example = "null", value = "Describes node affinity scheduling rules for the pod.")
   ...
   * @return podAffinity
  **/
  @ApiModelProperty(example = "null", value = "Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s)).")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s)).")
