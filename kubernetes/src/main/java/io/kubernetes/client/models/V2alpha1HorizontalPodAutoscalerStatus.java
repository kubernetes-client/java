...
import io.kubernetes.client.models.V2alpha1HorizontalPodAutoscalerCondition;
...
public class V2alpha1HorizontalPodAutoscalerStatus {
  ...
  private List<V2alpha1HorizontalPodAutoscalerCondition> conditions = new ArrayList<V2alpha1HorizontalPodAutoscalerCondition>();
  ...
  public V2alpha1HorizontalPodAutoscalerStatus conditions(List<V2alpha1HorizontalPodAutoscalerCondition> conditions) {
    this.conditions = conditions;
    return this;
  }

  public V2alpha1HorizontalPodAutoscalerStatus addConditionsItem(V2alpha1HorizontalPodAutoscalerCondition conditionsItem) {
   ...
   * @return conditions
  **/
  @ApiModelProperty(example = "null", required = true, value = "conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.")
  public List<V2alpha1HorizontalPodAutoscalerCondition> getConditions() {
    return conditions;
  }

  public void setConditions(List<V2alpha1HorizontalPodAutoscalerCondition> conditions) {
    this.conditions = conditions;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.conditions, v2alpha1HorizontalPodAutoscalerStatus.conditions) &&
        Objects.equals(this.currentMetrics, v2alpha1HorizontalPodAutoscalerStatus.currentMetrics) &&
