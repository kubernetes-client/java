...
public class V1PodSpec {
   ...
   * Readiness probes, or Liveness probes. The resourceRequirements of an init container are taken
   * into account during scheduling by finding the highest request/limit for each resource type, and
   * then using the max of of that value or the sum of the normal containers. Limits are applied to
   * init containers in a similar fashion. Init containers cannot currently be added or removed.
   ...
   * https://github.com/kubernetes/community/blob/master/keps/sig-node/0014-runtime-class.md This is
