...
public class V1PodTemplate {
  ...
  **/
   ...
   * @return template
  **/
  @ApiModelProperty(value = "Template defines the pods that will be created from this pod template. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
