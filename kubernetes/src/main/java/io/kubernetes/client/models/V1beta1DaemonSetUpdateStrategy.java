...
public class V1beta1DaemonSetUpdateStrategy {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Rolling update config params. Present only if type = \"RollingUpdate\".")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "Type of daemon set update. Can be \"RollingUpdate\" or \"OnDelete\". Default is OnDelete.")
