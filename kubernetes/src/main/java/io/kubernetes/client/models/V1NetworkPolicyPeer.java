...
public class V1NetworkPolicyPeer {
   ...
   * semantics; if present but empty, it selects all namespaces. If PodSelector is also set, then
   * the NetworkPolicyPeer as a whole selects the Pods matching PodSelector in the Namespaces
   ...
   * semantics; if present but empty, it selects all pods. If NamespaceSelector is also set, then
   * the NetworkPolicyPeer as a whole selects the Pods matching PodSelector in the Namespaces
   * selected by NamespaceSelector. Otherwise it selects the Pods matching PodSelector in the
