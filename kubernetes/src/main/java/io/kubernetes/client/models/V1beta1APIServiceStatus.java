...
public class V1beta1APIServiceStatus {
  ...
  private List<V1beta1APIServiceCondition> conditions = new ArrayList<V1beta1APIServiceCondition>();
   ...
   * @return conditions
  **/
  @ApiModelProperty(example = "null", value = "Current service state of apiService.")
