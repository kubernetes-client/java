...
public class AppsV1beta1ScaleStatus {
  ...
  **/
   ...
   * @return selector
  **/
  @ApiModelProperty(example = "null", value = "label query over pods that should match the replicas count. More info: http://kubernetes.io/docs/user-guide/labels#label-selectors")
