...
public class V1Taint {
   ...
   * @return effect
  **/
  @ApiModelProperty(example = "null", required = true, value = "Required. The effect of the taint on pods that do not tolerate the taint. Valid effects are NoSchedule, PreferNoSchedule and NoExecute.")
   ...
   * @return key
  **/
  @ApiModelProperty(example = "null", required = true, value = "Required. The taint key to be applied to a node.")
   ...
   * @return timeAdded
  **/
  @ApiModelProperty(example = "null", value = "TimeAdded represents the time at which the taint was added. It is only written for NoExecute taints.")
   ...
   * @return value
  **/
  @ApiModelProperty(example = "null", value = "Required. The taint value corresponding to the taint key.")
