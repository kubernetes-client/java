...
public class V1beta1PodDisruptionBudgetSpec {
   ...
   * pod. For example, one can prevent all voluntary evictions by specifying 0. This is a mutually
   ...
   * the evicted pod. So for example you can prevent all voluntary evictions by specifying
   * \&quot;100%\&quot;.
   *
   * @return minAvailable
   */
   ...
   */
  @ApiModelProperty(
      value = "Label query over pods whose evictions are managed by the disruption budget.")
