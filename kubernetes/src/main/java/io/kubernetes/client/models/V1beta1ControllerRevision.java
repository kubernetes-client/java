...
public class V1beta1ControllerRevision {
  ...
  **/
   ...
   * @return data
  **/
  @ApiModelProperty(example = "null", value = "Data is the serialized representation of the state.")
  ...
  **/
   ...
   * @return revision
  **/
  @ApiModelProperty(example = "null", required = true, value = "Revision indicates the revision of the state represented by Data.")
