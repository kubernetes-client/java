...
public class V1HorizontalPodAutoscaler {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(example = "null", value = "behaviour of autoscaler. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.")
