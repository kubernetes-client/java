...
public class V1FlockerVolumeSource {
   ...
   * @return datasetName
  **/
  @ApiModelProperty(example = "null", value = "Name of the dataset stored as metadata -> name on the dataset for Flocker should be considered as deprecated")
   ...
   * @return datasetUUID
  **/
  @ApiModelProperty(example = "null", value = "UUID of the dataset. This is unique identifier of a Flocker dataset")
