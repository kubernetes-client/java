...
public class V2beta1PodsMetricStatus {
   ...
   * metric When set in the PodsMetricSource, it is passed as an additional parameter to the metrics
   * server for more specific metrics scoping. When unset, just the metricName will be used to
   * gather metrics.
   *
   * @return selector
   */
