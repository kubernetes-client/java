...
public class AppsV1beta1Scale {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(example = "null", value = "defines the behavior of the scale. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "current status of the scale. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status. Read-only.")
