...
public class V1PreferredSchedulingTerm {
   ...
   * @return preference
  **/
  @ApiModelProperty(example = "null", required = true, value = "A node selector term, associated with the corresponding weight.")
   ...
   * @return weight
  **/
  @ApiModelProperty(example = "null", required = true, value = "Weight associated with matching the corresponding nodeSelectorTerm, in the range 1-100.")
