...
public class V1beta1ClusterRoleBinding {
  ...
  **/
   ...
   * @return roleRef
  **/
  @ApiModelProperty(example = "null", required = true, value = "RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.")
