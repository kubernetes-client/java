...
public class V1AWSElasticBlockStoreVolumeSource {
  ...
  **/
   ...
   * @return readOnly
  **/
  @ApiModelProperty(example = "null", value = "Specify \"true\" to force and set the ReadOnly property in VolumeMounts to \"true\". If omitted, the default is \"false\". More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore")
   ...
   * @return volumeID
  **/
  @ApiModelProperty(example = "null", required = true, value = "Unique ID of the persistent disk resource in AWS (Amazon EBS volume). More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore")
