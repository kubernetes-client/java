...
public class V1HostPathVolumeSource {
   ...
   * @return path
  **/
  @ApiModelProperty(example = "null", required = true, value = "Path of the directory on the host. More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath")
