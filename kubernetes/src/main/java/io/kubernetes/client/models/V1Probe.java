...
public class V1Probe {
   ...
   * @return exec
  **/
  @ApiModelProperty(example = "null", value = "One and only one of the following should be specified. Exec specifies the action to take.")
  ...
  **/
   ...
   * @return httpGet
  **/
  @ApiModelProperty(example = "null", value = "HTTPGet specifies the http request to perform.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Number of seconds after the container has started before liveness probes are initiated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes")
  ...
  **/
   ...
   * @return tcpSocket
  **/
  @ApiModelProperty(example = "null", value = "TCPSocket specifies an action involving a TCP port. TCP hooks not yet supported")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes")
