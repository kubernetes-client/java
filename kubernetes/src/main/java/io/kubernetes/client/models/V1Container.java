...
public class V1Container {
  ...
  **/
   ...
   * @return image
  **/
  @ApiModelProperty(example = "null", value = "Docker image name. More info: http://kubernetes.io/docs/user-guide/images")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/images#updating-images")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/pod-states#container-probes")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/pod-states#container-probes")
   ...
   * @return resources
  **/
  @ApiModelProperty(example = "null", value = "Compute Resources required by this container. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#resources")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Security options the pod should run with. More info: http://releases.k8s.io/HEAD/docs/design/security_context.md")
