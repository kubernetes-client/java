...
public class V1LocalVolumeSource {
   ...
   * @return path
  **/
  @ApiModelProperty(example = "null", required = true, value = "The full path to the volume on the node For alpha, this path must be a directory Once block as a source is supported, then this path can point to a block device")
