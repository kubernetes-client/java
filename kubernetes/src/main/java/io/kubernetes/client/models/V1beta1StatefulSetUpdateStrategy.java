...
public class V1beta1StatefulSetUpdateStrategy {
  ...
  **/
  @ApiModelProperty(example = "null", value = "RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType.")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "Type indicates the type of the StatefulSetUpdateStrategy.")
