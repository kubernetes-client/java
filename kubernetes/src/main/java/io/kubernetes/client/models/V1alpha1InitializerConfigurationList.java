...
public class V1alpha1InitializerConfigurationList {
  ...
  private List<V1alpha1InitializerConfiguration> items = new ArrayList<V1alpha1InitializerConfiguration>();
  ...
  **/
  ...
  public V1alpha1InitializerConfigurationList addItemsItem(V1alpha1InitializerConfiguration itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of InitializerConfiguration.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1InitializerConfigurationList v1alpha1InitializerConfigurationList = (V1alpha1InitializerConfigurationList) o;
