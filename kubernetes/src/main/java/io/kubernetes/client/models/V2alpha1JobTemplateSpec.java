...
public class V2alpha1JobTemplateSpec {
   ...
   * @return metadata
  **/
  @ApiModelProperty(value = "Standard object's metadata of the jobs created from this template. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata")
   ...
   * @return spec
  **/
  @ApiModelProperty(value = "Specification of the desired behavior of the job. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
