...
public class V1ContainerStatus {
   ...
   * @return containerID
  **/
  @ApiModelProperty(example = "null", value = "Container's ID in the format 'docker://<container_id>'. More info: http://kubernetes.io/docs/user-guide/container-environment#container-information")
   ...
   * @return image
  **/
  @ApiModelProperty(example = "null", required = true, value = "The image the container is running. More info: http://kubernetes.io/docs/user-guide/images")
  ...
  **/
   ...
   * @return lastState
  **/
  @ApiModelProperty(example = "null", value = "Details about the container's last termination condition.")
  ...
  **/
   ...
   * @return state
  **/
  @ApiModelProperty(example = "null", value = "Details about the container's current condition.")
