...
public class V1ResourceQuota {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(example = "null", value = "Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status")
