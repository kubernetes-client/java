...
public class V1ResourceQuota {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(value = "Spec defines the desired quota. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Status defines the actual enforced quota and its current usage. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
