...
public class V1PersistentVolumeClaimList {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "A list of persistent volume claims. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims")
