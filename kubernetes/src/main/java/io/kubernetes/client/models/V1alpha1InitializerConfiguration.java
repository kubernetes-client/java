...
public class V1alpha1InitializerConfiguration {
  ...
  private List<V1alpha1Initializer> initializers = new ArrayList<V1alpha1Initializer>();
  ...
  **/
   ...
   * @return initializers
  **/
  @ApiModelProperty(example = "null", value = "Initializers is a list of resources and their default initializers Order-sensitive. When merging multiple InitializerConfigurations, we sort the initializers from different InitializerConfigurations by the name of the InitializerConfigurations; the order of the initializers from the same InitializerConfiguration is preserved.")
