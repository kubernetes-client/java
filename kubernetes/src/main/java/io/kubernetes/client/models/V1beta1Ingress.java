...
public class V1beta1Ingress {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(value = "Spec is the desired state of the Ingress. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Status is the current state of the Ingress. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
