...
public class V1beta1Eviction {
  ...
  **/
  @ApiModelProperty(example = "null", value = "DeleteOptions may be provided")
  ...
  **/
   ...
   * @return metadata
  **/
  @ApiModelProperty(example = "null", value = "ObjectMeta describes the pod that is being evicted.")
