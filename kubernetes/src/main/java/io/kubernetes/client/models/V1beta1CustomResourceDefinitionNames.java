...
public class V1beta1CustomResourceDefinitionNames {
   ...
   */
  @ApiModelProperty(
      value = "Categories is a list of grouped resources custom resources belong to (e.g. 'all')")
   ...
   */
  @ApiModelProperty(
      value = "ShortNames are short names for the resource.  It must be all lowercase.")
