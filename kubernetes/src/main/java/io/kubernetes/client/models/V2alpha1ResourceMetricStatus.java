...
public class V2alpha1ResourceMetricStatus {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "currentAverageValue is the current value of the average of the resource metric across all relevant pods, as a raw value (instead of as a percentage of the request), similar to the \"pods\" metric source type. It will always be set, regardless of the corresponding metric specification.")
