...
public class ExtensionsV1beta1Scale {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(value = "defines the behavior of the scale. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "current status of the scale. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status. Read-only.")
