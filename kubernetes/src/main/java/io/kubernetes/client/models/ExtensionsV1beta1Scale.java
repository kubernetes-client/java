...
public class ExtensionsV1beta1Scale {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(example = "null", value = "defines the behavior of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.")
