...
public class V1alpha1Subject {
   ...
   * @return apiVersion
  **/
  @ApiModelProperty(example = "null", value = "APIVersion holds the API group and version of the referenced subject. Defaults to \"v1\" for ServiceAccount subjects. Defaults to \"rbac.authorization.k8s.io/v1alpha1\" for User and Group subjects.")
   ...
   * @return kind
  **/
  @ApiModelProperty(example = "null", required = true, value = "Kind of object being referenced. Values defined by this API group are \"User\", \"Group\", and \"ServiceAccount\". If the Authorizer does not recognized the kind value, the Authorizer should report an error.")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "Name of the object being referenced.")
   ...
   * @return namespace
  **/
  @ApiModelProperty(example = "null", value = "Namespace of the referenced object.  If the object kind is non-namespace, such as \"User\" or \"Group\", and this value is not empty the Authorizer should report an error.")
