...
import io.kubernetes.client.models.V1beta1ReplicaSetCondition;
...
public class V1beta1ReplicaSetStatus {
  ...
  private List<V1beta1ReplicaSetCondition> conditions = new ArrayList<V1beta1ReplicaSetCondition>();
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of available replicas (ready for at least minReadySeconds) for this replica set.")
   ...
   * @return conditions
  **/
  @ApiModelProperty(example = "null", value = "Represents the latest available observations of a replica set's current state.")
  ...
  **/
   ...
   * @return replicas
  **/
  @ApiModelProperty(example = "null", required = true, value = "Replicas is the most recently oberved number of replicas. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller/#what-is-a-replicationcontroller")
