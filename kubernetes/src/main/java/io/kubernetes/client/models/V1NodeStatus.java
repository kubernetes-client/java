...
public class V1NodeStatus {
  ...
  private Map<String, String> allocatable = new HashMap<String, String>();
   ...
   * @return addresses
  **/
  @ApiModelProperty(example = "null", value = "List of addresses reachable to the node. Queried from cloud provider, if available. More info: https://kubernetes.io/docs/concepts/nodes/node/#addresses")
  ...
  **/
   ...
   * @return capacity
  **/
  @ApiModelProperty(example = "null", value = "Capacity represents the total resources of a node. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#capacity")
   ...
   * @return conditions
  **/
  @ApiModelProperty(example = "null", value = "Conditions is an array of current observed node conditions. More info: https://kubernetes.io/docs/concepts/nodes/node/#condition")
  ...
  **/
   ...
   * @return nodeInfo
  **/
  @ApiModelProperty(example = "null", value = "Set of ids/uuids to uniquely identify the node. More info: https://kubernetes.io/docs/concepts/nodes/node/#info")
   ...
   * @return phase
  **/
  @ApiModelProperty(example = "null", value = "NodePhase is the recently observed lifecycle phase of the node. More info: https://kubernetes.io/docs/concepts/nodes/node/#phase The field is never populated, and now is deprecated.")
