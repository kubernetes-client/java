...
public class V1NetworkPolicyPort {
  ...
  /**
   * The port on the given protocol. This can either be a numerical or named port on a pod. If this
   * field is not provided, this matches all port names and numbers.
   *
   * @return port
   */
  @ApiModelProperty(
