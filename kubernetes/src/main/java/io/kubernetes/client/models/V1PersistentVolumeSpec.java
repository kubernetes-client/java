...
public class V1PersistentVolumeSpec {
   ...
   * @return accessModes
  **/
  @ApiModelProperty(example = "null", value = "AccessModes contains all ways the volume can be mounted. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes")
  ...
  **/
   ...
   * @return capacity
  **/
  @ApiModelProperty(example = "null", value = "A description of the persistent volume's resources and capacity. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#capacity")
  ...
  **/
   ...
   * @return claimRef
  **/
  @ApiModelProperty(example = "null", value = "ClaimRef is part of a bi-directional binding between PersistentVolume and PersistentVolumeClaim. Expected to be non-nil when bound. claim.VolumeName is the authoritative bind between PV and PVC. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#binding")
  ...
  **/
  @ApiModelProperty(example = "null", value = "GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. Provisioned by an admin. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk")
   ...
   * @return glusterfs
  **/
  @ApiModelProperty(example = "null", value = "Glusterfs represents a Glusterfs volume that is attached to a host and exposed to the pod. Provisioned by an admin. More info: https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md")
  ...
  **/
   ...
   * @return local
  **/
  @ApiModelProperty(example = "null", value = "Local represents directly-attached storage with node affinity")
   ...
   * @return nfs
  **/
  @ApiModelProperty(example = "null", value = "NFS represents an NFS mount on the host. Provisioned by an admin. More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs")
  ...
  **/
   ...
   * @return storageos
  **/
  @ApiModelProperty(example = "null", value = "StorageOS represents a StorageOS volume that is attached to the kubelet's host machine and mounted into the pod More info: https://releases.k8s.io/HEAD/examples/volumes/storageos/README.md")
