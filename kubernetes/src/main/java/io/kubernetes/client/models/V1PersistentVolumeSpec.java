...
public class V1PersistentVolumeSpec {
   ...
   */
  @ApiModelProperty(
      value = "CephFS represents a Ceph FS mount on the host that shares a pod's lifetime")
   ...
   */
  @ApiModelProperty(
      value = "CSI represents storage that handled by an external CSI driver (Beta feature).")
   ...
   * useful for single-node development and testing only! On-host storage is not supported in any
   ...
   * in raw block state. Value of Filesystem is implied when not included in spec. This is an alpha
