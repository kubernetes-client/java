...
public class V1beta1CustomResourceDefinitionSpec {
  ...
  **/
   ...
   * @return validation
  **/
  @ApiModelProperty(value = "Validation describes the validation methods for CustomResources This field is alpha-level and should only be sent to servers that enable the CustomResourceValidation feature.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(group, names, scope, validation, version);
  }
