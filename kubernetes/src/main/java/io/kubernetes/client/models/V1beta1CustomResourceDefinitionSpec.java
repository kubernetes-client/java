...
public class V1beta1CustomResourceDefinitionSpec {
  ...
  @ApiModelProperty(
      required = true,
      value = "Names are the names used to describe this custom resource")
   ...
   * will be used to compute the order. If the version string is \&quot;kube-like\&quot;, it will
  ...
  public int hashCode() {
    return Objects.hash(
        additionalPrinterColumns, group, names, scope, subresources, validation, version, versions);
  }
