...
public class V1beta1APIServiceSpec {
   ...
   * @return caBundle
  **/
  @ApiModelProperty(example = "null", required = true, value = "CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate.")
   ...
   * @return group
  **/
  @ApiModelProperty(example = "null", value = "Group is the API group name this server hosts")
  ...
  **/
  @ApiModelProperty(example = "null", value = "InsecureSkipTLSVerify disables TLS certificate verification when communicating with this server. This is strongly discouraged.  You should use the CABundle instead.")
  ...
  **/
   ...
   * @return version
  **/
  @ApiModelProperty(example = "null", value = "Version is the API version this server hosts.  For example, \"v1\"")
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "VersionPriority controls the ordering of this API version inside of its group.  Must be greater than zero. The primary sort is based on VersionPriority, ordered highest to lowest (20 before 10). The secondary sort is based on the alphabetical comparison of the name of the object.  (v1.bar before v1.foo) Since it's inside of a group, the number can be small, probably in the 10s.")
