...
public class V1Volume {
  ...
  **/
  @ApiModelProperty(example = "null", value = "AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore")
  ...
  **/
   ...
   * @return cinder
  **/
  @ApiModelProperty(example = "null", value = "Cinder represents a cinder volume attached and mounted on kubelets host machine More info: https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md")
  ...
  **/
   ...
   * @return emptyDir
  **/
  @ApiModelProperty(example = "null", value = "EmptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir")
  ...
  **/
  @ApiModelProperty(example = "null", value = "GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk")
  ...
  **/
   ...
   * @return glusterfs
  **/
  @ApiModelProperty(example = "null", value = "Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md")
  ...
  **/
   ...
   * @return iscsi
  **/
  @ApiModelProperty(example = "null", value = "ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "Volume's name. Must be a DNS_LABEL and unique within the pod. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names")
   ...
   * @return nfs
  **/
  @ApiModelProperty(example = "null", value = "NFS represents an NFS mount on the host that shares a pod's lifetime More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs")
  ...
  **/
  @ApiModelProperty(example = "null", value = "PersistentVolumeClaimVolumeSource represents a reference to a PersistentVolumeClaim in the same namespace. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims")
  ...
  **/
   ...
   * @return rbd
  **/
  @ApiModelProperty(example = "null", value = "RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md")
  ...
  **/
   ...
   * @return secret
  **/
  @ApiModelProperty(example = "null", value = "Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret")
   ...
   * @return storageos
  **/
  @ApiModelProperty(example = "null", value = "StorageOS represents a StorageOS volume attached and mounted on Kubernetes nodes.")
