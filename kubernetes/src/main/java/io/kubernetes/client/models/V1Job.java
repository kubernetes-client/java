...
public class V1Job {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(example = "null", value = "Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "Current status of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status")
