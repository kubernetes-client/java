...
public class V1Job {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(value = "Spec is a structure defining the expected behavior of a job. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
