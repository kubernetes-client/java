...
public class V1beta1NetworkPolicySpec {
   ...
   * applied to any pods selected by this field. Multiple network policies can select the same set
   * of pods. In this case, the ingress rules for each are combined additively. This field is NOT
   * optional and follows standard label selector semantics. An empty podSelector matches all pods
   * in this namespace.
   *
   * @return podSelector
   */
   ...
   * and all policies (whether or not they contain an Ingress section) are assumed to affect
