...
public class V1ServiceAccount {
  ...
  **/
   ...
   * @return secrets
  **/
  @ApiModelProperty(example = "null", value = "Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. More info: http://kubernetes.io/docs/user-guide/secrets")
