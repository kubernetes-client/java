...
public class V2alpha1CronJobStatus {
   ...
   * @return active
  **/
  @ApiModelProperty(example = "null", value = "A list of pointers to currently running jobs.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Information when was the last time the job was successfully scheduled.")
