...
public class V2beta1ExternalMetricStatus {
   ...
   */
  @ApiModelProperty(
      value = "currentAverageValue is the current value of metric averaged over autoscaled pods.")
  ...
  @ApiModelProperty(
      required = true,
      value = "currentValue is the current value of the metric (as a quantity)")
   ...
   */
  @ApiModelProperty(
      value = "metricSelector is used to identify a specific time series within a given metric.")
