...
public class V1ObjectReference {
  ...
  **/
   ...
   * @return namespace
  **/
  @ApiModelProperty(example = "null", value = "Namespace of the referent. More info: http://kubernetes.io/docs/user-guide/namespaces")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specific resourceVersion to which this reference is made, if any. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#concurrency-control-and-consistency")
   ...
   * @return uid
  **/
  @ApiModelProperty(example = "null", value = "UID of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#uids")
