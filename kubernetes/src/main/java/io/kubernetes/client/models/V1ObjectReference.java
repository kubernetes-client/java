...
public class V1ObjectReference {
  ...
  **/
   ...
   * @return kind
  **/
  @ApiModelProperty(example = "null", value = "Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names")
   ...
   * @return namespace
  **/
  @ApiModelProperty(example = "null", value = "Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specific resourceVersion to which this reference is made, if any. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#concurrency-control-and-consistency")
   ...
   * @return uid
  **/
  @ApiModelProperty(example = "null", value = "UID of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#uids")
