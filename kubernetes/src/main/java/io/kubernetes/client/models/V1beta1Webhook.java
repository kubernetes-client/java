...
public class V1beta1Webhook {
  ...
  @ApiModelProperty(
      required = true,
      value = "ClientConfig defines how to communicate with the hook. Required")
   ...
   * resource, it never skips the webhook. For example, to run the webhook on any objects whose
   * namespace is not associated with \&quot;runlevel\&quot; of \&quot;0\&quot; or \&quot;1\&quot;;
   * you will set the selector as follows: \&quot;namespaceSelector\&quot;: {
   * \&quot;matchExpressions\&quot;: [ { \&quot;key\&quot;: \&quot;runlevel\&quot;,
   * \&quot;operator\&quot;: \&quot;NotIn\&quot;, \&quot;values\&quot;: [ \&quot;0\&quot;,
   * \&quot;1\&quot; ] } ] } If instead you want to only run the webhook on any objects whose
   ...
   * \&quot;staging\&quot; ] } ] } See
   * https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more examples of
   * label selectors. Default to the empty LabelSelector, which matches everything.
   *
   ...
   * since a request may be rejected by a future step in the admission change and the side effects
   * therefore need to be undone. Requests with the dryRun attribute will be auto-rejected if they
   * match a webhook with sideEffects &#x3D;&#x3D; Unknown or Some. Defaults to Unknown.
   *
   * @return sideEffects
   */
  @ApiModelProperty(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientConfig, failurePolicy, name, namespaceSelector, rules, sideEffects);
  }
