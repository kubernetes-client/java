...
public class V1EnvVarSource {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Selects a key of a ConfigMap.")
   ...
   * @return fieldRef
  **/
  @ApiModelProperty(example = "null", value = "Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, requests.cpu and requests.memory) are currently supported.")
   ...
   * @return secretKeyRef
  **/
  @ApiModelProperty(example = "null", value = "Selects a key of a secret in the pod's namespace")
