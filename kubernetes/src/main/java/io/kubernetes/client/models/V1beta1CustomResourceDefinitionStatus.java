...
public class V1beta1CustomResourceDefinitionStatus {
  ...
  private List<V1beta1CustomResourceDefinitionCondition> conditions =
      new ArrayList<V1beta1CustomResourceDefinitionCondition>();
   ...
   * migration controller can first finish a migration to another version (i.e. that no old objects
   * are left in the storage), and then remove the rest of the versions from this list. None of the
