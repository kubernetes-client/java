...
public class ExtensionsV1beta1DeploymentStatus {
  ...
  private List<ExtensionsV1beta1DeploymentCondition> conditions = new ArrayList<ExtensionsV1beta1DeploymentCondition>();
  ...
  **/
  ...
  public ExtensionsV1beta1DeploymentStatus collisionCount(Long collisionCount) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Count of hash collisions for the Deployment. The Deployment controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ReplicaSet.")
