...
public class V2alpha1ResourceMetricSource {
  ...
  **/
  @ApiModelProperty(example = "null", value = "targetAverageValue is the target value of the average of the resource metric across all relevant pods, as a raw value (instead of as a percentage of the request), similar to the \"pods\" metric source type.")
