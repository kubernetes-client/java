...
public class V1VsphereVirtualDiskVolumeSource {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Storage Policy Based Management (SPBM) profile ID associated with the StoragePolicyName.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Storage Policy Based Management (SPBM) profile name.")
