...
public class V1ResourceQuotaSpec {
   ...
   * @return hard
  **/
  @ApiModelProperty(example = "null", value = "Hard is the set of desired hard limits for each named resource. More info: https://git.k8s.io/community/contributors/design-proposals/admission_control_resource_quota.md")
