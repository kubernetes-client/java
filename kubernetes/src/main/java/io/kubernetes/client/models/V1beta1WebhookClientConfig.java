...
public class V1beta1WebhookClientConfig {
   ...
   * or &#x60;url&#x60; must be specified. If the webhook is running within the cluster, then you
   * should use &#x60;service&#x60;. Port 443 will be used if it is open, otherwise it is an error.
   *
   * @return service
   */
  @ApiModelProperty(
