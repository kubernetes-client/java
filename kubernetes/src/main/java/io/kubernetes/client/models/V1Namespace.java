...
public class V1Namespace {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(value = "Spec defines the behavior of the Namespace. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Status describes the current status of a Namespace. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status")
