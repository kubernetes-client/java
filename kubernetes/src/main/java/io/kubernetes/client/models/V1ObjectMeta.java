...
public class V1ObjectMeta {
   ...
   * observe uninitialized objects. When an object is created, the system will populate this list
   * with the current set of initializers. Only privileged users may set or modify this list. Once
   ...
   */
  @ApiModelProperty(
      value = "SelfLink is a URL representing this object. Populated by the system. Read-only.")
