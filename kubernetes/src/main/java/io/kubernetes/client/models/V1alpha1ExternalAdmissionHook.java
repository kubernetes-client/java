...
public class V1alpha1ExternalAdmissionHook {
  ...
  private List<V1alpha1RuleWithOperations> rules = new ArrayList<V1alpha1RuleWithOperations>();
   ...
   * @return clientConfig
  **/
  @ApiModelProperty(example = "null", required = true, value = "ClientConfig defines how to communicate with the hook. Required")
  ...
  **/
  @ApiModelProperty(example = "null", value = "FailurePolicy defines how unrecognized errors from the admission endpoint are handled - allowed values are Ignore or Fail. Defaults to Ignore.")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "The name of the external admission webhook. Name should be fully qualified, e.g., imagepolicy.kubernetes.io, where \"imagepolicy\" is the name of the webhook, and kubernetes.io is the name of the organization. Required.")
   ...
   * @return rules
  **/
  @ApiModelProperty(example = "null", value = "Rules describes what operations on what resources/subresources the webhook cares about. The webhook cares about an operation if it matches _any_ Rule.")
