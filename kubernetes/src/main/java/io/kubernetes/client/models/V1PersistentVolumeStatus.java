...
public class V1PersistentVolumeStatus {
  ...
  **/
   ...
   * @return phase
  **/
  @ApiModelProperty(example = "null", value = "Phase indicates if a volume is available, bound to a claim, or released by a claim. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#phase")
