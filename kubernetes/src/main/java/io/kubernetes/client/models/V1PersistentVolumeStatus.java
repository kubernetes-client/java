...
public class V1PersistentVolumeStatus {
  ...
  **/
   ...
   * @return phase
  **/
  @ApiModelProperty(example = "null", value = "Phase indicates if a volume is available, bound to a claim, or released by a claim. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#phase")
