...
public class V1beta1SELinuxStrategyOptions {
  ...
  **/
  @ApiModelProperty(example = "null", value = "seLinuxOptions required to run as; required for MustRunAs More info: https://git.k8s.io/community/contributors/design-proposals/security_context.md")
