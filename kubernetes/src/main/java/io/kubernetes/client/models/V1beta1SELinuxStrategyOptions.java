...
public class V1beta1SELinuxStrategyOptions {
  ...
  **/
  @ApiModelProperty(example = "null", value = "seLinuxOptions required to run as; required for MustRunAs More info: http://releases.k8s.io/HEAD/docs/design/security_context.md#security-context")
