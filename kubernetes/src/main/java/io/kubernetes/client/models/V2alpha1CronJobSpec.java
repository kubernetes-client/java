...
public class V2alpha1CronJobSpec {
  ...
  **/
  @ApiModelProperty(value = "ConcurrencyPolicy specifies how to treat concurrent executions of a Job. Defaults to Allow.")
  ...
  **/
   ...
   * @return jobTemplate
  **/
  @ApiModelProperty(required = true, value = "JobTemplate is the object that describes the job that will be created when executing a CronJob.")
   ...
   * @return schedule
  **/
  @ApiModelProperty(required = true, value = "Schedule contains the schedule in Cron format, see https://en.wikipedia.org/wiki/Cron.")
  ...
  **/
   ...
   * @return suspend
  **/
  @ApiModelProperty(value = "Suspend flag tells the controller to suspend subsequent executions, it does not apply to already started executions.  Defaults to false.")
