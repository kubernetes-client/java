...
public class V2alpha1CronJobSpec {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies how to treat concurrent executions of a Job. Defaults to Allow.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of failed finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.")
   ...
   * @return jobTemplate
  **/
  @ApiModelProperty(example = "null", required = true, value = "Specifies the job that will be created when executing a CronJob.")
   ...
   * @return schedule
  **/
  @ApiModelProperty(example = "null", required = true, value = "The schedule in Cron format, see https://en.wikipedia.org/wiki/Cron.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of successful finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.")
   ...
   * @return suspend
  **/
  @ApiModelProperty(example = "null", value = "This flag tells the controller to suspend subsequent executions, it does not apply to already started executions.  Defaults to false.")
