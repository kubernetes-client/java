...
public class V1NamespaceSpec {
   ...
   * @return finalizers
  **/
  @ApiModelProperty(example = "null", value = "Finalizers is an opaque list of values that must be empty to permanently remove object from storage. More info: https://git.k8s.io/community/contributors/design-proposals/namespaces.md#finalizers")
