 ...
 */
@ApiModel(description = "RunAsUserStrategyOptions defines the strategy type and any options used to create the strategy. Deprecated: use RunAsUserStrategyOptions from policy API Group instead.")
...
public class ExtensionsV1beta1RunAsUserStrategyOptions {
  ...
  public ExtensionsV1beta1RunAsUserStrategyOptions addRangesItem(ExtensionsV1beta1IDRange rangesItem) {
    if (this.ranges == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExtensionsV1beta1RunAsUserStrategyOptions extensionsV1beta1RunAsUserStrategyOptions = (ExtensionsV1beta1RunAsUserStrategyOptions) o;
