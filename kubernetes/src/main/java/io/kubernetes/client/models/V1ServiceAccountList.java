...
public class V1ServiceAccountList {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of ServiceAccounts. More info: http://releases.k8s.io/HEAD/docs/design/service_accounts.md#service-accounts")
