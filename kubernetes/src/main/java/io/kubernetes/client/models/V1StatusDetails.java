...
public class V1StatusDetails {
  ...
  **/
   ...
   * @return kind
  **/
  @ApiModelProperty(example = "null", value = "The kind attribute of the resource associated with the status StatusReason. On some operations may differ from the requested resource Kind. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds")
  ...
  **/
   ...
   * @return uid
  **/
  @ApiModelProperty(example = "null", value = "UID of the resource. (when there is a single resource which can be described). More info: http://kubernetes.io/docs/user-guide/identifiers#uids")
