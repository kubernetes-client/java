...
public class V1PersistentVolumeClaim {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(example = "null", value = "Spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "Status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims")
