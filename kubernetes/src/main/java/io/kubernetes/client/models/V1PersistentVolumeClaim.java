...
public class V1PersistentVolumeClaim {
  ...
  **/
   ...
   * @return spec
  **/
  @ApiModelProperty(value = "Spec defines the desired characteristics of a volume requested by a pod author. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Status represents the current information/status of a persistent volume claim. Read-only. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims")
