...
public class V1PersistentVolumeClaimStatus {
   ...
   * @return accessModes
  **/
  @ApiModelProperty(example = "null", value = "AccessModes contains the actual access modes the volume backing the PVC has. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1")
