...
public class V1RBDVolumeSource {
   ...
   * @return fsType
  **/
  @ApiModelProperty(example = "null", value = "Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified. More info: https://kubernetes.io/docs/concepts/storage/volumes#rbd")
   ...
   * @return image
  **/
  @ApiModelProperty(example = "null", required = true, value = "The rados image name. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it")
   ...
   * @return keyring
  **/
  @ApiModelProperty(example = "null", value = "Keyring is the path to key ring for RBDUser. Default is /etc/ceph/keyring. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it")
   ...
   * @return monitors
  **/
  @ApiModelProperty(example = "null", required = true, value = "A collection of Ceph monitors. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it")
   ...
   * @return pool
  **/
  @ApiModelProperty(example = "null", value = "The rados pool name. Default is rbd. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it")
   ...
   * @return readOnly
  **/
  @ApiModelProperty(example = "null", value = "ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it")
   ...
   * @return secretRef
  **/
  @ApiModelProperty(example = "null", value = "SecretRef is name of the authentication secret for RBDUser. If provided overrides keyring. Default is nil. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it")
   ...
   * @return user
  **/
  @ApiModelProperty(example = "null", value = "The rados user name. Default is admin. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it")
