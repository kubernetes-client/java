...
public class V1JobStatus {
   ...
   * @return active
  **/
  @ApiModelProperty(value = "Active is the number of actively running pods.")
  ...
  **/
  @ApiModelProperty(value = "CompletionTime represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.")
   ...
   * @return conditions
  **/
  @ApiModelProperty(value = "Conditions represent the latest available observations of an object's current state. More info: http://kubernetes.io/docs/user-guide/jobs")
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "Failed is the number of pods which reached Phase Failed.")
   ...
   * @return startTime
  **/
  @ApiModelProperty(value = "StartTime represents time when the job was acknowledged by the Job Manager. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.")
   ...
   * @return succeeded
  **/
  @ApiModelProperty(value = "Succeeded is the number of pods which reached Phase Succeeded.")
