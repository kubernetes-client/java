...
public class V1JobStatus {
   ...
   * @return active
  **/
  @ApiModelProperty(example = "null", value = "The number of actively running pods.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.")
   ...
   * @return conditions
  **/
  @ApiModelProperty(example = "null", value = "The latest available observations of an object's current state. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/")
   ...
   * @return failed
  **/
  @ApiModelProperty(example = "null", value = "The number of pods which reached phase Failed.")
   ...
   * @return startTime
  **/
  @ApiModelProperty(example = "null", value = "Represents time when the job was acknowledged by the job controller. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.")
   ...
   * @return succeeded
  **/
  @ApiModelProperty(example = "null", value = "The number of pods which reached phase Succeeded.")
