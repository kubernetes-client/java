...
public class V1WeightedPodAffinityTerm {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Required. A pod affinity term, associated with the corresponding weight.")
   ...
   * @return weight
  **/
  @ApiModelProperty(example = "null", required = true, value = "weight associated with matching the corresponding podAffinityTerm, in the range 1-100.")
