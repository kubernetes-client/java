...
public class V1Event {
  ...
  **/
   ...
   * @return metadata
  **/
  @ApiModelProperty(example = "null", required = true, value = "Standard object's metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata")
