...
public class V1Event {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "The object that this event is about.")
  ...
  **/
   ...
   * @return metadata
  **/
  @ApiModelProperty(example = "null", required = true, value = "Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata")
  ...
  **/
   ...
   * @return source
  **/
  @ApiModelProperty(example = "null", value = "The component reporting this event. Should be a short machine understandable string.")
