...
public class V1alpha1AdmissionHookClientConfig {
   ...
   * @return caBundle
  **/
  @ApiModelProperty(example = "null", required = true, value = "CABundle is a PEM encoded CA bundle which will be used to validate webhook's server certificate. Required")
   ...
   * @return service
  **/
  @ApiModelProperty(example = "null", required = true, value = "Service is a reference to the service for this webhook. If there is only one port open for the service, that port will be used. If there are multiple ports open, port 443 will be used if it is open, otherwise it is an error. Required")
