...
public class V1alpha1ServiceReference {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "Name is the name of the service Required")
   ...
   * @return namespace
  **/
  @ApiModelProperty(example = "null", required = true, value = "Namespace is the namespace of the service Required")
