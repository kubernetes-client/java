...
public class V1PersistentVolumeClaimSpec {
   ...
   * time. If the provisioner does not support VolumeSnapshot data source, volume will not be
   * created and the failure will be reported as an event. In the future, we plan to support more
   ...
   * when not included in claim spec. This is an alpha feature and may change in the future.
   *
   * @return volumeMode
   */
  @ApiModelProperty(
