...
public class V1PersistentVolumeClaimSpec {
   ...
   * @return accessModes
  **/
  @ApiModelProperty(example = "null", value = "AccessModes contains the desired access modes the volume should have. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#access-modes-1")
   ...
   * @return resources
  **/
  @ApiModelProperty(example = "null", value = "Resources represents the minimum resources the volume should have. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#resources")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Name of the StorageClass required by the claim. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#class-1")
