...
public class V1PersistentVolumeClaimSpec {
   ...
   * @return accessModes
  **/
  @ApiModelProperty(example = "null", value = "AccessModes contains the desired access modes the volume should have. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1")
   ...
   * @return resources
  **/
  @ApiModelProperty(example = "null", value = "Resources represents the minimum resources the volume should have. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources")
   ...
   * @return selector
  **/
  @ApiModelProperty(example = "null", value = "A label query over volumes to consider for binding.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Name of the StorageClass required by the claim. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#class-1")
