...
public class V1CephFSVolumeSource {
   ...
   * @return monitors
  **/
  @ApiModelProperty(example = "null", required = true, value = "Required: Monitors is a collection of Ceph monitors More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it")
  ...
  **/
   ...
   * @return readOnly
  **/
  @ApiModelProperty(example = "null", value = "Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts. More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it")
   ...
   * @return secretFile
  **/
  @ApiModelProperty(example = "null", value = "Optional: SecretFile is the path to key ring for User, default is /etc/ceph/user.secret More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it")
   ...
   * @return secretRef
  **/
  @ApiModelProperty(example = "null", value = "Optional: SecretRef is reference to the authentication secret for User, default is empty. More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it")
   ...
   * @return user
  **/
  @ApiModelProperty(example = "null", value = "Optional: User is the rados user name, default is admin More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it")
