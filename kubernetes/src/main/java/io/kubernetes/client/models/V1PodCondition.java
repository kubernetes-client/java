...
public class V1PodCondition {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", required = true, value = "Status is the status of the condition. Can be True, False, Unknown. More info: http://kubernetes.io/docs/user-guide/pod-states#pod-conditions")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "Type is the type of the condition. Currently only Ready. More info: http://kubernetes.io/docs/user-guide/pod-states#pod-conditions")
