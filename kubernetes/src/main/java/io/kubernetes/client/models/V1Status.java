...
public class V1Status {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "Status of the operation. One of: \"Success\" or \"Failure\". More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status")
