...
public class AutoscalingV1ApiTest {
    ...
    public void createNamespacedHorizontalPodAutoscalerTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1HorizontalPodAutoscaler response = api.createNamespacedHorizontalPodAutoscaler(namespace, body, includeUninitialized, pretty, dryRun);
    ...
    public void listHorizontalPodAutoscalerForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1HorizontalPodAutoscalerList response = api.listHorizontalPodAutoscalerForAllNamespaces(_continue, fieldSelector, includeUninitialized, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedHorizontalPodAutoscalerTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1HorizontalPodAutoscalerList response = api.listNamespacedHorizontalPodAutoscaler(namespace, includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchNamespacedHorizontalPodAutoscalerTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1HorizontalPodAutoscaler response = api.patchNamespacedHorizontalPodAutoscaler(name, namespace, body, pretty, dryRun);
    ...
    public void patchNamespacedHorizontalPodAutoscalerStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1HorizontalPodAutoscaler response = api.patchNamespacedHorizontalPodAutoscalerStatus(name, namespace, body, pretty, dryRun);
    ...
    public void replaceNamespacedHorizontalPodAutoscalerTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1HorizontalPodAutoscaler response = api.replaceNamespacedHorizontalPodAutoscaler(name, namespace, body, pretty, dryRun);
    ...
    public void replaceNamespacedHorizontalPodAutoscalerStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1HorizontalPodAutoscaler response = api.replaceNamespacedHorizontalPodAutoscalerStatus(name, namespace, body, pretty, dryRun);
