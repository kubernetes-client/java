...
public class BatchV1ApiTest {
    ...
    public void deleteCollectionNamespacedJobTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionNamespacedJob(namespace, pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listJobForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1JobList response = api.listJobForAllNamespaces(fieldSelector, includeUninitialized, labelSelector, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedJobTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1JobList response = api.listNamespacedJob(namespace, pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
