...
public class EventsV1beta1ApiTest {
    ...
    public void createNamespacedEventTest() throws ApiException {
        ...
        String pretty = null;
        V1beta1Event response = api.createNamespacedEvent(namespace, body, pretty);
    ...
    public void listNamespacedEventTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1EventList response = api.listNamespacedEvent(namespace, pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchNamespacedEventTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        V1beta1Event response = api.patchNamespacedEvent(name, namespace, body, pretty);
    ...
    public void replaceNamespacedEventTest() throws ApiException {
        ...
        V1beta1Event body = null;
        String pretty = null;
        V1beta1Event response = api.replaceNamespacedEvent(name, namespace, body, pretty);
