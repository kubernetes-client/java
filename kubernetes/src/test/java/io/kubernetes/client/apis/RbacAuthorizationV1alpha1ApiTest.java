...
public class RbacAuthorizationV1alpha1ApiTest {
  ...
  public void createClusterRoleTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1alpha1ClusterRole response =
        api.createClusterRole(body, includeUninitialized, pretty, dryRun);
  ...
  public void createClusterRoleBindingTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1alpha1ClusterRoleBinding response =
        api.createClusterRoleBinding(body, includeUninitialized, pretty, dryRun);
  ...
  public void createNamespacedRoleTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1alpha1Role response =
        api.createNamespacedRole(namespace, body, includeUninitialized, pretty, dryRun);
  ...
  public void createNamespacedRoleBindingTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1alpha1RoleBinding response =
        api.createNamespacedRoleBinding(namespace, body, includeUninitialized, pretty, dryRun);
  ...
  public void deleteCollectionClusterRoleTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionClusterRole(
  ...
  public void deleteCollectionClusterRoleBindingTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionClusterRoleBinding(
            includeUninitialized,
            pretty,
            _continue,
            fieldSelector,
  ...
  public void deleteCollectionNamespacedRoleTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionNamespacedRole(
            namespace,
            includeUninitialized,
            pretty,
            _continue,
  ...
  public void deleteCollectionNamespacedRoleBindingTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionNamespacedRoleBinding(
            namespace,
            includeUninitialized,
            pretty,
            _continue,
  ...
  public void deleteNamespacedRoleBindingTest() throws ApiException {
    ...
    String propagationPolicy = null;
    V1Status response =
        api.deleteNamespacedRoleBinding(
            name,
            namespace,
            body,
            pretty,
  ...
  public void listClusterRoleTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1alpha1ClusterRoleList response =
        api.listClusterRole(
            includeUninitialized,
            pretty,
            _continue,
  ...
  public void listClusterRoleBindingTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1alpha1ClusterRoleBindingList response =
  ...
  public void listNamespacedRoleBindingTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1alpha1RoleBindingList response =
        api.listNamespacedRoleBinding(
            namespace,
            includeUninitialized,
            pretty,
            _continue,
  ...
  public void patchNamespacedRoleBindingTest() throws ApiException {
    ...
    String dryRun = null;
    V1alpha1RoleBinding response =
        api.patchNamespacedRoleBinding(name, namespace, body, pretty, dryRun);
  ...
  public void replaceNamespacedRoleBindingTest() throws ApiException {
    ...
    String dryRun = null;
    V1alpha1RoleBinding response =
        api.replaceNamespacedRoleBinding(name, namespace, body, pretty, dryRun);
