...
public class StorageV1alpha1ApiTest {
    ...
    public void createVolumeAttachmentTest() throws ApiException {
        ...
        String pretty = null;
        V1alpha1VolumeAttachment response = api.createVolumeAttachment(body, pretty);
    ...
    public void deleteCollectionVolumeAttachmentTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionVolumeAttachment(pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void deleteVolumeAttachmentTest() throws ApiException {
        ...
        V1Status response = api.deleteVolumeAttachment(name, body, pretty, gracePeriodSeconds, orphanDependents, propagationPolicy);
    ...
    public void listVolumeAttachmentTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1alpha1VolumeAttachmentList response = api.listVolumeAttachment(pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchVolumeAttachmentTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        V1alpha1VolumeAttachment response = api.patchVolumeAttachment(name, body, pretty);
    ...
    public void replaceVolumeAttachmentTest() throws ApiException {
        ...
        V1alpha1VolumeAttachment body = null;
        String pretty = null;
        V1alpha1VolumeAttachment response = api.replaceVolumeAttachment(name, body, pretty);
