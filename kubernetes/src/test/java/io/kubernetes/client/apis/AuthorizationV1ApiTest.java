...
public class AuthorizationV1ApiTest {
    ...
    public void createNamespacedLocalSubjectAccessReviewTest() throws ApiException {
        ...
        String pretty = null;
        V1LocalSubjectAccessReview response = api.createNamespacedLocalSubjectAccessReview(namespace, body, pretty);
    ...
    public void createSelfSubjectAccessReviewTest() throws ApiException {
        ...
        String pretty = null;
        V1SelfSubjectAccessReview response = api.createSelfSubjectAccessReview(body, pretty);
    ...
    public void createSelfSubjectRulesReviewTest() throws ApiException {
        ...
        String pretty = null;
        V1SelfSubjectRulesReview response = api.createSelfSubjectRulesReview(body, pretty);
