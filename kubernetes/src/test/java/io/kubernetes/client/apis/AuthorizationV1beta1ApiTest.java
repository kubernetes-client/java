...
public class AuthorizationV1beta1ApiTest {
    ...
    public void createNamespacedLocalSubjectAccessReviewTest() throws ApiException {
        ...
        String pretty = null;
        V1beta1LocalSubjectAccessReview response = api.createNamespacedLocalSubjectAccessReview(namespace, body, dryRun, includeUninitialized, pretty);
    ...
    public void createSelfSubjectAccessReviewTest() throws ApiException {
        ...
        Boolean includeUninitialized = null;
        String pretty = null;
        V1beta1SelfSubjectAccessReview response = api.createSelfSubjectAccessReview(body, dryRun, includeUninitialized, pretty);
    ...
    public void createSelfSubjectRulesReviewTest() throws ApiException {
        ...
        Boolean includeUninitialized = null;
        String pretty = null;
        V1beta1SelfSubjectRulesReview response = api.createSelfSubjectRulesReview(body, dryRun, includeUninitialized, pretty);
    ...
    public void createSubjectAccessReviewTest() throws ApiException {
        ...
        Boolean includeUninitialized = null;
        String pretty = null;
        V1beta1SubjectAccessReview response = api.createSubjectAccessReview(body, dryRun, includeUninitialized, pretty);
