...
public class AutoscalingV2beta1ApiTest {
  ...
  public void deleteCollectionNamespacedHorizontalPodAutoscalerTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionNamespacedHorizontalPodAutoscaler(
            namespace,
  ...
  public void deleteNamespacedHorizontalPodAutoscalerTest() throws ApiException {
    ...
    V1Status response =
        api.deleteNamespacedHorizontalPodAutoscaler(
            name,
            namespace,
            body,
            pretty,
  ...
  public void listHorizontalPodAutoscalerForAllNamespacesTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V2beta1HorizontalPodAutoscalerList response =
        api.listHorizontalPodAutoscalerForAllNamespaces(
            _continue,
            fieldSelector,
            includeUninitialized,
            labelSelector,
  ...
  public void listNamespacedHorizontalPodAutoscalerTest() throws ApiException {
    ...
    Boolean watch = null;
    V2beta1HorizontalPodAutoscalerList response =
        api.listNamespacedHorizontalPodAutoscaler(
            namespace,
            includeUninitialized,
            pretty,
            _continue,
  ...
  public void patchNamespacedHorizontalPodAutoscalerTest() throws ApiException {
    ...
    String dryRun = null;
    V2beta1HorizontalPodAutoscaler response =
        api.patchNamespacedHorizontalPodAutoscaler(name, namespace, body, pretty, dryRun);
  ...
  public void patchNamespacedHorizontalPodAutoscalerStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V2beta1HorizontalPodAutoscaler response =
        api.patchNamespacedHorizontalPodAutoscalerStatus(name, namespace, body, pretty, dryRun);
  ...
  public void readNamespacedHorizontalPodAutoscalerStatusTest() throws ApiException {
    ...
    String pretty = null;
    V2beta1HorizontalPodAutoscaler response =
        api.readNamespacedHorizontalPodAutoscalerStatus(name, namespace, pretty);
  ...
  public void replaceNamespacedHorizontalPodAutoscalerTest() throws ApiException {
    ...
    String dryRun = null;
    V2beta1HorizontalPodAutoscaler response =
        api.replaceNamespacedHorizontalPodAutoscaler(name, namespace, body, pretty, dryRun);
  ...
  public void replaceNamespacedHorizontalPodAutoscalerStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V2beta1HorizontalPodAutoscaler response =
        api.replaceNamespacedHorizontalPodAutoscalerStatus(name, namespace, body, pretty, dryRun);
