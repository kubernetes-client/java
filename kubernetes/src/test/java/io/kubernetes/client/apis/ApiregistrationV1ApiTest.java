...
public class ApiregistrationV1ApiTest {
    ...
    public void createAPIServiceTest() throws ApiException {
        ...
        String pretty = null;
        V1APIService response = api.createAPIService(body, pretty);
    ...
    public void listAPIServiceTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1APIServiceList response = api.listAPIService(pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchAPIServiceTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        V1APIService response = api.patchAPIService(name, body, pretty);
    ...
    public void patchAPIServiceStatusTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        V1APIService response = api.patchAPIServiceStatus(name, body, pretty);
    ...
    public void replaceAPIServiceTest() throws ApiException {
        ...
        V1APIService body = null;
        String pretty = null;
        V1APIService response = api.replaceAPIService(name, body, pretty);
    ...
    public void replaceAPIServiceStatusTest() throws ApiException {
        ...
        V1APIService body = null;
        String pretty = null;
        V1APIService response = api.replaceAPIServiceStatus(name, body, pretty);
