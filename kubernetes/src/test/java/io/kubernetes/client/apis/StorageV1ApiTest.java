...
public class StorageV1ApiTest {
    ...
    public void deleteCollectionStorageClassTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionStorageClass(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listStorageClassTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1StorageClassList response = api.listStorageClass(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
