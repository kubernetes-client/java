...
public class StorageV1beta1ApiTest {
    ...
    public void createVolumeAttachmentTest() throws ApiException {
        ...
        String pretty = null;
        V1beta1VolumeAttachment response = api.createVolumeAttachment(body, pretty);
    ...
    public void listVolumeAttachmentTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1VolumeAttachmentList response = api.listVolumeAttachment(pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchVolumeAttachmentTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        V1beta1VolumeAttachment response = api.patchVolumeAttachment(name, body, pretty);
    ...
    public void replaceVolumeAttachmentTest() throws ApiException {
        ...
        V1beta1VolumeAttachment body = null;
        String pretty = null;
        V1beta1VolumeAttachment response = api.replaceVolumeAttachment(name, body, pretty);
