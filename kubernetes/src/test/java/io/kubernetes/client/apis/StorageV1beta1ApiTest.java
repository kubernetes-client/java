...
public class StorageV1beta1ApiTest {
  ...
  public void createStorageClassTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1beta1StorageClass response =
        api.createStorageClass(body, includeUninitialized, pretty, dryRun);
  ...
  public void createVolumeAttachmentTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1beta1VolumeAttachment response =
        api.createVolumeAttachment(body, includeUninitialized, pretty, dryRun);
  ...
  public void deleteCollectionVolumeAttachmentTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionVolumeAttachment(
            includeUninitialized,
            pretty,
            _continue,
            fieldSelector,
  ...
  public void listStorageClassTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1beta1StorageClassList response =
  ...
  public void listVolumeAttachmentTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1beta1VolumeAttachmentList response =
        api.listVolumeAttachment(
            includeUninitialized,
            pretty,
            _continue,
            fieldSelector,
