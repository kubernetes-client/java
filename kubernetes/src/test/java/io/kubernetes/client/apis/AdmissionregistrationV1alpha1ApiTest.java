...
public class AdmissionregistrationV1alpha1ApiTest {
    ...
    public void createInitializerConfigurationTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1alpha1InitializerConfiguration response = api.createInitializerConfiguration(body, includeUninitialized, pretty, dryRun);
    ...
    public void deleteCollectionInitializerConfigurationTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionInitializerConfiguration(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void deleteInitializerConfigurationTest() throws ApiException {
        ...
        V1Status response = api.deleteInitializerConfiguration(name, body, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy);
    ...
    public void listInitializerConfigurationTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1alpha1InitializerConfigurationList response = api.listInitializerConfiguration(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchInitializerConfigurationTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1alpha1InitializerConfiguration response = api.patchInitializerConfiguration(name, body, pretty, dryRun);
    ...
    public void replaceInitializerConfigurationTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1alpha1InitializerConfiguration response = api.replaceInitializerConfiguration(name, body, pretty, dryRun);
