...
public class AdmissionregistrationV1alpha1ApiTest {
    ...
    public void deleteCollectionExternalAdmissionHookConfigurationTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionExternalAdmissionHookConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void deleteCollectionInitializerConfigurationTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1Status response = api.deleteCollectionInitializerConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listExternalAdmissionHookConfigurationTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1alpha1ExternalAdmissionHookConfigurationList response = api.listExternalAdmissionHookConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listInitializerConfigurationTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1alpha1InitializerConfigurationList response = api.listInitializerConfiguration(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
