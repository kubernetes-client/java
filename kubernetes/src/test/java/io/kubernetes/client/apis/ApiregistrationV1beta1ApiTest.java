...
public class ApiregistrationV1beta1ApiTest {
    ...
    public void deleteCollectionAPIServiceTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionAPIService(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listAPIServiceTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1APIServiceList response = api.listAPIService(pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
