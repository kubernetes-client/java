...
public class ApiregistrationV1beta1ApiTest {
    ...
    public void createAPIServiceTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1APIService response = api.createAPIService(body, includeUninitialized, pretty, dryRun);
    ...
    public void listAPIServiceTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1APIServiceList response = api.listAPIService(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchAPIServiceTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1APIService response = api.patchAPIService(name, body, pretty, dryRun);
    ...
    public void patchAPIServiceStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1APIService response = api.patchAPIServiceStatus(name, body, pretty, dryRun);
    ...
    public void replaceAPIServiceTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1APIService response = api.replaceAPIService(name, body, pretty, dryRun);
    ...
    public void replaceAPIServiceStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1APIService response = api.replaceAPIServiceStatus(name, body, pretty, dryRun);
