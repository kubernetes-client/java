...
public class CustomObjectsApiTest {
    ...
    public void listClusterCustomObjectTest() throws ApiException {
        ...
        Boolean watch = null;
        Object response = api.listClusterCustomObject(group, version, plural, pretty, fieldSelector, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedCustomObjectTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        Object response = api.listNamespacedCustomObject(group, version, namespace, plural, pretty, fieldSelector, labelSelector, resourceVersion, timeoutSeconds, watch);
