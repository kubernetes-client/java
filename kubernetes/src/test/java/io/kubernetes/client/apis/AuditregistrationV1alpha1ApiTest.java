...
public class AuditregistrationV1alpha1ApiTest {
    ...
    public void deleteCollectionAuditSinkTest() throws ApiException {
        ...
        Boolean watch = null;
        V1DeleteOptions body = null;
        V1Status response = api.deleteCollectionAuditSink(pretty, allowWatchBookmarks, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, timeoutSeconds, watch, body);
    ...
    public void listAuditSinkTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1alpha1AuditSinkList response = api.listAuditSink(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
