...
public class CertificatesV1beta1ApiTest {
    ...
    public void createCertificateSigningRequestTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1CertificateSigningRequest response = api.createCertificateSigningRequest(body, includeUninitialized, pretty, dryRun);
    ...
    public void deleteCertificateSigningRequestTest() throws ApiException {
        ...
        V1Status response = api.deleteCertificateSigningRequest(name, body, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy);
    ...
    public void deleteCollectionCertificateSigningRequestTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionCertificateSigningRequest(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listCertificateSigningRequestTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1CertificateSigningRequestList response = api.listCertificateSigningRequest(includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchCertificateSigningRequestTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1CertificateSigningRequest response = api.patchCertificateSigningRequest(name, body, pretty, dryRun);
    ...
    public void patchCertificateSigningRequestStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1CertificateSigningRequest response = api.patchCertificateSigningRequestStatus(name, body, pretty, dryRun);
    ...
    public void replaceCertificateSigningRequestTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1CertificateSigningRequest response = api.replaceCertificateSigningRequest(name, body, pretty, dryRun);
    ...
    public void replaceCertificateSigningRequestApprovalTest() throws ApiException {
        ...
        String dryRun = null;
        String pretty = null;
        V1beta1CertificateSigningRequest response = api.replaceCertificateSigningRequestApproval(name, body, dryRun, pretty);
    ...
    public void replaceCertificateSigningRequestStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V1beta1CertificateSigningRequest response = api.replaceCertificateSigningRequestStatus(name, body, pretty, dryRun);
