...
public class CertificatesV1beta1ApiTest {
    ...
    public void deleteCertificateSigningRequestTest() throws ApiException {
        ...
        V1Status response = api.deleteCertificateSigningRequest(name, pretty, body, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy);
    ...
    public void deleteCollectionCertificateSigningRequestTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionCertificateSigningRequest(pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listCertificateSigningRequestTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1CertificateSigningRequestList response = api.listCertificateSigningRequest(pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
