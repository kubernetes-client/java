...
public class CertificatesV1beta1ApiTest {
    ...
    public void deleteCollectionCertificateSigningRequestTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionCertificateSigningRequest(pretty, fieldSelector, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listCertificateSigningRequestTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1CertificateSigningRequestList response = api.listCertificateSigningRequest(pretty, fieldSelector, labelSelector, resourceVersion, timeoutSeconds, watch);
