...
public class CertificatesV1beta1ApiTest {
  ...
  public void createCertificateSigningRequestTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1beta1CertificateSigningRequest response =
        api.createCertificateSigningRequest(body, includeUninitialized, pretty, dryRun);
  ...
  public void deleteCertificateSigningRequestTest() throws ApiException {
    ...
    V1Status response =
        api.deleteCertificateSigningRequest(
  ...
  public void deleteCollectionCertificateSigningRequestTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionCertificateSigningRequest(
  ...
  public void listCertificateSigningRequestTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1beta1CertificateSigningRequestList response =
        api.listCertificateSigningRequest(
            includeUninitialized,
            pretty,
            _continue,
            fieldSelector,
  ...
  public void patchCertificateSigningRequestTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1CertificateSigningRequest response =
        api.patchCertificateSigningRequest(name, body, pretty, dryRun);
  ...
  public void patchCertificateSigningRequestStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1CertificateSigningRequest response =
        api.patchCertificateSigningRequestStatus(name, body, pretty, dryRun);
  ...
  public void readCertificateSigningRequestTest() throws ApiException {
    ...
    Boolean export = null;
    V1beta1CertificateSigningRequest response =
        api.readCertificateSigningRequest(name, pretty, exact, export);
  ...
  public void readCertificateSigningRequestStatusTest() throws ApiException {
    ...
    String pretty = null;
    V1beta1CertificateSigningRequest response =
        api.readCertificateSigningRequestStatus(name, pretty);
  ...
  public void replaceCertificateSigningRequestTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1CertificateSigningRequest response =
        api.replaceCertificateSigningRequest(name, body, pretty, dryRun);
  ...
  public void replaceCertificateSigningRequestApprovalTest() throws ApiException {
    ...
    String pretty = null;
    V1beta1CertificateSigningRequest response =
        api.replaceCertificateSigningRequestApproval(name, body, dryRun, pretty);
  ...
  public void replaceCertificateSigningRequestStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1CertificateSigningRequest response =
        api.replaceCertificateSigningRequestStatus(name, body, pretty, dryRun);
