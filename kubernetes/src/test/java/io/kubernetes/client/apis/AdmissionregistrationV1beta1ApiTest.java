...
public class AdmissionregistrationV1beta1ApiTest {
    ...
    public void deleteCollectionMutatingWebhookConfigurationTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionMutatingWebhookConfiguration(pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void deleteCollectionValidatingWebhookConfigurationTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1Status response = api.deleteCollectionValidatingWebhookConfiguration(pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listMutatingWebhookConfigurationTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1MutatingWebhookConfigurationList response = api.listMutatingWebhookConfiguration(pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listValidatingWebhookConfigurationTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1ValidatingWebhookConfigurationList response = api.listValidatingWebhookConfiguration(pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
