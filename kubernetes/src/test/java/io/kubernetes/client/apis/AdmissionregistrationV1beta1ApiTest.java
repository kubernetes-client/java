...
public class AdmissionregistrationV1beta1ApiTest {
    ...
    public void deleteMutatingWebhookConfigurationTest() throws ApiException {
        ...
        V1Status response = api.deleteMutatingWebhookConfiguration(name, body, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy);
    ...
    public void deleteValidatingWebhookConfigurationTest() throws ApiException {
        ...
        Boolean orphanDependents = null;
        String propagationPolicy = null;
        V1Status response = api.deleteValidatingWebhookConfiguration(name, body, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy);
