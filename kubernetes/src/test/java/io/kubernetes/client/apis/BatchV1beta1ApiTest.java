...
public class BatchV1beta1ApiTest {
    ...
    public void createNamespacedCronJobTest() throws ApiException {
        ...
        String pretty = null;
        V1beta1CronJob response = api.createNamespacedCronJob(namespace, body, pretty);
    ...
    public void deleteCollectionNamespacedCronJobTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionNamespacedCronJob(namespace, pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedCronJobTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1CronJobList response = api.listNamespacedCronJob(namespace, pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchNamespacedCronJobTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        V1beta1CronJob response = api.patchNamespacedCronJob(name, namespace, body, pretty);
    ...
    public void patchNamespacedCronJobStatusTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        V1beta1CronJob response = api.patchNamespacedCronJobStatus(name, namespace, body, pretty);
    ...
    public void replaceNamespacedCronJobTest() throws ApiException {
        ...
        V1beta1CronJob body = null;
        String pretty = null;
        V1beta1CronJob response = api.replaceNamespacedCronJob(name, namespace, body, pretty);
    ...
    public void replaceNamespacedCronJobStatusTest() throws ApiException {
        ...
        V1beta1CronJob body = null;
        String pretty = null;
        V1beta1CronJob response = api.replaceNamespacedCronJobStatus(name, namespace, body, pretty);
