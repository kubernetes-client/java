...
public class SettingsV1alpha1ApiTest {
  ...
  public void createNamespacedPodPresetTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1alpha1PodPreset response =
        api.createNamespacedPodPreset(namespace, body, includeUninitialized, pretty, dryRun);
  ...
  public void deleteCollectionNamespacedPodPresetTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionNamespacedPodPreset(
            namespace,
  ...
  public void listNamespacedPodPresetTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1alpha1PodPresetList response =
        api.listNamespacedPodPreset(
            namespace,
            includeUninitialized,
            pretty,
            _continue,
  ...
  public void listPodPresetForAllNamespacesTest() throws ApiException {
    ...
    Boolean watch = null;
    V1alpha1PodPresetList response =
        api.listPodPresetForAllNamespaces(
            _continue,
            fieldSelector,
            includeUninitialized,
            labelSelector,
  ...
  public void patchNamespacedPodPresetTest() throws ApiException {
    ...
    String dryRun = null;
    V1alpha1PodPreset response =
        api.patchNamespacedPodPreset(name, namespace, body, pretty, dryRun);
  ...
  public void readNamespacedPodPresetTest() throws ApiException {
    ...
    Boolean export = null;
    V1alpha1PodPreset response =
        api.readNamespacedPodPreset(name, namespace, pretty, exact, export);
  ...
  public void replaceNamespacedPodPresetTest() throws ApiException {
    ...
    String dryRun = null;
    V1alpha1PodPreset response =
        api.replaceNamespacedPodPreset(name, namespace, body, pretty, dryRun);
