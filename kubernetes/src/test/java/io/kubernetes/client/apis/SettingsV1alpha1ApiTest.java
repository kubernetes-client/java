...
public class SettingsV1alpha1ApiTest {
    ...
    public void deleteCollectionNamespacedPodPresetTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionNamespacedPodPreset(namespace, pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedPodPresetTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1alpha1PodPresetList response = api.listNamespacedPodPreset(namespace, pretty, fieldSelector, includeUninitialized, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listPodPresetForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1alpha1PodPresetList response = api.listPodPresetForAllNamespaces(fieldSelector, includeUninitialized, labelSelector, pretty, resourceVersion, timeoutSeconds, watch);
