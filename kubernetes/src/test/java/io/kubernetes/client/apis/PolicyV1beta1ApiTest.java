...
public class PolicyV1beta1ApiTest {
  ...
  public void createNamespacedPodDisruptionBudgetTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V1beta1PodDisruptionBudget response =
        api.createNamespacedPodDisruptionBudget(
  ...
  public void createPodSecurityPolicyTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    PolicyV1beta1PodSecurityPolicy response =
  ...
  public void deleteCollectionNamespacedPodDisruptionBudgetTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionNamespacedPodDisruptionBudget(
            namespace,
  ...
  public void deleteNamespacedPodDisruptionBudgetTest() throws ApiException {
    ...
    V1Status response =
        api.deleteNamespacedPodDisruptionBudget(
            name,
            namespace,
            body,
            pretty,
  ...
  public void listNamespacedPodDisruptionBudgetTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V1beta1PodDisruptionBudgetList response =
        api.listNamespacedPodDisruptionBudget(
            namespace,
            includeUninitialized,
            pretty,
            _continue,
  ...
  public void listPodDisruptionBudgetForAllNamespacesTest() throws ApiException {
    ...
    Boolean watch = null;
    V1beta1PodDisruptionBudgetList response =
        api.listPodDisruptionBudgetForAllNamespaces(
            _continue,
            fieldSelector,
            includeUninitialized,
            labelSelector,
  ...
  public void listPodSecurityPolicyTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    PolicyV1beta1PodSecurityPolicyList response =
  ...
  public void patchNamespacedPodDisruptionBudgetTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1PodDisruptionBudget response =
        api.patchNamespacedPodDisruptionBudget(name, namespace, body, pretty, dryRun);
  ...
  public void patchNamespacedPodDisruptionBudgetStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1PodDisruptionBudget response =
        api.patchNamespacedPodDisruptionBudgetStatus(name, namespace, body, pretty, dryRun);
  ...
  public void readNamespacedPodDisruptionBudgetTest() throws ApiException {
    ...
    Boolean export = null;
    V1beta1PodDisruptionBudget response =
        api.readNamespacedPodDisruptionBudget(name, namespace, pretty, exact, export);
  ...
  public void readNamespacedPodDisruptionBudgetStatusTest() throws ApiException {
    ...
    String pretty = null;
    V1beta1PodDisruptionBudget response =
        api.readNamespacedPodDisruptionBudgetStatus(name, namespace, pretty);
  ...
  public void replaceNamespacedPodDisruptionBudgetTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1PodDisruptionBudget response =
        api.replaceNamespacedPodDisruptionBudget(name, namespace, body, pretty, dryRun);
  ...
  public void replaceNamespacedPodDisruptionBudgetStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V1beta1PodDisruptionBudget response =
        api.replaceNamespacedPodDisruptionBudgetStatus(name, namespace, body, pretty, dryRun);
