...
public class PolicyV1beta1ApiTest {
    ...
    public void createPodSecurityPolicyTest() throws ApiException {
        ...
        String pretty = null;
        PolicyV1beta1PodSecurityPolicy response = api.createPodSecurityPolicy(body, pretty);
    ...
    public void listPodSecurityPolicyTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        PolicyV1beta1PodSecurityPolicyList response = api.listPodSecurityPolicy(pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchPodSecurityPolicyTest() throws ApiException {
        ...
        Object body = null;
        String pretty = null;
        PolicyV1beta1PodSecurityPolicy response = api.patchPodSecurityPolicy(name, body, pretty);
    ...
    public void replacePodSecurityPolicyTest() throws ApiException {
        ...
        PolicyV1beta1PodSecurityPolicy body = null;
        String pretty = null;
        PolicyV1beta1PodSecurityPolicy response = api.replacePodSecurityPolicy(name, body, pretty);
