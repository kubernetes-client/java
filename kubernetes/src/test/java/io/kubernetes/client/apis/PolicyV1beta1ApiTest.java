...
public class PolicyV1beta1ApiTest {
    ...
    public void deleteCollectionNamespacedPodDisruptionBudgetTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionNamespacedPodDisruptionBudget(namespace, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedPodDisruptionBudgetTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1PodDisruptionBudgetList response = api.listNamespacedPodDisruptionBudget(namespace, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listPodDisruptionBudgetForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1PodDisruptionBudgetList response = api.listPodDisruptionBudgetForAllNamespaces(_continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void listPodSecurityPolicyTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        PolicyV1beta1PodSecurityPolicyList response = api.listPodSecurityPolicy(pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
