...
public class PolicyV1beta1ApiTest {
    ...
    public void deleteCollectionNamespacedPodDisruptionBudgetTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionNamespacedPodDisruptionBudget(namespace, pretty, fieldSelector, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedPodDisruptionBudgetTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1PodDisruptionBudgetList response = api.listNamespacedPodDisruptionBudget(namespace, pretty, fieldSelector, labelSelector, resourceVersion, timeoutSeconds, watch);
    ...
    public void listPodDisruptionBudgetForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1PodDisruptionBudgetList response = api.listPodDisruptionBudgetForAllNamespaces(fieldSelector, labelSelector, pretty, resourceVersion, timeoutSeconds, watch);
