...
public class BatchV2alpha1ApiTest {
    ...
    public void deleteCollectionNamespacedCronJobTest() throws ApiException {
        ...
        Boolean watch = null;
        V1Status response = api.deleteCollectionNamespacedCronJob(namespace, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void listCronJobForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V2alpha1CronJobList response = api.listCronJobForAllNamespaces(_continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedCronJobTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V2alpha1CronJobList response = api.listNamespacedCronJob(namespace, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
