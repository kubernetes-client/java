...
public class BatchV2alpha1ApiTest {
    ...
    public void createNamespacedCronJobTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V2alpha1CronJob response = api.createNamespacedCronJob(namespace, body, includeUninitialized, pretty, dryRun);
    ...
    public void listCronJobForAllNamespacesTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V2alpha1CronJobList response = api.listCronJobForAllNamespaces(_continue, fieldSelector, includeUninitialized, labelSelector, limit, pretty, resourceVersion, timeoutSeconds, watch);
    ...
    public void listNamespacedCronJobTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V2alpha1CronJobList response = api.listNamespacedCronJob(namespace, includeUninitialized, pretty, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchNamespacedCronJobTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V2alpha1CronJob response = api.patchNamespacedCronJob(name, namespace, body, pretty, dryRun);
    ...
    public void patchNamespacedCronJobStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V2alpha1CronJob response = api.patchNamespacedCronJobStatus(name, namespace, body, pretty, dryRun);
    ...
    public void replaceNamespacedCronJobTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V2alpha1CronJob response = api.replaceNamespacedCronJob(name, namespace, body, pretty, dryRun);
    ...
    public void replaceNamespacedCronJobStatusTest() throws ApiException {
        ...
        String pretty = null;
        String dryRun = null;
        V2alpha1CronJob response = api.replaceNamespacedCronJobStatus(name, namespace, body, pretty, dryRun);
