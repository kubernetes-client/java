...
public class BatchV2alpha1ApiTest {
    ...
    public void listNamespacedCronJobTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V2alpha1CronJobList response = api.listNamespacedCronJob(namespace, pretty, _continue, fieldSelector, includeUninitialized, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
