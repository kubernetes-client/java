...
public class BatchV2alpha1ApiTest {
  ...
  public void createNamespacedCronJobTest() throws ApiException {
    ...
    String pretty = null;
    String dryRun = null;
    V2alpha1CronJob response =
        api.createNamespacedCronJob(namespace, body, includeUninitialized, pretty, dryRun);
  ...
  public void deleteCollectionNamespacedCronJobTest() throws ApiException {
    ...
    Boolean watch = null;
    V1Status response =
        api.deleteCollectionNamespacedCronJob(
            namespace,
  ...
  public void listCronJobForAllNamespacesTest() throws ApiException {
    ...
    Integer timeoutSeconds = null;
    Boolean watch = null;
    V2alpha1CronJobList response =
        api.listCronJobForAllNamespaces(
            _continue,
            fieldSelector,
            includeUninitialized,
            labelSelector,
  ...
  public void patchNamespacedCronJobStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V2alpha1CronJob response =
        api.patchNamespacedCronJobStatus(name, namespace, body, pretty, dryRun);
  ...
  public void replaceNamespacedCronJobStatusTest() throws ApiException {
    ...
    String dryRun = null;
    V2alpha1CronJob response =
        api.replaceNamespacedCronJobStatus(name, namespace, body, pretty, dryRun);
