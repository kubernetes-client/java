...
/**
 * Model tests for V1StatefulSetSpec
 */
public class V1StatefulSetSpecTest {
    private final V1StatefulSetSpec model = new V1StatefulSetSpec();
