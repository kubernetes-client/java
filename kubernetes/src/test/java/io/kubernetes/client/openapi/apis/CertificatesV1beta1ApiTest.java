...
public class CertificatesV1beta1ApiTest {
    ...
    public void createCertificateSigningRequestTest() throws ApiException {
        ...
        V1beta1CertificateSigningRequest response = api.createCertificateSigningRequest(body, pretty, dryRun, fieldManager);
    ...
    public void deleteCertificateSigningRequestTest() throws ApiException {
        ...
        V1Status response = api.deleteCertificateSigningRequest(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    ...
    public void deleteCollectionCertificateSigningRequestTest() throws ApiException {
        ...
        Boolean watch = null;
        V1DeleteOptions body = null;
        V1Status response = api.deleteCollectionCertificateSigningRequest(pretty, allowWatchBookmarks, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, timeoutSeconds, watch, body);
    ...
    public void listCertificateSigningRequestTest() throws ApiException {
        ...
        Integer timeoutSeconds = null;
        Boolean watch = null;
        V1beta1CertificateSigningRequestList response = api.listCertificateSigningRequest(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, timeoutSeconds, watch);
    ...
    public void patchCertificateSigningRequestTest() throws ApiException {
        ...
        String fieldManager = null;
        Boolean force = null;
        V1beta1CertificateSigningRequest response = api.patchCertificateSigningRequest(name, body, pretty, dryRun, fieldManager, force);
    ...
    public void patchCertificateSigningRequestStatusTest() throws ApiException {
        ...
        String fieldManager = null;
        Boolean force = null;
        V1beta1CertificateSigningRequest response = api.patchCertificateSigningRequestStatus(name, body, pretty, dryRun, fieldManager, force);
    ...
    public void replaceCertificateSigningRequestTest() throws ApiException {
        ...
        String dryRun = null;
        String fieldManager = null;
        V1beta1CertificateSigningRequest response = api.replaceCertificateSigningRequest(name, body, pretty, dryRun, fieldManager);
    ...
    public void replaceCertificateSigningRequestApprovalTest() throws ApiException {
        ...
        String fieldManager = null;
        String pretty = null;
        V1beta1CertificateSigningRequest response = api.replaceCertificateSigningRequestApproval(name, body, dryRun, fieldManager, pretty);
    ...
    public void replaceCertificateSigningRequestStatusTest() throws ApiException {
        ...
        String dryRun = null;
        String fieldManager = null;
        V1beta1CertificateSigningRequest response = api.replaceCertificateSigningRequestStatus(name, body, pretty, dryRun, fieldManager);
