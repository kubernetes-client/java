...
public class V1alpha1MutatingAdmissionPolicyFluent<A extends V1alpha1MutatingAdmissionPolicyFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new V1alpha1MutatingAdmissionPolicySpecBuilder().build()));
  }
