...
public class V1LoadBalancerIngressFluentImpl<A extends io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluent<A> {
    ...
    public A addToPorts(int index,io.kubernetes.client.openapi.models.V1PortStatus item) {
        ...
        io.kubernetes.client.openapi.models.V1PortStatusBuilder builder = new io.kubernetes.client.openapi.models.V1PortStatusBuilder(item);_visitables.get("ports").add(index >= 0 ? index : _visitables.get("ports").size(), builder);this.ports.add(index >= 0 ? index : ports.size(), builder); return (A)this;
    }

    public A setToPorts(int index,io.kubernetes.client.openapi.models.V1PortStatus item) {
        if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PortStatusBuilder>();}
        io.kubernetes.client.openapi.models.V1PortStatusBuilder builder = new io.kubernetes.client.openapi.models.V1PortStatusBuilder(item);
    ...
    public A addToPorts(io.kubernetes.client.openapi.models.V1PortStatus... items) {
        if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PortStatusBuilder>();}
        for (io.kubernetes.client.openapi.models.V1PortStatus item : items) {io.kubernetes.client.openapi.models.V1PortStatusBuilder builder = new io.kubernetes.client.openapi.models.V1PortStatusBuilder(item);_visitables.get("ports").add(builder);this.ports.add(builder);} return (A)this;
    }
    ...
    public A removeFromPorts(io.kubernetes.client.openapi.models.V1PortStatus... items) {
        for (io.kubernetes.client.openapi.models.V1PortStatus item : items) {io.kubernetes.client.openapi.models.V1PortStatusBuilder builder = new io.kubernetes.client.openapi.models.V1PortStatusBuilder(item);_visitables.get("ports").remove(builder);if (this.ports != null) {this.ports.remove(builder);}} return (A)this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PortStatus buildMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PortStatusBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1PortStatusBuilder item: ports) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PortStatusBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1PortStatusBuilder item: ports) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withPorts(java.util.List<io.kubernetes.client.openapi.models.V1PortStatus> ports) {
        ...
        if (ports != null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PortStatusBuilder>(); for (io.kubernetes.client.openapi.models.V1PortStatus item : ports){this.addToPorts(item);}} else { this.ports = null;} return (A) this;
    }

    public A withPorts(io.kubernetes.client.openapi.models.V1PortStatus... ports) {
        if (this.ports != null) {this.ports.clear();}
        if (ports != null) {for (io.kubernetes.client.openapi.models.V1PortStatus item :ports){ this.addToPorts(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluent.PortsNested<A> addNewPortLike(io.kubernetes.client.openapi.models.V1PortStatus item) {
        return new io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluentImpl.PortsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluent.PortsNested<A> setNewPortLike(int index,io.kubernetes.client.openapi.models.V1PortStatus item) {
        return new io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluentImpl.PortsNestedImpl(index, item);
    }
    ...
    public class PortsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PortStatusFluentImpl<io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            PortsNestedImpl(int index,io.kubernetes.client.openapi.models.V1PortStatus item) {
                this.index = index;
