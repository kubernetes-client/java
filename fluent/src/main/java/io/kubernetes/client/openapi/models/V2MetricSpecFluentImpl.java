...
import java.lang.Object;
  ...
  * Generated
  */
public class V2MetricSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V2MetricSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent<A>{
  ...
  private io.kubernetes.client.openapi.models.V2ContainerResourceMetricSourceBuilder containerResource;
  ...
  public io.kubernetes.client.openapi.models.V2ContainerResourceMetricSource buildContainerResource() {
    return this.containerResource!=null ?this.containerResource.build():null;
  }
  public A withContainerResource(io.kubernetes.client.openapi.models.V2ContainerResourceMetricSource containerResource) {
    _visitables.get("containerResource").remove(this.containerResource);
    if (containerResource!=null){ this.containerResource= new io.kubernetes.client.openapi.models.V2ContainerResourceMetricSourceBuilder(containerResource); _visitables.get("containerResource").add(this.containerResource);} return (A) this;
  }
  public java.lang.Boolean hasContainerResource() {
    return this.containerResource != null;
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<A> withNewContainerResource() {
    return new io.kubernetes.client.openapi.models.V2MetricSpecFluentImpl.ContainerResourceNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<A> withNewContainerResourceLike(io.kubernetes.client.openapi.models.V2ContainerResourceMetricSource item) {
    return new io.kubernetes.client.openapi.models.V2MetricSpecFluentImpl.ContainerResourceNestedImpl(item);
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<A> editContainerResource() {
    return withNewContainerResourceLike(getContainerResource());
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<A> editOrNewContainerResource() {
    return withNewContainerResourceLike(getContainerResource() != null ? getContainerResource(): new io.kubernetes.client.openapi.models.V2ContainerResourceMetricSourceBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<A> editOrNewContainerResourceLike(io.kubernetes.client.openapi.models.V2ContainerResourceMetricSource item) {
  ...
  public A withExternal(io.kubernetes.client.openapi.models.V2ExternalMetricSource external) {
    ...
    if (external!=null){ this.external= new io.kubernetes.client.openapi.models.V2ExternalMetricSourceBuilder(external); _visitables.get("external").add(this.external);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ExternalNested<A> withNewExternalLike(io.kubernetes.client.openapi.models.V2ExternalMetricSource item) {
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ExternalNested<A> editOrNewExternal() {
    return withNewExternalLike(getExternal() != null ? getExternal(): new io.kubernetes.client.openapi.models.V2ExternalMetricSourceBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ExternalNested<A> editOrNewExternalLike(io.kubernetes.client.openapi.models.V2ExternalMetricSource item) {
  ...
  public A withObject(io.kubernetes.client.openapi.models.V2ObjectMetricSource _object) {
    ...
    if (_object!=null){ this._object= new io.kubernetes.client.openapi.models.V2ObjectMetricSourceBuilder(_object); _visitables.get("_object").add(this._object);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ObjectNested<A> withNewObjectLike(io.kubernetes.client.openapi.models.V2ObjectMetricSource item) {
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ObjectNested<A> editOrNewObject() {
    return withNewObjectLike(getObject() != null ? getObject(): new io.kubernetes.client.openapi.models.V2ObjectMetricSourceBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ObjectNested<A> editOrNewObjectLike(io.kubernetes.client.openapi.models.V2ObjectMetricSource item) {
  ...
  public A withPods(io.kubernetes.client.openapi.models.V2PodsMetricSource pods) {
    ...
    if (pods!=null){ this.pods= new io.kubernetes.client.openapi.models.V2PodsMetricSourceBuilder(pods); _visitables.get("pods").add(this.pods);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.PodsNested<A> withNewPodsLike(io.kubernetes.client.openapi.models.V2PodsMetricSource item) {
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.PodsNested<A> editOrNewPods() {
    return withNewPodsLike(getPods() != null ? getPods(): new io.kubernetes.client.openapi.models.V2PodsMetricSourceBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.PodsNested<A> editOrNewPodsLike(io.kubernetes.client.openapi.models.V2PodsMetricSource item) {
  ...
  public A withResource(io.kubernetes.client.openapi.models.V2ResourceMetricSource resource) {
    ...
    if (resource!=null){ this.resource= new io.kubernetes.client.openapi.models.V2ResourceMetricSourceBuilder(resource); _visitables.get("resource").add(this.resource);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ResourceNested<A> withNewResourceLike(io.kubernetes.client.openapi.models.V2ResourceMetricSource item) {
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ResourceNested<A> editOrNewResource() {
    return withNewResourceLike(getResource() != null ? getResource(): new io.kubernetes.client.openapi.models.V2ResourceMetricSourceBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2MetricSpecFluent.ResourceNested<A> editOrNewResourceLike(io.kubernetes.client.openapi.models.V2ResourceMetricSource item) {
  ...
  public class ContainerResourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V2ContainerResourceMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ContainerResourceNestedImpl(io.kubernetes.client.openapi.models.V2ContainerResourceMetricSource item) {
      this.builder = new io.kubernetes.client.openapi.models.V2ContainerResourceMetricSourceBuilder(this, item);
    }
    ContainerResourceNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V2ContainerResourceMetricSourceBuilder(this);
    }
  ...
  public class ExternalNestedImpl<N> extends io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2MetricSpecFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ExternalNestedImpl(io.kubernetes.client.openapi.models.V2ExternalMetricSource item) {
      this.builder = new io.kubernetes.client.openapi.models.V2ExternalMetricSourceBuilder(this, item);
    }
    ExternalNestedImpl() {
  ...
  public class ObjectNestedImpl<N> extends io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2MetricSpecFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ObjectNestedImpl(io.kubernetes.client.openapi.models.V2ObjectMetricSource item) {
      this.builder = new io.kubernetes.client.openapi.models.V2ObjectMetricSourceBuilder(this, item);
    }
    ObjectNestedImpl() {
  ...
  public class PodsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2PodsMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2MetricSpecFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class ResourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2MetricSpecFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ResourceNestedImpl(io.kubernetes.client.openapi.models.V2ResourceMetricSource item) {
      this.builder = new io.kubernetes.client.openapi.models.V2ResourceMetricSourceBuilder(this, item);
    }
    ResourceNestedImpl() {
