...
/** Generated */
public interface V1alpha1RuntimeClassListFluent<A extends V1alpha1RuntimeClassListFluent<A>>
    extends Fluent<A> {
  ...
  public A addToItems(Integer index, io.kubernetes.client.openapi.models.V1alpha1RuntimeClass item);
  ...
  public A removeMatchingFromItems(Predicate<V1alpha1RuntimeClassBuilder> predicate);
  ...
  public interface ItemsNested<N>
      extends Nested<N>, V1alpha1RuntimeClassFluent<V1alpha1RuntimeClassListFluent.ItemsNested<N>> {
    public N and();
  ...
  public interface MetadataNested<N>
      extends io.kubernetes.client.fluent.Nested<N>,
          V1ListMetaFluent<V1alpha1RuntimeClassListFluent.MetadataNested<N>> {
    public N and();
