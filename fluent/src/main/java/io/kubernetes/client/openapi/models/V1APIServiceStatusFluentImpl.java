...
public class V1APIServiceStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1APIServiceStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1APIServiceStatusFluent<A>{
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1APIServiceConditionBuilder> conditions;
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1APIServiceCondition item) {
  ...
  public A setToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1APIServiceCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1APIServiceConditionBuilder>();}
  ...
  public io.kubernetes.client.openapi.models.V1APIServiceCondition buildCondition(java.lang.Integer index) {
  ...
  public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1APIServiceCondition> conditions) {
    ...
    if (conditions != null) {this.conditions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1APIServiceCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1APIServiceStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1APIServiceCondition item) {
    return new io.kubernetes.client.openapi.models.V1APIServiceStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1APIServiceStatusFluent.ConditionsNested<A> editCondition(java.lang.Integer index) {
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1APIServiceConditionFluentImpl<io.kubernetes.client.openapi.models.V1APIServiceStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1APIServiceStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ConditionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1APIServiceCondition item) {
      this.index = index;
