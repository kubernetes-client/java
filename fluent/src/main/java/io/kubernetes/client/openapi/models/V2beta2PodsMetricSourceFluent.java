...
/** Generated */
public interface V2beta2PodsMetricSourceFluent<A extends V2beta2PodsMetricSourceFluent<A>>
    extends Fluent<A> {
  ...
  public interface MetricNested<N>
      extends Nested<N>,
          V2beta2MetricIdentifierFluent<V2beta2PodsMetricSourceFluent.MetricNested<N>> {
    public N and();
  ...
  public interface TargetNested<N>
      extends Nested<N>, V2beta2MetricTargetFluent<V2beta2PodsMetricSourceFluent.TargetNested<N>> {
    public N and();
