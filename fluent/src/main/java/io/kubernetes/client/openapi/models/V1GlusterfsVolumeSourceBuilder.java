...
public class V1GlusterfsVolumeSourceBuilder
    ...
    implements VisitableBuilder<V1GlusterfsVolumeSource, V1GlusterfsVolumeSourceBuilder> {
  ...
  public V1GlusterfsVolumeSourceBuilder(
      V1GlusterfsVolumeSourceFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V1GlusterfsVolumeSource(), validationEnabled);
  }

  public V1GlusterfsVolumeSourceBuilder(
      V1GlusterfsVolumeSourceFluent<?> fluent, V1GlusterfsVolumeSource instance) {
  ...
  public V1GlusterfsVolumeSourceBuilder(
      V1GlusterfsVolumeSource instance, Boolean validationEnabled) {
    this.fluent = this;
