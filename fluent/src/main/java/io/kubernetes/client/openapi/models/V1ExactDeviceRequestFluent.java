...
public class V1ExactDeviceRequestFluent<A extends io.kubernetes.client.openapi.models.V1ExactDeviceRequestFluent<A>> extends BaseFluent<A>{
  ...
  public V1ExactDeviceRequestFluent() {
  }
  
  public V1ExactDeviceRequestFluent(V1ExactDeviceRequest instance) {
  ...
  protected void copyInstance(V1ExactDeviceRequest instance) {
    instance = instance != null ? instance : new V1ExactDeviceRequest();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1ExactDeviceRequestFluent that = (V1ExactDeviceRequestFluent) o;
  ...
  public class CapacityNested<N> extends V1CapacityRequirementsFluent<CapacityNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ExactDeviceRequestFluent.this.withCapacity(builder.build());
    }
  ...
  public class SelectorsNested<N> extends V1DeviceSelectorFluent<SelectorsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ExactDeviceRequestFluent.this.setToSelectors(index, builder.build());
    }
  ...
  public class TolerationsNested<N> extends V1DeviceTolerationFluent<TolerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ExactDeviceRequestFluent.this.setToTolerations(index, builder.build());
    }
