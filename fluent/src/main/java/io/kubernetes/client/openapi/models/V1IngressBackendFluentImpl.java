...
public class V1IngressBackendFluentImpl<A extends io.kubernetes.client.openapi.models.V1IngressBackendFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1IngressBackendFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1IngressBackendFluent.ResourceNested<A> withNewResourceLike(io.kubernetes.client.openapi.models.V1TypedLocalObjectReference item) {
        return new io.kubernetes.client.openapi.models.V1IngressBackendFluentImpl.ResourceNestedImpl(item);
    }
    ...
    public A withService(io.kubernetes.client.openapi.models.V1IngressServiceBackend service) {
        ...
        if (service!=null){ this.service= new io.kubernetes.client.openapi.models.V1IngressServiceBackendBuilder(service); _visitables.get("service").add(this.service);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1IngressBackendFluent.ServiceNested<A> withNewServiceLike(io.kubernetes.client.openapi.models.V1IngressServiceBackend item) {
        return new io.kubernetes.client.openapi.models.V1IngressBackendFluentImpl.ServiceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1IngressBackendFluent.ServiceNested<A> editOrNewService() {
        return withNewServiceLike(getService() != null ? getService(): new io.kubernetes.client.openapi.models.V1IngressServiceBackendBuilder().build());
    }
    ...
    public class ResourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TypedLocalObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1IngressBackendFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V1IngressBackendFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class ServiceNestedImpl<N> extends io.kubernetes.client.openapi.models.V1IngressServiceBackendFluentImpl<io.kubernetes.client.openapi.models.V1IngressBackendFluent.ServiceNested<N>> implements io.kubernetes.client.openapi.models.V1IngressBackendFluent.ServiceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1IngressServiceBackendBuilder builder;

            ServiceNestedImpl(io.kubernetes.client.openapi.models.V1IngressServiceBackend item) {
                this.builder = new io.kubernetes.client.openapi.models.V1IngressServiceBackendBuilder(this, item);
