...
public class V1alpha1IPAddressListFluent<A extends V1alpha1IPAddressListFluent<A>> extends BaseFluent<A>{
  public V1alpha1IPAddressListFluent() {
  }
  
  public V1alpha1IPAddressListFluent(V1alpha1IPAddressList instance) {
  ...
  protected void copyInstance(V1alpha1IPAddressList instance) {
    instance = (instance != null ? instance : new V1alpha1IPAddressList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha1IPAddress... items) {
    ...
    for (V1alpha1IPAddress item : items) {V1alpha1IPAddressBuilder builder = new V1alpha1IPAddressBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1alpha1IPAddress buildMatchingItem(Predicate<V1alpha1IPAddressBuilder> predicate) {
      for (V1alpha1IPAddressBuilder item : items) {
  ...
  public A withItems(List<V1alpha1IPAddress> items) {
    ...
    if (items != null) {
        ...
        for (V1alpha1IPAddress item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1alpha1IPAddress item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1alpha1IPAddress item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1alpha1IPAddressBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1IPAddressListFluent that = (V1alpha1IPAddressListFluent) o;
  ...
  public class ItemsNested<N> extends V1alpha1IPAddressFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1alpha1IPAddress item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1alpha1IPAddressListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1IPAddressListFluent.this.withMetadata(builder.build());
    }
