...
import java.lang.Object;
  ...
  */
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1PodFluent.MetadataNested<N>> implements V1PodFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1PodSpecFluentImpl<V1PodFluent.SpecNested<N>> implements V1PodFluent.SpecNested<N>,Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1PodStatusFluentImpl<V1PodFluent.StatusNested<N>> implements V1PodFluent.StatusNested<N>,Nested<N>{
