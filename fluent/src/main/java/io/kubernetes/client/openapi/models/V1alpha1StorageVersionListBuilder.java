...
public class V1alpha1StorageVersionListBuilder extends io.kubernetes.client.openapi.models.V1alpha1StorageVersionListFluentImpl<io.kubernetes.client.openapi.models.V1alpha1StorageVersionListBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1alpha1StorageVersionList,io.kubernetes.client.openapi.models.V1alpha1StorageVersionListBuilder> {
    ...
    public V1alpha1StorageVersionListBuilder(io.kubernetes.client.openapi.models.V1alpha1StorageVersionListFluent<?> fluent) {
        this(fluent, true);
    }
