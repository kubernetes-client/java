...
public interface V1SecurityContextFluent<A extends V1SecurityContextFluent<A>> extends Fluent<A> {
  ...
  public interface SeLinuxOptionsNested<N>
      extends Nested<N>, V1SELinuxOptionsFluent<V1SecurityContextFluent.SeLinuxOptionsNested<N>> {
    public N and();
  ...
  public interface SeccompProfileNested<N>
      extends Nested<N>, V1SeccompProfileFluent<V1SecurityContextFluent.SeccompProfileNested<N>> {
    public N and();
