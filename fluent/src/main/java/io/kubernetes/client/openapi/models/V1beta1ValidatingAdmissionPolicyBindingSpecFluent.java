...
public class V1beta1ValidatingAdmissionPolicyBindingSpecFluent<A extends V1beta1ValidatingAdmissionPolicyBindingSpecFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta1ValidatingAdmissionPolicyBindingSpecFluent(V1beta1ValidatingAdmissionPolicyBindingSpec instance) {
  ...
  protected void copyInstance(V1beta1ValidatingAdmissionPolicyBindingSpec instance) {
    instance = (instance != null ? instance : new V1beta1ValidatingAdmissionPolicyBindingSpec());
    if (instance != null) {
  ...
  public MatchResourcesNested<A> editOrNewMatchResources() {
    return withNewMatchResourcesLike(java.util.Optional.ofNullable(buildMatchResources()).orElse(new V1beta1MatchResourcesBuilder().build()));
  }
  ...
  public ParamRefNested<A> editOrNewParamRef() {
    return withNewParamRefLike(java.util.Optional.ofNullable(buildParamRef()).orElse(new V1beta1ParamRefBuilder().build()));
  }
  ...
  public boolean equals(Object o) {
    ...
    V1beta1ValidatingAdmissionPolicyBindingSpecFluent that = (V1beta1ValidatingAdmissionPolicyBindingSpecFluent) o;
  ...
  public class MatchResourcesNested<N> extends V1beta1MatchResourcesFluent<MatchResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta1ValidatingAdmissionPolicyBindingSpecFluent.this.withMatchResources(builder.build());
    }
  ...
  public class ParamRefNested<N> extends V1beta1ParamRefFluent<ParamRefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta1ValidatingAdmissionPolicyBindingSpecFluent.this.withParamRef(builder.build());
    }
