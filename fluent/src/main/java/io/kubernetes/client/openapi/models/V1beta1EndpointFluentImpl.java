...
public class V1beta1EndpointFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1EndpointFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1EndpointFluent<A>{
  ...
  public A withHints(io.kubernetes.client.openapi.models.V1beta1EndpointHints hints) {
    ...
    if (hints!=null){ this.hints= new io.kubernetes.client.openapi.models.V1beta1EndpointHintsBuilder(hints); _visitables.get("hints").add(this.hints);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1EndpointFluent.HintsNested<A> editOrNewHints() {
    return withNewHintsLike(getHints() != null ? getHints(): new io.kubernetes.client.openapi.models.V1beta1EndpointHintsBuilder().build());
  }
  ...
  public int hashCode() {
    return java.util.Objects.hash(addresses,  conditions,  hints,  hostname,  nodeName,  targetRef,  topology,  super.hashCode());
  }
  ...
  public class HintsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluentImpl<io.kubernetes.client.openapi.models.V1beta1EndpointFluent.HintsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EndpointFluent.HintsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    HintsNestedImpl(io.kubernetes.client.openapi.models.V1beta1EndpointHints item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1EndpointHintsBuilder(this, item);
    }
    HintsNestedImpl() {
