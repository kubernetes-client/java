...
public class V1beta1PodDisruptionBudgetSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpecFluent<A> {
    ...
    public V1beta1PodDisruptionBudgetSpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpec instance) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpecFluent.SelectorNested<A> withNewSelector() {
        return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpecFluentImpl.SelectorNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpecFluent.SelectorNested<A> withNewSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
        return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpecFluentImpl.SelectorNestedImpl(item);
    }
