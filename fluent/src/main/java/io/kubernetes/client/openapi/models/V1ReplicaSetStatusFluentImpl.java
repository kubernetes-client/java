...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1ReplicaSetStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent<A>{
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder> conditions;
  ...
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicaSetCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder(item);_visitables.get("conditions").add(index >= 0 ? index : _visitables.get("conditions").size(), builder);this.conditions.add(index >= 0 ? index : conditions.size(), builder); return (A)this;
  }
  public A setToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicaSetCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder(item);
  ...
  public A addToConditions(io.kubernetes.client.openapi.models.V1ReplicaSetCondition... items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1ReplicaSetCondition item : items) {io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeFromConditions(io.kubernetes.client.openapi.models.V1ReplicaSetCondition... items) {
    for (io.kubernetes.client.openapi.models.V1ReplicaSetCondition item : items) {io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder(item);_visitables.get("conditions").remove(builder);if (this.conditions != null) {this.conditions.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder> each = conditions.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1ReplicaSetCondition buildCondition(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1ReplicaSetCondition buildMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder item: conditions) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder item: conditions) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1ReplicaSetCondition> conditions) {
    ...
    if (conditions != null) {this.conditions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1ReplicaSetCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
  }
  public A withConditions(io.kubernetes.client.openapi.models.V1ReplicaSetCondition... conditions) {
    if (this.conditions != null) {this.conditions.clear();}
    if (conditions != null) {for (io.kubernetes.client.openapi.models.V1ReplicaSetCondition item :conditions){ this.addToConditions(item);}} return (A) this;
  }
  public java.lang.Boolean hasConditions() {
    return conditions != null && !conditions.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent.ConditionsNested<A> addNewCondition() {
    return new io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluentImpl.ConditionsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1ReplicaSetCondition item) {
    return new io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluentImpl.ConditionsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicaSetCondition item) {
    return new io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent.ConditionsNested<A> editCondition(java.lang.Integer index) {
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ReplicaSetConditionFluentImpl<io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ConditionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicaSetCondition item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder(this, item);
    }
