...
public class V1FlexVolumeSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluent<A> {
    ...
    public A addToOptions(java.lang.String key,java.lang.String value) {
        if(this.options == null && key != null && value != null) { this.options = new java.util.LinkedHashMap<java.lang.String,java.lang.String>(); }
    ...
    public A addToOptions(java.util.Map<java.lang.String,java.lang.String> map) {
        if(this.options == null && map != null) { this.options = new java.util.LinkedHashMap<java.lang.String,java.lang.String>(); }
    ...
    public <K,V>A withOptions(java.util.Map<java.lang.String,java.lang.String> options) {
        if (options == null) { this.options =  null;} else {this.options = new java.util.LinkedHashMap<java.lang.String,java.lang.String>(options);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluent.SecretRefNested<A> withNewSecretRefLike(io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
        return new io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluentImpl.SecretRefNestedImpl(item);
    }
    ...
    public class SecretRefNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LocalObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluent.SecretRefNested<N>> implements io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluent.SecretRefNested<N>,io.kubernetes.client.fluent.Nested<N> {
