...
import java.lang.Object;
  ...
  */
  ...
  public V1APIServiceListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1APIServiceListFluentImpl.ItemsNestedImpl();
  }
  public V1APIServiceListFluentImpl.ItemsNested<A> addNewItemLike(V1APIService item) {
    return new V1APIServiceListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1APIServiceListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1APIService item) {
    return new V1APIServiceListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1APIServiceListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1APIServiceListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1APIServiceListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1APIServiceListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1APIServiceBuilder> predicate) {
    int index = -1;
  ...
  public V1APIServiceListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1APIServiceListFluentImpl.MetadataNestedImpl();
  }
  public V1APIServiceListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1APIServiceListFluentImpl.MetadataNestedImpl(item);
  }
  public V1APIServiceListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1APIServiceListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1APIServiceListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1APIServiceFluentImpl<V1APIServiceListFluentImpl.ItemsNested<N>> implements V1APIServiceListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1APIService item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1APIServiceListFluentImpl.MetadataNested<N>> implements V1APIServiceListFluentImpl.MetadataNested<N>,Nested<N>{
