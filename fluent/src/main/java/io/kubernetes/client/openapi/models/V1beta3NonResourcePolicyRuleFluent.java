...
public class V1beta3NonResourcePolicyRuleFluent<A extends V1beta3NonResourcePolicyRuleFluent<A>> extends BaseFluent<A>{
  public V1beta3NonResourcePolicyRuleFluent() {
  }
  
  public V1beta3NonResourcePolicyRuleFluent(V1beta3NonResourcePolicyRule instance) {
    this.copyInstance(instance);
  }
  private List<String> nonResourceURLs;
  private List<String> verbs;
  
  protected void copyInstance(V1beta3NonResourcePolicyRule instance) {
    instance = (instance != null ? instance : new V1beta3NonResourcePolicyRule());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta3NonResourcePolicyRuleFluent that = (V1beta3NonResourcePolicyRuleFluent) o;
