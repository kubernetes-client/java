...
public class V1HTTPIngressRuleValueFluentImpl<A extends io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent<A> {
    ...
    public A addToPaths(int index,io.kubernetes.client.openapi.models.V1HTTPIngressPath item) {
    ...
    public A setToPaths(int index,io.kubernetes.client.openapi.models.V1HTTPIngressPath item) {
        if (this.paths == null) {this.paths = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder>();}
        io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder builder = new io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder(item);
    ...
    public A addToPaths(io.kubernetes.client.openapi.models.V1HTTPIngressPath... items) {
        if (this.paths == null) {this.paths = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder>();}
        for (io.kubernetes.client.openapi.models.V1HTTPIngressPath item : items) {io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder builder = new io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder(item);_visitables.get("paths").add(builder);this.paths.add(builder);} return (A)this;
    }
    ...
    public A removeFromPaths(io.kubernetes.client.openapi.models.V1HTTPIngressPath... items) {
        for (io.kubernetes.client.openapi.models.V1HTTPIngressPath item : items) {io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder builder = new io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder(item);_visitables.get("paths").remove(builder);if (this.paths != null) {this.paths.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromPaths(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder> each = paths.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1HTTPIngressPath buildPath(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1HTTPIngressPath buildMatchingPath(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder item: paths) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingPath(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder item: paths) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withPaths(java.util.List<io.kubernetes.client.openapi.models.V1HTTPIngressPath> paths) {
        ...
        if (paths != null) {this.paths = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder>(); for (io.kubernetes.client.openapi.models.V1HTTPIngressPath item : paths){this.addToPaths(item);}} else { this.paths = null;} return (A) this;
    }

    public A withPaths(io.kubernetes.client.openapi.models.V1HTTPIngressPath... paths) {
        if (this.paths != null) {this.paths.clear();}
        if (paths != null) {for (io.kubernetes.client.openapi.models.V1HTTPIngressPath item :paths){ this.addToPaths(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent.PathsNested<A> addNewPathLike(io.kubernetes.client.openapi.models.V1HTTPIngressPath item) {
        return new io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluentImpl.PathsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent.PathsNested<A> setNewPathLike(int index,io.kubernetes.client.openapi.models.V1HTTPIngressPath item) {
        return new io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluentImpl.PathsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent.PathsNested<A> editPath(int index) {
    ...
    public class PathsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HTTPIngressPathFluentImpl<io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent.PathsNested<N>> implements io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent.PathsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder builder;
        private final int index;

            PathsNestedImpl(int index,io.kubernetes.client.openapi.models.V1HTTPIngressPath item) {
                this.index = index;
