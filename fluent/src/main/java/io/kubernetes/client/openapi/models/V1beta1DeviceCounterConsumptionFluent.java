...
public class V1beta1DeviceCounterConsumptionFluent<A extends io.kubernetes.client.openapi.models.V1beta1DeviceCounterConsumptionFluent<A>> extends BaseFluent<A>{

  private String counterSet;
  private Map<String,V1beta1Counter> counters;

  public V1beta1DeviceCounterConsumptionFluent() {
  }
  
  public V1beta1DeviceCounterConsumptionFluent(V1beta1DeviceCounterConsumption instance) {
  ...
  protected void copyInstance(V1beta1DeviceCounterConsumption instance) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1DeviceCounterConsumptionFluent that = (V1beta1DeviceCounterConsumptionFluent) o;
