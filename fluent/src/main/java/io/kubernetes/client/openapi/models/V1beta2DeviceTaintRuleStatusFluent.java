...
public class V1beta2DeviceTaintRuleStatusFluent<A extends io.kubernetes.client.openapi.models.V1beta2DeviceTaintRuleStatusFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta2DeviceTaintRuleStatusFluent(V1beta2DeviceTaintRuleStatus instance) {
  ...
  protected void copyInstance(V1beta2DeviceTaintRuleStatus instance) {
    instance = instance != null ? instance : new V1beta2DeviceTaintRuleStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2DeviceTaintRuleStatusFluent that = (V1beta2DeviceTaintRuleStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2DeviceTaintRuleStatusFluent.this.setToConditions(index, builder.build());
    }
