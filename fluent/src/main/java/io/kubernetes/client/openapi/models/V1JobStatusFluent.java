...
public interface V1JobStatusFluent<A extends io.kubernetes.client.openapi.models.V1JobStatusFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface UncountedTerminatedPodsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1UncountedTerminatedPodsFluent<io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<N>>{
    public N and();
