...
public class V1beta1MutatingWebhookConfigurationListFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent<A> {

    private java.lang.String apiVersion;
    private java.util.List<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder> items;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ListMetaBuilder metadata;

    public V1beta1MutatingWebhookConfigurationListFluentImpl() {
    }

    public V1beta1MutatingWebhookConfigurationListFluentImpl(io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationList instance) {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder builder = new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
    }

    public A setToItems(int index,io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder builder = new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder(item);
    ...
    public A addToItems(io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration... items) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder>();}
        for (io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item : items) {io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder builder = new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
    }
    ...
    public A removeFromItems(io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration... items) {
        for (io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item : items) {io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder builder = new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder> each = items.iterator();
        final List visitables = _visitables.get("items");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder>(); for (io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }

    public A withItems(io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration... items) {
        if (this.items != null) {this.items.clear();}
        if (items != null) {for (io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item :items){ this.addToItems(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item) {
        return new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluentImpl.ItemsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item) {
        return new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluentImpl.ItemsNestedImpl(index, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1MutatingWebhookConfigurationListFluentImpl that = (V1beta1MutatingWebhookConfigurationListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationFluentImpl<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfiguration item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder(this, item);
                        
            }

            ItemsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationBuilder(this);
                        
            }

            public N and() {
                return (N) V1beta1MutatingWebhookConfigurationListFluentImpl.this.setToItems(index,builder.build());
            }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1MutatingWebhookConfigurationListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ListMetaBuilder builder;
            ...
            public N and() {
                return (N) V1beta1MutatingWebhookConfigurationListFluentImpl.this.withMetadata(builder.build());
            }
