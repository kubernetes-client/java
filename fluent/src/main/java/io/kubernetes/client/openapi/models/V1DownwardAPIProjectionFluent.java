...
public interface V1DownwardAPIProjectionFluent<A extends V1DownwardAPIProjectionFluent<A>> extends Fluent<A>{
  ...
  public V1DownwardAPIProjectionFluent.ItemsNested<A> setNewItemLike(int index,V1DownwardAPIVolumeFile item);
  public V1DownwardAPIProjectionFluent.ItemsNested<A> editItem(int index);
