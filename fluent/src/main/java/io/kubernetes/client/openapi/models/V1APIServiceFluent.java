...
public interface V1APIServiceFluent<A extends io.kubernetes.client.openapi.models.V1APIServiceFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1APIServiceFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1APIServiceSpecFluent<io.kubernetes.client.openapi.models.V1APIServiceFluent.SpecNested<N>> {

            public N and();
            public N endSpec();    }


    public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1APIServiceStatusFluent<io.kubernetes.client.openapi.models.V1APIServiceFluent.StatusNested<N>> {
