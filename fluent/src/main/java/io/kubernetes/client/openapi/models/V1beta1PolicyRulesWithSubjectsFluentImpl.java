...
public class V1beta1PolicyRulesWithSubjectsFluentImpl<
    ...
    extends BaseFluent<A> implements V1beta1PolicyRulesWithSubjectsFluent<A> {
  ...
  public A addToNonResourceRules(Integer index, V1beta1NonResourcePolicyRule item) {
    if (this.nonResourceRules == null) {
      this.nonResourceRules = new ArrayList<V1beta1NonResourcePolicyRuleBuilder>();
    }
  ...
  public A addToNonResourceRules(
    ...
    for (V1beta1NonResourcePolicyRule item : items) {
      V1beta1NonResourcePolicyRuleBuilder builder = new V1beta1NonResourcePolicyRuleBuilder(item);
      _visitables.get("nonResourceRules").add(builder);
  ...
  public V1beta1NonResourcePolicyRule buildMatchingNonResourceRule(
      Predicate<V1beta1NonResourcePolicyRuleBuilder> predicate) {
    for (V1beta1NonResourcePolicyRuleBuilder item : nonResourceRules) {
  ...
  public A withNonResourceRules(List<V1beta1NonResourcePolicyRule> nonResourceRules) {
    ...
    if (nonResourceRules != null) {
      ...
      for (V1beta1NonResourcePolicyRule item : nonResourceRules) {
  ...
  public V1beta1PolicyRulesWithSubjectsFluent.NonResourceRulesNested<A> addNewNonResourceRuleLike(
      V1beta1NonResourcePolicyRule item) {
    return new V1beta1PolicyRulesWithSubjectsFluentImpl.NonResourceRulesNestedImpl(-1, item);
  }

  public V1beta1PolicyRulesWithSubjectsFluent.NonResourceRulesNested<A> setNewNonResourceRuleLike(
      Integer index, V1beta1NonResourcePolicyRule item) {
    return new V1beta1PolicyRulesWithSubjectsFluentImpl.NonResourceRulesNestedImpl(index, item);
  }

  public V1beta1PolicyRulesWithSubjectsFluent.NonResourceRulesNested<A> editNonResourceRule(
      Integer index) {
  ...
  public V1beta1PolicyRulesWithSubjectsFluent.NonResourceRulesNested<A> editMatchingNonResourceRule(
      Predicate<V1beta1NonResourcePolicyRuleBuilder> predicate) {
    int index = -1;
  ...
  public A addToResourceRules(Integer index, V1beta1ResourcePolicyRule item) {
    if (this.resourceRules == null) {
      this.resourceRules = new ArrayList<V1beta1ResourcePolicyRuleBuilder>();
    }
  ...
  public A addToResourceRules(
    ...
    for (V1beta1ResourcePolicyRule item : items) {
      V1beta1ResourcePolicyRuleBuilder builder = new V1beta1ResourcePolicyRuleBuilder(item);
      _visitables.get("resourceRules").add(builder);
  ...
  public V1beta1ResourcePolicyRule buildMatchingResourceRule(
      Predicate<V1beta1ResourcePolicyRuleBuilder> predicate) {
    for (V1beta1ResourcePolicyRuleBuilder item : resourceRules) {
      if (predicate.test(item)) {
        return item.build();
      }
    }
  ...
  public A withResourceRules(List<V1beta1ResourcePolicyRule> resourceRules) {
    ...
    if (resourceRules != null) {
      ...
      for (V1beta1ResourcePolicyRule item : resourceRules) {
  ...
  public V1beta1PolicyRulesWithSubjectsFluent.ResourceRulesNested<A> addNewResourceRuleLike(
      V1beta1ResourcePolicyRule item) {
    return new V1beta1PolicyRulesWithSubjectsFluentImpl.ResourceRulesNestedImpl(-1, item);
  }

  public V1beta1PolicyRulesWithSubjectsFluent.ResourceRulesNested<A> setNewResourceRuleLike(
      Integer index, V1beta1ResourcePolicyRule item) {
    return new V1beta1PolicyRulesWithSubjectsFluentImpl.ResourceRulesNestedImpl(index, item);
  }

  public V1beta1PolicyRulesWithSubjectsFluent.ResourceRulesNested<A> editResourceRule(
      Integer index) {
  ...
  public V1beta1PolicyRulesWithSubjectsFluent.ResourceRulesNested<A> editMatchingResourceRule(
      Predicate<V1beta1ResourcePolicyRuleBuilder> predicate) {
    int index = -1;
  ...
  public A addToSubjects(Integer index, V1beta1Subject item) {
    if (this.subjects == null) {
      this.subjects = new ArrayList<V1beta1SubjectBuilder>();
    }
  ...
  public V1beta1Subject buildMatchingSubject(Predicate<V1beta1SubjectBuilder> predicate) {
    for (V1beta1SubjectBuilder item : subjects) {
      if (predicate.test(item)) {
        return item.build();
      }
    }
  ...
  public A withSubjects(List<V1beta1Subject> subjects) {
    ...
    if (subjects != null) {
      ...
      for (V1beta1Subject item : subjects) {
  ...
  public V1beta1PolicyRulesWithSubjectsFluent.SubjectsNested<A> addNewSubjectLike(
      V1beta1Subject item) {
    return new V1beta1PolicyRulesWithSubjectsFluentImpl.SubjectsNestedImpl(-1, item);
  }

  public V1beta1PolicyRulesWithSubjectsFluent.SubjectsNested<A> setNewSubjectLike(
      Integer index, V1beta1Subject item) {
  ...
  public V1beta1PolicyRulesWithSubjectsFluent.SubjectsNested<A> editMatchingSubject(
      Predicate<V1beta1SubjectBuilder> predicate) {
    int index = -1;
  ...
  class NonResourceRulesNestedImpl<N>
      ...
      implements V1beta1PolicyRulesWithSubjectsFluent.NonResourceRulesNested<N>, Nested<N> {
  ...
  class ResourceRulesNestedImpl<N>
      ...
      implements V1beta1PolicyRulesWithSubjectsFluent.ResourceRulesNested<N>, Nested<N> {
  ...
  class SubjectsNestedImpl<N>
      extends V1beta1SubjectFluentImpl<V1beta1PolicyRulesWithSubjectsFluent.SubjectsNested<N>>
      implements V1beta1PolicyRulesWithSubjectsFluent.SubjectsNested<N>, Nested<N> {
