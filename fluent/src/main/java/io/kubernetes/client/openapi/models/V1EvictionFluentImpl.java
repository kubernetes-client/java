...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1EvictionFluentImpl<A extends io.kubernetes.client.openapi.models.V1EvictionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1EvictionFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V1EvictionFluent.DeleteOptionsNested<A> withNewDeleteOptionsLike(io.kubernetes.client.openapi.models.V1DeleteOptions item) {
    return new io.kubernetes.client.openapi.models.V1EvictionFluentImpl.DeleteOptionsNestedImpl(item);
  }
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1EvictionFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1EvictionFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
