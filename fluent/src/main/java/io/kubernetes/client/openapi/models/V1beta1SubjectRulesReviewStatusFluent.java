...
public interface V1beta1SubjectRulesReviewStatusFluent<A extends io.kubernetes.client.openapi.models.V1beta1SubjectRulesReviewStatusFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface NonResourceRulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta1NonResourceRuleFluent<io.kubernetes.client.openapi.models.V1beta1SubjectRulesReviewStatusFluent.NonResourceRulesNested<N>> {

            public N and();
            public N endNonResourceRule();    }


    public interface ResourceRulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta1ResourceRuleFluent<io.kubernetes.client.openapi.models.V1beta1SubjectRulesReviewStatusFluent.ResourceRulesNested<N>> {
