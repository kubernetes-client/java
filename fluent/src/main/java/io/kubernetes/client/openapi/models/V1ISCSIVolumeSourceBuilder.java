...
public class V1ISCSIVolumeSourceBuilder extends io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1ISCSIVolumeSource,io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceBuilder> {
    ...
    public V1ISCSIVolumeSourceBuilder(io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent<?> fluent) {
        this(fluent, true);
    }

    public V1ISCSIVolumeSourceBuilder(io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1ISCSIVolumeSource(), validationEnabled);
    }

    public V1ISCSIVolumeSourceBuilder(io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent<?> fluent,io.kubernetes.client.openapi.models.V1ISCSIVolumeSource instance) {
        this(fluent, instance, true);
    }

    public V1ISCSIVolumeSourceBuilder(io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent<?> fluent,io.kubernetes.client.openapi.models.V1ISCSIVolumeSource instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1ISCSIVolumeSourceBuilder(io.kubernetes.client.openapi.models.V1ISCSIVolumeSource instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
