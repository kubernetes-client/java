...
public class V1beta1CertificateSigningRequestSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestSpecFluent<A> {
    ...
    public V1beta1CertificateSigningRequestSpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestSpec instance) {
    ...
    public A addToRequest(int index,java.lang.Byte item) {
        if (this.request == null) {this.request =  new java.util.ArrayList<java.lang.Byte>();}
    ...
    public A addToRequest(java.lang.Byte... items) {
        if (this.request == null) {this.request =  new java.util.ArrayList<java.lang.Byte>();}
        for (java.lang.Byte item : items) {this.request.add(item);} return (A)this;
    }
    ...
    public A removeFromRequest(java.lang.Byte... items) {
        for (java.lang.Byte item : items) {if (this.request!= null){ this.request.remove(item);}} return (A)this;
    }
