...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(int index,V1ResourceQuota item) {
  ...
  public A setToItems(int index,V1ResourceQuota item) {
    if (this.items == null) {this.items = new ArrayList<V1ResourceQuotaBuilder>();}
    V1ResourceQuotaBuilder builder = new V1ResourceQuotaBuilder(item);
  ...
  public V1ResourceQuota buildItem(int index) {
  ...
  public V1ResourceQuotaListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1ResourceQuotaListFluentImpl.ItemsNestedImpl();
  }
  public V1ResourceQuotaListFluentImpl.ItemsNested<A> addNewItemLike(V1ResourceQuota item) {
    return new V1ResourceQuotaListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1ResourceQuotaListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1ResourceQuota item) {
    return new V1ResourceQuotaListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1ResourceQuotaListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ResourceQuotaListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1ResourceQuotaListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ResourceQuotaListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1ResourceQuotaBuilder> predicate) {
    int index = -1;
  ...
  public V1ResourceQuotaListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1ResourceQuotaListFluentImpl.MetadataNestedImpl();
  }
  public V1ResourceQuotaListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1ResourceQuotaListFluentImpl.MetadataNestedImpl(item);
  }
  public V1ResourceQuotaListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1ResourceQuotaListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1ResourceQuotaListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1ResourceQuotaFluentImpl<V1ResourceQuotaListFluentImpl.ItemsNested<N>> implements V1ResourceQuotaListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1ResourceQuota item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ResourceQuotaListFluentImpl.MetadataNested<N>> implements V1ResourceQuotaListFluentImpl.MetadataNested<N>,Nested<N>{
