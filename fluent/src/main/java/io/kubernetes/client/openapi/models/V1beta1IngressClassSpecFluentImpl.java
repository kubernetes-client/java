...
public class V1beta1IngressClassSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluent<A> {
    ...
    public V1beta1IngressClassSpecFluentImpl() {
    }

    public V1beta1IngressClassSpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1IngressClassSpec instance) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluent.ParametersNested<A> withNewParameters() {
        return new io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluentImpl.ParametersNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluent.ParametersNested<A> withNewParametersLike(io.kubernetes.client.openapi.models.V1TypedLocalObjectReference item) {
        return new io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluentImpl.ParametersNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluent.ParametersNested<A> editOrNewParametersLike(io.kubernetes.client.openapi.models.V1TypedLocalObjectReference item) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1IngressClassSpecFluentImpl that = (V1beta1IngressClassSpecFluentImpl) o;
    ...
    public class ParametersNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TypedLocalObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluent.ParametersNested<N>> implements io.kubernetes.client.openapi.models.V1beta1IngressClassSpecFluent.ParametersNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1TypedLocalObjectReferenceBuilder builder;
            ...
            public N and() {
                return (N) V1beta1IngressClassSpecFluentImpl.this.withParameters(builder.build());
            }
