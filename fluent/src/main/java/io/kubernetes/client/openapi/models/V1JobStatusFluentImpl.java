...
public class V1JobStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1JobStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1JobStatusFluent<A>{
  ...
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1JobCondition item) {
  ...
  public A setToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1JobCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1JobConditionBuilder>();}
  ...
  public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1JobCondition> conditions) {
    ...
    if (conditions != null) {this.conditions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1JobCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1JobStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1JobCondition item) {
    return new io.kubernetes.client.openapi.models.V1JobStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1JobStatusFluent.ConditionsNested<A> editCondition(java.lang.Integer index) {
  ...
  public A withUncountedTerminatedPods(io.kubernetes.client.openapi.models.V1UncountedTerminatedPods uncountedTerminatedPods) {
    ...
    if (uncountedTerminatedPods!=null){ this.uncountedTerminatedPods= new io.kubernetes.client.openapi.models.V1UncountedTerminatedPodsBuilder(uncountedTerminatedPods); _visitables.get("uncountedTerminatedPods").add(this.uncountedTerminatedPods);} return (A) this;
  }
  public java.lang.Boolean hasUncountedTerminatedPods() {
    return this.uncountedTerminatedPods != null;
  }
  public io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<A> withNewUncountedTerminatedPods() {
    return new io.kubernetes.client.openapi.models.V1JobStatusFluentImpl.UncountedTerminatedPodsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<A> withNewUncountedTerminatedPodsLike(io.kubernetes.client.openapi.models.V1UncountedTerminatedPods item) {
    return new io.kubernetes.client.openapi.models.V1JobStatusFluentImpl.UncountedTerminatedPodsNestedImpl(item);
  }
  public io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<A> editUncountedTerminatedPods() {
    return withNewUncountedTerminatedPodsLike(getUncountedTerminatedPods());
  }
  public io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<A> editOrNewUncountedTerminatedPods() {
    return withNewUncountedTerminatedPodsLike(getUncountedTerminatedPods() != null ? getUncountedTerminatedPods(): new io.kubernetes.client.openapi.models.V1UncountedTerminatedPodsBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<A> editOrNewUncountedTerminatedPodsLike(io.kubernetes.client.openapi.models.V1UncountedTerminatedPods item) {
  ...
  public class UncountedTerminatedPodsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1UncountedTerminatedPodsFluentImpl<io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<N>> implements io.kubernetes.client.openapi.models.V1JobStatusFluent.UncountedTerminatedPodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    UncountedTerminatedPodsNestedImpl(io.kubernetes.client.openapi.models.V1UncountedTerminatedPods item) {
      this.builder = new io.kubernetes.client.openapi.models.V1UncountedTerminatedPodsBuilder(this, item);
    }
