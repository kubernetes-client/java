...
import java.lang.Object;
  ...
  * Generated
  */
public class V2beta1HorizontalPodAutoscalerSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent<A>{
  public V2beta1HorizontalPodAutoscalerSpecFluentImpl() {
  }
  public V2beta1HorizontalPodAutoscalerSpecFluentImpl(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpec instance) {
  ...
  public A addToMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta1MetricSpec item) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder>();}
    io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder(item);_visitables.get("metrics").add(index >= 0 ? index : _visitables.get("metrics").size(), builder);this.metrics.add(index >= 0 ? index : metrics.size(), builder); return (A)this;
  }
  public A setToMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta1MetricSpec item) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder>();}
    io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder(item);
  ...
  public A addToMetrics(io.kubernetes.client.openapi.models.V2beta1MetricSpec... items) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder>();}
    for (io.kubernetes.client.openapi.models.V2beta1MetricSpec item : items) {io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder(item);_visitables.get("metrics").add(builder);this.metrics.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromMetrics(java.util.function.Predicate<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder> each = metrics.iterator();
  ...
  public io.kubernetes.client.openapi.models.V2beta1MetricSpec buildMatchingMetric(java.util.function.Predicate<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder item: metrics) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingMetric(java.util.function.Predicate<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder item: metrics) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withMetrics(java.util.List<io.kubernetes.client.openapi.models.V2beta1MetricSpec> metrics) {
    ...
    if (metrics != null) {this.metrics = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V2beta1MetricSpec item : metrics){this.addToMetrics(item);}} else { this.metrics = null;} return (A) this;
  }
  public A withMetrics(io.kubernetes.client.openapi.models.V2beta1MetricSpec... metrics) {
    ...
    if (metrics != null) {for (io.kubernetes.client.openapi.models.V2beta1MetricSpec item :metrics){ this.addToMetrics(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<A> addNewMetric() {
    return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluentImpl.MetricsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<A> addNewMetricLike(io.kubernetes.client.openapi.models.V2beta1MetricSpec item) {
    return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluentImpl.MetricsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<A> setNewMetricLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta1MetricSpec item) {
    return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluentImpl.MetricsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<A> editMetric(java.lang.Integer index) {
  ...
  public A withScaleTargetRef(io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReference scaleTargetRef) {
    ...
    if (scaleTargetRef!=null){ this.scaleTargetRef= new io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReferenceBuilder(scaleTargetRef); _visitables.get("scaleTargetRef").add(this.scaleTargetRef);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<A> withNewScaleTargetRef() {
    return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluentImpl.ScaleTargetRefNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<A> withNewScaleTargetRefLike(io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReference item) {
    return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluentImpl.ScaleTargetRefNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<A> editOrNewScaleTargetRef() {
    return withNewScaleTargetRefLike(getScaleTargetRef() != null ? getScaleTargetRef(): new io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReferenceBuilder().build());
  }
  ...
  public class MetricsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1MetricSpecFluentImpl<io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    MetricsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta1MetricSpec item) {
      this.index = index;
  ...
  public class ScaleTargetRefNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ScaleTargetRefNestedImpl(io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReference item) {
      this.builder = new io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReferenceBuilder(this, item);
    }
    ScaleTargetRefNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReferenceBuilder(this);
    }
