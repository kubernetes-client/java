...
public class V1ISCSIVolumeSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent<A> {
    ...
    public V1ISCSIVolumeSourceFluentImpl(io.kubernetes.client.openapi.models.V1ISCSIVolumeSource instance) {
    ...
    public A withPortals(java.util.List<java.lang.String> portals) {
        ...
        if (portals != null) {this.portals = new java.util.ArrayList<java.lang.String>(); for (java.lang.String item : portals){this.addToPortals(item);}} else { this.portals = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent.SecretRefNested<A> withNewSecretRef() {
        return new io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluentImpl.SecretRefNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent.SecretRefNested<A> withNewSecretRefLike(io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
        return new io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluentImpl.SecretRefNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent.SecretRefNested<A> editSecretRef() {
        return withNewSecretRefLike(getSecretRef());
    }

    public io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent.SecretRefNested<A> editOrNewSecretRef() {
    ...
    public io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent.SecretRefNested<A> editOrNewSecretRefLike(io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
    ...
    public class SecretRefNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LocalObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent.SecretRefNested<N>> implements io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluent.SecretRefNested<N>,io.kubernetes.client.fluent.Nested<N> {
