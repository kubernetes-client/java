...
public class V1beta2DeviceSubRequestFluent<A extends io.kubernetes.client.openapi.models.V1beta2DeviceSubRequestFluent<A>> extends BaseFluent<A>{
  ...
  public class CapacityNested<N> extends V1beta2CapacityRequirementsFluent<CapacityNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2DeviceSubRequestFluent.this.withCapacity(builder.build());
    }
