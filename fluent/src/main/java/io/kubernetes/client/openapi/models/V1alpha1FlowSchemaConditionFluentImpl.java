...
public class V1alpha1FlowSchemaConditionFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1FlowSchemaConditionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1FlowSchemaConditionFluent<A> {
    ...
    public V1alpha1FlowSchemaConditionFluentImpl() {
    }

    public V1alpha1FlowSchemaConditionFluentImpl(io.kubernetes.client.openapi.models.V1alpha1FlowSchemaCondition instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1alpha1FlowSchemaConditionFluentImpl that = (V1alpha1FlowSchemaConditionFluentImpl) o;
