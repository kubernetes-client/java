...
public class V1MutatingWebhookConfigurationFluentImpl<A extends io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent<A> {
    ...
    private java.util.List<io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder> webhooks;
    ...
    public A addToWebhooks(int index,io.kubernetes.client.openapi.models.V1MutatingWebhook item) {
    ...
    public A setToWebhooks(int index,io.kubernetes.client.openapi.models.V1MutatingWebhook item) {
        if (this.webhooks == null) {this.webhooks = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder>();}
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhook buildWebhook(int index) {
    ...
    public A withWebhooks(java.util.List<io.kubernetes.client.openapi.models.V1MutatingWebhook> webhooks) {
        ...
        if (webhooks != null) {this.webhooks = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder>(); for (io.kubernetes.client.openapi.models.V1MutatingWebhook item : webhooks){this.addToWebhooks(item);}} else { this.webhooks = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent.WebhooksNested<A> setNewWebhookLike(int index,io.kubernetes.client.openapi.models.V1MutatingWebhook item) {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluentImpl.WebhooksNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent.WebhooksNested<A> editWebhook(int index) {
    ...
    public class WebhooksNestedImpl<N> extends io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl<io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent.WebhooksNested<N>> implements io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent.WebhooksNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder builder;
        private final int index;

            WebhooksNestedImpl(int index,io.kubernetes.client.openapi.models.V1MutatingWebhook item) {
                this.index = index;
