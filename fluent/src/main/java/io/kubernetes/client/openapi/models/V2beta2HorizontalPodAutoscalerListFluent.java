...
public interface V2beta2HorizontalPodAutoscalerListFluent<A extends io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerListFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler item);
    public A setToItems(int index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler item);
    ...
    public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler buildItem(int index);
    ...
    public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler item);
    public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerListFluent.ItemsNested<A> editItem(int index);
    ...
    public interface ItemsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerFluent<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerListFluent.ItemsNested<N>> {

            public N and();
            public N endItem();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ListMetaFluent<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerListFluent.MetadataNested<N>> {
