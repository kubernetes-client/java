...
import java.lang.Object;
  ...
  */
  ...
  public V1beta1PriorityLevelConfigurationListFluentImpl(V1beta1PriorityLevelConfigurationList instance) {
  ...
  public A addToItems(Integer index,V1beta1PriorityLevelConfiguration item) {
    if (this.items == null) {this.items = new ArrayList<V1beta1PriorityLevelConfigurationBuilder>();}
    V1beta1PriorityLevelConfigurationBuilder builder = new V1beta1PriorityLevelConfigurationBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(Integer index,V1beta1PriorityLevelConfiguration item) {
    if (this.items == null) {this.items = new ArrayList<V1beta1PriorityLevelConfigurationBuilder>();}
    V1beta1PriorityLevelConfigurationBuilder builder = new V1beta1PriorityLevelConfigurationBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfiguration... items) {
    if (this.items == null) {this.items = new ArrayList<V1beta1PriorityLevelConfigurationBuilder>();}
    for (V1beta1PriorityLevelConfiguration item : items) {V1beta1PriorityLevelConfigurationBuilder builder = new V1beta1PriorityLevelConfigurationBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfiguration... items) {
    for (V1beta1PriorityLevelConfiguration item : items) {V1beta1PriorityLevelConfigurationBuilder builder = new V1beta1PriorityLevelConfigurationBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<V1beta1PriorityLevelConfigurationBuilder> predicate) {
    ...
    final Iterator<V1beta1PriorityLevelConfigurationBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      V1beta1PriorityLevelConfigurationBuilder builder = each.next();
  ...
  public V1beta1PriorityLevelConfiguration buildMatchingItem(Predicate<V1beta1PriorityLevelConfigurationBuilder> predicate) {
    for (V1beta1PriorityLevelConfigurationBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V1beta1PriorityLevelConfigurationBuilder> predicate) {
    for (V1beta1PriorityLevelConfigurationBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V1beta1PriorityLevelConfiguration> items) {
    ...
    if (items != null) {this.items = new ArrayList(); for (V1beta1PriorityLevelConfiguration item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfiguration... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (V1beta1PriorityLevelConfiguration item :items){ this.addToItems(item);}} return (A) this;
  }
  ...
  public V1beta1PriorityLevelConfigurationListFluent.ItemsNested<A> setNewItemLike(Integer index,V1beta1PriorityLevelConfiguration item) {
    return new V1beta1PriorityLevelConfigurationListFluentImpl.ItemsNestedImpl(index, item);
  }
  ...
  public V1beta1PriorityLevelConfigurationListFluent.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1beta1PriorityLevelConfigurationListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  class ItemsNestedImpl<N> extends V1beta1PriorityLevelConfigurationFluentImpl<V1beta1PriorityLevelConfigurationListFluent.ItemsNested<N>> implements V1beta1PriorityLevelConfigurationListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1beta1PriorityLevelConfiguration item) {
      this.index = index;
    ...
    V1beta1PriorityLevelConfigurationBuilder builder;
    Integer index;
    public N and() {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta1PriorityLevelConfigurationListFluent.MetadataNested<N>> implements V1beta1PriorityLevelConfigurationListFluent.MetadataNested<N>,Nested<N>{
