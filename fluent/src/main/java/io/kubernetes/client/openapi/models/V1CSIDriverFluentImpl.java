...
public class V1CSIDriverFluentImpl<A extends io.kubernetes.client.openapi.models.V1CSIDriverFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CSIDriverFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private io.kubernetes.client.openapi.models.V1CSIDriverSpecBuilder spec;
    ...
    public io.kubernetes.client.openapi.models.V1CSIDriverFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1CSIDriverFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSIDriverFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1CSIDriverFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1CSIDriverSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1CSIDriverSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSIDriverFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1CSIDriverFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSIDriverFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1CSIDriverSpecBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1CSIDriverFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CSIDriverFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CSIDriverSpecFluentImpl<io.kubernetes.client.openapi.models.V1CSIDriverFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CSIDriverFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CSIDriverSpecBuilder builder;

            SpecNestedImpl(io.kubernetes.client.openapi.models.V1CSIDriverSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CSIDriverSpecBuilder(this, item);
