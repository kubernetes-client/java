...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1ReplicaSet item) {
    ...
    V1ReplicaSetBuilder builder = new V1ReplicaSetBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1ReplicaSetFluentImpl<V1ReplicaSetListFluent.ItemsNested<N>> implements V1ReplicaSetListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1ReplicaSet item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ReplicaSetListFluent.MetadataNested<N>> implements V1ReplicaSetListFluent.MetadataNested<N>,Nested<N>{
