...
import java.lang.Boolean;
  ...
  */
  ...
  public V1NetworkPolicyStatusFluentImpl.ConditionsNested<A> addNewCondition() {
    return new V1NetworkPolicyStatusFluentImpl.ConditionsNestedImpl();
  }
  public V1NetworkPolicyStatusFluentImpl.ConditionsNested<A> addNewConditionLike(V1Condition item) {
    return new V1NetworkPolicyStatusFluentImpl.ConditionsNestedImpl(-1, item);
  }
  public V1NetworkPolicyStatusFluentImpl.ConditionsNested<A> setNewConditionLike(int index,V1Condition item) {
    return new V1NetworkPolicyStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  public V1NetworkPolicyStatusFluentImpl.ConditionsNested<A> editCondition(int index) {
    if (conditions.size() <= index) throw new RuntimeException("Can't edit conditions. Index exceeds size.");
    return setNewConditionLike(index, buildCondition(index));
  }
  public V1NetworkPolicyStatusFluentImpl.ConditionsNested<A> editFirstCondition() {
    if (conditions.size() == 0) throw new RuntimeException("Can't edit first conditions. The list is empty.");
    return setNewConditionLike(0, buildCondition(0));
  }
  public V1NetworkPolicyStatusFluentImpl.ConditionsNested<A> editLastCondition() {
    int index = conditions.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last conditions. The list is empty.");
    return setNewConditionLike(index, buildCondition(index));
  }
  public V1NetworkPolicyStatusFluentImpl.ConditionsNested<A> editMatchingCondition(Predicate<V1ConditionBuilder> predicate) {
    int index = -1;
  ...
  class ConditionsNestedImpl<N> extends V1ConditionFluentImpl<V1NetworkPolicyStatusFluentImpl.ConditionsNested<N>> implements V1NetworkPolicyStatusFluentImpl.ConditionsNested<N>,Nested<N>{
