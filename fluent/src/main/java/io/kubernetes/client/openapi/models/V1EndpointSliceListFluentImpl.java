...
import java.lang.Object;
  ...
  * Generated
  */
public class V1EndpointSliceListFluentImpl<A extends io.kubernetes.client.openapi.models.V1EndpointSliceListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1EndpointSliceListFluent<A>{
  ...
  private java.util.List<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder> items;
  ...
  public A addToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointSlice item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder>();}
    io.kubernetes.client.openapi.models.V1EndpointSliceBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointSliceBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointSlice item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder>();}
    io.kubernetes.client.openapi.models.V1EndpointSliceBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointSliceBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1EndpointSlice... items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder>();}
    for (io.kubernetes.client.openapi.models.V1EndpointSlice item : items) {io.kubernetes.client.openapi.models.V1EndpointSliceBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointSliceBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1EndpointSlice... items) {
    for (io.kubernetes.client.openapi.models.V1EndpointSlice item : items) {io.kubernetes.client.openapi.models.V1EndpointSliceBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointSliceBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder> each = items.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSlice buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1EndpointSliceBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EndpointSliceBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1EndpointSliceBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1EndpointSlice> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1EndpointSlice item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1EndpointSlice... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (io.kubernetes.client.openapi.models.V1EndpointSlice item :items){ this.addToItems(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSliceListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1EndpointSlice item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1EndpointSliceListFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointSlice item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceListFluentImpl.ItemsNestedImpl(index, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSliceListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EndpointSliceFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSliceListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSliceListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointSlice item) {
      this.index = index;
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSliceListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSliceListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
