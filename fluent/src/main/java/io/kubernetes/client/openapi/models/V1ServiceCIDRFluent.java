...
public class V1ServiceCIDRFluent<A extends io.kubernetes.client.openapi.models.V1ServiceCIDRFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V1ServiceCIDRSpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V1ServiceCIDRStatusBuilder().build()));
  }
