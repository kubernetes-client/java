...
public class V1beta2FlowSchemaListFluent<A extends V1beta2FlowSchemaListFluent<A>> extends BaseFluent<A>{
  public V1beta2FlowSchemaListFluent() {
  }
  
  public V1beta2FlowSchemaListFluent(V1beta2FlowSchemaList instance) {
  ...
  protected void copyInstance(V1beta2FlowSchemaList instance) {
    instance = (instance != null ? instance : new V1beta2FlowSchemaList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta2FlowSchema... items) {
    ...
    for (V1beta2FlowSchema item : items) {V1beta2FlowSchemaBuilder builder = new V1beta2FlowSchemaBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1beta2FlowSchema buildMatchingItem(Predicate<V1beta2FlowSchemaBuilder> predicate) {
      for (V1beta2FlowSchemaBuilder item : items) {
  ...
  public A withItems(List<V1beta2FlowSchema> items) {
    ...
    if (items != null) {
        ...
        for (V1beta2FlowSchema item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1beta2FlowSchema item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1beta2FlowSchema item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1beta2FlowSchemaBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1beta2FlowSchemaListFluent that = (V1beta2FlowSchemaListFluent) o;
  ...
  public class ItemsNested<N> extends V1beta2FlowSchemaFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1beta2FlowSchema item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1beta2FlowSchemaListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2FlowSchemaListFluent.this.withMetadata(builder.build());
    }
