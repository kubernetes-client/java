...
public class V1SecretListFluent<A extends io.kubernetes.client.openapi.models.V1SecretListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1Secret... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1Secret... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1Secret item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1SecretBuilder> predicate) {
    ...
    Iterator<V1SecretBuilder> each = items.iterator();
  ...
  public A withItems(V1Secret... items) {
    if (this.items != null) {
        this.items.clear();
