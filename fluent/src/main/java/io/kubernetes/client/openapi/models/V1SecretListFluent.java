...
public class V1SecretListFluent<A extends V1SecretListFluent<A>> extends BaseFluent<A>{
  public V1SecretListFluent() {
  }
  
  public V1SecretListFluent(V1SecretList instance) {
  ...
  protected void copyInstance(V1SecretList instance) {
    instance = (instance != null ? instance : new V1SecretList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Secret... items) {
    ...
    for (V1Secret item : items) {V1SecretBuilder builder = new V1SecretBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1Secret buildMatchingItem(Predicate<V1SecretBuilder> predicate) {
      for (V1SecretBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1Secret item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1Secret item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1SecretBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1SecretListFluent that = (V1SecretListFluent) o;
  ...
  public class ItemsNested<N> extends V1SecretFluent<ItemsNested<N>> implements Nested<N>{
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1SecretListFluent.this.withMetadata(builder.build());
    }
