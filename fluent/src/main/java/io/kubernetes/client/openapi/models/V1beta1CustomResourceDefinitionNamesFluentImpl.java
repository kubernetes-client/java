...
public class V1beta1CustomResourceDefinitionNamesFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNamesFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNamesFluent<A> {
    ...
    public V1beta1CustomResourceDefinitionNamesFluentImpl() {
    }

    public V1beta1CustomResourceDefinitionNamesFluentImpl(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNames instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1CustomResourceDefinitionNamesFluentImpl that = (V1beta1CustomResourceDefinitionNamesFluentImpl) o;
