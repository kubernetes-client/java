...
public class V1ClusterRoleBindingListFluent<A extends io.kubernetes.client.openapi.models.V1ClusterRoleBindingListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1ClusterRoleBinding... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1ClusterRoleBinding... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1ClusterRoleBinding item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1ClusterRoleBindingBuilder> predicate) {
    ...
    Iterator<V1ClusterRoleBindingBuilder> each = items.iterator();
  ...
  public A withItems(V1ClusterRoleBinding... items) {
    if (this.items != null) {
        this.items.clear();
