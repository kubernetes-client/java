...
public class V1alpha3DeviceTolerationFluent<A extends V1alpha3DeviceTolerationFluent<A>> extends BaseFluent<A>{
  public V1alpha3DeviceTolerationFluent() {
  }
  
  public V1alpha3DeviceTolerationFluent(V1alpha3DeviceToleration instance) {
  ...
  protected void copyInstance(V1alpha3DeviceToleration instance) {
    instance = (instance != null ? instance : new V1alpha3DeviceToleration());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3DeviceTolerationFluent that = (V1alpha3DeviceTolerationFluent) o;
