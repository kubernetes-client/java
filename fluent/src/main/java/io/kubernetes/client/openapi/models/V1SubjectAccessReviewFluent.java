...
public class V1SubjectAccessReviewFluent<A extends V1SubjectAccessReviewFluent<A>> extends BaseFluent<A>{
  public V1SubjectAccessReviewFluent() {
  }
  
  public V1SubjectAccessReviewFluent(V1SubjectAccessReview instance) {
  ...
  protected void copyInstance(V1SubjectAccessReview instance) {
    instance = (instance != null ? instance : new V1SubjectAccessReview());
    if (instance != null) {
  ...
  public SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new V1SubjectAccessReviewSpecBuilder().build()));
  }
  ...
  public boolean equals(Object o) {
    ...
    V1SubjectAccessReviewFluent that = (V1SubjectAccessReviewFluent) o;
  ...
  public class MetadataNested<N> extends V1ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1SubjectAccessReviewFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends V1SubjectAccessReviewSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1SubjectAccessReviewFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends V1SubjectAccessReviewStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1SubjectAccessReviewFluent.this.withStatus(builder.build());
    }
