...
public class V1EndpointSliceListFluent<A extends io.kubernetes.client.openapi.models.V1EndpointSliceListFluent<A>> extends BaseFluent<A>{
  public V1EndpointSliceListFluent() {
  }
  
  public V1EndpointSliceListFluent(V1EndpointSliceList instance) {
  ...
  protected void copyInstance(V1EndpointSliceList instance) {
    instance = instance != null ? instance : new V1EndpointSliceList();
    if (instance != null) {
  ...
  public A addToItems(V1EndpointSlice... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1EndpointSlice... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1EndpointSlice item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1EndpointSliceBuilder> predicate) {
    ...
    Iterator<V1EndpointSliceBuilder> each = items.iterator();
  ...
  public A withItems(V1EndpointSlice... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public ItemsNested<A> addNewItemLike(V1EndpointSlice item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1EndpointSlice item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1EndpointSliceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1EndpointSliceListFluent that = (V1EndpointSliceListFluent) o;
  ...
  public class ItemsNested<N> extends V1EndpointSliceFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1EndpointSlice item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1EndpointSliceListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1EndpointSliceListFluent.this.withMetadata(builder.build());
    }
