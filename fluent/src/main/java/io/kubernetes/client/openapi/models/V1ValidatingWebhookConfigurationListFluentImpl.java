...
public class V1ValidatingWebhookConfigurationListFluentImpl<A extends io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent<A> {
    ...
    private java.util.List<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder> items;
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item) {
    ...
    public A setToItems(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder>();}
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration buildItem(int index) {
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder>(); for (io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item) {
        return new io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluentImpl.ItemsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent.ItemsNested<A> editItem(int index) {
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluentImpl<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item) {
                this.index = index;
