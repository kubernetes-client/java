...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1ValidatingWebhookConfiguration item) {
    ...
    V1ValidatingWebhookConfigurationBuilder builder = new V1ValidatingWebhookConfigurationBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1ValidatingWebhookConfigurationFluentImpl<V1ValidatingWebhookConfigurationListFluent.ItemsNested<N>> implements V1ValidatingWebhookConfigurationListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1ValidatingWebhookConfiguration item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ValidatingWebhookConfigurationListFluent.MetadataNested<N>> implements V1ValidatingWebhookConfigurationListFluent.MetadataNested<N>,Nested<N>{
