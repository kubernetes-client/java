...
public class V1beta1CSIStorageCapacityBuilder extends io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityFluentImpl<io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity,io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityBuilder>{
  ...
  public V1beta1CSIStorageCapacityBuilder(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityFluent<?> fluent) {
    this(fluent, false);
  }
  public V1beta1CSIStorageCapacityBuilder(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityFluent<?> fluent,java.lang.Boolean validationEnabled) {
    this(fluent, new V1beta1CSIStorageCapacity(), validationEnabled);
  }
  public V1beta1CSIStorageCapacityBuilder(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityFluent<?> fluent,io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity instance) {
    this(fluent, instance, false);
  }
  public V1beta1CSIStorageCapacityBuilder(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityFluent<?> fluent,io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity instance,java.lang.Boolean validationEnabled) {
    this.fluent = fluent; 
  ...
  public V1beta1CSIStorageCapacityBuilder(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity instance) {
    this(instance,false);
  }
  public V1beta1CSIStorageCapacityBuilder(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity instance,java.lang.Boolean validationEnabled) {
    this.fluent = this; 
