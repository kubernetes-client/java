...
public class V1alpha1VolumeAttachmentListFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentListFluent<A> {
    ...
    private java.util.List<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentBuilder> items;
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1alpha1VolumeAttachment item) {
    ...
    public A setToItems(int index,io.kubernetes.client.openapi.models.V1alpha1VolumeAttachment item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentBuilder>();}
    ...
    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachment buildItem(int index) {
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachment> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentBuilder>(); for (io.kubernetes.client.openapi.models.V1alpha1VolumeAttachment item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1alpha1VolumeAttachment item) {
        return new io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentListFluentImpl.ItemsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentListFluent.ItemsNested<A> editItem(int index) {
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentFluentImpl<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1alpha1VolumeAttachment item) {
                this.index = index;
