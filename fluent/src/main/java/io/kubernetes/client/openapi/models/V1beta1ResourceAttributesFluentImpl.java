...
public class V1beta1ResourceAttributesFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1ResourceAttributesFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1ResourceAttributesFluent<A> {
    ...
    public V1beta1ResourceAttributesFluentImpl() {
    }

    public V1beta1ResourceAttributesFluentImpl(io.kubernetes.client.openapi.models.V1beta1ResourceAttributes instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1ResourceAttributesFluentImpl that = (V1beta1ResourceAttributesFluentImpl) o;
