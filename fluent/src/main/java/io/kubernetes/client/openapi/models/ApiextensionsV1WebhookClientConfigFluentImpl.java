...
public class ApiextensionsV1WebhookClientConfigFluentImpl<A extends io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluent<A> {
    ...
    public ApiextensionsV1WebhookClientConfigFluentImpl(io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfig instance) {
    ...
    public A withService(io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReference service) {
        ...
        if (service!=null){ this.service= new io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReferenceBuilder(service); _visitables.get("service").add(this.service);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluent.ServiceNested<A> withNewService() {
        return new io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluentImpl.ServiceNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluent.ServiceNested<A> withNewServiceLike(io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReference item) {
        return new io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluentImpl.ServiceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluent.ServiceNested<A> editOrNewService() {
        return withNewServiceLike(getService() != null ? getService(): new io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReferenceBuilder().build());
    }
    ...
    public class ServiceNestedImpl<N> extends io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReferenceFluentImpl<io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluent.ServiceNested<N>> implements io.kubernetes.client.openapi.models.ApiextensionsV1WebhookClientConfigFluent.ServiceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReferenceBuilder builder;

            ServiceNestedImpl(io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReference item) {
                this.builder = new io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReferenceBuilder(this, item);
                        
            }

            ServiceNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.ApiextensionsV1ServiceReferenceBuilder(this);
