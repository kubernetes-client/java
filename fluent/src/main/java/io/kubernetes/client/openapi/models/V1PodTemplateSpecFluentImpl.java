...
public class V1PodTemplateSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodTemplateSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodTemplateSpecFluent<A> {
    ...
    public V1PodTemplateSpecFluentImpl(io.kubernetes.client.openapi.models.V1PodTemplateSpec instance) {
    ...
    public io.kubernetes.client.openapi.models.V1PodTemplateSpecFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1PodTemplateSpecFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1PodTemplateSpecFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1PodTemplateSpecFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodSpecFluentImpl<io.kubernetes.client.openapi.models.V1PodTemplateSpecFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1PodTemplateSpecFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
