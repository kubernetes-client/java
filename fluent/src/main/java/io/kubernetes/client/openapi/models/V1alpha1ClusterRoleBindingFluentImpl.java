...
public class V1alpha1ClusterRoleBindingFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluent.SubjectsNested<A> addNewSubjectLike(io.kubernetes.client.openapi.models.RbacV1alpha1Subject item) {
        return new io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluentImpl.SubjectsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluent.SubjectsNested<A> setNewSubjectLike(int index,io.kubernetes.client.openapi.models.RbacV1alpha1Subject item) {
        return new io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluentImpl.SubjectsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluent.SubjectsNested<A> editSubject(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluent.SubjectsNested<A> editMatchingSubject(java.util.function.Predicate<io.kubernetes.client.openapi.models.RbacV1alpha1SubjectBuilder> predicate) {
        int index = -1;
