...
import java.util.Map;
  ...
  * Generated
  */
public class V1EndpointFluentImpl<A extends io.kubernetes.client.openapi.models.V1EndpointFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1EndpointFluent<A>{
  ...
  public A withConditions(io.kubernetes.client.openapi.models.V1EndpointConditions conditions) {
    ...
    if (conditions!=null){ this.conditions= new io.kubernetes.client.openapi.models.V1EndpointConditionsBuilder(conditions); _visitables.get("conditions").add(this.conditions);} return (A) this;
  }
  public java.lang.Boolean hasConditions() {
    return this.conditions != null;
  }
  public io.kubernetes.client.openapi.models.V1EndpointFluent.ConditionsNested<A> withNewConditions() {
    return new io.kubernetes.client.openapi.models.V1EndpointFluentImpl.ConditionsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1EndpointFluent.ConditionsNested<A> withNewConditionsLike(io.kubernetes.client.openapi.models.V1EndpointConditions item) {
  ...
  public io.kubernetes.client.openapi.models.V1EndpointFluent.ConditionsNested<A> editOrNewConditions() {
    return withNewConditionsLike(getConditions() != null ? getConditions(): new io.kubernetes.client.openapi.models.V1EndpointConditionsBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V1EndpointFluent.ConditionsNested<A> editOrNewConditionsLike(io.kubernetes.client.openapi.models.V1EndpointConditions item) {
  ...
  public A addToDeprecatedTopology(java.lang.String key,java.lang.String value) {
    if(this.deprecatedTopology == null && key != null && value != null) { this.deprecatedTopology = new java.util.LinkedHashMap(); }
  ...
  public A addToDeprecatedTopology(java.util.Map<java.lang.String,java.lang.String> map) {
    if(this.deprecatedTopology == null && map != null) { this.deprecatedTopology = new java.util.LinkedHashMap(); }
  ...
  public <K,V>A withDeprecatedTopology(java.util.Map<java.lang.String,java.lang.String> deprecatedTopology) {
    if (deprecatedTopology == null) { this.deprecatedTopology =  null;} else {this.deprecatedTopology = new java.util.LinkedHashMap(deprecatedTopology);} return (A) this;
  }
  ...
  public A withHints(io.kubernetes.client.openapi.models.V1EndpointHints hints) {
    ...
    if (hints!=null){ this.hints= new io.kubernetes.client.openapi.models.V1EndpointHintsBuilder(hints); _visitables.get("hints").add(this.hints);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointFluent.HintsNested<A> withNewHintsLike(io.kubernetes.client.openapi.models.V1EndpointHints item) {
  ...
  public io.kubernetes.client.openapi.models.V1EndpointFluent.HintsNested<A> editOrNewHints() {
    return withNewHintsLike(getHints() != null ? getHints(): new io.kubernetes.client.openapi.models.V1EndpointHintsBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V1EndpointFluent.HintsNested<A> editOrNewHintsLike(io.kubernetes.client.openapi.models.V1EndpointHints item) {
  ...
  public io.kubernetes.client.openapi.models.V1EndpointFluent.TargetRefNested<A> withNewTargetRefLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
  ...
  public io.kubernetes.client.openapi.models.V1EndpointFluent.TargetRefNested<A> editOrNewTargetRef() {
  ...
  public io.kubernetes.client.openapi.models.V1EndpointFluent.TargetRefNested<A> editOrNewTargetRefLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EndpointConditionsFluentImpl<io.kubernetes.client.openapi.models.V1EndpointFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ConditionsNestedImpl(io.kubernetes.client.openapi.models.V1EndpointConditions item) {
      this.builder = new io.kubernetes.client.openapi.models.V1EndpointConditionsBuilder(this, item);
    }
  ...
  public class HintsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EndpointHintsFluentImpl<io.kubernetes.client.openapi.models.V1EndpointFluent.HintsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointFluent.HintsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class TargetRefNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1EndpointFluent.TargetRefNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointFluent.TargetRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
