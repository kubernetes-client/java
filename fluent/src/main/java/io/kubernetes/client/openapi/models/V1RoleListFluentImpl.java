...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1Role item) {
    ...
    V1RoleBuilder builder = new V1RoleBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1RoleFluentImpl<V1RoleListFluent.ItemsNested<N>> implements V1RoleListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1Role item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1RoleListFluent.MetadataNested<N>> implements V1RoleListFluent.MetadataNested<N>,Nested<N>{
