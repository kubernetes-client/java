...
public class AuthenticationV1TokenRequestFluent<A extends io.kubernetes.client.openapi.models.AuthenticationV1TokenRequestFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V1TokenRequestSpecBuilder().build()));
  }
