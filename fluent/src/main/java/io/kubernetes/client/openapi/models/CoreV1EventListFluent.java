...
public class CoreV1EventListFluent<A extends CoreV1EventListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.CoreV1Event... items) {
    ...
    for (CoreV1Event item : items) {CoreV1EventBuilder builder = new CoreV1EventBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
