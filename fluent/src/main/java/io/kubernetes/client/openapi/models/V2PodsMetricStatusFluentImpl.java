...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2PodsMetricStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent<A>{
  public V2PodsMetricStatusFluentImpl() {
  }
  public V2PodsMetricStatusFluentImpl(io.kubernetes.client.openapi.models.V2PodsMetricStatus instance) {
  ...
  public io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent.CurrentNested<A> withNewCurrent() {
    return new io.kubernetes.client.openapi.models.V2PodsMetricStatusFluentImpl.CurrentNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent.CurrentNested<A> withNewCurrentLike(io.kubernetes.client.openapi.models.V2MetricValueStatus item) {
    return new io.kubernetes.client.openapi.models.V2PodsMetricStatusFluentImpl.CurrentNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent.MetricNested<A> withNewMetricLike(io.kubernetes.client.openapi.models.V2MetricIdentifier item) {
    return new io.kubernetes.client.openapi.models.V2PodsMetricStatusFluentImpl.MetricNestedImpl(item);
  }
  ...
  public class CurrentNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricValueStatusFluentImpl<io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent.CurrentNested<N>> implements io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent.CurrentNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class MetricNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricIdentifierFluentImpl<io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent.MetricNested<N>> implements io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent.MetricNested<N>,io.kubernetes.client.fluent.Nested<N>{
