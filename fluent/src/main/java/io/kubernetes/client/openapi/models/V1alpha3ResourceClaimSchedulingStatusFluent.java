...
public class V1alpha3ResourceClaimSchedulingStatusFluent<A extends V1alpha3ResourceClaimSchedulingStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(V1alpha3ResourceClaimSchedulingStatus instance) {
    instance = (instance != null ? instance : new V1alpha3ResourceClaimSchedulingStatus());
    if (instance != null) {
