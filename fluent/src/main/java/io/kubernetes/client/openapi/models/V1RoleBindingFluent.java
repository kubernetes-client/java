...
public interface V1RoleBindingFluent<A extends V1RoleBindingFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends Nested<N>,V1ObjectMetaFluent<V1RoleBindingFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface RoleRefNested<N> extends Nested<N>,V1RoleRefFluent<V1RoleBindingFluent.RoleRefNested<N>>{
    public N and();
    public N endRoleRef();
    
  }
  public interface SubjectsNested<N> extends Nested<N>,V1SubjectFluent<V1RoleBindingFluent.SubjectsNested<N>>{
    public N and();
    public N endSubject();
