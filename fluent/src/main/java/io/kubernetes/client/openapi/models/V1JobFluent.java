...
public class V1JobFluent<A extends io.kubernetes.client.openapi.models.V1JobFluent<A>> extends BaseFluent<A>{
  public V1JobFluent() {
  }
  
  public V1JobFluent(V1Job instance) {
  ...
  protected void copyInstance(V1Job instance) {
    instance = instance != null ? instance : new V1Job();
    if (instance != null) {
  ...
  public StatusNested<A> withNewStatusLike(V1JobStatus item) {
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V1JobStatusBuilder().build()));
  }
  
  public StatusNested<A> editOrNewStatusLike(V1JobStatus item) {
  ...
  public boolean equals(Object o) {
    ...
    V1JobFluent that = (V1JobFluent) o;
  ...
  public class MetadataNested<N> extends V1ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1JobFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends V1JobSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1JobFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends V1JobStatusFluent<StatusNested<N>> implements Nested<N>{
    StatusNested(V1JobStatus item) {
      this.builder = new V1JobStatusBuilder(this, item);
    }
    V1JobStatusBuilder builder;
    
    public N and() {
      return (N) V1JobFluent.this.withStatus(builder.build());
    }
