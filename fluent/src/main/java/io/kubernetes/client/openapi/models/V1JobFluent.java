...
public class V1JobFluent<A extends V1JobFluent<A>> extends BaseFluent<A>{
  public V1JobFluent() {
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(java.util.Optional.ofNullable(buildStatus()).orElse(new V1JobStatusBuilder().build()));
  }
