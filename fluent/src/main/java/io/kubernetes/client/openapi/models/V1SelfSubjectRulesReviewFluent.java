...
public class V1SelfSubjectRulesReviewFluent<A extends V1SelfSubjectRulesReviewFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new V1SelfSubjectRulesReviewSpecBuilder().build()));
  }
  
  public SpecNested<A> editOrNewSpecLike(V1SelfSubjectRulesReviewSpec item) {
  ...
  public StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(java.util.Optional.ofNullable(buildStatus()).orElse(new V1SubjectRulesReviewStatusBuilder().build()));
  }
  ...
  public boolean equals(Object o) {
    ...
    V1SelfSubjectRulesReviewFluent that = (V1SelfSubjectRulesReviewFluent) o;
