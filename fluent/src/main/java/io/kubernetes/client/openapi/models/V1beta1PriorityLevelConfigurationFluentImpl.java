...
public class V1beta1PriorityLevelConfigurationFluentImpl<
  ...
  public V1beta1PriorityLevelConfigurationFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(
        getSpec() != null ? getSpec() : new V1beta1PriorityLevelConfigurationSpecBuilder().build());
  }
  ...
  public A withStatus(V1beta1PriorityLevelConfigurationStatus status) {
    ...
    if (status != null) {
      this.status = new V1beta1PriorityLevelConfigurationStatusBuilder(status);
  ...
  public V1beta1PriorityLevelConfigurationFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(
        getStatus() != null
            ? getStatus()
            : new V1beta1PriorityLevelConfigurationStatusBuilder().build());
  }
  ...
  class MetadataNestedImpl<N>
      ...
      implements V1beta1PriorityLevelConfigurationFluent.MetadataNested<N>, Nested<N> {
  ...
  class SpecNestedImpl<N>
      ...
      implements V1beta1PriorityLevelConfigurationFluent.SpecNested<N>, Nested<N> {
  ...
  class StatusNestedImpl<N>
      ...
      implements V1beta1PriorityLevelConfigurationFluent.StatusNested<N>, Nested<N> {
