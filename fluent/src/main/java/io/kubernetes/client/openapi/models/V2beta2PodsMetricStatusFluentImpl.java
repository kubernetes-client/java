...
import java.lang.Boolean;
  ...
  */
  ...
  public class V2beta2PodsMetricStatusFluentImpl<A extends V2beta2PodsMetricStatusFluent<A>> extends BaseFluent<A> implements V2beta2PodsMetricStatusFluent<A>{
  public V2beta2PodsMetricStatusFluentImpl() {
  }
  public V2beta2PodsMetricStatusFluentImpl(V2beta2PodsMetricStatus instance) {
  ...
  public V2beta2PodsMetricStatusFluent.MetricNested<A> withNewMetricLike(V2beta2MetricIdentifier item) {
    return new V2beta2PodsMetricStatusFluentImpl.MetricNestedImpl(item);
  }
  ...
  class CurrentNestedImpl<N> extends V2beta2MetricValueStatusFluentImpl<V2beta2PodsMetricStatusFluent.CurrentNested<N>> implements V2beta2PodsMetricStatusFluent.CurrentNested<N>,Nested<N>{
  ...
  class MetricNestedImpl<N> extends V2beta2MetricIdentifierFluentImpl<V2beta2PodsMetricStatusFluent.MetricNested<N>> implements V2beta2PodsMetricStatusFluent.MetricNested<N>,Nested<N>{
