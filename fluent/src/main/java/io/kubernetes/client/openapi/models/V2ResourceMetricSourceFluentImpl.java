...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2ResourceMetricSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluent<A>{
  public V2ResourceMetricSourceFluentImpl() {
  }
  public V2ResourceMetricSourceFluentImpl(io.kubernetes.client.openapi.models.V2ResourceMetricSource instance) {
  ...
  public io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluent.TargetNested<A> withNewTarget() {
    return new io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluentImpl.TargetNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluent.TargetNested<A> withNewTargetLike(io.kubernetes.client.openapi.models.V2MetricTarget item) {
    return new io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluentImpl.TargetNestedImpl(item);
  }
  ...
  public class TargetNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricTargetFluentImpl<io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluent.TargetNested<N>> implements io.kubernetes.client.openapi.models.V2ResourceMetricSourceFluent.TargetNested<N>,io.kubernetes.client.fluent.Nested<N>{
