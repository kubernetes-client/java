...
import java.lang.Object;
  ...
  */
  ...
  public class V1JobFluentImpl<A extends V1JobFluent<A>> extends BaseFluent<A> implements V1JobFluent<A>{
  ...
  public A withStatus(V1JobStatus status) {
    ...
    if (status!=null){ this.status= new V1JobStatusBuilder(status); _visitables.get("status").add(this.status);} else { this.status = null; _visitables.get("status").remove(this.status); } return (A) this;
  }
