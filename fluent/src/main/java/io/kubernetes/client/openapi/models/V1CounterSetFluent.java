...
public class V1CounterSetFluent<A extends io.kubernetes.client.openapi.models.V1CounterSetFluent<A>> extends BaseFluent<A>{

  private Map<String,V1Counter> counters;
  private String name;

  public V1CounterSetFluent() {
  }
  
  public V1CounterSetFluent(V1CounterSet instance) {
  ...
  protected void copyInstance(V1CounterSet instance) {
    instance = instance != null ? instance : new V1CounterSet();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1CounterSetFluent that = (V1CounterSetFluent) o;
