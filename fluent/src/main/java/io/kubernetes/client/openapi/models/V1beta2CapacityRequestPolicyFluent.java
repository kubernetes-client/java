...
public class V1beta2CapacityRequestPolicyFluent<A extends io.kubernetes.client.openapi.models.V1beta2CapacityRequestPolicyFluent<A>> extends BaseFluent<A>{

  private Quantity _default;
  private V1beta2CapacityRequestPolicyRangeBuilder validRange;
  private List<Quantity> validValues;

  public V1beta2CapacityRequestPolicyFluent() {
  }
  
  public V1beta2CapacityRequestPolicyFluent(V1beta2CapacityRequestPolicy instance) {
  ...
  public V1beta2CapacityRequestPolicyRange buildValidRange() {
    return this.validRange != null ? this.validRange.build() : null;
  }
  
  protected void copyInstance(V1beta2CapacityRequestPolicy instance) {
    instance = instance != null ? instance : new V1beta2CapacityRequestPolicy();
    if (instance != null) {
  ...
  public ValidRangeNested<A> editOrNewValidRange() {
    return this.withNewValidRangeLike(Optional.ofNullable(this.buildValidRange()).orElse(new V1beta2CapacityRequestPolicyRangeBuilder().build()));
  }
  
  public ValidRangeNested<A> editOrNewValidRangeLike(V1beta2CapacityRequestPolicyRange item) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2CapacityRequestPolicyFluent that = (V1beta2CapacityRequestPolicyFluent) o;
  ...
  public ValidRangeNested<A> withNewValidRangeLike(V1beta2CapacityRequestPolicyRange item) {
    return new ValidRangeNested(item);
  }
  
  public A withValidRange(V1beta2CapacityRequestPolicyRange validRange) {
    this._visitables.remove("validRange");
    if (validRange != null) {
        this.validRange = new V1beta2CapacityRequestPolicyRangeBuilder(validRange);
  ...
  public class ValidRangeNested<N> extends V1beta2CapacityRequestPolicyRangeFluent<ValidRangeNested<N>> implements Nested<N>{
  
    V1beta2CapacityRequestPolicyRangeBuilder builder;
  
    ValidRangeNested(V1beta2CapacityRequestPolicyRange item) {
      this.builder = new V1beta2CapacityRequestPolicyRangeBuilder(this, item);
    }
  
    public N and() {
      return (N) V1beta2CapacityRequestPolicyFluent.this.withValidRange(builder.build());
    }
