...
public class V2beta2PodsMetricStatusBuilder
    ...
    implements VisitableBuilder<V2beta2PodsMetricStatus, V2beta2PodsMetricStatusBuilder> {
  ...
  public V2beta2PodsMetricStatusBuilder(
      V2beta2PodsMetricStatusFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V2beta2PodsMetricStatus(), validationEnabled);
  }

  public V2beta2PodsMetricStatusBuilder(
      V2beta2PodsMetricStatusFluent<?> fluent, V2beta2PodsMetricStatus instance) {
    this(fluent, instance, false);
  }

  public V2beta2PodsMetricStatusBuilder(
      V2beta2PodsMetricStatusFluent<?> fluent,
      V2beta2PodsMetricStatus instance,
  ...
  public V2beta2PodsMetricStatusBuilder(
      V2beta2PodsMetricStatus instance, Boolean validationEnabled) {
    this.fluent = this;
