...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2MetricIdentifierFluentImpl<A extends io.kubernetes.client.openapi.models.V2MetricIdentifierFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2MetricIdentifierFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V2MetricIdentifierFluent.SelectorNested<A> withNewSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
    return new io.kubernetes.client.openapi.models.V2MetricIdentifierFluentImpl.SelectorNestedImpl(item);
  }
