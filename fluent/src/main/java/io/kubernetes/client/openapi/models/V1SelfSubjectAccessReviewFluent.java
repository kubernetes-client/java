...
public class V1SelfSubjectAccessReviewFluent<A extends io.kubernetes.client.openapi.models.V1SelfSubjectAccessReviewFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V1SelfSubjectAccessReviewSpecBuilder().build()));
  }
