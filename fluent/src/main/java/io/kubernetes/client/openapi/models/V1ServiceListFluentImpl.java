...
import java.lang.Object;
  ...
  */
  ...
  public V1ServiceListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1ServiceListFluentImpl.ItemsNestedImpl();
  }
  public V1ServiceListFluentImpl.ItemsNested<A> addNewItemLike(V1Service item) {
    return new V1ServiceListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1ServiceListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1Service item) {
    return new V1ServiceListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1ServiceListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ServiceListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1ServiceListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ServiceListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1ServiceBuilder> predicate) {
    int index = -1;
  ...
  public V1ServiceListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1ServiceListFluentImpl.MetadataNestedImpl();
  }
  public V1ServiceListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1ServiceListFluentImpl.MetadataNestedImpl(item);
  }
  public V1ServiceListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1ServiceListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1ServiceListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1ServiceFluentImpl<V1ServiceListFluentImpl.ItemsNested<N>> implements V1ServiceListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1Service item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ServiceListFluentImpl.MetadataNested<N>> implements V1ServiceListFluentImpl.MetadataNested<N>,Nested<N>{
