...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1PriorityClass item) {
    ...
    V1PriorityClassBuilder builder = new V1PriorityClassBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1PriorityClassFluentImpl<V1PriorityClassListFluent.ItemsNested<N>> implements V1PriorityClassListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1PriorityClassListFluent.MetadataNested<N>> implements V1PriorityClassListFluent.MetadataNested<N>,Nested<N>{
