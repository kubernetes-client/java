...
public class V1PriorityClassListFluentImpl<A extends V1PriorityClassListFluent<A>>
  ...
  public A addToItems(Integer index, io.kubernetes.client.openapi.models.V1PriorityClass item) {
    if (this.items == null) {
      this.items =
  ...
  public A removeMatchingFromItems(
      Predicate<io.kubernetes.client.openapi.models.V1PriorityClassBuilder> predicate) {
