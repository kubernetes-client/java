...
public class V1PodAffinityFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodAffinityFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodAffinityFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1PodAffinityFluent.PreferredDuringSchedulingIgnoredDuringExecutionNested<A> setNewPreferredDuringSchedulingIgnoredDuringExecutionLike(int index,io.kubernetes.client.openapi.models.V1WeightedPodAffinityTerm item) {
    ...
    public io.kubernetes.client.openapi.models.V1PodAffinityFluent.PreferredDuringSchedulingIgnoredDuringExecutionNested<A> editPreferredDuringSchedulingIgnoredDuringExecution(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1PodAffinityFluent.RequiredDuringSchedulingIgnoredDuringExecutionNested<A> setNewRequiredDuringSchedulingIgnoredDuringExecutionLike(int index,io.kubernetes.client.openapi.models.V1PodAffinityTerm item) {
    ...
    public io.kubernetes.client.openapi.models.V1PodAffinityFluent.RequiredDuringSchedulingIgnoredDuringExecutionNested<A> editRequiredDuringSchedulingIgnoredDuringExecution(int index) {
    ...
    public class PreferredDuringSchedulingIgnoredDuringExecutionNestedImpl<N> extends io.kubernetes.client.openapi.models.V1WeightedPodAffinityTermFluentImpl<io.kubernetes.client.openapi.models.V1PodAffinityFluent.PreferredDuringSchedulingIgnoredDuringExecutionNested<N>> implements io.kubernetes.client.openapi.models.V1PodAffinityFluent.PreferredDuringSchedulingIgnoredDuringExecutionNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1WeightedPodAffinityTermBuilder builder;
        private final int index;

            PreferredDuringSchedulingIgnoredDuringExecutionNestedImpl(int index,io.kubernetes.client.openapi.models.V1WeightedPodAffinityTerm item) {
                this.index = index;
    ...
    public class RequiredDuringSchedulingIgnoredDuringExecutionNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodAffinityTermFluentImpl<io.kubernetes.client.openapi.models.V1PodAffinityFluent.RequiredDuringSchedulingIgnoredDuringExecutionNested<N>> implements io.kubernetes.client.openapi.models.V1PodAffinityFluent.RequiredDuringSchedulingIgnoredDuringExecutionNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            RequiredDuringSchedulingIgnoredDuringExecutionNestedImpl(int index,io.kubernetes.client.openapi.models.V1PodAffinityTerm item) {
                this.index = index;
