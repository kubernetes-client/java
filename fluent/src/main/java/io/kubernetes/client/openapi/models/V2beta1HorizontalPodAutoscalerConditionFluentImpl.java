...
public class V2beta1HorizontalPodAutoscalerConditionFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerConditionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerConditionFluent<A> {
    ...
    public V2beta1HorizontalPodAutoscalerConditionFluentImpl() {
    }

    public V2beta1HorizontalPodAutoscalerConditionFluentImpl(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerCondition instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V2beta1HorizontalPodAutoscalerConditionFluentImpl that = (V2beta1HorizontalPodAutoscalerConditionFluentImpl) o;
