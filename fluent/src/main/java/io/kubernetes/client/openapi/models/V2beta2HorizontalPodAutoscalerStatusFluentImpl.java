...
public class V2beta2HorizontalPodAutoscalerStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent<A>{
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerConditionBuilder> conditions;
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta2MetricStatusBuilder> currentMetrics;
  ...
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition item) {
  ...
  public A setToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerConditionBuilder>();}
  ...
  public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition buildCondition(java.lang.Integer index) {
  ...
  public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition> conditions) {
    ...
    if (conditions != null) {this.conditions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition item) {
  ...
  public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.ConditionsNested<A> editCondition(java.lang.Integer index) {
  ...
  public A addToCurrentMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2MetricStatus item) {
  ...
  public A setToCurrentMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2MetricStatus item) {
    if (this.currentMetrics == null) {this.currentMetrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta2MetricStatusBuilder>();}
  ...
  public io.kubernetes.client.openapi.models.V2beta2MetricStatus buildCurrentMetric(java.lang.Integer index) {
  ...
  public A withCurrentMetrics(java.util.List<io.kubernetes.client.openapi.models.V2beta2MetricStatus> currentMetrics) {
    ...
    if (currentMetrics != null) {this.currentMetrics = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V2beta2MetricStatus item : currentMetrics){this.addToCurrentMetrics(item);}} else { this.currentMetrics = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<A> setNewCurrentMetricLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2MetricStatus item) {
  ...
  public io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<A> editCurrentMetric(java.lang.Integer index) {
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerConditionFluentImpl<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ConditionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition item) {
      this.index = index;
  ...
  public class CurrentMetricsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2MetricStatusFluentImpl<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    CurrentMetricsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2MetricStatus item) {
      this.index = index;
