...
public class V1PersistentVolumeFluentImpl<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PersistentVolumeFluent<A> {
    ...
    public V1PersistentVolumeFluentImpl(io.kubernetes.client.openapi.models.V1PersistentVolume instance) {
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.MetadataNested<A> withNewMetadata() {
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1PersistentVolumeSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1PersistentVolumeSpec item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1PersistentVolumeStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1PersistentVolumeStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.StatusNested<A> withNewStatus() {
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1PersistentVolumeStatus item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeFluentImpl.StatusNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1PersistentVolumeStatusBuilder().build());
    }
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PersistentVolumeStatusFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1PersistentVolumeStatusBuilder builder;
            ...
            StatusNestedImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeStatusBuilder(this, item);
