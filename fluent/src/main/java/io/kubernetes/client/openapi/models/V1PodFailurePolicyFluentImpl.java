...
public class V1PodFailurePolicyFluentImpl<A extends V1PodFailurePolicyFluent<A>>
    extends BaseFluent<A> implements V1PodFailurePolicyFluent<A> {
  ...
  public A addToRules(Integer index, V1PodFailurePolicyRule item) {
    if (this.rules == null) {
      this.rules = new ArrayList<V1PodFailurePolicyRuleBuilder>();
    }
  ...
  class RulesNestedImpl<N>
      extends V1PodFailurePolicyRuleFluentImpl<V1PodFailurePolicyFluent.RulesNested<N>>
      implements V1PodFailurePolicyFluent.RulesNested<N>, Nested<N> {
