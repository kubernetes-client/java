...
public class V1ServiceStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1ServiceStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ServiceStatusFluent<A> {
    ...
    public A addToConditions(int index,io.kubernetes.client.openapi.models.V1Condition item) {
    ...
    public A setToConditions(int index,io.kubernetes.client.openapi.models.V1Condition item) {
        if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ConditionBuilder>();}
    ...
    public io.kubernetes.client.openapi.models.V1Condition buildCondition(int index) {
    ...
    public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1Condition> conditions) {
        ...
        if (conditions != null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ConditionBuilder>(); for (io.kubernetes.client.openapi.models.V1Condition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ServiceStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1Condition item) {
        return new io.kubernetes.client.openapi.models.V1ServiceStatusFluentImpl.ConditionsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1ServiceStatusFluent.ConditionsNested<A> setNewConditionLike(int index,io.kubernetes.client.openapi.models.V1Condition item) {
        return new io.kubernetes.client.openapi.models.V1ServiceStatusFluentImpl.ConditionsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1ServiceStatusFluent.ConditionsNested<A> editCondition(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1ServiceStatusFluent.LoadBalancerNested<A> withNewLoadBalancerLike(io.kubernetes.client.openapi.models.V1LoadBalancerStatus item) {
        return new io.kubernetes.client.openapi.models.V1ServiceStatusFluentImpl.LoadBalancerNestedImpl(item);
    }
    ...
    public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ConditionFluentImpl<io.kubernetes.client.openapi.models.V1ServiceStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ConditionBuilder builder;
        private final int index;

            ConditionsNestedImpl(int index,io.kubernetes.client.openapi.models.V1Condition item) {
                this.index = index;
    ...
    public class LoadBalancerNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluentImpl<io.kubernetes.client.openapi.models.V1ServiceStatusFluent.LoadBalancerNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceStatusFluent.LoadBalancerNested<N>,io.kubernetes.client.fluent.Nested<N> {
