...
public class V1VolumeFluentImpl<A extends io.kubernetes.client.openapi.models.V1VolumeFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1VolumeFluent<A> {
    ...
    private io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSourceBuilder persistentVolumeClaim;
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.AwsElasticBlockStoreNested<A> withNewAwsElasticBlockStore() {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.AwsElasticBlockStoreNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.AwsElasticBlockStoreNested<A> withNewAwsElasticBlockStoreLike(io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.AwsElasticBlockStoreNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.AwsElasticBlockStoreNested<A> editAwsElasticBlockStore() {
        return withNewAwsElasticBlockStoreLike(getAwsElasticBlockStore());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.AwsElasticBlockStoreNested<A> editOrNewAwsElasticBlockStore() {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.AwsElasticBlockStoreNested<A> editOrNewAwsElasticBlockStoreLike(io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.AzureDiskNested<A> withNewAzureDiskLike(io.kubernetes.client.openapi.models.V1AzureDiskVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.AzureDiskNested<A> editOrNewAzureDiskLike(io.kubernetes.client.openapi.models.V1AzureDiskVolumeSource item) {
    ...
    public A withAzureFile(io.kubernetes.client.openapi.models.V1AzureFileVolumeSource azureFile) {
        ...
        if (azureFile!=null){ this.azureFile= new io.kubernetes.client.openapi.models.V1AzureFileVolumeSourceBuilder(azureFile); _visitables.get("azureFile").add(this.azureFile);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.AzureFileNested<A> withNewAzureFileLike(io.kubernetes.client.openapi.models.V1AzureFileVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.AzureFileNested<A> editOrNewAzureFile() {
        return withNewAzureFileLike(getAzureFile() != null ? getAzureFile(): new io.kubernetes.client.openapi.models.V1AzureFileVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.AzureFileNested<A> editOrNewAzureFileLike(io.kubernetes.client.openapi.models.V1AzureFileVolumeSource item) {
    ...
    public A withCephfs(io.kubernetes.client.openapi.models.V1CephFSVolumeSource cephfs) {
        ...
        if (cephfs!=null){ this.cephfs= new io.kubernetes.client.openapi.models.V1CephFSVolumeSourceBuilder(cephfs); _visitables.get("cephfs").add(this.cephfs);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.CephfsNested<A> withNewCephfsLike(io.kubernetes.client.openapi.models.V1CephFSVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.CephfsNested<A> editOrNewCephfs() {
        return withNewCephfsLike(getCephfs() != null ? getCephfs(): new io.kubernetes.client.openapi.models.V1CephFSVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.CephfsNested<A> editOrNewCephfsLike(io.kubernetes.client.openapi.models.V1CephFSVolumeSource item) {
    ...
    public A withCinder(io.kubernetes.client.openapi.models.V1CinderVolumeSource cinder) {
        ...
        if (cinder!=null){ this.cinder= new io.kubernetes.client.openapi.models.V1CinderVolumeSourceBuilder(cinder); _visitables.get("cinder").add(this.cinder);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.CinderNested<A> withNewCinderLike(io.kubernetes.client.openapi.models.V1CinderVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.CinderNested<A> editOrNewCinder() {
        return withNewCinderLike(getCinder() != null ? getCinder(): new io.kubernetes.client.openapi.models.V1CinderVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.CinderNested<A> editOrNewCinderLike(io.kubernetes.client.openapi.models.V1CinderVolumeSource item) {
    ...
    public A withConfigMap(io.kubernetes.client.openapi.models.V1ConfigMapVolumeSource configMap) {
        ...
        if (configMap!=null){ this.configMap= new io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceBuilder(configMap); _visitables.get("configMap").add(this.configMap);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.ConfigMapNested<A> withNewConfigMapLike(io.kubernetes.client.openapi.models.V1ConfigMapVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.ConfigMapNested<A> editOrNewConfigMap() {
        return withNewConfigMapLike(getConfigMap() != null ? getConfigMap(): new io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.ConfigMapNested<A> editOrNewConfigMapLike(io.kubernetes.client.openapi.models.V1ConfigMapVolumeSource item) {
    ...
    public A withCsi(io.kubernetes.client.openapi.models.V1CSIVolumeSource csi) {
        ...
        if (csi!=null){ this.csi= new io.kubernetes.client.openapi.models.V1CSIVolumeSourceBuilder(csi); _visitables.get("csi").add(this.csi);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.CsiNested<A> withNewCsiLike(io.kubernetes.client.openapi.models.V1CSIVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.CsiNested<A> editOrNewCsi() {
        return withNewCsiLike(getCsi() != null ? getCsi(): new io.kubernetes.client.openapi.models.V1CSIVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.CsiNested<A> editOrNewCsiLike(io.kubernetes.client.openapi.models.V1CSIVolumeSource item) {
    ...
    public A withDownwardAPI(io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSource downwardAPI) {
        _visitables.get("downwardAPI").remove(this.downwardAPI);
        if (downwardAPI!=null){ this.downwardAPI= new io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSourceBuilder(downwardAPI); _visitables.get("downwardAPI").add(this.downwardAPI);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.DownwardAPINested<A> withNewDownwardAPI() {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.DownwardAPINestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.DownwardAPINested<A> withNewDownwardAPILike(io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.DownwardAPINested<A> editOrNewDownwardAPI() {
        return withNewDownwardAPILike(getDownwardAPI() != null ? getDownwardAPI(): new io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.DownwardAPINested<A> editOrNewDownwardAPILike(io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSource item) {
    ...
    public A withEmptyDir(io.kubernetes.client.openapi.models.V1EmptyDirVolumeSource emptyDir) {
        ...
        if (emptyDir!=null){ this.emptyDir= new io.kubernetes.client.openapi.models.V1EmptyDirVolumeSourceBuilder(emptyDir); _visitables.get("emptyDir").add(this.emptyDir);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.EmptyDirNested<A> withNewEmptyDirLike(io.kubernetes.client.openapi.models.V1EmptyDirVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.EmptyDirNested<A> editOrNewEmptyDir() {
        return withNewEmptyDirLike(getEmptyDir() != null ? getEmptyDir(): new io.kubernetes.client.openapi.models.V1EmptyDirVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.EmptyDirNested<A> editOrNewEmptyDirLike(io.kubernetes.client.openapi.models.V1EmptyDirVolumeSource item) {
    ...
    public A withEphemeral(io.kubernetes.client.openapi.models.V1EphemeralVolumeSource ephemeral) {
        ...
        if (ephemeral!=null){ this.ephemeral= new io.kubernetes.client.openapi.models.V1EphemeralVolumeSourceBuilder(ephemeral); _visitables.get("ephemeral").add(this.ephemeral);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.EphemeralNested<A> withNewEphemeralLike(io.kubernetes.client.openapi.models.V1EphemeralVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.EphemeralNested<A> editOrNewEphemeral() {
        return withNewEphemeralLike(getEphemeral() != null ? getEphemeral(): new io.kubernetes.client.openapi.models.V1EphemeralVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.EphemeralNested<A> editOrNewEphemeralLike(io.kubernetes.client.openapi.models.V1EphemeralVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.FcNested<A> withNewFcLike(io.kubernetes.client.openapi.models.V1FCVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.FcNested<A> editOrNewFcLike(io.kubernetes.client.openapi.models.V1FCVolumeSource item) {
    ...
    public A withFlexVolume(io.kubernetes.client.openapi.models.V1FlexVolumeSource flexVolume) {
        ...
        if (flexVolume!=null){ this.flexVolume= new io.kubernetes.client.openapi.models.V1FlexVolumeSourceBuilder(flexVolume); _visitables.get("flexVolume").add(this.flexVolume);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.FlexVolumeNested<A> withNewFlexVolumeLike(io.kubernetes.client.openapi.models.V1FlexVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.FlexVolumeNested<A> editOrNewFlexVolume() {
        return withNewFlexVolumeLike(getFlexVolume() != null ? getFlexVolume(): new io.kubernetes.client.openapi.models.V1FlexVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.FlexVolumeNested<A> editOrNewFlexVolumeLike(io.kubernetes.client.openapi.models.V1FlexVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.FlockerNested<A> withNewFlockerLike(io.kubernetes.client.openapi.models.V1FlockerVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.FlockerNested<A> editOrNewFlockerLike(io.kubernetes.client.openapi.models.V1FlockerVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.GcePersistentDiskNested<A> withNewGcePersistentDisk() {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.GcePersistentDiskNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.GcePersistentDiskNested<A> withNewGcePersistentDiskLike(io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.GcePersistentDiskNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.GcePersistentDiskNested<A> editGcePersistentDisk() {
        return withNewGcePersistentDiskLike(getGcePersistentDisk());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.GcePersistentDiskNested<A> editOrNewGcePersistentDisk() {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.GcePersistentDiskNested<A> editOrNewGcePersistentDiskLike(io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSource item) {
    ...
    public A withGitRepo(io.kubernetes.client.openapi.models.V1GitRepoVolumeSource gitRepo) {
        ...
        if (gitRepo!=null){ this.gitRepo= new io.kubernetes.client.openapi.models.V1GitRepoVolumeSourceBuilder(gitRepo); _visitables.get("gitRepo").add(this.gitRepo);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.GitRepoNested<A> withNewGitRepoLike(io.kubernetes.client.openapi.models.V1GitRepoVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.GitRepoNested<A> editOrNewGitRepo() {
        return withNewGitRepoLike(getGitRepo() != null ? getGitRepo(): new io.kubernetes.client.openapi.models.V1GitRepoVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.GitRepoNested<A> editOrNewGitRepoLike(io.kubernetes.client.openapi.models.V1GitRepoVolumeSource item) {
    ...
    public A withGlusterfs(io.kubernetes.client.openapi.models.V1GlusterfsVolumeSource glusterfs) {
        ...
        if (glusterfs!=null){ this.glusterfs= new io.kubernetes.client.openapi.models.V1GlusterfsVolumeSourceBuilder(glusterfs); _visitables.get("glusterfs").add(this.glusterfs);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.GlusterfsNested<A> withNewGlusterfsLike(io.kubernetes.client.openapi.models.V1GlusterfsVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.GlusterfsNested<A> editOrNewGlusterfs() {
        return withNewGlusterfsLike(getGlusterfs() != null ? getGlusterfs(): new io.kubernetes.client.openapi.models.V1GlusterfsVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.GlusterfsNested<A> editOrNewGlusterfsLike(io.kubernetes.client.openapi.models.V1GlusterfsVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.HostPathNested<A> withNewHostPathLike(io.kubernetes.client.openapi.models.V1HostPathVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.HostPathNested<A> editOrNewHostPathLike(io.kubernetes.client.openapi.models.V1HostPathVolumeSource item) {
    ...
    public A withIscsi(io.kubernetes.client.openapi.models.V1ISCSIVolumeSource iscsi) {
        ...
        if (iscsi!=null){ this.iscsi= new io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceBuilder(iscsi); _visitables.get("iscsi").add(this.iscsi);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.IscsiNested<A> withNewIscsiLike(io.kubernetes.client.openapi.models.V1ISCSIVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.IscsiNested<A> editOrNewIscsi() {
        return withNewIscsiLike(getIscsi() != null ? getIscsi(): new io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.IscsiNested<A> editOrNewIscsiLike(io.kubernetes.client.openapi.models.V1ISCSIVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.NfsNested<A> withNewNfsLike(io.kubernetes.client.openapi.models.V1NFSVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.NfsNested<A> editOrNewNfsLike(io.kubernetes.client.openapi.models.V1NFSVolumeSource item) {
     ...
     * @return The buildable object.
     */
        public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSource getPersistentVolumeClaim() {
        return this.persistentVolumeClaim!=null?this.persistentVolumeClaim.build():null;
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSource buildPersistentVolumeClaim() {
        return this.persistentVolumeClaim!=null?this.persistentVolumeClaim.build():null;
    }

    public A withPersistentVolumeClaim(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSource persistentVolumeClaim) {
        _visitables.get("persistentVolumeClaim").remove(this.persistentVolumeClaim);
        if (persistentVolumeClaim!=null){ this.persistentVolumeClaim= new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSourceBuilder(persistentVolumeClaim); _visitables.get("persistentVolumeClaim").add(this.persistentVolumeClaim);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.PersistentVolumeClaimNested<A> withNewPersistentVolumeClaim() {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.PersistentVolumeClaimNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PersistentVolumeClaimNested<A> withNewPersistentVolumeClaimLike(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.PersistentVolumeClaimNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PersistentVolumeClaimNested<A> editPersistentVolumeClaim() {
        return withNewPersistentVolumeClaimLike(getPersistentVolumeClaim());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PersistentVolumeClaimNested<A> editOrNewPersistentVolumeClaim() {
        return withNewPersistentVolumeClaimLike(getPersistentVolumeClaim() != null ? getPersistentVolumeClaim(): new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PersistentVolumeClaimNested<A> editOrNewPersistentVolumeClaimLike(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.PhotonPersistentDiskNested<A> withNewPhotonPersistentDisk() {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.PhotonPersistentDiskNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PhotonPersistentDiskNested<A> withNewPhotonPersistentDiskLike(io.kubernetes.client.openapi.models.V1PhotonPersistentDiskVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.PhotonPersistentDiskNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PhotonPersistentDiskNested<A> editPhotonPersistentDisk() {
        return withNewPhotonPersistentDiskLike(getPhotonPersistentDisk());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PhotonPersistentDiskNested<A> editOrNewPhotonPersistentDisk() {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.PhotonPersistentDiskNested<A> editOrNewPhotonPersistentDiskLike(io.kubernetes.client.openapi.models.V1PhotonPersistentDiskVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.PortworxVolumeNested<A> withNewPortworxVolume() {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.PortworxVolumeNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PortworxVolumeNested<A> withNewPortworxVolumeLike(io.kubernetes.client.openapi.models.V1PortworxVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.PortworxVolumeNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PortworxVolumeNested<A> editPortworxVolume() {
        return withNewPortworxVolumeLike(getPortworxVolume());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.PortworxVolumeNested<A> editOrNewPortworxVolume() {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.PortworxVolumeNested<A> editOrNewPortworxVolumeLike(io.kubernetes.client.openapi.models.V1PortworxVolumeSource item) {
    ...
    public A withProjected(io.kubernetes.client.openapi.models.V1ProjectedVolumeSource projected) {
        ...
        if (projected!=null){ this.projected= new io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceBuilder(projected); _visitables.get("projected").add(this.projected);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.ProjectedNested<A> withNewProjectedLike(io.kubernetes.client.openapi.models.V1ProjectedVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.ProjectedNested<A> editOrNewProjected() {
        return withNewProjectedLike(getProjected() != null ? getProjected(): new io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.ProjectedNested<A> editOrNewProjectedLike(io.kubernetes.client.openapi.models.V1ProjectedVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.QuobyteNested<A> withNewQuobyteLike(io.kubernetes.client.openapi.models.V1QuobyteVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.QuobyteNested<A> editOrNewQuobyteLike(io.kubernetes.client.openapi.models.V1QuobyteVolumeSource item) {
    ...
    public A withRbd(io.kubernetes.client.openapi.models.V1RBDVolumeSource rbd) {
        ...
        if (rbd!=null){ this.rbd= new io.kubernetes.client.openapi.models.V1RBDVolumeSourceBuilder(rbd); _visitables.get("rbd").add(this.rbd);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.RbdNested<A> withNewRbdLike(io.kubernetes.client.openapi.models.V1RBDVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.RbdNested<A> editOrNewRbd() {
        return withNewRbdLike(getRbd() != null ? getRbd(): new io.kubernetes.client.openapi.models.V1RBDVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.RbdNested<A> editOrNewRbdLike(io.kubernetes.client.openapi.models.V1RBDVolumeSource item) {
    ...
    public A withScaleIO(io.kubernetes.client.openapi.models.V1ScaleIOVolumeSource scaleIO) {
        ...
        if (scaleIO!=null){ this.scaleIO= new io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceBuilder(scaleIO); _visitables.get("scaleIO").add(this.scaleIO);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.ScaleIONested<A> withNewScaleIOLike(io.kubernetes.client.openapi.models.V1ScaleIOVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.ScaleIONested<A> editOrNewScaleIO() {
        return withNewScaleIOLike(getScaleIO() != null ? getScaleIO(): new io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.ScaleIONested<A> editOrNewScaleIOLike(io.kubernetes.client.openapi.models.V1ScaleIOVolumeSource item) {
    ...
    public A withSecret(io.kubernetes.client.openapi.models.V1SecretVolumeSource secret) {
        ...
        if (secret!=null){ this.secret= new io.kubernetes.client.openapi.models.V1SecretVolumeSourceBuilder(secret); _visitables.get("secret").add(this.secret);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.SecretNested<A> withNewSecretLike(io.kubernetes.client.openapi.models.V1SecretVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.SecretNested<A> editOrNewSecret() {
        return withNewSecretLike(getSecret() != null ? getSecret(): new io.kubernetes.client.openapi.models.V1SecretVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.SecretNested<A> editOrNewSecretLike(io.kubernetes.client.openapi.models.V1SecretVolumeSource item) {
    ...
    public A withStorageos(io.kubernetes.client.openapi.models.V1StorageOSVolumeSource storageos) {
        ...
        if (storageos!=null){ this.storageos= new io.kubernetes.client.openapi.models.V1StorageOSVolumeSourceBuilder(storageos); _visitables.get("storageos").add(this.storageos);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.StorageosNested<A> withNewStorageosLike(io.kubernetes.client.openapi.models.V1StorageOSVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.StorageosNested<A> editOrNewStorageos() {
        return withNewStorageosLike(getStorageos() != null ? getStorageos(): new io.kubernetes.client.openapi.models.V1StorageOSVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.StorageosNested<A> editOrNewStorageosLike(io.kubernetes.client.openapi.models.V1StorageOSVolumeSource item) {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.VsphereVolumeNested<A> withNewVsphereVolume() {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.VsphereVolumeNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.VsphereVolumeNested<A> withNewVsphereVolumeLike(io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1VolumeFluentImpl.VsphereVolumeNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.VsphereVolumeNested<A> editVsphereVolume() {
        return withNewVsphereVolumeLike(getVsphereVolume());
    }

    public io.kubernetes.client.openapi.models.V1VolumeFluent.VsphereVolumeNested<A> editOrNewVsphereVolume() {
    ...
    public io.kubernetes.client.openapi.models.V1VolumeFluent.VsphereVolumeNested<A> editOrNewVsphereVolumeLike(io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSource item) {
    ...
    public class AzureDiskNestedImpl<N> extends io.kubernetes.client.openapi.models.V1AzureDiskVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.AzureDiskNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.AzureDiskNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class AzureFileNestedImpl<N> extends io.kubernetes.client.openapi.models.V1AzureFileVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.AzureFileNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.AzureFileNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1AzureFileVolumeSourceBuilder builder;
            ...
            AzureFileNestedImpl(io.kubernetes.client.openapi.models.V1AzureFileVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1AzureFileVolumeSourceBuilder(this, item);
    ...
    public class CephfsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CephFSVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.CephfsNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.CephfsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CephFSVolumeSourceBuilder builder;
            ...
            CephfsNestedImpl(io.kubernetes.client.openapi.models.V1CephFSVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CephFSVolumeSourceBuilder(this, item);
    ...
    public class CinderNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CinderVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.CinderNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.CinderNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CinderVolumeSourceBuilder builder;

            CinderNestedImpl(io.kubernetes.client.openapi.models.V1CinderVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CinderVolumeSourceBuilder(this, item);
    ...
    public class ConfigMapNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.ConfigMapNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.ConfigMapNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceBuilder builder;

            ConfigMapNestedImpl(io.kubernetes.client.openapi.models.V1ConfigMapVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceBuilder(this, item);
    ...
    public class CsiNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CSIVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.CsiNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.CsiNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CSIVolumeSourceBuilder builder;
    ...
    public class DownwardAPINestedImpl<N> extends io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.DownwardAPINested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.DownwardAPINested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSourceBuilder builder;

            DownwardAPINestedImpl(io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1DownwardAPIVolumeSourceBuilder(this, item);
    ...
    public class EmptyDirNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EmptyDirVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.EmptyDirNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.EmptyDirNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1EmptyDirVolumeSourceBuilder builder;
            ...
            EmptyDirNestedImpl(io.kubernetes.client.openapi.models.V1EmptyDirVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1EmptyDirVolumeSourceBuilder(this, item);
    ...
    public class EphemeralNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EphemeralVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.EphemeralNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.EphemeralNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1EphemeralVolumeSourceBuilder builder;

            EphemeralNestedImpl(io.kubernetes.client.openapi.models.V1EphemeralVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1EphemeralVolumeSourceBuilder(this, item);
    ...
    public class FcNestedImpl<N> extends io.kubernetes.client.openapi.models.V1FCVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.FcNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.FcNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class FlexVolumeNestedImpl<N> extends io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.FlexVolumeNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.FlexVolumeNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class FlockerNestedImpl<N> extends io.kubernetes.client.openapi.models.V1FlockerVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.FlockerNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.FlockerNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class GitRepoNestedImpl<N> extends io.kubernetes.client.openapi.models.V1GitRepoVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.GitRepoNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.GitRepoNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1GitRepoVolumeSourceBuilder builder;

            GitRepoNestedImpl(io.kubernetes.client.openapi.models.V1GitRepoVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1GitRepoVolumeSourceBuilder(this, item);
    ...
    public class GlusterfsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1GlusterfsVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.GlusterfsNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.GlusterfsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1GlusterfsVolumeSourceBuilder builder;

            GlusterfsNestedImpl(io.kubernetes.client.openapi.models.V1GlusterfsVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1GlusterfsVolumeSourceBuilder(this, item);
    ...
    public class HostPathNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HostPathVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.HostPathNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.HostPathNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class IscsiNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.IscsiNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.IscsiNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ISCSIVolumeSourceBuilder builder;
    ...
    public class NfsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1NFSVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.NfsNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.NfsNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class PersistentVolumeClaimNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.PersistentVolumeClaimNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.PersistentVolumeClaimNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSourceBuilder builder;

            PersistentVolumeClaimNestedImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSourceBuilder(this, item);
                        
            }

            PersistentVolumeClaimNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimVolumeSourceBuilder(this);
    ...
    public class ProjectedNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.ProjectedNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.ProjectedNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceBuilder builder;

            ProjectedNestedImpl(io.kubernetes.client.openapi.models.V1ProjectedVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceBuilder(this, item);
    ...
    public class QuobyteNestedImpl<N> extends io.kubernetes.client.openapi.models.V1QuobyteVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.QuobyteNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.QuobyteNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class RbdNestedImpl<N> extends io.kubernetes.client.openapi.models.V1RBDVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.RbdNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.RbdNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1RBDVolumeSourceBuilder builder;
    ...
    public class ScaleIONestedImpl<N> extends io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.ScaleIONested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.ScaleIONested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceBuilder builder;
            ...
            ScaleIONestedImpl(io.kubernetes.client.openapi.models.V1ScaleIOVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceBuilder(this, item);
    ...
    public class SecretNestedImpl<N> extends io.kubernetes.client.openapi.models.V1SecretVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.SecretNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.SecretNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1SecretVolumeSourceBuilder builder;

            SecretNestedImpl(io.kubernetes.client.openapi.models.V1SecretVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1SecretVolumeSourceBuilder(this, item);
    ...
    public class StorageosNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StorageOSVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1VolumeFluent.StorageosNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeFluent.StorageosNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1StorageOSVolumeSourceBuilder builder;

            StorageosNestedImpl(io.kubernetes.client.openapi.models.V1StorageOSVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1StorageOSVolumeSourceBuilder(this, item);
