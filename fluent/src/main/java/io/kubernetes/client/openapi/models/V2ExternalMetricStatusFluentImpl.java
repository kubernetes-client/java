...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2ExternalMetricStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent<A>{
  public V2ExternalMetricStatusFluentImpl() {
  }
  public V2ExternalMetricStatusFluentImpl(io.kubernetes.client.openapi.models.V2ExternalMetricStatus instance) {
  ...
  public io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.CurrentNested<A> withNewCurrent() {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluentImpl.CurrentNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.CurrentNested<A> withNewCurrentLike(io.kubernetes.client.openapi.models.V2MetricValueStatus item) {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluentImpl.CurrentNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.MetricNested<A> withNewMetric() {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluentImpl.MetricNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.MetricNested<A> withNewMetricLike(io.kubernetes.client.openapi.models.V2MetricIdentifier item) {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluentImpl.MetricNestedImpl(item);
  }
  ...
  public class CurrentNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricValueStatusFluentImpl<io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.CurrentNested<N>> implements io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.CurrentNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class MetricNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricIdentifierFluentImpl<io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.MetricNested<N>> implements io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent.MetricNested<N>,io.kubernetes.client.fluent.Nested<N>{
