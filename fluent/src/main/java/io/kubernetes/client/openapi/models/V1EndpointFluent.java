...
import java.util.Map;
  ...
  * Generated
  */
public interface V1EndpointFluent<A extends io.kubernetes.client.openapi.models.V1EndpointFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface HintsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1EndpointHintsFluent<io.kubernetes.client.openapi.models.V1EndpointFluent.HintsNested<N>>{
    public N and();
    public N endHints();
    
  }
  public interface TargetRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectReferenceFluent<io.kubernetes.client.openapi.models.V1EndpointFluent.TargetRefNested<N>>{
    public N and();
