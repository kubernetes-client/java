...
public interface V2beta2HorizontalPodAutoscalerFluent<A extends io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerFluent.SpecNested<N>> {

            public N and();
            public N endSpec();    }


    public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatusFluent<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerFluent.StatusNested<N>> {
