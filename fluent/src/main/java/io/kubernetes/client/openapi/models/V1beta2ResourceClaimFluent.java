...
public class V1beta2ResourceClaimFluent<A extends io.kubernetes.client.openapi.models.V1beta2ResourceClaimFluent<A>> extends BaseFluent<A>{
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V1beta2ResourceClaimStatusBuilder().build()));
  }
