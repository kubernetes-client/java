...
import java.util.function.Predicate;
  ...
  */
  ...
  public class V1beta3ResourcePolicyRuleFluentImpl<A extends V1beta3ResourcePolicyRuleFluent<A>> extends BaseFluent<A> implements V1beta3ResourcePolicyRuleFluent<A>{
  public V1beta3ResourcePolicyRuleFluentImpl() {
  }
  public V1beta3ResourcePolicyRuleFluentImpl(V1beta3ResourcePolicyRule instance) {
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta3ResourcePolicyRuleFluentImpl that = (V1beta3ResourcePolicyRuleFluentImpl) o;
