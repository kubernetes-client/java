...
public class V1beta1VolumeAttachmentSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluent<A> {

    private java.lang.String attacher;
    private java.lang.String nodeName;
    private io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSourceBuilder source;

    public V1beta1VolumeAttachmentSpecFluentImpl() {
    }

    public V1beta1VolumeAttachmentSpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpec instance) {
    ...
    public A withSource(io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSource source) {
        ...
        if (source!=null){ this.source= new io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSourceBuilder(source); _visitables.get("source").add(this.source);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluent.SourceNested<A> withNewSource() {
        return new io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluentImpl.SourceNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluent.SourceNested<A> withNewSourceLike(io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSource item) {
        return new io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluentImpl.SourceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluent.SourceNested<A> editOrNewSource() {
        return withNewSourceLike(getSource() != null ? getSource(): new io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSourceBuilder().build());
    }
    ...
    public class SourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSourceFluentImpl<io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluent.SourceNested<N>> implements io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSpecFluent.SourceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSourceBuilder builder;

            SourceNestedImpl(io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSourceBuilder(this, item);
                        
            }

            SourceNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1beta1VolumeAttachmentSourceBuilder(this);
