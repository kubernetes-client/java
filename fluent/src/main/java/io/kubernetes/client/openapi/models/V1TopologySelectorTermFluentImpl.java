...
import java.lang.Boolean;
  ...
  */
  ...
  public V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<A> addNewMatchLabelExpression() {
    return new V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNestedImpl();
  }
  public V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<A> addNewMatchLabelExpressionLike(V1TopologySelectorLabelRequirement item) {
    return new V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNestedImpl(-1, item);
  }
  public V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<A> setNewMatchLabelExpressionLike(int index,V1TopologySelectorLabelRequirement item) {
    return new V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNestedImpl(index, item);
  }
  public V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<A> editMatchLabelExpression(int index) {
  ...
  public V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<A> editFirstMatchLabelExpression() {
  ...
  public V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<A> editLastMatchLabelExpression() {
  ...
  public V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<A> editMatchingMatchLabelExpression(Predicate<V1TopologySelectorLabelRequirementBuilder> predicate) {
    int index = -1;
  ...
  public String toString() {
    ...
    sb.append("{");
    if (matchLabelExpressions != null) { sb.append("matchLabelExpressions:"); sb.append(matchLabelExpressions); }
    sb.append("}");
    return sb.toString();
  }
  class MatchLabelExpressionsNestedImpl<N> extends V1TopologySelectorLabelRequirementFluentImpl<V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<N>> implements V1TopologySelectorTermFluentImpl.MatchLabelExpressionsNested<N>,Nested<N>{
