...
public class V1beta1ExpressionWarningFluent<A extends V1beta1ExpressionWarningFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta1ExpressionWarningFluent(V1beta1ExpressionWarning instance) {
    this.copyInstance(instance);
  }
  private String fieldRef;
  private String warning;
  
  protected void copyInstance(V1beta1ExpressionWarning instance) {
    instance = (instance != null ? instance : new V1beta1ExpressionWarning());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1ExpressionWarningFluent that = (V1beta1ExpressionWarningFluent) o;
