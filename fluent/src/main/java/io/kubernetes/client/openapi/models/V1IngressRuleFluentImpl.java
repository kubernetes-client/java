...
public class V1IngressRuleFluentImpl<A extends io.kubernetes.client.openapi.models.V1IngressRuleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1IngressRuleFluent<A> {
    ...
    public A withHttp(io.kubernetes.client.openapi.models.V1HTTPIngressRuleValue http) {
        ...
        if (http!=null){ this.http= new io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueBuilder(http); _visitables.get("http").add(this.http);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1IngressRuleFluent.HttpNested<A> editOrNewHttp() {
        return withNewHttpLike(getHttp() != null ? getHttp(): new io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueBuilder().build());
    }
    ...
    public class HttpNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluentImpl<io.kubernetes.client.openapi.models.V1IngressRuleFluent.HttpNested<N>> implements io.kubernetes.client.openapi.models.V1IngressRuleFluent.HttpNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueBuilder builder;

            HttpNestedImpl(io.kubernetes.client.openapi.models.V1HTTPIngressRuleValue item) {
                this.builder = new io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueBuilder(this, item);
