...
public class V1alpha1ClusterRoleBindingListFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingListFluent<A> {
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBinding> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingBuilder>(); for (io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBinding item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingFluentImpl<io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBindingBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1alpha1ClusterRoleBinding item) {
                this.index = index;
