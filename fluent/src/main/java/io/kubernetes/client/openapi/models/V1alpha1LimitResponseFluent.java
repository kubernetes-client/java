...
public interface V1alpha1LimitResponseFluent<A extends io.kubernetes.client.openapi.models.V1alpha1LimitResponseFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface QueuingNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1alpha1QueuingConfigurationFluent<io.kubernetes.client.openapi.models.V1alpha1LimitResponseFluent.QueuingNested<N>> {
