...
public class V1MutatingWebhookFluentImpl<A extends io.kubernetes.client.openapi.models.V1MutatingWebhookFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1MutatingWebhookFluent<A>{
  ...
  public A withAdmissionReviewVersions(java.util.List<java.lang.String> admissionReviewVersions) {
    if (admissionReviewVersions != null) {this.admissionReviewVersions = new java.util.ArrayList(); for (java.lang.String item : admissionReviewVersions){this.addToAdmissionReviewVersions(item);}} else { this.admissionReviewVersions = null;} return (A) this;
  }
  ...
  public A withRules(java.util.List<io.kubernetes.client.openapi.models.V1RuleWithOperations> rules) {
    ...
    if (rules != null) {this.rules = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1RuleWithOperations item : rules){this.addToRules(item);}} else { this.rules = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<A> setNewRuleLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1RuleWithOperations item) {
    return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.RulesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<A> editRule(java.lang.Integer index) {
  ...
  public class RulesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1RuleWithOperationsFluentImpl<io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    RulesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1RuleWithOperations item) {
      this.index = index;
