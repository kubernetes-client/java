...
public class V1MutatingWebhookFluentImpl<A extends io.kubernetes.client.openapi.models.V1MutatingWebhookFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1MutatingWebhookFluent<A> {

    private java.util.List<java.lang.String> admissionReviewVersions;
    private io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigBuilder clientConfig;
    ...
    public V1MutatingWebhookFluentImpl(io.kubernetes.client.openapi.models.V1MutatingWebhook instance) {
    ...
    public A withClientConfig(io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfig clientConfig) {
        ...
        if (clientConfig!=null){ this.clientConfig= new io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigBuilder(clientConfig); _visitables.get("clientConfig").add(this.clientConfig);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ClientConfigNested<A> withNewClientConfig() {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.ClientConfigNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ClientConfigNested<A> withNewClientConfigLike(io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfig item) {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.ClientConfigNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ClientConfigNested<A> editClientConfig() {
        return withNewClientConfigLike(getClientConfig());
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ClientConfigNested<A> editOrNewClientConfig() {
        return withNewClientConfigLike(getClientConfig() != null ? getClientConfig(): new io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ClientConfigNested<A> editOrNewClientConfigLike(io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfig item) {
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.NamespaceSelectorNested<A> withNewNamespaceSelector() {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.NamespaceSelectorNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.NamespaceSelectorNested<A> withNewNamespaceSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.NamespaceSelectorNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.NamespaceSelectorNested<A> editNamespaceSelector() {
        return withNewNamespaceSelectorLike(getNamespaceSelector());
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.NamespaceSelectorNested<A> editOrNewNamespaceSelector() {
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.NamespaceSelectorNested<A> editOrNewNamespaceSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ObjectSelectorNested<A> withNewObjectSelector() {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.ObjectSelectorNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ObjectSelectorNested<A> withNewObjectSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.ObjectSelectorNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ObjectSelectorNested<A> editObjectSelector() {
        return withNewObjectSelectorLike(getObjectSelector());
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ObjectSelectorNested<A> editOrNewObjectSelector() {
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ObjectSelectorNested<A> editOrNewObjectSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
    ...
    public A addToRules(int index,io.kubernetes.client.openapi.models.V1RuleWithOperations item) {
        if (this.rules == null) {this.rules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder>();}
        io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder builder = new io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder(item);_visitables.get("rules").add(index >= 0 ? index : _visitables.get("rules").size(), builder);this.rules.add(index >= 0 ? index : rules.size(), builder); return (A)this;
    }

    public A setToRules(int index,io.kubernetes.client.openapi.models.V1RuleWithOperations item) {
        if (this.rules == null) {this.rules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder>();}
        io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder builder = new io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder(item);
    ...
    public A addToRules(io.kubernetes.client.openapi.models.V1RuleWithOperations... items) {
        if (this.rules == null) {this.rules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder>();}
        for (io.kubernetes.client.openapi.models.V1RuleWithOperations item : items) {io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder builder = new io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder(item);_visitables.get("rules").add(builder);this.rules.add(builder);} return (A)this;
    }
    ...
    public A removeMatchingFromRules(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder> each = rules.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1RuleWithOperations buildRule(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1RuleWithOperations buildMatchingRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder item: rules) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder item: rules) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withRules(java.util.List<io.kubernetes.client.openapi.models.V1RuleWithOperations> rules) {
        ...
        if (rules != null) {this.rules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder>(); for (io.kubernetes.client.openapi.models.V1RuleWithOperations item : rules){this.addToRules(item);}} else { this.rules = null;} return (A) this;
    }

    public A withRules(io.kubernetes.client.openapi.models.V1RuleWithOperations... rules) {
        if (this.rules != null) {this.rules.clear();}
        if (rules != null) {for (io.kubernetes.client.openapi.models.V1RuleWithOperations item :rules){ this.addToRules(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<A> addNewRuleLike(io.kubernetes.client.openapi.models.V1RuleWithOperations item) {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.RulesNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<A> setNewRuleLike(int index,io.kubernetes.client.openapi.models.V1RuleWithOperations item) {
        return new io.kubernetes.client.openapi.models.V1MutatingWebhookFluentImpl.RulesNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<A> editRule(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<A> editMatchingRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder> predicate) {
        int index = -1;
    ...
    public class ClientConfigNestedImpl<N> extends io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigFluentImpl<io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ClientConfigNested<N>> implements io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.ClientConfigNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigBuilder builder;

            ClientConfigNestedImpl(io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfig item) {
                this.builder = new io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigBuilder(this, item);
                        
            }

            ClientConfigNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigBuilder(this);
    ...
    public class RulesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1RuleWithOperationsFluentImpl<io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1MutatingWebhookFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder builder;
        private final int index;

            RulesNestedImpl(int index,io.kubernetes.client.openapi.models.V1RuleWithOperations item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1RuleWithOperationsBuilder(this, item);
