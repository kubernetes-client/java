...
public class V1ResourceClaimStatusFluent<A extends io.kubernetes.client.openapi.models.V1ResourceClaimStatusFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(V1ResourceClaimStatus instance) {
    instance = instance != null ? instance : new V1ResourceClaimStatus();
    if (instance != null) {
  ...
  public V1AllocatedDeviceStatus buildMatchingDevice(Predicate<V1AllocatedDeviceStatusBuilder> predicate) {
      for (V1AllocatedDeviceStatusBuilder item : devices) {
  ...
  public V1ResourceClaimConsumerReference buildMatchingReservedFor(Predicate<V1ResourceClaimConsumerReferenceBuilder> predicate) {
      for (V1ResourceClaimConsumerReferenceBuilder item : reservedFor) {
        if (predicate.test(item)) {
          return item.build();
        }
      }
  ...
  public class AllocationNested<N> extends V1AllocationResultFluent<AllocationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ResourceClaimStatusFluent.this.withAllocation(builder.build());
    }
  ...
  public class DevicesNested<N> extends V1AllocatedDeviceStatusFluent<DevicesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ResourceClaimStatusFluent.this.setToDevices(index, builder.build());
    }
  ...
  public class ReservedForNested<N> extends V1ResourceClaimConsumerReferenceFluent<ReservedForNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ResourceClaimStatusFluent.this.setToReservedFor(index, builder.build());
    }
