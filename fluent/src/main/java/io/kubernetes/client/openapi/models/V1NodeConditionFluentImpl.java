...
public class V1NodeConditionFluentImpl<A extends io.kubernetes.client.openapi.models.V1NodeConditionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1NodeConditionFluent<A> {
    ...
    public int hashCode() {
        return java.util.Objects.hash(lastHeartbeatTime,  lastTransitionTime,  message,  reason,  status,  type,  super.hashCode());
    }
