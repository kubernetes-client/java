...
public class V1alpha1ValidatingAdmissionPolicySpecFluent<A extends V1alpha1ValidatingAdmissionPolicySpecFluent<A>> extends BaseFluent<A>{
  ...
  public AuditAnnotationsNested<A> addNewAuditAnnotationLike(V1alpha1AuditAnnotation item) {
    return new AuditAnnotationsNested(-1, item);
  }
  
  public AuditAnnotationsNested<A> setNewAuditAnnotationLike(int index,V1alpha1AuditAnnotation item) {
  ...
  public AuditAnnotationsNested<A> editMatchingAuditAnnotation(Predicate<V1alpha1AuditAnnotationBuilder> predicate) {
    int index = -1;
  ...
  public A withMatchConstraints(V1alpha1MatchResources matchConstraints) {
    this._visitables.remove(this.matchConstraints);
  ...
  public A withParamKind(V1alpha1ParamKind paramKind) {
    this._visitables.remove(this.paramKind);
    if (paramKind != null) {
  ...
  public ValidationsNested<A> addNewValidationLike(V1alpha1Validation item) {
    return new ValidationsNested(-1, item);
  }
  
  public ValidationsNested<A> setNewValidationLike(int index,V1alpha1Validation item) {
  ...
  public ValidationsNested<A> editMatchingValidation(Predicate<V1alpha1ValidationBuilder> predicate) {
    int index = -1;
  ...
  public A withVariables(io.kubernetes.client.openapi.models.V1alpha1Variable... variables) {
    ...
    if (variables != null) {for (V1alpha1Variable item :variables){ this.addToVariables(item);}} return (A) this;
  }
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ValidatingAdmissionPolicySpecFluent that = (V1alpha1ValidatingAdmissionPolicySpecFluent) o;
  ...
  public class AuditAnnotationsNested<N> extends V1alpha1AuditAnnotationFluent<AuditAnnotationsNested<N>> implements Nested<N>{
  ...
  public class ValidationsNested<N> extends V1alpha1ValidationFluent<ValidationsNested<N>> implements Nested<N>{
