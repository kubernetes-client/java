...
public class V1beta1PodCertificateRequestStatusFluent<A extends io.kubernetes.client.openapi.models.V1beta1PodCertificateRequestStatusFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta1PodCertificateRequestStatusFluent() {
  }
  
  public V1beta1PodCertificateRequestStatusFluent(V1beta1PodCertificateRequestStatus instance) {
  ...
  protected void copyInstance(V1beta1PodCertificateRequestStatus instance) {
    instance = instance != null ? instance : new V1beta1PodCertificateRequestStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1PodCertificateRequestStatusFluent that = (V1beta1PodCertificateRequestStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta1PodCertificateRequestStatusFluent.this.setToConditions(index, builder.build());
    }
