...
import java.lang.Object;
  ...
  */
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1VolumeAttachmentFluent.MetadataNested<N>> implements V1VolumeAttachmentFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1VolumeAttachmentSpecFluentImpl<V1VolumeAttachmentFluent.SpecNested<N>> implements V1VolumeAttachmentFluent.SpecNested<N>,Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1VolumeAttachmentStatusFluentImpl<V1VolumeAttachmentFluent.StatusNested<N>> implements V1VolumeAttachmentFluent.StatusNested<N>,Nested<N>{
