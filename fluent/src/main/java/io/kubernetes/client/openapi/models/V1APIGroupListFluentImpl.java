...
public class V1APIGroupListFluentImpl<A extends io.kubernetes.client.openapi.models.V1APIGroupListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1APIGroupListFluent<A> {
    ...
    public A addToGroups(int index,io.kubernetes.client.openapi.models.V1APIGroup item) {
        ...
        io.kubernetes.client.openapi.models.V1APIGroupBuilder builder = new io.kubernetes.client.openapi.models.V1APIGroupBuilder(item);_visitables.get("groups").add(index >= 0 ? index : _visitables.get("groups").size(), builder);this.groups.add(index >= 0 ? index : groups.size(), builder); return (A)this;
    }

    public A setToGroups(int index,io.kubernetes.client.openapi.models.V1APIGroup item) {
        if (this.groups == null) {this.groups = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1APIGroupBuilder>();}
        io.kubernetes.client.openapi.models.V1APIGroupBuilder builder = new io.kubernetes.client.openapi.models.V1APIGroupBuilder(item);
    ...
    public A addToGroups(io.kubernetes.client.openapi.models.V1APIGroup... items) {
        if (this.groups == null) {this.groups = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1APIGroupBuilder>();}
        for (io.kubernetes.client.openapi.models.V1APIGroup item : items) {io.kubernetes.client.openapi.models.V1APIGroupBuilder builder = new io.kubernetes.client.openapi.models.V1APIGroupBuilder(item);_visitables.get("groups").add(builder);this.groups.add(builder);} return (A)this;
    }
    ...
    public A removeFromGroups(io.kubernetes.client.openapi.models.V1APIGroup... items) {
        for (io.kubernetes.client.openapi.models.V1APIGroup item : items) {io.kubernetes.client.openapi.models.V1APIGroupBuilder builder = new io.kubernetes.client.openapi.models.V1APIGroupBuilder(item);_visitables.get("groups").remove(builder);if (this.groups != null) {this.groups.remove(builder);}} return (A)this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1APIGroup buildMatchingGroup(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1APIGroupBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1APIGroupBuilder item: groups) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingGroup(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1APIGroupBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1APIGroupBuilder item: groups) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withGroups(java.util.List<io.kubernetes.client.openapi.models.V1APIGroup> groups) {
        ...
        if (groups != null) {this.groups = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1APIGroupBuilder>(); for (io.kubernetes.client.openapi.models.V1APIGroup item : groups){this.addToGroups(item);}} else { this.groups = null;} return (A) this;
    }

    public A withGroups(io.kubernetes.client.openapi.models.V1APIGroup... groups) {
        if (this.groups != null) {this.groups.clear();}
        if (groups != null) {for (io.kubernetes.client.openapi.models.V1APIGroup item :groups){ this.addToGroups(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1APIGroupListFluent.GroupsNested<A> addNewGroupLike(io.kubernetes.client.openapi.models.V1APIGroup item) {
        return new io.kubernetes.client.openapi.models.V1APIGroupListFluentImpl.GroupsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1APIGroupListFluent.GroupsNested<A> setNewGroupLike(int index,io.kubernetes.client.openapi.models.V1APIGroup item) {
        return new io.kubernetes.client.openapi.models.V1APIGroupListFluentImpl.GroupsNestedImpl(index, item);
    }
    ...
    public class GroupsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1APIGroupFluentImpl<io.kubernetes.client.openapi.models.V1APIGroupListFluent.GroupsNested<N>> implements io.kubernetes.client.openapi.models.V1APIGroupListFluent.GroupsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1APIGroupBuilder builder;
        private final int index;

            GroupsNestedImpl(int index,io.kubernetes.client.openapi.models.V1APIGroup item) {
                this.index = index;
