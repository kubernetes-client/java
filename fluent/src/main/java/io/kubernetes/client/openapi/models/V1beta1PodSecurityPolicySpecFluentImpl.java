...
import java.lang.Integer;
  ...
  * Generated
  */
public class V1beta1PodSecurityPolicySpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent<A>{
  public V1beta1PodSecurityPolicySpecFluentImpl() {
  }
  public V1beta1PodSecurityPolicySpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpec instance) {
  ...
  private io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsBuilder runtimeClass;
  private io.kubernetes.client.openapi.models.V1beta1SELinuxStrategyOptionsBuilder seLinux;
  private io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsBuilder supplementalGroups;
  ...
  public A addToAllowedCSIDrivers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item) {
    if (this.allowedCSIDrivers == null) {this.allowedCSIDrivers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder>();}
  ...
  public A setToAllowedCSIDrivers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item) {
    if (this.allowedCSIDrivers == null) {this.allowedCSIDrivers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder>();}
    io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder builder = new io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder(item);
  ...
  public A addToAllowedCSIDrivers(io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver... items) {
    if (this.allowedCSIDrivers == null) {this.allowedCSIDrivers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder>();}
    for (io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item : items) {io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder builder = new io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder(item);_visitables.get("allowedCSIDrivers").add(builder);this.allowedCSIDrivers.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromAllowedCSIDrivers(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder> each = allowedCSIDrivers.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver buildMatchingAllowedCSIDriver(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder item: allowedCSIDrivers) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingAllowedCSIDriver(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder item: allowedCSIDrivers) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withAllowedCSIDrivers(java.util.List<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver> allowedCSIDrivers) {
    ...
    if (allowedCSIDrivers != null) {this.allowedCSIDrivers = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item : allowedCSIDrivers){this.addToAllowedCSIDrivers(item);}} else { this.allowedCSIDrivers = null;} return (A) this;
  }
  public A withAllowedCSIDrivers(io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver... allowedCSIDrivers) {
    ...
    if (allowedCSIDrivers != null) {for (io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item :allowedCSIDrivers){ this.addToAllowedCSIDrivers(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedCSIDriversNested<A> addNewAllowedCSIDriver() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedCSIDriversNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedCSIDriversNested<A> addNewAllowedCSIDriverLike(io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedCSIDriversNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedCSIDriversNested<A> setNewAllowedCSIDriverLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedCSIDriversNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedCSIDriversNested<A> editAllowedCSIDriver(java.lang.Integer index) {
  ...
  public A withAllowedCapabilities(java.util.List<java.lang.String> allowedCapabilities) {
    if (allowedCapabilities != null) {this.allowedCapabilities = new java.util.ArrayList(); for (java.lang.String item : allowedCapabilities){this.addToAllowedCapabilities(item);}} else { this.allowedCapabilities = null;} return (A) this;
  }
  ...
  public A setToAllowedFlexVolumes(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume item) {
    if (this.allowedFlexVolumes == null) {this.allowedFlexVolumes = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder>();}
    io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder builder = new io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder(item);
  ...
  public A removeMatchingFromAllowedFlexVolumes(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder> each = allowedFlexVolumes.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume buildMatchingAllowedFlexVolume(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder item: allowedFlexVolumes) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingAllowedFlexVolume(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder item: allowedFlexVolumes) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withAllowedFlexVolumes(java.util.List<io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume> allowedFlexVolumes) {
    ...
    if (allowedFlexVolumes != null) {this.allowedFlexVolumes = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume item : allowedFlexVolumes){this.addToAllowedFlexVolumes(item);}} else { this.allowedFlexVolumes = null;} return (A) this;
  }
  public A withAllowedFlexVolumes(io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume... allowedFlexVolumes) {
    ...
    if (allowedFlexVolumes != null) {for (io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume item :allowedFlexVolumes){ this.addToAllowedFlexVolumes(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedFlexVolumesNested<A> addNewAllowedFlexVolume() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedFlexVolumesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedFlexVolumesNested<A> addNewAllowedFlexVolumeLike(io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedFlexVolumesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedFlexVolumesNested<A> setNewAllowedFlexVolumeLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedFlexVolumesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedFlexVolumesNested<A> editAllowedFlexVolume(java.lang.Integer index) {
  ...
  public A addToAllowedHostPaths(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedHostPath item) {
    if (this.allowedHostPaths == null) {this.allowedHostPaths = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder>();}
  ...
  public A setToAllowedHostPaths(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedHostPath item) {
    if (this.allowedHostPaths == null) {this.allowedHostPaths = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder>();}
    io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder builder = new io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder(item);
  ...
  public A removeMatchingFromAllowedHostPaths(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder> each = allowedHostPaths.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1beta1AllowedHostPath buildMatchingAllowedHostPath(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder item: allowedHostPaths) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingAllowedHostPath(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder item: allowedHostPaths) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withAllowedHostPaths(java.util.List<io.kubernetes.client.openapi.models.V1beta1AllowedHostPath> allowedHostPaths) {
    ...
    if (allowedHostPaths != null) {this.allowedHostPaths = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1AllowedHostPath item : allowedHostPaths){this.addToAllowedHostPaths(item);}} else { this.allowedHostPaths = null;} return (A) this;
  }
  public A withAllowedHostPaths(io.kubernetes.client.openapi.models.V1beta1AllowedHostPath... allowedHostPaths) {
    ...
    if (allowedHostPaths != null) {for (io.kubernetes.client.openapi.models.V1beta1AllowedHostPath item :allowedHostPaths){ this.addToAllowedHostPaths(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedHostPathsNested<A> addNewAllowedHostPath() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedHostPathsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedHostPathsNested<A> addNewAllowedHostPathLike(io.kubernetes.client.openapi.models.V1beta1AllowedHostPath item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedHostPathsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedHostPathsNested<A> setNewAllowedHostPathLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedHostPath item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.AllowedHostPathsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedHostPathsNested<A> editAllowedHostPath(java.lang.Integer index) {
  ...
  public A withAllowedProcMountTypes(java.util.List<java.lang.String> allowedProcMountTypes) {
    if (allowedProcMountTypes != null) {this.allowedProcMountTypes = new java.util.ArrayList(); for (java.lang.String item : allowedProcMountTypes){this.addToAllowedProcMountTypes(item);}} else { this.allowedProcMountTypes = null;} return (A) this;
  }
  ...
  public A withAllowedUnsafeSysctls(java.util.List<java.lang.String> allowedUnsafeSysctls) {
    if (allowedUnsafeSysctls != null) {this.allowedUnsafeSysctls = new java.util.ArrayList(); for (java.lang.String item : allowedUnsafeSysctls){this.addToAllowedUnsafeSysctls(item);}} else { this.allowedUnsafeSysctls = null;} return (A) this;
  }
  ...
  public A withDefaultAddCapabilities(java.util.List<java.lang.String> defaultAddCapabilities) {
    if (defaultAddCapabilities != null) {this.defaultAddCapabilities = new java.util.ArrayList(); for (java.lang.String item : defaultAddCapabilities){this.addToDefaultAddCapabilities(item);}} else { this.defaultAddCapabilities = null;} return (A) this;
  }
  ...
  public A withForbiddenSysctls(java.util.List<java.lang.String> forbiddenSysctls) {
    if (forbiddenSysctls != null) {this.forbiddenSysctls = new java.util.ArrayList(); for (java.lang.String item : forbiddenSysctls){this.addToForbiddenSysctls(item);}} else { this.forbiddenSysctls = null;} return (A) this;
  }
  ...
  public A withFsGroup(io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptions fsGroup) {
    ...
    if (fsGroup!=null){ this.fsGroup= new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsBuilder(fsGroup); _visitables.get("fsGroup").add(this.fsGroup);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.FsGroupNested<A> withNewFsGroup() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.FsGroupNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.FsGroupNested<A> withNewFsGroupLike(io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptions item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.FsGroupNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.FsGroupNested<A> editOrNewFsGroup() {
    return withNewFsGroupLike(getFsGroup() != null ? getFsGroup(): new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsBuilder().build());
  }
  ...
  public A addToHostPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1HostPortRange item) {
    if (this.hostPorts == null) {this.hostPorts = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder>();}
    io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder builder = new io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder(item);_visitables.get("hostPorts").add(index >= 0 ? index : _visitables.get("hostPorts").size(), builder);this.hostPorts.add(index >= 0 ? index : hostPorts.size(), builder); return (A)this;
  }
  public A setToHostPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1HostPortRange item) {
    if (this.hostPorts == null) {this.hostPorts = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder>();}
    io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder builder = new io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder(item);
  ...
  public A addToHostPorts(io.kubernetes.client.openapi.models.V1beta1HostPortRange... items) {
    if (this.hostPorts == null) {this.hostPorts = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder>();}
    for (io.kubernetes.client.openapi.models.V1beta1HostPortRange item : items) {io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder builder = new io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder(item);_visitables.get("hostPorts").add(builder);this.hostPorts.add(builder);} return (A)this;
  }
  ...
  public A removeFromHostPorts(io.kubernetes.client.openapi.models.V1beta1HostPortRange... items) {
    for (io.kubernetes.client.openapi.models.V1beta1HostPortRange item : items) {io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder builder = new io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder(item);_visitables.get("hostPorts").remove(builder);if (this.hostPorts != null) {this.hostPorts.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromHostPorts(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder> each = hostPorts.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1beta1HostPortRange buildMatchingHostPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder item: hostPorts) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingHostPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder item: hostPorts) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withHostPorts(java.util.List<io.kubernetes.client.openapi.models.V1beta1HostPortRange> hostPorts) {
    ...
    if (hostPorts != null) {this.hostPorts = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1HostPortRange item : hostPorts){this.addToHostPorts(item);}} else { this.hostPorts = null;} return (A) this;
  }
  public A withHostPorts(io.kubernetes.client.openapi.models.V1beta1HostPortRange... hostPorts) {
    ...
    if (hostPorts != null) {for (io.kubernetes.client.openapi.models.V1beta1HostPortRange item :hostPorts){ this.addToHostPorts(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.HostPortsNested<A> addNewHostPort() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.HostPortsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.HostPortsNested<A> addNewHostPortLike(io.kubernetes.client.openapi.models.V1beta1HostPortRange item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.HostPortsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.HostPortsNested<A> setNewHostPortLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1HostPortRange item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.HostPortsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.HostPortsNested<A> editHostPort(java.lang.Integer index) {
  ...
  public A withRequiredDropCapabilities(java.util.List<java.lang.String> requiredDropCapabilities) {
    if (requiredDropCapabilities != null) {this.requiredDropCapabilities = new java.util.ArrayList(); for (java.lang.String item : requiredDropCapabilities){this.addToRequiredDropCapabilities(item);}} else { this.requiredDropCapabilities = null;} return (A) this;
  }
  ...
  public A withRunAsGroup(io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptions runAsGroup) {
    ...
    if (runAsGroup!=null){ this.runAsGroup= new io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptionsBuilder(runAsGroup); _visitables.get("runAsGroup").add(this.runAsGroup);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsGroupNested<A> withNewRunAsGroup() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.RunAsGroupNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsGroupNested<A> withNewRunAsGroupLike(io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptions item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.RunAsGroupNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsGroupNested<A> editOrNewRunAsGroup() {
    return withNewRunAsGroupLike(getRunAsGroup() != null ? getRunAsGroup(): new io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptionsBuilder().build());
  }
  ...
  public A withRunAsUser(io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptions runAsUser) {
    ...
    if (runAsUser!=null){ this.runAsUser= new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsBuilder(runAsUser); _visitables.get("runAsUser").add(this.runAsUser);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsUserNested<A> withNewRunAsUser() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.RunAsUserNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsUserNested<A> withNewRunAsUserLike(io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptions item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.RunAsUserNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsUserNested<A> editOrNewRunAsUser() {
    return withNewRunAsUserLike(getRunAsUser() != null ? getRunAsUser(): new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsBuilder().build());
  }
  ...
  public A withRuntimeClass(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions runtimeClass) {
    ...
    if (runtimeClass!=null){ this.runtimeClass= new io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsBuilder(runtimeClass); _visitables.get("runtimeClass").add(this.runtimeClass);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RuntimeClassNested<A> withNewRuntimeClass() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.RuntimeClassNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RuntimeClassNested<A> withNewRuntimeClassLike(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.RuntimeClassNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RuntimeClassNested<A> editOrNewRuntimeClass() {
    return withNewRuntimeClassLike(getRuntimeClass() != null ? getRuntimeClass(): new io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsBuilder().build());
  }
  ...
  public A withSeLinux(io.kubernetes.client.openapi.models.V1beta1SELinuxStrategyOptions seLinux) {
    ...
    if (seLinux!=null){ this.seLinux= new io.kubernetes.client.openapi.models.V1beta1SELinuxStrategyOptionsBuilder(seLinux); _visitables.get("seLinux").add(this.seLinux);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SeLinuxNested<A> withNewSeLinux() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.SeLinuxNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SeLinuxNested<A> withNewSeLinuxLike(io.kubernetes.client.openapi.models.V1beta1SELinuxStrategyOptions item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.SeLinuxNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SeLinuxNested<A> editOrNewSeLinux() {
    return withNewSeLinuxLike(getSeLinux() != null ? getSeLinux(): new io.kubernetes.client.openapi.models.V1beta1SELinuxStrategyOptionsBuilder().build());
  }
  ...
  public A withSupplementalGroups(io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptions supplementalGroups) {
    ...
    if (supplementalGroups!=null){ this.supplementalGroups= new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsBuilder(supplementalGroups); _visitables.get("supplementalGroups").add(this.supplementalGroups);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SupplementalGroupsNested<A> withNewSupplementalGroups() {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.SupplementalGroupsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SupplementalGroupsNested<A> withNewSupplementalGroupsLike(io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptions item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluentImpl.SupplementalGroupsNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SupplementalGroupsNested<A> editOrNewSupplementalGroups() {
    return withNewSupplementalGroupsLike(getSupplementalGroups() != null ? getSupplementalGroups(): new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsBuilder().build());
  }
  ...
  public A withVolumes(java.util.List<java.lang.String> volumes) {
    if (volumes != null) {this.volumes = new java.util.ArrayList(); for (java.lang.String item : volumes){this.addToVolumes(item);}} else { this.volumes = null;} return (A) this;
  }
  ...
  public class AllowedCSIDriversNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedCSIDriversNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedCSIDriversNested<N>,io.kubernetes.client.fluent.Nested<N>{
    AllowedCSIDriversNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder(this, item);
    }
  ...
  public class AllowedFlexVolumesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedFlexVolumesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedFlexVolumesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    AllowedFlexVolumesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolumeBuilder(this, item);
    }
  ...
  public class AllowedHostPathsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1AllowedHostPathFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedHostPathsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.AllowedHostPathsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    AllowedHostPathsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1AllowedHostPath item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1beta1AllowedHostPathBuilder(this, item);
    }
  ...
  public class FsGroupNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.FsGroupNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.FsGroupNested<N>,io.kubernetes.client.fluent.Nested<N>{
    FsGroupNestedImpl(io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptions item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsBuilder(this, item);
    }
    FsGroupNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsBuilder(this);
    }
  ...
  public class HostPortsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1HostPortRangeFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.HostPortsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.HostPortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    HostPortsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1HostPortRange item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1beta1HostPortRangeBuilder(this, item);
    }
    HostPortsNestedImpl() {
      this.index = -1;
  ...
  public class RunAsGroupNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptionsFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsGroupNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsGroupNested<N>,io.kubernetes.client.fluent.Nested<N>{
    RunAsGroupNestedImpl(io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptions item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptionsBuilder(this, item);
    }
    RunAsGroupNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptionsBuilder(this);
    }
  ...
  public class RunAsUserNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsUserNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RunAsUserNested<N>,io.kubernetes.client.fluent.Nested<N>{
    RunAsUserNestedImpl(io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptions item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsBuilder(this, item);
    }
    RunAsUserNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsBuilder(this);
    }
  ...
  public class RuntimeClassNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RuntimeClassNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.RuntimeClassNested<N>,io.kubernetes.client.fluent.Nested<N>{
    RuntimeClassNestedImpl(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsBuilder(this, item);
    }
    RuntimeClassNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsBuilder(this);
    }
  ...
  public class SupplementalGroupsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SupplementalGroupsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpecFluent.SupplementalGroupsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    SupplementalGroupsNestedImpl(io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptions item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsBuilder(this, item);
    }
    SupplementalGroupsNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsBuilder(this);
    }
