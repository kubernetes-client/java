...
public class V2beta2HorizontalPodAutoscalerSpecBuilder
    ...
    implements VisitableBuilder<
        V2beta2HorizontalPodAutoscalerSpec, V2beta2HorizontalPodAutoscalerSpecBuilder> {
  ...
  public V2beta2HorizontalPodAutoscalerSpecBuilder(
      V2beta2HorizontalPodAutoscalerSpecFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V2beta2HorizontalPodAutoscalerSpec(), validationEnabled);
  }

  public V2beta2HorizontalPodAutoscalerSpecBuilder(
      V2beta2HorizontalPodAutoscalerSpecFluent<?> fluent,
      V2beta2HorizontalPodAutoscalerSpec instance) {
  ...
  public V2beta2HorizontalPodAutoscalerSpecBuilder(
      V2beta2HorizontalPodAutoscalerSpec instance, Boolean validationEnabled) {
    this.fluent = this;
