...
public class V1ServerAddressByClientCIDRBuilder extends io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRFluentImpl<io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDR,io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRBuilder> {
    ...
    public V1ServerAddressByClientCIDRBuilder(io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRFluent<?> fluent) {
        this(fluent, true);
    }

    public V1ServerAddressByClientCIDRBuilder(io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1ServerAddressByClientCIDR(), validationEnabled);
    }

    public V1ServerAddressByClientCIDRBuilder(io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRFluent<?> fluent,io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDR instance) {
        this(fluent, instance, true);
    }

    public V1ServerAddressByClientCIDRBuilder(io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRFluent<?> fluent,io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDR instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1ServerAddressByClientCIDRBuilder(io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDR instance) {
        this(instance,true);
    }

    public V1ServerAddressByClientCIDRBuilder(io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDR instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
