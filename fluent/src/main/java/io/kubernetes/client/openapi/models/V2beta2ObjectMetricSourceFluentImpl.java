...
public class V2beta2ObjectMetricSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent<A> {
    ...
    public V2beta2ObjectMetricSourceFluentImpl(io.kubernetes.client.openapi.models.V2beta2ObjectMetricSource instance) {
    ...
    public A withDescribedObject(io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReference describedObject) {
        ...
        if (describedObject!=null){ this.describedObject= new io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReferenceBuilder(describedObject); _visitables.get("describedObject").add(this.describedObject);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.DescribedObjectNested<A> withNewDescribedObject() {
        return new io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluentImpl.DescribedObjectNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.DescribedObjectNested<A> withNewDescribedObjectLike(io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReference item) {
        return new io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluentImpl.DescribedObjectNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.DescribedObjectNested<A> editOrNewDescribedObject() {
        return withNewDescribedObjectLike(getDescribedObject() != null ? getDescribedObject(): new io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReferenceBuilder().build());
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.MetricNested<A> withNewMetric() {
        return new io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluentImpl.MetricNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.MetricNested<A> withNewMetricLike(io.kubernetes.client.openapi.models.V2beta2MetricIdentifier item) {
        return new io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluentImpl.MetricNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.TargetNested<A> withNewTarget() {
        return new io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluentImpl.TargetNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.TargetNested<A> withNewTargetLike(io.kubernetes.client.openapi.models.V2beta2MetricTarget item) {
        return new io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluentImpl.TargetNestedImpl(item);
    }
    ...
    public class DescribedObjectNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.DescribedObjectNested<N>> implements io.kubernetes.client.openapi.models.V2beta2ObjectMetricSourceFluent.DescribedObjectNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReferenceBuilder builder;
            ...
            DescribedObjectNestedImpl(io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReference item) {
