...
public class V1alpha1PriorityClassFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluent<A> {
    ...
    public V1alpha1PriorityClassFluentImpl() {
    }

    public V1alpha1PriorityClassFluentImpl(io.kubernetes.client.openapi.models.V1alpha1PriorityClass instance) {
    ...
    public io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1alpha1PriorityClassFluentImpl that = (V1alpha1PriorityClassFluentImpl) o;
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1PriorityClassFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ObjectMetaBuilder builder;
            ...
            public N and() {
                return (N) V1alpha1PriorityClassFluentImpl.this.withMetadata(builder.build());
            }
