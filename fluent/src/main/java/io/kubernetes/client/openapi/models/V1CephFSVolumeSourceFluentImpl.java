...
import java.lang.Boolean;
  ...
  */
  ...
  public class V1CephFSVolumeSourceFluentImpl<A extends V1CephFSVolumeSourceFluent<A>> extends BaseFluent<A> implements V1CephFSVolumeSourceFluent<A>{
  ...
  public V1CephFSVolumeSourceFluentImpl.SecretRefNested<A> withNewSecretRef() {
    return new V1CephFSVolumeSourceFluentImpl.SecretRefNestedImpl();
  }
  public V1CephFSVolumeSourceFluentImpl.SecretRefNested<A> withNewSecretRefLike(V1LocalObjectReference item) {
    return new V1CephFSVolumeSourceFluentImpl.SecretRefNestedImpl(item);
  }
  public V1CephFSVolumeSourceFluentImpl.SecretRefNested<A> editSecretRef() {
    return withNewSecretRefLike(getSecretRef());
  }
  public V1CephFSVolumeSourceFluentImpl.SecretRefNested<A> editOrNewSecretRef() {
    return withNewSecretRefLike(getSecretRef() != null ? getSecretRef(): new V1LocalObjectReferenceBuilder().build());
  }
  public V1CephFSVolumeSourceFluentImpl.SecretRefNested<A> editOrNewSecretRefLike(V1LocalObjectReference item) {
  ...
  class SecretRefNestedImpl<N> extends V1LocalObjectReferenceFluentImpl<V1CephFSVolumeSourceFluentImpl.SecretRefNested<N>> implements V1CephFSVolumeSourceFluentImpl.SecretRefNested<N>,Nested<N>{
