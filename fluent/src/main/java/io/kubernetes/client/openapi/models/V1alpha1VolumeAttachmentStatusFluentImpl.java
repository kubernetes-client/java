...
public class V1alpha1VolumeAttachmentStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent<A> {
    ...
    public V1alpha1VolumeAttachmentStatusFluentImpl(io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatus instance) {
    ...
    public A withAttachError(io.kubernetes.client.openapi.models.V1alpha1VolumeError attachError) {
        ...
        if (attachError!=null){ this.attachError= new io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder(attachError); _visitables.get("attachError").add(this.attachError);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.AttachErrorNested<A> withNewAttachError() {
        return new io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluentImpl.AttachErrorNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.AttachErrorNested<A> withNewAttachErrorLike(io.kubernetes.client.openapi.models.V1alpha1VolumeError item) {
        return new io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluentImpl.AttachErrorNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.AttachErrorNested<A> editOrNewAttachError() {
        return withNewAttachErrorLike(getAttachError() != null ? getAttachError(): new io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.AttachErrorNested<A> editOrNewAttachErrorLike(io.kubernetes.client.openapi.models.V1alpha1VolumeError item) {
    ...
    public A withDetachError(io.kubernetes.client.openapi.models.V1alpha1VolumeError detachError) {
        ...
        if (detachError!=null){ this.detachError= new io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder(detachError); _visitables.get("detachError").add(this.detachError);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.DetachErrorNested<A> withNewDetachError() {
        return new io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluentImpl.DetachErrorNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.DetachErrorNested<A> withNewDetachErrorLike(io.kubernetes.client.openapi.models.V1alpha1VolumeError item) {
        return new io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluentImpl.DetachErrorNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.DetachErrorNested<A> editOrNewDetachError() {
        return withNewDetachErrorLike(getDetachError() != null ? getDetachError(): new io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.DetachErrorNested<A> editOrNewDetachErrorLike(io.kubernetes.client.openapi.models.V1alpha1VolumeError item) {
    ...
    public class AttachErrorNestedImpl<N> extends io.kubernetes.client.openapi.models.V1alpha1VolumeErrorFluentImpl<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.AttachErrorNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.AttachErrorNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder builder;

            AttachErrorNestedImpl(io.kubernetes.client.openapi.models.V1alpha1VolumeError item) {
                this.builder = new io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder(this, item);
                        
            }

            AttachErrorNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder(this);
    ...
    public class DetachErrorNestedImpl<N> extends io.kubernetes.client.openapi.models.V1alpha1VolumeErrorFluentImpl<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.DetachErrorNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.DetachErrorNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder builder;

            DetachErrorNestedImpl(io.kubernetes.client.openapi.models.V1alpha1VolumeError item) {
                this.builder = new io.kubernetes.client.openapi.models.V1alpha1VolumeErrorBuilder(this, item);
