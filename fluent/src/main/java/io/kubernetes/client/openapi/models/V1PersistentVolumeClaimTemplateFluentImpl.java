...
public class V1PersistentVolumeClaimTemplateFluentImpl<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent<A> {
    ...
    public V1PersistentVolumeClaimTemplateFluentImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplate instance) {
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpec item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluentImpl.SpecNestedImpl(item);
    }
