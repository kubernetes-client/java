...
public class V1HTTPGetActionFluentImpl<A extends io.kubernetes.client.openapi.models.V1HTTPGetActionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1HTTPGetActionFluent<A> {
    ...
    public A addToHttpHeaders(int index,io.kubernetes.client.openapi.models.V1HTTPHeader item) {
        ...
        io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder builder = new io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder(item);_visitables.get("httpHeaders").add(index >= 0 ? index : _visitables.get("httpHeaders").size(), builder);this.httpHeaders.add(index >= 0 ? index : httpHeaders.size(), builder); return (A)this;
    }

    public A setToHttpHeaders(int index,io.kubernetes.client.openapi.models.V1HTTPHeader item) {
        if (this.httpHeaders == null) {this.httpHeaders = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder>();}
        io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder builder = new io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder(item);
    ...
    public A addToHttpHeaders(io.kubernetes.client.openapi.models.V1HTTPHeader... items) {
        if (this.httpHeaders == null) {this.httpHeaders = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder>();}
        for (io.kubernetes.client.openapi.models.V1HTTPHeader item : items) {io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder builder = new io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder(item);_visitables.get("httpHeaders").add(builder);this.httpHeaders.add(builder);} return (A)this;
    }
    ...
    public A removeMatchingFromHttpHeaders(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder> each = httpHeaders.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1HTTPHeader buildMatchingHttpHeader(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder item: httpHeaders) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingHttpHeader(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder item: httpHeaders) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withHttpHeaders(java.util.List<io.kubernetes.client.openapi.models.V1HTTPHeader> httpHeaders) {
        ...
        if (httpHeaders != null) {this.httpHeaders = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder>(); for (io.kubernetes.client.openapi.models.V1HTTPHeader item : httpHeaders){this.addToHttpHeaders(item);}} else { this.httpHeaders = null;} return (A) this;
    }
    ...
    public A withHttpHeaders(io.kubernetes.client.openapi.models.V1HTTPHeader... httpHeaders) {
        ...
        if (httpHeaders != null) {for (io.kubernetes.client.openapi.models.V1HTTPHeader item :httpHeaders){ this.addToHttpHeaders(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1HTTPGetActionFluent.HttpHeadersNested<A> addNewHttpHeaderLike(io.kubernetes.client.openapi.models.V1HTTPHeader item) {
        return new io.kubernetes.client.openapi.models.V1HTTPGetActionFluentImpl.HttpHeadersNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1HTTPGetActionFluent.HttpHeadersNested<A> setNewHttpHeaderLike(int index,io.kubernetes.client.openapi.models.V1HTTPHeader item) {
        return new io.kubernetes.client.openapi.models.V1HTTPGetActionFluentImpl.HttpHeadersNestedImpl(index, item);
    }
    ...
    public class HttpHeadersNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HTTPHeaderFluentImpl<io.kubernetes.client.openapi.models.V1HTTPGetActionFluent.HttpHeadersNested<N>> implements io.kubernetes.client.openapi.models.V1HTTPGetActionFluent.HttpHeadersNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder builder;
        private final int index;

            HttpHeadersNestedImpl(int index,io.kubernetes.client.openapi.models.V1HTTPHeader item) {
                this.index = index;
