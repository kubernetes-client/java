...
import java.util.Map;
  ...
  * Generated
  */
public interface V1SchedulingFluent<A extends io.kubernetes.client.openapi.models.V1SchedulingFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface TolerationsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1TolerationFluent<io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<N>>{
    public N and();
