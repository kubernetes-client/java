...
public class V2beta1HorizontalPodAutoscalerFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent<A> {
    ...
    public V2beta1HorizontalPodAutoscalerFluentImpl(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscaler instance) {
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpec item) {
        return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatus item) {
        return new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluentImpl.StatusNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusBuilder().build());
    }
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluentImpl<io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecBuilder builder;
            ...
            SpecNestedImpl(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecBuilder(this, item);
                        
            }

            SpecNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecBuilder(this);
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusFluentImpl<io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusBuilder builder;

            StatusNestedImpl(io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusBuilder(this, item);
                        
            }

            StatusNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusBuilder(this);
