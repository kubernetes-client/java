...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1DeploymentStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1DeploymentStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1DeploymentStatusFluent<A>{
  ...
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DeploymentCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder(item);_visitables.get("conditions").add(index >= 0 ? index : _visitables.get("conditions").size(), builder);this.conditions.add(index >= 0 ? index : conditions.size(), builder); return (A)this;
  }
  public A setToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DeploymentCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder(item);
  ...
  public A addToConditions(io.kubernetes.client.openapi.models.V1DeploymentCondition... items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1DeploymentCondition item : items) {io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeFromConditions(io.kubernetes.client.openapi.models.V1DeploymentCondition... items) {
    for (io.kubernetes.client.openapi.models.V1DeploymentCondition item : items) {io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder(item);_visitables.get("conditions").remove(builder);if (this.conditions != null) {this.conditions.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder> each = conditions.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1DeploymentCondition buildMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder item: conditions) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder item: conditions) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1DeploymentCondition> conditions) {
    ...
    if (conditions != null) {this.conditions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1DeploymentCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
  }
  public A withConditions(io.kubernetes.client.openapi.models.V1DeploymentCondition... conditions) {
    if (this.conditions != null) {this.conditions.clear();}
    if (conditions != null) {for (io.kubernetes.client.openapi.models.V1DeploymentCondition item :conditions){ this.addToConditions(item);}} return (A) this;
  }
  public java.lang.Boolean hasConditions() {
    return conditions != null && !conditions.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1DeploymentStatusFluent.ConditionsNested<A> addNewCondition() {
    return new io.kubernetes.client.openapi.models.V1DeploymentStatusFluentImpl.ConditionsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1DeploymentStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1DeploymentCondition item) {
    return new io.kubernetes.client.openapi.models.V1DeploymentStatusFluentImpl.ConditionsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1DeploymentStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DeploymentCondition item) {
    return new io.kubernetes.client.openapi.models.V1DeploymentStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1DeploymentStatusFluent.ConditionsNested<A> editCondition(java.lang.Integer index) {
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1DeploymentConditionFluentImpl<io.kubernetes.client.openapi.models.V1DeploymentStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ConditionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DeploymentCondition item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder(this, item);
    }
