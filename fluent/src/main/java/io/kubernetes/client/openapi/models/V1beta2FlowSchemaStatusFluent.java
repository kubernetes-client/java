...
public interface V1beta2FlowSchemaStatusFluent<A extends V1beta2FlowSchemaStatusFluent<A>> extends Fluent<A>{
  ...
  public V1beta2FlowSchemaStatusFluent.ConditionsNested<A> setNewConditionLike(int index,V1beta2FlowSchemaCondition item);
  public V1beta2FlowSchemaStatusFluent.ConditionsNested<A> editCondition(int index);
