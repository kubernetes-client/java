...
public class V1beta2FlowSchemaStatusFluent<A extends V1beta2FlowSchemaStatusFluent<A>> extends BaseFluent<A>{
  public V1beta2FlowSchemaStatusFluent() {
  }
  
  public V1beta2FlowSchemaStatusFluent(V1beta2FlowSchemaStatus instance) {
    this.copyInstance(instance);
  }
  private ArrayList<V1beta2FlowSchemaConditionBuilder> conditions;
  
  protected void copyInstance(V1beta2FlowSchemaStatus instance) {
    instance = (instance != null ? instance : new V1beta2FlowSchemaStatus());
    if (instance != null) {
  ...
  public A removeFromConditions(io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition... items) {
    ...
    for (V1beta2FlowSchemaCondition item : items) {V1beta2FlowSchemaConditionBuilder builder = new V1beta2FlowSchemaConditionBuilder(item);_visitables.get("conditions").remove(builder); this.conditions.remove(builder);} return (A)this;
  }
  ...
  public ConditionsNested<A> addNewConditionLike(V1beta2FlowSchemaCondition item) {
    return new ConditionsNested(-1, item);
  }
  
  public ConditionsNested<A> setNewConditionLike(int index,V1beta2FlowSchemaCondition item) {
  ...
  public ConditionsNested<A> editMatchingCondition(Predicate<V1beta2FlowSchemaConditionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1beta2FlowSchemaStatusFluent that = (V1beta2FlowSchemaStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1beta2FlowSchemaConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ConditionsNested(int index,V1beta2FlowSchemaCondition item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1beta2FlowSchemaStatusFluent.this.setToConditions(index,builder.build());
    }
