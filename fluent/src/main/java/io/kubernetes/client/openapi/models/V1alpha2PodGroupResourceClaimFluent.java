...
public class V1alpha2PodGroupResourceClaimFluent<A extends io.kubernetes.client.openapi.models.V1alpha2PodGroupResourceClaimFluent<A>> extends BaseFluent<A>{

  private String name;
  private String resourceClaimName;
  private String resourceClaimTemplateName;

  public V1alpha2PodGroupResourceClaimFluent() {
  }
  
  public V1alpha2PodGroupResourceClaimFluent(V1alpha2PodGroupResourceClaim instance) {
    this.copyInstance(instance);
  }

  protected void copyInstance(V1alpha2PodGroupResourceClaim instance) {
    instance = instance != null ? instance : new V1alpha2PodGroupResourceClaim();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha2PodGroupResourceClaimFluent that = (V1alpha2PodGroupResourceClaimFluent) o;
