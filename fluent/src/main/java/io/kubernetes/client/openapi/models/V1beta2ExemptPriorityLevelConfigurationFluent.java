...
public class V1beta2ExemptPriorityLevelConfigurationFluent<A extends V1beta2ExemptPriorityLevelConfigurationFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta2ExemptPriorityLevelConfigurationFluent(V1beta2ExemptPriorityLevelConfiguration instance) {
    this.copyInstance(instance);
  }
  private Integer lendablePercent;
  private Integer nominalConcurrencyShares;
  
  protected void copyInstance(V1beta2ExemptPriorityLevelConfiguration instance) {
    instance = (instance != null ? instance : new V1beta2ExemptPriorityLevelConfiguration());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2ExemptPriorityLevelConfigurationFluent that = (V1beta2ExemptPriorityLevelConfigurationFluent) o;
