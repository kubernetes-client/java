...
public class V1SELinuxOptionsBuilder extends io.kubernetes.client.openapi.models.V1SELinuxOptionsFluentImpl<io.kubernetes.client.openapi.models.V1SELinuxOptionsBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1SELinuxOptions,io.kubernetes.client.openapi.models.V1SELinuxOptionsBuilder> {
    ...
    public V1SELinuxOptionsBuilder(io.kubernetes.client.openapi.models.V1SELinuxOptionsFluent<?> fluent) {
        this(fluent, true);
    }

    public V1SELinuxOptionsBuilder(io.kubernetes.client.openapi.models.V1SELinuxOptionsFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1SELinuxOptions(), validationEnabled);
    }

    public V1SELinuxOptionsBuilder(io.kubernetes.client.openapi.models.V1SELinuxOptionsFluent<?> fluent,io.kubernetes.client.openapi.models.V1SELinuxOptions instance) {
        this(fluent, instance, true);
    }

    public V1SELinuxOptionsBuilder(io.kubernetes.client.openapi.models.V1SELinuxOptionsFluent<?> fluent,io.kubernetes.client.openapi.models.V1SELinuxOptions instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1SELinuxOptionsBuilder(io.kubernetes.client.openapi.models.V1SELinuxOptions instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
