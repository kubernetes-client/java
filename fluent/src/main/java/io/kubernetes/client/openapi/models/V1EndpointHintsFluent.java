...
public interface V1EndpointHintsFluent<A extends V1EndpointHintsFluent<A>> extends Fluent<A>{
  ...
  public V1EndpointHintsFluent.ForZonesNested<A> setNewForZoneLike(int index,V1ForZone item);
  public V1EndpointHintsFluent.ForZonesNested<A> editForZone(int index);
