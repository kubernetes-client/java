...
public class V1PersistentVolumeSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent<A> {

    private java.util.List<java.lang.String> accessModes;
    private io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSourceBuilder awsElasticBlockStore;
    ...
    private io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSourceBuilder gcePersistentDisk;
    ...
    public A withAwsElasticBlockStore(io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSource awsElasticBlockStore) {
        ...
        if (awsElasticBlockStore!=null){ this.awsElasticBlockStore= new io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSourceBuilder(awsElasticBlockStore); _visitables.get("awsElasticBlockStore").add(this.awsElasticBlockStore);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AwsElasticBlockStoreNested<A> withNewAwsElasticBlockStore() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.AwsElasticBlockStoreNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AwsElasticBlockStoreNested<A> withNewAwsElasticBlockStoreLike(io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.AwsElasticBlockStoreNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AwsElasticBlockStoreNested<A> editAwsElasticBlockStore() {
        return withNewAwsElasticBlockStoreLike(getAwsElasticBlockStore());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AwsElasticBlockStoreNested<A> editOrNewAwsElasticBlockStore() {
        return withNewAwsElasticBlockStoreLike(getAwsElasticBlockStore() != null ? getAwsElasticBlockStore(): new io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AwsElasticBlockStoreNested<A> editOrNewAwsElasticBlockStoreLike(io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSource item) {
    ...
    public A withAzureDisk(io.kubernetes.client.openapi.models.V1AzureDiskVolumeSource azureDisk) {
        ...
        if (azureDisk!=null){ this.azureDisk= new io.kubernetes.client.openapi.models.V1AzureDiskVolumeSourceBuilder(azureDisk); _visitables.get("azureDisk").add(this.azureDisk);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureDiskNested<A> withNewAzureDisk() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.AzureDiskNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureDiskNested<A> withNewAzureDiskLike(io.kubernetes.client.openapi.models.V1AzureDiskVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.AzureDiskNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureDiskNested<A> editAzureDisk() {
        return withNewAzureDiskLike(getAzureDisk());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureDiskNested<A> editOrNewAzureDisk() {
        return withNewAzureDiskLike(getAzureDisk() != null ? getAzureDisk(): new io.kubernetes.client.openapi.models.V1AzureDiskVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureDiskNested<A> editOrNewAzureDiskLike(io.kubernetes.client.openapi.models.V1AzureDiskVolumeSource item) {
    ...
    public A withAzureFile(io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSource azureFile) {
        ...
        if (azureFile!=null){ this.azureFile= new io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSourceBuilder(azureFile); _visitables.get("azureFile").add(this.azureFile);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureFileNested<A> withNewAzureFile() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.AzureFileNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureFileNested<A> withNewAzureFileLike(io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.AzureFileNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureFileNested<A> editAzureFile() {
        return withNewAzureFileLike(getAzureFile());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureFileNested<A> editOrNewAzureFile() {
        return withNewAzureFileLike(getAzureFile() != null ? getAzureFile(): new io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureFileNested<A> editOrNewAzureFileLike(io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSource item) {
    ...
    public A withCephfs(io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSource cephfs) {
        ...
        if (cephfs!=null){ this.cephfs= new io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSourceBuilder(cephfs); _visitables.get("cephfs").add(this.cephfs);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CephfsNested<A> withNewCephfs() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.CephfsNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CephfsNested<A> withNewCephfsLike(io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.CephfsNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CephfsNested<A> editCephfs() {
        return withNewCephfsLike(getCephfs());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CephfsNested<A> editOrNewCephfs() {
        return withNewCephfsLike(getCephfs() != null ? getCephfs(): new io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CephfsNested<A> editOrNewCephfsLike(io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSource item) {
    ...
    public A withCinder(io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSource cinder) {
        ...
        if (cinder!=null){ this.cinder= new io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSourceBuilder(cinder); _visitables.get("cinder").add(this.cinder);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CinderNested<A> withNewCinder() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.CinderNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CinderNested<A> withNewCinderLike(io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.CinderNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CinderNested<A> editCinder() {
        return withNewCinderLike(getCinder());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CinderNested<A> editOrNewCinder() {
        return withNewCinderLike(getCinder() != null ? getCinder(): new io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CinderNested<A> editOrNewCinderLike(io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSource item) {
    ...
    public A withClaimRef(io.kubernetes.client.openapi.models.V1ObjectReference claimRef) {
        ...
        if (claimRef!=null){ this.claimRef= new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder(claimRef); _visitables.get("claimRef").add(this.claimRef);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ClaimRefNested<A> withNewClaimRef() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.ClaimRefNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ClaimRefNested<A> withNewClaimRefLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.ClaimRefNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ClaimRefNested<A> editClaimRef() {
        return withNewClaimRefLike(getClaimRef());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ClaimRefNested<A> editOrNewClaimRef() {
        return withNewClaimRefLike(getClaimRef() != null ? getClaimRef(): new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ClaimRefNested<A> editOrNewClaimRefLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
    ...
    public A withCsi(io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSource csi) {
        ...
        if (csi!=null){ this.csi= new io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSourceBuilder(csi); _visitables.get("csi").add(this.csi);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CsiNested<A> withNewCsiLike(io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.CsiNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CsiNested<A> editOrNewCsi() {
        return withNewCsiLike(getCsi() != null ? getCsi(): new io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CsiNested<A> editOrNewCsiLike(io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSource item) {
    ...
    public A withFc(io.kubernetes.client.openapi.models.V1FCVolumeSource fc) {
        ...
        if (fc!=null){ this.fc= new io.kubernetes.client.openapi.models.V1FCVolumeSourceBuilder(fc); _visitables.get("fc").add(this.fc);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FcNested<A> withNewFcLike(io.kubernetes.client.openapi.models.V1FCVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.FcNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FcNested<A> editOrNewFc() {
        return withNewFcLike(getFc() != null ? getFc(): new io.kubernetes.client.openapi.models.V1FCVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FcNested<A> editOrNewFcLike(io.kubernetes.client.openapi.models.V1FCVolumeSource item) {
    ...
    public A withFlexVolume(io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSource flexVolume) {
        ...
        if (flexVolume!=null){ this.flexVolume= new io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSourceBuilder(flexVolume); _visitables.get("flexVolume").add(this.flexVolume);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlexVolumeNested<A> withNewFlexVolume() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.FlexVolumeNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlexVolumeNested<A> withNewFlexVolumeLike(io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.FlexVolumeNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlexVolumeNested<A> editFlexVolume() {
        return withNewFlexVolumeLike(getFlexVolume());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlexVolumeNested<A> editOrNewFlexVolume() {
        return withNewFlexVolumeLike(getFlexVolume() != null ? getFlexVolume(): new io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlexVolumeNested<A> editOrNewFlexVolumeLike(io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSource item) {
    ...
    public A withFlocker(io.kubernetes.client.openapi.models.V1FlockerVolumeSource flocker) {
        ...
        if (flocker!=null){ this.flocker= new io.kubernetes.client.openapi.models.V1FlockerVolumeSourceBuilder(flocker); _visitables.get("flocker").add(this.flocker);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlockerNested<A> withNewFlocker() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.FlockerNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlockerNested<A> withNewFlockerLike(io.kubernetes.client.openapi.models.V1FlockerVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.FlockerNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlockerNested<A> editFlocker() {
        return withNewFlockerLike(getFlocker());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlockerNested<A> editOrNewFlocker() {
        return withNewFlockerLike(getFlocker() != null ? getFlocker(): new io.kubernetes.client.openapi.models.V1FlockerVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlockerNested<A> editOrNewFlockerLike(io.kubernetes.client.openapi.models.V1FlockerVolumeSource item) {
    ...
    public A withGcePersistentDisk(io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSource gcePersistentDisk) {
        ...
        if (gcePersistentDisk!=null){ this.gcePersistentDisk= new io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSourceBuilder(gcePersistentDisk); _visitables.get("gcePersistentDisk").add(this.gcePersistentDisk);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GcePersistentDiskNested<A> withNewGcePersistentDisk() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.GcePersistentDiskNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GcePersistentDiskNested<A> withNewGcePersistentDiskLike(io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.GcePersistentDiskNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GcePersistentDiskNested<A> editGcePersistentDisk() {
        return withNewGcePersistentDiskLike(getGcePersistentDisk());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GcePersistentDiskNested<A> editOrNewGcePersistentDisk() {
        return withNewGcePersistentDiskLike(getGcePersistentDisk() != null ? getGcePersistentDisk(): new io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GcePersistentDiskNested<A> editOrNewGcePersistentDiskLike(io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSource item) {
    ...
    public A withGlusterfs(io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSource glusterfs) {
        ...
        if (glusterfs!=null){ this.glusterfs= new io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSourceBuilder(glusterfs); _visitables.get("glusterfs").add(this.glusterfs);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GlusterfsNested<A> withNewGlusterfs() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.GlusterfsNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GlusterfsNested<A> withNewGlusterfsLike(io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.GlusterfsNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GlusterfsNested<A> editGlusterfs() {
        return withNewGlusterfsLike(getGlusterfs());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GlusterfsNested<A> editOrNewGlusterfs() {
        return withNewGlusterfsLike(getGlusterfs() != null ? getGlusterfs(): new io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GlusterfsNested<A> editOrNewGlusterfsLike(io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSource item) {
    ...
    public A withHostPath(io.kubernetes.client.openapi.models.V1HostPathVolumeSource hostPath) {
        ...
        if (hostPath!=null){ this.hostPath= new io.kubernetes.client.openapi.models.V1HostPathVolumeSourceBuilder(hostPath); _visitables.get("hostPath").add(this.hostPath);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.HostPathNested<A> withNewHostPath() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.HostPathNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.HostPathNested<A> withNewHostPathLike(io.kubernetes.client.openapi.models.V1HostPathVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.HostPathNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.HostPathNested<A> editHostPath() {
        return withNewHostPathLike(getHostPath());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.HostPathNested<A> editOrNewHostPath() {
        return withNewHostPathLike(getHostPath() != null ? getHostPath(): new io.kubernetes.client.openapi.models.V1HostPathVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.HostPathNested<A> editOrNewHostPathLike(io.kubernetes.client.openapi.models.V1HostPathVolumeSource item) {
    ...
    public A withIscsi(io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSource iscsi) {
        ...
        if (iscsi!=null){ this.iscsi= new io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSourceBuilder(iscsi); _visitables.get("iscsi").add(this.iscsi);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.IscsiNested<A> withNewIscsi() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.IscsiNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.IscsiNested<A> withNewIscsiLike(io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.IscsiNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.IscsiNested<A> editIscsi() {
        return withNewIscsiLike(getIscsi());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.IscsiNested<A> editOrNewIscsi() {
        return withNewIscsiLike(getIscsi() != null ? getIscsi(): new io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.IscsiNested<A> editOrNewIscsiLike(io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSource item) {
    ...
    public A withLocal(io.kubernetes.client.openapi.models.V1LocalVolumeSource local) {
        ...
        if (local!=null){ this.local= new io.kubernetes.client.openapi.models.V1LocalVolumeSourceBuilder(local); _visitables.get("local").add(this.local);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.LocalNested<A> withNewLocal() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.LocalNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.LocalNested<A> withNewLocalLike(io.kubernetes.client.openapi.models.V1LocalVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.LocalNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.LocalNested<A> editLocal() {
        return withNewLocalLike(getLocal());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.LocalNested<A> editOrNewLocal() {
        return withNewLocalLike(getLocal() != null ? getLocal(): new io.kubernetes.client.openapi.models.V1LocalVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.LocalNested<A> editOrNewLocalLike(io.kubernetes.client.openapi.models.V1LocalVolumeSource item) {
    ...
    public A withNfs(io.kubernetes.client.openapi.models.V1NFSVolumeSource nfs) {
        ...
        if (nfs!=null){ this.nfs= new io.kubernetes.client.openapi.models.V1NFSVolumeSourceBuilder(nfs); _visitables.get("nfs").add(this.nfs);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NfsNested<A> withNewNfsLike(io.kubernetes.client.openapi.models.V1NFSVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.NfsNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NfsNested<A> editOrNewNfs() {
        return withNewNfsLike(getNfs() != null ? getNfs(): new io.kubernetes.client.openapi.models.V1NFSVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NfsNested<A> editOrNewNfsLike(io.kubernetes.client.openapi.models.V1NFSVolumeSource item) {
    ...
    public A withNodeAffinity(io.kubernetes.client.openapi.models.V1VolumeNodeAffinity nodeAffinity) {
        ...
        if (nodeAffinity!=null){ this.nodeAffinity= new io.kubernetes.client.openapi.models.V1VolumeNodeAffinityBuilder(nodeAffinity); _visitables.get("nodeAffinity").add(this.nodeAffinity);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NodeAffinityNested<A> withNewNodeAffinity() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.NodeAffinityNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NodeAffinityNested<A> withNewNodeAffinityLike(io.kubernetes.client.openapi.models.V1VolumeNodeAffinity item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.NodeAffinityNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NodeAffinityNested<A> editOrNewNodeAffinity() {
        return withNewNodeAffinityLike(getNodeAffinity() != null ? getNodeAffinity(): new io.kubernetes.client.openapi.models.V1VolumeNodeAffinityBuilder().build());
    }
    ...
    public A withPhotonPersistentDisk(io.kubernetes.client.openapi.models.V1PhotonPersistentDiskVolumeSource photonPersistentDisk) {
        ...
        if (photonPersistentDisk!=null){ this.photonPersistentDisk= new io.kubernetes.client.openapi.models.V1PhotonPersistentDiskVolumeSourceBuilder(photonPersistentDisk); _visitables.get("photonPersistentDisk").add(this.photonPersistentDisk);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PhotonPersistentDiskNested<A> withNewPhotonPersistentDisk() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.PhotonPersistentDiskNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PhotonPersistentDiskNested<A> withNewPhotonPersistentDiskLike(io.kubernetes.client.openapi.models.V1PhotonPersistentDiskVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.PhotonPersistentDiskNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PhotonPersistentDiskNested<A> editPhotonPersistentDisk() {
        return withNewPhotonPersistentDiskLike(getPhotonPersistentDisk());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PhotonPersistentDiskNested<A> editOrNewPhotonPersistentDisk() {
        return withNewPhotonPersistentDiskLike(getPhotonPersistentDisk() != null ? getPhotonPersistentDisk(): new io.kubernetes.client.openapi.models.V1PhotonPersistentDiskVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PhotonPersistentDiskNested<A> editOrNewPhotonPersistentDiskLike(io.kubernetes.client.openapi.models.V1PhotonPersistentDiskVolumeSource item) {
    ...
    public A withPortworxVolume(io.kubernetes.client.openapi.models.V1PortworxVolumeSource portworxVolume) {
        ...
        if (portworxVolume!=null){ this.portworxVolume= new io.kubernetes.client.openapi.models.V1PortworxVolumeSourceBuilder(portworxVolume); _visitables.get("portworxVolume").add(this.portworxVolume);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PortworxVolumeNested<A> withNewPortworxVolume() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.PortworxVolumeNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PortworxVolumeNested<A> withNewPortworxVolumeLike(io.kubernetes.client.openapi.models.V1PortworxVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.PortworxVolumeNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PortworxVolumeNested<A> editPortworxVolume() {
        return withNewPortworxVolumeLike(getPortworxVolume());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PortworxVolumeNested<A> editOrNewPortworxVolume() {
        return withNewPortworxVolumeLike(getPortworxVolume() != null ? getPortworxVolume(): new io.kubernetes.client.openapi.models.V1PortworxVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PortworxVolumeNested<A> editOrNewPortworxVolumeLike(io.kubernetes.client.openapi.models.V1PortworxVolumeSource item) {
    ...
    public A withQuobyte(io.kubernetes.client.openapi.models.V1QuobyteVolumeSource quobyte) {
        ...
        if (quobyte!=null){ this.quobyte= new io.kubernetes.client.openapi.models.V1QuobyteVolumeSourceBuilder(quobyte); _visitables.get("quobyte").add(this.quobyte);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.QuobyteNested<A> withNewQuobyte() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.QuobyteNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.QuobyteNested<A> withNewQuobyteLike(io.kubernetes.client.openapi.models.V1QuobyteVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.QuobyteNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.QuobyteNested<A> editQuobyte() {
        return withNewQuobyteLike(getQuobyte());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.QuobyteNested<A> editOrNewQuobyte() {
        return withNewQuobyteLike(getQuobyte() != null ? getQuobyte(): new io.kubernetes.client.openapi.models.V1QuobyteVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.QuobyteNested<A> editOrNewQuobyteLike(io.kubernetes.client.openapi.models.V1QuobyteVolumeSource item) {
    ...
    public A withRbd(io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSource rbd) {
        ...
        if (rbd!=null){ this.rbd= new io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSourceBuilder(rbd); _visitables.get("rbd").add(this.rbd);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.RbdNested<A> withNewRbdLike(io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.RbdNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.RbdNested<A> editOrNewRbd() {
        return withNewRbdLike(getRbd() != null ? getRbd(): new io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.RbdNested<A> editOrNewRbdLike(io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSource item) {
    ...
    public A withScaleIO(io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSource scaleIO) {
        ...
        if (scaleIO!=null){ this.scaleIO= new io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSourceBuilder(scaleIO); _visitables.get("scaleIO").add(this.scaleIO);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ScaleIONested<A> withNewScaleIO() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.ScaleIONestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ScaleIONested<A> withNewScaleIOLike(io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.ScaleIONestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ScaleIONested<A> editScaleIO() {
        return withNewScaleIOLike(getScaleIO());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ScaleIONested<A> editOrNewScaleIO() {
        return withNewScaleIOLike(getScaleIO() != null ? getScaleIO(): new io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ScaleIONested<A> editOrNewScaleIOLike(io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSource item) {
    ...
    public A withStorageos(io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSource storageos) {
        ...
        if (storageos!=null){ this.storageos= new io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSourceBuilder(storageos); _visitables.get("storageos").add(this.storageos);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.StorageosNested<A> withNewStorageos() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.StorageosNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.StorageosNested<A> withNewStorageosLike(io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.StorageosNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.StorageosNested<A> editStorageos() {
        return withNewStorageosLike(getStorageos());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.StorageosNested<A> editOrNewStorageos() {
        return withNewStorageosLike(getStorageos() != null ? getStorageos(): new io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.StorageosNested<A> editOrNewStorageosLike(io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSource item) {
    ...
    public A withVsphereVolume(io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSource vsphereVolume) {
        ...
        if (vsphereVolume!=null){ this.vsphereVolume= new io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSourceBuilder(vsphereVolume); _visitables.get("vsphereVolume").add(this.vsphereVolume);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.VsphereVolumeNested<A> withNewVsphereVolume() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.VsphereVolumeNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.VsphereVolumeNested<A> withNewVsphereVolumeLike(io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSource item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluentImpl.VsphereVolumeNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.VsphereVolumeNested<A> editVsphereVolume() {
        return withNewVsphereVolumeLike(getVsphereVolume());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.VsphereVolumeNested<A> editOrNewVsphereVolume() {
        return withNewVsphereVolumeLike(getVsphereVolume() != null ? getVsphereVolume(): new io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.VsphereVolumeNested<A> editOrNewVsphereVolumeLike(io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSource item) {
    ...
    public class AwsElasticBlockStoreNestedImpl<N> extends io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AwsElasticBlockStoreNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AwsElasticBlockStoreNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSourceBuilder builder;

            AwsElasticBlockStoreNestedImpl(io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSourceBuilder(this, item);
                        
            }

            AwsElasticBlockStoreNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1AWSElasticBlockStoreVolumeSourceBuilder(this);
    ...
    public class AzureDiskNestedImpl<N> extends io.kubernetes.client.openapi.models.V1AzureDiskVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureDiskNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureDiskNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1AzureDiskVolumeSourceBuilder builder;
            ...
            AzureDiskNestedImpl(io.kubernetes.client.openapi.models.V1AzureDiskVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1AzureDiskVolumeSourceBuilder(this, item);
    ...
    public class AzureFileNestedImpl<N> extends io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureFileNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.AzureFileNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSourceBuilder builder;

            AzureFileNestedImpl(io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSourceBuilder(this, item);
                        
            }

            AzureFileNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1AzureFilePersistentVolumeSourceBuilder(this);
    ...
    public class CephfsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CephfsNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CephfsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSourceBuilder builder;

            CephfsNestedImpl(io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSourceBuilder(this, item);
                        
            }

            CephfsNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CephFSPersistentVolumeSourceBuilder(this);
    ...
    public class CinderNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CinderNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CinderNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSourceBuilder builder;
            ...
            CinderNestedImpl(io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSourceBuilder(this, item);
                        
            }

            CinderNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CinderPersistentVolumeSourceBuilder(this);
    ...
    public class ClaimRefNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ClaimRefNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ClaimRefNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class CsiNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CsiNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.CsiNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSourceBuilder builder;

            CsiNestedImpl(io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSourceBuilder(this, item);
                        
            }

            CsiNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CSIPersistentVolumeSourceBuilder(this);
    ...
    public class FcNestedImpl<N> extends io.kubernetes.client.openapi.models.V1FCVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FcNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FcNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1FCVolumeSourceBuilder builder;
    ...
    public class FlexVolumeNestedImpl<N> extends io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlexVolumeNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlexVolumeNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSourceBuilder builder;

            FlexVolumeNestedImpl(io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSourceBuilder(this, item);
                        
            }

            FlexVolumeNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1FlexPersistentVolumeSourceBuilder(this);
    ...
    public class FlockerNestedImpl<N> extends io.kubernetes.client.openapi.models.V1FlockerVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlockerNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.FlockerNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1FlockerVolumeSourceBuilder builder;
            ...
            FlockerNestedImpl(io.kubernetes.client.openapi.models.V1FlockerVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1FlockerVolumeSourceBuilder(this, item);
    ...
    public class GcePersistentDiskNestedImpl<N> extends io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GcePersistentDiskNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GcePersistentDiskNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSourceBuilder builder;

            GcePersistentDiskNestedImpl(io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSourceBuilder(this, item);
                        
            }

            GcePersistentDiskNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1GCEPersistentDiskVolumeSourceBuilder(this);
    ...
    public class GlusterfsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GlusterfsNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.GlusterfsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSourceBuilder builder;

            GlusterfsNestedImpl(io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSourceBuilder(this, item);
                        
            }

            GlusterfsNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1GlusterfsPersistentVolumeSourceBuilder(this);
    ...
    public class HostPathNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HostPathVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.HostPathNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.HostPathNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1HostPathVolumeSourceBuilder builder;
            ...
            HostPathNestedImpl(io.kubernetes.client.openapi.models.V1HostPathVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1HostPathVolumeSourceBuilder(this, item);
    ...
    public class IscsiNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.IscsiNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.IscsiNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSourceBuilder builder;

            IscsiNestedImpl(io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSourceBuilder(this, item);
                        
            }

            IscsiNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1ISCSIPersistentVolumeSourceBuilder(this);
    ...
    public class LocalNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LocalVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.LocalNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.LocalNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1LocalVolumeSourceBuilder builder;
    ...
    public class NfsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1NFSVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NfsNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NfsNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class NodeAffinityNestedImpl<N> extends io.kubernetes.client.openapi.models.V1VolumeNodeAffinityFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NodeAffinityNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.NodeAffinityNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1VolumeNodeAffinityBuilder builder;

            NodeAffinityNestedImpl(io.kubernetes.client.openapi.models.V1VolumeNodeAffinity item) {
                this.builder = new io.kubernetes.client.openapi.models.V1VolumeNodeAffinityBuilder(this, item);
    ...
    public class PortworxVolumeNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PortworxVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PortworxVolumeNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.PortworxVolumeNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1PortworxVolumeSourceBuilder builder;
            ...
            PortworxVolumeNestedImpl(io.kubernetes.client.openapi.models.V1PortworxVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1PortworxVolumeSourceBuilder(this, item);
    ...
    public class QuobyteNestedImpl<N> extends io.kubernetes.client.openapi.models.V1QuobyteVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.QuobyteNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.QuobyteNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1QuobyteVolumeSourceBuilder builder;
            ...
            QuobyteNestedImpl(io.kubernetes.client.openapi.models.V1QuobyteVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1QuobyteVolumeSourceBuilder(this, item);
    ...
    public class RbdNestedImpl<N> extends io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.RbdNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.RbdNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSourceBuilder builder;

            RbdNestedImpl(io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSourceBuilder(this, item);
                        
            }

            RbdNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1RBDPersistentVolumeSourceBuilder(this);
    ...
    public class ScaleIONestedImpl<N> extends io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ScaleIONested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.ScaleIONested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSourceBuilder builder;
            ...
            ScaleIONestedImpl(io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSourceBuilder(this, item);
                        
            }

            ScaleIONestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1ScaleIOPersistentVolumeSourceBuilder(this);
    ...
    public class StorageosNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.StorageosNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.StorageosNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSourceBuilder builder;

            StorageosNestedImpl(io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSourceBuilder(this, item);
                        
            }

            StorageosNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1StorageOSPersistentVolumeSourceBuilder(this);
    ...
    public class VsphereVolumeNestedImpl<N> extends io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSourceFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.VsphereVolumeNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeSpecFluent.VsphereVolumeNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSourceBuilder builder;

            VsphereVolumeNestedImpl(io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSourceBuilder(this, item);
                        
            }

            VsphereVolumeNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1VsphereVirtualDiskVolumeSourceBuilder(this);
