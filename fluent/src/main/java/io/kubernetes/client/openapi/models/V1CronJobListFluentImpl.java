...
import java.lang.Object;
  ...
  * Generated
  */
public class V1CronJobListFluentImpl<A extends io.kubernetes.client.openapi.models.V1CronJobListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CronJobListFluent<A>{
  ...
  private java.util.List<io.kubernetes.client.openapi.models.V1CronJobBuilder> items;
  ...
  public A addToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1CronJob item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CronJobBuilder>();}
    io.kubernetes.client.openapi.models.V1CronJobBuilder builder = new io.kubernetes.client.openapi.models.V1CronJobBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1CronJob item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CronJobBuilder>();}
    io.kubernetes.client.openapi.models.V1CronJobBuilder builder = new io.kubernetes.client.openapi.models.V1CronJobBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1CronJob... items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CronJobBuilder>();}
    for (io.kubernetes.client.openapi.models.V1CronJob item : items) {io.kubernetes.client.openapi.models.V1CronJobBuilder builder = new io.kubernetes.client.openapi.models.V1CronJobBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1CronJob... items) {
    for (io.kubernetes.client.openapi.models.V1CronJob item : items) {io.kubernetes.client.openapi.models.V1CronJobBuilder builder = new io.kubernetes.client.openapi.models.V1CronJobBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1CronJob buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CronJobBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1CronJobBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CronJobBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1CronJobBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1CronJob> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1CronJob item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1CronJob... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (io.kubernetes.client.openapi.models.V1CronJob item :items){ this.addToItems(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1CronJobListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1CronJob item) {
    return new io.kubernetes.client.openapi.models.V1CronJobListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1CronJobListFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1CronJob item) {
    return new io.kubernetes.client.openapi.models.V1CronJobListFluentImpl.ItemsNestedImpl(index, item);
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CronJobFluentImpl<io.kubernetes.client.openapi.models.V1CronJobListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1CronJobListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
