...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1CronJob item) {
    ...
    V1CronJobBuilder builder = new V1CronJobBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1CronJobFluentImpl<V1CronJobListFluent.ItemsNested<N>> implements V1CronJobListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1CronJob item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CronJobListFluent.MetadataNested<N>> implements V1CronJobListFluent.MetadataNested<N>,Nested<N>{
