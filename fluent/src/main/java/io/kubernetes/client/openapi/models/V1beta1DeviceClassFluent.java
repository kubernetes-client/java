...
public class V1beta1DeviceClassFluent<A extends V1beta1DeviceClassFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta1DeviceClassFluent(V1beta1DeviceClass instance) {
  ...
  public A withSpec(V1beta1DeviceClassSpec spec) {
    this._visitables.remove("spec");
    if (spec != null) {
        this.spec = new V1beta1DeviceClassSpecBuilder(spec);
  ...
  public SpecNested<A> withNewSpecLike(V1beta1DeviceClassSpec item) {
  ...
  public class MetadataNested<N> extends V1ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta1DeviceClassFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends V1beta1DeviceClassSpecFluent<SpecNested<N>> implements Nested<N>{
    SpecNested(V1beta1DeviceClassSpec item) {
      this.builder = new V1beta1DeviceClassSpecBuilder(this, item);
    }
    V1beta1DeviceClassSpecBuilder builder;
    
    public N and() {
      return (N) V1beta1DeviceClassFluent.this.withSpec(builder.build());
    }
