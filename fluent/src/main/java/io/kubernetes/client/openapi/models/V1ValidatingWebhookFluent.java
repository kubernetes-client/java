...
public interface V1ValidatingWebhookFluent<A extends V1ValidatingWebhookFluent<A>>
  ...
  public interface ObjectSelectorNested<N>
      extends Nested<N>, V1LabelSelectorFluent<V1ValidatingWebhookFluent.ObjectSelectorNested<N>> {
    public N and();
  ...
  public interface RulesNested<N>
      extends Nested<N>, V1RuleWithOperationsFluent<V1ValidatingWebhookFluent.RulesNested<N>> {
    public N and();
