...
public class V1beta1PriorityClassListFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent<A> {

    private java.lang.String apiVersion;
    private java.util.List<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder> items;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ListMetaBuilder metadata;

    public V1beta1PriorityClassListFluentImpl() {
    }

    public V1beta1PriorityClassListFluentImpl(io.kubernetes.client.openapi.models.V1beta1PriorityClassList instance) {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1beta1PriorityClass item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder builder = new io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
    }

    public A setToItems(int index,io.kubernetes.client.openapi.models.V1beta1PriorityClass item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder builder = new io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder(item);
    ...
    public A addToItems(io.kubernetes.client.openapi.models.V1beta1PriorityClass... items) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder>();}
        for (io.kubernetes.client.openapi.models.V1beta1PriorityClass item : items) {io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder builder = new io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
    }
    ...
    public A removeFromItems(io.kubernetes.client.openapi.models.V1beta1PriorityClass... items) {
        for (io.kubernetes.client.openapi.models.V1beta1PriorityClass item : items) {io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder builder = new io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder> each = items.iterator();
        final List visitables = _visitables.get("items");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClass buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1beta1PriorityClass> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder>(); for (io.kubernetes.client.openapi.models.V1beta1PriorityClass item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }

    public A withItems(io.kubernetes.client.openapi.models.V1beta1PriorityClass... items) {
        if (this.items != null) {this.items.clear();}
        if (items != null) {for (io.kubernetes.client.openapi.models.V1beta1PriorityClass item :items){ this.addToItems(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1beta1PriorityClass item) {
        return new io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluentImpl.ItemsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1beta1PriorityClass item) {
        return new io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluentImpl.ItemsNestedImpl(index, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1PriorityClassListFluentImpl that = (V1beta1PriorityClassListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1PriorityClassFluentImpl<io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1beta1PriorityClass item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder(this, item);
                        
            }

            ItemsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1PriorityClassBuilder(this);
                        
            }

            public N and() {
                return (N) V1beta1PriorityClassListFluentImpl.this.setToItems(index,builder.build());
            }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PriorityClassListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ListMetaBuilder builder;
            ...
            public N and() {
                return (N) V1beta1PriorityClassListFluentImpl.this.withMetadata(builder.build());
            }
