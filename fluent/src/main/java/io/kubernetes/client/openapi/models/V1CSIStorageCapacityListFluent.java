...
public class V1CSIStorageCapacityListFluent<A extends V1CSIStorageCapacityListFluent<A>> extends BaseFluent<A>{
  public V1CSIStorageCapacityListFluent() {
  }
  
  public V1CSIStorageCapacityListFluent(V1CSIStorageCapacityList instance) {
  ...
  protected void copyInstance(V1CSIStorageCapacityList instance) {
    instance = (instance != null ? instance : new V1CSIStorageCapacityList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1CSIStorageCapacity... items) {
    ...
    for (V1CSIStorageCapacity item : items) {V1CSIStorageCapacityBuilder builder = new V1CSIStorageCapacityBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1CSIStorageCapacity buildMatchingItem(Predicate<V1CSIStorageCapacityBuilder> predicate) {
      for (V1CSIStorageCapacityBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1CSIStorageCapacity item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1CSIStorageCapacity item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1CSIStorageCapacityBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1CSIStorageCapacityListFluent that = (V1CSIStorageCapacityListFluent) o;
  ...
  public class ItemsNested<N> extends V1CSIStorageCapacityFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1CSIStorageCapacity item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1CSIStorageCapacityListFluent.this.withMetadata(builder.build());
    }
