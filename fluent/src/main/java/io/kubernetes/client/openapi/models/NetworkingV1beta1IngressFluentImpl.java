...
public class NetworkingV1beta1IngressFluentImpl<A extends io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpecBuilder spec;
    private io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatusBuilder status;

    public NetworkingV1beta1IngressFluentImpl() {
    }

    public NetworkingV1beta1IngressFluentImpl(io.kubernetes.client.openapi.models.NetworkingV1beta1Ingress instance) {
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpec item) {
        return new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatus item) {
        return new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluentImpl.StatusNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatusBuilder().build());
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        NetworkingV1beta1IngressFluentImpl that = (NetworkingV1beta1IngressFluentImpl) o;
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ObjectMetaBuilder builder;
            ...
            public N and() {
                return (N) NetworkingV1beta1IngressFluentImpl.this.withMetadata(builder.build());
            }
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpecFluentImpl<io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpecBuilder builder;
            ...
            SpecNestedImpl(io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpecBuilder(this, item);
                        
            }

            SpecNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressSpecBuilder(this);
                        
            }

            public N and() {
                return (N) NetworkingV1beta1IngressFluentImpl.this.withSpec(builder.build());
            }
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatusFluentImpl<io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.NetworkingV1beta1IngressFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatusBuilder builder;

            StatusNestedImpl(io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatusBuilder(this, item);
                        
            }

            StatusNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.NetworkingV1beta1IngressStatusBuilder(this);
                        
            }

            public N and() {
                return (N) NetworkingV1beta1IngressFluentImpl.this.withStatus(builder.build());
            }
