...
import java.lang.Object;
  ...
  * Generated
  */
public class V1SubjectRulesReviewStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent<A>{
  public V1SubjectRulesReviewStatusFluentImpl() {
  }
  public V1SubjectRulesReviewStatusFluentImpl(io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatus instance) {
  ...
  public A addToNonResourceRules(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NonResourceRule item) {
    if (this.nonResourceRules == null) {this.nonResourceRules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder>();}
    io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder builder = new io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder(item);_visitables.get("nonResourceRules").add(index >= 0 ? index : _visitables.get("nonResourceRules").size(), builder);this.nonResourceRules.add(index >= 0 ? index : nonResourceRules.size(), builder); return (A)this;
  }
  public A setToNonResourceRules(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NonResourceRule item) {
    if (this.nonResourceRules == null) {this.nonResourceRules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder>();}
    io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder builder = new io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder(item);
  ...
  public A addToNonResourceRules(io.kubernetes.client.openapi.models.V1NonResourceRule... items) {
    if (this.nonResourceRules == null) {this.nonResourceRules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder>();}
    for (io.kubernetes.client.openapi.models.V1NonResourceRule item : items) {io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder builder = new io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder(item);_visitables.get("nonResourceRules").add(builder);this.nonResourceRules.add(builder);} return (A)this;
  }
  ...
  public A removeFromNonResourceRules(io.kubernetes.client.openapi.models.V1NonResourceRule... items) {
    for (io.kubernetes.client.openapi.models.V1NonResourceRule item : items) {io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder builder = new io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder(item);_visitables.get("nonResourceRules").remove(builder);if (this.nonResourceRules != null) {this.nonResourceRules.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromNonResourceRules(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder> each = nonResourceRules.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1NonResourceRule buildMatchingNonResourceRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder item: nonResourceRules) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingNonResourceRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder item: nonResourceRules) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withNonResourceRules(java.util.List<io.kubernetes.client.openapi.models.V1NonResourceRule> nonResourceRules) {
    ...
    if (nonResourceRules != null) {this.nonResourceRules = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1NonResourceRule item : nonResourceRules){this.addToNonResourceRules(item);}} else { this.nonResourceRules = null;} return (A) this;
  }
  public A withNonResourceRules(io.kubernetes.client.openapi.models.V1NonResourceRule... nonResourceRules) {
    ...
    if (nonResourceRules != null) {for (io.kubernetes.client.openapi.models.V1NonResourceRule item :nonResourceRules){ this.addToNonResourceRules(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<A> addNewNonResourceRule() {
    return new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluentImpl.NonResourceRulesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<A> addNewNonResourceRuleLike(io.kubernetes.client.openapi.models.V1NonResourceRule item) {
    return new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluentImpl.NonResourceRulesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<A> setNewNonResourceRuleLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NonResourceRule item) {
    return new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluentImpl.NonResourceRulesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<A> editNonResourceRule(java.lang.Integer index) {
  ...
  public A addToResourceRules(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ResourceRule item) {
    if (this.resourceRules == null) {this.resourceRules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ResourceRuleBuilder>();}
  ...
  public A setToResourceRules(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ResourceRule item) {
    if (this.resourceRules == null) {this.resourceRules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ResourceRuleBuilder>();}
    io.kubernetes.client.openapi.models.V1ResourceRuleBuilder builder = new io.kubernetes.client.openapi.models.V1ResourceRuleBuilder(item);
  ...
  public A addToResourceRules(io.kubernetes.client.openapi.models.V1ResourceRule... items) {
    if (this.resourceRules == null) {this.resourceRules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ResourceRuleBuilder>();}
    for (io.kubernetes.client.openapi.models.V1ResourceRule item : items) {io.kubernetes.client.openapi.models.V1ResourceRuleBuilder builder = new io.kubernetes.client.openapi.models.V1ResourceRuleBuilder(item);_visitables.get("resourceRules").add(builder);this.resourceRules.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromResourceRules(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ResourceRuleBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1ResourceRuleBuilder> each = resourceRules.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1ResourceRule buildMatchingResourceRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ResourceRuleBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ResourceRuleBuilder item: resourceRules) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingResourceRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ResourceRuleBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ResourceRuleBuilder item: resourceRules) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withResourceRules(java.util.List<io.kubernetes.client.openapi.models.V1ResourceRule> resourceRules) {
    ...
    if (resourceRules != null) {this.resourceRules = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1ResourceRule item : resourceRules){this.addToResourceRules(item);}} else { this.resourceRules = null;} return (A) this;
  }
  public A withResourceRules(io.kubernetes.client.openapi.models.V1ResourceRule... resourceRules) {
    ...
    if (resourceRules != null) {for (io.kubernetes.client.openapi.models.V1ResourceRule item :resourceRules){ this.addToResourceRules(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.ResourceRulesNested<A> addNewResourceRule() {
    return new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluentImpl.ResourceRulesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.ResourceRulesNested<A> addNewResourceRuleLike(io.kubernetes.client.openapi.models.V1ResourceRule item) {
    return new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluentImpl.ResourceRulesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.ResourceRulesNested<A> setNewResourceRuleLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ResourceRule item) {
    return new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluentImpl.ResourceRulesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.ResourceRulesNested<A> editResourceRule(java.lang.Integer index) {
  ...
  public class NonResourceRulesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1NonResourceRuleFluentImpl<io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<N>> implements io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    NonResourceRulesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NonResourceRule item) {
      this.index = index;
  ...
  public class ResourceRulesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ResourceRuleFluentImpl<io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.ResourceRulesNested<N>> implements io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.ResourceRulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ResourceRulesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ResourceRule item) {
      this.index = index;
