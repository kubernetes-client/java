...
public class V2beta1MetricSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent<A> {

    private io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSourceBuilder containerResource;
    ...
    public V2beta1MetricSpecFluentImpl(io.kubernetes.client.openapi.models.V2beta1MetricSpec instance) {
    ...
    public A withContainerResource(io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSource containerResource) {
        ...
        if (containerResource!=null){ this.containerResource= new io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSourceBuilder(containerResource); _visitables.get("containerResource").add(this.containerResource);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ContainerResourceNested<A> withNewContainerResource() {
        return new io.kubernetes.client.openapi.models.V2beta1MetricSpecFluentImpl.ContainerResourceNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ContainerResourceNested<A> withNewContainerResourceLike(io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSource item) {
        return new io.kubernetes.client.openapi.models.V2beta1MetricSpecFluentImpl.ContainerResourceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ContainerResourceNested<A> editOrNewContainerResource() {
        return withNewContainerResourceLike(getContainerResource() != null ? getContainerResource(): new io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSourceBuilder().build());
    }
    ...
    public A withExternal(io.kubernetes.client.openapi.models.V2beta1ExternalMetricSource external) {
        ...
        if (external!=null){ this.external= new io.kubernetes.client.openapi.models.V2beta1ExternalMetricSourceBuilder(external); _visitables.get("external").add(this.external);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ExternalNested<A> withNewExternalLike(io.kubernetes.client.openapi.models.V2beta1ExternalMetricSource item) {
        return new io.kubernetes.client.openapi.models.V2beta1MetricSpecFluentImpl.ExternalNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ExternalNested<A> editOrNewExternal() {
        return withNewExternalLike(getExternal() != null ? getExternal(): new io.kubernetes.client.openapi.models.V2beta1ExternalMetricSourceBuilder().build());
    }
    ...
    public A withObject(io.kubernetes.client.openapi.models.V2beta1ObjectMetricSource _object) {
        ...
        if (_object!=null){ this._object= new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceBuilder(_object); _visitables.get("_object").add(this._object);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ObjectNested<A> withNewObjectLike(io.kubernetes.client.openapi.models.V2beta1ObjectMetricSource item) {
        return new io.kubernetes.client.openapi.models.V2beta1MetricSpecFluentImpl.ObjectNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ObjectNested<A> editOrNewObject() {
        return withNewObjectLike(getObject() != null ? getObject(): new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceBuilder().build());
    }
    ...
    public A withPods(io.kubernetes.client.openapi.models.V2beta1PodsMetricSource pods) {
        ...
        if (pods!=null){ this.pods= new io.kubernetes.client.openapi.models.V2beta1PodsMetricSourceBuilder(pods); _visitables.get("pods").add(this.pods);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.PodsNested<A> editOrNewPods() {
        return withNewPodsLike(getPods() != null ? getPods(): new io.kubernetes.client.openapi.models.V2beta1PodsMetricSourceBuilder().build());
    }
    ...
    public A withResource(io.kubernetes.client.openapi.models.V2beta1ResourceMetricSource resource) {
        ...
        if (resource!=null){ this.resource= new io.kubernetes.client.openapi.models.V2beta1ResourceMetricSourceBuilder(resource); _visitables.get("resource").add(this.resource);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ResourceNested<A> withNewResourceLike(io.kubernetes.client.openapi.models.V2beta1ResourceMetricSource item) {
        return new io.kubernetes.client.openapi.models.V2beta1MetricSpecFluentImpl.ResourceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ResourceNested<A> editOrNewResource() {
        return withNewResourceLike(getResource() != null ? getResource(): new io.kubernetes.client.openapi.models.V2beta1ResourceMetricSourceBuilder().build());
    }
    ...
    public class ContainerResourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ContainerResourceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSourceBuilder builder;

            ContainerResourceNestedImpl(io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSourceBuilder(this, item);
                        
            }

            ContainerResourceNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSourceBuilder(this);
    ...
    public class ExternalNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1ExternalMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1ExternalMetricSourceBuilder builder;

            ExternalNestedImpl(io.kubernetes.client.openapi.models.V2beta1ExternalMetricSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1ExternalMetricSourceBuilder(this, item);
                        
            }

            ExternalNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1ExternalMetricSourceBuilder(this);
    ...
    public class ObjectNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceBuilder builder;

            ObjectNestedImpl(io.kubernetes.client.openapi.models.V2beta1ObjectMetricSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceBuilder(this, item);
    ...
    public class PodsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1PodsMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1PodsMetricSourceBuilder builder;

            PodsNestedImpl(io.kubernetes.client.openapi.models.V2beta1PodsMetricSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1PodsMetricSourceBuilder(this, item);
    ...
    public class ResourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1ResourceMetricSourceFluentImpl<io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1ResourceMetricSourceBuilder builder;

            ResourceNestedImpl(io.kubernetes.client.openapi.models.V2beta1ResourceMetricSource item) {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1ResourceMetricSourceBuilder(this, item);
                        
            }

            ResourceNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V2beta1ResourceMetricSourceBuilder(this);
