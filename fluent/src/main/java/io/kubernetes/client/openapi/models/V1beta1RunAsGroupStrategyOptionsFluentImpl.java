...
public class V1beta1RunAsGroupStrategyOptionsFluentImpl<
    ...
    extends BaseFluent<A> implements V1beta1RunAsGroupStrategyOptionsFluent<A> {
  ...
  public V1beta1RunAsGroupStrategyOptionsFluent.RangesNested<A> addNewRange() {
    return new V1beta1RunAsGroupStrategyOptionsFluentImpl.RangesNestedImpl();
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptionsFluent.RangesNested<A>
    ...
    return new V1beta1RunAsGroupStrategyOptionsFluentImpl.RangesNestedImpl(-1, item);
  }
  ...
  class RangesNestedImpl<N>
      extends V1beta1IDRangeFluentImpl<V1beta1RunAsGroupStrategyOptionsFluent.RangesNested<N>>
