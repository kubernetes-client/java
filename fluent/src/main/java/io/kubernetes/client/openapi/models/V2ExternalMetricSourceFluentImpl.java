...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2ExternalMetricSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent<A>{
  public V2ExternalMetricSourceFluentImpl() {
  }
  public V2ExternalMetricSourceFluentImpl(io.kubernetes.client.openapi.models.V2ExternalMetricSource instance) {
  ...
  public io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent.MetricNested<A> withNewMetric() {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluentImpl.MetricNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent.MetricNested<A> withNewMetricLike(io.kubernetes.client.openapi.models.V2MetricIdentifier item) {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluentImpl.MetricNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent.TargetNested<A> withNewTarget() {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluentImpl.TargetNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent.TargetNested<A> withNewTargetLike(io.kubernetes.client.openapi.models.V2MetricTarget item) {
    return new io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluentImpl.TargetNestedImpl(item);
  }
  ...
  public class MetricNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricIdentifierFluentImpl<io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent.MetricNested<N>> implements io.kubernetes.client.openapi.models.V2ExternalMetricSourceFluent.MetricNested<N>,io.kubernetes.client.fluent.Nested<N>{
