...
public class V1StorageClassListFluent<A extends io.kubernetes.client.openapi.models.V1StorageClassListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1StorageClassBuilder> predicate) {
    ...
    Iterator<V1StorageClassBuilder> each = items.iterator();
