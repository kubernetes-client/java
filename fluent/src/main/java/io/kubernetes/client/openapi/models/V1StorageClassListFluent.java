...
public class V1StorageClassListFluent<A extends V1StorageClassListFluent<A>> extends BaseFluent<A>{
  public V1StorageClassListFluent() {
  }
  
  public V1StorageClassListFluent(V1StorageClassList instance) {
  ...
  protected void copyInstance(V1StorageClassList instance) {
    instance = (instance != null ? instance : new V1StorageClassList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1StorageClass... items) {
    ...
    for (V1StorageClass item : items) {V1StorageClassBuilder builder = new V1StorageClassBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1StorageClass buildMatchingItem(Predicate<V1StorageClassBuilder> predicate) {
      for (V1StorageClassBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1StorageClass item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1StorageClass item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1StorageClassBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1StorageClassListFluent that = (V1StorageClassListFluent) o;
  ...
  public class ItemsNested<N> extends V1StorageClassFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1StorageClass item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1StorageClassListFluent.this.withMetadata(builder.build());
    }
