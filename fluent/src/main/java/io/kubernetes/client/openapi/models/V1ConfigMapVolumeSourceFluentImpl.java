...
public class V1ConfigMapVolumeSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent<A> {
    ...
    public V1ConfigMapVolumeSourceFluentImpl(io.kubernetes.client.openapi.models.V1ConfigMapVolumeSource instance) {
    ...
    public io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1KeyToPath item) {
        return new io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluentImpl.ItemsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1KeyToPath item) {
        return new io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluentImpl.ItemsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent.ItemsNested<A> editItem(int index) {
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1KeyToPathFluentImpl<io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1ConfigMapVolumeSourceFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
