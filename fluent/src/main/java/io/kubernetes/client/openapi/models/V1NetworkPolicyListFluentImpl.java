...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1NetworkPolicy item) {
    ...
    V1NetworkPolicyBuilder builder = new V1NetworkPolicyBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1NetworkPolicyFluentImpl<V1NetworkPolicyListFluent.ItemsNested<N>> implements V1NetworkPolicyListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1NetworkPolicy item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1NetworkPolicyListFluent.MetadataNested<N>> implements V1NetworkPolicyListFluent.MetadataNested<N>,Nested<N>{
