...
import java.util.Map;
  ...
  * Generated
  */
public class V1SchedulingFluentImpl<A extends io.kubernetes.client.openapi.models.V1SchedulingFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1SchedulingFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<A> addNewToleration() {
    return new io.kubernetes.client.openapi.models.V1SchedulingFluentImpl.TolerationsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<A> addNewTolerationLike(io.kubernetes.client.openapi.models.V1Toleration item) {
    return new io.kubernetes.client.openapi.models.V1SchedulingFluentImpl.TolerationsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<A> setNewTolerationLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Toleration item) {
    return new io.kubernetes.client.openapi.models.V1SchedulingFluentImpl.TolerationsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<A> editToleration(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<A> editFirstToleration() {
  ...
  public io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<A> editLastToleration() {
    int index = tolerations.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last tolerations. The list is empty.");
    return setNewTolerationLike(index, buildToleration(index));
  }
  public io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<A> editMatchingToleration(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TolerationBuilder> predicate) {
    int index = -1;
  ...
  public class TolerationsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TolerationFluentImpl<io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<N>> implements io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<N>,io.kubernetes.client.fluent.Nested<N>{
