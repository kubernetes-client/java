...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2HorizontalPodAutoscalerBehaviorFluentImpl<A extends io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent<A>{
  ...
  public A withScaleDown(io.kubernetes.client.openapi.models.V2HPAScalingRules scaleDown) {
    ...
    if (scaleDown!=null){ this.scaleDown= new io.kubernetes.client.openapi.models.V2HPAScalingRulesBuilder(scaleDown); _visitables.get("scaleDown").add(this.scaleDown);} return (A) this;
  }
  public java.lang.Boolean hasScaleDown() {
    return this.scaleDown != null;
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleDownNested<A> withNewScaleDown() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluentImpl.ScaleDownNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleDownNested<A> withNewScaleDownLike(io.kubernetes.client.openapi.models.V2HPAScalingRules item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluentImpl.ScaleDownNestedImpl(item);
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleDownNested<A> editScaleDown() {
    return withNewScaleDownLike(getScaleDown());
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleDownNested<A> editOrNewScaleDown() {
    return withNewScaleDownLike(getScaleDown() != null ? getScaleDown(): new io.kubernetes.client.openapi.models.V2HPAScalingRulesBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleDownNested<A> editOrNewScaleDownLike(io.kubernetes.client.openapi.models.V2HPAScalingRules item) {
  ...
  public A withScaleUp(io.kubernetes.client.openapi.models.V2HPAScalingRules scaleUp) {
    ...
    if (scaleUp!=null){ this.scaleUp= new io.kubernetes.client.openapi.models.V2HPAScalingRulesBuilder(scaleUp); _visitables.get("scaleUp").add(this.scaleUp);} return (A) this;
  }
  public java.lang.Boolean hasScaleUp() {
    return this.scaleUp != null;
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleUpNested<A> withNewScaleUp() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluentImpl.ScaleUpNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleUpNested<A> withNewScaleUpLike(io.kubernetes.client.openapi.models.V2HPAScalingRules item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluentImpl.ScaleUpNestedImpl(item);
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleUpNested<A> editScaleUp() {
    return withNewScaleUpLike(getScaleUp());
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleUpNested<A> editOrNewScaleUp() {
    return withNewScaleUpLike(getScaleUp() != null ? getScaleUp(): new io.kubernetes.client.openapi.models.V2HPAScalingRulesBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorFluent.ScaleUpNested<A> editOrNewScaleUpLike(io.kubernetes.client.openapi.models.V2HPAScalingRules item) {
