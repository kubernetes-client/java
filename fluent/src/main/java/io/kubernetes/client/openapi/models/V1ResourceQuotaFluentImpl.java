...
public class V1ResourceQuotaFluentImpl<A extends io.kubernetes.client.openapi.models.V1ResourceQuotaFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ResourceQuotaFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1ResourceQuotaFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1ResourceQuotaSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1ResourceQuotaSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1ResourceQuotaSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1ResourceQuotaStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1ResourceQuotaStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1ResourceQuotaStatusBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ResourceQuotaSpecFluentImpl<io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ResourceQuotaSpecBuilder builder;
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ResourceQuotaStatusFluentImpl<io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ResourceQuotaStatusBuilder builder;

            StatusNestedImpl(io.kubernetes.client.openapi.models.V1ResourceQuotaStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ResourceQuotaStatusBuilder(this, item);
