...
import java.lang.Object;
  ...
  */
  ...
  public V1ResourceQuotaFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1ResourceQuotaFluentImpl.MetadataNestedImpl();
  }
  public V1ResourceQuotaFluentImpl.MetadataNested<A> withNewMetadataLike(V1ObjectMeta item) {
    return new V1ResourceQuotaFluentImpl.MetadataNestedImpl(item);
  }
  public V1ResourceQuotaFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1ResourceQuotaFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ObjectMetaBuilder().build());
  }
  public V1ResourceQuotaFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ObjectMeta item) {
  ...
  public V1ResourceQuotaFluentImpl.SpecNested<A> withNewSpec() {
    return new V1ResourceQuotaFluentImpl.SpecNestedImpl();
  }
  public V1ResourceQuotaFluentImpl.SpecNested<A> withNewSpecLike(V1ResourceQuotaSpec item) {
    return new V1ResourceQuotaFluentImpl.SpecNestedImpl(item);
  }
  public V1ResourceQuotaFluentImpl.SpecNested<A> editSpec() {
    return withNewSpecLike(getSpec());
  }
  public V1ResourceQuotaFluentImpl.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new V1ResourceQuotaSpecBuilder().build());
  }
  public V1ResourceQuotaFluentImpl.SpecNested<A> editOrNewSpecLike(V1ResourceQuotaSpec item) {
  ...
  public V1ResourceQuotaFluentImpl.StatusNested<A> withNewStatus() {
    return new V1ResourceQuotaFluentImpl.StatusNestedImpl();
  }
  public V1ResourceQuotaFluentImpl.StatusNested<A> withNewStatusLike(V1ResourceQuotaStatus item) {
    return new V1ResourceQuotaFluentImpl.StatusNestedImpl(item);
  }
  public V1ResourceQuotaFluentImpl.StatusNested<A> editStatus() {
    return withNewStatusLike(getStatus());
  }
  public V1ResourceQuotaFluentImpl.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(getStatus() != null ? getStatus(): new V1ResourceQuotaStatusBuilder().build());
  }
  public V1ResourceQuotaFluentImpl.StatusNested<A> editOrNewStatusLike(V1ResourceQuotaStatus item) {
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ResourceQuotaFluentImpl.MetadataNested<N>> implements V1ResourceQuotaFluentImpl.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1ResourceQuotaSpecFluentImpl<V1ResourceQuotaFluentImpl.SpecNested<N>> implements V1ResourceQuotaFluentImpl.SpecNested<N>,Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1ResourceQuotaStatusFluentImpl<V1ResourceQuotaFluentImpl.StatusNested<N>> implements V1ResourceQuotaFluentImpl.StatusNested<N>,Nested<N>{
