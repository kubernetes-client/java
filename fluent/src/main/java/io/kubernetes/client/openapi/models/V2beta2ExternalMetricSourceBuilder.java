...
public class V2beta2ExternalMetricSourceBuilder
    extends V2beta2ExternalMetricSourceFluentImpl<V2beta2ExternalMetricSourceBuilder>
    implements VisitableBuilder<V2beta2ExternalMetricSource, V2beta2ExternalMetricSourceBuilder> {
  ...
  public V2beta2ExternalMetricSourceBuilder(
      V2beta2ExternalMetricSourceFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V2beta2ExternalMetricSource(), validationEnabled);
  }

  public V2beta2ExternalMetricSourceBuilder(
      V2beta2ExternalMetricSourceFluent<?> fluent, V2beta2ExternalMetricSource instance) {
    this(fluent, instance, false);
  }

  public V2beta2ExternalMetricSourceBuilder(
      V2beta2ExternalMetricSourceFluent<?> fluent,
      V2beta2ExternalMetricSource instance,
  ...
  public V2beta2ExternalMetricSourceBuilder(
      V2beta2ExternalMetricSource instance, Boolean validationEnabled) {
    this.fluent = this;
