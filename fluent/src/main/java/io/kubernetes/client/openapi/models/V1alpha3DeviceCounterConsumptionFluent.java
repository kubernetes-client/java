...
public class V1alpha3DeviceCounterConsumptionFluent<A extends V1alpha3DeviceCounterConsumptionFluent<A>> extends BaseFluent<A>{
  public V1alpha3DeviceCounterConsumptionFluent() {
  }
  
  public V1alpha3DeviceCounterConsumptionFluent(V1alpha3DeviceCounterConsumption instance) {
    this.copyInstance(instance);
  }
  private String counterSet;
  private Map<String,V1alpha3Counter> counters;
  
  protected void copyInstance(V1alpha3DeviceCounterConsumption instance) {
    instance = (instance != null ? instance : new V1alpha3DeviceCounterConsumption());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3DeviceCounterConsumptionFluent that = (V1alpha3DeviceCounterConsumptionFluent) o;
