...
public class V1beta2FlowSchemaFluent<A extends V1beta2FlowSchemaFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(V1beta2FlowSchema instance) {
    instance = (instance != null ? instance : new V1beta2FlowSchema());
    if (instance != null) {
  ...
  public SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new V1beta2FlowSchemaSpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(java.util.Optional.ofNullable(buildStatus()).orElse(new V1beta2FlowSchemaStatusBuilder().build()));
  }
  ...
  public class MetadataNested<N> extends V1ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2FlowSchemaFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends V1beta2FlowSchemaSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2FlowSchemaFluent.this.withSpec(builder.build());
    }
  ...
  public class StatusNested<N> extends V1beta2FlowSchemaStatusFluent<StatusNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2FlowSchemaFluent.this.withStatus(builder.build());
    }
