...
public class V1ReplicationControllerListFluent<A extends V1ReplicationControllerListFluent<A>> extends BaseFluent<A>{
  public V1ReplicationControllerListFluent() {
  }
  
  public V1ReplicationControllerListFluent(V1ReplicationControllerList instance) {
  ...
  protected void copyInstance(V1ReplicationControllerList instance) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ReplicationController... items) {
    ...
    for (V1ReplicationController item : items) {V1ReplicationControllerBuilder builder = new V1ReplicationControllerBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1ReplicationController buildMatchingItem(Predicate<V1ReplicationControllerBuilder> predicate) {
      for (V1ReplicationControllerBuilder item : items) {
  ...
  public A withItems(List<V1ReplicationController> items) {
    ...
    if (items != null) {
        ...
        for (V1ReplicationController item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1ReplicationController item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1ReplicationController item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1ReplicationControllerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1ReplicationControllerListFluent that = (V1ReplicationControllerListFluent) o;
  ...
  public class ItemsNested<N> extends V1ReplicationControllerFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1ReplicationController item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ReplicationControllerListFluent.this.withMetadata(builder.build());
    }
