...
public class V1ReplicationControllerListFluent<A extends io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1ReplicationControllerBuilder> predicate) {
    ...
    Iterator<V1ReplicationControllerBuilder> each = items.iterator();
