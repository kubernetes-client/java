...
import java.lang.Object;
  ...
  * Generated
  */
public class V2HorizontalPodAutoscalerSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent<A>{
  ...
  public A withBehavior(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehavior behavior) {
    ...
    if (behavior!=null){ this.behavior= new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorBuilder(behavior); _visitables.get("behavior").add(this.behavior);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.BehaviorNested<A> withNewBehavior() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl.BehaviorNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.BehaviorNested<A> withNewBehaviorLike(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehavior item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl.BehaviorNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.BehaviorNested<A> editOrNewBehavior() {
    return withNewBehaviorLike(getBehavior() != null ? getBehavior(): new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehaviorBuilder().build());
  }
  ...
  public A addToMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2MetricSpec item) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2MetricSpecBuilder>();}
    io.kubernetes.client.openapi.models.V2MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2MetricSpecBuilder(item);_visitables.get("metrics").add(index >= 0 ? index : _visitables.get("metrics").size(), builder);this.metrics.add(index >= 0 ? index : metrics.size(), builder); return (A)this;
  }
  public A setToMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2MetricSpec item) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2MetricSpecBuilder>();}
    io.kubernetes.client.openapi.models.V2MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2MetricSpecBuilder(item);
  ...
  public A addToMetrics(io.kubernetes.client.openapi.models.V2MetricSpec... items) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2MetricSpecBuilder>();}
    for (io.kubernetes.client.openapi.models.V2MetricSpec item : items) {io.kubernetes.client.openapi.models.V2MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2MetricSpecBuilder(item);_visitables.get("metrics").add(builder);this.metrics.add(builder);} return (A)this;
  }
  ...
  public A removeFromMetrics(io.kubernetes.client.openapi.models.V2MetricSpec... items) {
    for (io.kubernetes.client.openapi.models.V2MetricSpec item : items) {io.kubernetes.client.openapi.models.V2MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2MetricSpecBuilder(item);_visitables.get("metrics").remove(builder);if (this.metrics != null) {this.metrics.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromMetrics(java.util.function.Predicate<io.kubernetes.client.openapi.models.V2MetricSpecBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V2MetricSpecBuilder> each = metrics.iterator();
  ...
  public io.kubernetes.client.openapi.models.V2MetricSpec buildMatchingMetric(java.util.function.Predicate<io.kubernetes.client.openapi.models.V2MetricSpecBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V2MetricSpecBuilder item: metrics) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingMetric(java.util.function.Predicate<io.kubernetes.client.openapi.models.V2MetricSpecBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V2MetricSpecBuilder item: metrics) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withMetrics(java.util.List<io.kubernetes.client.openapi.models.V2MetricSpec> metrics) {
    ...
    if (metrics != null) {this.metrics = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V2MetricSpec item : metrics){this.addToMetrics(item);}} else { this.metrics = null;} return (A) this;
  }
  public A withMetrics(io.kubernetes.client.openapi.models.V2MetricSpec... metrics) {
    if (this.metrics != null) {this.metrics.clear();}
    if (metrics != null) {for (io.kubernetes.client.openapi.models.V2MetricSpec item :metrics){ this.addToMetrics(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.MetricsNested<A> addNewMetric() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl.MetricsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.MetricsNested<A> addNewMetricLike(io.kubernetes.client.openapi.models.V2MetricSpec item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl.MetricsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.MetricsNested<A> setNewMetricLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V2MetricSpec item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl.MetricsNestedImpl(index, item);
  }
  ...
  public A withScaleTargetRef(io.kubernetes.client.openapi.models.V2CrossVersionObjectReference scaleTargetRef) {
    ...
    if (scaleTargetRef!=null){ this.scaleTargetRef= new io.kubernetes.client.openapi.models.V2CrossVersionObjectReferenceBuilder(scaleTargetRef); _visitables.get("scaleTargetRef").add(this.scaleTargetRef);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<A> withNewScaleTargetRef() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl.ScaleTargetRefNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<A> withNewScaleTargetRefLike(io.kubernetes.client.openapi.models.V2CrossVersionObjectReference item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl.ScaleTargetRefNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<A> editOrNewScaleTargetRef() {
    return withNewScaleTargetRefLike(getScaleTargetRef() != null ? getScaleTargetRef(): new io.kubernetes.client.openapi.models.V2CrossVersionObjectReferenceBuilder().build());
  }
  ...
  public class ScaleTargetRefNestedImpl<N> extends io.kubernetes.client.openapi.models.V2CrossVersionObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ScaleTargetRefNestedImpl(io.kubernetes.client.openapi.models.V2CrossVersionObjectReference item) {
