...
import java.lang.Object;
  ...
  */
  ...
  public V1PodTemplateListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1PodTemplateListFluentImpl.ItemsNestedImpl();
  }
  public V1PodTemplateListFluentImpl.ItemsNested<A> addNewItemLike(V1PodTemplate item) {
    return new V1PodTemplateListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1PodTemplateListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1PodTemplate item) {
    return new V1PodTemplateListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1PodTemplateListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1PodTemplateListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1PodTemplateListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1PodTemplateListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1PodTemplateBuilder> predicate) {
    int index = -1;
  ...
  public V1PodTemplateListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1PodTemplateListFluentImpl.MetadataNestedImpl();
  }
  public V1PodTemplateListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1PodTemplateListFluentImpl.MetadataNestedImpl(item);
  }
  public V1PodTemplateListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1PodTemplateListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1PodTemplateListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1PodTemplateFluentImpl<V1PodTemplateListFluentImpl.ItemsNested<N>> implements V1PodTemplateListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1PodTemplate item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1PodTemplateListFluentImpl.MetadataNested<N>> implements V1PodTemplateListFluentImpl.MetadataNested<N>,Nested<N>{
