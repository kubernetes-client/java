...
public class V1JobConditionFluent<A extends io.kubernetes.client.openapi.models.V1JobConditionFluent<A>> extends BaseFluent<A>{
  ...
  public V1JobConditionFluent() {
  }
  
  public V1JobConditionFluent(V1JobCondition instance) {
    this.copyInstance(instance);
  }

  protected void copyInstance(V1JobCondition instance) {
    instance = instance != null ? instance : new V1JobCondition();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1JobConditionFluent that = (V1JobConditionFluent) o;
