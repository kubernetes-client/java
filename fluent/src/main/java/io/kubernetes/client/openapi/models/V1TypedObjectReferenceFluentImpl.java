...
import java.lang.Boolean;
  ...
  */
  ...
  public class V1TypedObjectReferenceFluentImpl<A extends V1TypedObjectReferenceFluent<A>> extends BaseFluent<A> implements V1TypedObjectReferenceFluent<A>{
  public V1TypedObjectReferenceFluentImpl() {
  }
  public V1TypedObjectReferenceFluentImpl(V1TypedObjectReference instance) {
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1TypedObjectReferenceFluentImpl that = (V1TypedObjectReferenceFluentImpl) o;
