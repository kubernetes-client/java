...
public class V1alpha1NamedRuleWithOperationsFluent<A extends V1alpha1NamedRuleWithOperationsFluent<A>> extends BaseFluent<A>{
  public V1alpha1NamedRuleWithOperationsFluent() {
  }
  
  public V1alpha1NamedRuleWithOperationsFluent(V1alpha1NamedRuleWithOperations instance) {
  ...
  protected void copyInstance(V1alpha1NamedRuleWithOperations instance) {
    instance = (instance != null ? instance : new V1alpha1NamedRuleWithOperations());
    if (instance != null) {
  ...
  public A withOperations(java.lang.String... operations) {
    if (this.operations != null) {this.operations.clear(); _visitables.remove("operations"); }
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1NamedRuleWithOperationsFluent that = (V1alpha1NamedRuleWithOperationsFluent) o;
