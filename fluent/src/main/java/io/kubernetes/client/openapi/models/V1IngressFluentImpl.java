...
/** Generated */
public class V1IngressFluentImpl<A extends io.kubernetes.client.openapi.models.V1IngressFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1IngressFluent<A> {
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1IngressSpec spec) {
    ...
    if (spec != null) {
      this.spec = new io.kubernetes.client.openapi.models.V1IngressSpecBuilder(spec);
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1IngressStatus status) {
    ...
    if (status != null) {
      this.status = new io.kubernetes.client.openapi.models.V1IngressStatusBuilder(status);
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1IngressFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1IngressFluent.MetadataNested<N>,
  ...
  public class SpecNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1IngressSpecFluentImpl<
          io.kubernetes.client.openapi.models.V1IngressFluent.SpecNested<N>>
  ...
  public class StatusNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1IngressStatusFluentImpl<
          io.kubernetes.client.openapi.models.V1IngressFluent.StatusNested<N>>
