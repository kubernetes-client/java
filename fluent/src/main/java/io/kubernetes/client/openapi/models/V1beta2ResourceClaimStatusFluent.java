...
public class V1beta2ResourceClaimStatusFluent<A extends io.kubernetes.client.openapi.models.V1beta2ResourceClaimStatusFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta2AllocatedDeviceStatus buildMatchingDevice(Predicate<V1beta2AllocatedDeviceStatusBuilder> predicate) {
      for (V1beta2AllocatedDeviceStatusBuilder item : devices) {
  ...
  public V1beta2ResourceClaimConsumerReference buildMatchingReservedFor(Predicate<V1beta2ResourceClaimConsumerReferenceBuilder> predicate) {
      for (V1beta2ResourceClaimConsumerReferenceBuilder item : reservedFor) {
        if (predicate.test(item)) {
          return item.build();
        }
      }
  ...
  public class AllocationNested<N> extends V1beta2AllocationResultFluent<AllocationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2ResourceClaimStatusFluent.this.withAllocation(builder.build());
    }
  ...
  public class DevicesNested<N> extends V1beta2AllocatedDeviceStatusFluent<DevicesNested<N>> implements Nested<N>{
  ...
  public class ReservedForNested<N> extends V1beta2ResourceClaimConsumerReferenceFluent<ReservedForNested<N>> implements Nested<N>{
