...
public class V1CustomResourceDefinitionNamesBuilder extends io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNamesFluentImpl<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNamesBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNames,io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNamesBuilder> {
    ...
    public V1CustomResourceDefinitionNamesBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNamesFluent<?> fluent) {
        this(fluent, true);
    }

    public V1CustomResourceDefinitionNamesBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNamesFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1CustomResourceDefinitionNames(), validationEnabled);
    }

    public V1CustomResourceDefinitionNamesBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNamesFluent<?> fluent,io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNames instance) {
        this(fluent, instance, true);
    }

    public V1CustomResourceDefinitionNamesBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNamesFluent<?> fluent,io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNames instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1CustomResourceDefinitionNamesBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNames instance) {
        this(instance,true);
    }

    public V1CustomResourceDefinitionNamesBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionNames instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
