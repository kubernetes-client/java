...
public class V1ScaleIOVolumeSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceFluent.SecretRefNested<A> withNewSecretRef() {
        return new io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceFluentImpl.SecretRefNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceFluent.SecretRefNested<A> withNewSecretRefLike(io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
        return new io.kubernetes.client.openapi.models.V1ScaleIOVolumeSourceFluentImpl.SecretRefNestedImpl(item);
    }
