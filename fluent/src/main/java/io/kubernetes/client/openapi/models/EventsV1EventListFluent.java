...
public class EventsV1EventListFluent<A extends EventsV1EventListFluent<A>> extends BaseFluent<A>{
  public EventsV1EventListFluent() {
  }
  
  public EventsV1EventListFluent(EventsV1EventList instance) {
  ...
  protected void copyInstance(EventsV1EventList instance) {
    instance = (instance != null ? instance : new EventsV1EventList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.EventsV1Event... items) {
    ...
    for (EventsV1Event item : items) {EventsV1EventBuilder builder = new EventsV1EventBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public EventsV1Event buildMatchingItem(Predicate<EventsV1EventBuilder> predicate) {
      for (EventsV1EventBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(EventsV1Event item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,EventsV1Event item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<EventsV1EventBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    EventsV1EventListFluent that = (EventsV1EventListFluent) o;
  ...
  public class ItemsNested<N> extends EventsV1EventFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,EventsV1Event item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EventsV1EventListFluent.this.withMetadata(builder.build());
    }
