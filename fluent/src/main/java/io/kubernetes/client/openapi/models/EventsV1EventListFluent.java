...
public class EventsV1EventListFluent<A extends io.kubernetes.client.openapi.models.EventsV1EventListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<EventsV1EventBuilder> predicate) {
    ...
    Iterator<EventsV1EventBuilder> each = items.iterator();
