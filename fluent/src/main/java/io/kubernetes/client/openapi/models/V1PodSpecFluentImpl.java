...
import java.lang.Integer;
  ...
  * Generated
  */
public class V1PodSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodSpecFluent<A>{
  ...
  public A withAffinity(io.kubernetes.client.openapi.models.V1Affinity affinity) {
    ...
    if (affinity!=null){ this.affinity= new io.kubernetes.client.openapi.models.V1AffinityBuilder(affinity); _visitables.get("affinity").add(this.affinity);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.AffinityNested<A> withNewAffinityLike(io.kubernetes.client.openapi.models.V1Affinity item) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.AffinityNested<A> editOrNewAffinity() {
    return withNewAffinityLike(getAffinity() != null ? getAffinity(): new io.kubernetes.client.openapi.models.V1AffinityBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.AffinityNested<A> editOrNewAffinityLike(io.kubernetes.client.openapi.models.V1Affinity item) {
  ...
  public A addToContainers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
    if (this.containers == null) {this.containers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("containers").add(index >= 0 ? index : _visitables.get("containers").size(), builder);this.containers.add(index >= 0 ? index : containers.size(), builder); return (A)this;
  }
  public A setToContainers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
    if (this.containers == null) {this.containers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);
  ...
  public A addToContainers(io.kubernetes.client.openapi.models.V1Container... items) {
    if (this.containers == null) {this.containers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("containers").add(builder);this.containers.add(builder);} return (A)this;
  }
  public A addAllToContainers(java.util.Collection<io.kubernetes.client.openapi.models.V1Container> items) {
    if (this.containers == null) {this.containers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("containers").add(builder);this.containers.add(builder);} return (A)this;
  }
  public A removeFromContainers(io.kubernetes.client.openapi.models.V1Container... items) {
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("containers").remove(builder);if (this.containers != null) {this.containers.remove(builder);}} return (A)this;
  }
  public A removeAllFromContainers(java.util.Collection<io.kubernetes.client.openapi.models.V1Container> items) {
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("containers").remove(builder);if (this.containers != null) {this.containers.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromContainers(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    if (containers == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.V1ContainerBuilder> each = containers.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1Container buildMatchingContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ContainerBuilder item: containers) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ContainerBuilder item: containers) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withContainers(java.util.List<io.kubernetes.client.openapi.models.V1Container> containers) {
    if (this.containers != null) { _visitables.get("containers").removeAll(this.containers);}
    if (containers != null) {this.containers = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Container item : containers){this.addToContainers(item);}} else { this.containers = null;} return (A) this;
  }
  public A withContainers(io.kubernetes.client.openapi.models.V1Container... containers) {
    ...
    if (containers != null) {for (io.kubernetes.client.openapi.models.V1Container item :containers){ this.addToContainers(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<A> addNewContainerLike(io.kubernetes.client.openapi.models.V1Container item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ContainersNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<A> setNewContainerLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ContainersNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<A> editContainer(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<A> editFirstContainer() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<A> editLastContainer() {
    int index = containers.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last containers. The list is empty.");
    return setNewContainerLike(index, buildContainer(index));
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<A> editMatchingContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    int index = -1;
  ...
  public A withDnsConfig(io.kubernetes.client.openapi.models.V1PodDNSConfig dnsConfig) {
    ...
    if (dnsConfig!=null){ this.dnsConfig= new io.kubernetes.client.openapi.models.V1PodDNSConfigBuilder(dnsConfig); _visitables.get("dnsConfig").add(this.dnsConfig);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.DnsConfigNested<A> withNewDnsConfigLike(io.kubernetes.client.openapi.models.V1PodDNSConfig item) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.DnsConfigNested<A> editOrNewDnsConfig() {
    return withNewDnsConfigLike(getDnsConfig() != null ? getDnsConfig(): new io.kubernetes.client.openapi.models.V1PodDNSConfigBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.DnsConfigNested<A> editOrNewDnsConfigLike(io.kubernetes.client.openapi.models.V1PodDNSConfig item) {
  ...
  public A addToEphemeralContainers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EphemeralContainer item) {
    if (this.ephemeralContainers == null) {this.ephemeralContainers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder>();}
  ...
  public A setToEphemeralContainers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EphemeralContainer item) {
    if (this.ephemeralContainers == null) {this.ephemeralContainers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder>();}
    io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder builder = new io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder(item);
  ...
  public A addAllToEphemeralContainers(java.util.Collection<io.kubernetes.client.openapi.models.V1EphemeralContainer> items) {
    if (this.ephemeralContainers == null) {this.ephemeralContainers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1EphemeralContainer item : items) {io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder builder = new io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder(item);_visitables.get("ephemeralContainers").add(builder);this.ephemeralContainers.add(builder);} return (A)this;
  }
  ...
  public A removeAllFromEphemeralContainers(java.util.Collection<io.kubernetes.client.openapi.models.V1EphemeralContainer> items) {
    for (io.kubernetes.client.openapi.models.V1EphemeralContainer item : items) {io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder builder = new io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder(item);_visitables.get("ephemeralContainers").remove(builder);if (this.ephemeralContainers != null) {this.ephemeralContainers.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromEphemeralContainers(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder> predicate) {
    if (ephemeralContainers == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder> each = ephemeralContainers.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1EphemeralContainer buildMatchingEphemeralContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder item: ephemeralContainers) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingEphemeralContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder item: ephemeralContainers) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withEphemeralContainers(java.util.List<io.kubernetes.client.openapi.models.V1EphemeralContainer> ephemeralContainers) {
    if (this.ephemeralContainers != null) { _visitables.get("ephemeralContainers").removeAll(this.ephemeralContainers);}
    if (ephemeralContainers != null) {this.ephemeralContainers = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1EphemeralContainer item : ephemeralContainers){this.addToEphemeralContainers(item);}} else { this.ephemeralContainers = null;} return (A) this;
  }
  public A withEphemeralContainers(io.kubernetes.client.openapi.models.V1EphemeralContainer... ephemeralContainers) {
    ...
    if (ephemeralContainers != null) {for (io.kubernetes.client.openapi.models.V1EphemeralContainer item :ephemeralContainers){ this.addToEphemeralContainers(item);}} return (A) this;
  }
  public java.lang.Boolean hasEphemeralContainers() {
    return ephemeralContainers != null && !ephemeralContainers.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<A> addNewEphemeralContainer() {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.EphemeralContainersNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<A> addNewEphemeralContainerLike(io.kubernetes.client.openapi.models.V1EphemeralContainer item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.EphemeralContainersNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<A> setNewEphemeralContainerLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EphemeralContainer item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.EphemeralContainersNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<A> editEphemeralContainer(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<A> editFirstEphemeralContainer() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<A> editLastEphemeralContainer() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<A> editMatchingEphemeralContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder> predicate) {
    int index = -1;
  ...
  public A addToHostAliases(java.lang.Integer index,io.kubernetes.client.openapi.models.V1HostAlias item) {
    if (this.hostAliases == null) {this.hostAliases = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HostAliasBuilder>();}
    io.kubernetes.client.openapi.models.V1HostAliasBuilder builder = new io.kubernetes.client.openapi.models.V1HostAliasBuilder(item);_visitables.get("hostAliases").add(index >= 0 ? index : _visitables.get("hostAliases").size(), builder);this.hostAliases.add(index >= 0 ? index : hostAliases.size(), builder); return (A)this;
  }
  public A setToHostAliases(java.lang.Integer index,io.kubernetes.client.openapi.models.V1HostAlias item) {
    if (this.hostAliases == null) {this.hostAliases = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HostAliasBuilder>();}
    io.kubernetes.client.openapi.models.V1HostAliasBuilder builder = new io.kubernetes.client.openapi.models.V1HostAliasBuilder(item);
  ...
  public A addToHostAliases(io.kubernetes.client.openapi.models.V1HostAlias... items) {
    if (this.hostAliases == null) {this.hostAliases = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HostAliasBuilder>();}
    for (io.kubernetes.client.openapi.models.V1HostAlias item : items) {io.kubernetes.client.openapi.models.V1HostAliasBuilder builder = new io.kubernetes.client.openapi.models.V1HostAliasBuilder(item);_visitables.get("hostAliases").add(builder);this.hostAliases.add(builder);} return (A)this;
  }
  public A addAllToHostAliases(java.util.Collection<io.kubernetes.client.openapi.models.V1HostAlias> items) {
    if (this.hostAliases == null) {this.hostAliases = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1HostAliasBuilder>();}
    for (io.kubernetes.client.openapi.models.V1HostAlias item : items) {io.kubernetes.client.openapi.models.V1HostAliasBuilder builder = new io.kubernetes.client.openapi.models.V1HostAliasBuilder(item);_visitables.get("hostAliases").add(builder);this.hostAliases.add(builder);} return (A)this;
  }
  public A removeFromHostAliases(io.kubernetes.client.openapi.models.V1HostAlias... items) {
    for (io.kubernetes.client.openapi.models.V1HostAlias item : items) {io.kubernetes.client.openapi.models.V1HostAliasBuilder builder = new io.kubernetes.client.openapi.models.V1HostAliasBuilder(item);_visitables.get("hostAliases").remove(builder);if (this.hostAliases != null) {this.hostAliases.remove(builder);}} return (A)this;
  }
  public A removeAllFromHostAliases(java.util.Collection<io.kubernetes.client.openapi.models.V1HostAlias> items) {
    for (io.kubernetes.client.openapi.models.V1HostAlias item : items) {io.kubernetes.client.openapi.models.V1HostAliasBuilder builder = new io.kubernetes.client.openapi.models.V1HostAliasBuilder(item);_visitables.get("hostAliases").remove(builder);if (this.hostAliases != null) {this.hostAliases.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromHostAliases(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HostAliasBuilder> predicate) {
    if (hostAliases == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.V1HostAliasBuilder> each = hostAliases.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1HostAlias buildMatchingHostAlias(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HostAliasBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1HostAliasBuilder item: hostAliases) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingHostAlias(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HostAliasBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1HostAliasBuilder item: hostAliases) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withHostAliases(java.util.List<io.kubernetes.client.openapi.models.V1HostAlias> hostAliases) {
    if (this.hostAliases != null) { _visitables.get("hostAliases").removeAll(this.hostAliases);}
    if (hostAliases != null) {this.hostAliases = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1HostAlias item : hostAliases){this.addToHostAliases(item);}} else { this.hostAliases = null;} return (A) this;
  }
  public A withHostAliases(io.kubernetes.client.openapi.models.V1HostAlias... hostAliases) {
    ...
    if (hostAliases != null) {for (io.kubernetes.client.openapi.models.V1HostAlias item :hostAliases){ this.addToHostAliases(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<A> addNewHostAliasLike(io.kubernetes.client.openapi.models.V1HostAlias item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.HostAliasesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<A> setNewHostAliasLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1HostAlias item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.HostAliasesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<A> editHostAlias(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<A> editFirstHostAlias() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<A> editLastHostAlias() {
    int index = hostAliases.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last hostAliases. The list is empty.");
    return setNewHostAliasLike(index, buildHostAlias(index));
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<A> editMatchingHostAlias(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1HostAliasBuilder> predicate) {
    int index = -1;
  ...
  public A addToImagePullSecrets(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
    ...
    io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder builder = new io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder(item);_visitables.get("imagePullSecrets").add(index >= 0 ? index : _visitables.get("imagePullSecrets").size(), builder);this.imagePullSecrets.add(index >= 0 ? index : imagePullSecrets.size(), builder); return (A)this;
  }
  public A setToImagePullSecrets(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
    if (this.imagePullSecrets == null) {this.imagePullSecrets = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder>();}
    io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder builder = new io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder(item);
  ...
  public A addToImagePullSecrets(io.kubernetes.client.openapi.models.V1LocalObjectReference... items) {
    if (this.imagePullSecrets == null) {this.imagePullSecrets = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder>();}
    for (io.kubernetes.client.openapi.models.V1LocalObjectReference item : items) {io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder builder = new io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder(item);_visitables.get("imagePullSecrets").add(builder);this.imagePullSecrets.add(builder);} return (A)this;
  }
  ...
  public A removeFromImagePullSecrets(io.kubernetes.client.openapi.models.V1LocalObjectReference... items) {
    for (io.kubernetes.client.openapi.models.V1LocalObjectReference item : items) {io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder builder = new io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder(item);_visitables.get("imagePullSecrets").remove(builder);if (this.imagePullSecrets != null) {this.imagePullSecrets.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromImagePullSecrets(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder> each = imagePullSecrets.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1LocalObjectReference buildMatchingImagePullSecret(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder item: imagePullSecrets) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingImagePullSecret(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder item: imagePullSecrets) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withImagePullSecrets(java.util.List<io.kubernetes.client.openapi.models.V1LocalObjectReference> imagePullSecrets) {
    ...
    if (imagePullSecrets != null) {this.imagePullSecrets = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1LocalObjectReference item : imagePullSecrets){this.addToImagePullSecrets(item);}} else { this.imagePullSecrets = null;} return (A) this;
  }
  public A withImagePullSecrets(io.kubernetes.client.openapi.models.V1LocalObjectReference... imagePullSecrets) {
    ...
    if (imagePullSecrets != null) {for (io.kubernetes.client.openapi.models.V1LocalObjectReference item :imagePullSecrets){ this.addToImagePullSecrets(item);}} return (A) this;
  }
  public java.lang.Boolean hasImagePullSecrets() {
    return imagePullSecrets != null && !imagePullSecrets.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<A> addNewImagePullSecret() {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ImagePullSecretsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<A> addNewImagePullSecretLike(io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ImagePullSecretsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<A> setNewImagePullSecretLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ImagePullSecretsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<A> editImagePullSecret(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<A> editFirstImagePullSecret() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<A> editLastImagePullSecret() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<A> editMatchingImagePullSecret(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder> predicate) {
    int index = -1;
  ...
  public A addToInitContainers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
    if (this.initContainers == null) {this.initContainers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("initContainers").add(index >= 0 ? index : _visitables.get("initContainers").size(), builder);this.initContainers.add(index >= 0 ? index : initContainers.size(), builder); return (A)this;
  }
  public A setToInitContainers(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
    if (this.initContainers == null) {this.initContainers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);
  ...
  public A addToInitContainers(io.kubernetes.client.openapi.models.V1Container... items) {
    if (this.initContainers == null) {this.initContainers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("initContainers").add(builder);this.initContainers.add(builder);} return (A)this;
  }
  public A addAllToInitContainers(java.util.Collection<io.kubernetes.client.openapi.models.V1Container> items) {
    if (this.initContainers == null) {this.initContainers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ContainerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("initContainers").add(builder);this.initContainers.add(builder);} return (A)this;
  }
  public A removeFromInitContainers(io.kubernetes.client.openapi.models.V1Container... items) {
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("initContainers").remove(builder);if (this.initContainers != null) {this.initContainers.remove(builder);}} return (A)this;
  }
  public A removeAllFromInitContainers(java.util.Collection<io.kubernetes.client.openapi.models.V1Container> items) {
    for (io.kubernetes.client.openapi.models.V1Container item : items) {io.kubernetes.client.openapi.models.V1ContainerBuilder builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(item);_visitables.get("initContainers").remove(builder);if (this.initContainers != null) {this.initContainers.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromInitContainers(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    if (initContainers == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.V1ContainerBuilder> each = initContainers.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1Container buildMatchingInitContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ContainerBuilder item: initContainers) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingInitContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ContainerBuilder item: initContainers) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withInitContainers(java.util.List<io.kubernetes.client.openapi.models.V1Container> initContainers) {
    if (this.initContainers != null) { _visitables.get("initContainers").removeAll(this.initContainers);}
    if (initContainers != null) {this.initContainers = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Container item : initContainers){this.addToInitContainers(item);}} else { this.initContainers = null;} return (A) this;
  }
  public A withInitContainers(io.kubernetes.client.openapi.models.V1Container... initContainers) {
    ...
    if (initContainers != null) {for (io.kubernetes.client.openapi.models.V1Container item :initContainers){ this.addToInitContainers(item);}} return (A) this;
  }
  public java.lang.Boolean hasInitContainers() {
    return initContainers != null && !initContainers.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<A> addNewInitContainer() {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.InitContainersNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<A> addNewInitContainerLike(io.kubernetes.client.openapi.models.V1Container item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.InitContainersNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<A> setNewInitContainerLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.InitContainersNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<A> editInitContainer(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<A> editFirstInitContainer() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<A> editLastInitContainer() {
    int index = initContainers.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last initContainers. The list is empty.");
    return setNewInitContainerLike(index, buildInitContainer(index));
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<A> editMatchingInitContainer(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
    int index = -1;
  ...
  public A withOs(io.kubernetes.client.openapi.models.V1PodOS os) {
    ...
    if (os!=null){ this.os= new io.kubernetes.client.openapi.models.V1PodOSBuilder(os); _visitables.get("os").add(this.os);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.OsNested<A> withNewOsLike(io.kubernetes.client.openapi.models.V1PodOS item) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.OsNested<A> editOrNewOs() {
    return withNewOsLike(getOs() != null ? getOs(): new io.kubernetes.client.openapi.models.V1PodOSBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.OsNested<A> editOrNewOsLike(io.kubernetes.client.openapi.models.V1PodOS item) {
  ...
  public A removeFromOverhead(java.util.Map<java.lang.String,io.kubernetes.client.custom.Quantity> map) {
    if(this.overhead == null) { return (A) this; }
  ...
  public <K,V>A withOverhead(java.util.Map<java.lang.String,io.kubernetes.client.custom.Quantity> overhead) {
  ...
  public A setToReadinessGates(java.lang.Integer index,io.kubernetes.client.openapi.models.V1PodReadinessGate item) {
    if (this.readinessGates == null) {this.readinessGates = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder>();}
    io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder builder = new io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder(item);
  ...
  public A addToReadinessGates(io.kubernetes.client.openapi.models.V1PodReadinessGate... items) {
    if (this.readinessGates == null) {this.readinessGates = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder>();}
    for (io.kubernetes.client.openapi.models.V1PodReadinessGate item : items) {io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder builder = new io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder(item);_visitables.get("readinessGates").add(builder);this.readinessGates.add(builder);} return (A)this;
  }
  public A addAllToReadinessGates(java.util.Collection<io.kubernetes.client.openapi.models.V1PodReadinessGate> items) {
    if (this.readinessGates == null) {this.readinessGates = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder>();}
    for (io.kubernetes.client.openapi.models.V1PodReadinessGate item : items) {io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder builder = new io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder(item);_visitables.get("readinessGates").add(builder);this.readinessGates.add(builder);} return (A)this;
  }
  public A removeFromReadinessGates(io.kubernetes.client.openapi.models.V1PodReadinessGate... items) {
    for (io.kubernetes.client.openapi.models.V1PodReadinessGate item : items) {io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder builder = new io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder(item);_visitables.get("readinessGates").remove(builder);if (this.readinessGates != null) {this.readinessGates.remove(builder);}} return (A)this;
  }
  public A removeAllFromReadinessGates(java.util.Collection<io.kubernetes.client.openapi.models.V1PodReadinessGate> items) {
    for (io.kubernetes.client.openapi.models.V1PodReadinessGate item : items) {io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder builder = new io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder(item);_visitables.get("readinessGates").remove(builder);if (this.readinessGates != null) {this.readinessGates.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromReadinessGates(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder> predicate) {
    if (readinessGates == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder> each = readinessGates.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1PodReadinessGate buildMatchingReadinessGate(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder item: readinessGates) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingReadinessGate(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder item: readinessGates) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withReadinessGates(java.util.List<io.kubernetes.client.openapi.models.V1PodReadinessGate> readinessGates) {
    if (this.readinessGates != null) { _visitables.get("readinessGates").removeAll(this.readinessGates);}
    if (readinessGates != null) {this.readinessGates = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1PodReadinessGate item : readinessGates){this.addToReadinessGates(item);}} else { this.readinessGates = null;} return (A) this;
  }
  public A withReadinessGates(io.kubernetes.client.openapi.models.V1PodReadinessGate... readinessGates) {
    ...
    if (readinessGates != null) {for (io.kubernetes.client.openapi.models.V1PodReadinessGate item :readinessGates){ this.addToReadinessGates(item);}} return (A) this;
  }
  public java.lang.Boolean hasReadinessGates() {
    return readinessGates != null && !readinessGates.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<A> addNewReadinessGate() {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ReadinessGatesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<A> addNewReadinessGateLike(io.kubernetes.client.openapi.models.V1PodReadinessGate item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ReadinessGatesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<A> setNewReadinessGateLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1PodReadinessGate item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.ReadinessGatesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<A> editReadinessGate(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<A> editFirstReadinessGate() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<A> editLastReadinessGate() {
    int index = readinessGates.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last readinessGates. The list is empty.");
    return setNewReadinessGateLike(index, buildReadinessGate(index));
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<A> editMatchingReadinessGate(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PodReadinessGateBuilder> predicate) {
    int index = -1;
  ...
  public A withRestartPolicy(io.kubernetes.client.openapi.models.V1PodSpec.RestartPolicyEnum restartPolicy) {
  ...
  public A withSecurityContext(io.kubernetes.client.openapi.models.V1PodSecurityContext securityContext) {
    ...
    if (securityContext!=null){ this.securityContext= new io.kubernetes.client.openapi.models.V1PodSecurityContextBuilder(securityContext); _visitables.get("securityContext").add(this.securityContext);} return (A) this;
  }
  public java.lang.Boolean hasSecurityContext() {
    return this.securityContext != null;
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<A> withNewSecurityContext() {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.SecurityContextNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<A> withNewSecurityContextLike(io.kubernetes.client.openapi.models.V1PodSecurityContext item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.SecurityContextNestedImpl(item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<A> editSecurityContext() {
    return withNewSecurityContextLike(getSecurityContext());
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<A> editOrNewSecurityContext() {
    return withNewSecurityContextLike(getSecurityContext() != null ? getSecurityContext(): new io.kubernetes.client.openapi.models.V1PodSecurityContextBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<A> editOrNewSecurityContextLike(io.kubernetes.client.openapi.models.V1PodSecurityContext item) {
  ...
  public A addToTolerations(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Toleration item) {
  ...
  public A setToTolerations(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Toleration item) {
    if (this.tolerations == null) {this.tolerations = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TolerationBuilder>();}
  ...
  public A withTolerations(java.util.List<io.kubernetes.client.openapi.models.V1Toleration> tolerations) {
    ...
    if (tolerations != null) {this.tolerations = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Toleration item : tolerations){this.addToTolerations(item);}} else { this.tolerations = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<A> addNewToleration() {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.TolerationsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<A> addNewTolerationLike(io.kubernetes.client.openapi.models.V1Toleration item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.TolerationsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<A> setNewTolerationLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Toleration item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.TolerationsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<A> editToleration(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<A> editFirstToleration() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<A> editLastToleration() {
    int index = tolerations.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last tolerations. The list is empty.");
    return setNewTolerationLike(index, buildToleration(index));
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<A> editMatchingToleration(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TolerationBuilder> predicate) {
    int index = -1;
  ...
  public A addToTopologySpreadConstraints(java.lang.Integer index,io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder>();}
  ...
  public A setToTopologySpreadConstraints(java.lang.Integer index,io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder>();}
    io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder builder = new io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder(item);
  ...
  public A addAllToTopologySpreadConstraints(java.util.Collection<io.kubernetes.client.openapi.models.V1TopologySpreadConstraint> items) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder>();}
    for (io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item : items) {io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder builder = new io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder(item);_visitables.get("topologySpreadConstraints").add(builder);this.topologySpreadConstraints.add(builder);} return (A)this;
  }
  ...
  public A removeAllFromTopologySpreadConstraints(java.util.Collection<io.kubernetes.client.openapi.models.V1TopologySpreadConstraint> items) {
    for (io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item : items) {io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder builder = new io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder(item);_visitables.get("topologySpreadConstraints").remove(builder);if (this.topologySpreadConstraints != null) {this.topologySpreadConstraints.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromTopologySpreadConstraints(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder> predicate) {
    if (topologySpreadConstraints == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder> each = topologySpreadConstraints.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1TopologySpreadConstraint buildMatchingTopologySpreadConstraint(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder item: topologySpreadConstraints) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingTopologySpreadConstraint(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder item: topologySpreadConstraints) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withTopologySpreadConstraints(java.util.List<io.kubernetes.client.openapi.models.V1TopologySpreadConstraint> topologySpreadConstraints) {
    ...
    if (topologySpreadConstraints != null) {this.topologySpreadConstraints = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item : topologySpreadConstraints){this.addToTopologySpreadConstraints(item);}} else { this.topologySpreadConstraints = null;} return (A) this;
  }
  public A withTopologySpreadConstraints(io.kubernetes.client.openapi.models.V1TopologySpreadConstraint... topologySpreadConstraints) {
    ...
    if (topologySpreadConstraints != null) {for (io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item :topologySpreadConstraints){ this.addToTopologySpreadConstraints(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<A> addNewTopologySpreadConstraint() {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.TopologySpreadConstraintsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<A> addNewTopologySpreadConstraintLike(io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.TopologySpreadConstraintsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<A> setNewTopologySpreadConstraintLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.TopologySpreadConstraintsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<A> editTopologySpreadConstraint(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<A> editFirstTopologySpreadConstraint() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<A> editLastTopologySpreadConstraint() {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<A> editMatchingTopologySpreadConstraint(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder> predicate) {
    int index = -1;
  ...
  public A addToVolumes(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Volume item) {
    if (this.volumes == null) {this.volumes = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1VolumeBuilder>();}
    io.kubernetes.client.openapi.models.V1VolumeBuilder builder = new io.kubernetes.client.openapi.models.V1VolumeBuilder(item);_visitables.get("volumes").add(index >= 0 ? index : _visitables.get("volumes").size(), builder);this.volumes.add(index >= 0 ? index : volumes.size(), builder); return (A)this;
  }
  public A setToVolumes(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Volume item) {
    if (this.volumes == null) {this.volumes = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1VolumeBuilder>();}
    io.kubernetes.client.openapi.models.V1VolumeBuilder builder = new io.kubernetes.client.openapi.models.V1VolumeBuilder(item);
  ...
  public A addToVolumes(io.kubernetes.client.openapi.models.V1Volume... items) {
    if (this.volumes == null) {this.volumes = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1VolumeBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Volume item : items) {io.kubernetes.client.openapi.models.V1VolumeBuilder builder = new io.kubernetes.client.openapi.models.V1VolumeBuilder(item);_visitables.get("volumes").add(builder);this.volumes.add(builder);} return (A)this;
  }
  public A addAllToVolumes(java.util.Collection<io.kubernetes.client.openapi.models.V1Volume> items) {
    if (this.volumes == null) {this.volumes = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1VolumeBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Volume item : items) {io.kubernetes.client.openapi.models.V1VolumeBuilder builder = new io.kubernetes.client.openapi.models.V1VolumeBuilder(item);_visitables.get("volumes").add(builder);this.volumes.add(builder);} return (A)this;
  }
  public A removeFromVolumes(io.kubernetes.client.openapi.models.V1Volume... items) {
    for (io.kubernetes.client.openapi.models.V1Volume item : items) {io.kubernetes.client.openapi.models.V1VolumeBuilder builder = new io.kubernetes.client.openapi.models.V1VolumeBuilder(item);_visitables.get("volumes").remove(builder);if (this.volumes != null) {this.volumes.remove(builder);}} return (A)this;
  }
  public A removeAllFromVolumes(java.util.Collection<io.kubernetes.client.openapi.models.V1Volume> items) {
    for (io.kubernetes.client.openapi.models.V1Volume item : items) {io.kubernetes.client.openapi.models.V1VolumeBuilder builder = new io.kubernetes.client.openapi.models.V1VolumeBuilder(item);_visitables.get("volumes").remove(builder);if (this.volumes != null) {this.volumes.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromVolumes(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1VolumeBuilder> predicate) {
  ...
  public io.kubernetes.client.openapi.models.V1Volume buildMatchingVolume(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1VolumeBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1VolumeBuilder item: volumes) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingVolume(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1VolumeBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1VolumeBuilder item: volumes) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withVolumes(java.util.List<io.kubernetes.client.openapi.models.V1Volume> volumes) {
    ...
    if (volumes != null) {this.volumes = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Volume item : volumes){this.addToVolumes(item);}} else { this.volumes = null;} return (A) this;
  }
  public A withVolumes(io.kubernetes.client.openapi.models.V1Volume... volumes) {
    if (this.volumes != null) {this.volumes.clear();}
    if (volumes != null) {for (io.kubernetes.client.openapi.models.V1Volume item :volumes){ this.addToVolumes(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.VolumesNested<A> addNewVolumeLike(io.kubernetes.client.openapi.models.V1Volume item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.VolumesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.VolumesNested<A> setNewVolumeLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Volume item) {
    return new io.kubernetes.client.openapi.models.V1PodSpecFluentImpl.VolumesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.VolumesNested<A> editVolume(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1PodSpecFluent.VolumesNested<A> editMatchingVolume(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1VolumeBuilder> predicate) {
    int index = -1;
  ...
  public class AffinityNestedImpl<N> extends io.kubernetes.client.openapi.models.V1AffinityFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.AffinityNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.AffinityNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class ContainersNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ContainerFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ContainersNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
      this.index = index;
  ...
  public class DnsConfigNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodDNSConfigFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.DnsConfigNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.DnsConfigNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class EphemeralContainersNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EphemeralContainerFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<N>,io.kubernetes.client.fluent.Nested<N>{
    EphemeralContainersNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EphemeralContainer item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1EphemeralContainerBuilder(this, item);
    }
  ...
  public class HostAliasesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HostAliasFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    HostAliasesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1HostAlias item) {
      this.index = index;
  ...
  public class ImagePullSecretsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LocalObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ImagePullSecretsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LocalObjectReference item) {
      this.index = index;
  ...
  public class InitContainersNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ContainerFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<N>,io.kubernetes.client.fluent.Nested<N>{
    InitContainersNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Container item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1ContainerBuilder(this, item);
    }
  ...
  public class OsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodOSFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.OsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.OsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class ReadinessGatesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodReadinessGateFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ReadinessGatesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1PodReadinessGate item) {
      this.index = index;
  ...
  public class SecurityContextNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<N>,io.kubernetes.client.fluent.Nested<N>{
    SecurityContextNestedImpl(io.kubernetes.client.openapi.models.V1PodSecurityContext item) {
      this.builder = new io.kubernetes.client.openapi.models.V1PodSecurityContextBuilder(this, item);
    }
  ...
  public class TolerationsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TolerationFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    TolerationsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Toleration item) {
      this.index = index;
  ...
  public class TopologySpreadConstraintsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TopologySpreadConstraintFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    TopologySpreadConstraintsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1TopologySpreadConstraint item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder(this, item);
    }
    TopologySpreadConstraintsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1TopologySpreadConstraintBuilder(this);
    }
  ...
  public class VolumesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1VolumeFluentImpl<io.kubernetes.client.openapi.models.V1PodSpecFluent.VolumesNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.VolumesNested<N>,io.kubernetes.client.fluent.Nested<N>{
