...
public class V1CSINodeDriverFluentImpl<A extends io.kubernetes.client.openapi.models.V1CSINodeDriverFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CSINodeDriverFluent<A> {
    ...
    public A withAllocatable(io.kubernetes.client.openapi.models.V1VolumeNodeResources allocatable) {
        ...
        if (allocatable!=null){ this.allocatable= new io.kubernetes.client.openapi.models.V1VolumeNodeResourcesBuilder(allocatable); _visitables.get("allocatable").add(this.allocatable);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSINodeDriverFluent.AllocatableNested<A> withNewAllocatableLike(io.kubernetes.client.openapi.models.V1VolumeNodeResources item) {
        return new io.kubernetes.client.openapi.models.V1CSINodeDriverFluentImpl.AllocatableNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSINodeDriverFluent.AllocatableNested<A> editOrNewAllocatable() {
        return withNewAllocatableLike(getAllocatable() != null ? getAllocatable(): new io.kubernetes.client.openapi.models.V1VolumeNodeResourcesBuilder().build());
    }
    ...
    public class AllocatableNestedImpl<N> extends io.kubernetes.client.openapi.models.V1VolumeNodeResourcesFluentImpl<io.kubernetes.client.openapi.models.V1CSINodeDriverFluent.AllocatableNested<N>> implements io.kubernetes.client.openapi.models.V1CSINodeDriverFluent.AllocatableNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1VolumeNodeResourcesBuilder builder;
            ...
            AllocatableNestedImpl(io.kubernetes.client.openapi.models.V1VolumeNodeResources item) {
                this.builder = new io.kubernetes.client.openapi.models.V1VolumeNodeResourcesBuilder(this, item);
