...
public class V1LoadBalancerStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluent<A> {

    private java.util.List<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder> ingress;
    ...
    public A addToIngress(int index,io.kubernetes.client.openapi.models.V1LoadBalancerIngress item) {
        if (this.ingress == null) {this.ingress = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder>();}
        io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder builder = new io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder(item);_visitables.get("ingress").add(index >= 0 ? index : _visitables.get("ingress").size(), builder);this.ingress.add(index >= 0 ? index : ingress.size(), builder); return (A)this;
    }

    public A setToIngress(int index,io.kubernetes.client.openapi.models.V1LoadBalancerIngress item) {
        if (this.ingress == null) {this.ingress = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder>();}
        io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder builder = new io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder(item);
    ...
    public A addToIngress(io.kubernetes.client.openapi.models.V1LoadBalancerIngress... items) {
        if (this.ingress == null) {this.ingress = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder>();}
        for (io.kubernetes.client.openapi.models.V1LoadBalancerIngress item : items) {io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder builder = new io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder(item);_visitables.get("ingress").add(builder);this.ingress.add(builder);} return (A)this;
    }
    ...
    public A removeMatchingFromIngress(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder> each = ingress.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1LoadBalancerIngress buildMatchingIngress(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder item: ingress) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingIngress(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder item: ingress) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withIngress(java.util.List<io.kubernetes.client.openapi.models.V1LoadBalancerIngress> ingress) {
        ...
        if (ingress != null) {this.ingress = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder>(); for (io.kubernetes.client.openapi.models.V1LoadBalancerIngress item : ingress){this.addToIngress(item);}} else { this.ingress = null;} return (A) this;
    }
    ...
    public A withIngress(io.kubernetes.client.openapi.models.V1LoadBalancerIngress... ingress) {
        ...
        if (ingress != null) {for (io.kubernetes.client.openapi.models.V1LoadBalancerIngress item :ingress){ this.addToIngress(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluent.IngressNested<A> addNewIngressLike(io.kubernetes.client.openapi.models.V1LoadBalancerIngress item) {
        return new io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluentImpl.IngressNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluent.IngressNested<A> setNewIngressLike(int index,io.kubernetes.client.openapi.models.V1LoadBalancerIngress item) {
        return new io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluentImpl.IngressNestedImpl(index, item);
    }
    ...
    public class IngressNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LoadBalancerIngressFluentImpl<io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluent.IngressNested<N>> implements io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluent.IngressNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder builder;
        private final int index;

            IngressNestedImpl(int index,io.kubernetes.client.openapi.models.V1LoadBalancerIngress item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder(this, item);
