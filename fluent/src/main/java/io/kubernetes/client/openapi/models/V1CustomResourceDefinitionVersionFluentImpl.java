...
public class V1CustomResourceDefinitionVersionFluentImpl<A extends io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent<A> {
    ...
    public V1CustomResourceDefinitionVersionFluentImpl(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersion instance) {
    ...
    public A addToAdditionalPrinterColumns(int index,io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item) {
        if (this.additionalPrinterColumns == null) {this.additionalPrinterColumns = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder>();}
    ...
    public A setToAdditionalPrinterColumns(int index,io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item) {
        if (this.additionalPrinterColumns == null) {this.additionalPrinterColumns = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder>();}
        io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder builder = new io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder(item);
    ...
    public A removeMatchingFromAdditionalPrinterColumns(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder> each = additionalPrinterColumns.iterator();
        final List visitables = _visitables.get("additionalPrinterColumns");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition buildAdditionalPrinterColumn(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition buildMatchingAdditionalPrinterColumn(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder item: additionalPrinterColumns) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingAdditionalPrinterColumn(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder item: additionalPrinterColumns) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withAdditionalPrinterColumns(io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition... additionalPrinterColumns) {
        ...
        if (additionalPrinterColumns != null) {for (io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item :additionalPrinterColumns){ this.addToAdditionalPrinterColumns(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<A> addNewAdditionalPrinterColumn() {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl.AdditionalPrinterColumnsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<A> addNewAdditionalPrinterColumnLike(io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item) {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl.AdditionalPrinterColumnsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<A> setNewAdditionalPrinterColumnLike(int index,io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item) {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl.AdditionalPrinterColumnsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<A> editAdditionalPrinterColumn(int index) {
    ...
    public A withSchema(io.kubernetes.client.openapi.models.V1CustomResourceValidation schema) {
        ...
        if (schema!=null){ this.schema= new io.kubernetes.client.openapi.models.V1CustomResourceValidationBuilder(schema); _visitables.get("schema").add(this.schema);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SchemaNested<A> withNewSchema() {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl.SchemaNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SchemaNested<A> withNewSchemaLike(io.kubernetes.client.openapi.models.V1CustomResourceValidation item) {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl.SchemaNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SchemaNested<A> editOrNewSchema() {
        return withNewSchemaLike(getSchema() != null ? getSchema(): new io.kubernetes.client.openapi.models.V1CustomResourceValidationBuilder().build());
    }
    ...
    public A withSubresources(io.kubernetes.client.openapi.models.V1CustomResourceSubresources subresources) {
        ...
        if (subresources!=null){ this.subresources= new io.kubernetes.client.openapi.models.V1CustomResourceSubresourcesBuilder(subresources); _visitables.get("subresources").add(this.subresources);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SubresourcesNested<A> withNewSubresources() {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl.SubresourcesNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SubresourcesNested<A> withNewSubresourcesLike(io.kubernetes.client.openapi.models.V1CustomResourceSubresources item) {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl.SubresourcesNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SubresourcesNested<A> editOrNewSubresources() {
        return withNewSubresourcesLike(getSubresources() != null ? getSubresources(): new io.kubernetes.client.openapi.models.V1CustomResourceSubresourcesBuilder().build());
    }
    ...
    public class AdditionalPrinterColumnsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionFluentImpl<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder builder;
        private final int index;

            AdditionalPrinterColumnsNestedImpl(int index,io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder(this, item);
                        
            }

            AdditionalPrinterColumnsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder(this);
    ...
    public class SchemaNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CustomResourceValidationFluentImpl<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SchemaNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SchemaNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CustomResourceValidationBuilder builder;
            ...
            SchemaNestedImpl(io.kubernetes.client.openapi.models.V1CustomResourceValidation item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceValidationBuilder(this, item);
                        
            }

            SchemaNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceValidationBuilder(this);
    ...
    public class SubresourcesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CustomResourceSubresourcesFluentImpl<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SubresourcesNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SubresourcesNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CustomResourceSubresourcesBuilder builder;

            SubresourcesNestedImpl(io.kubernetes.client.openapi.models.V1CustomResourceSubresources item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceSubresourcesBuilder(this, item);
                        
            }

            SubresourcesNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceSubresourcesBuilder(this);
