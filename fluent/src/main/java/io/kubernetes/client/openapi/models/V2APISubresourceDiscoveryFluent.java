...
public class V2APISubresourceDiscoveryFluent<A extends io.kubernetes.client.openapi.models.V2APISubresourceDiscoveryFluent<A>> extends BaseFluent<A>{
  ...
  public V2APISubresourceDiscoveryFluent(V2APISubresourceDiscovery instance) {
  ...
  protected void copyInstance(V2APISubresourceDiscovery instance) {
    instance = instance != null ? instance : new V2APISubresourceDiscovery();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V2APISubresourceDiscoveryFluent that = (V2APISubresourceDiscoveryFluent) o;
  ...
  public class AcceptedTypesNested<N> extends V1GroupVersionKindFluent<AcceptedTypesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V2APISubresourceDiscoveryFluent.this.setToAcceptedTypes(index, builder.build());
    }
  ...
  public class ResponseKindNested<N> extends V1GroupVersionKindFluent<ResponseKindNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V2APISubresourceDiscoveryFluent.this.withResponseKind(builder.build());
    }
