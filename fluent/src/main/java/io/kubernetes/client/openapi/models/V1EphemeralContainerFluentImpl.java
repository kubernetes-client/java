...
public class V1EphemeralContainerFluentImpl<A extends V1EphemeralContainerFluent<A>>
  ...
  public V1EphemeralContainerFluent.LivenessProbeNested<A> editOrNewLivenessProbeLike(
      V1Probe item) {
  ...
  public V1EphemeralContainerFluent.ReadinessProbeNested<A> withNewReadinessProbeLike(
      V1Probe item) {
  ...
  public V1EphemeralContainerFluent.VolumeMountsNested<A> addNewVolumeMountLike(
      V1VolumeMount item) {
  ...
  class EnvNestedImpl<N> extends V1EnvVarFluentImpl<V1EphemeralContainerFluent.EnvNested<N>>
      implements V1EphemeralContainerFluent.EnvNested<N>, Nested<N> {
  ...
  class EnvFromNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.EnvFromNested<N>, Nested<N> {
  ...
  class LifecycleNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.LifecycleNested<N>, Nested<N> {
  ...
  class LivenessProbeNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.LivenessProbeNested<N>, Nested<N> {
  ...
  class PortsNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.PortsNested<N>, Nested<N> {
  ...
  class ReadinessProbeNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.ReadinessProbeNested<N>, Nested<N> {
  ...
  class ResourcesNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.ResourcesNested<N>, Nested<N> {
  ...
  class SecurityContextNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.SecurityContextNested<N>, Nested<N> {
  ...
  class StartupProbeNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.StartupProbeNested<N>, Nested<N> {
  ...
  class VolumeDevicesNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.VolumeDevicesNested<N>, Nested<N> {
  ...
  class VolumeMountsNestedImpl<N>
      ...
      implements V1EphemeralContainerFluent.VolumeMountsNested<N>, Nested<N> {
