...
public class V1beta1CustomResourceDefinitionStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent<A> {

    private io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNamesBuilder acceptedNames;
    private java.util.List<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder> conditions;
    private java.util.List<java.lang.String> storedVersions;

    public V1beta1CustomResourceDefinitionStatusFluentImpl() {
    }

    public V1beta1CustomResourceDefinitionStatusFluentImpl(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatus instance) {
    ...
    public A withAcceptedNames(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNames acceptedNames) {
        ...
        if (acceptedNames!=null){ this.acceptedNames= new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNamesBuilder(acceptedNames); _visitables.get("acceptedNames").add(this.acceptedNames);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.AcceptedNamesNested<A> withNewAcceptedNames() {
        return new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluentImpl.AcceptedNamesNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.AcceptedNamesNested<A> withNewAcceptedNamesLike(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNames item) {
        return new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluentImpl.AcceptedNamesNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.AcceptedNamesNested<A> editOrNewAcceptedNames() {
        return withNewAcceptedNamesLike(getAcceptedNames() != null ? getAcceptedNames(): new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNamesBuilder().build());
    }
    ...
    public A addToConditions(int index,io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item) {
        if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder(item);_visitables.get("conditions").add(index >= 0 ? index : _visitables.get("conditions").size(), builder);this.conditions.add(index >= 0 ? index : conditions.size(), builder); return (A)this;
    }

    public A setToConditions(int index,io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item) {
        if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder(item);
    ...
    public A addToConditions(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition... items) {
        if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder>();}
        for (io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item : items) {io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
    }
    ...
    public A removeFromConditions(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition... items) {
        for (io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item : items) {io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder(item);_visitables.get("conditions").remove(builder);if (this.conditions != null) {this.conditions.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromConditions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder> each = conditions.iterator();
        final List visitables = _visitables.get("conditions");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition buildMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder item: conditions) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder item: conditions) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition> conditions) {
        ...
        if (conditions != null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder>(); for (io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
    }

    public A withConditions(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition... conditions) {
        if (this.conditions != null) {this.conditions.clear();}
        if (conditions != null) {for (io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item :conditions){ this.addToConditions(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.ConditionsNested<A> addNewCondition() {
        return new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluentImpl.ConditionsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item) {
        return new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluentImpl.ConditionsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.ConditionsNested<A> setNewConditionLike(int index,io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item) {
        return new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluentImpl.ConditionsNestedImpl(index, item);
    }
    ...
    public class AcceptedNamesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNamesFluentImpl<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.AcceptedNamesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.AcceptedNamesNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNamesBuilder builder;

            AcceptedNamesNestedImpl(io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionNames item) {
    ...
    public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionFluentImpl<io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder builder;
        private final int index;

            ConditionsNestedImpl(int index,io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionCondition item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder(this, item);
                        
            }

            ConditionsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1CustomResourceDefinitionConditionBuilder(this);
