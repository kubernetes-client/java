...
/** Generated */
public class V1ServiceFluentImpl<A extends io.kubernetes.client.openapi.models.V1ServiceFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1ServiceFluent<A> {
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1ServiceSpec spec) {
    ...
    if (spec != null) {
      this.spec = new io.kubernetes.client.openapi.models.V1ServiceSpecBuilder(spec);
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1ServiceFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1ServiceFluent.MetadataNested<N>,
  ...
  public class SpecNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ServiceSpecFluentImpl<
          io.kubernetes.client.openapi.models.V1ServiceFluent.SpecNested<N>>
  ...
  public class StatusNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ServiceStatusFluentImpl<
          io.kubernetes.client.openapi.models.V1ServiceFluent.StatusNested<N>>
