...
public class V1VolumeAttachmentListFluent<A extends io.kubernetes.client.openapi.models.V1VolumeAttachmentListFluent<A>> extends BaseFluent<A>{
  public V1VolumeAttachmentListFluent() {
  }
  
  public V1VolumeAttachmentListFluent(V1VolumeAttachmentList instance) {
  ...
  protected void copyInstance(V1VolumeAttachmentList instance) {
    instance = instance != null ? instance : new V1VolumeAttachmentList();
    if (instance != null) {
  ...
  public A addToItems(V1VolumeAttachment... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1VolumeAttachment... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1VolumeAttachment item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1VolumeAttachmentBuilder> predicate) {
    ...
    Iterator<V1VolumeAttachmentBuilder> each = items.iterator();
  ...
  public A withItems(V1VolumeAttachment... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public ItemsNested<A> addNewItemLike(V1VolumeAttachment item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1VolumeAttachment item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1VolumeAttachmentBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1VolumeAttachmentListFluent that = (V1VolumeAttachmentListFluent) o;
  ...
  public class ItemsNested<N> extends V1VolumeAttachmentFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1VolumeAttachment item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1VolumeAttachmentListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1VolumeAttachmentListFluent.this.withMetadata(builder.build());
    }
