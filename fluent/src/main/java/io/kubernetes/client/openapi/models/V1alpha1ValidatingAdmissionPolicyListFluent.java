...
public class V1alpha1ValidatingAdmissionPolicyListFluent<A extends V1alpha1ValidatingAdmissionPolicyListFluent<A>> extends BaseFluent<A>{
  public V1alpha1ValidatingAdmissionPolicyListFluent() {
  }
  
  public V1alpha1ValidatingAdmissionPolicyListFluent(V1alpha1ValidatingAdmissionPolicyList instance) {
  ...
  protected void copyInstance(V1alpha1ValidatingAdmissionPolicyList instance) {
    instance = (instance != null ? instance : new V1alpha1ValidatingAdmissionPolicyList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha1ValidatingAdmissionPolicy... items) {
    ...
    for (V1alpha1ValidatingAdmissionPolicy item : items) {V1alpha1ValidatingAdmissionPolicyBuilder builder = new V1alpha1ValidatingAdmissionPolicyBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1alpha1ValidatingAdmissionPolicy buildMatchingItem(Predicate<V1alpha1ValidatingAdmissionPolicyBuilder> predicate) {
      for (V1alpha1ValidatingAdmissionPolicyBuilder item : items) {
  ...
  public A withItems(List<V1alpha1ValidatingAdmissionPolicy> items) {
    ...
    if (items != null) {
        ...
        for (V1alpha1ValidatingAdmissionPolicy item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1alpha1ValidatingAdmissionPolicy item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1alpha1ValidatingAdmissionPolicy item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1alpha1ValidatingAdmissionPolicyBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ValidatingAdmissionPolicyListFluent that = (V1alpha1ValidatingAdmissionPolicyListFluent) o;
  ...
  public class ItemsNested<N> extends V1alpha1ValidatingAdmissionPolicyFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1alpha1ValidatingAdmissionPolicy item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1alpha1ValidatingAdmissionPolicyListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1ValidatingAdmissionPolicyListFluent.this.withMetadata(builder.build());
    }
