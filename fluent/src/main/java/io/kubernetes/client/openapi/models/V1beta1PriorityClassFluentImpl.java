...
public class V1beta1PriorityClassFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent<A> {
    ...
    public V1beta1PriorityClassFluentImpl(io.kubernetes.client.openapi.models.V1beta1PriorityClass instance) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1PriorityClassFluentImpl.MetadataNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1PriorityClassFluentImpl.MetadataNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent.MetadataNested<A> editMetadata() {
        return withNewMetadataLike(getMetadata());
    }

    public io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent.MetadataNested<A> editOrNewMetadata() {
    ...
    public io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent.MetadataNested<A> editOrNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PriorityClassFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
