...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1Pod item) {
    ...
    V1PodBuilder builder = new V1PodBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1PodFluentImpl<V1PodListFluent.ItemsNested<N>> implements V1PodListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1Pod item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1PodListFluent.MetadataNested<N>> implements V1PodListFluent.MetadataNested<N>,Nested<N>{
