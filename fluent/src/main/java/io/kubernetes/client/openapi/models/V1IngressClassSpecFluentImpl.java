...
public class V1IngressClassSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1IngressClassSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1IngressClassSpecFluent<A>{
  ...
  public A withParameters(io.kubernetes.client.openapi.models.V1IngressClassParametersReference parameters) {
    ...
    if (parameters!=null){ this.parameters= new io.kubernetes.client.openapi.models.V1IngressClassParametersReferenceBuilder(parameters); _visitables.get("parameters").add(this.parameters);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1IngressClassSpecFluent.ParametersNested<A> editOrNewParameters() {
    return withNewParametersLike(getParameters() != null ? getParameters(): new io.kubernetes.client.openapi.models.V1IngressClassParametersReferenceBuilder().build());
  }
  ...
  public class ParametersNestedImpl<N> extends io.kubernetes.client.openapi.models.V1IngressClassParametersReferenceFluentImpl<io.kubernetes.client.openapi.models.V1IngressClassSpecFluent.ParametersNested<N>> implements io.kubernetes.client.openapi.models.V1IngressClassSpecFluent.ParametersNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ParametersNestedImpl(io.kubernetes.client.openapi.models.V1IngressClassParametersReference item) {
      this.builder = new io.kubernetes.client.openapi.models.V1IngressClassParametersReferenceBuilder(this, item);
    }
    ParametersNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1IngressClassParametersReferenceBuilder(this);
    }
