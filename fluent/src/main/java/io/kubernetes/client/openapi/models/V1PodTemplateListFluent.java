...
public class V1PodTemplateListFluent<A extends io.kubernetes.client.openapi.models.V1PodTemplateListFluent<A>> extends BaseFluent<A>{
  ...
  public V1PodTemplateListFluent() {
  }
  
  public V1PodTemplateListFluent(V1PodTemplateList instance) {
  ...
  public ItemsNested<A> addNewItemLike(V1PodTemplate item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1PodTemplate... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1PodTemplate item : items) {
  ...
  public V1PodTemplate buildMatchingItem(Predicate<V1PodTemplateBuilder> predicate) {
      for (V1PodTemplateBuilder item : items) {
  ...
  protected void copyInstance(V1PodTemplateList instance) {
    instance = instance != null ? instance : new V1PodTemplateList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1PodTemplateBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1PodTemplateListFluent that = (V1PodTemplateListFluent) o;
  ...
  public A removeFromItems(V1PodTemplate... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1PodTemplate item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1PodTemplateBuilder> predicate) {
    ...
    Iterator<V1PodTemplateBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1PodTemplate item) {
  ...
  public A withItems(V1PodTemplate... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1PodTemplateFluent<ItemsNested<N>> implements Nested<N>{
  
    V1PodTemplateBuilder builder;
    int index;
  
    ItemsNested(int index,V1PodTemplate item) {
      this.index = index;
      this.builder = new V1PodTemplateBuilder(this, item);
    }
  
    public N and() {
      return (N) V1PodTemplateListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1PodTemplateListFluent.this.withMetadata(builder.build());
    }
