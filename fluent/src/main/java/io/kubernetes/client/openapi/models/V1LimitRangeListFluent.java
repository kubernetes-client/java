...
public class V1LimitRangeListFluent<A extends V1LimitRangeListFluent<A>> extends BaseFluent<A>{
  public V1LimitRangeListFluent() {
  }
  
  public V1LimitRangeListFluent(V1LimitRangeList instance) {
  ...
  protected void copyInstance(V1LimitRangeList instance) {
    instance = (instance != null ? instance : new V1LimitRangeList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1LimitRange... items) {
    ...
    for (V1LimitRange item : items) {V1LimitRangeBuilder builder = new V1LimitRangeBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1LimitRange buildMatchingItem(Predicate<V1LimitRangeBuilder> predicate) {
      for (V1LimitRangeBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1LimitRange item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1LimitRange item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1LimitRangeBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1LimitRangeListFluent that = (V1LimitRangeListFluent) o;
  ...
  public class ItemsNested<N> extends V1LimitRangeFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1LimitRange item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1LimitRangeListFluent.this.withMetadata(builder.build());
    }
