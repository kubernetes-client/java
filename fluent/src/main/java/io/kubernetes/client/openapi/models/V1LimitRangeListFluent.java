...
public class V1LimitRangeListFluent<A extends io.kubernetes.client.openapi.models.V1LimitRangeListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1LimitRangeBuilder> predicate) {
    ...
    Iterator<V1LimitRangeBuilder> each = items.iterator();
