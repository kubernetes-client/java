...
public class V1PodFluent<A extends io.kubernetes.client.openapi.models.V1PodFluent<A>> extends BaseFluent<A>{
  public V1PodFluent() {
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V1PodStatusBuilder().build()));
  }
