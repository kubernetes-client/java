...
public class V1alpha3DeviceClaimConfigurationFluent<A extends V1alpha3DeviceClaimConfigurationFluent<A>> extends BaseFluent<A>{
  public V1alpha3DeviceClaimConfigurationFluent() {
  }
  
  public V1alpha3DeviceClaimConfigurationFluent(V1alpha3DeviceClaimConfiguration instance) {
    this.copyInstance(instance);
  }
  private V1alpha3OpaqueDeviceConfigurationBuilder opaque;
  private List<String> requests;
  
  protected void copyInstance(V1alpha3DeviceClaimConfiguration instance) {
    instance = (instance != null ? instance : new V1alpha3DeviceClaimConfiguration());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3DeviceClaimConfigurationFluent that = (V1alpha3DeviceClaimConfigurationFluent) o;
  ...
  public int hashCode() {
    return java.util.Objects.hash(opaque,  requests,  super.hashCode());
  }
  ...
  public class OpaqueNested<N> extends V1alpha3OpaqueDeviceConfigurationFluent<OpaqueNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha3DeviceClaimConfigurationFluent.this.withOpaque(builder.build());
    }
