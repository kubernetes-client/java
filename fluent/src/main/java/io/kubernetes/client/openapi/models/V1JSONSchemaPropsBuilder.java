...
public class V1JSONSchemaPropsBuilder extends io.kubernetes.client.openapi.models.V1JSONSchemaPropsFluentImpl<io.kubernetes.client.openapi.models.V1JSONSchemaPropsBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1JSONSchemaProps,io.kubernetes.client.openapi.models.V1JSONSchemaPropsBuilder> {
    ...
    public V1JSONSchemaPropsBuilder(io.kubernetes.client.openapi.models.V1JSONSchemaPropsFluent<?> fluent) {
        this(fluent, true);
    }

    public V1JSONSchemaPropsBuilder(io.kubernetes.client.openapi.models.V1JSONSchemaPropsFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1JSONSchemaProps(), validationEnabled);
    }

    public V1JSONSchemaPropsBuilder(io.kubernetes.client.openapi.models.V1JSONSchemaPropsFluent<?> fluent,io.kubernetes.client.openapi.models.V1JSONSchemaProps instance) {
        this(fluent, instance, true);
    }

    public V1JSONSchemaPropsBuilder(io.kubernetes.client.openapi.models.V1JSONSchemaPropsFluent<?> fluent,io.kubernetes.client.openapi.models.V1JSONSchemaProps instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1JSONSchemaPropsBuilder(io.kubernetes.client.openapi.models.V1JSONSchemaProps instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
