...
public class V1PodAffinityFluent<A extends io.kubernetes.client.openapi.models.V1PodAffinityFluent<A>> extends BaseFluent<A>{
  ...
  public V1PodAffinityFluent(V1PodAffinity instance) {
  ...
  protected void copyInstance(V1PodAffinity instance) {
    instance = instance != null ? instance : new V1PodAffinity();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1PodAffinityFluent that = (V1PodAffinityFluent) o;
  ...
  public class PreferredDuringSchedulingIgnoredDuringExecutionNested<N> extends V1WeightedPodAffinityTermFluent<PreferredDuringSchedulingIgnoredDuringExecutionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1PodAffinityFluent.this.setToPreferredDuringSchedulingIgnoredDuringExecution(index, builder.build());
    }
