...
public interface V1beta1StorageClassFluent<A extends io.kubernetes.client.openapi.models.V1beta1StorageClassFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface AllowedTopologiesNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1TopologySelectorTermFluent<io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<N>> {

            public N and();
            public N endAllowedTopology();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<N>> {
