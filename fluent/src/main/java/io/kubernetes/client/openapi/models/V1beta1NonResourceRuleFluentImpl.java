...
public class V1beta1NonResourceRuleFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1NonResourceRuleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1NonResourceRuleFluent<A> {
    ...
    public V1beta1NonResourceRuleFluentImpl(io.kubernetes.client.openapi.models.V1beta1NonResourceRule instance) {
