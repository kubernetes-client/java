...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1CSIDriver item) {
    ...
    V1CSIDriverBuilder builder = new V1CSIDriverBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1CSIDriverFluentImpl<V1CSIDriverListFluent.ItemsNested<N>> implements V1CSIDriverListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CSIDriverListFluent.MetadataNested<N>> implements V1CSIDriverListFluent.MetadataNested<N>,Nested<N>{
