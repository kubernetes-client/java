...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1CSIDriver... items) {
    if (this.items == null) {this.items = new ArrayList<V1CSIDriverBuilder>();}
    for (V1CSIDriver item : items) {V1CSIDriverBuilder builder = new V1CSIDriverBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1CSIDriver... items) {
    for (V1CSIDriver item : items) {V1CSIDriverBuilder builder = new V1CSIDriverBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public V1CSIDriver buildMatchingItem(Predicate<V1CSIDriverBuilder> predicate) {
    for (V1CSIDriverBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V1CSIDriverBuilder> predicate) {
    for (V1CSIDriverBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V1CSIDriver> items) {
    if (this.items != null) { _visitables.get("items").clear();}
    if (items != null) {this.items = new ArrayList(); for (V1CSIDriver item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1CSIDriver... items) {
    ...
    if (items != null) {for (V1CSIDriver item :items){ this.addToItems(item);}} return (A) this;
  }
  public Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public V1CSIDriverListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1CSIDriverListFluentImpl.ItemsNestedImpl();
  }
  public V1CSIDriverListFluentImpl.ItemsNested<A> addNewItemLike(V1CSIDriver item) {
    return new V1CSIDriverListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1CSIDriverListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1CSIDriver item) {
    return new V1CSIDriverListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1CSIDriverListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CSIDriverListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1CSIDriverListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CSIDriverListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1CSIDriverBuilder> predicate) {
    int index = -1;
  ...
  public V1CSIDriverListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1CSIDriverListFluentImpl.MetadataNestedImpl();
  }
  public V1CSIDriverListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1CSIDriverListFluentImpl.MetadataNestedImpl(item);
  }
  public V1CSIDriverListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1CSIDriverListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1CSIDriverListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1CSIDriverFluentImpl<V1CSIDriverListFluentImpl.ItemsNested<N>> implements V1CSIDriverListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1CSIDriver item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CSIDriverListFluentImpl.MetadataNested<N>> implements V1CSIDriverListFluentImpl.MetadataNested<N>,Nested<N>{
