...
public interface V2MetricSpecFluent<A extends V2MetricSpecFluent<A>> extends Fluent<A> {
  ...
  public interface ExternalNested<N>
      extends Nested<N>, V2ExternalMetricSourceFluent<V2MetricSpecFluent.ExternalNested<N>> {
    public N and();
  ...
  public interface ObjectNested<N>
      extends Nested<N>, V2ObjectMetricSourceFluent<V2MetricSpecFluent.ObjectNested<N>> {
    public N and();
  ...
  public interface PodsNested<N>
      extends Nested<N>, V2PodsMetricSourceFluent<V2MetricSpecFluent.PodsNested<N>> {
    public N and();
  ...
  public interface ResourceNested<N>
      extends Nested<N>, V2ResourceMetricSourceFluent<V2MetricSpecFluent.ResourceNested<N>> {
    public N and();
