...
public class V1alpha2ResourceClaimTemplateListFluent<A extends V1alpha2ResourceClaimTemplateListFluent<A>> extends BaseFluent<A>{
  public V1alpha2ResourceClaimTemplateListFluent() {
  }
  
  public V1alpha2ResourceClaimTemplateListFluent(V1alpha2ResourceClaimTemplateList instance) {
  ...
  protected void copyInstance(V1alpha2ResourceClaimTemplateList instance) {
    instance = (instance != null ? instance : new V1alpha2ResourceClaimTemplateList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha2ResourceClaimTemplate... items) {
    ...
    for (V1alpha2ResourceClaimTemplate item : items) {V1alpha2ResourceClaimTemplateBuilder builder = new V1alpha2ResourceClaimTemplateBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1alpha2ResourceClaimTemplate buildMatchingItem(Predicate<V1alpha2ResourceClaimTemplateBuilder> predicate) {
      for (V1alpha2ResourceClaimTemplateBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1alpha2ResourceClaimTemplate item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1alpha2ResourceClaimTemplate item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1alpha2ResourceClaimTemplateBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1alpha2ResourceClaimTemplateListFluent that = (V1alpha2ResourceClaimTemplateListFluent) o;
  ...
  public class ItemsNested<N> extends V1alpha2ResourceClaimTemplateFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1alpha2ResourceClaimTemplate item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1alpha2ResourceClaimTemplateListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha2ResourceClaimTemplateListFluent.this.withMetadata(builder.build());
    }
