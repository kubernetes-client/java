...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1AggregationRuleFluentImpl<A extends io.kubernetes.client.openapi.models.V1AggregationRuleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1AggregationRuleFluent<A>{
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> clusterRoleSelectors;
  public A addToClusterRoleSelectors(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LabelSelector item) {
    if (this.clusterRoleSelectors == null) {this.clusterRoleSelectors = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder>();}
  ...
  public A setToClusterRoleSelectors(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LabelSelector item) {
    if (this.clusterRoleSelectors == null) {this.clusterRoleSelectors = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder>();}
    io.kubernetes.client.openapi.models.V1LabelSelectorBuilder builder = new io.kubernetes.client.openapi.models.V1LabelSelectorBuilder(item);
  ...
  public A removeMatchingFromClusterRoleSelectors(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> each = clusterRoleSelectors.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1LabelSelector buildMatchingClusterRoleSelector(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1LabelSelectorBuilder item: clusterRoleSelectors) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingClusterRoleSelector(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1LabelSelectorBuilder item: clusterRoleSelectors) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withClusterRoleSelectors(java.util.List<io.kubernetes.client.openapi.models.V1LabelSelector> clusterRoleSelectors) {
    ...
    if (clusterRoleSelectors != null) {this.clusterRoleSelectors = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1LabelSelector item : clusterRoleSelectors){this.addToClusterRoleSelectors(item);}} else { this.clusterRoleSelectors = null;} return (A) this;
  }
  public A withClusterRoleSelectors(io.kubernetes.client.openapi.models.V1LabelSelector... clusterRoleSelectors) {
    ...
    if (clusterRoleSelectors != null) {for (io.kubernetes.client.openapi.models.V1LabelSelector item :clusterRoleSelectors){ this.addToClusterRoleSelectors(item);}} return (A) this;
  }
  public java.lang.Boolean hasClusterRoleSelectors() {
    return clusterRoleSelectors != null && !clusterRoleSelectors.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<A> addNewClusterRoleSelector() {
    return new io.kubernetes.client.openapi.models.V1AggregationRuleFluentImpl.ClusterRoleSelectorsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<A> addNewClusterRoleSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
    return new io.kubernetes.client.openapi.models.V1AggregationRuleFluentImpl.ClusterRoleSelectorsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<A> setNewClusterRoleSelectorLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LabelSelector item) {
    return new io.kubernetes.client.openapi.models.V1AggregationRuleFluentImpl.ClusterRoleSelectorsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<A> editClusterRoleSelector(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<A> editFirstClusterRoleSelector() {
  ...
  public io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<A> editLastClusterRoleSelector() {
  ...
  public io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<A> editMatchingClusterRoleSelector(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> predicate) {
    int index = -1;
