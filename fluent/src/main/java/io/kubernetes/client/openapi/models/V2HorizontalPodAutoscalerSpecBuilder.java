...
public class V2HorizontalPodAutoscalerSpecBuilder
    ...
    implements VisitableBuilder<
        V2HorizontalPodAutoscalerSpec, V2HorizontalPodAutoscalerSpecBuilder> {
  ...
  public V2HorizontalPodAutoscalerSpecBuilder(
      V2HorizontalPodAutoscalerSpecFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V2HorizontalPodAutoscalerSpec(), validationEnabled);
  }

  public V2HorizontalPodAutoscalerSpecBuilder(
      V2HorizontalPodAutoscalerSpecFluent<?> fluent, V2HorizontalPodAutoscalerSpec instance) {
  ...
  public V2HorizontalPodAutoscalerSpecBuilder(
      V2HorizontalPodAutoscalerSpec instance, Boolean validationEnabled) {
    this.fluent = this;
