...
public class V2beta1ObjectMetricSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent<A> {
    ...
    public V2beta1ObjectMetricSourceFluentImpl(io.kubernetes.client.openapi.models.V2beta1ObjectMetricSource instance) {
    ...
    public io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.SelectorNested<A> withNewSelector() {
        return new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluentImpl.SelectorNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.SelectorNested<A> withNewSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
        return new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluentImpl.SelectorNestedImpl(item);
    }
    ...
    public A withTarget(io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReference target) {
        ...
        if (target!=null){ this.target= new io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReferenceBuilder(target); _visitables.get("target").add(this.target);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.TargetNested<A> withNewTarget() {
        return new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluentImpl.TargetNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.TargetNested<A> withNewTargetLike(io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReference item) {
        return new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluentImpl.TargetNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.TargetNested<A> editOrNewTarget() {
        return withNewTargetLike(getTarget() != null ? getTarget(): new io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReferenceBuilder().build());
    }
    ...
    public int hashCode() {
        return java.util.Objects.hash(averageValue,  metricName,  selector,  target,  targetValue,  super.hashCode());
    }
