...
public class V1HorizontalPodAutoscalerFluentImpl<A extends V1HorizontalPodAutoscalerFluent<A>>
  ...
  public V1HorizontalPodAutoscalerFluent.MetadataNested<A> editOrNewMetadataLike(
      V1ObjectMeta item) {
  ...
  public V1HorizontalPodAutoscalerFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(
        getSpec() != null ? getSpec() : new V1HorizontalPodAutoscalerSpecBuilder().build());
  }
  ...
  public V1HorizontalPodAutoscalerFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(
        getStatus() != null ? getStatus() : new V1HorizontalPodAutoscalerStatusBuilder().build());
  }
  ...
  class MetadataNestedImpl<N>
      ...
      implements V1HorizontalPodAutoscalerFluent.MetadataNested<N>, Nested<N> {
  ...
  class SpecNestedImpl<N>
      ...
      implements V1HorizontalPodAutoscalerFluent.SpecNested<N>, Nested<N> {
  ...
  class StatusNestedImpl<N>
      ...
      implements V1HorizontalPodAutoscalerFluent.StatusNested<N>, Nested<N> {
