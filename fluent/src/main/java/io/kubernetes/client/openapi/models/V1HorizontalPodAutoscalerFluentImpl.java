...
public class V1HorizontalPodAutoscalerFluentImpl<A extends io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpecBuilder spec;
    private io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatusBuilder status;

    public V1HorizontalPodAutoscalerFluentImpl() {
    }

    public V1HorizontalPodAutoscalerFluentImpl(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscaler instance) {
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpec item) {
        return new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatus item) {
        return new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluentImpl.StatusNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatusBuilder().build());
    }
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpecFluentImpl<io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpecBuilder builder;

            SpecNestedImpl(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpecBuilder(this, item);
                        
            }

            SpecNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpecBuilder(this);
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatusFluentImpl<io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatusBuilder builder;

            StatusNestedImpl(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatusBuilder(this, item);
                        
            }

            StatusNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerStatusBuilder(this);
