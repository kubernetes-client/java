...
public interface V1alpha1FlowSchemaFluent<A extends io.kubernetes.client.openapi.models.V1alpha1FlowSchemaFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1alpha1FlowSchemaSpecFluent<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaFluent.SpecNested<N>> {

            public N and();
            public N endSpec();    }


    public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1alpha1FlowSchemaStatusFluent<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaFluent.StatusNested<N>> {
