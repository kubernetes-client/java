...
public class V1beta2ResourcePolicyRuleFluent<A extends V1beta2ResourcePolicyRuleFluent<A>> extends BaseFluent<A>{
  public V1beta2ResourcePolicyRuleFluent() {
  }
  
  public V1beta2ResourcePolicyRuleFluent(V1beta2ResourcePolicyRule instance) {
  ...
  protected void copyInstance(V1beta2ResourcePolicyRule instance) {
    instance = (instance != null ? instance : new V1beta2ResourcePolicyRule());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2ResourcePolicyRuleFluent that = (V1beta2ResourcePolicyRuleFluent) o;
