...
public class V1IngressSpecFluentImpl<A extends V1IngressSpecFluent<A>> extends BaseFluent<A>
  ...
  private java.util.ArrayList<V1IngressTLSBuilder> tls;
  ...
  public A addToRules(Integer index, io.kubernetes.client.openapi.models.V1IngressRule item) {
    if (this.rules == null) {
      this.rules = new java.util.ArrayList<V1IngressRuleBuilder>();
    }
  ...
  public A removeMatchingFromRules(
      Predicate<io.kubernetes.client.openapi.models.V1IngressRuleBuilder> predicate) {
  ...
  public A addToTls(
    ...
    if (this.tls == null) {
      this.tls = new java.util.ArrayList<V1IngressTLSBuilder>();
    }
