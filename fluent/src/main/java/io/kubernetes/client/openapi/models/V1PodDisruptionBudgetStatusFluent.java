...
import java.util.Map;
  ...
  * Generated
  */
public interface V1PodDisruptionBudgetStatusFluent<A extends io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface ConditionsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ConditionFluent<io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusFluent.ConditionsNested<N>>{
    public N and();
