...
public interface V1beta1JobTemplateSpecFluent<A extends io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1JobSpecFluent<io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecFluent.SpecNested<N>> {
