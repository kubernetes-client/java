...
public class V1NetworkPolicyListFluent<A extends V1NetworkPolicyListFluent<A>> extends BaseFluent<A>{
  public V1NetworkPolicyListFluent() {
  }
  
  public V1NetworkPolicyListFluent(V1NetworkPolicyList instance) {
  ...
  protected void copyInstance(V1NetworkPolicyList instance) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1NetworkPolicy... items) {
    ...
    for (V1NetworkPolicy item : items) {V1NetworkPolicyBuilder builder = new V1NetworkPolicyBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1NetworkPolicy buildMatchingItem(Predicate<V1NetworkPolicyBuilder> predicate) {
      for (V1NetworkPolicyBuilder item : items) {
  ...
  public A withItems(List<V1NetworkPolicy> items) {
    ...
    if (items != null) {
        ...
        for (V1NetworkPolicy item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1NetworkPolicy item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1NetworkPolicy item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1NetworkPolicyBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1NetworkPolicyListFluent that = (V1NetworkPolicyListFluent) o;
  ...
  public class ItemsNested<N> extends V1NetworkPolicyFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1NetworkPolicy item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1NetworkPolicyListFluent.this.withMetadata(builder.build());
    }
