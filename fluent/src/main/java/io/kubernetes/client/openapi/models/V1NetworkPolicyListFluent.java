...
public class V1NetworkPolicyListFluent<A extends io.kubernetes.client.openapi.models.V1NetworkPolicyListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1NetworkPolicy... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1NetworkPolicy... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1NetworkPolicy item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1NetworkPolicyBuilder> predicate) {
    ...
    Iterator<V1NetworkPolicyBuilder> each = items.iterator();
  ...
  public A withItems(V1NetworkPolicy... items) {
    if (this.items != null) {
        this.items.clear();
