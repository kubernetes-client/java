...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta2FlowSchemaStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent<A>{
  public V1beta2FlowSchemaStatusFluentImpl() {
  }
  public V1beta2FlowSchemaStatusFluentImpl(io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatus instance) {
    this.withConditions(instance.getConditions());

  }
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder> conditions;
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder(item);_visitables.get("conditions").add(index >= 0 ? index : _visitables.get("conditions").size(), builder);this.conditions.add(index >= 0 ? index : conditions.size(), builder); return (A)this;
  }
  public A setToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder(item);
  ...
  public A addToConditions(io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition... items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item : items) {io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeFromConditions(io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition... items) {
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item : items) {io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder(item);_visitables.get("conditions").remove(builder);if (this.conditions != null) {this.conditions.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder> each = conditions.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition buildMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder item: conditions) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder item: conditions) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition> conditions) {
    ...
    if (conditions != null) {this.conditions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
  }
  public A withConditions(io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition... conditions) {
    if (this.conditions != null) {this.conditions.clear();}
    if (conditions != null) {for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item :conditions){ this.addToConditions(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent.ConditionsNested<A> addNewCondition() {
    return new io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluentImpl.ConditionsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item) {
    return new io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluentImpl.ConditionsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item) {
    return new io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionFluentImpl<io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ConditionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder(this, item);
    }
    ConditionsNestedImpl() {
      this.index = -1;
      this.builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder(this);
    }
