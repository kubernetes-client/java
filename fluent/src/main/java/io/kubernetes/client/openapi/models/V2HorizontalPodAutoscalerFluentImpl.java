...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2HorizontalPodAutoscalerFluentImpl<A extends io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent<A>{
  public V2HorizontalPodAutoscalerFluentImpl() {
  }
  public V2HorizontalPodAutoscalerFluentImpl(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscaler instance) {
  ...
  private io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecBuilder spec;
  private io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatusBuilder status;
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpec spec) {
    ...
    if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  public java.lang.Boolean hasSpec() {
    return this.spec != null;
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.SpecNested<A> withNewSpec() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluentImpl.SpecNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpec item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluentImpl.SpecNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecBuilder().build());
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatus status) {
    ...
    if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  public java.lang.Boolean hasStatus() {
    return this.status != null;
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.StatusNested<A> withNewStatus() {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluentImpl.StatusNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatus item) {
    return new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluentImpl.StatusNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatusBuilder().build());
  }
  ...
  public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluentImpl<io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
    SpecNestedImpl(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpec item) {
      this.builder = new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecBuilder(this, item);
    }
    SpecNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecBuilder(this);
    }
  ...
  public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatusFluentImpl<io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
    StatusNestedImpl(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatus item) {
      this.builder = new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatusBuilder(this, item);
    }
    StatusNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatusBuilder(this);
    }
