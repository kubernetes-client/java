...
public class V2beta1HorizontalPodAutoscalerStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusFluent<A> {
    ...
    public A withCurrentMetrics(java.util.List<io.kubernetes.client.openapi.models.V2beta1MetricStatus> currentMetrics) {
        ...
        if (currentMetrics != null) {this.currentMetrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta1MetricStatusBuilder>(); for (io.kubernetes.client.openapi.models.V2beta1MetricStatus item : currentMetrics){this.addToCurrentMetrics(item);}} else { this.currentMetrics = null;} return (A) this;
    }
    ...
    public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerConditionFluentImpl<io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            ConditionsNestedImpl(int index,io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerCondition item) {
                this.index = index;
    ...
    public class CurrentMetricsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta1MetricStatusFluentImpl<io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta1MetricStatusBuilder builder;
        private final int index;

            CurrentMetricsNestedImpl(int index,io.kubernetes.client.openapi.models.V2beta1MetricStatus item) {
                this.index = index;
