...
public class CoreV1EventBuilder extends io.kubernetes.client.openapi.models.CoreV1EventFluentImpl<io.kubernetes.client.openapi.models.CoreV1EventBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.CoreV1Event,io.kubernetes.client.openapi.models.CoreV1EventBuilder> {
    ...
    public CoreV1EventBuilder(io.kubernetes.client.openapi.models.CoreV1EventFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new CoreV1Event(), validationEnabled);
    }

    public CoreV1EventBuilder(io.kubernetes.client.openapi.models.CoreV1EventFluent<?> fluent,io.kubernetes.client.openapi.models.CoreV1Event instance) {
        this(fluent, instance, true);
    }

    public CoreV1EventBuilder(io.kubernetes.client.openapi.models.CoreV1EventFluent<?> fluent,io.kubernetes.client.openapi.models.CoreV1Event instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public CoreV1EventBuilder(io.kubernetes.client.openapi.models.CoreV1Event instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
