...
public class V1NetworkPolicyStatusBuilder
    ...
    implements VisitableBuilder<V1NetworkPolicyStatus, V1NetworkPolicyStatusBuilder> {
  ...
  public V1NetworkPolicyStatusBuilder(
      V1NetworkPolicyStatusFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V1NetworkPolicyStatus(), validationEnabled);
  }

  public V1NetworkPolicyStatusBuilder(
      V1NetworkPolicyStatusFluent<?> fluent, V1NetworkPolicyStatus instance) {
