...
public class V1StorageClassListFluentImpl<A extends io.kubernetes.client.openapi.models.V1StorageClassListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1StorageClassListFluent<A> {
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1StorageClass> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1StorageClassBuilder>(); for (io.kubernetes.client.openapi.models.V1StorageClass item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StorageClassFluentImpl<io.kubernetes.client.openapi.models.V1StorageClassListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1StorageClassListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1StorageClassBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1StorageClass item) {
                this.index = index;
