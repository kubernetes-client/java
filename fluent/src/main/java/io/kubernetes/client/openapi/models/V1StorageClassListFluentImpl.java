...
import java.lang.Object;
  ...
  * Generated
  */
public class V1StorageClassListFluentImpl<A extends io.kubernetes.client.openapi.models.V1StorageClassListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1StorageClassListFluent<A>{
  ...
  private java.util.List<io.kubernetes.client.openapi.models.V1StorageClassBuilder> items;
  ...
  public A addToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1StorageClass item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1StorageClassBuilder>();}
    io.kubernetes.client.openapi.models.V1StorageClassBuilder builder = new io.kubernetes.client.openapi.models.V1StorageClassBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1StorageClass item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1StorageClassBuilder>();}
    io.kubernetes.client.openapi.models.V1StorageClassBuilder builder = new io.kubernetes.client.openapi.models.V1StorageClassBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1StorageClass... items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1StorageClassBuilder>();}
    for (io.kubernetes.client.openapi.models.V1StorageClass item : items) {io.kubernetes.client.openapi.models.V1StorageClassBuilder builder = new io.kubernetes.client.openapi.models.V1StorageClassBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1StorageClass... items) {
    for (io.kubernetes.client.openapi.models.V1StorageClass item : items) {io.kubernetes.client.openapi.models.V1StorageClassBuilder builder = new io.kubernetes.client.openapi.models.V1StorageClassBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1StorageClassBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1StorageClassBuilder> each = items.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1StorageClass buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1StorageClassBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1StorageClassBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1StorageClassBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1StorageClassBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1StorageClass> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1StorageClass item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1StorageClass... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (io.kubernetes.client.openapi.models.V1StorageClass item :items){ this.addToItems(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1StorageClassListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1StorageClass item) {
    return new io.kubernetes.client.openapi.models.V1StorageClassListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1StorageClassListFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1StorageClass item) {
    return new io.kubernetes.client.openapi.models.V1StorageClassListFluentImpl.ItemsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1StorageClassListFluent.ItemsNested<A> editItem(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1StorageClassListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
    return new io.kubernetes.client.openapi.models.V1StorageClassListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StorageClassFluentImpl<io.kubernetes.client.openapi.models.V1StorageClassListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1StorageClassListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1StorageClass item) {
      this.index = index;
