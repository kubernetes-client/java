...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1StorageClass item) {
    ...
    V1StorageClassBuilder builder = new V1StorageClassBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1StorageClassFluentImpl<V1StorageClassListFluent.ItemsNested<N>> implements V1StorageClassListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1StorageClass item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1StorageClassListFluent.MetadataNested<N>> implements V1StorageClassListFluent.MetadataNested<N>,Nested<N>{
