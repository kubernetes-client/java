...
public class V1ScopeSelectorFluentImpl<A extends io.kubernetes.client.openapi.models.V1ScopeSelectorFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ScopeSelectorFluent<A> {
    ...
    public class MatchExpressionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ScopedResourceSelectorRequirementFluentImpl<io.kubernetes.client.openapi.models.V1ScopeSelectorFluent.MatchExpressionsNested<N>> implements io.kubernetes.client.openapi.models.V1ScopeSelectorFluent.MatchExpressionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ScopedResourceSelectorRequirementBuilder builder;
        private final int index;

            MatchExpressionsNestedImpl(int index,io.kubernetes.client.openapi.models.V1ScopedResourceSelectorRequirement item) {
                this.index = index;
