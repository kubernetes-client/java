...
public class V1PersistentVolumeListFluent<A extends V1PersistentVolumeListFluent<A>> extends BaseFluent<A>{
  public V1PersistentVolumeListFluent() {
  }
  
  public V1PersistentVolumeListFluent(V1PersistentVolumeList instance) {
  ...
  protected void copyInstance(V1PersistentVolumeList instance) {
    instance = (instance != null ? instance : new V1PersistentVolumeList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1PersistentVolume... items) {
    ...
    for (V1PersistentVolume item : items) {V1PersistentVolumeBuilder builder = new V1PersistentVolumeBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1PersistentVolume buildMatchingItem(Predicate<V1PersistentVolumeBuilder> predicate) {
      for (V1PersistentVolumeBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1PersistentVolume item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1PersistentVolume item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1PersistentVolumeBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1PersistentVolumeListFluent that = (V1PersistentVolumeListFluent) o;
  ...
  public class ItemsNested<N> extends V1PersistentVolumeFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1PersistentVolume item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1PersistentVolumeListFluent.this.withMetadata(builder.build());
    }
