...
public class V1PersistentVolumeListFluent<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1PersistentVolumeBuilder> predicate) {
    ...
    Iterator<V1PersistentVolumeBuilder> each = items.iterator();
