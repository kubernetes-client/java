...
public class V1alpha1FlowSchemaListFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent<A> {

    private java.lang.String apiVersion;
    private java.util.List<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder> items;
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1alpha1FlowSchema item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder>();}
        io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
    }

    public A setToItems(int index,io.kubernetes.client.openapi.models.V1alpha1FlowSchema item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder>();}
        io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder(item);
    ...
    public A addToItems(io.kubernetes.client.openapi.models.V1alpha1FlowSchema... items) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder>();}
        for (io.kubernetes.client.openapi.models.V1alpha1FlowSchema item : items) {io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
    }
    ...
    public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha1FlowSchema... items) {
        for (io.kubernetes.client.openapi.models.V1alpha1FlowSchema item : items) {io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder> each = items.iterator();
        final List visitables = _visitables.get("items");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.V1alpha1FlowSchema buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1alpha1FlowSchema> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder>(); for (io.kubernetes.client.openapi.models.V1alpha1FlowSchema item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }

    public A withItems(io.kubernetes.client.openapi.models.V1alpha1FlowSchema... items) {
        if (this.items != null) {this.items.clear();}
        if (items != null) {for (io.kubernetes.client.openapi.models.V1alpha1FlowSchema item :items){ this.addToItems(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1alpha1FlowSchema item) {
        return new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluentImpl.ItemsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1alpha1FlowSchema item) {
        return new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluentImpl.ItemsNestedImpl(index, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
        return new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1alpha1FlowSchemaListFluentImpl that = (V1alpha1FlowSchemaListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1alpha1FlowSchemaFluentImpl<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1alpha1FlowSchema item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder(this, item);
                        
            }

            ItemsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1alpha1FlowSchemaBuilder(this);
                        
            }

            public N and() {
                return (N) V1alpha1FlowSchemaListFluentImpl.this.setToItems(index,builder.build());
            }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1FlowSchemaListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ListMetaBuilder builder;
            ...
            public N and() {
                return (N) V1alpha1FlowSchemaListFluentImpl.this.withMetadata(builder.build());
            }
