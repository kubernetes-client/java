...
import java.lang.Boolean;
  ...
  */
  ...
  public V1alpha1SelfSubjectReviewStatusFluentImpl(V1alpha1SelfSubjectReviewStatus instance) {
    if (instance != null) {
  ...
  public V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNested<A> withNewUserInfo() {
    return new V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNestedImpl();
  }
  public V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNested<A> withNewUserInfoLike(V1UserInfo item) {
    return new V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNestedImpl(item);
  }
  public V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNested<A> editUserInfo() {
    return withNewUserInfoLike(getUserInfo());
  }
  public V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNested<A> editOrNewUserInfo() {
    return withNewUserInfoLike(getUserInfo() != null ? getUserInfo(): new V1UserInfoBuilder().build());
  }
  public V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNested<A> editOrNewUserInfoLike(V1UserInfo item) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1SelfSubjectReviewStatusFluentImpl that = (V1alpha1SelfSubjectReviewStatusFluentImpl) o;
  ...
  class UserInfoNestedImpl<N> extends V1UserInfoFluentImpl<V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNested<N>> implements V1alpha1SelfSubjectReviewStatusFluentImpl.UserInfoNested<N>,Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1SelfSubjectReviewStatusFluentImpl.this.withUserInfo(builder.build());
    }
