...
public class V1beta1PriorityLevelConfigurationStatusBuilder
    ...
    implements VisitableBuilder<
        V1beta1PriorityLevelConfigurationStatus, V1beta1PriorityLevelConfigurationStatusBuilder> {
  ...
  public V1beta1PriorityLevelConfigurationStatusBuilder(
      V1beta1PriorityLevelConfigurationStatusFluent<?> fluent, Boolean validationEnabled) {
  ...
  public V1beta1PriorityLevelConfigurationStatusBuilder(
      V1beta1PriorityLevelConfigurationStatus instance, Boolean validationEnabled) {
    this.fluent = this;
