...
public class V1CustomResourceDefinitionFluentImpl<
  ...
  public V1CustomResourceDefinitionFluentImpl(
      io.kubernetes.client.openapi.models.V1CustomResourceDefinition instance) {
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpec spec) {
    ...
    if (spec != null) {
      this.spec =
          new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder(spec);
  ...
  public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.SpecNested<A>
    ...
    return withNewSpecLike(
        getSpec() != null
            ? getSpec()
            : new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder()
                .build());
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatus status) {
    ...
    if (status != null) {
      this.status =
          new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusBuilder(status);
  ...
  public class SpecNestedImpl<N>
    ...
    SpecNestedImpl() {
      this.builder =
          new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder(this);
    }
  ...
  public class StatusNestedImpl<N>
    ...
    StatusNestedImpl() {
      this.builder =
          new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusBuilder(this);
    }
