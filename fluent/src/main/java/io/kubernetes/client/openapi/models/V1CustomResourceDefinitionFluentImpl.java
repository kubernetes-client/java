...
public class V1CustomResourceDefinitionFluentImpl<A extends io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent<A> {
    ...
    public V1CustomResourceDefinitionFluentImpl(io.kubernetes.client.openapi.models.V1CustomResourceDefinition instance) {
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpec item) {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatus item) {
        return new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluentImpl.StatusNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusBuilder().build());
    }
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecFluentImpl<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder builder;

            SpecNestedImpl(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder(this, item);
                        
            }

            SpecNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionSpecBuilder(this);
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusFluentImpl<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusBuilder builder;

            StatusNestedImpl(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusBuilder(this, item);
                        
            }

            StatusNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CustomResourceDefinitionStatusBuilder(this);
