...
public class V1beta2QueuingConfigurationFluent<A extends V1beta2QueuingConfigurationFluent<A>> extends BaseFluent<A>{
  public V1beta2QueuingConfigurationFluent() {
  }
  
  public V1beta2QueuingConfigurationFluent(V1beta2QueuingConfiguration instance) {
  ...
  protected void copyInstance(V1beta2QueuingConfiguration instance) {
    instance = (instance != null ? instance : new V1beta2QueuingConfiguration());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2QueuingConfigurationFluent that = (V1beta2QueuingConfigurationFluent) o;
