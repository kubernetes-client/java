...
public class V1PersistentVolumeListFluentImpl<A extends V1PersistentVolumeListFluent<A>>
    extends BaseFluent<A> implements V1PersistentVolumeListFluent<A> {
  ...
  public A addToItems(Integer index, V1PersistentVolume item) {
    if (this.items == null) {
      this.items = new ArrayList<V1PersistentVolumeBuilder>();
    }
  ...
  class ItemsNestedImpl<N>
      extends V1PersistentVolumeFluentImpl<V1PersistentVolumeListFluent.ItemsNested<N>>
      implements V1PersistentVolumeListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N>
      extends V1ListMetaFluentImpl<V1PersistentVolumeListFluent.MetadataNested<N>>
      implements V1PersistentVolumeListFluent.MetadataNested<N>, Nested<N> {
