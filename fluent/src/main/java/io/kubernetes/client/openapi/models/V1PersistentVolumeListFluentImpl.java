...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1PersistentVolume item) {
    ...
    V1PersistentVolumeBuilder builder = new V1PersistentVolumeBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1PersistentVolumeFluentImpl<V1PersistentVolumeListFluent.ItemsNested<N>> implements V1PersistentVolumeListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1PersistentVolume item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1PersistentVolumeListFluent.MetadataNested<N>> implements V1PersistentVolumeListFluent.MetadataNested<N>,Nested<N>{
