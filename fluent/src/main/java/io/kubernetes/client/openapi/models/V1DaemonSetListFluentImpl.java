...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1DaemonSet item) {
    ...
    V1DaemonSetBuilder builder = new V1DaemonSetBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1DaemonSetFluentImpl<V1DaemonSetListFluent.ItemsNested<N>> implements V1DaemonSetListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1DaemonSetListFluent.MetadataNested<N>> implements V1DaemonSetListFluent.MetadataNested<N>,Nested<N>{
