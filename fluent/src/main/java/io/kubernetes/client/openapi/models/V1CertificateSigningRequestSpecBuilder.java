...
public class V1CertificateSigningRequestSpecBuilder extends io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecFluentImpl<io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec,io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecBuilder> {
    ...
    public V1CertificateSigningRequestSpecBuilder(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecFluent<?> fluent) {
        this(fluent, true);
    }

    public V1CertificateSigningRequestSpecBuilder(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1CertificateSigningRequestSpec(), validationEnabled);
    }

    public V1CertificateSigningRequestSpecBuilder(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecFluent<?> fluent,io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec instance) {
        this(fluent, instance, true);
    }

    public V1CertificateSigningRequestSpecBuilder(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecFluent<?> fluent,io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1CertificateSigningRequestSpecBuilder(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec instance) {
        this(instance,true);
    }

    public V1CertificateSigningRequestSpecBuilder(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
