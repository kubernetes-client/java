...
public class V1beta1PodDisruptionBudgetStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluent.ConditionsNested<A> addNewCondition() {
    return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluentImpl.ConditionsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1Condition item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluentImpl.ConditionsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Condition item) {
    return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ConditionFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ...
    public N and() {
      return (N) V1beta1PodDisruptionBudgetStatusFluentImpl.this.setToConditions(index,builder.build());
    }
