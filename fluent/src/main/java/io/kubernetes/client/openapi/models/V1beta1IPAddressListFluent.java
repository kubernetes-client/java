...
public class V1beta1IPAddressListFluent<A extends io.kubernetes.client.openapi.models.V1beta1IPAddressListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1beta1IPAddress... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1beta1IPAddress item : items) {
  ...
  public A removeFromItems(V1beta1IPAddress... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1beta1IPAddress item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1beta1IPAddressBuilder> predicate) {
    ...
    Iterator<V1beta1IPAddressBuilder> each = items.iterator();
  ...
  public A withItems(V1beta1IPAddress... items) {
    if (this.items != null) {
        this.items.clear();
