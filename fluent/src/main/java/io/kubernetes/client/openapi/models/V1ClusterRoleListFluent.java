...
public class V1ClusterRoleListFluent<A extends V1ClusterRoleListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ClusterRole... items) {
    ...
    for (V1ClusterRole item : items) {V1ClusterRoleBuilder builder = new V1ClusterRoleBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1ClusterRoleBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1ClusterRoleListFluent that = (V1ClusterRoleListFluent) o;
