...
public interface V1ClusterRoleListFluent<A extends V1ClusterRoleListFluent<A>> extends Fluent<A>{
  ...
  public V1ClusterRoleListFluent.ItemsNested<A> setNewItemLike(int index,V1ClusterRole item);
  public V1ClusterRoleListFluent.ItemsNested<A> editItem(int index);
