...
public class V1NetworkPolicyFluentImpl<A extends io.kubernetes.client.openapi.models.V1NetworkPolicyFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1NetworkPolicyFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1NetworkPolicyFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1NetworkPolicyFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1NetworkPolicySpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1NetworkPolicySpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1NetworkPolicyFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1NetworkPolicySpecBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1NetworkPolicyFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicyFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1NetworkPolicySpecFluentImpl<io.kubernetes.client.openapi.models.V1NetworkPolicyFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicyFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
