...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1alpha1CSIStorageCapacityFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent<A>{
  public V1alpha1CSIStorageCapacityFluentImpl() {
  }
  public V1alpha1CSIStorageCapacityFluentImpl(io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacity instance) {
  ...
  public io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent.NodeTopologyNested<A> withNewNodeTopology() {
    return new io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluentImpl.NodeTopologyNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent.NodeTopologyNested<A> withNewNodeTopologyLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
    return new io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluentImpl.NodeTopologyNestedImpl(item);
  }
