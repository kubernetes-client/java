...
public class ApiextensionsV1beta1WebhookClientConfigFluentImpl<A extends io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluent<A> {

    private java.util.List<java.lang.Byte> caBundle;
    private io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReferenceBuilder service;
    private java.lang.String url;

    public ApiextensionsV1beta1WebhookClientConfigFluentImpl() {
    }

    public ApiextensionsV1beta1WebhookClientConfigFluentImpl(io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfig instance) {
    ...
    public A withService(io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReference service) {
        ...
        if (service!=null){ this.service= new io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReferenceBuilder(service); _visitables.get("service").add(this.service);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluent.ServiceNested<A> withNewService() {
        return new io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluentImpl.ServiceNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluent.ServiceNested<A> withNewServiceLike(io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReference item) {
        return new io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluentImpl.ServiceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluent.ServiceNested<A> editOrNewService() {
        return withNewServiceLike(getService() != null ? getService(): new io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReferenceBuilder().build());
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApiextensionsV1beta1WebhookClientConfigFluentImpl that = (ApiextensionsV1beta1WebhookClientConfigFluentImpl) o;
    ...
    public class ServiceNestedImpl<N> extends io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReferenceFluentImpl<io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluent.ServiceNested<N>> implements io.kubernetes.client.openapi.models.ApiextensionsV1beta1WebhookClientConfigFluent.ServiceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReferenceBuilder builder;

            ServiceNestedImpl(io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReference item) {
                this.builder = new io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReferenceBuilder(this, item);
                        
            }

            ServiceNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.ApiextensionsV1beta1ServiceReferenceBuilder(this);
                        
            }

            public N and() {
                return (N) ApiextensionsV1beta1WebhookClientConfigFluentImpl.this.withService(builder.build());
            }
