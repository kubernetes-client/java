...
public class V1beta2ResourceSliceSpecFluent<A extends V1beta2ResourceSliceSpecFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta2ResourceSliceSpecFluent(V1beta2ResourceSliceSpec instance) {
  ...
  protected void copyInstance(V1beta2ResourceSliceSpec instance) {
  ...
  public A addToDevices(int index,V1beta2Device item) {
    if (this.devices == null) {this.devices = new ArrayList<V1beta2DeviceBuilder>();}
    V1beta2DeviceBuilder builder = new V1beta2DeviceBuilder(item);
  ...
  public A setToDevices(int index,V1beta2Device item) {
    if (this.devices == null) {this.devices = new ArrayList<V1beta2DeviceBuilder>();}
    V1beta2DeviceBuilder builder = new V1beta2DeviceBuilder(item);
    if (index < 0 || index >= devices.size()) {
        _visitables.get("devices").add(builder);
  ...
  public A addToDevices(io.kubernetes.client.openapi.models.V1beta2Device... items) {
    if (this.devices == null) {this.devices = new ArrayList<V1beta2DeviceBuilder>();}
    for (V1beta2Device item : items) {V1beta2DeviceBuilder builder = new V1beta2DeviceBuilder(item);_visitables.get("devices").add(builder);this.devices.add(builder);} return (A)this;
  }
  
  public A addAllToDevices(Collection<V1beta2Device> items) {
    if (this.devices == null) {this.devices = new ArrayList<V1beta2DeviceBuilder>();}
    for (V1beta2Device item : items) {V1beta2DeviceBuilder builder = new V1beta2DeviceBuilder(item);_visitables.get("devices").add(builder);this.devices.add(builder);} return (A)this;
  }
  
  public A removeFromDevices(io.kubernetes.client.openapi.models.V1beta2Device... items) {
    if (this.devices == null) return (A)this;
    for (V1beta2Device item : items) {V1beta2DeviceBuilder builder = new V1beta2DeviceBuilder(item);_visitables.get("devices").remove(builder); this.devices.remove(builder);} return (A)this;
  }
  
  public A removeAllFromDevices(Collection<V1beta2Device> items) {
    if (this.devices == null) return (A)this;
    for (V1beta2Device item : items) {V1beta2DeviceBuilder builder = new V1beta2DeviceBuilder(item);_visitables.get("devices").remove(builder); this.devices.remove(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromDevices(Predicate<V1beta2DeviceBuilder> predicate) {
    ...
    final Iterator<V1beta2DeviceBuilder> each = devices.iterator();
    final List visitables = _visitables.get("devices");
    while (each.hasNext()) {
      V1beta2DeviceBuilder builder = each.next();
  ...
  public V1beta2Device buildDevice(int index) {
  ...
  public V1beta2Device buildMatchingDevice(Predicate<V1beta2DeviceBuilder> predicate) {
      for (V1beta2DeviceBuilder item : devices) {
  ...
  public A withDevices(List<V1beta2Device> devices) {
    if (this.devices != null) {
      this._visitables.get("devices").clear();
    }
    if (devices != null) {
        this.devices = new ArrayList();
        for (V1beta2Device item : devices) {
  ...
  public A withDevices(io.kubernetes.client.openapi.models.V1beta2Device... devices) {
    if (this.devices != null) {
        this.devices.clear();
  ...
  public DevicesNested<A> addNewDeviceLike(V1beta2Device item) {
    return new DevicesNested(-1, item);
  }
  
  public DevicesNested<A> setNewDeviceLike(int index,V1beta2Device item) {
  ...
  public DevicesNested<A> editMatchingDevice(Predicate<V1beta2DeviceBuilder> predicate) {
    int index = -1;
  ...
  public A withPool(V1beta2ResourcePool pool) {
    this._visitables.remove("pool");
    if (pool != null) {
        this.pool = new V1beta2ResourcePoolBuilder(pool);
  ...
  public PoolNested<A> withNewPoolLike(V1beta2ResourcePool item) {
  ...
  public PoolNested<A> editOrNewPool() {
    return withNewPoolLike(java.util.Optional.ofNullable(buildPool()).orElse(new V1beta2ResourcePoolBuilder().build()));
  }
  
  public PoolNested<A> editOrNewPoolLike(V1beta2ResourcePool item) {
    return withNewPoolLike(java.util.Optional.ofNullable(buildPool()).orElse(item));
  }
  
  public A addToSharedCounters(int index,V1beta2CounterSet item) {
    if (this.sharedCounters == null) {this.sharedCounters = new ArrayList<V1beta2CounterSetBuilder>();}
    V1beta2CounterSetBuilder builder = new V1beta2CounterSetBuilder(item);
  ...
  public A setToSharedCounters(int index,V1beta2CounterSet item) {
    if (this.sharedCounters == null) {this.sharedCounters = new ArrayList<V1beta2CounterSetBuilder>();}
    V1beta2CounterSetBuilder builder = new V1beta2CounterSetBuilder(item);
    if (index < 0 || index >= sharedCounters.size()) {
        _visitables.get("sharedCounters").add(builder);
  ...
  public A addToSharedCounters(io.kubernetes.client.openapi.models.V1beta2CounterSet... items) {
    if (this.sharedCounters == null) {this.sharedCounters = new ArrayList<V1beta2CounterSetBuilder>();}
    for (V1beta2CounterSet item : items) {V1beta2CounterSetBuilder builder = new V1beta2CounterSetBuilder(item);_visitables.get("sharedCounters").add(builder);this.sharedCounters.add(builder);} return (A)this;
  }
  
  public A addAllToSharedCounters(Collection<V1beta2CounterSet> items) {
    if (this.sharedCounters == null) {this.sharedCounters = new ArrayList<V1beta2CounterSetBuilder>();}
    for (V1beta2CounterSet item : items) {V1beta2CounterSetBuilder builder = new V1beta2CounterSetBuilder(item);_visitables.get("sharedCounters").add(builder);this.sharedCounters.add(builder);} return (A)this;
  }
  
  public A removeFromSharedCounters(io.kubernetes.client.openapi.models.V1beta2CounterSet... items) {
    if (this.sharedCounters == null) return (A)this;
    for (V1beta2CounterSet item : items) {V1beta2CounterSetBuilder builder = new V1beta2CounterSetBuilder(item);_visitables.get("sharedCounters").remove(builder); this.sharedCounters.remove(builder);} return (A)this;
  }
  
  public A removeAllFromSharedCounters(Collection<V1beta2CounterSet> items) {
    if (this.sharedCounters == null) return (A)this;
    for (V1beta2CounterSet item : items) {V1beta2CounterSetBuilder builder = new V1beta2CounterSetBuilder(item);_visitables.get("sharedCounters").remove(builder); this.sharedCounters.remove(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromSharedCounters(Predicate<V1beta2CounterSetBuilder> predicate) {
    ...
    final Iterator<V1beta2CounterSetBuilder> each = sharedCounters.iterator();
    final List visitables = _visitables.get("sharedCounters");
    while (each.hasNext()) {
      V1beta2CounterSetBuilder builder = each.next();
      if (predicate.test(builder)) {
        visitables.remove(builder);
        each.remove();
      }
  ...
  public V1beta2CounterSet buildSharedCounter(int index) {
  ...
  public V1beta2CounterSet buildMatchingSharedCounter(Predicate<V1beta2CounterSetBuilder> predicate) {
      for (V1beta2CounterSetBuilder item : sharedCounters) {
        if (predicate.test(item)) {
          return item.build();
        }
      }
  ...
  public A withSharedCounters(List<V1beta2CounterSet> sharedCounters) {
    ...
    if (sharedCounters != null) {
        ...
        for (V1beta2CounterSet item : sharedCounters) {
  ...
  public A withSharedCounters(io.kubernetes.client.openapi.models.V1beta2CounterSet... sharedCounters) {
    if (this.sharedCounters != null) {
  ...
  public SharedCountersNested<A> addNewSharedCounterLike(V1beta2CounterSet item) {
    return new SharedCountersNested(-1, item);
  }
  
  public SharedCountersNested<A> setNewSharedCounterLike(int index,V1beta2CounterSet item) {
  ...
  public SharedCountersNested<A> editMatchingSharedCounter(Predicate<V1beta2CounterSetBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1beta2ResourceSliceSpecFluent that = (V1beta2ResourceSliceSpecFluent) o;
  ...
  public class DevicesNested<N> extends V1beta2DeviceFluent<DevicesNested<N>> implements Nested<N>{
    DevicesNested(int index,V1beta2Device item) {
      this.index = index;
      this.builder = new V1beta2DeviceBuilder(this, item);
    }
  ...
  public class NodeSelectorNested<N> extends V1NodeSelectorFluent<NodeSelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2ResourceSliceSpecFluent.this.withNodeSelector(builder.build());
    }
  ...
  public class PoolNested<N> extends V1beta2ResourcePoolFluent<PoolNested<N>> implements Nested<N>{
    PoolNested(V1beta2ResourcePool item) {
      this.builder = new V1beta2ResourcePoolBuilder(this, item);
    }
    V1beta2ResourcePoolBuilder builder;
    
    public N and() {
      return (N) V1beta2ResourceSliceSpecFluent.this.withPool(builder.build());
    }
  ...
  public class SharedCountersNested<N> extends V1beta2CounterSetFluent<SharedCountersNested<N>> implements Nested<N>{
    SharedCountersNested(int index,V1beta2CounterSet item) {
      this.index = index;
      this.builder = new V1beta2CounterSetBuilder(this, item);
    }
    V1beta2CounterSetBuilder builder;
    int index;
    
    public N and() {
      return (N) V1beta2ResourceSliceSpecFluent.this.setToSharedCounters(index,builder.build());
    }
