...
public class V1ProjectedVolumeSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceFluent<A>{
  ...
  public A addToSources(java.lang.Integer index,io.kubernetes.client.openapi.models.V1VolumeProjection item) {
  ...
  public A withSources(java.util.List<io.kubernetes.client.openapi.models.V1VolumeProjection> sources) {
    ...
    if (sources != null) {this.sources = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1VolumeProjection item : sources){this.addToSources(item);}} else { this.sources = null;} return (A) this;
  }
  ...
  public class SourcesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1VolumeProjectionFluentImpl<io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceFluent.SourcesNested<N>> implements io.kubernetes.client.openapi.models.V1ProjectedVolumeSourceFluent.SourcesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    SourcesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1VolumeProjection item) {
      this.index = index;
