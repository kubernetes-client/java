...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1NodeSelectorTermFluentImpl<A extends io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent<A>{
  ...
  public A setToMatchExpressions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
    if (this.matchExpressions == null) {this.matchExpressions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder>();}
    io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(item);
  ...
  public A removeMatchingFromMatchExpressions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> each = matchExpressions.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1NodeSelectorRequirement buildMatchingMatchExpression(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder item: matchExpressions) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingMatchExpression(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder item: matchExpressions) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withMatchExpressions(java.util.List<io.kubernetes.client.openapi.models.V1NodeSelectorRequirement> matchExpressions) {
    ...
    if (matchExpressions != null) {this.matchExpressions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item : matchExpressions){this.addToMatchExpressions(item);}} else { this.matchExpressions = null;} return (A) this;
  }
  public A withMatchExpressions(io.kubernetes.client.openapi.models.V1NodeSelectorRequirement... matchExpressions) {
    ...
    if (matchExpressions != null) {for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item :matchExpressions){ this.addToMatchExpressions(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchExpressionsNested<A> addNewMatchExpression() {
    return new io.kubernetes.client.openapi.models.V1NodeSelectorTermFluentImpl.MatchExpressionsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchExpressionsNested<A> addNewMatchExpressionLike(io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
    return new io.kubernetes.client.openapi.models.V1NodeSelectorTermFluentImpl.MatchExpressionsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchExpressionsNested<A> setNewMatchExpressionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
    return new io.kubernetes.client.openapi.models.V1NodeSelectorTermFluentImpl.MatchExpressionsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchExpressionsNested<A> editMatchExpression(java.lang.Integer index) {
  ...
  public A addToMatchFields(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
    if (this.matchFields == null) {this.matchFields = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder>();}
    io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(item);_visitables.get("matchFields").add(index >= 0 ? index : _visitables.get("matchFields").size(), builder);this.matchFields.add(index >= 0 ? index : matchFields.size(), builder); return (A)this;
  }
  public A setToMatchFields(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
    if (this.matchFields == null) {this.matchFields = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder>();}
    io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(item);
  ...
  public A addToMatchFields(io.kubernetes.client.openapi.models.V1NodeSelectorRequirement... items) {
    if (this.matchFields == null) {this.matchFields = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder>();}
    for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item : items) {io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(item);_visitables.get("matchFields").add(builder);this.matchFields.add(builder);} return (A)this;
  }
  ...
  public A removeFromMatchFields(io.kubernetes.client.openapi.models.V1NodeSelectorRequirement... items) {
    for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item : items) {io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(item);_visitables.get("matchFields").remove(builder);if (this.matchFields != null) {this.matchFields.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromMatchFields(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> each = matchFields.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1NodeSelectorRequirement buildMatchingMatchField(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder item: matchFields) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingMatchField(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder item: matchFields) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withMatchFields(java.util.List<io.kubernetes.client.openapi.models.V1NodeSelectorRequirement> matchFields) {
    ...
    if (matchFields != null) {this.matchFields = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item : matchFields){this.addToMatchFields(item);}} else { this.matchFields = null;} return (A) this;
  }
  public A withMatchFields(io.kubernetes.client.openapi.models.V1NodeSelectorRequirement... matchFields) {
    ...
    if (matchFields != null) {for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item :matchFields){ this.addToMatchFields(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchFieldsNested<A> addNewMatchField() {
    return new io.kubernetes.client.openapi.models.V1NodeSelectorTermFluentImpl.MatchFieldsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchFieldsNested<A> addNewMatchFieldLike(io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
    return new io.kubernetes.client.openapi.models.V1NodeSelectorTermFluentImpl.MatchFieldsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchFieldsNested<A> setNewMatchFieldLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
    return new io.kubernetes.client.openapi.models.V1NodeSelectorTermFluentImpl.MatchFieldsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchFieldsNested<A> editMatchField(java.lang.Integer index) {
  ...
  public class MatchExpressionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1NodeSelectorRequirementFluentImpl<io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchExpressionsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchExpressionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    MatchExpressionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(this, item);
    }
  ...
  public class MatchFieldsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1NodeSelectorRequirementFluentImpl<io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchFieldsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchFieldsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    MatchFieldsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(this, item);
    }
