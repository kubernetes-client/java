...
public class V1DeviceTaintFluent<A extends io.kubernetes.client.openapi.models.V1DeviceTaintFluent<A>> extends BaseFluent<A>{
  public V1DeviceTaintFluent() {
  }
  
  public V1DeviceTaintFluent(V1DeviceTaint instance) {
  ...
  protected void copyInstance(V1DeviceTaint instance) {
    instance = instance != null ? instance : new V1DeviceTaint();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1DeviceTaintFluent that = (V1DeviceTaintFluent) o;
