...
public class V1alpha1RoleFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1RoleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1RoleFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1alpha1RoleFluent.RulesNested<A> setNewRuleLike(int index,io.kubernetes.client.openapi.models.V1alpha1PolicyRule item) {
        return new io.kubernetes.client.openapi.models.V1alpha1RoleFluentImpl.RulesNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1alpha1RoleFluent.RulesNested<A> editRule(int index) {
