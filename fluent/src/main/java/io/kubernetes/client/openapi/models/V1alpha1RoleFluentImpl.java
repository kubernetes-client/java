...
import java.lang.Object;
  ...
  * Generated
  */
public class V1alpha1RoleFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1RoleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1RoleFluent<A>{
  public V1alpha1RoleFluentImpl() {
  }
  public V1alpha1RoleFluentImpl(io.kubernetes.client.openapi.models.V1alpha1Role instance) {
  ...
  public io.kubernetes.client.openapi.models.V1alpha1RoleFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1alpha1RoleFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1alpha1RoleFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new io.kubernetes.client.openapi.models.V1alpha1RoleFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public A withRules(java.util.List<io.kubernetes.client.openapi.models.V1alpha1PolicyRule> rules) {
    ...
    if (rules != null) {this.rules = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1alpha1PolicyRule item : rules){this.addToRules(item);}} else { this.rules = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1alpha1RoleFluent.RulesNested<A> addNewRule() {
    return new io.kubernetes.client.openapi.models.V1alpha1RoleFluentImpl.RulesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1alpha1RoleFluent.RulesNested<A> addNewRuleLike(io.kubernetes.client.openapi.models.V1alpha1PolicyRule item) {
    return new io.kubernetes.client.openapi.models.V1alpha1RoleFluentImpl.RulesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1alpha1RoleFluent.RulesNested<A> setNewRuleLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1alpha1PolicyRule item) {
    return new io.kubernetes.client.openapi.models.V1alpha1RoleFluentImpl.RulesNestedImpl(index, item);
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1RoleFluentImpl that = (V1alpha1RoleFluentImpl) o;
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1alpha1RoleFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RoleFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1RoleFluentImpl.this.withMetadata(builder.build());
    }
  ...
  public class RulesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1alpha1PolicyRuleFluentImpl<io.kubernetes.client.openapi.models.V1alpha1RoleFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RoleFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    RulesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1alpha1PolicyRule item) {
      this.index = index;
    ...
    io.kubernetes.client.openapi.models.V1alpha1PolicyRuleBuilder builder;
    java.lang.Integer index;
    public N and() {
      return (N) V1alpha1RoleFluentImpl.this.setToRules(index,builder.build());
    }
    public N endRule() {
      return and();
    }
