...
public class V2alpha1JobTemplateSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent<A> {
    ...
    public V2alpha1JobTemplateSpecFluentImpl(io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpec instance) {
    ...
    public io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1JobSpec item) {
        return new io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluentImpl.SpecNestedImpl(item);
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1JobSpecFluentImpl<io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V2alpha1JobTemplateSpecFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
