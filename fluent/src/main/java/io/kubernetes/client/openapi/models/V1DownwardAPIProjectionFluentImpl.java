...
public class V1DownwardAPIProjectionFluentImpl<A extends io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent<A> {
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFile> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFileBuilder>(); for (io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFile item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFile item) {
        return new io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluentImpl.ItemsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFile item) {
        return new io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluentImpl.ItemsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent.ItemsNested<A> editItem(int index) {
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFileFluentImpl<io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFileBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFile item) {
                this.index = index;
