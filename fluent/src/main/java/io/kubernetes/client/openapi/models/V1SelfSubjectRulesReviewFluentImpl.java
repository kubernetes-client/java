...
public class V1SelfSubjectRulesReviewFluentImpl<A extends V1SelfSubjectRulesReviewFluent<A>>
  ...
  public V1SelfSubjectRulesReviewFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(
        getSpec() != null ? getSpec() : new V1SelfSubjectRulesReviewSpecBuilder().build());
  }
  ...
  public V1SelfSubjectRulesReviewFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(
        getStatus() != null ? getStatus() : new V1SubjectRulesReviewStatusBuilder().build());
  }
  ...
  class MetadataNestedImpl<N>
      ...
      implements V1SelfSubjectRulesReviewFluent.MetadataNested<N>, Nested<N> {
  ...
  class SpecNestedImpl<N>
      ...
      implements V1SelfSubjectRulesReviewFluent.SpecNested<N>, Nested<N> {
  ...
  class StatusNestedImpl<N>
      ...
      implements V1SelfSubjectRulesReviewFluent.StatusNested<N>, Nested<N> {
