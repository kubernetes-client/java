...
public class V1SelfSubjectRulesReviewFluentImpl<A extends io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent<A> {
    ...
    public V1SelfSubjectRulesReviewFluentImpl(io.kubernetes.client.openapi.models.V1SelfSubjectRulesReview instance) {
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpec item) {
        return new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatus item) {
        return new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluentImpl.StatusNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusBuilder().build());
    }
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpecFluentImpl<io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpecBuilder builder;
            ...
            SpecNestedImpl(io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpecBuilder(this, item);
                        
            }

            SpecNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewSpecBuilder(this);
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluentImpl<io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1SelfSubjectRulesReviewFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusBuilder builder;

            StatusNestedImpl(io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusBuilder(this, item);
                        
            }

            StatusNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusBuilder(this);
