...
public class V1beta2NonResourcePolicyRuleFluent<A extends V1beta2NonResourcePolicyRuleFluent<A>> extends BaseFluent<A>{
  public V1beta2NonResourcePolicyRuleFluent() {
  }
  
  public V1beta2NonResourcePolicyRuleFluent(V1beta2NonResourcePolicyRule instance) {
    this.copyInstance(instance);
  }
  private List<String> nonResourceURLs;
  private List<String> verbs;
  
  protected void copyInstance(V1beta2NonResourcePolicyRule instance) {
    instance = (instance != null ? instance : new V1beta2NonResourcePolicyRule());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2NonResourcePolicyRuleFluent that = (V1beta2NonResourcePolicyRuleFluent) o;
