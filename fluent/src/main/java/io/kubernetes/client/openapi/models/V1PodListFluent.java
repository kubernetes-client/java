...
public class V1PodListFluent<A extends V1PodListFluent<A>> extends BaseFluent<A>{
  public V1PodListFluent() {
  }
  
  public V1PodListFluent(V1PodList instance) {
  ...
  protected void copyInstance(V1PodList instance) {
    instance = (instance != null ? instance : new V1PodList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Pod... items) {
    ...
    for (V1Pod item : items) {V1PodBuilder builder = new V1PodBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public ItemsNested<A> addNewItemLike(V1Pod item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1Pod item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1PodBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1PodListFluent that = (V1PodListFluent) o;
  ...
  public class ItemsNested<N> extends V1PodFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1Pod item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1PodListFluent.this.withMetadata(builder.build());
    }
