...
public class V1PodListFluent<A extends io.kubernetes.client.openapi.models.V1PodListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1PodBuilder> predicate) {
    ...
    Iterator<V1PodBuilder> each = items.iterator();
