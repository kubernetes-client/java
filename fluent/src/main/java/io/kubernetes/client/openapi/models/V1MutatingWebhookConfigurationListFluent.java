...
public class V1MutatingWebhookConfigurationListFluent<A extends V1MutatingWebhookConfigurationListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1MutatingWebhookConfiguration... items) {
    ...
    for (V1MutatingWebhookConfiguration item : items) {V1MutatingWebhookConfigurationBuilder builder = new V1MutatingWebhookConfigurationBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
