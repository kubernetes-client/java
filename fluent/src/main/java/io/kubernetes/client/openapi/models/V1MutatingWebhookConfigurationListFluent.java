...
public class V1MutatingWebhookConfigurationListFluent<A extends io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationListFluent<A>> extends BaseFluent<A>{
  public V1MutatingWebhookConfigurationListFluent() {
  }
  
  public V1MutatingWebhookConfigurationListFluent(V1MutatingWebhookConfigurationList instance) {
  ...
  protected void copyInstance(V1MutatingWebhookConfigurationList instance) {
  ...
  public A addToItems(V1MutatingWebhookConfiguration... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1MutatingWebhookConfiguration... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1MutatingWebhookConfiguration item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1MutatingWebhookConfigurationBuilder> predicate) {
    ...
    Iterator<V1MutatingWebhookConfigurationBuilder> each = items.iterator();
  ...
  public A withItems(V1MutatingWebhookConfiguration... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public ItemsNested<A> addNewItemLike(V1MutatingWebhookConfiguration item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1MutatingWebhookConfiguration item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1MutatingWebhookConfigurationBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1MutatingWebhookConfigurationListFluent that = (V1MutatingWebhookConfigurationListFluent) o;
  ...
  public class ItemsNested<N> extends V1MutatingWebhookConfigurationFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1MutatingWebhookConfiguration item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1MutatingWebhookConfigurationListFluent.this.withMetadata(builder.build());
    }
