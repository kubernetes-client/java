...
public class V2beta2HorizontalPodAutoscalerFluentImpl<
  ...
  public A withSpec(V2beta2HorizontalPodAutoscalerSpec spec) {
    ...
    if (spec != null) {
      this.spec = new V2beta2HorizontalPodAutoscalerSpecBuilder(spec);
  ...
  public V2beta2HorizontalPodAutoscalerFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(
        getSpec() != null ? getSpec() : new V2beta2HorizontalPodAutoscalerSpecBuilder().build());
  }
  ...
  public V2beta2HorizontalPodAutoscalerFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(
        getStatus() != null
            ? getStatus()
            : new V2beta2HorizontalPodAutoscalerStatusBuilder().build());
  }
  ...
  class MetadataNestedImpl<N>
      ...
      implements V2beta2HorizontalPodAutoscalerFluent.MetadataNested<N>, Nested<N> {
  ...
  class SpecNestedImpl<N>
      ...
      implements V2beta2HorizontalPodAutoscalerFluent.SpecNested<N>, Nested<N> {
  ...
  class StatusNestedImpl<N>
      ...
      implements V2beta2HorizontalPodAutoscalerFluent.StatusNested<N>, Nested<N> {
