...
public class V1PersistentVolumeClaimListFluent<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent<A>> extends BaseFluent<A>{
  ...
  public V1PersistentVolumeClaimListFluent(V1PersistentVolumeClaimList instance) {
  ...
  public ItemsNested<A> addNewItemLike(V1PersistentVolumeClaim item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1PersistentVolumeClaim... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1PersistentVolumeClaim item : items) {
  ...
  protected void copyInstance(V1PersistentVolumeClaimList instance) {
    instance = instance != null ? instance : new V1PersistentVolumeClaimList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1PersistentVolumeClaimBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1PersistentVolumeClaimListFluent that = (V1PersistentVolumeClaimListFluent) o;
  ...
  public A removeFromItems(V1PersistentVolumeClaim... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1PersistentVolumeClaim item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1PersistentVolumeClaimBuilder> predicate) {
    ...
    Iterator<V1PersistentVolumeClaimBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1PersistentVolumeClaim item) {
  ...
  public A withItems(V1PersistentVolumeClaim... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1PersistentVolumeClaimFluent<ItemsNested<N>> implements Nested<N>{
  
    V1PersistentVolumeClaimBuilder builder;
    int index;
  
    ItemsNested(int index,V1PersistentVolumeClaim item) {
      this.index = index;
      this.builder = new V1PersistentVolumeClaimBuilder(this, item);
    }
  
    public N and() {
      return (N) V1PersistentVolumeClaimListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1PersistentVolumeClaimListFluent.this.withMetadata(builder.build());
    }
