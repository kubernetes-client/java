...
import java.lang.Boolean;
  ...
  */
  ...
  public A withDrivers(List<V1CSINodeDriver> drivers) {
    if (this.drivers != null) { _visitables.get("drivers").clear();}
  ...
  public V1CSINodeSpecFluentImpl.DriversNested<A> addNewDriver() {
    return new V1CSINodeSpecFluentImpl.DriversNestedImpl();
  }
  public V1CSINodeSpecFluentImpl.DriversNested<A> addNewDriverLike(V1CSINodeDriver item) {
    return new V1CSINodeSpecFluentImpl.DriversNestedImpl(-1, item);
  }
  public V1CSINodeSpecFluentImpl.DriversNested<A> setNewDriverLike(int index,V1CSINodeDriver item) {
    return new V1CSINodeSpecFluentImpl.DriversNestedImpl(index, item);
  }
  public V1CSINodeSpecFluentImpl.DriversNested<A> editDriver(int index) {
  ...
  public V1CSINodeSpecFluentImpl.DriversNested<A> editFirstDriver() {
  ...
  public V1CSINodeSpecFluentImpl.DriversNested<A> editLastDriver() {
    int index = drivers.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last drivers. The list is empty.");
    return setNewDriverLike(index, buildDriver(index));
  }
  public V1CSINodeSpecFluentImpl.DriversNested<A> editMatchingDriver(Predicate<V1CSINodeDriverBuilder> predicate) {
    int index = -1;
  ...
  public String toString() {
    ...
    sb.append("{");
    if (drivers != null) { sb.append("drivers:"); sb.append(drivers); }
    sb.append("}");
    return sb.toString();
  }
  class DriversNestedImpl<N> extends V1CSINodeDriverFluentImpl<V1CSINodeSpecFluentImpl.DriversNested<N>> implements V1CSINodeSpecFluentImpl.DriversNested<N>,Nested<N>{
    DriversNestedImpl(int index,V1CSINodeDriver item) {
      this.index = index;
