...
public class V1CSINodeSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1CSINodeSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CSINodeSpecFluent<A> {
    ...
    public A setToDrivers(int index,io.kubernetes.client.openapi.models.V1CSINodeDriver item) {
        if (this.drivers == null) {this.drivers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder>();}
        io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder builder = new io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder(item);
    ...
    public A addToDrivers(io.kubernetes.client.openapi.models.V1CSINodeDriver... items) {
        if (this.drivers == null) {this.drivers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder>();}
        for (io.kubernetes.client.openapi.models.V1CSINodeDriver item : items) {io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder builder = new io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder(item);_visitables.get("drivers").add(builder);this.drivers.add(builder);} return (A)this;
    }
    ...
    public A removeFromDrivers(io.kubernetes.client.openapi.models.V1CSINodeDriver... items) {
        for (io.kubernetes.client.openapi.models.V1CSINodeDriver item : items) {io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder builder = new io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder(item);_visitables.get("drivers").remove(builder);if (this.drivers != null) {this.drivers.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromDrivers(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder> each = drivers.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1CSINodeDriver buildMatchingDriver(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder item: drivers) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingDriver(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder item: drivers) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withDrivers(java.util.List<io.kubernetes.client.openapi.models.V1CSINodeDriver> drivers) {
        ...
        if (drivers != null) {this.drivers = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder>(); for (io.kubernetes.client.openapi.models.V1CSINodeDriver item : drivers){this.addToDrivers(item);}} else { this.drivers = null;} return (A) this;
    }

    public A withDrivers(io.kubernetes.client.openapi.models.V1CSINodeDriver... drivers) {
        if (this.drivers != null) {this.drivers.clear();}
        if (drivers != null) {for (io.kubernetes.client.openapi.models.V1CSINodeDriver item :drivers){ this.addToDrivers(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSINodeSpecFluent.DriversNested<A> addNewDriverLike(io.kubernetes.client.openapi.models.V1CSINodeDriver item) {
        return new io.kubernetes.client.openapi.models.V1CSINodeSpecFluentImpl.DriversNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSINodeSpecFluent.DriversNested<A> setNewDriverLike(int index,io.kubernetes.client.openapi.models.V1CSINodeDriver item) {
        return new io.kubernetes.client.openapi.models.V1CSINodeSpecFluentImpl.DriversNestedImpl(index, item);
    }
    ...
    public class DriversNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CSINodeDriverFluentImpl<io.kubernetes.client.openapi.models.V1CSINodeSpecFluent.DriversNested<N>> implements io.kubernetes.client.openapi.models.V1CSINodeSpecFluent.DriversNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CSINodeDriverBuilder builder;
        private final int index;

            DriversNestedImpl(int index,io.kubernetes.client.openapi.models.V1CSINodeDriver item) {
                this.index = index;
