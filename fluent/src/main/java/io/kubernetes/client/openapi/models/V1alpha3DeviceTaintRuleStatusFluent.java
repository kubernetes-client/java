...
public class V1alpha3DeviceTaintRuleStatusFluent<A extends io.kubernetes.client.openapi.models.V1alpha3DeviceTaintRuleStatusFluent<A>> extends BaseFluent<A>{

  private ArrayList<V1ConditionBuilder> conditions;

  public V1alpha3DeviceTaintRuleStatusFluent() {
  }
  
  public V1alpha3DeviceTaintRuleStatusFluent(V1alpha3DeviceTaintRuleStatus instance) {
  ...
  protected void copyInstance(V1alpha3DeviceTaintRuleStatus instance) {
    instance = instance != null ? instance : new V1alpha3DeviceTaintRuleStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3DeviceTaintRuleStatusFluent that = (V1alpha3DeviceTaintRuleStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha3DeviceTaintRuleStatusFluent.this.setToConditions(index, builder.build());
    }
