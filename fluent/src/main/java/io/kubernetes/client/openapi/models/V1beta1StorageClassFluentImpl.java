...
public class V1beta1StorageClassFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1StorageClassFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1StorageClassFluent<A> {
    ...
    public V1beta1StorageClassFluentImpl() {
    }

    public V1beta1StorageClassFluentImpl(io.kubernetes.client.openapi.models.V1beta1StorageClass instance) {
    ...
    public A removeMatchingFromAllowedTopologies(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder> each = allowedTopologies.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1TopologySelectorTerm buildMatchingAllowedTopology(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder item: allowedTopologies) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingAllowedTopology(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder item: allowedTopologies) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withAllowedTopologies(io.kubernetes.client.openapi.models.V1TopologySelectorTerm... allowedTopologies) {
        ...
        if (allowedTopologies != null) {for (io.kubernetes.client.openapi.models.V1TopologySelectorTerm item :allowedTopologies){ this.addToAllowedTopologies(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<A> addNewAllowedTopology() {
        return new io.kubernetes.client.openapi.models.V1beta1StorageClassFluentImpl.AllowedTopologiesNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<A> addNewAllowedTopologyLike(io.kubernetes.client.openapi.models.V1TopologySelectorTerm item) {
        return new io.kubernetes.client.openapi.models.V1beta1StorageClassFluentImpl.AllowedTopologiesNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<A> setNewAllowedTopologyLike(int index,io.kubernetes.client.openapi.models.V1TopologySelectorTerm item) {
        return new io.kubernetes.client.openapi.models.V1beta1StorageClassFluentImpl.AllowedTopologiesNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<A> editAllowedTopology(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<A> editFirstAllowedTopology() {
    ...
    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<A> editLastAllowedTopology() {
    ...
    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<A> editMatchingAllowedTopology(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder> predicate) {
        int index = -1;
    ...
    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1StorageClassFluentImpl.MetadataNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1StorageClassFluentImpl.MetadataNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<A> editMetadata() {
        return withNewMetadataLike(getMetadata());
    }

    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<A> editOrNewMetadata() {
    ...
    public io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<A> editOrNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1StorageClassFluentImpl that = (V1beta1StorageClassFluentImpl) o;
    ...
    public class AllowedTopologiesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TopologySelectorTermFluentImpl<io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.AllowedTopologiesNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder builder;
        private final int index;

            AllowedTopologiesNestedImpl(int index,io.kubernetes.client.openapi.models.V1TopologySelectorTerm item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder(this, item);
            ...
            public N and() {
                return (N) V1beta1StorageClassFluentImpl.this.setToAllowedTopologies(index,builder.build());
            }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1StorageClassFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ObjectMetaBuilder builder;
            ...
            public N and() {
                return (N) V1beta1StorageClassFluentImpl.this.withMetadata(builder.build());
            }
