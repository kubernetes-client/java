...
public class V1CustomResourceDefinitionVersionBuilder extends io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluentImpl<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersion,io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionBuilder> {
    ...
    public V1CustomResourceDefinitionVersionBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent<?> fluent) {
        this(fluent, true);
    }

    public V1CustomResourceDefinitionVersionBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1CustomResourceDefinitionVersion(), validationEnabled);
    }

    public V1CustomResourceDefinitionVersionBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent<?> fluent,io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersion instance) {
        this(fluent, instance, true);
    }

    public V1CustomResourceDefinitionVersionBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent<?> fluent,io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersion instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1CustomResourceDefinitionVersionBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersion instance) {
        this(instance,true);
    }

    public V1CustomResourceDefinitionVersionBuilder(io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersion instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
