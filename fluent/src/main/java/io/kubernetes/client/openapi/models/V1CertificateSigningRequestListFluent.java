...
public interface V1CertificateSigningRequestListFluent<A extends V1CertificateSigningRequestListFluent<A>> extends Fluent<A>{
  ...
  public V1CertificateSigningRequestListFluent.ItemsNested<A> setNewItemLike(int index,V1CertificateSigningRequest item);
  public V1CertificateSigningRequestListFluent.ItemsNested<A> editItem(int index);
