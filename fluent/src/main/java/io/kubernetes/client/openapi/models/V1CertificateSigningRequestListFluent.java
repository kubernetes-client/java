...
public class V1CertificateSigningRequestListFluent<A extends io.kubernetes.client.openapi.models.V1CertificateSigningRequestListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1CertificateSigningRequest... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1CertificateSigningRequest item : items) {
  ...
  public A removeFromItems(V1CertificateSigningRequest... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1CertificateSigningRequest item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1CertificateSigningRequestBuilder> predicate) {
    ...
    Iterator<V1CertificateSigningRequestBuilder> each = items.iterator();
  ...
  public A withItems(V1CertificateSigningRequest... items) {
    if (this.items != null) {
        this.items.clear();
