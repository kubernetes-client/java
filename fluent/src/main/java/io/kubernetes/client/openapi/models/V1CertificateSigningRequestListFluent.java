...
public class V1CertificateSigningRequestListFluent<A extends V1CertificateSigningRequestListFluent<A>> extends BaseFluent<A>{
  public V1CertificateSigningRequestListFluent() {
  }
  
  public V1CertificateSigningRequestListFluent(V1CertificateSigningRequestList instance) {
  ...
  protected void copyInstance(V1CertificateSigningRequestList instance) {
    instance = (instance != null ? instance : new V1CertificateSigningRequestList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1CertificateSigningRequest... items) {
    ...
    for (V1CertificateSigningRequest item : items) {V1CertificateSigningRequestBuilder builder = new V1CertificateSigningRequestBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public ItemsNested<A> addNewItemLike(V1CertificateSigningRequest item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1CertificateSigningRequest item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1CertificateSigningRequestBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1CertificateSigningRequestListFluent that = (V1CertificateSigningRequestListFluent) o;
  ...
  public class ItemsNested<N> extends V1CertificateSigningRequestFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1CertificateSigningRequest item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1CertificateSigningRequestListFluent.this.withMetadata(builder.build());
    }
