...
import java.lang.Object;
  ...
  */
  ...
  public class V1beta1FlowSchemaListFluentImpl<A extends V1beta1FlowSchemaListFluent<A>> extends BaseFluent<A> implements V1beta1FlowSchemaListFluent<A>{
  ...
  private ArrayList<V1beta1FlowSchemaBuilder> items;
  private String kind;
  ...
  public A addToItems(Integer index,V1beta1FlowSchema item) {
    if (this.items == null) {this.items = new ArrayList<V1beta1FlowSchemaBuilder>();}
    V1beta1FlowSchemaBuilder builder = new V1beta1FlowSchemaBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(Integer index,V1beta1FlowSchema item) {
    if (this.items == null) {this.items = new ArrayList<V1beta1FlowSchemaBuilder>();}
    V1beta1FlowSchemaBuilder builder = new V1beta1FlowSchemaBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1beta1FlowSchema... items) {
    if (this.items == null) {this.items = new ArrayList<V1beta1FlowSchemaBuilder>();}
    for (V1beta1FlowSchema item : items) {V1beta1FlowSchemaBuilder builder = new V1beta1FlowSchemaBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta1FlowSchema... items) {
    for (V1beta1FlowSchema item : items) {V1beta1FlowSchemaBuilder builder = new V1beta1FlowSchemaBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<V1beta1FlowSchemaBuilder> predicate) {
    ...
    final Iterator<V1beta1FlowSchemaBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      V1beta1FlowSchemaBuilder builder = each.next();
  ...
  public V1beta1FlowSchema buildMatchingItem(Predicate<V1beta1FlowSchemaBuilder> predicate) {
    for (V1beta1FlowSchemaBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V1beta1FlowSchemaBuilder> predicate) {
    for (V1beta1FlowSchemaBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V1beta1FlowSchema> items) {
    if (this.items != null) { _visitables.get("items").removeAll(this.items);}
    if (items != null) {this.items = new ArrayList(); for (V1beta1FlowSchema item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1beta1FlowSchema... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (V1beta1FlowSchema item :items){ this.addToItems(item);}} return (A) this;
  }
  public Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public V1beta1FlowSchemaListFluent.ItemsNested<A> addNewItem() {
    return new V1beta1FlowSchemaListFluentImpl.ItemsNestedImpl();
  }
  public V1beta1FlowSchemaListFluent.ItemsNested<A> addNewItemLike(V1beta1FlowSchema item) {
    return new V1beta1FlowSchemaListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1beta1FlowSchemaListFluent.ItemsNested<A> setNewItemLike(Integer index,V1beta1FlowSchema item) {
    return new V1beta1FlowSchemaListFluentImpl.ItemsNestedImpl(index, item);
  }
  ...
  public V1beta1FlowSchemaListFluent.MetadataNested<A> withNewMetadata() {
    return new V1beta1FlowSchemaListFluentImpl.MetadataNestedImpl();
  }
  public V1beta1FlowSchemaListFluent.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1beta1FlowSchemaListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  class ItemsNestedImpl<N> extends V1beta1FlowSchemaFluentImpl<V1beta1FlowSchemaListFluent.ItemsNested<N>> implements V1beta1FlowSchemaListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1beta1FlowSchema item) {
      this.index = index;
      this.builder = new V1beta1FlowSchemaBuilder(this, item);
    }
    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new V1beta1FlowSchemaBuilder(this);
    }
    V1beta1FlowSchemaBuilder builder;
    Integer index;
    public N and() {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta1FlowSchemaListFluent.MetadataNested<N>> implements V1beta1FlowSchemaListFluent.MetadataNested<N>,Nested<N>{
