...
public interface V1PodSpecFluent<A extends V1PodSpecFluent<A>> extends Fluent<A> {
  ...
  public interface ContainersNested<N>
      extends Nested<N>, V1ContainerFluent<V1PodSpecFluent.ContainersNested<N>> {
    public N and();
  ...
  public interface DnsConfigNested<N>
      extends Nested<N>, V1PodDNSConfigFluent<V1PodSpecFluent.DnsConfigNested<N>> {
    public N and();
  ...
  public interface EphemeralContainersNested<N>
      extends Nested<N>, V1EphemeralContainerFluent<V1PodSpecFluent.EphemeralContainersNested<N>> {
    public N and();
  ...
  public interface HostAliasesNested<N>
      extends Nested<N>, V1HostAliasFluent<V1PodSpecFluent.HostAliasesNested<N>> {
    public N and();
  ...
  public interface ImagePullSecretsNested<N>
      extends Nested<N>, V1LocalObjectReferenceFluent<V1PodSpecFluent.ImagePullSecretsNested<N>> {
    public N and();
  ...
  public interface InitContainersNested<N>
      extends Nested<N>, V1ContainerFluent<V1PodSpecFluent.InitContainersNested<N>> {
    public N and();
  ...
  public interface ReadinessGatesNested<N>
      extends Nested<N>, V1PodReadinessGateFluent<V1PodSpecFluent.ReadinessGatesNested<N>> {
    public N and();
  ...
  public interface SecurityContextNested<N>
      extends Nested<N>, V1PodSecurityContextFluent<V1PodSpecFluent.SecurityContextNested<N>> {
    public N and();
  ...
  public interface VolumesNested<N>
      extends Nested<N>, V1VolumeFluent<V1PodSpecFluent.VolumesNested<N>> {
    public N and();
