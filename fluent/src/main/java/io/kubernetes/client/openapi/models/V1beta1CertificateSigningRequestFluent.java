...
public interface V1beta1CertificateSigningRequestFluent<A extends io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestSpecFluent<io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestFluent.SpecNested<N>> {

            public N and();
            public N endSpec();    }


    public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestStatusFluent<io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestFluent.StatusNested<N>> {
