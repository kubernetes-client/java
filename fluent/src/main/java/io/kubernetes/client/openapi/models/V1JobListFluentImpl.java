...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1Job item) {
    ...
    V1JobBuilder builder = new V1JobBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1JobFluentImpl<V1JobListFluent.ItemsNested<N>> implements V1JobListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1Job item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1JobListFluent.MetadataNested<N>> implements V1JobListFluent.MetadataNested<N>,Nested<N>{
