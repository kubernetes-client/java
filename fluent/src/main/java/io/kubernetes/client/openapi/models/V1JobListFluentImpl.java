...
import java.lang.Object;
  ...
  * Generated
  */
public class V1JobListFluentImpl<A extends io.kubernetes.client.openapi.models.V1JobListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1JobListFluent<A>{
  ...
  private java.util.List<io.kubernetes.client.openapi.models.V1JobBuilder> items;
  ...
  public A addToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Job item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1JobBuilder>();}
    io.kubernetes.client.openapi.models.V1JobBuilder builder = new io.kubernetes.client.openapi.models.V1JobBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Job item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1JobBuilder>();}
    io.kubernetes.client.openapi.models.V1JobBuilder builder = new io.kubernetes.client.openapi.models.V1JobBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Job... items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1JobBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Job item : items) {io.kubernetes.client.openapi.models.V1JobBuilder builder = new io.kubernetes.client.openapi.models.V1JobBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Job... items) {
    for (io.kubernetes.client.openapi.models.V1Job item : items) {io.kubernetes.client.openapi.models.V1JobBuilder builder = new io.kubernetes.client.openapi.models.V1JobBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1Job buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1JobBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1JobBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1JobBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1JobBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1Job> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Job item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1Job... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (io.kubernetes.client.openapi.models.V1Job item :items){ this.addToItems(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Job item) {
    return new io.kubernetes.client.openapi.models.V1JobListFluentImpl.ItemsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<A> editItem(java.lang.Integer index) {
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1JobFluentImpl<io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1JobListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1JobListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
