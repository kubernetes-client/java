...
public class V1JobListFluentImpl<A extends io.kubernetes.client.openapi.models.V1JobListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1JobListFluent<A> {
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1Job> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1JobBuilder>(); for (io.kubernetes.client.openapi.models.V1Job item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1JobFluentImpl<io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1JobListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1Job item) {
                this.index = index;
