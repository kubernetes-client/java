...
/** Generated */
public interface V1ClusterRoleBindingFluent<A extends V1ClusterRoleBindingFluent<A>>
    extends Fluent<A> {
  ...
  public V1ClusterRoleBindingFluent.SubjectsNested<A> setNewSubjectLike(
      Integer index, V1Subject item);
  ...
  public V1ClusterRoleBindingFluent.SubjectsNested<A> editMatchingSubject(
      Predicate<V1SubjectBuilder> predicate);

  public interface MetadataNested<N>
      extends Nested<N>, V1ObjectMetaFluent<V1ClusterRoleBindingFluent.MetadataNested<N>> {
    public N and();
  ...
  public interface RoleRefNested<N>
      extends Nested<N>, V1RoleRefFluent<V1ClusterRoleBindingFluent.RoleRefNested<N>> {
    public N and();
  ...
  public interface SubjectsNested<N>
      extends Nested<N>, V1SubjectFluent<V1ClusterRoleBindingFluent.SubjectsNested<N>> {
    public N and();
