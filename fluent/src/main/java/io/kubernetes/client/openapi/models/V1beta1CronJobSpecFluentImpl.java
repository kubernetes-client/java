...
public class V1beta1CronJobSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluent<A> {
    ...
    public V1beta1CronJobSpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1CronJobSpec instance) {
    ...
    public A withJobTemplate(io.kubernetes.client.openapi.models.V1beta1JobTemplateSpec jobTemplate) {
        ...
        if (jobTemplate!=null){ this.jobTemplate= new io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecBuilder(jobTemplate); _visitables.get("jobTemplate").add(this.jobTemplate);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluent.JobTemplateNested<A> withNewJobTemplate() {
        return new io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluentImpl.JobTemplateNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluent.JobTemplateNested<A> withNewJobTemplateLike(io.kubernetes.client.openapi.models.V1beta1JobTemplateSpec item) {
        return new io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluentImpl.JobTemplateNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluent.JobTemplateNested<A> editOrNewJobTemplate() {
        return withNewJobTemplateLike(getJobTemplate() != null ? getJobTemplate(): new io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecBuilder().build());
    }
    ...
    public class JobTemplateNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecFluentImpl<io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluent.JobTemplateNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CronJobSpecFluent.JobTemplateNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecBuilder builder;

            JobTemplateNestedImpl(io.kubernetes.client.openapi.models.V1beta1JobTemplateSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecBuilder(this, item);
