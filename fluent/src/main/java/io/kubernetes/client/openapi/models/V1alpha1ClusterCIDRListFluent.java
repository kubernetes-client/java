...
public class V1alpha1ClusterCIDRListFluent<A extends V1alpha1ClusterCIDRListFluent<A>> extends BaseFluent<A>{
  public V1alpha1ClusterCIDRListFluent() {
  }
  
  public V1alpha1ClusterCIDRListFluent(V1alpha1ClusterCIDRList instance) {
  ...
  protected void copyInstance(V1alpha1ClusterCIDRList instance) {
    instance = (instance != null ? instance : new V1alpha1ClusterCIDRList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha1ClusterCIDR... items) {
    ...
    for (V1alpha1ClusterCIDR item : items) {V1alpha1ClusterCIDRBuilder builder = new V1alpha1ClusterCIDRBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public ItemsNested<A> addNewItemLike(V1alpha1ClusterCIDR item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1alpha1ClusterCIDR item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1alpha1ClusterCIDRBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ClusterCIDRListFluent that = (V1alpha1ClusterCIDRListFluent) o;
  ...
  public class ItemsNested<N> extends V1alpha1ClusterCIDRFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1alpha1ClusterCIDR item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1alpha1ClusterCIDRListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1ClusterCIDRListFluent.this.withMetadata(builder.build());
    }
