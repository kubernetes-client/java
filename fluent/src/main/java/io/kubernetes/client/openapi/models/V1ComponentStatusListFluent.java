...
public interface V1ComponentStatusListFluent<A extends io.kubernetes.client.openapi.models.V1ComponentStatusListFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface ItemsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ComponentStatusFluent<io.kubernetes.client.openapi.models.V1ComponentStatusListFluent.ItemsNested<N>> {

            public N and();
            public N endItem();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ListMetaFluent<io.kubernetes.client.openapi.models.V1ComponentStatusListFluent.MetadataNested<N>> {
