...
public class V1ComponentStatusListFluent<A extends V1ComponentStatusListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ComponentStatus... items) {
    ...
    for (V1ComponentStatus item : items) {V1ComponentStatusBuilder builder = new V1ComponentStatusBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
