...
public class V1JobListFluent<A extends io.kubernetes.client.openapi.models.V1JobListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1JobBuilder> predicate) {
    ...
    Iterator<V1JobBuilder> each = items.iterator();
