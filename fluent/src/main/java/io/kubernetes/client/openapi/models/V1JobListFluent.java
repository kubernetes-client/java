...
public class V1JobListFluent<A extends V1JobListFluent<A>> extends BaseFluent<A>{
  public V1JobListFluent() {
  }
  
  public V1JobListFluent(V1JobList instance) {
  ...
  protected void copyInstance(V1JobList instance) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Job... items) {
    ...
    for (V1Job item : items) {V1JobBuilder builder = new V1JobBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public ItemsNested<A> addNewItemLike(V1Job item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1Job item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1JobBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1JobListFluent that = (V1JobListFluent) o;
  ...
  public class ItemsNested<N> extends V1JobFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1Job item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1JobListFluent.this.withMetadata(builder.build());
    }
