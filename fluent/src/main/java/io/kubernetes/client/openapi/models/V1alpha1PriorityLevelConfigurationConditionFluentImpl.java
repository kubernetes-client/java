...
public class V1alpha1PriorityLevelConfigurationConditionFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1PriorityLevelConfigurationConditionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1PriorityLevelConfigurationConditionFluent<A> {
    ...
    public V1alpha1PriorityLevelConfigurationConditionFluentImpl() {
    }

    public V1alpha1PriorityLevelConfigurationConditionFluentImpl(io.kubernetes.client.openapi.models.V1alpha1PriorityLevelConfigurationCondition instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1alpha1PriorityLevelConfigurationConditionFluentImpl that = (V1alpha1PriorityLevelConfigurationConditionFluentImpl) o;
