...
public class V1beta2PriorityLevelConfigurationStatusFluentImpl<
  ...
  public A addToConditions(Integer index, V1beta2PriorityLevelConfigurationCondition item) {
    if (this.conditions == null) {
      this.conditions = new ArrayList<V1beta2PriorityLevelConfigurationConditionBuilder>();
    }
    V1beta2PriorityLevelConfigurationConditionBuilder builder =
        new V1beta2PriorityLevelConfigurationConditionBuilder(item);
    _visitables
        .get("conditions")
  ...
  public A addToConditions(
    ...
    for (V1beta2PriorityLevelConfigurationCondition item : items) {
      V1beta2PriorityLevelConfigurationConditionBuilder builder =
          new V1beta2PriorityLevelConfigurationConditionBuilder(item);
      _visitables.get("conditions").add(builder);
  ...
  class ConditionsNestedImpl<N>
      ...
      implements V1beta2PriorityLevelConfigurationStatusFluent.ConditionsNested<N>, Nested<N> {
