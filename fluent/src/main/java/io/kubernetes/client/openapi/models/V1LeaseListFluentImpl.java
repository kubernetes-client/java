...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1Lease item) {
    ...
    V1LeaseBuilder builder = new V1LeaseBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1LeaseFluentImpl<V1LeaseListFluent.ItemsNested<N>> implements V1LeaseListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1LeaseListFluent.MetadataNested<N>> implements V1LeaseListFluent.MetadataNested<N>,Nested<N>{
