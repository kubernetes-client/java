...
import java.util.LinkedHashMap;
  ...
  */
  ...
  public class V1LimitRangeItemFluentImpl<A extends V1LimitRangeItemFluent<A>> extends BaseFluent<A> implements V1LimitRangeItemFluent<A>{
  ...
  public <K,V>A withDefault(Map<String,Quantity> _default) {
    if (_default == null) { this._default =  null;} else {this._default = new LinkedHashMap(_default);} return (A) this;
  }
  ...
  public <K,V>A withDefaultRequest(Map<String,Quantity> defaultRequest) {
    if (defaultRequest == null) { this.defaultRequest =  null;} else {this.defaultRequest = new LinkedHashMap(defaultRequest);} return (A) this;
  }
  ...
  public <K,V>A withMax(Map<String,Quantity> max) {
    if (max == null) { this.max =  null;} else {this.max = new LinkedHashMap(max);} return (A) this;
  }
  ...
  public <K,V>A withMaxLimitRequestRatio(Map<String,Quantity> maxLimitRequestRatio) {
    if (maxLimitRequestRatio == null) { this.maxLimitRequestRatio =  null;} else {this.maxLimitRequestRatio = new LinkedHashMap(maxLimitRequestRatio);} return (A) this;
  }
  ...
  public <K,V>A withMin(Map<String,Quantity> min) {
    if (min == null) { this.min =  null;} else {this.min = new LinkedHashMap(min);} return (A) this;
  }
