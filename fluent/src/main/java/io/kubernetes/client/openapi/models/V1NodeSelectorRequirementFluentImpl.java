...
import java.util.function.Predicate;
  ...
  */
  ...
  public class V1NodeSelectorRequirementFluentImpl<A extends V1NodeSelectorRequirementFluent<A>> extends BaseFluent<A> implements V1NodeSelectorRequirementFluent<A>{
