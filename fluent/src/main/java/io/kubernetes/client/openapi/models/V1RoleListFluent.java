...
public class V1RoleListFluent<A extends io.kubernetes.client.openapi.models.V1RoleListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1Role... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1Role... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1Role item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1RoleBuilder> predicate) {
    ...
    Iterator<V1RoleBuilder> each = items.iterator();
  ...
  public A withItems(V1Role... items) {
    if (this.items != null) {
        this.items.clear();
