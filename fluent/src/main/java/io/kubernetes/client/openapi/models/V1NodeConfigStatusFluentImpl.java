...
import java.lang.Boolean;
  ...
  */
  ...
  public V1NodeConfigStatusFluentImpl.ActiveNested<A> withNewActive() {
    return new V1NodeConfigStatusFluentImpl.ActiveNestedImpl();
  }
  public V1NodeConfigStatusFluentImpl.ActiveNested<A> withNewActiveLike(V1NodeConfigSource item) {
    return new V1NodeConfigStatusFluentImpl.ActiveNestedImpl(item);
  }
  public V1NodeConfigStatusFluentImpl.ActiveNested<A> editActive() {
    return withNewActiveLike(getActive());
  }
  public V1NodeConfigStatusFluentImpl.ActiveNested<A> editOrNewActive() {
    return withNewActiveLike(getActive() != null ? getActive(): new V1NodeConfigSourceBuilder().build());
  }
  public V1NodeConfigStatusFluentImpl.ActiveNested<A> editOrNewActiveLike(V1NodeConfigSource item) {
  ...
  public V1NodeConfigStatusFluentImpl.AssignedNested<A> withNewAssigned() {
    return new V1NodeConfigStatusFluentImpl.AssignedNestedImpl();
  }
  public V1NodeConfigStatusFluentImpl.AssignedNested<A> withNewAssignedLike(V1NodeConfigSource item) {
    return new V1NodeConfigStatusFluentImpl.AssignedNestedImpl(item);
  }
  public V1NodeConfigStatusFluentImpl.AssignedNested<A> editAssigned() {
    return withNewAssignedLike(getAssigned());
  }
  public V1NodeConfigStatusFluentImpl.AssignedNested<A> editOrNewAssigned() {
    return withNewAssignedLike(getAssigned() != null ? getAssigned(): new V1NodeConfigSourceBuilder().build());
  }
  public V1NodeConfigStatusFluentImpl.AssignedNested<A> editOrNewAssignedLike(V1NodeConfigSource item) {
  ...
  public V1NodeConfigStatusFluentImpl.LastKnownGoodNested<A> withNewLastKnownGood() {
    return new V1NodeConfigStatusFluentImpl.LastKnownGoodNestedImpl();
  }
  public V1NodeConfigStatusFluentImpl.LastKnownGoodNested<A> withNewLastKnownGoodLike(V1NodeConfigSource item) {
    return new V1NodeConfigStatusFluentImpl.LastKnownGoodNestedImpl(item);
  }
  public V1NodeConfigStatusFluentImpl.LastKnownGoodNested<A> editLastKnownGood() {
    return withNewLastKnownGoodLike(getLastKnownGood());
  }
  public V1NodeConfigStatusFluentImpl.LastKnownGoodNested<A> editOrNewLastKnownGood() {
    return withNewLastKnownGoodLike(getLastKnownGood() != null ? getLastKnownGood(): new V1NodeConfigSourceBuilder().build());
  }
  public V1NodeConfigStatusFluentImpl.LastKnownGoodNested<A> editOrNewLastKnownGoodLike(V1NodeConfigSource item) {
  ...
  class ActiveNestedImpl<N> extends V1NodeConfigSourceFluentImpl<V1NodeConfigStatusFluentImpl.ActiveNested<N>> implements V1NodeConfigStatusFluentImpl.ActiveNested<N>,Nested<N>{
  ...
  class AssignedNestedImpl<N> extends V1NodeConfigSourceFluentImpl<V1NodeConfigStatusFluentImpl.AssignedNested<N>> implements V1NodeConfigStatusFluentImpl.AssignedNested<N>,Nested<N>{
  ...
  class LastKnownGoodNestedImpl<N> extends V1NodeConfigSourceFluentImpl<V1NodeConfigStatusFluentImpl.LastKnownGoodNested<N>> implements V1NodeConfigStatusFluentImpl.LastKnownGoodNested<N>,Nested<N>{
