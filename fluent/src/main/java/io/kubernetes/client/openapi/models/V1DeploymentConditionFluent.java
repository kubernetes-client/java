...
public interface V1DeploymentConditionFluent<A extends io.kubernetes.client.openapi.models.V1DeploymentConditionFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
