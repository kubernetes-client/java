...
public class V1beta1ResourceRuleFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1ResourceRuleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1ResourceRuleFluent<A> {
    ...
    public V1beta1ResourceRuleFluentImpl() {
    }

    public V1beta1ResourceRuleFluentImpl(io.kubernetes.client.openapi.models.V1beta1ResourceRule instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1ResourceRuleFluentImpl that = (V1beta1ResourceRuleFluentImpl) o;
