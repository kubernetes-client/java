...
import java.lang.Object;
  ...
  */
  ...
  public V1ClusterRoleListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1ClusterRoleListFluentImpl.ItemsNestedImpl();
  }
  public V1ClusterRoleListFluentImpl.ItemsNested<A> addNewItemLike(V1ClusterRole item) {
    return new V1ClusterRoleListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1ClusterRoleListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1ClusterRole item) {
    return new V1ClusterRoleListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1ClusterRoleListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ClusterRoleListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1ClusterRoleListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ClusterRoleListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1ClusterRoleBuilder> predicate) {
    int index = -1;
  ...
  public V1ClusterRoleListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1ClusterRoleListFluentImpl.MetadataNestedImpl();
  }
  public V1ClusterRoleListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1ClusterRoleListFluentImpl.MetadataNestedImpl(item);
  }
  public V1ClusterRoleListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1ClusterRoleListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1ClusterRoleListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1ClusterRoleFluentImpl<V1ClusterRoleListFluentImpl.ItemsNested<N>> implements V1ClusterRoleListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1ClusterRole item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ClusterRoleListFluentImpl.MetadataNested<N>> implements V1ClusterRoleListFluentImpl.MetadataNested<N>,Nested<N>{
