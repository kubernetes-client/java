...
import java.lang.Object;
  ...
  */
  ...
  public class V2HorizontalPodAutoscalerListFluentImpl<A extends V2HorizontalPodAutoscalerListFluent<A>> extends BaseFluent<A> implements V2HorizontalPodAutoscalerListFluent<A>{
  ...
  public A addToItems(int index,V2HorizontalPodAutoscaler item) {
    if (this.items == null) {this.items = new ArrayList<V2HorizontalPodAutoscalerBuilder>();}
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscaler... items) {
    if (this.items == null) {this.items = new ArrayList<V2HorizontalPodAutoscalerBuilder>();}
    for (V2HorizontalPodAutoscaler item : items) {V2HorizontalPodAutoscalerBuilder builder = new V2HorizontalPodAutoscalerBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscaler... items) {
    for (V2HorizontalPodAutoscaler item : items) {V2HorizontalPodAutoscalerBuilder builder = new V2HorizontalPodAutoscalerBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public V2HorizontalPodAutoscaler buildMatchingItem(Predicate<V2HorizontalPodAutoscalerBuilder> predicate) {
    for (V2HorizontalPodAutoscalerBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V2HorizontalPodAutoscalerBuilder> predicate) {
    for (V2HorizontalPodAutoscalerBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V2HorizontalPodAutoscaler> items) {
    if (this.items != null) { _visitables.get("items").clear();}
    if (items != null) {this.items = new ArrayList(); for (V2HorizontalPodAutoscaler item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscaler... items) {
    ...
    if (items != null) {for (V2HorizontalPodAutoscaler item :items){ this.addToItems(item);}} return (A) this;
  }
  public Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<A> addNewItem() {
    return new V2HorizontalPodAutoscalerListFluentImpl.ItemsNestedImpl();
  }
  public V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<A> addNewItemLike(V2HorizontalPodAutoscaler item) {
    return new V2HorizontalPodAutoscalerListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<A> setNewItemLike(int index,V2HorizontalPodAutoscaler item) {
    return new V2HorizontalPodAutoscalerListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V2HorizontalPodAutoscalerBuilder> predicate) {
    int index = -1;
  ...
  public V2HorizontalPodAutoscalerListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V2HorizontalPodAutoscalerListFluentImpl.MetadataNestedImpl();
  }
  public V2HorizontalPodAutoscalerListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V2HorizontalPodAutoscalerListFluentImpl.MetadataNestedImpl(item);
  }
  public V2HorizontalPodAutoscalerListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V2HorizontalPodAutoscalerListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V2HorizontalPodAutoscalerListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V2HorizontalPodAutoscalerFluentImpl<V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<N>> implements V2HorizontalPodAutoscalerListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V2HorizontalPodAutoscaler item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V2HorizontalPodAutoscalerListFluentImpl.MetadataNested<N>> implements V2HorizontalPodAutoscalerListFluentImpl.MetadataNested<N>,Nested<N>{
