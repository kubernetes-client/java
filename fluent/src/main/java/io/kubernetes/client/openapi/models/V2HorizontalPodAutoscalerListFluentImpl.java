...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V2HorizontalPodAutoscaler item) {
    ...
    V2HorizontalPodAutoscalerBuilder builder = new V2HorizontalPodAutoscalerBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V2HorizontalPodAutoscalerFluentImpl<V2HorizontalPodAutoscalerListFluent.ItemsNested<N>> implements V2HorizontalPodAutoscalerListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V2HorizontalPodAutoscalerListFluent.MetadataNested<N>> implements V2HorizontalPodAutoscalerListFluent.MetadataNested<N>,Nested<N>{
