...
public class V1RoleFluentImpl<A extends io.kubernetes.client.openapi.models.V1RoleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1RoleFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private java.util.List<io.kubernetes.client.openapi.models.V1PolicyRuleBuilder> rules;
    ...
    public io.kubernetes.client.openapi.models.V1RoleFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    ...
    public io.kubernetes.client.openapi.models.V1RoleFluent.MetadataNested<A> editOrNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    ...
    public A withRules(java.util.List<io.kubernetes.client.openapi.models.V1PolicyRule> rules) {
        ...
        if (rules != null) {this.rules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PolicyRuleBuilder>(); for (io.kubernetes.client.openapi.models.V1PolicyRule item : rules){this.addToRules(item);}} else { this.rules = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1RoleFluent.RulesNested<A> addNewRuleLike(io.kubernetes.client.openapi.models.V1PolicyRule item) {
        return new io.kubernetes.client.openapi.models.V1RoleFluentImpl.RulesNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1RoleFluent.RulesNested<A> setNewRuleLike(int index,io.kubernetes.client.openapi.models.V1PolicyRule item) {
        return new io.kubernetes.client.openapi.models.V1RoleFluentImpl.RulesNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1RoleFluent.RulesNested<A> editRule(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1RoleFluent.RulesNested<A> editMatchingRule(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PolicyRuleBuilder> predicate) {
        int index = -1;
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1RoleFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1RoleFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class RulesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PolicyRuleFluentImpl<io.kubernetes.client.openapi.models.V1RoleFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1RoleFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1PolicyRuleBuilder builder;
        private final int index;

            RulesNestedImpl(int index,io.kubernetes.client.openapi.models.V1PolicyRule item) {
                this.index = index;
