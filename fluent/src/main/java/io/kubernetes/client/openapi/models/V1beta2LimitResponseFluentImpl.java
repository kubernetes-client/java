...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta2LimitResponseFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta2LimitResponseFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta2LimitResponseFluent<A>{
  ...
  public A withQueuing(io.kubernetes.client.openapi.models.V1beta2QueuingConfiguration queuing) {
    ...
    if (queuing!=null){ this.queuing= new io.kubernetes.client.openapi.models.V1beta2QueuingConfigurationBuilder(queuing); _visitables.get("queuing").add(this.queuing);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2LimitResponseFluent.QueuingNested<A> withNewQueuingLike(io.kubernetes.client.openapi.models.V1beta2QueuingConfiguration item) {
    return new io.kubernetes.client.openapi.models.V1beta2LimitResponseFluentImpl.QueuingNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2LimitResponseFluent.QueuingNested<A> editOrNewQueuing() {
    return withNewQueuingLike(getQueuing() != null ? getQueuing(): new io.kubernetes.client.openapi.models.V1beta2QueuingConfigurationBuilder().build());
  }
  ...
  public class QueuingNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta2QueuingConfigurationFluentImpl<io.kubernetes.client.openapi.models.V1beta2LimitResponseFluent.QueuingNested<N>> implements io.kubernetes.client.openapi.models.V1beta2LimitResponseFluent.QueuingNested<N>,io.kubernetes.client.fluent.Nested<N>{
    QueuingNestedImpl(io.kubernetes.client.openapi.models.V1beta2QueuingConfiguration item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta2QueuingConfigurationBuilder(this, item);
    }
    QueuingNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1beta2QueuingConfigurationBuilder(this);
    }
