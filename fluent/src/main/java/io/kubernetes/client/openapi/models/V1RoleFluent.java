...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1RoleFluent<A extends io.kubernetes.client.openapi.models.V1RoleFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1RoleFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface RulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1PolicyRuleFluent<io.kubernetes.client.openapi.models.V1RoleFluent.RulesNested<N>>{
    public N and();
    public N endRule();
