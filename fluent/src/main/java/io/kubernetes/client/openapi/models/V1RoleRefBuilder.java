...
public class V1RoleRefBuilder extends io.kubernetes.client.openapi.models.V1RoleRefFluentImpl<io.kubernetes.client.openapi.models.V1RoleRefBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1RoleRef,io.kubernetes.client.openapi.models.V1RoleRefBuilder> {
    ...
    public V1RoleRefBuilder(io.kubernetes.client.openapi.models.V1RoleRefFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1RoleRef(), validationEnabled);
    }

    public V1RoleRefBuilder(io.kubernetes.client.openapi.models.V1RoleRefFluent<?> fluent,io.kubernetes.client.openapi.models.V1RoleRef instance) {
        this(fluent, instance, true);
    }

    public V1RoleRefBuilder(io.kubernetes.client.openapi.models.V1RoleRefFluent<?> fluent,io.kubernetes.client.openapi.models.V1RoleRef instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1RoleRefBuilder(io.kubernetes.client.openapi.models.V1RoleRef instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
