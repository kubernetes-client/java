...
public class V1ConfigMapListFluent<A extends io.kubernetes.client.openapi.models.V1ConfigMapListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1ConfigMap... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1ConfigMap item : items) {
  ...
  public A removeFromItems(V1ConfigMap... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1ConfigMap item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1ConfigMapBuilder> predicate) {
    ...
    Iterator<V1ConfigMapBuilder> each = items.iterator();
  ...
  public A withItems(V1ConfigMap... items) {
    if (this.items != null) {
        this.items.clear();
