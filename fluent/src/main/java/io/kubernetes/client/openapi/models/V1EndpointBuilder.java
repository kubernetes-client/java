...
public class V1EndpointBuilder extends io.kubernetes.client.openapi.models.V1EndpointFluentImpl<io.kubernetes.client.openapi.models.V1EndpointBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1Endpoint,io.kubernetes.client.openapi.models.V1EndpointBuilder>{
  ...
  public V1EndpointBuilder(io.kubernetes.client.openapi.models.V1EndpointFluent<?> fluent,java.lang.Boolean validationEnabled) {
    this(fluent, new V1Endpoint(), validationEnabled);
  }
  public V1EndpointBuilder(io.kubernetes.client.openapi.models.V1EndpointFluent<?> fluent,io.kubernetes.client.openapi.models.V1Endpoint instance) {
    this(fluent, instance, false);
  }
  public V1EndpointBuilder(io.kubernetes.client.openapi.models.V1EndpointFluent<?> fluent,io.kubernetes.client.openapi.models.V1Endpoint instance,java.lang.Boolean validationEnabled) {
    this.fluent = fluent; 
  ...
  public V1EndpointBuilder(io.kubernetes.client.openapi.models.V1Endpoint instance,java.lang.Boolean validationEnabled) {
    this.fluent = this; 
