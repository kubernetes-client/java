...
public class V1ScaleFluentImpl<A extends io.kubernetes.client.openapi.models.V1ScaleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ScaleFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private io.kubernetes.client.openapi.models.V1ScaleSpecBuilder spec;
    private io.kubernetes.client.openapi.models.V1ScaleStatusBuilder status;
    ...
    public io.kubernetes.client.openapi.models.V1ScaleFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1ScaleFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ScaleFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1ScaleFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1ScaleSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1ScaleSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ScaleFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1ScaleFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ScaleFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1ScaleSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1ScaleStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1ScaleStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ScaleFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V1ScaleFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ScaleFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1ScaleStatusBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1ScaleFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ScaleFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ScaleSpecFluentImpl<io.kubernetes.client.openapi.models.V1ScaleFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1ScaleFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ScaleSpecBuilder builder;

            SpecNestedImpl(io.kubernetes.client.openapi.models.V1ScaleSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ScaleSpecBuilder(this, item);
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ScaleStatusFluentImpl<io.kubernetes.client.openapi.models.V1ScaleFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1ScaleFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ScaleStatusBuilder builder;

            StatusNestedImpl(io.kubernetes.client.openapi.models.V1ScaleStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1ScaleStatusBuilder(this, item);
