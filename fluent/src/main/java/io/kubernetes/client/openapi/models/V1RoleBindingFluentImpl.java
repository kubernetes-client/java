...
public class V1RoleBindingFluentImpl<A extends io.kubernetes.client.openapi.models.V1RoleBindingFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1RoleBindingFluent<A>{
  ...
  public A withSubjects(java.util.List<io.kubernetes.client.openapi.models.V1Subject> subjects) {
    ...
    if (subjects != null) {this.subjects = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Subject item : subjects){this.addToSubjects(item);}} else { this.subjects = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1RoleBindingFluent.SubjectsNested<A> setNewSubjectLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Subject item) {
    return new io.kubernetes.client.openapi.models.V1RoleBindingFluentImpl.SubjectsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1RoleBindingFluent.SubjectsNested<A> editSubject(java.lang.Integer index) {
  ...
  public class SubjectsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1SubjectFluentImpl<io.kubernetes.client.openapi.models.V1RoleBindingFluent.SubjectsNested<N>> implements io.kubernetes.client.openapi.models.V1RoleBindingFluent.SubjectsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    SubjectsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Subject item) {
      this.index = index;
