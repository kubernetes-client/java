...
public class V2beta1APIResourceDiscoveryFluent<A extends io.kubernetes.client.openapi.models.V2beta1APIResourceDiscoveryFluent<A>> extends BaseFluent<A>{
  ...
  private ArrayList<V2beta1APISubresourceDiscoveryBuilder> subresources;
  private List<String> verbs;

  public V2beta1APIResourceDiscoveryFluent() {
  }
  
  public V2beta1APIResourceDiscoveryFluent(V2beta1APIResourceDiscovery instance) {
  ...
  public A addAllToSubresources(Collection<V2beta1APISubresourceDiscovery> items) {
    if (this.subresources == null) {
      this.subresources = new ArrayList();
    }
    for (V2beta1APISubresourceDiscovery item : items) {
        V2beta1APISubresourceDiscoveryBuilder builder = new V2beta1APISubresourceDiscoveryBuilder(item);
  ...
  public SubresourcesNested<A> addNewSubresourceLike(V2beta1APISubresourceDiscovery item) {
  ...
  public A addToSubresources(V2beta1APISubresourceDiscovery... items) {
    if (this.subresources == null) {
      this.subresources = new ArrayList();
    }
    for (V2beta1APISubresourceDiscovery item : items) {
  ...
  public A addToSubresources(int index,V2beta1APISubresourceDiscovery item) {
    if (this.subresources == null) {
      this.subresources = new ArrayList();
    }
    V2beta1APISubresourceDiscoveryBuilder builder = new V2beta1APISubresourceDiscoveryBuilder(item);
  ...
  public V2beta1APISubresourceDiscovery buildFirstSubresource() {
    return this.subresources.get(0).build();
  }
  
  public V2beta1APISubresourceDiscovery buildLastSubresource() {
    return this.subresources.get(subresources.size() - 1).build();
  }
  
  public V2beta1APISubresourceDiscovery buildMatchingSubresource(Predicate<V2beta1APISubresourceDiscoveryBuilder> predicate) {
      for (V2beta1APISubresourceDiscoveryBuilder item : subresources) {
  ...
  public V2beta1APISubresourceDiscovery buildSubresource(int index) {
    return this.subresources.get(index).build();
  }
  
  public List<V2beta1APISubresourceDiscovery> buildSubresources() {
    return this.subresources != null ? build(subresources) : null;
  }
  
  protected void copyInstance(V2beta1APIResourceDiscovery instance) {
    instance = instance != null ? instance : new V2beta1APIResourceDiscovery();
    if (instance != null) {
  ...
  public SubresourcesNested<A> editMatchingSubresource(Predicate<V2beta1APISubresourceDiscoveryBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V2beta1APIResourceDiscoveryFluent that = (V2beta1APIResourceDiscoveryFluent) o;
  ...
  public boolean hasMatchingSubresource(Predicate<V2beta1APISubresourceDiscoveryBuilder> predicate) {
      for (V2beta1APISubresourceDiscoveryBuilder item : subresources) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeAllFromSubresources(Collection<V2beta1APISubresourceDiscovery> items) {
    if (this.subresources == null) {
      return (A) this;
    }
    for (V2beta1APISubresourceDiscovery item : items) {
  ...
  public A removeFromSubresources(V2beta1APISubresourceDiscovery... items) {
    if (this.subresources == null) {
      return (A) this;
    }
    for (V2beta1APISubresourceDiscovery item : items) {
  ...
  public A removeMatchingFromSubresources(Predicate<V2beta1APISubresourceDiscoveryBuilder> predicate) {
    if (subresources == null) {
      return (A) this;
    }
    Iterator<V2beta1APISubresourceDiscoveryBuilder> each = subresources.iterator();
    List visitables = this._visitables.get("subresources");
    while (each.hasNext()) {
        V2beta1APISubresourceDiscoveryBuilder builder = each.next();
  ...
  public SubresourcesNested<A> setNewSubresourceLike(int index,V2beta1APISubresourceDiscovery item) {
  ...
  public A setToSubresources(int index,V2beta1APISubresourceDiscovery item) {
    if (this.subresources == null) {
      this.subresources = new ArrayList();
    }
    V2beta1APISubresourceDiscoveryBuilder builder = new V2beta1APISubresourceDiscoveryBuilder(item);
  ...
  public A withSubresources(List<V2beta1APISubresourceDiscovery> subresources) {
    if (this.subresources != null) {
      this._visitables.get("subresources").clear();
    }
    if (subresources != null) {
        this.subresources = new ArrayList();
        for (V2beta1APISubresourceDiscovery item : subresources) {
  ...
  public A withSubresources(V2beta1APISubresourceDiscovery... subresources) {
    if (this.subresources != null) {
  ...
  public class ResponseKindNested<N> extends V1GroupVersionKindFluent<ResponseKindNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V2beta1APIResourceDiscoveryFluent.this.withResponseKind(builder.build());
    }
  ...
  public class SubresourcesNested<N> extends V2beta1APISubresourceDiscoveryFluent<SubresourcesNested<N>> implements Nested<N>{
  
    V2beta1APISubresourceDiscoveryBuilder builder;
    int index;
  
    SubresourcesNested(int index,V2beta1APISubresourceDiscovery item) {
      this.index = index;
      this.builder = new V2beta1APISubresourceDiscoveryBuilder(this, item);
    }
  
    public N and() {
      return (N) V2beta1APIResourceDiscoveryFluent.this.setToSubresources(index, builder.build());
    }
