...
public class V1DaemonSetBuilder extends io.kubernetes.client.openapi.models.V1DaemonSetFluentImpl<io.kubernetes.client.openapi.models.V1DaemonSetBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1DaemonSet,io.kubernetes.client.openapi.models.V1DaemonSetBuilder> {
    ...
    public V1DaemonSetBuilder(io.kubernetes.client.openapi.models.V1DaemonSetFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1DaemonSet(), validationEnabled);
    }

    public V1DaemonSetBuilder(io.kubernetes.client.openapi.models.V1DaemonSetFluent<?> fluent,io.kubernetes.client.openapi.models.V1DaemonSet instance) {
        this(fluent, instance, true);
    }

    public V1DaemonSetBuilder(io.kubernetes.client.openapi.models.V1DaemonSetFluent<?> fluent,io.kubernetes.client.openapi.models.V1DaemonSet instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1DaemonSetBuilder(io.kubernetes.client.openapi.models.V1DaemonSet instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
