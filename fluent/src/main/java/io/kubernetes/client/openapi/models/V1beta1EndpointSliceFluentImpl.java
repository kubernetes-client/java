...
public class V1beta1EndpointSliceFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent<A>{
  ...
  public A addToEndpoints(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1Endpoint item) {
  ...
  public A setToEndpoints(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1Endpoint item) {
    if (this.endpoints == null) {this.endpoints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1EndpointBuilder>();}
  ...
  public A withEndpoints(java.util.List<io.kubernetes.client.openapi.models.V1beta1Endpoint> endpoints) {
    ...
    if (endpoints != null) {this.endpoints = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1Endpoint item : endpoints){this.addToEndpoints(item);}} else { this.endpoints = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.EndpointsNested<A> setNewEndpointLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1Endpoint item) {
    return new io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluentImpl.EndpointsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.EndpointsNested<A> editEndpoint(java.lang.Integer index) {
  ...
  public A addToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1EndpointPort item) {
  ...
  public A setToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1EndpointPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1EndpointPortBuilder>();}
  ...
  public A withPorts(java.util.List<io.kubernetes.client.openapi.models.V1beta1EndpointPort> ports) {
    ...
    if (ports != null) {this.ports = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1EndpointPort item : ports){this.addToPorts(item);}} else { this.ports = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.PortsNested<A> setNewPortLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1EndpointPort item) {
    return new io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluentImpl.PortsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.PortsNested<A> editPort(java.lang.Integer index) {
  ...
  public class EndpointsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1EndpointFluentImpl<io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.EndpointsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.EndpointsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    EndpointsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1Endpoint item) {
      this.index = index;
  ...
  public class PortsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1EndpointPortFluentImpl<io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    PortsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1EndpointPort item) {
      this.index = index;
