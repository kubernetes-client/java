...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta2SubjectFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta2SubjectFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta2SubjectFluent<A>{
  ...
  public A withGroup(io.kubernetes.client.openapi.models.V1beta2GroupSubject group) {
    ...
    if (group!=null){ this.group= new io.kubernetes.client.openapi.models.V1beta2GroupSubjectBuilder(group); _visitables.get("group").add(this.group);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2SubjectFluent.GroupNested<A> editOrNewGroup() {
    return withNewGroupLike(getGroup() != null ? getGroup(): new io.kubernetes.client.openapi.models.V1beta2GroupSubjectBuilder().build());
  }
  ...
  public A withServiceAccount(io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubject serviceAccount) {
    ...
    if (serviceAccount!=null){ this.serviceAccount= new io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubjectBuilder(serviceAccount); _visitables.get("serviceAccount").add(this.serviceAccount);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2SubjectFluent.ServiceAccountNested<A> withNewServiceAccount() {
    return new io.kubernetes.client.openapi.models.V1beta2SubjectFluentImpl.ServiceAccountNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta2SubjectFluent.ServiceAccountNested<A> withNewServiceAccountLike(io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubject item) {
    return new io.kubernetes.client.openapi.models.V1beta2SubjectFluentImpl.ServiceAccountNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2SubjectFluent.ServiceAccountNested<A> editOrNewServiceAccount() {
    return withNewServiceAccountLike(getServiceAccount() != null ? getServiceAccount(): new io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubjectBuilder().build());
  }
  ...
  public A withUser(io.kubernetes.client.openapi.models.V1beta2UserSubject user) {
    ...
    if (user!=null){ this.user= new io.kubernetes.client.openapi.models.V1beta2UserSubjectBuilder(user); _visitables.get("user").add(this.user);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2SubjectFluent.UserNested<A> editOrNewUser() {
    return withNewUserLike(getUser() != null ? getUser(): new io.kubernetes.client.openapi.models.V1beta2UserSubjectBuilder().build());
  }
  ...
  public class GroupNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta2GroupSubjectFluentImpl<io.kubernetes.client.openapi.models.V1beta2SubjectFluent.GroupNested<N>> implements io.kubernetes.client.openapi.models.V1beta2SubjectFluent.GroupNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class ServiceAccountNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubjectFluentImpl<io.kubernetes.client.openapi.models.V1beta2SubjectFluent.ServiceAccountNested<N>> implements io.kubernetes.client.openapi.models.V1beta2SubjectFluent.ServiceAccountNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ServiceAccountNestedImpl(io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubject item) {
      this.builder = new io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubjectBuilder(this, item);
    }
    ServiceAccountNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubjectBuilder(this);
    }
  ...
  public class UserNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta2UserSubjectFluentImpl<io.kubernetes.client.openapi.models.V1beta2SubjectFluent.UserNested<N>> implements io.kubernetes.client.openapi.models.V1beta2SubjectFluent.UserNested<N>,io.kubernetes.client.fluent.Nested<N>{
