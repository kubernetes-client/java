...
/** Generated */
public class V1LeaseFluentImpl<A extends io.kubernetes.client.openapi.models.V1LeaseFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1LeaseFluent<A> {
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1LeaseSpec spec) {
    ...
    if (spec != null) {
      this.spec = new io.kubernetes.client.openapi.models.V1LeaseSpecBuilder(spec);
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1LeaseFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1LeaseFluent.MetadataNested<N>,
  ...
  public class SpecNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1LeaseSpecFluentImpl<
          io.kubernetes.client.openapi.models.V1LeaseFluent.SpecNested<N>>
