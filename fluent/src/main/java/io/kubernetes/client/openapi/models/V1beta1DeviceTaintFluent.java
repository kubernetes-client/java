...
public class V1beta1DeviceTaintFluent<A extends io.kubernetes.client.openapi.models.V1beta1DeviceTaintFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta1DeviceTaintFluent(V1beta1DeviceTaint instance) {
    this.copyInstance(instance);
  }

  protected void copyInstance(V1beta1DeviceTaint instance) {
    instance = instance != null ? instance : new V1beta1DeviceTaint();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1DeviceTaintFluent that = (V1beta1DeviceTaintFluent) o;
