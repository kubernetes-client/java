...
public class V1PodSecurityContextFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodSecurityContextFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodSecurityContextFluent<A>{
  ...
  public A withSupplementalGroups(java.util.List<java.lang.Long> supplementalGroups) {
    if (supplementalGroups != null) {this.supplementalGroups = new java.util.ArrayList(); for (java.lang.Long item : supplementalGroups){this.addToSupplementalGroups(item);}} else { this.supplementalGroups = null;} return (A) this;
  }
  ...
  public A withSysctls(java.util.List<io.kubernetes.client.openapi.models.V1Sysctl> sysctls) {
    ...
    if (sysctls != null) {this.sysctls = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Sysctl item : sysctls){this.addToSysctls(item);}} else { this.sysctls = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> setNewSysctlLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Sysctl item) {
    return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SysctlsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> editSysctl(java.lang.Integer index) {
