...
public class V1PodSecurityContextFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodSecurityContextFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodSecurityContextFluent<A> {
    ...
    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeLinuxOptionsNested<A> withNewSeLinuxOptions() {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SeLinuxOptionsNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeLinuxOptionsNested<A> withNewSeLinuxOptionsLike(io.kubernetes.client.openapi.models.V1SELinuxOptions item) {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SeLinuxOptionsNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeLinuxOptionsNested<A> editSeLinuxOptions() {
        return withNewSeLinuxOptionsLike(getSeLinuxOptions());
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeLinuxOptionsNested<A> editOrNewSeLinuxOptions() {
    ...
    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeLinuxOptionsNested<A> editOrNewSeLinuxOptionsLike(io.kubernetes.client.openapi.models.V1SELinuxOptions item) {
    ...
    public A withSeccompProfile(io.kubernetes.client.openapi.models.V1SeccompProfile seccompProfile) {
        ...
        if (seccompProfile!=null){ this.seccompProfile= new io.kubernetes.client.openapi.models.V1SeccompProfileBuilder(seccompProfile); _visitables.get("seccompProfile").add(this.seccompProfile);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeccompProfileNested<A> withNewSeccompProfile() {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SeccompProfileNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeccompProfileNested<A> withNewSeccompProfileLike(io.kubernetes.client.openapi.models.V1SeccompProfile item) {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SeccompProfileNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeccompProfileNested<A> editSeccompProfile() {
        return withNewSeccompProfileLike(getSeccompProfile());
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeccompProfileNested<A> editOrNewSeccompProfile() {
        return withNewSeccompProfileLike(getSeccompProfile() != null ? getSeccompProfile(): new io.kubernetes.client.openapi.models.V1SeccompProfileBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeccompProfileNested<A> editOrNewSeccompProfileLike(io.kubernetes.client.openapi.models.V1SeccompProfile item) {
    ...
    public A addToSysctls(int index,io.kubernetes.client.openapi.models.V1Sysctl item) {
        if (this.sysctls == null) {this.sysctls = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1SysctlBuilder>();}
        io.kubernetes.client.openapi.models.V1SysctlBuilder builder = new io.kubernetes.client.openapi.models.V1SysctlBuilder(item);_visitables.get("sysctls").add(index >= 0 ? index : _visitables.get("sysctls").size(), builder);this.sysctls.add(index >= 0 ? index : sysctls.size(), builder); return (A)this;
    }

    public A setToSysctls(int index,io.kubernetes.client.openapi.models.V1Sysctl item) {
        if (this.sysctls == null) {this.sysctls = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1SysctlBuilder>();}
        io.kubernetes.client.openapi.models.V1SysctlBuilder builder = new io.kubernetes.client.openapi.models.V1SysctlBuilder(item);
    ...
    public A addToSysctls(io.kubernetes.client.openapi.models.V1Sysctl... items) {
        if (this.sysctls == null) {this.sysctls = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1SysctlBuilder>();}
        for (io.kubernetes.client.openapi.models.V1Sysctl item : items) {io.kubernetes.client.openapi.models.V1SysctlBuilder builder = new io.kubernetes.client.openapi.models.V1SysctlBuilder(item);_visitables.get("sysctls").add(builder);this.sysctls.add(builder);} return (A)this;
    }

    public A addAllToSysctls(java.util.Collection<io.kubernetes.client.openapi.models.V1Sysctl> items) {
        if (this.sysctls == null) {this.sysctls = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1SysctlBuilder>();}
        for (io.kubernetes.client.openapi.models.V1Sysctl item : items) {io.kubernetes.client.openapi.models.V1SysctlBuilder builder = new io.kubernetes.client.openapi.models.V1SysctlBuilder(item);_visitables.get("sysctls").add(builder);this.sysctls.add(builder);} return (A)this;
    }

    public A removeFromSysctls(io.kubernetes.client.openapi.models.V1Sysctl... items) {
        for (io.kubernetes.client.openapi.models.V1Sysctl item : items) {io.kubernetes.client.openapi.models.V1SysctlBuilder builder = new io.kubernetes.client.openapi.models.V1SysctlBuilder(item);_visitables.get("sysctls").remove(builder);if (this.sysctls != null) {this.sysctls.remove(builder);}} return (A)this;
    }

    public A removeAllFromSysctls(java.util.Collection<io.kubernetes.client.openapi.models.V1Sysctl> items) {
        for (io.kubernetes.client.openapi.models.V1Sysctl item : items) {io.kubernetes.client.openapi.models.V1SysctlBuilder builder = new io.kubernetes.client.openapi.models.V1SysctlBuilder(item);_visitables.get("sysctls").remove(builder);if (this.sysctls != null) {this.sysctls.remove(builder);}} return (A)this;
    }

    public A removeMatchingFromSysctls(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1SysctlBuilder> predicate) {
    ...
    public io.kubernetes.client.openapi.models.V1Sysctl buildSysctl(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1Sysctl buildMatchingSysctl(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1SysctlBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1SysctlBuilder item: sysctls) { if(predicate.test(item)){ return item.build();} } return null;
    }

    public java.lang.Boolean hasMatchingSysctl(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1SysctlBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1SysctlBuilder item: sysctls) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withSysctls(java.util.List<io.kubernetes.client.openapi.models.V1Sysctl> sysctls) {
        ...
        if (sysctls != null) {this.sysctls = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1SysctlBuilder>(); for (io.kubernetes.client.openapi.models.V1Sysctl item : sysctls){this.addToSysctls(item);}} else { this.sysctls = null;} return (A) this;
    }

    public A withSysctls(io.kubernetes.client.openapi.models.V1Sysctl... sysctls) {
        if (this.sysctls != null) {this.sysctls.clear();}
        if (sysctls != null) {for (io.kubernetes.client.openapi.models.V1Sysctl item :sysctls){ this.addToSysctls(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> addNewSysctl() {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SysctlsNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> addNewSysctlLike(io.kubernetes.client.openapi.models.V1Sysctl item) {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SysctlsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> setNewSysctlLike(int index,io.kubernetes.client.openapi.models.V1Sysctl item) {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.SysctlsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> editSysctl(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> editFirstSysctl() {
    ...
    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> editLastSysctl() {
        int index = sysctls.size() - 1;
        if (index < 0) throw new RuntimeException("Can't edit last sysctls. The list is empty.");
        return setNewSysctlLike(index, buildSysctl(index));
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<A> editMatchingSysctl(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1SysctlBuilder> predicate) {
        int index = -1;
    ...
    public A withWindowsOptions(io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptions windowsOptions) {
        ...
        if (windowsOptions!=null){ this.windowsOptions= new io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptionsBuilder(windowsOptions); _visitables.get("windowsOptions").add(this.windowsOptions);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.WindowsOptionsNested<A> withNewWindowsOptions() {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.WindowsOptionsNestedImpl();
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.WindowsOptionsNested<A> withNewWindowsOptionsLike(io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptions item) {
        return new io.kubernetes.client.openapi.models.V1PodSecurityContextFluentImpl.WindowsOptionsNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.WindowsOptionsNested<A> editWindowsOptions() {
        return withNewWindowsOptionsLike(getWindowsOptions());
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.WindowsOptionsNested<A> editOrNewWindowsOptions() {
        return withNewWindowsOptionsLike(getWindowsOptions() != null ? getWindowsOptions(): new io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptionsBuilder().build());
    }

    public io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.WindowsOptionsNested<A> editOrNewWindowsOptionsLike(io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptions item) {
    ...
    public class SeccompProfileNestedImpl<N> extends io.kubernetes.client.openapi.models.V1SeccompProfileFluentImpl<io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeccompProfileNested<N>> implements io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SeccompProfileNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1SeccompProfileBuilder builder;
    ...
    public class SysctlsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1SysctlFluentImpl<io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.SysctlsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1SysctlBuilder builder;
        private final int index;

            SysctlsNestedImpl(int index,io.kubernetes.client.openapi.models.V1Sysctl item) {
                this.index = index;
    ...
    public class WindowsOptionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptionsFluentImpl<io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.WindowsOptionsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSecurityContextFluent.WindowsOptionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptionsBuilder builder;

            WindowsOptionsNestedImpl(io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptions item) {
                this.builder = new io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptionsBuilder(this, item);
                        
            }

            WindowsOptionsNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptionsBuilder(this);
