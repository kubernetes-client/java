...
public class V1beta1PolicyRuleFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PolicyRuleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PolicyRuleFluent<A> {
    ...
    public V1beta1PolicyRuleFluentImpl() {
    }

    public V1beta1PolicyRuleFluentImpl(io.kubernetes.client.openapi.models.V1beta1PolicyRule instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1PolicyRuleFluentImpl that = (V1beta1PolicyRuleFluentImpl) o;
