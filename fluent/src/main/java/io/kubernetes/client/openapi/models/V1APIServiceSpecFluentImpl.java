...
public class V1APIServiceSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1APIServiceSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1APIServiceSpecFluent<A> {
    ...
    public A withService(io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReference service) {
        ...
        if (service!=null){ this.service= new io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReferenceBuilder(service); _visitables.get("service").add(this.service);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1APIServiceSpecFluent.ServiceNested<A> withNewServiceLike(io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReference item) {
        return new io.kubernetes.client.openapi.models.V1APIServiceSpecFluentImpl.ServiceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1APIServiceSpecFluent.ServiceNested<A> editOrNewService() {
        return withNewServiceLike(getService() != null ? getService(): new io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReferenceBuilder().build());
    }
    ...
    public class ServiceNestedImpl<N> extends io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReferenceFluentImpl<io.kubernetes.client.openapi.models.V1APIServiceSpecFluent.ServiceNested<N>> implements io.kubernetes.client.openapi.models.V1APIServiceSpecFluent.ServiceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReferenceBuilder builder;

            ServiceNestedImpl(io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReference item) {
                this.builder = new io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReferenceBuilder(this, item);
                        
            }

            ServiceNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.ApiregistrationV1ServiceReferenceBuilder(this);
