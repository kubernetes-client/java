...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta1CronJobStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent<A>{
  public V1beta1CronJobStatusFluentImpl() {
  }
  public V1beta1CronJobStatusFluentImpl(io.kubernetes.client.openapi.models.V1beta1CronJobStatus instance) {
  ...
  public A withActive(java.util.List<io.kubernetes.client.openapi.models.V1ObjectReference> active) {
    ...
    if (active != null) {this.active = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1ObjectReference item : active){this.addToActive(item);}} else { this.active = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<A> addNewActive() {
    return new io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluentImpl.ActiveNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<A> addNewActiveLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
    return new io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluentImpl.ActiveNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<A> setNewActiveLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ObjectReference item) {
    return new io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluentImpl.ActiveNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<A> editActive(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<A> editFirstActive() {
  ...
  public io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<A> editLastActive() {
    int index = active.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last active. The list is empty.");
    return setNewActiveLike(index, buildActive(index));
  }
  public io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<A> editMatchingActive(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder> predicate) {
    int index = -1;
  ...
  public class ActiveNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ActiveNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ObjectReference item) {
      this.index = index;
