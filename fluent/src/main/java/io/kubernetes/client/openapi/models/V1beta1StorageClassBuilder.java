...
public class V1beta1StorageClassBuilder extends io.kubernetes.client.openapi.models.V1beta1StorageClassFluentImpl<io.kubernetes.client.openapi.models.V1beta1StorageClassBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1beta1StorageClass,io.kubernetes.client.openapi.models.V1beta1StorageClassBuilder> {
    ...
    public V1beta1StorageClassBuilder(java.lang.Boolean validationEnabled) {
        this(new V1beta1StorageClass(), validationEnabled);
    }

    public V1beta1StorageClassBuilder(io.kubernetes.client.openapi.models.V1beta1StorageClassFluent<?> fluent) {
        this(fluent, true);
    }

    public V1beta1StorageClassBuilder(io.kubernetes.client.openapi.models.V1beta1StorageClassFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1beta1StorageClass(), validationEnabled);
    }

    public V1beta1StorageClassBuilder(io.kubernetes.client.openapi.models.V1beta1StorageClassFluent<?> fluent,io.kubernetes.client.openapi.models.V1beta1StorageClass instance) {
        this(fluent, instance, true);
    }

    public V1beta1StorageClassBuilder(io.kubernetes.client.openapi.models.V1beta1StorageClassFluent<?> fluent,io.kubernetes.client.openapi.models.V1beta1StorageClass instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1beta1StorageClassBuilder(io.kubernetes.client.openapi.models.V1beta1StorageClass instance) {
        this(instance,true);
    }

    public V1beta1StorageClassBuilder(io.kubernetes.client.openapi.models.V1beta1StorageClass instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
    ...
    public io.kubernetes.client.openapi.models.V1beta1StorageClass build() {
        V1beta1StorageClass buildable = new V1beta1StorageClass();
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1StorageClassBuilder that = (V1beta1StorageClassBuilder) o;
