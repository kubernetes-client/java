...
public class V1beta2ResourceClaimTemplateSpecFluent<A extends io.kubernetes.client.openapi.models.V1beta2ResourceClaimTemplateSpecFluent<A>> extends BaseFluent<A>{
  public V1beta2ResourceClaimTemplateSpecFluent() {
  }
  
  public V1beta2ResourceClaimTemplateSpecFluent(V1beta2ResourceClaimTemplateSpec instance) {
    this.copyInstance(instance);
  }
  private V1ObjectMetaBuilder metadata;
  private V1beta2ResourceClaimSpecBuilder spec;
  
  protected void copyInstance(V1beta2ResourceClaimTemplateSpec instance) {
    instance = instance != null ? instance : new V1beta2ResourceClaimTemplateSpec();
    if (instance != null) {
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V1beta2ResourceClaimSpecBuilder().build()));
  }
  ...
  public boolean equals(Object o) {
    ...
    V1beta2ResourceClaimTemplateSpecFluent that = (V1beta2ResourceClaimTemplateSpecFluent) o;
  ...
  public class MetadataNested<N> extends V1ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2ResourceClaimTemplateSpecFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends V1beta2ResourceClaimSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2ResourceClaimTemplateSpecFluent.this.withSpec(builder.build());
    }
