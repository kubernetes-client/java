...
public class V1RuntimeClassListFluent<A extends V1RuntimeClassListFluent<A>> extends BaseFluent<A>{
  public V1RuntimeClassListFluent() {
  }
  
  public V1RuntimeClassListFluent(V1RuntimeClassList instance) {
  ...
  protected void copyInstance(V1RuntimeClassList instance) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1RuntimeClass... items) {
    ...
    for (V1RuntimeClass item : items) {V1RuntimeClassBuilder builder = new V1RuntimeClassBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1RuntimeClass buildMatchingItem(Predicate<V1RuntimeClassBuilder> predicate) {
      for (V1RuntimeClassBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1RuntimeClass item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1RuntimeClass item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1RuntimeClassBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1RuntimeClassListFluent that = (V1RuntimeClassListFluent) o;
  ...
  public class ItemsNested<N> extends V1RuntimeClassFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1RuntimeClass item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1RuntimeClassListFluent.this.withMetadata(builder.build());
    }
