...
public class V1RuntimeClassListFluent<A extends io.kubernetes.client.openapi.models.V1RuntimeClassListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1RuntimeClassBuilder> predicate) {
    ...
    Iterator<V1RuntimeClassBuilder> each = items.iterator();
