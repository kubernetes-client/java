...
public class V1CSINodeListFluentImpl<A extends V1CSINodeListFluent<A>> extends BaseFluent<A>
  ...
  public A addToItems(Integer index, V1CSINode item) {
    if (this.items == null) {
      this.items = new ArrayList<V1CSINodeBuilder>();
    }
  ...
  public V1CSINodeListFluent.ItemsNested<A> editMatchingItem(
      Predicate<V1CSINodeBuilder> predicate) {
    int index = -1;
  ...
  class ItemsNestedImpl<N> extends V1CSINodeFluentImpl<V1CSINodeListFluent.ItemsNested<N>>
      implements V1CSINodeListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CSINodeListFluent.MetadataNested<N>>
      implements V1CSINodeListFluent.MetadataNested<N>, Nested<N> {
