...
import java.lang.Object;
  ...
  */
  ...
  public V1CSINodeListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1CSINodeListFluentImpl.ItemsNestedImpl();
  }
  public V1CSINodeListFluentImpl.ItemsNested<A> addNewItemLike(V1CSINode item) {
    return new V1CSINodeListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1CSINodeListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1CSINode item) {
    return new V1CSINodeListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1CSINodeListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CSINodeListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1CSINodeListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CSINodeListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1CSINodeBuilder> predicate) {
    int index = -1;
  ...
  public V1CSINodeListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1CSINodeListFluentImpl.MetadataNestedImpl();
  }
  public V1CSINodeListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1CSINodeListFluentImpl.MetadataNestedImpl(item);
  }
  public V1CSINodeListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1CSINodeListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1CSINodeListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1CSINodeFluentImpl<V1CSINodeListFluentImpl.ItemsNested<N>> implements V1CSINodeListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1CSINode item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CSINodeListFluentImpl.MetadataNested<N>> implements V1CSINodeListFluentImpl.MetadataNested<N>,Nested<N>{
