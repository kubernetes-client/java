...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(int index,V1PersistentVolumeClaim item) {
  ...
  public A setToItems(int index,V1PersistentVolumeClaim item) {
    if (this.items == null) {this.items = new ArrayList<V1PersistentVolumeClaimBuilder>();}
    V1PersistentVolumeClaimBuilder builder = new V1PersistentVolumeClaimBuilder(item);
  ...
  public V1PersistentVolumeClaim buildItem(int index) {
  ...
  public V1PersistentVolumeClaimListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1PersistentVolumeClaimListFluentImpl.ItemsNestedImpl();
  }
  public V1PersistentVolumeClaimListFluentImpl.ItemsNested<A> addNewItemLike(V1PersistentVolumeClaim item) {
    return new V1PersistentVolumeClaimListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1PersistentVolumeClaimListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1PersistentVolumeClaim item) {
    return new V1PersistentVolumeClaimListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1PersistentVolumeClaimListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1PersistentVolumeClaimListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1PersistentVolumeClaimListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1PersistentVolumeClaimListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1PersistentVolumeClaimBuilder> predicate) {
    int index = -1;
  ...
  public V1PersistentVolumeClaimListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1PersistentVolumeClaimListFluentImpl.MetadataNestedImpl();
  }
  public V1PersistentVolumeClaimListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1PersistentVolumeClaimListFluentImpl.MetadataNestedImpl(item);
  }
  public V1PersistentVolumeClaimListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1PersistentVolumeClaimListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1PersistentVolumeClaimListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1PersistentVolumeClaimFluentImpl<V1PersistentVolumeClaimListFluentImpl.ItemsNested<N>> implements V1PersistentVolumeClaimListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1PersistentVolumeClaim item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1PersistentVolumeClaimListFluentImpl.MetadataNested<N>> implements V1PersistentVolumeClaimListFluentImpl.MetadataNested<N>,Nested<N>{
