...
public class V1PersistentVolumeClaimListFluentImpl<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent<A> {

    private java.lang.String apiVersion;
    private java.util.List<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> items;
    ...
    public V1PersistentVolumeClaimListFluentImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimList instance) {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder>();}
        io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
    }

    public A setToItems(int index,io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder>();}
    ...
    public A addToItems(io.kubernetes.client.openapi.models.V1PersistentVolumeClaim... items) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder>();}
        for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item : items) {io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
    }
    ...
    public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> each = items.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaim buildItem(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaim buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1PersistentVolumeClaim> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder>(); for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }

    public A withItems(io.kubernetes.client.openapi.models.V1PersistentVolumeClaim... items) {
        if (this.items != null) {this.items.clear();}
        if (items != null) {for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item :items){ this.addToItems(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluentImpl.ItemsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluentImpl.ItemsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.ItemsNested<A> editItem(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
        return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluentImpl.MetadataNestedImpl(item);
    }
