...
public class V1PersistentVolumeClaimListFluentImpl<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent<A>{
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> items;
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1PersistentVolumeClaim> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
      this.index = index;
