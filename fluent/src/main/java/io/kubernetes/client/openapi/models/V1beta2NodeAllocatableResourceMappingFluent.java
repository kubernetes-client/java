...
public class V1beta2NodeAllocatableResourceMappingFluent<A extends io.kubernetes.client.openapi.models.V1beta2NodeAllocatableResourceMappingFluent<A>> extends BaseFluent<A>{

  private Quantity allocationMultiplier;
  private String capacityKey;

  public V1beta2NodeAllocatableResourceMappingFluent() {
  }
  
  public V1beta2NodeAllocatableResourceMappingFluent(V1beta2NodeAllocatableResourceMapping instance) {
    this.copyInstance(instance);
  }

  protected void copyInstance(V1beta2NodeAllocatableResourceMapping instance) {
    instance = instance != null ? instance : new V1beta2NodeAllocatableResourceMapping();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2NodeAllocatableResourceMappingFluent that = (V1beta2NodeAllocatableResourceMappingFluent) o;
