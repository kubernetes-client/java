...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(int index,V1beta2FlowSchema item) {
  ...
  public A setToItems(int index,V1beta2FlowSchema item) {
    if (this.items == null) {this.items = new ArrayList<V1beta2FlowSchemaBuilder>();}
    V1beta2FlowSchemaBuilder builder = new V1beta2FlowSchemaBuilder(item);
  ...
  public V1beta2FlowSchema buildItem(int index) {
  ...
  public V1beta2FlowSchemaListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1beta2FlowSchemaListFluentImpl.ItemsNestedImpl();
  }
  public V1beta2FlowSchemaListFluentImpl.ItemsNested<A> addNewItemLike(V1beta2FlowSchema item) {
    return new V1beta2FlowSchemaListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1beta2FlowSchemaListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1beta2FlowSchema item) {
    return new V1beta2FlowSchemaListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1beta2FlowSchemaListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1beta2FlowSchemaListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1beta2FlowSchemaListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1beta2FlowSchemaListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1beta2FlowSchemaBuilder> predicate) {
    int index = -1;
  ...
  public V1beta2FlowSchemaListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1beta2FlowSchemaListFluentImpl.MetadataNestedImpl();
  }
  public V1beta2FlowSchemaListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1beta2FlowSchemaListFluentImpl.MetadataNestedImpl(item);
  }
  public V1beta2FlowSchemaListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1beta2FlowSchemaListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1beta2FlowSchemaListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1beta2FlowSchemaFluentImpl<V1beta2FlowSchemaListFluentImpl.ItemsNested<N>> implements V1beta2FlowSchemaListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1beta2FlowSchema item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta2FlowSchemaListFluentImpl.MetadataNested<N>> implements V1beta2FlowSchemaListFluentImpl.MetadataNested<N>,Nested<N>{
