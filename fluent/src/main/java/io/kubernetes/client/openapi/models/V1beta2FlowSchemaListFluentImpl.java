...
import java.lang.Object;
  ...
  * Generated
  */
public class V1beta2FlowSchemaListFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent<A>{
  public V1beta2FlowSchemaListFluentImpl() {
  }
  public V1beta2FlowSchemaListFluentImpl(io.kubernetes.client.openapi.models.V1beta2FlowSchemaList instance) {
  ...
  public A addToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchema item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder>();}
    io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchema item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder>();}
    io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1beta2FlowSchema... items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder>();}
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchema item : items) {io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta2FlowSchema... items) {
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchema item : items) {io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder> each = items.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1beta2FlowSchema buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1beta2FlowSchema> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta2FlowSchema item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1beta2FlowSchema... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (io.kubernetes.client.openapi.models.V1beta2FlowSchema item :items){ this.addToItems(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1beta2FlowSchema item) {
    return new io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchema item) {
    return new io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluentImpl.ItemsNestedImpl(index, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
    return new io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta2FlowSchemaFluentImpl<io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta2FlowSchema item) {
      this.index = index;
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
