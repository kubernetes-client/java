...
import java.util.Map;
  ...
  * Generated
  */
public class V1alpha1SchedulingFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1SchedulingFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1SchedulingFluent<A>{
  public V1alpha1SchedulingFluentImpl() {
  }
  public V1alpha1SchedulingFluentImpl(io.kubernetes.client.openapi.models.V1alpha1Scheduling instance) {
  ...
  public io.kubernetes.client.openapi.models.V1alpha1SchedulingFluent.TolerationsNested<A> addNewToleration() {
    return new io.kubernetes.client.openapi.models.V1alpha1SchedulingFluentImpl.TolerationsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1alpha1SchedulingFluent.TolerationsNested<A> addNewTolerationLike(io.kubernetes.client.openapi.models.V1Toleration item) {
    return new io.kubernetes.client.openapi.models.V1alpha1SchedulingFluentImpl.TolerationsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1alpha1SchedulingFluent.TolerationsNested<A> setNewTolerationLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Toleration item) {
    return new io.kubernetes.client.openapi.models.V1alpha1SchedulingFluentImpl.TolerationsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1alpha1SchedulingFluent.TolerationsNested<A> editToleration(java.lang.Integer index) {
