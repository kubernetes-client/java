...
import java.lang.Boolean;
  ...
  */
  ...
  public class V1beta3FlowSchemaConditionFluentImpl<A extends V1beta3FlowSchemaConditionFluent<A>> extends BaseFluent<A> implements V1beta3FlowSchemaConditionFluent<A>{
  public V1beta3FlowSchemaConditionFluentImpl() {
  }
  public V1beta3FlowSchemaConditionFluentImpl(V1beta3FlowSchemaCondition instance) {
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta3FlowSchemaConditionFluentImpl that = (V1beta3FlowSchemaConditionFluentImpl) o;
