...
public class V1ComponentStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1ComponentStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ComponentStatusFluent<A> {
    ...
    public V1ComponentStatusFluentImpl(io.kubernetes.client.openapi.models.V1ComponentStatus instance) {
    ...
    public A setToConditions(int index,io.kubernetes.client.openapi.models.V1ComponentCondition item) {
        if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder>();}
        io.kubernetes.client.openapi.models.V1ComponentConditionBuilder builder = new io.kubernetes.client.openapi.models.V1ComponentConditionBuilder(item);
    ...
    public A addToConditions(io.kubernetes.client.openapi.models.V1ComponentCondition... items) {
        if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder>();}
        for (io.kubernetes.client.openapi.models.V1ComponentCondition item : items) {io.kubernetes.client.openapi.models.V1ComponentConditionBuilder builder = new io.kubernetes.client.openapi.models.V1ComponentConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
    }
    ...
    public A removeMatchingFromConditions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder> each = conditions.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1ComponentCondition buildMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1ComponentConditionBuilder item: conditions) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1ComponentConditionBuilder item: conditions) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1ComponentCondition> conditions) {
        ...
        if (conditions != null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder>(); for (io.kubernetes.client.openapi.models.V1ComponentCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
    }

    public A withConditions(io.kubernetes.client.openapi.models.V1ComponentCondition... conditions) {
        if (this.conditions != null) {this.conditions.clear();}
        if (conditions != null) {for (io.kubernetes.client.openapi.models.V1ComponentCondition item :conditions){ this.addToConditions(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ComponentStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1ComponentCondition item) {
        return new io.kubernetes.client.openapi.models.V1ComponentStatusFluentImpl.ConditionsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1ComponentStatusFluent.ConditionsNested<A> setNewConditionLike(int index,io.kubernetes.client.openapi.models.V1ComponentCondition item) {
        return new io.kubernetes.client.openapi.models.V1ComponentStatusFluentImpl.ConditionsNestedImpl(index, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1ComponentStatusFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1ComponentStatusFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ComponentConditionFluentImpl<io.kubernetes.client.openapi.models.V1ComponentStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1ComponentStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ComponentConditionBuilder builder;
        private final int index;

            ConditionsNestedImpl(int index,io.kubernetes.client.openapi.models.V1ComponentCondition item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1ComponentConditionBuilder(this, item);
