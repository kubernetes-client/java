...
import java.lang.Object;
  ...
  */
  ...
  public V1ComponentStatusFluentImpl.ConditionsNested<A> addNewCondition() {
    return new V1ComponentStatusFluentImpl.ConditionsNestedImpl();
  }
  public V1ComponentStatusFluentImpl.ConditionsNested<A> addNewConditionLike(V1ComponentCondition item) {
    return new V1ComponentStatusFluentImpl.ConditionsNestedImpl(-1, item);
  }
  public V1ComponentStatusFluentImpl.ConditionsNested<A> setNewConditionLike(int index,V1ComponentCondition item) {
    return new V1ComponentStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  public V1ComponentStatusFluentImpl.ConditionsNested<A> editCondition(int index) {
    if (conditions.size() <= index) throw new RuntimeException("Can't edit conditions. Index exceeds size.");
    return setNewConditionLike(index, buildCondition(index));
  }
  public V1ComponentStatusFluentImpl.ConditionsNested<A> editFirstCondition() {
    if (conditions.size() == 0) throw new RuntimeException("Can't edit first conditions. The list is empty.");
    return setNewConditionLike(0, buildCondition(0));
  }
  public V1ComponentStatusFluentImpl.ConditionsNested<A> editLastCondition() {
    int index = conditions.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last conditions. The list is empty.");
    return setNewConditionLike(index, buildCondition(index));
  }
  public V1ComponentStatusFluentImpl.ConditionsNested<A> editMatchingCondition(Predicate<V1ComponentConditionBuilder> predicate) {
    int index = -1;
  ...
  public V1ComponentStatusFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1ComponentStatusFluentImpl.MetadataNestedImpl();
  }
  public V1ComponentStatusFluentImpl.MetadataNested<A> withNewMetadataLike(V1ObjectMeta item) {
    return new V1ComponentStatusFluentImpl.MetadataNestedImpl(item);
  }
  public V1ComponentStatusFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1ComponentStatusFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ObjectMetaBuilder().build());
  }
  public V1ComponentStatusFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ObjectMeta item) {
  ...
  class ConditionsNestedImpl<N> extends V1ComponentConditionFluentImpl<V1ComponentStatusFluentImpl.ConditionsNested<N>> implements V1ComponentStatusFluentImpl.ConditionsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ComponentStatusFluentImpl.MetadataNested<N>> implements V1ComponentStatusFluentImpl.MetadataNested<N>,Nested<N>{
