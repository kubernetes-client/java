...
public class V1MutatingWebhookConfigurationListFluentImpl<
        A extends V1MutatingWebhookConfigurationListFluent<A>>
    extends BaseFluent<A> implements V1MutatingWebhookConfigurationListFluent<A> {
  ...
  public A addToItems(Integer index, V1MutatingWebhookConfiguration item) {
    if (this.items == null) {
      this.items = new ArrayList<V1MutatingWebhookConfigurationBuilder>();
    }
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1MutatingWebhookConfiguration... items) {
    ...
    for (V1MutatingWebhookConfiguration item : items) {
      V1MutatingWebhookConfigurationBuilder builder =
          new V1MutatingWebhookConfigurationBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public V1MutatingWebhookConfiguration buildMatchingItem(
      Predicate<V1MutatingWebhookConfigurationBuilder> predicate) {
    for (V1MutatingWebhookConfigurationBuilder item : items) {
  ...
  public V1MutatingWebhookConfigurationListFluent.ItemsNested<A> addNewItemLike(
      V1MutatingWebhookConfiguration item) {
    return new V1MutatingWebhookConfigurationListFluentImpl.ItemsNestedImpl(-1, item);
  }

  public V1MutatingWebhookConfigurationListFluent.ItemsNested<A> setNewItemLike(
      Integer index, V1MutatingWebhookConfiguration item) {
  ...
  public V1MutatingWebhookConfigurationListFluent.ItemsNested<A> editMatchingItem(
      Predicate<V1MutatingWebhookConfigurationBuilder> predicate) {
    int index = -1;
  ...
  public V1MutatingWebhookConfigurationListFluent.MetadataNested<A> withNewMetadataLike(
      V1ListMeta item) {
  ...
  public V1MutatingWebhookConfigurationListFluent.MetadataNested<A> editOrNewMetadataLike(
      V1ListMeta item) {
  ...
  class ItemsNestedImpl<N>
      extends V1MutatingWebhookConfigurationFluentImpl<
          V1MutatingWebhookConfigurationListFluent.ItemsNested<N>>
      implements V1MutatingWebhookConfigurationListFluent.ItemsNested<N>, Nested<N> {
    ItemsNestedImpl(Integer index, V1MutatingWebhookConfiguration item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N>
      extends V1ListMetaFluentImpl<V1MutatingWebhookConfigurationListFluent.MetadataNested<N>>
      implements V1MutatingWebhookConfigurationListFluent.MetadataNested<N>, Nested<N> {
