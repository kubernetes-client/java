...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2PodsMetricSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.MetricNested<A> withNewMetric() {
    return new io.kubernetes.client.openapi.models.V2PodsMetricSourceFluentImpl.MetricNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.MetricNested<A> withNewMetricLike(io.kubernetes.client.openapi.models.V2MetricIdentifier item) {
    return new io.kubernetes.client.openapi.models.V2PodsMetricSourceFluentImpl.MetricNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.MetricNested<A> editOrNewMetric() {
  ...
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.MetricNested<A> editOrNewMetricLike(io.kubernetes.client.openapi.models.V2MetricIdentifier item) {
  ...
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.TargetNested<A> withNewTarget() {
    return new io.kubernetes.client.openapi.models.V2PodsMetricSourceFluentImpl.TargetNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.TargetNested<A> withNewTargetLike(io.kubernetes.client.openapi.models.V2MetricTarget item) {
    return new io.kubernetes.client.openapi.models.V2PodsMetricSourceFluentImpl.TargetNestedImpl(item);
  }
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.TargetNested<A> editTarget() {
    return withNewTargetLike(getTarget());
  }
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.TargetNested<A> editOrNewTarget() {
    return withNewTargetLike(getTarget() != null ? getTarget(): new io.kubernetes.client.openapi.models.V2MetricTargetBuilder().build());
  }
  public io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.TargetNested<A> editOrNewTargetLike(io.kubernetes.client.openapi.models.V2MetricTarget item) {
  ...
  public class TargetNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricTargetFluentImpl<io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.TargetNested<N>> implements io.kubernetes.client.openapi.models.V2PodsMetricSourceFluent.TargetNested<N>,io.kubernetes.client.fluent.Nested<N>{
