...
import java.lang.Boolean;
  ...
  */
  ...
  public V2PodsMetricSourceFluentImpl.MetricNested<A> withNewMetric() {
    return new V2PodsMetricSourceFluentImpl.MetricNestedImpl();
  }
  public V2PodsMetricSourceFluentImpl.MetricNested<A> withNewMetricLike(V2MetricIdentifier item) {
    return new V2PodsMetricSourceFluentImpl.MetricNestedImpl(item);
  }
  public V2PodsMetricSourceFluentImpl.MetricNested<A> editMetric() {
    return withNewMetricLike(getMetric());
  }
  public V2PodsMetricSourceFluentImpl.MetricNested<A> editOrNewMetric() {
    return withNewMetricLike(getMetric() != null ? getMetric(): new V2MetricIdentifierBuilder().build());
  }
  public V2PodsMetricSourceFluentImpl.MetricNested<A> editOrNewMetricLike(V2MetricIdentifier item) {
  ...
  public V2PodsMetricSourceFluentImpl.TargetNested<A> withNewTarget() {
    return new V2PodsMetricSourceFluentImpl.TargetNestedImpl();
  }
  public V2PodsMetricSourceFluentImpl.TargetNested<A> withNewTargetLike(V2MetricTarget item) {
    return new V2PodsMetricSourceFluentImpl.TargetNestedImpl(item);
  }
  public V2PodsMetricSourceFluentImpl.TargetNested<A> editTarget() {
    return withNewTargetLike(getTarget());
  }
  public V2PodsMetricSourceFluentImpl.TargetNested<A> editOrNewTarget() {
    return withNewTargetLike(getTarget() != null ? getTarget(): new V2MetricTargetBuilder().build());
  }
  public V2PodsMetricSourceFluentImpl.TargetNested<A> editOrNewTargetLike(V2MetricTarget item) {
  ...
  class MetricNestedImpl<N> extends V2MetricIdentifierFluentImpl<V2PodsMetricSourceFluentImpl.MetricNested<N>> implements V2PodsMetricSourceFluentImpl.MetricNested<N>,Nested<N>{
  ...
  class TargetNestedImpl<N> extends V2MetricTargetFluentImpl<V2PodsMetricSourceFluentImpl.TargetNested<N>> implements V2PodsMetricSourceFluentImpl.TargetNested<N>,Nested<N>{
