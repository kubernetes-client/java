...
public interface V1ValidatingWebhookConfigurationListFluent<A extends V1ValidatingWebhookConfigurationListFluent<A>> extends Fluent<A>{
  ...
  public V1ValidatingWebhookConfigurationListFluent.ItemsNested<A> setNewItemLike(int index,V1ValidatingWebhookConfiguration item);
  public V1ValidatingWebhookConfigurationListFluent.ItemsNested<A> editItem(int index);
