...
public class V1alpha2ResourceClaimListFluent<A extends V1alpha2ResourceClaimListFluent<A>> extends BaseFluent<A>{
  public V1alpha2ResourceClaimListFluent() {
  }
  
  public V1alpha2ResourceClaimListFluent(V1alpha2ResourceClaimList instance) {
  ...
  protected void copyInstance(V1alpha2ResourceClaimList instance) {
    instance = (instance != null ? instance : new V1alpha2ResourceClaimList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha2ResourceClaim... items) {
    ...
    for (V1alpha2ResourceClaim item : items) {V1alpha2ResourceClaimBuilder builder = new V1alpha2ResourceClaimBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1alpha2ResourceClaim buildMatchingItem(Predicate<V1alpha2ResourceClaimBuilder> predicate) {
      for (V1alpha2ResourceClaimBuilder item : items) {
  ...
  public A withItems(List<V1alpha2ResourceClaim> items) {
    ...
    if (items != null) {
        ...
        for (V1alpha2ResourceClaim item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1alpha2ResourceClaim item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1alpha2ResourceClaim item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1alpha2ResourceClaimBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1alpha2ResourceClaimListFluent that = (V1alpha2ResourceClaimListFluent) o;
  ...
  public class ItemsNested<N> extends V1alpha2ResourceClaimFluent<ItemsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha2ResourceClaimListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha2ResourceClaimListFluent.this.withMetadata(builder.build());
    }
