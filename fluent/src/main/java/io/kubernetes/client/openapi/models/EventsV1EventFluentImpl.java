...
public class EventsV1EventFluentImpl<A extends io.kubernetes.client.openapi.models.EventsV1EventFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.EventsV1EventFluent<A> {
    ...
    public A withDeprecatedSource(io.kubernetes.client.openapi.models.V1EventSource deprecatedSource) {
        ...
        if (deprecatedSource!=null){ this.deprecatedSource= new io.kubernetes.client.openapi.models.V1EventSourceBuilder(deprecatedSource); _visitables.get("deprecatedSource").add(this.deprecatedSource);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.DeprecatedSourceNested<A> withNewDeprecatedSource() {
        return new io.kubernetes.client.openapi.models.EventsV1EventFluentImpl.DeprecatedSourceNestedImpl();
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.DeprecatedSourceNested<A> withNewDeprecatedSourceLike(io.kubernetes.client.openapi.models.V1EventSource item) {
        return new io.kubernetes.client.openapi.models.EventsV1EventFluentImpl.DeprecatedSourceNestedImpl(item);
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.DeprecatedSourceNested<A> editDeprecatedSource() {
        return withNewDeprecatedSourceLike(getDeprecatedSource());
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.DeprecatedSourceNested<A> editOrNewDeprecatedSource() {
        return withNewDeprecatedSourceLike(getDeprecatedSource() != null ? getDeprecatedSource(): new io.kubernetes.client.openapi.models.V1EventSourceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.DeprecatedSourceNested<A> editOrNewDeprecatedSourceLike(io.kubernetes.client.openapi.models.V1EventSource item) {
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.EventsV1EventFluentImpl.MetadataNestedImpl();
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.MetadataNested<A> editOrNewMetadata() {
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.MetadataNested<A> editOrNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    ...
    public A withRegarding(io.kubernetes.client.openapi.models.V1ObjectReference regarding) {
        ...
        if (regarding!=null){ this.regarding= new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder(regarding); _visitables.get("regarding").add(this.regarding);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.RegardingNested<A> withNewRegarding() {
        return new io.kubernetes.client.openapi.models.EventsV1EventFluentImpl.RegardingNestedImpl();
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.RegardingNested<A> withNewRegardingLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
        return new io.kubernetes.client.openapi.models.EventsV1EventFluentImpl.RegardingNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.RegardingNested<A> editOrNewRegarding() {
        return withNewRegardingLike(getRegarding() != null ? getRegarding(): new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.RegardingNested<A> editOrNewRegardingLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
    ...
    public A withRelated(io.kubernetes.client.openapi.models.V1ObjectReference related) {
        ...
        if (related!=null){ this.related= new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder(related); _visitables.get("related").add(this.related);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.RelatedNested<A> withNewRelatedLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.RelatedNested<A> editOrNewRelated() {
        return withNewRelatedLike(getRelated() != null ? getRelated(): new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder().build());
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.RelatedNested<A> editOrNewRelatedLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
    ...
    public A withSeries(io.kubernetes.client.openapi.models.EventsV1EventSeries series) {
        ...
        if (series!=null){ this.series= new io.kubernetes.client.openapi.models.EventsV1EventSeriesBuilder(series); _visitables.get("series").add(this.series);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.SeriesNested<A> withNewSeriesLike(io.kubernetes.client.openapi.models.EventsV1EventSeries item) {
    ...
    public io.kubernetes.client.openapi.models.EventsV1EventFluent.SeriesNested<A> editOrNewSeries() {
        return withNewSeriesLike(getSeries() != null ? getSeries(): new io.kubernetes.client.openapi.models.EventsV1EventSeriesBuilder().build());
    }

    public io.kubernetes.client.openapi.models.EventsV1EventFluent.SeriesNested<A> editOrNewSeriesLike(io.kubernetes.client.openapi.models.EventsV1EventSeries item) {
    ...
    public class DeprecatedSourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EventSourceFluentImpl<io.kubernetes.client.openapi.models.EventsV1EventFluent.DeprecatedSourceNested<N>> implements io.kubernetes.client.openapi.models.EventsV1EventFluent.DeprecatedSourceNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.EventsV1EventFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.EventsV1EventFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class RegardingNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.EventsV1EventFluent.RegardingNested<N>> implements io.kubernetes.client.openapi.models.EventsV1EventFluent.RegardingNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class RelatedNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.EventsV1EventFluent.RelatedNested<N>> implements io.kubernetes.client.openapi.models.EventsV1EventFluent.RelatedNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder builder;
    ...
    public class SeriesNestedImpl<N> extends io.kubernetes.client.openapi.models.EventsV1EventSeriesFluentImpl<io.kubernetes.client.openapi.models.EventsV1EventFluent.SeriesNested<N>> implements io.kubernetes.client.openapi.models.EventsV1EventFluent.SeriesNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.EventsV1EventSeriesBuilder builder;
