...
import java.lang.Object;
  ...
  * Generated
  */
public class V1EndpointSliceFluentImpl<A extends io.kubernetes.client.openapi.models.V1EndpointSliceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1EndpointSliceFluent<A>{
  ...
  public A addToEndpoints(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Endpoint item) {
    ...
    io.kubernetes.client.openapi.models.V1EndpointBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointBuilder(item);_visitables.get("endpoints").add(index >= 0 ? index : _visitables.get("endpoints").size(), builder);this.endpoints.add(index >= 0 ? index : endpoints.size(), builder); return (A)this;
  }
  public A setToEndpoints(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Endpoint item) {
    if (this.endpoints == null) {this.endpoints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointBuilder>();}
    io.kubernetes.client.openapi.models.V1EndpointBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointBuilder(item);
  ...
  public A addToEndpoints(io.kubernetes.client.openapi.models.V1Endpoint... items) {
    if (this.endpoints == null) {this.endpoints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointBuilder>();}
    for (io.kubernetes.client.openapi.models.V1Endpoint item : items) {io.kubernetes.client.openapi.models.V1EndpointBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointBuilder(item);_visitables.get("endpoints").add(builder);this.endpoints.add(builder);} return (A)this;
  }
  ...
  public A removeFromEndpoints(io.kubernetes.client.openapi.models.V1Endpoint... items) {
    for (io.kubernetes.client.openapi.models.V1Endpoint item : items) {io.kubernetes.client.openapi.models.V1EndpointBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointBuilder(item);_visitables.get("endpoints").remove(builder);if (this.endpoints != null) {this.endpoints.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromEndpoints(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EndpointBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1EndpointBuilder> each = endpoints.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1Endpoint buildMatchingEndpoint(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EndpointBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1EndpointBuilder item: endpoints) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingEndpoint(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EndpointBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1EndpointBuilder item: endpoints) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withEndpoints(java.util.List<io.kubernetes.client.openapi.models.V1Endpoint> endpoints) {
    ...
    if (endpoints != null) {this.endpoints = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Endpoint item : endpoints){this.addToEndpoints(item);}} else { this.endpoints = null;} return (A) this;
  }
  public A withEndpoints(io.kubernetes.client.openapi.models.V1Endpoint... endpoints) {
    ...
    if (endpoints != null) {for (io.kubernetes.client.openapi.models.V1Endpoint item :endpoints){ this.addToEndpoints(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSliceFluent.EndpointsNested<A> addNewEndpointLike(io.kubernetes.client.openapi.models.V1Endpoint item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceFluentImpl.EndpointsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1EndpointSliceFluent.EndpointsNested<A> setNewEndpointLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Endpoint item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceFluentImpl.EndpointsNestedImpl(index, item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSliceFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public A addToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder>();}
    io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder(item);_visitables.get("ports").add(index >= 0 ? index : _visitables.get("ports").size(), builder);this.ports.add(index >= 0 ? index : ports.size(), builder); return (A)this;
  }
  public A setToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder>();}
    io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder(item);
  ...
  public A addToPorts(io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort... items) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder>();}
    for (io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item : items) {io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder(item);_visitables.get("ports").add(builder);this.ports.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromPorts(java.util.function.Predicate<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder> each = ports.iterator();
  ...
  public io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort buildMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder item: ports) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder item: ports) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withPorts(java.util.List<io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort> ports) {
    ...
    if (ports != null) {this.ports = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item : ports){this.addToPorts(item);}} else { this.ports = null;} return (A) this;
  }
  public A withPorts(io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort... ports) {
    if (this.ports != null) {this.ports.clear();}
    if (ports != null) {for (io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item :ports){ this.addToPorts(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSliceFluent.PortsNested<A> addNewPortLike(io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceFluentImpl.PortsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1EndpointSliceFluent.PortsNested<A> setNewPortLike(java.lang.Integer index,io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSliceFluentImpl.PortsNestedImpl(index, item);
  }
  ...
  public class EndpointsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EndpointFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSliceFluent.EndpointsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSliceFluent.EndpointsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    EndpointsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Endpoint item) {
      this.index = index;
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSliceFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSliceFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class PortsNestedImpl<N> extends io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSliceFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSliceFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    PortsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.DiscoveryV1EndpointPortBuilder(this, item);
    }
    PortsNestedImpl() {
      this.index = -1;
