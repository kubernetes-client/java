...
public class V1beta1ValidatingAdmissionPolicyStatusFluent<A extends V1beta1ValidatingAdmissionPolicyStatusFluent<A>> extends BaseFluent<A>{
  public V1beta1ValidatingAdmissionPolicyStatusFluent() {
  }
  
  public V1beta1ValidatingAdmissionPolicyStatusFluent(V1beta1ValidatingAdmissionPolicyStatus instance) {
    this.copyInstance(instance);
  }
  private ArrayList<V1ConditionBuilder> conditions;
  private Long observedGeneration;
  private V1beta1TypeCheckingBuilder typeChecking;
  
  protected void copyInstance(V1beta1ValidatingAdmissionPolicyStatus instance) {
    instance = (instance != null ? instance : new V1beta1ValidatingAdmissionPolicyStatus());
    if (instance != null) {
  ...
  public V1beta1TypeChecking buildTypeChecking() {
    return this.typeChecking != null ? this.typeChecking.build() : null;
  }
  
  public A withTypeChecking(V1beta1TypeChecking typeChecking) {
    this._visitables.remove("typeChecking");
    if (typeChecking != null) {
        this.typeChecking = new V1beta1TypeCheckingBuilder(typeChecking);
  ...
  public TypeCheckingNested<A> withNewTypeCheckingLike(V1beta1TypeChecking item) {
  ...
  public TypeCheckingNested<A> editOrNewTypeChecking() {
    return withNewTypeCheckingLike(java.util.Optional.ofNullable(buildTypeChecking()).orElse(new V1beta1TypeCheckingBuilder().build()));
  }
  
  public TypeCheckingNested<A> editOrNewTypeCheckingLike(V1beta1TypeChecking item) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1ValidatingAdmissionPolicyStatusFluent that = (V1beta1ValidatingAdmissionPolicyStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta1ValidatingAdmissionPolicyStatusFluent.this.setToConditions(index,builder.build());
    }
  ...
  public class TypeCheckingNested<N> extends V1beta1TypeCheckingFluent<TypeCheckingNested<N>> implements Nested<N>{
    TypeCheckingNested(V1beta1TypeChecking item) {
      this.builder = new V1beta1TypeCheckingBuilder(this, item);
    }
    V1beta1TypeCheckingBuilder builder;
    
    public N and() {
      return (N) V1beta1ValidatingAdmissionPolicyStatusFluent.this.withTypeChecking(builder.build());
    }
