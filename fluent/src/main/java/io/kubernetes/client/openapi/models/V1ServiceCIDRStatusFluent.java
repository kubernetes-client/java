...
public class V1ServiceCIDRStatusFluent<A extends io.kubernetes.client.openapi.models.V1ServiceCIDRStatusFluent<A>> extends BaseFluent<A>{
  ...
  public V1ServiceCIDRStatusFluent(V1ServiceCIDRStatus instance) {
  ...
  protected void copyInstance(V1ServiceCIDRStatus instance) {
    instance = instance != null ? instance : new V1ServiceCIDRStatus();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1ServiceCIDRStatusFluent that = (V1ServiceCIDRStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ServiceCIDRStatusFluent.this.setToConditions(index, builder.build());
    }
