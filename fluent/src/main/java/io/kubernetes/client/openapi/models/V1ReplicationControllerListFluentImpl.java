...
import java.lang.Object;
  ...
  * Generated
  */
public class V1ReplicationControllerListFluentImpl<A extends io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent<A>{
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder> items;
  ...
  public A addToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicationController item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder>();}
    io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicationController item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder>();}
    io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1ReplicationController... items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1ReplicationController item : items) {io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder> each = items.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1ReplicationController buildItem(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1ReplicationController buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1ReplicationController> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1ReplicationController item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1ReplicationController... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (io.kubernetes.client.openapi.models.V1ReplicationController item :items){ this.addToItems(item);}} return (A) this;
  }
  public java.lang.Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1ReplicationControllerListFluentImpl.ItemsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1ReplicationController item) {
    return new io.kubernetes.client.openapi.models.V1ReplicationControllerListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicationController item) {
    return new io.kubernetes.client.openapi.models.V1ReplicationControllerListFluentImpl.ItemsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.ItemsNested<A> editItem(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1ReplicationControllerListFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
    return new io.kubernetes.client.openapi.models.V1ReplicationControllerListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ReplicationControllerFluentImpl<io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicationController item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder(this, item);
    }
    ItemsNestedImpl() {
      this.index = -1;
