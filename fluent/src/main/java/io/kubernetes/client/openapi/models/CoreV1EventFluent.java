...
public interface CoreV1EventFluent<A extends CoreV1EventFluent<A>> extends Fluent<A> {
  ...
  public interface MetadataNested<N>
      extends Nested<N>, V1ObjectMetaFluent<CoreV1EventFluent.MetadataNested<N>> {
    public N and();
  ...
  public interface RelatedNested<N>
      extends Nested<N>, V1ObjectReferenceFluent<CoreV1EventFluent.RelatedNested<N>> {
    public N and();
  ...
  public interface SeriesNested<N>
      extends Nested<N>, CoreV1EventSeriesFluent<CoreV1EventFluent.SeriesNested<N>> {
    public N and();
  ...
  public interface SourceNested<N>
      extends Nested<N>, V1EventSourceFluent<CoreV1EventFluent.SourceNested<N>> {
    public N and();
