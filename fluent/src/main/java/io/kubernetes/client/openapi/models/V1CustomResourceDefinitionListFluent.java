...
public class V1CustomResourceDefinitionListFluent<A extends io.kubernetes.client.openapi.models.V1CustomResourceDefinitionListFluent<A>> extends BaseFluent<A>{
  ...
  public V1CustomResourceDefinitionListFluent() {
  }
  
  public V1CustomResourceDefinitionListFluent(V1CustomResourceDefinitionList instance) {
  ...
  public A addAllToItems(Collection<V1CustomResourceDefinition> items) {
    ...
    for (V1CustomResourceDefinition item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1CustomResourceDefinition item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1CustomResourceDefinition... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1CustomResourceDefinition item : items) {
  ...
  public V1CustomResourceDefinition buildMatchingItem(Predicate<V1CustomResourceDefinitionBuilder> predicate) {
      for (V1CustomResourceDefinitionBuilder item : items) {
  ...
  protected void copyInstance(V1CustomResourceDefinitionList instance) {
    instance = instance != null ? instance : new V1CustomResourceDefinitionList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1CustomResourceDefinitionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1CustomResourceDefinitionListFluent that = (V1CustomResourceDefinitionListFluent) o;
  ...
  public A removeFromItems(V1CustomResourceDefinition... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1CustomResourceDefinition item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1CustomResourceDefinitionBuilder> predicate) {
    ...
    Iterator<V1CustomResourceDefinitionBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1CustomResourceDefinition item) {
  ...
  public A withItems(V1CustomResourceDefinition... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1CustomResourceDefinitionFluent<ItemsNested<N>> implements Nested<N>{
  
    V1CustomResourceDefinitionBuilder builder;
    int index;
  
    ItemsNested(int index,V1CustomResourceDefinition item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1CustomResourceDefinitionListFluent.this.withMetadata(builder.build());
    }
