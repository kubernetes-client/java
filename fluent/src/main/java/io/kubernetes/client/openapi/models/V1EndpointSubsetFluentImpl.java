...
public class V1EndpointSubsetFluentImpl<A extends io.kubernetes.client.openapi.models.V1EndpointSubsetFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1EndpointSubsetFluent<A>{
  ...
  public A setToAddresses(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointAddress item) {
    if (this.addresses == null) {this.addresses = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointAddressBuilder>();}
  ...
  public A withAddresses(java.util.List<io.kubernetes.client.openapi.models.V1EndpointAddress> addresses) {
    ...
    if (addresses != null) {this.addresses = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1EndpointAddress item : addresses){this.addToAddresses(item);}} else { this.addresses = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.AddressesNested<A> setNewAddressLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointAddress item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSubsetFluentImpl.AddressesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.AddressesNested<A> editAddress(java.lang.Integer index) {
  ...
  public A addToNotReadyAddresses(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointAddress item) {
  ...
  public A setToNotReadyAddresses(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointAddress item) {
    if (this.notReadyAddresses == null) {this.notReadyAddresses = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointAddressBuilder>();}
    io.kubernetes.client.openapi.models.V1EndpointAddressBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointAddressBuilder(item);
  ...
  public A withNotReadyAddresses(java.util.List<io.kubernetes.client.openapi.models.V1EndpointAddress> notReadyAddresses) {
    ...
    if (notReadyAddresses != null) {this.notReadyAddresses = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1EndpointAddress item : notReadyAddresses){this.addToNotReadyAddresses(item);}} else { this.notReadyAddresses = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.NotReadyAddressesNested<A> setNewNotReadyAddressLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointAddress item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSubsetFluentImpl.NotReadyAddressesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.NotReadyAddressesNested<A> editNotReadyAddress(java.lang.Integer index) {
  ...
  public A addToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.CoreV1EndpointPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder>();}
    io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder(item);_visitables.get("ports").add(index >= 0 ? index : _visitables.get("ports").size(), builder);this.ports.add(index >= 0 ? index : ports.size(), builder); return (A)this;
  }
  public A setToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.CoreV1EndpointPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder>();}
    io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder(item);
  ...
  public A addToPorts(io.kubernetes.client.openapi.models.CoreV1EndpointPort... items) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder>();}
    for (io.kubernetes.client.openapi.models.CoreV1EndpointPort item : items) {io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder(item);_visitables.get("ports").add(builder);this.ports.add(builder);} return (A)this;
  }
  public A addAllToPorts(java.util.Collection<io.kubernetes.client.openapi.models.CoreV1EndpointPort> items) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder>();}
    for (io.kubernetes.client.openapi.models.CoreV1EndpointPort item : items) {io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder(item);_visitables.get("ports").add(builder);this.ports.add(builder);} return (A)this;
  }
  public A removeFromPorts(io.kubernetes.client.openapi.models.CoreV1EndpointPort... items) {
    for (io.kubernetes.client.openapi.models.CoreV1EndpointPort item : items) {io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder(item);_visitables.get("ports").remove(builder);if (this.ports != null) {this.ports.remove(builder);}} return (A)this;
  }
  public A removeAllFromPorts(java.util.Collection<io.kubernetes.client.openapi.models.CoreV1EndpointPort> items) {
    for (io.kubernetes.client.openapi.models.CoreV1EndpointPort item : items) {io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder builder = new io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder(item);_visitables.get("ports").remove(builder);if (this.ports != null) {this.ports.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromPorts(java.util.function.Predicate<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder> predicate) {
    if (ports == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder> each = ports.iterator();
  ...
  public io.kubernetes.client.openapi.models.CoreV1EndpointPort buildMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder item: ports) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder item: ports) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withPorts(java.util.List<io.kubernetes.client.openapi.models.CoreV1EndpointPort> ports) {
    ...
    if (ports != null) {this.ports = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.CoreV1EndpointPort item : ports){this.addToPorts(item);}} else { this.ports = null;} return (A) this;
  }
  public A withPorts(io.kubernetes.client.openapi.models.CoreV1EndpointPort... ports) {
    if (this.ports != null) {this.ports.clear();}
    if (ports != null) {for (io.kubernetes.client.openapi.models.CoreV1EndpointPort item :ports){ this.addToPorts(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<A> addNewPortLike(io.kubernetes.client.openapi.models.CoreV1EndpointPort item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSubsetFluentImpl.PortsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<A> setNewPortLike(java.lang.Integer index,io.kubernetes.client.openapi.models.CoreV1EndpointPort item) {
    return new io.kubernetes.client.openapi.models.V1EndpointSubsetFluentImpl.PortsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<A> editPort(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<A> editMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.CoreV1EndpointPortBuilder> predicate) {
    int index = -1;
  ...
  public class AddressesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EndpointAddressFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.AddressesNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.AddressesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    AddressesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointAddress item) {
      this.index = index;
  ...
  public class NotReadyAddressesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1EndpointAddressFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.NotReadyAddressesNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.NotReadyAddressesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    NotReadyAddressesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EndpointAddress item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1EndpointAddressBuilder(this, item);
    }
  ...
  public class PortsNestedImpl<N> extends io.kubernetes.client.openapi.models.CoreV1EndpointPortFluentImpl<io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    PortsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.CoreV1EndpointPort item) {
      this.index = index;
