...
public class V1CSIDriverSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent<A> {
    ...
    public A withTokenRequests(java.util.List<io.kubernetes.client.openapi.models.StorageV1TokenRequest> tokenRequests) {
        ...
        if (tokenRequests != null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder>(); for (io.kubernetes.client.openapi.models.StorageV1TokenRequest item : tokenRequests){this.addToTokenRequests(item);}} else { this.tokenRequests = null;} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> setNewTokenRequestLike(int index,io.kubernetes.client.openapi.models.StorageV1TokenRequest item) {
        return new io.kubernetes.client.openapi.models.V1CSIDriverSpecFluentImpl.TokenRequestsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> editTokenRequest(int index) {
    ...
    public A withVolumeLifecycleModes(java.util.List<java.lang.String> volumeLifecycleModes) {
        ...
        if (volumeLifecycleModes != null) {this.volumeLifecycleModes = new java.util.ArrayList<java.lang.String>(); for (java.lang.String item : volumeLifecycleModes){this.addToVolumeLifecycleModes(item);}} else { this.volumeLifecycleModes = null;} return (A) this;
    }
    ...
    public class TokenRequestsNestedImpl<N> extends io.kubernetes.client.openapi.models.StorageV1TokenRequestFluentImpl<io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<N>> implements io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder builder;
        private final int index;

            TokenRequestsNestedImpl(int index,io.kubernetes.client.openapi.models.StorageV1TokenRequest item) {
                this.index = index;
