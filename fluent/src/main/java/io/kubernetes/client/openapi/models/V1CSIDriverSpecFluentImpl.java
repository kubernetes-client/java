...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1CSIDriverSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent<A>{
  ...
  public A addToTokenRequests(java.lang.Integer index,io.kubernetes.client.openapi.models.StorageV1TokenRequest item) {
    if (this.tokenRequests == null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder>();}
    io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder(item);_visitables.get("tokenRequests").add(index >= 0 ? index : _visitables.get("tokenRequests").size(), builder);this.tokenRequests.add(index >= 0 ? index : tokenRequests.size(), builder); return (A)this;
  }
  public A setToTokenRequests(java.lang.Integer index,io.kubernetes.client.openapi.models.StorageV1TokenRequest item) {
    if (this.tokenRequests == null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder>();}
    io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder(item);
  ...
  public A addToTokenRequests(io.kubernetes.client.openapi.models.StorageV1TokenRequest... items) {
    if (this.tokenRequests == null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder>();}
    for (io.kubernetes.client.openapi.models.StorageV1TokenRequest item : items) {io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder(item);_visitables.get("tokenRequests").add(builder);this.tokenRequests.add(builder);} return (A)this;
  }
  public A addAllToTokenRequests(java.util.Collection<io.kubernetes.client.openapi.models.StorageV1TokenRequest> items) {
    if (this.tokenRequests == null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder>();}
    for (io.kubernetes.client.openapi.models.StorageV1TokenRequest item : items) {io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder(item);_visitables.get("tokenRequests").add(builder);this.tokenRequests.add(builder);} return (A)this;
  }
  public A removeFromTokenRequests(io.kubernetes.client.openapi.models.StorageV1TokenRequest... items) {
    for (io.kubernetes.client.openapi.models.StorageV1TokenRequest item : items) {io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder(item);_visitables.get("tokenRequests").remove(builder);if (this.tokenRequests != null) {this.tokenRequests.remove(builder);}} return (A)this;
  }
  public A removeAllFromTokenRequests(java.util.Collection<io.kubernetes.client.openapi.models.StorageV1TokenRequest> items) {
    for (io.kubernetes.client.openapi.models.StorageV1TokenRequest item : items) {io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder(item);_visitables.get("tokenRequests").remove(builder);if (this.tokenRequests != null) {this.tokenRequests.remove(builder);}} return (A)this;
  }
  public A removeMatchingFromTokenRequests(java.util.function.Predicate<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder> predicate) {
    if (tokenRequests == null) return (A) this;
    final Iterator<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder> each = tokenRequests.iterator();
  ...
  public io.kubernetes.client.openapi.models.StorageV1TokenRequest buildMatchingTokenRequest(java.util.function.Predicate<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder item: tokenRequests) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingTokenRequest(java.util.function.Predicate<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder item: tokenRequests) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withTokenRequests(java.util.List<io.kubernetes.client.openapi.models.StorageV1TokenRequest> tokenRequests) {
    if (this.tokenRequests != null) { _visitables.get("tokenRequests").removeAll(this.tokenRequests);}
    if (tokenRequests != null) {this.tokenRequests = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.StorageV1TokenRequest item : tokenRequests){this.addToTokenRequests(item);}} else { this.tokenRequests = null;} return (A) this;
  }
  public A withTokenRequests(io.kubernetes.client.openapi.models.StorageV1TokenRequest... tokenRequests) {
    ...
    if (tokenRequests != null) {for (io.kubernetes.client.openapi.models.StorageV1TokenRequest item :tokenRequests){ this.addToTokenRequests(item);}} return (A) this;
  }
  public java.lang.Boolean hasTokenRequests() {
    return tokenRequests != null && !tokenRequests.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> addNewTokenRequest() {
    return new io.kubernetes.client.openapi.models.V1CSIDriverSpecFluentImpl.TokenRequestsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> addNewTokenRequestLike(io.kubernetes.client.openapi.models.StorageV1TokenRequest item) {
    return new io.kubernetes.client.openapi.models.V1CSIDriverSpecFluentImpl.TokenRequestsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> setNewTokenRequestLike(java.lang.Integer index,io.kubernetes.client.openapi.models.StorageV1TokenRequest item) {
    return new io.kubernetes.client.openapi.models.V1CSIDriverSpecFluentImpl.TokenRequestsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> editTokenRequest(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> editFirstTokenRequest() {
  ...
  public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> editLastTokenRequest() {
    int index = tokenRequests.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last tokenRequests. The list is empty.");
    return setNewTokenRequestLike(index, buildTokenRequest(index));
  }
  public io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<A> editMatchingTokenRequest(java.util.function.Predicate<io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder> predicate) {
    int index = -1;
  ...
  public A addToVolumeLifecycleModes(java.lang.Integer index,java.lang.String item) {
    if (this.volumeLifecycleModes == null) {this.volumeLifecycleModes = new java.util.ArrayList<java.lang.String>();}
  ...
  public A addToVolumeLifecycleModes(java.lang.String... items) {
    if (this.volumeLifecycleModes == null) {this.volumeLifecycleModes = new java.util.ArrayList<java.lang.String>();}
    for (java.lang.String item : items) {this.volumeLifecycleModes.add(item);} return (A)this;
  }
  ...
  public A removeFromVolumeLifecycleModes(java.lang.String... items) {
    for (java.lang.String item : items) {if (this.volumeLifecycleModes!= null){ this.volumeLifecycleModes.remove(item);}} return (A)this;
  }
  ...
  public java.lang.String getMatchingVolumeLifecycleMode(java.util.function.Predicate<java.lang.String> predicate) {
    for (java.lang.String item: volumeLifecycleModes) { if(predicate.test(item)){ return item;} } return null;
  }
  public java.lang.Boolean hasMatchingVolumeLifecycleMode(java.util.function.Predicate<java.lang.String> predicate) {
    for (java.lang.String item: volumeLifecycleModes) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withVolumeLifecycleModes(java.util.List<java.lang.String> volumeLifecycleModes) {
    if (volumeLifecycleModes != null) {this.volumeLifecycleModes = new java.util.ArrayList(); for (java.lang.String item : volumeLifecycleModes){this.addToVolumeLifecycleModes(item);}} else { this.volumeLifecycleModes = null;} return (A) this;
  }
  public A withVolumeLifecycleModes(java.lang.String... volumeLifecycleModes) {
    ...
    if (volumeLifecycleModes != null) {for (java.lang.String item :volumeLifecycleModes){ this.addToVolumeLifecycleModes(item);}} return (A) this;
  }
  ...
  public class TokenRequestsNestedImpl<N> extends io.kubernetes.client.openapi.models.StorageV1TokenRequestFluentImpl<io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<N>> implements io.kubernetes.client.openapi.models.V1CSIDriverSpecFluent.TokenRequestsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    TokenRequestsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.StorageV1TokenRequest item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.StorageV1TokenRequestBuilder(this, item);
    }
