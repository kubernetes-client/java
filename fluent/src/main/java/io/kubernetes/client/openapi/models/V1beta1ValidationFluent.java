...
public class V1beta1ValidationFluent<A extends V1beta1ValidationFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta1ValidationFluent(V1beta1Validation instance) {
  ...
  protected void copyInstance(V1beta1Validation instance) {
    instance = (instance != null ? instance : new V1beta1Validation());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta1ValidationFluent that = (V1beta1ValidationFluent) o;
