...
public class V1beta3PriorityLevelConfigurationConditionFluent<A extends V1beta3PriorityLevelConfigurationConditionFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta3PriorityLevelConfigurationConditionFluent(V1beta3PriorityLevelConfigurationCondition instance) {
  ...
  protected void copyInstance(V1beta3PriorityLevelConfigurationCondition instance) {
    instance = (instance != null ? instance : new V1beta3PriorityLevelConfigurationCondition());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta3PriorityLevelConfigurationConditionFluent that = (V1beta3PriorityLevelConfigurationConditionFluent) o;
