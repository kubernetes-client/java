...
public class V1ValidatingAdmissionPolicyBindingListFluent<A extends io.kubernetes.client.openapi.models.V1ValidatingAdmissionPolicyBindingListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1ValidatingAdmissionPolicyBinding... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1ValidatingAdmissionPolicyBinding item : items) {
  ...
  public A removeFromItems(V1ValidatingAdmissionPolicyBinding... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1ValidatingAdmissionPolicyBinding item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1ValidatingAdmissionPolicyBindingBuilder> predicate) {
    ...
    Iterator<V1ValidatingAdmissionPolicyBindingBuilder> each = items.iterator();
  ...
  public A withItems(V1ValidatingAdmissionPolicyBinding... items) {
    if (this.items != null) {
        this.items.clear();
