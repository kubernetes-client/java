...
import java.lang.Object;
  ...
  * Generated
  */
public class V1ControllerRevisionListFluentImpl<A extends io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent<A>{
  public V1ControllerRevisionListFluentImpl() {
  }
  public V1ControllerRevisionListFluentImpl(io.kubernetes.client.openapi.models.V1ControllerRevisionList instance) {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder> items;
  ...
  public A addToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ControllerRevision item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder>();}
    io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder builder = new io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ControllerRevision item) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder>();}
    io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder builder = new io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1ControllerRevision... items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1ControllerRevision item : items) {io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder builder = new io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ControllerRevision... items) {
    for (io.kubernetes.client.openapi.models.V1ControllerRevision item : items) {io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder builder = new io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder> each = items.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1ControllerRevision buildItem(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1ControllerRevision buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1ControllerRevision> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1ControllerRevision item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1ControllerRevision... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (io.kubernetes.client.openapi.models.V1ControllerRevision item :items){ this.addToItems(item);}} return (A) this;
  }
  public java.lang.Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.ItemsNested<A> addNewItem() {
    return new io.kubernetes.client.openapi.models.V1ControllerRevisionListFluentImpl.ItemsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1ControllerRevision item) {
    return new io.kubernetes.client.openapi.models.V1ControllerRevisionListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ControllerRevision item) {
    return new io.kubernetes.client.openapi.models.V1ControllerRevisionListFluentImpl.ItemsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.ItemsNested<A> editItem(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1ControllerRevisionListFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
    return new io.kubernetes.client.openapi.models.V1ControllerRevisionListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ControllerRevisionFluentImpl<io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ControllerRevision item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder(this, item);
    }
    ItemsNestedImpl() {
      this.index = -1;
