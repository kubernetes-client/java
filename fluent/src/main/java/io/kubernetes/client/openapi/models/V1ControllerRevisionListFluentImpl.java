...
import java.lang.Object;
  ...
  */
  ...
  public class V1ControllerRevisionListFluentImpl<A extends V1ControllerRevisionListFluent<A>> extends BaseFluent<A> implements V1ControllerRevisionListFluent<A>{
  public V1ControllerRevisionListFluentImpl() {
  }
  public V1ControllerRevisionListFluentImpl(V1ControllerRevisionList instance) {
    if (instance != null) {
  ...
  public A addToItems(int index,V1ControllerRevision item) {
    if (this.items == null) {this.items = new ArrayList<V1ControllerRevisionBuilder>();}
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1ControllerRevision... items) {
    if (this.items == null) {this.items = new ArrayList<V1ControllerRevisionBuilder>();}
    for (V1ControllerRevision item : items) {V1ControllerRevisionBuilder builder = new V1ControllerRevisionBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ControllerRevision... items) {
    for (V1ControllerRevision item : items) {V1ControllerRevisionBuilder builder = new V1ControllerRevisionBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public V1ControllerRevision buildMatchingItem(Predicate<V1ControllerRevisionBuilder> predicate) {
    for (V1ControllerRevisionBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V1ControllerRevisionBuilder> predicate) {
    for (V1ControllerRevisionBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V1ControllerRevision> items) {
    if (this.items != null) { _visitables.get("items").clear();}
    if (items != null) {this.items = new ArrayList(); for (V1ControllerRevision item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1ControllerRevision... items) {
    ...
    if (items != null) {for (V1ControllerRevision item :items){ this.addToItems(item);}} return (A) this;
  }
  public Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public V1ControllerRevisionListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1ControllerRevisionListFluentImpl.ItemsNestedImpl();
  }
  public V1ControllerRevisionListFluentImpl.ItemsNested<A> addNewItemLike(V1ControllerRevision item) {
    return new V1ControllerRevisionListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1ControllerRevisionListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1ControllerRevision item) {
    return new V1ControllerRevisionListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1ControllerRevisionListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ControllerRevisionListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1ControllerRevisionListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ControllerRevisionListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1ControllerRevisionBuilder> predicate) {
    int index = -1;
  ...
  public V1ControllerRevisionListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1ControllerRevisionListFluentImpl.MetadataNestedImpl();
  }
  public V1ControllerRevisionListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1ControllerRevisionListFluentImpl.MetadataNestedImpl(item);
  }
  public V1ControllerRevisionListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1ControllerRevisionListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1ControllerRevisionListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1ControllerRevisionFluentImpl<V1ControllerRevisionListFluentImpl.ItemsNested<N>> implements V1ControllerRevisionListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1ControllerRevision item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ControllerRevisionListFluentImpl.MetadataNested<N>> implements V1ControllerRevisionListFluentImpl.MetadataNested<N>,Nested<N>{
