...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1ControllerRevision item) {
    ...
    V1ControllerRevisionBuilder builder = new V1ControllerRevisionBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1ControllerRevisionFluentImpl<V1ControllerRevisionListFluent.ItemsNested<N>> implements V1ControllerRevisionListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ControllerRevisionListFluent.MetadataNested<N>> implements V1ControllerRevisionListFluent.MetadataNested<N>,Nested<N>{
