...
public class V1ControllerRevisionListFluent<A extends io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1ControllerRevision... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1ControllerRevision... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1ControllerRevision item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1ControllerRevisionBuilder> predicate) {
    ...
    Iterator<V1ControllerRevisionBuilder> each = items.iterator();
  ...
  public A withItems(V1ControllerRevision... items) {
    if (this.items != null) {
        this.items.clear();
