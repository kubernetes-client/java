...
public class V1ControllerRevisionListFluent<A extends V1ControllerRevisionListFluent<A>> extends BaseFluent<A>{
  public V1ControllerRevisionListFluent() {
  }
  
  public V1ControllerRevisionListFluent(V1ControllerRevisionList instance) {
  ...
  protected void copyInstance(V1ControllerRevisionList instance) {
    instance = (instance != null ? instance : new V1ControllerRevisionList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ControllerRevision... items) {
    ...
    for (V1ControllerRevision item : items) {V1ControllerRevisionBuilder builder = new V1ControllerRevisionBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public ItemsNested<A> addNewItemLike(V1ControllerRevision item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1ControllerRevision item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1ControllerRevisionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1ControllerRevisionListFluent that = (V1ControllerRevisionListFluent) o;
  ...
  public class ItemsNested<N> extends V1ControllerRevisionFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1ControllerRevision item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ControllerRevisionListFluent.this.withMetadata(builder.build());
    }
