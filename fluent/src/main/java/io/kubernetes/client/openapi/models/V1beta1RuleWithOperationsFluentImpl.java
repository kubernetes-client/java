...
public class V1beta1RuleWithOperationsFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1RuleWithOperationsFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1RuleWithOperationsFluent<A> {
    ...
    public V1beta1RuleWithOperationsFluentImpl(io.kubernetes.client.openapi.models.V1beta1RuleWithOperations instance) {
    ...
    public A withApiVersions(java.util.List<java.lang.String> apiVersions) {
        ...
        if (apiVersions != null) {this.apiVersions = new java.util.ArrayList<java.lang.String>(); for (java.lang.String item : apiVersions){this.addToApiVersions(item);}} else { this.apiVersions = null;} return (A) this;
    }
    ...
    public A addToOperations(java.lang.String... items) {
        if (this.operations == null) {this.operations = new java.util.ArrayList<java.lang.String>();}
        for (java.lang.String item : items) {this.operations.add(item);} return (A)this;
    }
    ...
    public A removeFromOperations(java.lang.String... items) {
        for (java.lang.String item : items) {if (this.operations!= null){ this.operations.remove(item);}} return (A)this;
    }
    ...
    public java.lang.String getMatchingOperation(java.util.function.Predicate<java.lang.String> predicate) {
        for (java.lang.String item: operations) { if(predicate.test(item)){ return item;} } return null;
    }

    public java.lang.Boolean hasMatchingOperation(java.util.function.Predicate<java.lang.String> predicate) {
        for (java.lang.String item: operations) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withOperations(java.util.List<java.lang.String> operations) {
        ...
        if (operations != null) {this.operations = new java.util.ArrayList<java.lang.String>(); for (java.lang.String item : operations){this.addToOperations(item);}} else { this.operations = null;} return (A) this;
    }

    public A withOperations(java.lang.String... operations) {
        if (this.operations != null) {this.operations.clear();}
        if (operations != null) {for (java.lang.String item :operations){ this.addToOperations(item);}} return (A) this;
    }
