...
public class V1APIServiceSpecBuilder extends io.kubernetes.client.openapi.models.V1APIServiceSpecFluentImpl<io.kubernetes.client.openapi.models.V1APIServiceSpecBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1APIServiceSpec,io.kubernetes.client.openapi.models.V1APIServiceSpecBuilder> {
    ...
    public V1APIServiceSpecBuilder(io.kubernetes.client.openapi.models.V1APIServiceSpecFluent<?> fluent) {
        this(fluent, true);
    }

    public V1APIServiceSpecBuilder(io.kubernetes.client.openapi.models.V1APIServiceSpecFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1APIServiceSpec(), validationEnabled);
    }

    public V1APIServiceSpecBuilder(io.kubernetes.client.openapi.models.V1APIServiceSpecFluent<?> fluent,io.kubernetes.client.openapi.models.V1APIServiceSpec instance) {
        this(fluent, instance, true);
    }

    public V1APIServiceSpecBuilder(io.kubernetes.client.openapi.models.V1APIServiceSpecFluent<?> fluent,io.kubernetes.client.openapi.models.V1APIServiceSpec instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1APIServiceSpecBuilder(io.kubernetes.client.openapi.models.V1APIServiceSpec instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
