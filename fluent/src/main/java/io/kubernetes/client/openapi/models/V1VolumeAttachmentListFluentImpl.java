...
import java.lang.Object;
  ...
  */
  ...
  public V1VolumeAttachmentListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1VolumeAttachmentListFluentImpl.ItemsNestedImpl();
  }
  public V1VolumeAttachmentListFluentImpl.ItemsNested<A> addNewItemLike(V1VolumeAttachment item) {
    return new V1VolumeAttachmentListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1VolumeAttachmentListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1VolumeAttachment item) {
    return new V1VolumeAttachmentListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1VolumeAttachmentListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1VolumeAttachmentListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1VolumeAttachmentListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1VolumeAttachmentListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1VolumeAttachmentBuilder> predicate) {
    int index = -1;
  ...
  public V1VolumeAttachmentListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1VolumeAttachmentListFluentImpl.MetadataNestedImpl();
  }
  public V1VolumeAttachmentListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1VolumeAttachmentListFluentImpl.MetadataNestedImpl(item);
  }
  public V1VolumeAttachmentListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1VolumeAttachmentListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1VolumeAttachmentListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1VolumeAttachmentFluentImpl<V1VolumeAttachmentListFluentImpl.ItemsNested<N>> implements V1VolumeAttachmentListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1VolumeAttachment item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1VolumeAttachmentListFluentImpl.MetadataNested<N>> implements V1VolumeAttachmentListFluentImpl.MetadataNested<N>,Nested<N>{
