...
public class V1alpha1AuditAnnotationFluent<A extends V1alpha1AuditAnnotationFluent<A>> extends BaseFluent<A>{
  public V1alpha1AuditAnnotationFluent() {
  }
  
  public V1alpha1AuditAnnotationFluent(V1alpha1AuditAnnotation instance) {
    this.copyInstance(instance);
  }
  private String key;
  private String valueExpression;
  
  protected void copyInstance(V1alpha1AuditAnnotation instance) {
    instance = (instance != null ? instance : new V1alpha1AuditAnnotation());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1AuditAnnotationFluent that = (V1alpha1AuditAnnotationFluent) o;
