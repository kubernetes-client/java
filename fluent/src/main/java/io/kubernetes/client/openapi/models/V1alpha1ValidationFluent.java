...
public class V1alpha1ValidationFluent<A extends V1alpha1ValidationFluent<A>> extends BaseFluent<A>{
  public V1alpha1ValidationFluent() {
  }
  
  public V1alpha1ValidationFluent(V1alpha1Validation instance) {
  ...
  protected void copyInstance(V1alpha1Validation instance) {
    instance = (instance != null ? instance : new V1alpha1Validation());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ValidationFluent that = (V1alpha1ValidationFluent) o;
