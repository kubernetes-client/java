...
public class V1beta1LeaseSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1LeaseSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1LeaseSpecFluent<A> {
    ...
    public V1beta1LeaseSpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1LeaseSpec instance) {
