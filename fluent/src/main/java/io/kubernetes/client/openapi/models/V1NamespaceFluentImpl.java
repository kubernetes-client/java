...
/** Generated */
public class V1NamespaceFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1NamespaceFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1NamespaceFluent<A> {
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1NamespaceSpec spec) {
    ...
    if (spec != null) {
      this.spec = new io.kubernetes.client.openapi.models.V1NamespaceSpecBuilder(spec);
  ...
  public io.kubernetes.client.openapi.models.V1NamespaceFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(
        getSpec() != null
            ? getSpec()
            : new io.kubernetes.client.openapi.models.V1NamespaceSpecBuilder().build());
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1NamespaceStatus status) {
    ...
    if (status != null) {
      this.status = new io.kubernetes.client.openapi.models.V1NamespaceStatusBuilder(status);
  ...
  public io.kubernetes.client.openapi.models.V1NamespaceFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(
        getStatus() != null
            ? getStatus()
            : new io.kubernetes.client.openapi.models.V1NamespaceStatusBuilder().build());
  }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1NamespaceFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1NamespaceFluent.MetadataNested<N>,
  ...
  public class SpecNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1NamespaceSpecFluentImpl<
          io.kubernetes.client.openapi.models.V1NamespaceFluent.SpecNested<N>>
      implements io.kubernetes.client.openapi.models.V1NamespaceFluent.SpecNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ...
    io.kubernetes.client.openapi.models.V1NamespaceSpecBuilder builder;
  ...
  public class StatusNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1NamespaceStatusFluentImpl<
          io.kubernetes.client.openapi.models.V1NamespaceFluent.StatusNested<N>>
      implements io.kubernetes.client.openapi.models.V1NamespaceFluent.StatusNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    ...
    io.kubernetes.client.openapi.models.V1NamespaceStatusBuilder builder;
