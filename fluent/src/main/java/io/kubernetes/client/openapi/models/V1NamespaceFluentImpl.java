...
import java.lang.Object;
  ...
  */
  ...
  public class V1NamespaceFluentImpl<A extends V1NamespaceFluent<A>> extends BaseFluent<A> implements V1NamespaceFluent<A>{
  ...
  public A withSpec(V1NamespaceSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1NamespaceSpecBuilder(spec); _visitables.get("spec").add(this.spec);} else { this.spec = null; _visitables.get("spec").remove(this.spec); } return (A) this;
  }
  ...
  public A withStatus(V1NamespaceStatus status) {
    ...
    if (status!=null){ this.status= new V1NamespaceStatusBuilder(status); _visitables.get("status").add(this.status);} else { this.status = null; _visitables.get("status").remove(this.status); } return (A) this;
  }
