...
public class V1NodeSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1NodeSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1NodeSpecFluent<A>{
  ...
  public A withTaints(java.util.List<io.kubernetes.client.openapi.models.V1Taint> taints) {
    ...
    if (taints != null) {this.taints = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Taint item : taints){this.addToTaints(item);}} else { this.taints = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1NodeSpecFluent.TaintsNested<A> setNewTaintLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Taint item) {
    return new io.kubernetes.client.openapi.models.V1NodeSpecFluentImpl.TaintsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1NodeSpecFluent.TaintsNested<A> editTaint(java.lang.Integer index) {
