...
public class V1NodeSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1NodeSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1NodeSpecFluent<A> {
    ...
    private java.util.List<io.kubernetes.client.openapi.models.V1TaintBuilder> taints;
    ...
    public A withConfigSource(io.kubernetes.client.openapi.models.V1NodeConfigSource configSource) {
        ...
        if (configSource!=null){ this.configSource= new io.kubernetes.client.openapi.models.V1NodeConfigSourceBuilder(configSource); _visitables.get("configSource").add(this.configSource);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1NodeSpecFluent.ConfigSourceNested<A> withNewConfigSourceLike(io.kubernetes.client.openapi.models.V1NodeConfigSource item) {
        return new io.kubernetes.client.openapi.models.V1NodeSpecFluentImpl.ConfigSourceNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1NodeSpecFluent.ConfigSourceNested<A> editOrNewConfigSource() {
        return withNewConfigSourceLike(getConfigSource() != null ? getConfigSource(): new io.kubernetes.client.openapi.models.V1NodeConfigSourceBuilder().build());
    }
    ...
    public A withPodCIDRs(java.util.List<java.lang.String> podCIDRs) {
        ...
        if (podCIDRs != null) {this.podCIDRs = new java.util.ArrayList<java.lang.String>(); for (java.lang.String item : podCIDRs){this.addToPodCIDRs(item);}} else { this.podCIDRs = null;} return (A) this;
    }
    ...
    public A addToTaints(int index,io.kubernetes.client.openapi.models.V1Taint item) {
        ...
        io.kubernetes.client.openapi.models.V1TaintBuilder builder = new io.kubernetes.client.openapi.models.V1TaintBuilder(item);_visitables.get("taints").add(index >= 0 ? index : _visitables.get("taints").size(), builder);this.taints.add(index >= 0 ? index : taints.size(), builder); return (A)this;
    }

    public A setToTaints(int index,io.kubernetes.client.openapi.models.V1Taint item) {
        if (this.taints == null) {this.taints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TaintBuilder>();}
        io.kubernetes.client.openapi.models.V1TaintBuilder builder = new io.kubernetes.client.openapi.models.V1TaintBuilder(item);
    ...
    public A addToTaints(io.kubernetes.client.openapi.models.V1Taint... items) {
        if (this.taints == null) {this.taints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TaintBuilder>();}
        for (io.kubernetes.client.openapi.models.V1Taint item : items) {io.kubernetes.client.openapi.models.V1TaintBuilder builder = new io.kubernetes.client.openapi.models.V1TaintBuilder(item);_visitables.get("taints").add(builder);this.taints.add(builder);} return (A)this;
    }
    ...
    public A removeFromTaints(io.kubernetes.client.openapi.models.V1Taint... items) {
        for (io.kubernetes.client.openapi.models.V1Taint item : items) {io.kubernetes.client.openapi.models.V1TaintBuilder builder = new io.kubernetes.client.openapi.models.V1TaintBuilder(item);_visitables.get("taints").remove(builder);if (this.taints != null) {this.taints.remove(builder);}} return (A)this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1Taint buildMatchingTaint(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TaintBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1TaintBuilder item: taints) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingTaint(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1TaintBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1TaintBuilder item: taints) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withTaints(java.util.List<io.kubernetes.client.openapi.models.V1Taint> taints) {
        ...
        if (taints != null) {this.taints = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TaintBuilder>(); for (io.kubernetes.client.openapi.models.V1Taint item : taints){this.addToTaints(item);}} else { this.taints = null;} return (A) this;
    }

    public A withTaints(io.kubernetes.client.openapi.models.V1Taint... taints) {
        if (this.taints != null) {this.taints.clear();}
        if (taints != null) {for (io.kubernetes.client.openapi.models.V1Taint item :taints){ this.addToTaints(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1NodeSpecFluent.TaintsNested<A> setNewTaintLike(int index,io.kubernetes.client.openapi.models.V1Taint item) {
        return new io.kubernetes.client.openapi.models.V1NodeSpecFluentImpl.TaintsNestedImpl(index, item);
    }
    ...
    public class TaintsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TaintFluentImpl<io.kubernetes.client.openapi.models.V1NodeSpecFluent.TaintsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSpecFluent.TaintsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1TaintBuilder builder;
        private final int index;

            TaintsNestedImpl(int index,io.kubernetes.client.openapi.models.V1Taint item) {
                this.index = index;
