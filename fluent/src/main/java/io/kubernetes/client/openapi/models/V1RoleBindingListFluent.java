...
public class V1RoleBindingListFluent<A extends io.kubernetes.client.openapi.models.V1RoleBindingListFluent<A>> extends BaseFluent<A>{
  public V1RoleBindingListFluent() {
  }
  
  public V1RoleBindingListFluent(V1RoleBindingList instance) {
  ...
  protected void copyInstance(V1RoleBindingList instance) {
    instance = instance != null ? instance : new V1RoleBindingList();
    if (instance != null) {
  ...
  public A addToItems(V1RoleBinding... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1RoleBinding item : items) {
        V1RoleBindingBuilder builder = new V1RoleBindingBuilder(item);
        _visitables.get("items").add(builder);
  ...
  public A removeFromItems(V1RoleBinding... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1RoleBinding item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1RoleBindingBuilder> predicate) {
    ...
    Iterator<V1RoleBindingBuilder> each = items.iterator();
  ...
  public V1RoleBinding buildMatchingItem(Predicate<V1RoleBindingBuilder> predicate) {
      for (V1RoleBindingBuilder item : items) {
  ...
  public A withItems(V1RoleBinding... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public ItemsNested<A> addNewItemLike(V1RoleBinding item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1RoleBinding item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1RoleBindingBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1RoleBindingListFluent that = (V1RoleBindingListFluent) o;
  ...
  public class ItemsNested<N> extends V1RoleBindingFluent<ItemsNested<N>> implements Nested<N>{
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1RoleBindingListFluent.this.withMetadata(builder.build());
    }
