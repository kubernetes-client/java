...
public class V1NodeListFluent<A extends io.kubernetes.client.openapi.models.V1NodeListFluent<A>> extends BaseFluent<A>{
  ...
  public V1NodeListFluent() {
  }
  
  public V1NodeListFluent(V1NodeList instance) {
  ...
  public ItemsNested<A> addNewItemLike(V1Node item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1Node... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1Node item : items) {
  ...
  protected void copyInstance(V1NodeList instance) {
    instance = instance != null ? instance : new V1NodeList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1NodeBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1NodeListFluent that = (V1NodeListFluent) o;
  ...
  public A removeFromItems(V1Node... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1Node item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1NodeBuilder> predicate) {
    ...
    Iterator<V1NodeBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1Node item) {
  ...
  public A withItems(V1Node... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1NodeFluent<ItemsNested<N>> implements Nested<N>{
  
    V1NodeBuilder builder;
    int index;
  
    ItemsNested(int index,V1Node item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1NodeListFluent.this.withMetadata(builder.build());
    }
