...
public class V1beta1SelfSubjectAccessReviewFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpecBuilder spec;
    private io.kubernetes.client.openapi.models.V1beta1SubjectAccessReviewStatusBuilder status;

    public V1beta1SelfSubjectAccessReviewFluentImpl() {
    }

    public V1beta1SelfSubjectAccessReviewFluentImpl(io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReview instance) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpec item) {
        return new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpecBuilder().build());
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1beta1SubjectAccessReviewStatus item) {
        return new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluentImpl.StatusNestedImpl(item);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1SelfSubjectAccessReviewFluentImpl that = (V1beta1SelfSubjectAccessReviewFluentImpl) o;
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ObjectMetaBuilder builder;
            ...
            public N and() {
                return (N) V1beta1SelfSubjectAccessReviewFluentImpl.this.withMetadata(builder.build());
            }
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpecFluentImpl<io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpecBuilder builder;

            SpecNestedImpl(io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpecBuilder(this, item);
                        
            }

            SpecNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewSpecBuilder(this);
                        
            }

            public N and() {
                return (N) V1beta1SelfSubjectAccessReviewFluentImpl.this.withSpec(builder.build());
            }
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1SubjectAccessReviewStatusFluentImpl<io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SelfSubjectAccessReviewFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1SubjectAccessReviewStatusBuilder builder;
            ...
            public N and() {
                return (N) V1beta1SelfSubjectAccessReviewFluentImpl.this.withStatus(builder.build());
            }
