...
public class V2ContainerResourceMetricSourceBuilder
    ...
    implements VisitableBuilder<
        V2ContainerResourceMetricSource, V2ContainerResourceMetricSourceBuilder> {
  ...
  public V2ContainerResourceMetricSourceBuilder(
      V2ContainerResourceMetricSourceFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V2ContainerResourceMetricSource(), validationEnabled);
  }

  public V2ContainerResourceMetricSourceBuilder(
      V2ContainerResourceMetricSourceFluent<?> fluent, V2ContainerResourceMetricSource instance) {
  ...
  public V2ContainerResourceMetricSourceBuilder(
      V2ContainerResourceMetricSource instance, Boolean validationEnabled) {
    this.fluent = this;
