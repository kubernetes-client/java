...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1PodDisruptionBudgetFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent<A>{
  public V1PodDisruptionBudgetFluentImpl() {
  }
  public V1PodDisruptionBudgetFluentImpl(io.kubernetes.client.openapi.models.V1PodDisruptionBudget instance) {
  ...
  private io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpecBuilder spec;
  private io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusBuilder status;
  ...
  public io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpec spec) {
    ...
    if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpec item) {
    return new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluentImpl.SpecNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpecBuilder().build());
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatus status) {
    ...
    if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatus item) {
    return new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluentImpl.StatusNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusBuilder().build());
  }
  ...
  public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpecFluentImpl<io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
    SpecNestedImpl(io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpec item) {
      this.builder = new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetSpecBuilder(this, item);
    }
    SpecNestedImpl() {
  ...
  public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusFluentImpl<io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
    StatusNestedImpl(io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatus item) {
      this.builder = new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusBuilder(this, item);
    }
    StatusNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatusBuilder(this);
    }
