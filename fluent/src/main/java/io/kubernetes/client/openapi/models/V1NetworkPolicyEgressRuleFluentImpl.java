...
public class V1NetworkPolicyEgressRuleFluentImpl<A extends V1NetworkPolicyEgressRuleFluent<A>>
  ...
  public V1NetworkPolicyEgressRuleFluent.PortsNested<A> setNewPortLike(
  ...
  public V1NetworkPolicyEgressRuleFluent.PortsNested<A> editMatchingPort(
  ...
  public A addToTo(Integer index, V1NetworkPolicyPeer item) {
    if (this.to == null) {
      this.to = new ArrayList<V1NetworkPolicyPeerBuilder>();
    }
  ...
  public V1NetworkPolicyEgressRuleFluent.ToNested<A> setNewToLike(
  ...
  public V1NetworkPolicyEgressRuleFluent.ToNested<A> editMatchingTo(
  ...
  class PortsNestedImpl<N>
      ...
      implements V1NetworkPolicyEgressRuleFluent.PortsNested<N>, Nested<N> {
  ...
  class ToNestedImpl<N>
      ...
      implements V1NetworkPolicyEgressRuleFluent.ToNested<N>, Nested<N> {
