...
import java.lang.Object;
  ...
  * Generated
  */
public class V1NetworkPolicyEgressRuleFluentImpl<A extends io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent<A>{
  ...
  public A withPorts(java.util.List<io.kubernetes.client.openapi.models.V1NetworkPolicyPort> ports) {
    ...
    if (ports != null) {this.ports = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1NetworkPolicyPort item : ports){this.addToPorts(item);}} else { this.ports = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.PortsNested<A> addNewPort() {
    return new io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluentImpl.PortsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.PortsNested<A> addNewPortLike(io.kubernetes.client.openapi.models.V1NetworkPolicyPort item) {
    return new io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluentImpl.PortsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.PortsNested<A> setNewPortLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NetworkPolicyPort item) {
    return new io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluentImpl.PortsNestedImpl(index, item);
  }
  ...
  public A addToTo(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NetworkPolicyPeer item) {
    if (this.to == null) {this.to = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder>();}
    io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder builder = new io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder(item);_visitables.get("to").add(index >= 0 ? index : _visitables.get("to").size(), builder);this.to.add(index >= 0 ? index : to.size(), builder); return (A)this;
  }
  ...
  public A addToTo(io.kubernetes.client.openapi.models.V1NetworkPolicyPeer... items) {
    if (this.to == null) {this.to = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1NetworkPolicyPeer item : items) {io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder builder = new io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder(item);_visitables.get("to").add(builder);this.to.add(builder);} return (A)this;
  }
  ...
  public A removeFromTo(io.kubernetes.client.openapi.models.V1NetworkPolicyPeer... items) {
    for (io.kubernetes.client.openapi.models.V1NetworkPolicyPeer item : items) {io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder builder = new io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder(item);_visitables.get("to").remove(builder);if (this.to != null) {this.to.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromTo(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder> each = to.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1NetworkPolicyPeer buildMatchingTo(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder item: to) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingTo(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder item: to) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withTo(java.util.List<io.kubernetes.client.openapi.models.V1NetworkPolicyPeer> to) {
    ...
    if (to != null) {this.to = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1NetworkPolicyPeer item : to){this.addToTo(item);}} else { this.to = null;} return (A) this;
  }
  public A withTo(io.kubernetes.client.openapi.models.V1NetworkPolicyPeer... to) {
    if (this.to != null) {this.to.clear();}
    if (to != null) {for (io.kubernetes.client.openapi.models.V1NetworkPolicyPeer item :to){ this.addToTo(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.ToNested<A> addNewToLike(io.kubernetes.client.openapi.models.V1NetworkPolicyPeer item) {
    return new io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluentImpl.ToNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.ToNested<A> setNewToLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NetworkPolicyPeer item) {
    return new io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluentImpl.ToNestedImpl(index, item);
  }
  ...
  public class PortsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1NetworkPolicyPortFluentImpl<io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    PortsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NetworkPolicyPort item) {
      this.index = index;
