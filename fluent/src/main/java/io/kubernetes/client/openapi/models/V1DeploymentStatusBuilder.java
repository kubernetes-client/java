...
public class V1DeploymentStatusBuilder extends io.kubernetes.client.openapi.models.V1DeploymentStatusFluentImpl<io.kubernetes.client.openapi.models.V1DeploymentStatusBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1DeploymentStatus,io.kubernetes.client.openapi.models.V1DeploymentStatusBuilder> {
    ...
    public V1DeploymentStatusBuilder(io.kubernetes.client.openapi.models.V1DeploymentStatusFluent<?> fluent) {
        this(fluent, true);
    }

    public V1DeploymentStatusBuilder(io.kubernetes.client.openapi.models.V1DeploymentStatusFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1DeploymentStatus(), validationEnabled);
    }

    public V1DeploymentStatusBuilder(io.kubernetes.client.openapi.models.V1DeploymentStatusFluent<?> fluent,io.kubernetes.client.openapi.models.V1DeploymentStatus instance) {
        this(fluent, instance, true);
    }

    public V1DeploymentStatusBuilder(io.kubernetes.client.openapi.models.V1DeploymentStatusFluent<?> fluent,io.kubernetes.client.openapi.models.V1DeploymentStatus instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1DeploymentStatusBuilder(io.kubernetes.client.openapi.models.V1DeploymentStatus instance) {
        this(instance,true);
    }

    public V1DeploymentStatusBuilder(io.kubernetes.client.openapi.models.V1DeploymentStatus instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
