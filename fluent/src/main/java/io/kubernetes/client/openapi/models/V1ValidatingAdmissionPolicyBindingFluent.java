...
public class V1ValidatingAdmissionPolicyBindingFluent<A extends V1ValidatingAdmissionPolicyBindingFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(V1ValidatingAdmissionPolicyBinding instance) {
    instance = (instance != null ? instance : new V1ValidatingAdmissionPolicyBinding());
    if (instance != null) {
  ...
  public SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new V1ValidatingAdmissionPolicyBindingSpecBuilder().build()));
  }
  ...
  public class MetadataNested<N> extends V1ObjectMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ValidatingAdmissionPolicyBindingFluent.this.withMetadata(builder.build());
    }
  ...
  public class SpecNested<N> extends V1ValidatingAdmissionPolicyBindingSpecFluent<SpecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ValidatingAdmissionPolicyBindingFluent.this.withSpec(builder.build());
    }
