...
public interface V1beta1LeaseFluent<A extends io.kubernetes.client.openapi.models.V1beta1LeaseFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1beta1LeaseFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta1LeaseSpecFluent<io.kubernetes.client.openapi.models.V1beta1LeaseFluent.SpecNested<N>> {
