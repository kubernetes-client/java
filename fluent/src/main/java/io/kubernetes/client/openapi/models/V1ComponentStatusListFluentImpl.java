...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1ComponentStatus item) {
    ...
    V1ComponentStatusBuilder builder = new V1ComponentStatusBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  public V1ComponentStatusListFluent.ItemsNested<A> setNewItemLike(Integer index,V1ComponentStatus item) {
  ...
  class ItemsNestedImpl<N> extends V1ComponentStatusFluentImpl<V1ComponentStatusListFluent.ItemsNested<N>> implements V1ComponentStatusListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ComponentStatusListFluent.MetadataNested<N>> implements V1ComponentStatusListFluent.MetadataNested<N>,Nested<N>{
