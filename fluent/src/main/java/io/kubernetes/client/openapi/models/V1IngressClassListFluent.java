...
public class V1IngressClassListFluent<A extends io.kubernetes.client.openapi.models.V1IngressClassListFluent<A>> extends BaseFluent<A>{
  ...
  public V1IngressClassListFluent() {
  }
  
  public V1IngressClassListFluent(V1IngressClassList instance) {
  ...
  public ItemsNested<A> addNewItemLike(V1IngressClass item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1IngressClass... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1IngressClass item : items) {
  ...
  public V1IngressClass buildMatchingItem(Predicate<V1IngressClassBuilder> predicate) {
      for (V1IngressClassBuilder item : items) {
  ...
  protected void copyInstance(V1IngressClassList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1IngressClassBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1IngressClassListFluent that = (V1IngressClassListFluent) o;
  ...
  public A removeFromItems(V1IngressClass... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1IngressClass item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1IngressClassBuilder> predicate) {
    ...
    Iterator<V1IngressClassBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1IngressClass item) {
  ...
  public A withItems(V1IngressClass... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1IngressClassFluent<ItemsNested<N>> implements Nested<N>{
  
    V1IngressClassBuilder builder;
    int index;
  
    ItemsNested(int index,V1IngressClass item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1IngressClassListFluent.this.withMetadata(builder.build());
    }
