...
public class V1StatefulSetFluentImpl<A extends io.kubernetes.client.openapi.models.V1StatefulSetFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1StatefulSetFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private io.kubernetes.client.openapi.models.V1StatefulSetSpecBuilder spec;
    private io.kubernetes.client.openapi.models.V1StatefulSetStatusBuilder status;
    ...
    public io.kubernetes.client.openapi.models.V1StatefulSetFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1StatefulSetFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1StatefulSetFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1StatefulSetFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1StatefulSetSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1StatefulSetSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1StatefulSetFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1StatefulSetFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1StatefulSetFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1StatefulSetSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1StatefulSetStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1StatefulSetStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1StatefulSetFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V1StatefulSetFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1StatefulSetFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1StatefulSetStatusBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1StatefulSetFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StatefulSetSpecFluentImpl<io.kubernetes.client.openapi.models.V1StatefulSetFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1StatefulSetSpecBuilder builder;

            SpecNestedImpl(io.kubernetes.client.openapi.models.V1StatefulSetSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1StatefulSetSpecBuilder(this, item);
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StatefulSetStatusFluentImpl<io.kubernetes.client.openapi.models.V1StatefulSetFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1StatefulSetStatusBuilder builder;
            ...
            StatusNestedImpl(io.kubernetes.client.openapi.models.V1StatefulSetStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1StatefulSetStatusBuilder(this, item);
