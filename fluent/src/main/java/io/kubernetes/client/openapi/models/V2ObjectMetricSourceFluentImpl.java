...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2ObjectMetricSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent<A>{
  public V2ObjectMetricSourceFluentImpl() {
  }
  public V2ObjectMetricSourceFluentImpl(io.kubernetes.client.openapi.models.V2ObjectMetricSource instance) {
  ...
  public io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.DescribedObjectNested<A> withNewDescribedObject() {
    return new io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluentImpl.DescribedObjectNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.DescribedObjectNested<A> withNewDescribedObjectLike(io.kubernetes.client.openapi.models.V2CrossVersionObjectReference item) {
    return new io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluentImpl.DescribedObjectNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.MetricNested<A> withNewMetricLike(io.kubernetes.client.openapi.models.V2MetricIdentifier item) {
    return new io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluentImpl.MetricNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.TargetNested<A> withNewTargetLike(io.kubernetes.client.openapi.models.V2MetricTarget item) {
    return new io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluentImpl.TargetNestedImpl(item);
  }
  ...
  public class MetricNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricIdentifierFluentImpl<io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.MetricNested<N>> implements io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.MetricNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class TargetNestedImpl<N> extends io.kubernetes.client.openapi.models.V2MetricTargetFluentImpl<io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.TargetNested<N>> implements io.kubernetes.client.openapi.models.V2ObjectMetricSourceFluent.TargetNested<N>,io.kubernetes.client.fluent.Nested<N>{
