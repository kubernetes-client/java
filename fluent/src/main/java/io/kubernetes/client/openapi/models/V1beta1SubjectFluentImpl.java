...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta1SubjectFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1SubjectFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1SubjectFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V1beta1SubjectFluent.ServiceAccountNested<A> withNewServiceAccount() {
    return new io.kubernetes.client.openapi.models.V1beta1SubjectFluentImpl.ServiceAccountNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1SubjectFluent.ServiceAccountNested<A> withNewServiceAccountLike(io.kubernetes.client.openapi.models.V1beta1ServiceAccountSubject item) {
    return new io.kubernetes.client.openapi.models.V1beta1SubjectFluentImpl.ServiceAccountNestedImpl(item);
  }
  ...
  public class GroupNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1GroupSubjectFluentImpl<io.kubernetes.client.openapi.models.V1beta1SubjectFluent.GroupNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SubjectFluent.GroupNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class ServiceAccountNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1ServiceAccountSubjectFluentImpl<io.kubernetes.client.openapi.models.V1beta1SubjectFluent.ServiceAccountNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SubjectFluent.ServiceAccountNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class UserNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1UserSubjectFluentImpl<io.kubernetes.client.openapi.models.V1beta1SubjectFluent.UserNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SubjectFluent.UserNested<N>,io.kubernetes.client.fluent.Nested<N>{
