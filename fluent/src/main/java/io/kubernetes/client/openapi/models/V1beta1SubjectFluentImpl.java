...
public class V1beta1SubjectFluentImpl<A extends V1beta1SubjectFluent<A>> extends BaseFluent<A>
  ...
  public A withGroup(V1beta1GroupSubject group) {
    ...
    if (group != null) {
      this.group = new V1beta1GroupSubjectBuilder(group);
  ...
  public V1beta1SubjectFluent.GroupNested<A> editOrNewGroup() {
    return withNewGroupLike(
        getGroup() != null ? getGroup() : new V1beta1GroupSubjectBuilder().build());
  }
  ...
  public A withServiceAccount(V1beta1ServiceAccountSubject serviceAccount) {
    ...
    if (serviceAccount != null) {
      this.serviceAccount = new V1beta1ServiceAccountSubjectBuilder(serviceAccount);
  ...
  public V1beta1SubjectFluent.ServiceAccountNested<A> editOrNewServiceAccount() {
    return withNewServiceAccountLike(
        getServiceAccount() != null
            ? getServiceAccount()
            : new V1beta1ServiceAccountSubjectBuilder().build());
  }
  ...
  class GroupNestedImpl<N>
      ...
      implements V1beta1SubjectFluent.GroupNested<N>, Nested<N> {
  ...
  class ServiceAccountNestedImpl<N>
      ...
      implements V1beta1SubjectFluent.ServiceAccountNested<N>, Nested<N> {
  ...
  class UserNestedImpl<N> extends V1beta1UserSubjectFluentImpl<V1beta1SubjectFluent.UserNested<N>>
      implements V1beta1SubjectFluent.UserNested<N>, Nested<N> {
