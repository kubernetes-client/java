...
public class V1beta2NetworkDeviceDataFluent<A extends io.kubernetes.client.openapi.models.V1beta2NetworkDeviceDataFluent<A>> extends BaseFluent<A>{

  private String hardwareAddress;
  private String interfaceName;
  private List<String> ips;

  public V1beta2NetworkDeviceDataFluent() {
  }
  
  public V1beta2NetworkDeviceDataFluent(V1beta2NetworkDeviceData instance) {
  ...
  protected void copyInstance(V1beta2NetworkDeviceData instance) {
    instance = instance != null ? instance : new V1beta2NetworkDeviceData();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2NetworkDeviceDataFluent that = (V1beta2NetworkDeviceDataFluent) o;
