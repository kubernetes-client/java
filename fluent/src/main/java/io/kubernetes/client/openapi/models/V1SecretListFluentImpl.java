...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1Secret item) {
    ...
    V1SecretBuilder builder = new V1SecretBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1SecretFluentImpl<V1SecretListFluent.ItemsNested<N>> implements V1SecretListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1SecretListFluent.MetadataNested<N>> implements V1SecretListFluent.MetadataNested<N>,Nested<N>{
