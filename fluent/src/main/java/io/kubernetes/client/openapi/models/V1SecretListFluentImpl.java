...
public class V1SecretListFluentImpl<A extends V1SecretListFluent<A>> extends BaseFluent<A>
  ...
  public A addToItems(Integer index, io.kubernetes.client.openapi.models.V1Secret item) {
    if (this.items == null) {
  ...
  public A removeMatchingFromItems(
      Predicate<io.kubernetes.client.openapi.models.V1SecretBuilder> predicate) {
