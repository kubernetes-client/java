...
public class V1SecretListFluentImpl<A extends V1SecretListFluent<A>> extends BaseFluent<A>
  ...
  public A addToItems(Integer index, V1Secret item) {
    if (this.items == null) {
      this.items = new ArrayList<V1SecretBuilder>();
    }
  ...
  class ItemsNestedImpl<N> extends V1SecretFluentImpl<V1SecretListFluent.ItemsNested<N>>
      implements V1SecretListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1SecretListFluent.MetadataNested<N>>
      implements V1SecretListFluent.MetadataNested<N>, Nested<N> {
