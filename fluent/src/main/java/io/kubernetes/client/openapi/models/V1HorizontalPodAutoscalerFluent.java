...
public class V1HorizontalPodAutoscalerFluent<A extends io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V1HorizontalPodAutoscalerSpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V1HorizontalPodAutoscalerStatusBuilder().build()));
  }
