...
public class V1ServiceFluent<A extends V1ServiceFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new V1ServiceSpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(java.util.Optional.ofNullable(buildStatus()).orElse(new V1ServiceStatusBuilder().build()));
  }
