...
public interface V2alpha1CronJobListFluent<A extends io.kubernetes.client.openapi.models.V2alpha1CronJobListFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface ItemsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2alpha1CronJobFluent<io.kubernetes.client.openapi.models.V2alpha1CronJobListFluent.ItemsNested<N>> {

            public N and();
            public N endItem();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ListMetaFluent<io.kubernetes.client.openapi.models.V2alpha1CronJobListFluent.MetadataNested<N>> {
