...
public class V1LocalSubjectAccessReviewFluentImpl<A extends V1LocalSubjectAccessReviewFluent<A>>
  ...
  public V1LocalSubjectAccessReviewFluent.MetadataNested<A> editOrNewMetadataLike(
      V1ObjectMeta item) {
  ...
  public V1LocalSubjectAccessReviewFluent.SpecNested<A> withNewSpecLike(
  ...
  public V1LocalSubjectAccessReviewFluent.SpecNested<A> editOrNewSpecLike(
      V1SubjectAccessReviewSpec item) {
  ...
  public V1LocalSubjectAccessReviewFluent.StatusNested<A> withNewStatusLike(
  ...
  public V1LocalSubjectAccessReviewFluent.StatusNested<A> editOrNewStatusLike(
      V1SubjectAccessReviewStatus item) {
  ...
  class MetadataNestedImpl<N>
      ...
      implements V1LocalSubjectAccessReviewFluent.MetadataNested<N>, Nested<N> {
  ...
  class SpecNestedImpl<N>
      ...
      implements V1LocalSubjectAccessReviewFluent.SpecNested<N>, Nested<N> {
  ...
  class StatusNestedImpl<N>
      ...
      implements V1LocalSubjectAccessReviewFluent.StatusNested<N>, Nested<N> {
