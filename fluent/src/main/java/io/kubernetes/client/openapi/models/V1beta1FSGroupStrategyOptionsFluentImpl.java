...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta1FSGroupStrategyOptionsFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent<A>{
  public V1beta1FSGroupStrategyOptionsFluentImpl() {
  }
  public V1beta1FSGroupStrategyOptionsFluentImpl(io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptions instance) {
  ...
  public A withRanges(java.util.List<io.kubernetes.client.openapi.models.V1beta1IDRange> ranges) {
    ...
    if (ranges != null) {this.ranges = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1IDRange item : ranges){this.addToRanges(item);}} else { this.ranges = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent.RangesNested<A> addNewRange() {
    return new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluentImpl.RangesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent.RangesNested<A> addNewRangeLike(io.kubernetes.client.openapi.models.V1beta1IDRange item) {
    return new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluentImpl.RangesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent.RangesNested<A> setNewRangeLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1IDRange item) {
    return new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluentImpl.RangesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent.RangesNested<A> editRange(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent.RangesNested<A> editFirstRange() {
  ...
  public io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent.RangesNested<A> editLastRange() {
    int index = ranges.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last ranges. The list is empty.");
    return setNewRangeLike(index, buildRange(index));
  }
  public io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptionsFluent.RangesNested<A> editMatchingRange(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1IDRangeBuilder> predicate) {
    int index = -1;
