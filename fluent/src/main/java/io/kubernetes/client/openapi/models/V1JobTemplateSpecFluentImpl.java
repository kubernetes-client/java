...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1JobTemplateSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent<A>{
  public V1JobTemplateSpecFluentImpl() {
  }
  public V1JobTemplateSpecFluentImpl(io.kubernetes.client.openapi.models.V1JobTemplateSpec instance) {
  ...
  public io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1JobTemplateSpecFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new io.kubernetes.client.openapi.models.V1JobTemplateSpecFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent.SpecNested<A> withNewSpec() {
    return new io.kubernetes.client.openapi.models.V1JobTemplateSpecFluentImpl.SpecNestedImpl();
  }
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1JobSpecFluentImpl<io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1JobTemplateSpecFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
