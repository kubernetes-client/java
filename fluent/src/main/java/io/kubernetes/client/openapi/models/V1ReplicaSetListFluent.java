...
public class V1ReplicaSetListFluent<A extends V1ReplicaSetListFluent<A>> extends BaseFluent<A>{
  public V1ReplicaSetListFluent() {
  }
  
  public V1ReplicaSetListFluent(V1ReplicaSetList instance) {
  ...
  protected void copyInstance(V1ReplicaSetList instance) {
    instance = (instance != null ? instance : new V1ReplicaSetList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ReplicaSet... items) {
    ...
    for (V1ReplicaSet item : items) {V1ReplicaSetBuilder builder = new V1ReplicaSetBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1ReplicaSet buildMatchingItem(Predicate<V1ReplicaSetBuilder> predicate) {
      for (V1ReplicaSetBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1ReplicaSet item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1ReplicaSet item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1ReplicaSetBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1ReplicaSetListFluent that = (V1ReplicaSetListFluent) o;
  ...
  public class ItemsNested<N> extends V1ReplicaSetFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1ReplicaSet item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ReplicaSetListFluent.this.withMetadata(builder.build());
    }
