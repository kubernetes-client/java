...
public class V1ReplicaSetListFluent<A extends io.kubernetes.client.openapi.models.V1ReplicaSetListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1ReplicaSet... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1ReplicaSet item : items) {
  ...
  public A removeFromItems(V1ReplicaSet... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1ReplicaSet item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1ReplicaSetBuilder> predicate) {
    ...
    Iterator<V1ReplicaSetBuilder> each = items.iterator();
  ...
  public A withItems(V1ReplicaSet... items) {
    if (this.items != null) {
        this.items.clear();
