...
import io.kubernetes.client.fluent.Fluent;
  ...
  * Generated
  */
public interface V2MetricStatusFluent<A extends io.kubernetes.client.openapi.models.V2MetricStatusFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface ContainerResourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent<io.kubernetes.client.openapi.models.V2MetricStatusFluent.ContainerResourceNested<N>>{
    public N and();
    public N endContainerResource();
    
  }
  public interface ExternalNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2ExternalMetricStatusFluent<io.kubernetes.client.openapi.models.V2MetricStatusFluent.ExternalNested<N>>{
    public N and();
    public N endExternal();
    
  }
  public interface ObjectNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2ObjectMetricStatusFluent<io.kubernetes.client.openapi.models.V2MetricStatusFluent.ObjectNested<N>>{
    public N and();
    public N endObject();
    
  }
  public interface PodsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2PodsMetricStatusFluent<io.kubernetes.client.openapi.models.V2MetricStatusFluent.PodsNested<N>>{
    public N and();
    public N endPods();
    
  }
  public interface ResourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2ResourceMetricStatusFluent<io.kubernetes.client.openapi.models.V2MetricStatusFluent.ResourceNested<N>>{
    public N and();
