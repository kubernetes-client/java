...
public class V1FieldSelectorRequirementFluent<A extends io.kubernetes.client.openapi.models.V1FieldSelectorRequirementFluent<A>> extends BaseFluent<A>{
  public V1FieldSelectorRequirementFluent() {
  }
  
  public V1FieldSelectorRequirementFluent(V1FieldSelectorRequirement instance) {
  ...
  protected void copyInstance(V1FieldSelectorRequirement instance) {
    instance = instance != null ? instance : new V1FieldSelectorRequirement();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1FieldSelectorRequirementFluent that = (V1FieldSelectorRequirementFluent) o;
