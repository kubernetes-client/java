...
public class V1StatefulSetListFluentImpl<A extends io.kubernetes.client.openapi.models.V1StatefulSetListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1StatefulSetListFluent<A>{
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1StatefulSet> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1StatefulSet item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StatefulSetFluentImpl<io.kubernetes.client.openapi.models.V1StatefulSetListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1StatefulSet item) {
      this.index = index;
