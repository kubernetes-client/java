...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1StatefulSet item) {
    ...
    V1StatefulSetBuilder builder = new V1StatefulSetBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1StatefulSetFluentImpl<V1StatefulSetListFluent.ItemsNested<N>> implements V1StatefulSetListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1StatefulSetListFluent.MetadataNested<N>> implements V1StatefulSetListFluent.MetadataNested<N>,Nested<N>{
