...
public interface V1beta1ClusterRoleFluent<A extends io.kubernetes.client.openapi.models.V1beta1ClusterRoleFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface AggregationRuleNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta1AggregationRuleFluent<io.kubernetes.client.openapi.models.V1beta1ClusterRoleFluent.AggregationRuleNested<N>> {

            public N and();
            public N endAggregationRule();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1beta1ClusterRoleFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface RulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta1PolicyRuleFluent<io.kubernetes.client.openapi.models.V1beta1ClusterRoleFluent.RulesNested<N>> {
