...
import java.lang.Object;
  ...
  */
  ...
  public class V1alpha1ClusterCIDRListFluentImpl<A extends V1alpha1ClusterCIDRListFluent<A>> extends BaseFluent<A> implements V1alpha1ClusterCIDRListFluent<A>{
  ...
  public A addToItems(int index,V1alpha1ClusterCIDR item) {
    if (this.items == null) {this.items = new ArrayList<V1alpha1ClusterCIDRBuilder>();}
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1alpha1ClusterCIDR... items) {
    if (this.items == null) {this.items = new ArrayList<V1alpha1ClusterCIDRBuilder>();}
    for (V1alpha1ClusterCIDR item : items) {V1alpha1ClusterCIDRBuilder builder = new V1alpha1ClusterCIDRBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha1ClusterCIDR... items) {
    for (V1alpha1ClusterCIDR item : items) {V1alpha1ClusterCIDRBuilder builder = new V1alpha1ClusterCIDRBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public V1alpha1ClusterCIDR buildMatchingItem(Predicate<V1alpha1ClusterCIDRBuilder> predicate) {
    for (V1alpha1ClusterCIDRBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V1alpha1ClusterCIDRBuilder> predicate) {
    for (V1alpha1ClusterCIDRBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V1alpha1ClusterCIDR> items) {
    if (this.items != null) { _visitables.get("items").clear();}
    if (items != null) {this.items = new ArrayList(); for (V1alpha1ClusterCIDR item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1alpha1ClusterCIDR... items) {
    ...
    if (items != null) {for (V1alpha1ClusterCIDR item :items){ this.addToItems(item);}} return (A) this;
  }
  public Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public V1alpha1ClusterCIDRListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1alpha1ClusterCIDRListFluentImpl.ItemsNestedImpl();
  }
  public V1alpha1ClusterCIDRListFluentImpl.ItemsNested<A> addNewItemLike(V1alpha1ClusterCIDR item) {
    return new V1alpha1ClusterCIDRListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1alpha1ClusterCIDRListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1alpha1ClusterCIDR item) {
    return new V1alpha1ClusterCIDRListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1alpha1ClusterCIDRListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1alpha1ClusterCIDRListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1alpha1ClusterCIDRListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1alpha1ClusterCIDRListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1alpha1ClusterCIDRBuilder> predicate) {
    int index = -1;
  ...
  public V1alpha1ClusterCIDRListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1alpha1ClusterCIDRListFluentImpl.MetadataNestedImpl();
  }
  public V1alpha1ClusterCIDRListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1alpha1ClusterCIDRListFluentImpl.MetadataNestedImpl(item);
  }
  public V1alpha1ClusterCIDRListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1alpha1ClusterCIDRListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1alpha1ClusterCIDRListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1alpha1ClusterCIDRFluentImpl<V1alpha1ClusterCIDRListFluentImpl.ItemsNested<N>> implements V1alpha1ClusterCIDRListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1alpha1ClusterCIDR item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1alpha1ClusterCIDRListFluentImpl.MetadataNested<N>> implements V1alpha1ClusterCIDRListFluentImpl.MetadataNested<N>,Nested<N>{
