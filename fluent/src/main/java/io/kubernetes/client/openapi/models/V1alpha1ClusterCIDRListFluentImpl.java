...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1alpha1ClusterCIDR item) {
    ...
    V1alpha1ClusterCIDRBuilder builder = new V1alpha1ClusterCIDRBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1alpha1ClusterCIDRFluentImpl<V1alpha1ClusterCIDRListFluent.ItemsNested<N>> implements V1alpha1ClusterCIDRListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1alpha1ClusterCIDRListFluent.MetadataNested<N>> implements V1alpha1ClusterCIDRListFluent.MetadataNested<N>,Nested<N>{
