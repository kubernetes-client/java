...
public class V1beta1AllowedCSIDriverBuilder extends io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverFluentImpl<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver,io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverBuilder> {
    ...
    public V1beta1AllowedCSIDriverBuilder(io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriverFluent<?> fluent) {
        this(fluent, true);
    }
