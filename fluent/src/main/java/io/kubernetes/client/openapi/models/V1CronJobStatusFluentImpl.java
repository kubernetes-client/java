...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1CronJobStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1CronJobStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CronJobStatusFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V1CronJobStatusFluent.ActiveNested<A> addNewActiveLike(io.kubernetes.client.openapi.models.V1ObjectReference item) {
    return new io.kubernetes.client.openapi.models.V1CronJobStatusFluentImpl.ActiveNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1CronJobStatusFluent.ActiveNested<A> setNewActiveLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ObjectReference item) {
    return new io.kubernetes.client.openapi.models.V1CronJobStatusFluentImpl.ActiveNestedImpl(index, item);
  }
  ...
  public class ActiveNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1CronJobStatusFluent.ActiveNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobStatusFluent.ActiveNested<N>,io.kubernetes.client.fluent.Nested<N>{
