...
public interface V1VolumeAttachmentSpecFluent<A extends io.kubernetes.client.openapi.models.V1VolumeAttachmentSpecFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface SourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1VolumeAttachmentSourceFluent<io.kubernetes.client.openapi.models.V1VolumeAttachmentSpecFluent.SourceNested<N>> {
