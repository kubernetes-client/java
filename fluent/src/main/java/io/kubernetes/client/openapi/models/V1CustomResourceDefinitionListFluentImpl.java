...
import java.lang.Object;
  ...
  */
  ...
  public V1CustomResourceDefinitionListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1CustomResourceDefinitionListFluentImpl.ItemsNestedImpl();
  }
  public V1CustomResourceDefinitionListFluentImpl.ItemsNested<A> addNewItemLike(V1CustomResourceDefinition item) {
    return new V1CustomResourceDefinitionListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1CustomResourceDefinitionListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1CustomResourceDefinition item) {
    return new V1CustomResourceDefinitionListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1CustomResourceDefinitionListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CustomResourceDefinitionListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1CustomResourceDefinitionListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CustomResourceDefinitionListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1CustomResourceDefinitionBuilder> predicate) {
    int index = -1;
  ...
  public V1CustomResourceDefinitionListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1CustomResourceDefinitionListFluentImpl.MetadataNestedImpl();
  }
  public V1CustomResourceDefinitionListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1CustomResourceDefinitionListFluentImpl.MetadataNestedImpl(item);
  }
  public V1CustomResourceDefinitionListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1CustomResourceDefinitionListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1CustomResourceDefinitionListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1CustomResourceDefinitionFluentImpl<V1CustomResourceDefinitionListFluentImpl.ItemsNested<N>> implements V1CustomResourceDefinitionListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1CustomResourceDefinition item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CustomResourceDefinitionListFluentImpl.MetadataNested<N>> implements V1CustomResourceDefinitionListFluentImpl.MetadataNested<N>,Nested<N>{
