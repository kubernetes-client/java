...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1PodDisruptionBudgetListFluent<A extends io.kubernetes.client.openapi.models.V1PodDisruptionBudgetListFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface ItemsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent<io.kubernetes.client.openapi.models.V1PodDisruptionBudgetListFluent.ItemsNested<N>>{
    public N and();
    public N endItem();
    
  }
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ListMetaFluent<io.kubernetes.client.openapi.models.V1PodDisruptionBudgetListFluent.MetadataNested<N>>{
    public N and();
