...
public class V1PodDisruptionBudgetListFluent<A extends V1PodDisruptionBudgetListFluent<A>> extends BaseFluent<A>{
  public V1PodDisruptionBudgetListFluent() {
  }
  
  public V1PodDisruptionBudgetListFluent(V1PodDisruptionBudgetList instance) {
  ...
  protected void copyInstance(V1PodDisruptionBudgetList instance) {
    instance = (instance != null ? instance : new V1PodDisruptionBudgetList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1PodDisruptionBudget... items) {
    ...
    for (V1PodDisruptionBudget item : items) {V1PodDisruptionBudgetBuilder builder = new V1PodDisruptionBudgetBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1PodDisruptionBudget buildMatchingItem(Predicate<V1PodDisruptionBudgetBuilder> predicate) {
      for (V1PodDisruptionBudgetBuilder item : items) {
  ...
  public A withItems(List<V1PodDisruptionBudget> items) {
    ...
    if (items != null) {
        ...
        for (V1PodDisruptionBudget item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1PodDisruptionBudget item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1PodDisruptionBudget item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1PodDisruptionBudgetBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1PodDisruptionBudgetListFluent that = (V1PodDisruptionBudgetListFluent) o;
  ...
  public class ItemsNested<N> extends V1PodDisruptionBudgetFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1PodDisruptionBudget item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1PodDisruptionBudgetListFluent.this.withMetadata(builder.build());
    }
