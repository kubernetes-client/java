...
public class V1PodDisruptionBudgetListFluent<A extends io.kubernetes.client.openapi.models.V1PodDisruptionBudgetListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1PodDisruptionBudget... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1PodDisruptionBudget item : items) {
  ...
  public A removeFromItems(V1PodDisruptionBudget... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1PodDisruptionBudget item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1PodDisruptionBudgetBuilder> predicate) {
    ...
    Iterator<V1PodDisruptionBudgetBuilder> each = items.iterator();
  ...
  public A withItems(V1PodDisruptionBudget... items) {
    if (this.items != null) {
        this.items.clear();
