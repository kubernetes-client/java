...
public class V1DaemonSetListFluent<A extends io.kubernetes.client.openapi.models.V1DaemonSetListFluent<A>> extends BaseFluent<A>{
  ...
  public V1DaemonSetListFluent() {
  }
  
  public V1DaemonSetListFluent(V1DaemonSetList instance) {
  ...
  public ItemsNested<A> addNewItemLike(V1DaemonSet item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1DaemonSet... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1DaemonSet item : items) {
  ...
  protected void copyInstance(V1DaemonSetList instance) {
    instance = instance != null ? instance : new V1DaemonSetList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1DaemonSetBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1DaemonSetListFluent that = (V1DaemonSetListFluent) o;
  ...
  public A removeFromItems(V1DaemonSet... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1DaemonSet item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1DaemonSetBuilder> predicate) {
    ...
    Iterator<V1DaemonSetBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1DaemonSet item) {
  ...
  public A withItems(V1DaemonSet... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1DaemonSetFluent<ItemsNested<N>> implements Nested<N>{
  
    V1DaemonSetBuilder builder;
    int index;
  
    ItemsNested(int index,V1DaemonSet item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1DaemonSetListFluent.this.withMetadata(builder.build());
    }
