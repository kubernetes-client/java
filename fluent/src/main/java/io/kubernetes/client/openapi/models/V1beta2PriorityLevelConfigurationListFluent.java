...
public interface V1beta2PriorityLevelConfigurationListFluent<A extends V1beta2PriorityLevelConfigurationListFluent<A>> extends Fluent<A>{
  ...
  public V1beta2PriorityLevelConfigurationListFluent.ItemsNested<A> setNewItemLike(int index,V1beta2PriorityLevelConfiguration item);
  public V1beta2PriorityLevelConfigurationListFluent.ItemsNested<A> editItem(int index);
