...
public class V1beta2PriorityLevelConfigurationListFluent<A extends V1beta2PriorityLevelConfigurationListFluent<A>> extends BaseFluent<A>{
  public V1beta2PriorityLevelConfigurationListFluent() {
  }
  
  public V1beta2PriorityLevelConfigurationListFluent(V1beta2PriorityLevelConfigurationList instance) {
  ...
  protected void copyInstance(V1beta2PriorityLevelConfigurationList instance) {
    instance = (instance != null ? instance : new V1beta2PriorityLevelConfigurationList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfiguration... items) {
    ...
    for (V1beta2PriorityLevelConfiguration item : items) {V1beta2PriorityLevelConfigurationBuilder builder = new V1beta2PriorityLevelConfigurationBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1beta2PriorityLevelConfiguration buildMatchingItem(Predicate<V1beta2PriorityLevelConfigurationBuilder> predicate) {
      for (V1beta2PriorityLevelConfigurationBuilder item : items) {
  ...
  public A withItems(List<V1beta2PriorityLevelConfiguration> items) {
    ...
    if (items != null) {
        ...
        for (V1beta2PriorityLevelConfiguration item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1beta2PriorityLevelConfiguration item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1beta2PriorityLevelConfiguration item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1beta2PriorityLevelConfigurationBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1beta2PriorityLevelConfigurationListFluent that = (V1beta2PriorityLevelConfigurationListFluent) o;
  ...
  public class ItemsNested<N> extends V1beta2PriorityLevelConfigurationFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1beta2PriorityLevelConfiguration item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1beta2PriorityLevelConfigurationListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta2PriorityLevelConfigurationListFluent.this.withMetadata(builder.build());
    }
