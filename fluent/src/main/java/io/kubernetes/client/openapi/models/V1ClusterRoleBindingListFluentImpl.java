...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1ClusterRoleBinding item) {
    ...
    V1ClusterRoleBindingBuilder builder = new V1ClusterRoleBindingBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1ClusterRoleBindingFluentImpl<V1ClusterRoleBindingListFluent.ItemsNested<N>> implements V1ClusterRoleBindingListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1ClusterRoleBinding item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ClusterRoleBindingListFluent.MetadataNested<N>> implements V1ClusterRoleBindingListFluent.MetadataNested<N>,Nested<N>{
