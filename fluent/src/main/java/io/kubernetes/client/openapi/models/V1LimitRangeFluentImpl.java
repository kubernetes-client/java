...
import java.lang.Boolean;
  ...
  */
  ...
  public V1LimitRangeFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1LimitRangeFluentImpl.MetadataNestedImpl();
  }
  public V1LimitRangeFluentImpl.MetadataNested<A> withNewMetadataLike(V1ObjectMeta item) {
    return new V1LimitRangeFluentImpl.MetadataNestedImpl(item);
  }
  public V1LimitRangeFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1LimitRangeFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ObjectMetaBuilder().build());
  }
  public V1LimitRangeFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ObjectMeta item) {
  ...
  public V1LimitRangeFluentImpl.SpecNested<A> withNewSpec() {
    return new V1LimitRangeFluentImpl.SpecNestedImpl();
  }
  public V1LimitRangeFluentImpl.SpecNested<A> withNewSpecLike(V1LimitRangeSpec item) {
    return new V1LimitRangeFluentImpl.SpecNestedImpl(item);
  }
  public V1LimitRangeFluentImpl.SpecNested<A> editSpec() {
    return withNewSpecLike(getSpec());
  }
  public V1LimitRangeFluentImpl.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new V1LimitRangeSpecBuilder().build());
  }
  public V1LimitRangeFluentImpl.SpecNested<A> editOrNewSpecLike(V1LimitRangeSpec item) {
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1LimitRangeFluentImpl.MetadataNested<N>> implements V1LimitRangeFluentImpl.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1LimitRangeSpecFluentImpl<V1LimitRangeFluentImpl.SpecNested<N>> implements V1LimitRangeFluentImpl.SpecNested<N>,Nested<N>{
