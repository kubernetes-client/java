...
public class V1LimitRangeFluentImpl<A extends io.kubernetes.client.openapi.models.V1LimitRangeFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1LimitRangeFluent<A> {
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1LimitRangeSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1LimitRangeSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1LimitRangeFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1LimitRangeSpecBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1LimitRangeFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1LimitRangeFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LimitRangeSpecFluentImpl<io.kubernetes.client.openapi.models.V1LimitRangeFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1LimitRangeFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1LimitRangeSpecBuilder builder;
