...
public class V1BindingFluentImpl<A extends io.kubernetes.client.openapi.models.V1BindingFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1BindingFluent<A> {
    ...
    public A withTarget(io.kubernetes.client.openapi.models.V1ObjectReference target) {
        ...
        if (target!=null){ this.target= new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder(target); _visitables.get("target").add(this.target);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1BindingFluent.TargetNested<A> editOrNewTarget() {
        return withNewTargetLike(getTarget() != null ? getTarget(): new io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1BindingFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1BindingFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class TargetNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V1BindingFluent.TargetNested<N>> implements io.kubernetes.client.openapi.models.V1BindingFluent.TargetNested<N>,io.kubernetes.client.fluent.Nested<N> {
