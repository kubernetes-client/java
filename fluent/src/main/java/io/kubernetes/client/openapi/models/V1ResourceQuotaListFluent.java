...
public class V1ResourceQuotaListFluent<A extends io.kubernetes.client.openapi.models.V1ResourceQuotaListFluent<A>> extends BaseFluent<A>{
  public V1ResourceQuotaListFluent() {
  }
  
  public V1ResourceQuotaListFluent(V1ResourceQuotaList instance) {
  ...
  protected void copyInstance(V1ResourceQuotaList instance) {
    instance = instance != null ? instance : new V1ResourceQuotaList();
    if (instance != null) {
  ...
  public A addToItems(V1ResourceQuota... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1ResourceQuota item : items) {
        V1ResourceQuotaBuilder builder = new V1ResourceQuotaBuilder(item);
        _visitables.get("items").add(builder);
  ...
  public A removeFromItems(V1ResourceQuota... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1ResourceQuota item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1ResourceQuotaBuilder> predicate) {
    ...
    Iterator<V1ResourceQuotaBuilder> each = items.iterator();
  ...
  public V1ResourceQuota buildMatchingItem(Predicate<V1ResourceQuotaBuilder> predicate) {
      for (V1ResourceQuotaBuilder item : items) {
  ...
  public A withItems(V1ResourceQuota... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public ItemsNested<A> addNewItemLike(V1ResourceQuota item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1ResourceQuota item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1ResourceQuotaBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1ResourceQuotaListFluent that = (V1ResourceQuotaListFluent) o;
  ...
  public class ItemsNested<N> extends V1ResourceQuotaFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1ResourceQuota item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ResourceQuotaListFluent.this.withMetadata(builder.build());
    }
