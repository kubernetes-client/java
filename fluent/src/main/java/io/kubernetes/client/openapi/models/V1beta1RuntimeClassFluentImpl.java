...
public class V1beta1RuntimeClassFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent<A> {
    ...
    public V1beta1RuntimeClassFluentImpl(io.kubernetes.client.openapi.models.V1beta1RuntimeClass instance) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withOverhead(io.kubernetes.client.openapi.models.V1beta1Overhead overhead) {
        ...
        if (overhead!=null){ this.overhead= new io.kubernetes.client.openapi.models.V1beta1OverheadBuilder(overhead); _visitables.get("overhead").add(this.overhead);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.OverheadNested<A> withNewOverheadLike(io.kubernetes.client.openapi.models.V1beta1Overhead item) {
        return new io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluentImpl.OverheadNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.OverheadNested<A> editOrNewOverhead() {
        return withNewOverheadLike(getOverhead() != null ? getOverhead(): new io.kubernetes.client.openapi.models.V1beta1OverheadBuilder().build());
    }
    ...
    public A withScheduling(io.kubernetes.client.openapi.models.V1beta1Scheduling scheduling) {
        ...
        if (scheduling!=null){ this.scheduling= new io.kubernetes.client.openapi.models.V1beta1SchedulingBuilder(scheduling); _visitables.get("scheduling").add(this.scheduling);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.SchedulingNested<A> withNewScheduling() {
        return new io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluentImpl.SchedulingNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.SchedulingNested<A> withNewSchedulingLike(io.kubernetes.client.openapi.models.V1beta1Scheduling item) {
        return new io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluentImpl.SchedulingNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.SchedulingNested<A> editOrNewScheduling() {
        return withNewSchedulingLike(getScheduling() != null ? getScheduling(): new io.kubernetes.client.openapi.models.V1beta1SchedulingBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class OverheadNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1OverheadFluentImpl<io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.OverheadNested<N>> implements io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.OverheadNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1OverheadBuilder builder;
    ...
    public class SchedulingNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1SchedulingFluentImpl<io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.SchedulingNested<N>> implements io.kubernetes.client.openapi.models.V1beta1RuntimeClassFluent.SchedulingNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1SchedulingBuilder builder;
