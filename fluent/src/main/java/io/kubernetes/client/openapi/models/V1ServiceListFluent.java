...
public class V1ServiceListFluent<A extends io.kubernetes.client.openapi.models.V1ServiceListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1ServiceBuilder> predicate) {
    ...
    Iterator<V1ServiceBuilder> each = items.iterator();
