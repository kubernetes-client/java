...
import java.lang.Object;
  ...
  */
  ...
  public V1beta1CSIStorageCapacityListFluentImpl(V1beta1CSIStorageCapacityList instance) {
  ...
  private ArrayList<V1beta1CSIStorageCapacityBuilder> items;
  private String kind;
  ...
  public A addToItems(Integer index,V1beta1CSIStorageCapacity item) {
    if (this.items == null) {this.items = new ArrayList<V1beta1CSIStorageCapacityBuilder>();}
    V1beta1CSIStorageCapacityBuilder builder = new V1beta1CSIStorageCapacityBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  public A setToItems(Integer index,V1beta1CSIStorageCapacity item) {
    if (this.items == null) {this.items = new ArrayList<V1beta1CSIStorageCapacityBuilder>();}
    V1beta1CSIStorageCapacityBuilder builder = new V1beta1CSIStorageCapacityBuilder(item);
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity... items) {
    if (this.items == null) {this.items = new ArrayList<V1beta1CSIStorageCapacityBuilder>();}
    for (V1beta1CSIStorageCapacity item : items) {V1beta1CSIStorageCapacityBuilder builder = new V1beta1CSIStorageCapacityBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity... items) {
    for (V1beta1CSIStorageCapacity item : items) {V1beta1CSIStorageCapacityBuilder builder = new V1beta1CSIStorageCapacityBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<V1beta1CSIStorageCapacityBuilder> predicate) {
    ...
    final Iterator<V1beta1CSIStorageCapacityBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      V1beta1CSIStorageCapacityBuilder builder = each.next();
  ...
  public V1beta1CSIStorageCapacity buildMatchingItem(Predicate<V1beta1CSIStorageCapacityBuilder> predicate) {
    for (V1beta1CSIStorageCapacityBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V1beta1CSIStorageCapacityBuilder> predicate) {
    for (V1beta1CSIStorageCapacityBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V1beta1CSIStorageCapacity> items) {
    if (this.items != null) { _visitables.get("items").removeAll(this.items);}
    if (items != null) {this.items = new ArrayList(); for (V1beta1CSIStorageCapacity item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity... items) {
    if (this.items != null) {this.items.clear();}
    if (items != null) {for (V1beta1CSIStorageCapacity item :items){ this.addToItems(item);}} return (A) this;
  }
  public Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public V1beta1CSIStorageCapacityListFluent.ItemsNested<A> addNewItem() {
    return new V1beta1CSIStorageCapacityListFluentImpl.ItemsNestedImpl();
  }
  public V1beta1CSIStorageCapacityListFluent.ItemsNested<A> addNewItemLike(V1beta1CSIStorageCapacity item) {
    return new V1beta1CSIStorageCapacityListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1beta1CSIStorageCapacityListFluent.ItemsNested<A> setNewItemLike(Integer index,V1beta1CSIStorageCapacity item) {
    return new V1beta1CSIStorageCapacityListFluentImpl.ItemsNestedImpl(index, item);
  }
  ...
  public V1beta1CSIStorageCapacityListFluent.MetadataNested<A> withNewMetadata() {
    return new V1beta1CSIStorageCapacityListFluentImpl.MetadataNestedImpl();
  }
  public V1beta1CSIStorageCapacityListFluent.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1beta1CSIStorageCapacityListFluentImpl.MetadataNestedImpl(item);
  }
  ...
  class ItemsNestedImpl<N> extends V1beta1CSIStorageCapacityFluentImpl<V1beta1CSIStorageCapacityListFluent.ItemsNested<N>> implements V1beta1CSIStorageCapacityListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1beta1CSIStorageCapacity item) {
      this.index = index;
      this.builder = new V1beta1CSIStorageCapacityBuilder(this, item);
    }
    ItemsNestedImpl() {
      this.index = -1;
      this.builder = new V1beta1CSIStorageCapacityBuilder(this);
    }
    V1beta1CSIStorageCapacityBuilder builder;
    Integer index;
    public N and() {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta1CSIStorageCapacityListFluent.MetadataNested<N>> implements V1beta1CSIStorageCapacityListFluent.MetadataNested<N>,Nested<N>{
