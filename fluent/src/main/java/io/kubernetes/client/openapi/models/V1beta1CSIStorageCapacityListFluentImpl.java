...
public class V1beta1CSIStorageCapacityListFluentImpl<
        A extends V1beta1CSIStorageCapacityListFluent<A>>
    extends BaseFluent<A> implements V1beta1CSIStorageCapacityListFluent<A> {
  ...
  public A addToItems(Integer index, V1beta1CSIStorageCapacity item) {
    if (this.items == null) {
      this.items = new ArrayList<V1beta1CSIStorageCapacityBuilder>();
    }
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity... items) {
    ...
    for (V1beta1CSIStorageCapacity item : items) {
      V1beta1CSIStorageCapacityBuilder builder = new V1beta1CSIStorageCapacityBuilder(item);
      _visitables.get("items").add(builder);
  ...
  public V1beta1CSIStorageCapacity buildMatchingItem(
    ...
    for (V1beta1CSIStorageCapacityBuilder item : items) {
  ...
  public V1beta1CSIStorageCapacityListFluent.MetadataNested<A> withNewMetadataLike(
      V1ListMeta item) {
  ...
  class ItemsNestedImpl<N>
      extends V1beta1CSIStorageCapacityFluentImpl<
          V1beta1CSIStorageCapacityListFluent.ItemsNested<N>>
      implements V1beta1CSIStorageCapacityListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N>
      extends V1ListMetaFluentImpl<V1beta1CSIStorageCapacityListFluent.MetadataNested<N>>
      implements V1beta1CSIStorageCapacityListFluent.MetadataNested<N>, Nested<N> {
