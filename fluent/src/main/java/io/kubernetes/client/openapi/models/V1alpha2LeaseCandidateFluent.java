...
public class V1alpha2LeaseCandidateFluent<A extends V1alpha2LeaseCandidateFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new V1alpha2LeaseCandidateSpecBuilder().build()));
  }
