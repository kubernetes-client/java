...
public class V1APIServiceConditionFluentImpl<A extends io.kubernetes.client.openapi.models.V1APIServiceConditionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1APIServiceConditionFluent<A> {
    ...
    public V1APIServiceConditionFluentImpl() {
    }

    public V1APIServiceConditionFluentImpl(io.kubernetes.client.openapi.models.V1APIServiceCondition instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1APIServiceConditionFluentImpl that = (V1APIServiceConditionFluentImpl) o;
