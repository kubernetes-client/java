...
public class V1DeploymentListFluent<A extends V1DeploymentListFluent<A>> extends BaseFluent<A>{
  public V1DeploymentListFluent() {
  }
  
  public V1DeploymentListFluent(V1DeploymentList instance) {
  ...
  protected void copyInstance(V1DeploymentList instance) {
    instance = (instance != null ? instance : new V1DeploymentList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Deployment... items) {
    ...
    for (V1Deployment item : items) {V1DeploymentBuilder builder = new V1DeploymentBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1Deployment buildMatchingItem(Predicate<V1DeploymentBuilder> predicate) {
      for (V1DeploymentBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1Deployment item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1Deployment item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1DeploymentBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1DeploymentListFluent that = (V1DeploymentListFluent) o;
  ...
  public class ItemsNested<N> extends V1DeploymentFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1Deployment item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1DeploymentListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1DeploymentListFluent.this.withMetadata(builder.build());
    }
