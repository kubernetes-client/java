...
public class V1DeploymentListFluent<A extends io.kubernetes.client.openapi.models.V1DeploymentListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1DeploymentBuilder> predicate) {
    ...
    Iterator<V1DeploymentBuilder> each = items.iterator();
