...
public interface V1DeploymentListFluent<A extends V1DeploymentListFluent<A>> extends Fluent<A> {
  ...
  public V1DeploymentListFluent.ItemsNested<A> addNewItemLike(
  ...
  public interface ItemsNested<N>
      extends Nested<N>, V1DeploymentFluent<V1DeploymentListFluent.ItemsNested<N>> {
    public N and();
  ...
  public interface MetadataNested<N>
      extends io.kubernetes.client.fluent.Nested<N>,
          V1ListMetaFluent<V1DeploymentListFluent.MetadataNested<N>> {
    public N and();
