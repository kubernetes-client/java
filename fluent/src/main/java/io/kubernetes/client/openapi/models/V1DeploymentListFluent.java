...
public interface V1DeploymentListFluent<A extends io.kubernetes.client.openapi.models.V1DeploymentListFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1Deployment item);
    public A setToItems(int index,io.kubernetes.client.openapi.models.V1Deployment item);
    ...
    public io.kubernetes.client.openapi.models.V1Deployment buildItem(int index);
    ...
    public io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1Deployment item);
    public io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<A> editItem(int index);
    ...
    public interface ItemsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1DeploymentFluent<io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<N>> {

            public N and();
            public N endItem();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ListMetaFluent<io.kubernetes.client.openapi.models.V1DeploymentListFluent.MetadataNested<N>> {
