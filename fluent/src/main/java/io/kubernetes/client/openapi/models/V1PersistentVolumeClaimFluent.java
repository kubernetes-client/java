...
public interface V1PersistentVolumeClaimFluent<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpecFluent<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<N>> {

            public N and();
            public N endSpec();    }


    public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusFluent<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<N>> {
