...
public class V1PersistentVolumeClaimFluent<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V1PersistentVolumeClaimSpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V1PersistentVolumeClaimStatusBuilder().build()));
  }
