...
public class V1beta1SupplementalGroupsStrategyOptionsFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent<A> {
    ...
    public V1beta1SupplementalGroupsStrategyOptionsFluentImpl(io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptions instance) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent.RangesNested<A> addNewRange() {
        return new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluentImpl.RangesNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent.RangesNested<A> addNewRangeLike(io.kubernetes.client.openapi.models.V1beta1IDRange item) {
        return new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluentImpl.RangesNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent.RangesNested<A> setNewRangeLike(int index,io.kubernetes.client.openapi.models.V1beta1IDRange item) {
        return new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluentImpl.RangesNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent.RangesNested<A> editRange(int index) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1SupplementalGroupsStrategyOptionsFluentImpl that = (V1beta1SupplementalGroupsStrategyOptionsFluentImpl) o;
    ...
    public class RangesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1IDRangeFluentImpl<io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent.RangesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptionsFluent.RangesNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            public N and() {
                return (N) V1beta1SupplementalGroupsStrategyOptionsFluentImpl.this.setToRanges(index,builder.build());
            }
