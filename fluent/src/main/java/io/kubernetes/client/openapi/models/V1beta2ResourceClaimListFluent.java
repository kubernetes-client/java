...
public class V1beta2ResourceClaimListFluent<A extends V1beta2ResourceClaimListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(int index,V1beta2ResourceClaim item) {
    if (this.items == null) {this.items = new ArrayList<V1beta2ResourceClaimBuilder>();}
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1beta2ResourceClaim... items) {
    if (this.items == null) {this.items = new ArrayList<V1beta2ResourceClaimBuilder>();}
    for (V1beta2ResourceClaim item : items) {V1beta2ResourceClaimBuilder builder = new V1beta2ResourceClaimBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta2ResourceClaim... items) {
    if (this.items == null) return (A)this;
    for (V1beta2ResourceClaim item : items) {V1beta2ResourceClaimBuilder builder = new V1beta2ResourceClaimBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<V1beta2ResourceClaimBuilder> predicate) {
    ...
    final Iterator<V1beta2ResourceClaimBuilder> each = items.iterator();
  ...
  public A withItems(io.kubernetes.client.openapi.models.V1beta2ResourceClaim... items) {
    if (this.items != null) {
        this.items.clear();
