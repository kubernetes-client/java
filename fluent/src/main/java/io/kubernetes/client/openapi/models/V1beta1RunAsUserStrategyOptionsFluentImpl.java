...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta1RunAsUserStrategyOptionsFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluent<A>{
  public V1beta1RunAsUserStrategyOptionsFluentImpl() {
  }
  public V1beta1RunAsUserStrategyOptionsFluentImpl(io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptions instance) {
  ...
  public io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluent.RangesNested<A> addNewRange() {
    return new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluentImpl.RangesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluent.RangesNested<A> addNewRangeLike(io.kubernetes.client.openapi.models.V1beta1IDRange item) {
    return new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluentImpl.RangesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluent.RangesNested<A> setNewRangeLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1IDRange item) {
    return new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluentImpl.RangesNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptionsFluent.RangesNested<A> editRange(java.lang.Integer index) {
