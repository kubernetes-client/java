...
public class V1ValidatingWebhookConfigurationFluentImpl<A extends io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent<A> {

    private java.lang.String apiVersion;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ObjectMetaBuilder metadata;
    private java.util.List<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder> webhooks;

    public V1ValidatingWebhookConfigurationFluentImpl() {
    }

    public V1ValidatingWebhookConfigurationFluentImpl(io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration instance) {
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A addToWebhooks(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhook item) {
        if (this.webhooks == null) {this.webhooks = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder>();}
        io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder builder = new io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder(item);_visitables.get("webhooks").add(index >= 0 ? index : _visitables.get("webhooks").size(), builder);this.webhooks.add(index >= 0 ? index : webhooks.size(), builder); return (A)this;
    }

    public A setToWebhooks(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhook item) {
        if (this.webhooks == null) {this.webhooks = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder>();}
        io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder builder = new io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder(item);
    ...
    public A addToWebhooks(io.kubernetes.client.openapi.models.V1ValidatingWebhook... items) {
        if (this.webhooks == null) {this.webhooks = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder>();}
        for (io.kubernetes.client.openapi.models.V1ValidatingWebhook item : items) {io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder builder = new io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder(item);_visitables.get("webhooks").add(builder);this.webhooks.add(builder);} return (A)this;
    }
    ...
    public A removeFromWebhooks(io.kubernetes.client.openapi.models.V1ValidatingWebhook... items) {
        for (io.kubernetes.client.openapi.models.V1ValidatingWebhook item : items) {io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder builder = new io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder(item);_visitables.get("webhooks").remove(builder);if (this.webhooks != null) {this.webhooks.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromWebhooks(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder> each = webhooks.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhook buildWebhook(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhook buildMatchingWebhook(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder item: webhooks) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingWebhook(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder item: webhooks) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withWebhooks(java.util.List<io.kubernetes.client.openapi.models.V1ValidatingWebhook> webhooks) {
        ...
        if (webhooks != null) {this.webhooks = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder>(); for (io.kubernetes.client.openapi.models.V1ValidatingWebhook item : webhooks){this.addToWebhooks(item);}} else { this.webhooks = null;} return (A) this;
    }
    ...
    public A withWebhooks(io.kubernetes.client.openapi.models.V1ValidatingWebhook... webhooks) {
        ...
        if (webhooks != null) {for (io.kubernetes.client.openapi.models.V1ValidatingWebhook item :webhooks){ this.addToWebhooks(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.WebhooksNested<A> addNewWebhook() {
        return new io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluentImpl.WebhooksNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.WebhooksNested<A> addNewWebhookLike(io.kubernetes.client.openapi.models.V1ValidatingWebhook item) {
        return new io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluentImpl.WebhooksNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.WebhooksNested<A> setNewWebhookLike(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhook item) {
        return new io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluentImpl.WebhooksNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.WebhooksNested<A> editWebhook(int index) {
    ...
    public class WebhooksNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ValidatingWebhookFluentImpl<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.WebhooksNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationFluent.WebhooksNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ValidatingWebhookBuilder builder;
        private final int index;

            WebhooksNestedImpl(int index,io.kubernetes.client.openapi.models.V1ValidatingWebhook item) {
                this.index = index;
