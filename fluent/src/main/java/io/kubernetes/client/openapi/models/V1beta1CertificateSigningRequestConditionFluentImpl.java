...
public class V1beta1CertificateSigningRequestConditionFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestConditionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestConditionFluent<A> {
    ...
    public V1beta1CertificateSigningRequestConditionFluentImpl() {
    }

    public V1beta1CertificateSigningRequestConditionFluentImpl(io.kubernetes.client.openapi.models.V1beta1CertificateSigningRequestCondition instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1CertificateSigningRequestConditionFluentImpl that = (V1beta1CertificateSigningRequestConditionFluentImpl) o;
