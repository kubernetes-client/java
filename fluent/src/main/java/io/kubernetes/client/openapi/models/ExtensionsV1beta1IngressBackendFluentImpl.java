...
public class ExtensionsV1beta1IngressBackendFluentImpl<A extends io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluent<A> {
    ...
    public ExtensionsV1beta1IngressBackendFluentImpl(io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackend instance) {
    ...
    public io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluent.ResourceNested<A> withNewResource() {
        return new io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluentImpl.ResourceNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluent.ResourceNested<A> withNewResourceLike(io.kubernetes.client.openapi.models.V1TypedLocalObjectReference item) {
        return new io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluentImpl.ResourceNestedImpl(item);
    }
    ...
    public class ResourceNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TypedLocalObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.ExtensionsV1beta1IngressBackendFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1TypedLocalObjectReferenceBuilder builder;
            ...
            public N and() {
                return (N) ExtensionsV1beta1IngressBackendFluentImpl.this.withResource(builder.build());
            }
