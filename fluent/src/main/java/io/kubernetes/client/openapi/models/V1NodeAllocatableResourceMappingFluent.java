...
public class V1NodeAllocatableResourceMappingFluent<A extends io.kubernetes.client.openapi.models.V1NodeAllocatableResourceMappingFluent<A>> extends BaseFluent<A>{
  ...
  public V1NodeAllocatableResourceMappingFluent(V1NodeAllocatableResourceMapping instance) {
    this.copyInstance(instance);
  }

  protected void copyInstance(V1NodeAllocatableResourceMapping instance) {
    instance = instance != null ? instance : new V1NodeAllocatableResourceMapping();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1NodeAllocatableResourceMappingFluent that = (V1NodeAllocatableResourceMappingFluent) o;
