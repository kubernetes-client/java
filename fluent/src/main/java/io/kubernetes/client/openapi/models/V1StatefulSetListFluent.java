...
public class V1StatefulSetListFluent<A extends V1StatefulSetListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1StatefulSet... items) {
    ...
    for (V1StatefulSet item : items) {V1StatefulSetBuilder builder = new V1StatefulSetBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
