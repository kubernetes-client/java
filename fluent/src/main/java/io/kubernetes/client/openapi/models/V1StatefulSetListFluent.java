...
public class V1StatefulSetListFluent<A extends io.kubernetes.client.openapi.models.V1StatefulSetListFluent<A>> extends BaseFluent<A>{
  ...
  public V1StatefulSetListFluent() {
  }
  
  public V1StatefulSetListFluent(V1StatefulSetList instance) {
  ...
  public ItemsNested<A> addNewItemLike(V1StatefulSet item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1StatefulSet... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1StatefulSet item : items) {
  ...
  public V1StatefulSet buildMatchingItem(Predicate<V1StatefulSetBuilder> predicate) {
      for (V1StatefulSetBuilder item : items) {
  ...
  protected void copyInstance(V1StatefulSetList instance) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1StatefulSetBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1StatefulSetListFluent that = (V1StatefulSetListFluent) o;
  ...
  public A removeFromItems(V1StatefulSet... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1StatefulSet item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1StatefulSetBuilder> predicate) {
    ...
    Iterator<V1StatefulSetBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1StatefulSet item) {
  ...
  public A withItems(V1StatefulSet... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1StatefulSetFluent<ItemsNested<N>> implements Nested<N>{
  
    V1StatefulSetBuilder builder;
    int index;
  
    ItemsNested(int index,V1StatefulSet item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1StatefulSetListFluent.this.withMetadata(builder.build());
    }
