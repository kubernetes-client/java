...
public class V1DeploymentSpecBuilder extends io.kubernetes.client.openapi.models.V1DeploymentSpecFluentImpl<io.kubernetes.client.openapi.models.V1DeploymentSpecBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1DeploymentSpec,io.kubernetes.client.openapi.models.V1DeploymentSpecBuilder> {
    ...
    public V1DeploymentSpecBuilder(io.kubernetes.client.openapi.models.V1DeploymentSpecFluent<?> fluent) {
        this(fluent, true);
    }

    public V1DeploymentSpecBuilder(io.kubernetes.client.openapi.models.V1DeploymentSpecFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1DeploymentSpec(), validationEnabled);
    }

    public V1DeploymentSpecBuilder(io.kubernetes.client.openapi.models.V1DeploymentSpecFluent<?> fluent,io.kubernetes.client.openapi.models.V1DeploymentSpec instance) {
        this(fluent, instance, true);
    }

    public V1DeploymentSpecBuilder(io.kubernetes.client.openapi.models.V1DeploymentSpecFluent<?> fluent,io.kubernetes.client.openapi.models.V1DeploymentSpec instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1DeploymentSpecBuilder(io.kubernetes.client.openapi.models.V1DeploymentSpec instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
