...
public class V1alpha1RuntimeClassFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent<A> {
    ...
    public V1alpha1RuntimeClassFluentImpl(io.kubernetes.client.openapi.models.V1alpha1RuntimeClass instance) {
    ...
    public io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpec item) {
        return new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpecBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpecFluentImpl<io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpecBuilder builder;
            ...
            SpecNestedImpl(io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpecBuilder(this, item);
