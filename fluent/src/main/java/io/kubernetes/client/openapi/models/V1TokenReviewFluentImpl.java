...
public class V1TokenReviewFluentImpl<A extends io.kubernetes.client.openapi.models.V1TokenReviewFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1TokenReviewFluent<A> {
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1TokenReviewSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1TokenReviewSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1TokenReviewFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1TokenReviewSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1TokenReviewStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1TokenReviewStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1TokenReviewFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1TokenReviewStatusBuilder().build());
    }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1TokenReviewFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1TokenReviewFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TokenReviewSpecFluentImpl<io.kubernetes.client.openapi.models.V1TokenReviewFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1TokenReviewFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1TokenReviewSpecBuilder builder;
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TokenReviewStatusFluentImpl<io.kubernetes.client.openapi.models.V1TokenReviewFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1TokenReviewFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
