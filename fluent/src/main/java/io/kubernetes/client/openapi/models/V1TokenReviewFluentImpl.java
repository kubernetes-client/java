...
import java.lang.Object;
  ...
  */
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1TokenReviewFluent.MetadataNested<N>> implements V1TokenReviewFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1TokenReviewSpecFluentImpl<V1TokenReviewFluent.SpecNested<N>> implements V1TokenReviewFluent.SpecNested<N>,Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1TokenReviewStatusFluentImpl<V1TokenReviewFluent.StatusNested<N>> implements V1TokenReviewFluent.StatusNested<N>,Nested<N>{
