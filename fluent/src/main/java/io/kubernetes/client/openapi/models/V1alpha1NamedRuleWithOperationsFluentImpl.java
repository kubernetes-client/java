...
import java.util.function.Predicate;
  ...
  */
  ...
  public class V1alpha1NamedRuleWithOperationsFluentImpl<A extends V1alpha1NamedRuleWithOperationsFluent<A>> extends BaseFluent<A> implements V1alpha1NamedRuleWithOperationsFluent<A>{
  public V1alpha1NamedRuleWithOperationsFluentImpl() {
  }
  public V1alpha1NamedRuleWithOperationsFluentImpl(V1alpha1NamedRuleWithOperations instance) {
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1NamedRuleWithOperationsFluentImpl that = (V1alpha1NamedRuleWithOperationsFluentImpl) o;
