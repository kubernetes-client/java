...
public class V2beta2PodsMetricSourceFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent<A> {
    ...
    public V2beta2PodsMetricSourceFluentImpl(io.kubernetes.client.openapi.models.V2beta2PodsMetricSource instance) {
    ...
    public io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.MetricNested<A> withNewMetric() {
        return new io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluentImpl.MetricNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.MetricNested<A> withNewMetricLike(io.kubernetes.client.openapi.models.V2beta2MetricIdentifier item) {
        return new io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluentImpl.MetricNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.TargetNested<A> withNewTarget() {
        return new io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluentImpl.TargetNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.TargetNested<A> withNewTargetLike(io.kubernetes.client.openapi.models.V2beta2MetricTarget item) {
        return new io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluentImpl.TargetNestedImpl(item);
    }
    ...
    public class MetricNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2MetricIdentifierFluentImpl<io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.MetricNested<N>> implements io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.MetricNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class TargetNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2MetricTargetFluentImpl<io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.TargetNested<N>> implements io.kubernetes.client.openapi.models.V2beta2PodsMetricSourceFluent.TargetNested<N>,io.kubernetes.client.fluent.Nested<N> {
