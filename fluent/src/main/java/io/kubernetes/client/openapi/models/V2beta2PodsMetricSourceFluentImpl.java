...
public class V2beta2PodsMetricSourceFluentImpl<A extends V2beta2PodsMetricSourceFluent<A>>
    extends BaseFluent<A> implements V2beta2PodsMetricSourceFluent<A> {
  ...
  public V2beta2PodsMetricSourceFluent.MetricNested<A> withNewMetric() {
    return new V2beta2PodsMetricSourceFluentImpl.MetricNestedImpl();
  }

  public V2beta2PodsMetricSourceFluent.MetricNested<A> withNewMetricLike(
      V2beta2MetricIdentifier item) {
    return new V2beta2PodsMetricSourceFluentImpl.MetricNestedImpl(item);
  }
  ...
  public V2beta2PodsMetricSourceFluent.MetricNested<A> editOrNewMetricLike(
      V2beta2MetricIdentifier item) {
  ...
  public V2beta2PodsMetricSourceFluent.TargetNested<A> withNewTarget() {
    return new V2beta2PodsMetricSourceFluentImpl.TargetNestedImpl();
  }

  public V2beta2PodsMetricSourceFluent.TargetNested<A> withNewTargetLike(V2beta2MetricTarget item) {
    return new V2beta2PodsMetricSourceFluentImpl.TargetNestedImpl(item);
  }
  ...
  public V2beta2PodsMetricSourceFluent.TargetNested<A> editOrNewTargetLike(
  ...
  class MetricNestedImpl<N>
      extends V2beta2MetricIdentifierFluentImpl<V2beta2PodsMetricSourceFluent.MetricNested<N>>
      implements V2beta2PodsMetricSourceFluent.MetricNested<N>, Nested<N> {
  ...
  class TargetNestedImpl<N>
      extends V2beta2MetricTargetFluentImpl<V2beta2PodsMetricSourceFluent.TargetNested<N>>
      implements V2beta2PodsMetricSourceFluent.TargetNested<N>, Nested<N> {
