...
import java.lang.Boolean;
  ...
  */
  ...
  public V2beta2PodsMetricSourceFluent.MetricNested<A> withNewMetricLike(V2beta2MetricIdentifier item) {
  ...
  public V2beta2PodsMetricSourceFluent.MetricNested<A> editOrNewMetricLike(V2beta2MetricIdentifier item) {
  ...
  public V2beta2PodsMetricSourceFluent.TargetNested<A> editOrNewTargetLike(V2beta2MetricTarget item) {
  ...
  class MetricNestedImpl<N> extends V2beta2MetricIdentifierFluentImpl<V2beta2PodsMetricSourceFluent.MetricNested<N>> implements V2beta2PodsMetricSourceFluent.MetricNested<N>,Nested<N>{
  ...
  class TargetNestedImpl<N> extends V2beta2MetricTargetFluentImpl<V2beta2PodsMetricSourceFluent.TargetNested<N>> implements V2beta2PodsMetricSourceFluent.TargetNested<N>,Nested<N>{
