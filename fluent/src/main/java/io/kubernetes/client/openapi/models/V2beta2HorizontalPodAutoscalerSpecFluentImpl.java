...
public class V2beta2HorizontalPodAutoscalerSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent<A> {
    ...
    public A withMetrics(java.util.List<io.kubernetes.client.openapi.models.V2beta2MetricSpec> metrics) {
        ...
        if (metrics != null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta2MetricSpecBuilder>(); for (io.kubernetes.client.openapi.models.V2beta2MetricSpec item : metrics){this.addToMetrics(item);}} else { this.metrics = null;} return (A) this;
    }
    ...
    public class BehaviorNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBehaviorFluentImpl<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.BehaviorNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.BehaviorNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBehaviorBuilder builder;
    ...
    public class MetricsNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2MetricSpecFluentImpl<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            MetricsNestedImpl(int index,io.kubernetes.client.openapi.models.V2beta2MetricSpec item) {
                this.index = index;
    ...
    public class ScaleTargetRefNestedImpl<N> extends io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReferenceFluentImpl<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReferenceBuilder builder;
