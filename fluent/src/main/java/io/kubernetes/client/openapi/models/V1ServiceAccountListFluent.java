...
public class V1ServiceAccountListFluent<A extends io.kubernetes.client.openapi.models.V1ServiceAccountListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1ServiceAccountBuilder> predicate) {
    ...
    Iterator<V1ServiceAccountBuilder> each = items.iterator();
