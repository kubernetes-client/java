...
public class V1ServiceAccountListFluent<A extends V1ServiceAccountListFluent<A>> extends BaseFluent<A>{
  public V1ServiceAccountListFluent() {
  }
  
  public V1ServiceAccountListFluent(V1ServiceAccountList instance) {
  ...
  protected void copyInstance(V1ServiceAccountList instance) {
    instance = (instance != null ? instance : new V1ServiceAccountList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1ServiceAccount... items) {
    ...
    for (V1ServiceAccount item : items) {V1ServiceAccountBuilder builder = new V1ServiceAccountBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public ItemsNested<A> addNewItemLike(V1ServiceAccount item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1ServiceAccount item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1ServiceAccountBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1ServiceAccountListFluent that = (V1ServiceAccountListFluent) o;
  ...
  public class ItemsNested<N> extends V1ServiceAccountFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1ServiceAccount item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1ServiceAccountListFluent.this.withMetadata(builder.build());
    }
