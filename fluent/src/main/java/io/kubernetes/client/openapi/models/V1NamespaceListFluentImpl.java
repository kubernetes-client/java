...
public class V1NamespaceListFluentImpl<A extends io.kubernetes.client.openapi.models.V1NamespaceListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1NamespaceListFluent<A>{
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1Namespace> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Namespace item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
