...
public class V1NamespaceListFluentImpl<A extends V1NamespaceListFluent<A>> extends BaseFluent<A>
  ...
  public A addToItems(Integer index, io.kubernetes.client.openapi.models.V1Namespace item) {
    if (this.items == null) {
      this.items =
  ...
  public A removeMatchingFromItems(
      Predicate<io.kubernetes.client.openapi.models.V1NamespaceBuilder> predicate) {
