...
public class V1NamespaceListFluentImpl<A extends V1NamespaceListFluent<A>> extends BaseFluent<A>
    implements V1NamespaceListFluent<A> {
  ...
  public A addToItems(Integer index, V1Namespace item) {
    if (this.items == null) {
      this.items = new ArrayList<V1NamespaceBuilder>();
    }
  ...
  public V1NamespaceListFluent.ItemsNested<A> editMatchingItem(
      Predicate<V1NamespaceBuilder> predicate) {
    int index = -1;
  ...
  class ItemsNestedImpl<N> extends V1NamespaceFluentImpl<V1NamespaceListFluent.ItemsNested<N>>
      implements V1NamespaceListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1NamespaceListFluent.MetadataNested<N>>
      implements V1NamespaceListFluent.MetadataNested<N>, Nested<N> {
