...
public class V1beta1PodDisruptionBudgetListFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent<A> {

    private java.lang.String apiVersion;
    private java.util.List<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder> items;
    ...
    public V1beta1PodDisruptionBudgetListFluentImpl(io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetList instance) {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder builder = new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
    }

    public A setToItems(int index,io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder builder = new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder(item);
    ...
    public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder> each = items.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget buildItem(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder>(); for (io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }

    public A withItems(io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget... items) {
        if (this.items != null) {this.items.clear();}
        if (items != null) {for (io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item :items){ this.addToItems(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item) {
        return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluentImpl.ItemsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item) {
        return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluentImpl.ItemsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<A> editItem(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder(this, item);
                        
            }

            ItemsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder(this);
