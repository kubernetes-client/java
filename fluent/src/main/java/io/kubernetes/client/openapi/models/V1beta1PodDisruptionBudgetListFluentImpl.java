...
public class V1beta1PodDisruptionBudgetListFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent<A>{
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder> items;
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetFluentImpl<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item) {
      this.index = index;
