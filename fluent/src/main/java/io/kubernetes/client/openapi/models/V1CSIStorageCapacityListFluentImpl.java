...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1CSIStorageCapacity item) {
    ...
    V1CSIStorageCapacityBuilder builder = new V1CSIStorageCapacityBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1CSIStorageCapacityFluentImpl<V1CSIStorageCapacityListFluent.ItemsNested<N>> implements V1CSIStorageCapacityListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1CSIStorageCapacity item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CSIStorageCapacityListFluent.MetadataNested<N>> implements V1CSIStorageCapacityListFluent.MetadataNested<N>,Nested<N>{
