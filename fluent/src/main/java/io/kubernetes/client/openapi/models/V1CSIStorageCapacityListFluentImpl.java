...
public class V1CSIStorageCapacityListFluentImpl<A extends V1CSIStorageCapacityListFluent<A>>
  ...
  public A addToItems(Integer index, V1CSIStorageCapacity item) {
    if (this.items == null) {
      this.items = new ArrayList<V1CSIStorageCapacityBuilder>();
    }
  ...
  class ItemsNestedImpl<N>
      ...
      implements V1CSIStorageCapacityListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N>
      ...
      implements V1CSIStorageCapacityListFluent.MetadataNested<N>, Nested<N> {
