...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1beta2PriorityLevelConfigurationFluent<A extends io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationSpecFluent<io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationStatusFluent<io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
