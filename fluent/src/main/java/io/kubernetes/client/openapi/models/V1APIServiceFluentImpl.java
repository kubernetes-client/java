...
import java.lang.Object;
  ...
  */
  ...
  public V1APIServiceFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1APIServiceFluentImpl.MetadataNestedImpl();
  }
  public V1APIServiceFluentImpl.MetadataNested<A> withNewMetadataLike(V1ObjectMeta item) {
    return new V1APIServiceFluentImpl.MetadataNestedImpl(item);
  }
  public V1APIServiceFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1APIServiceFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ObjectMetaBuilder().build());
  }
  public V1APIServiceFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ObjectMeta item) {
  ...
  public V1APIServiceFluentImpl.SpecNested<A> withNewSpec() {
    return new V1APIServiceFluentImpl.SpecNestedImpl();
  }
  public V1APIServiceFluentImpl.SpecNested<A> withNewSpecLike(V1APIServiceSpec item) {
    return new V1APIServiceFluentImpl.SpecNestedImpl(item);
  }
  public V1APIServiceFluentImpl.SpecNested<A> editSpec() {
    return withNewSpecLike(getSpec());
  }
  public V1APIServiceFluentImpl.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new V1APIServiceSpecBuilder().build());
  }
  public V1APIServiceFluentImpl.SpecNested<A> editOrNewSpecLike(V1APIServiceSpec item) {
  ...
  public V1APIServiceFluentImpl.StatusNested<A> withNewStatus() {
    return new V1APIServiceFluentImpl.StatusNestedImpl();
  }
  public V1APIServiceFluentImpl.StatusNested<A> withNewStatusLike(V1APIServiceStatus item) {
    return new V1APIServiceFluentImpl.StatusNestedImpl(item);
  }
  public V1APIServiceFluentImpl.StatusNested<A> editStatus() {
    return withNewStatusLike(getStatus());
  }
  public V1APIServiceFluentImpl.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(getStatus() != null ? getStatus(): new V1APIServiceStatusBuilder().build());
  }
  public V1APIServiceFluentImpl.StatusNested<A> editOrNewStatusLike(V1APIServiceStatus item) {
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1APIServiceFluentImpl.MetadataNested<N>> implements V1APIServiceFluentImpl.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1APIServiceSpecFluentImpl<V1APIServiceFluentImpl.SpecNested<N>> implements V1APIServiceFluentImpl.SpecNested<N>,Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1APIServiceStatusFluentImpl<V1APIServiceFluentImpl.StatusNested<N>> implements V1APIServiceFluentImpl.StatusNested<N>,Nested<N>{
