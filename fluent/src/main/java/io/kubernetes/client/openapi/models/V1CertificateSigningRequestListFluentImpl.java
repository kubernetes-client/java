...
import java.lang.Object;
  ...
  */
  ...
  public class V1CertificateSigningRequestListFluentImpl<A extends V1CertificateSigningRequestListFluent<A>> extends BaseFluent<A> implements V1CertificateSigningRequestListFluent<A>{
  ...
  public A addToItems(int index,V1CertificateSigningRequest item) {
    if (this.items == null) {this.items = new ArrayList<V1CertificateSigningRequestBuilder>();}
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1CertificateSigningRequest... items) {
    if (this.items == null) {this.items = new ArrayList<V1CertificateSigningRequestBuilder>();}
    for (V1CertificateSigningRequest item : items) {V1CertificateSigningRequestBuilder builder = new V1CertificateSigningRequestBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1CertificateSigningRequest... items) {
    for (V1CertificateSigningRequest item : items) {V1CertificateSigningRequestBuilder builder = new V1CertificateSigningRequestBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
  }
  ...
  public V1CertificateSigningRequest buildItem(int index) {
  ...
  public V1CertificateSigningRequest buildMatchingItem(Predicate<V1CertificateSigningRequestBuilder> predicate) {
    for (V1CertificateSigningRequestBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public Boolean hasMatchingItem(Predicate<V1CertificateSigningRequestBuilder> predicate) {
    for (V1CertificateSigningRequestBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withItems(List<V1CertificateSigningRequest> items) {
    if (this.items != null) { _visitables.get("items").clear();}
    if (items != null) {this.items = new ArrayList(); for (V1CertificateSigningRequest item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  public A withItems(io.kubernetes.client.openapi.models.V1CertificateSigningRequest... items) {
    ...
    if (items != null) {for (V1CertificateSigningRequest item :items){ this.addToItems(item);}} return (A) this;
  }
  public Boolean hasItems() {
    return items != null && !items.isEmpty();
  }
  public V1CertificateSigningRequestListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1CertificateSigningRequestListFluentImpl.ItemsNestedImpl();
  }
  public V1CertificateSigningRequestListFluentImpl.ItemsNested<A> addNewItemLike(V1CertificateSigningRequest item) {
    return new V1CertificateSigningRequestListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1CertificateSigningRequestListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1CertificateSigningRequest item) {
    return new V1CertificateSigningRequestListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1CertificateSigningRequestListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CertificateSigningRequestListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1CertificateSigningRequestListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1CertificateSigningRequestListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1CertificateSigningRequestBuilder> predicate) {
    int index = -1;
  ...
  public V1CertificateSigningRequestListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1CertificateSigningRequestListFluentImpl.MetadataNestedImpl();
  }
  public V1CertificateSigningRequestListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1CertificateSigningRequestListFluentImpl.MetadataNestedImpl(item);
  }
  public V1CertificateSigningRequestListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1CertificateSigningRequestListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1CertificateSigningRequestListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1CertificateSigningRequestFluentImpl<V1CertificateSigningRequestListFluentImpl.ItemsNested<N>> implements V1CertificateSigningRequestListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1CertificateSigningRequest item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CertificateSigningRequestListFluentImpl.MetadataNested<N>> implements V1CertificateSigningRequestListFluentImpl.MetadataNested<N>,Nested<N>{
