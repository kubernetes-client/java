...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1CertificateSigningRequest item) {
    ...
    V1CertificateSigningRequestBuilder builder = new V1CertificateSigningRequestBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1CertificateSigningRequestFluentImpl<V1CertificateSigningRequestListFluent.ItemsNested<N>> implements V1CertificateSigningRequestListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CertificateSigningRequestListFluent.MetadataNested<N>> implements V1CertificateSigningRequestListFluent.MetadataNested<N>,Nested<N>{
