...
public class V1beta2CapacityRequirementsFluent<A extends io.kubernetes.client.openapi.models.V1beta2CapacityRequirementsFluent<A>> extends BaseFluent<A>{

  private Map<String,Quantity> requests;

  public V1beta2CapacityRequirementsFluent() {
  }
  
  public V1beta2CapacityRequirementsFluent(V1beta2CapacityRequirements instance) {
  ...
  protected void copyInstance(V1beta2CapacityRequirements instance) {
    instance = instance != null ? instance : new V1beta2CapacityRequirements();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2CapacityRequirementsFluent that = (V1beta2CapacityRequirementsFluent) o;
