...
public class V1alpha3PodSchedulingContextSpecFluent<A extends V1alpha3PodSchedulingContextSpecFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(V1alpha3PodSchedulingContextSpec instance) {
    instance = (instance != null ? instance : new V1alpha3PodSchedulingContextSpec());
    if (instance != null) {
