...
public class V1beta2FlowSchemaFluentImpl<A extends V1beta2FlowSchemaFluent<A>> extends BaseFluent<A>
  ...
  public V1beta2FlowSchemaFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(
        getSpec() != null ? getSpec() : new V1beta2FlowSchemaSpecBuilder().build());
  }
  ...
  public V1beta2FlowSchemaFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(
        getStatus() != null ? getStatus() : new V1beta2FlowSchemaStatusBuilder().build());
  }
  ...
  class MetadataNestedImpl<N>
      ...
      implements V1beta2FlowSchemaFluent.MetadataNested<N>, Nested<N> {
  ...
  class SpecNestedImpl<N>
      ...
      implements V1beta2FlowSchemaFluent.SpecNested<N>, Nested<N> {
  ...
  class StatusNestedImpl<N>
      ...
      implements V1beta2FlowSchemaFluent.StatusNested<N>, Nested<N> {
