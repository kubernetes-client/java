...
import java.lang.Object;
  ...
  */
  ...
  public class V1beta2FlowSchemaFluentImpl<A extends V1beta2FlowSchemaFluent<A>> extends BaseFluent<A> implements V1beta2FlowSchemaFluent<A>{
  ...
  public A withSpec(V1beta2FlowSchemaSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1beta2FlowSchemaSpecBuilder(spec); _visitables.get("spec").add(this.spec);} else { this.spec = null; _visitables.get("spec").remove(this.spec); } return (A) this;
  }
  ...
  public A withStatus(V1beta2FlowSchemaStatus status) {
    ...
    if (status!=null){ this.status= new V1beta2FlowSchemaStatusBuilder(status); _visitables.get("status").add(this.status);} else { this.status = null; _visitables.get("status").remove(this.status); } return (A) this;
  }
  ...
  class SpecNestedImpl<N> extends V1beta2FlowSchemaSpecFluentImpl<V1beta2FlowSchemaFluent.SpecNested<N>> implements V1beta2FlowSchemaFluent.SpecNested<N>,Nested<N>{
    ...
    SpecNestedImpl() {
      this.builder = new V1beta2FlowSchemaSpecBuilder(this);
    }
  ...
  class StatusNestedImpl<N> extends V1beta2FlowSchemaStatusFluentImpl<V1beta2FlowSchemaFluent.StatusNested<N>> implements V1beta2FlowSchemaFluent.StatusNested<N>,Nested<N>{
    ...
    StatusNestedImpl() {
      this.builder = new V1beta2FlowSchemaStatusBuilder(this);
    }
