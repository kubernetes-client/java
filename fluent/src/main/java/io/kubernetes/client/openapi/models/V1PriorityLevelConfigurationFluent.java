...
public class V1PriorityLevelConfigurationFluent<A extends io.kubernetes.client.openapi.models.V1PriorityLevelConfigurationFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V1PriorityLevelConfigurationSpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V1PriorityLevelConfigurationStatusBuilder().build()));
  }
