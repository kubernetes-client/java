...
public class V1ExecActionBuilder extends io.kubernetes.client.openapi.models.V1ExecActionFluentImpl<io.kubernetes.client.openapi.models.V1ExecActionBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1ExecAction,io.kubernetes.client.openapi.models.V1ExecActionBuilder> {
    ...
    public V1ExecActionBuilder(io.kubernetes.client.openapi.models.V1ExecActionFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1ExecAction(), validationEnabled);
    }

    public V1ExecActionBuilder(io.kubernetes.client.openapi.models.V1ExecActionFluent<?> fluent,io.kubernetes.client.openapi.models.V1ExecAction instance) {
        this(fluent, instance, true);
    }

    public V1ExecActionBuilder(io.kubernetes.client.openapi.models.V1ExecActionFluent<?> fluent,io.kubernetes.client.openapi.models.V1ExecAction instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1ExecActionBuilder(io.kubernetes.client.openapi.models.V1ExecAction instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
