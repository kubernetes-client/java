...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1DaemonSetStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1DaemonSetStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1DaemonSetStatusFluent<A>{
  public V1DaemonSetStatusFluentImpl() {
  }
  public V1DaemonSetStatusFluentImpl(io.kubernetes.client.openapi.models.V1DaemonSetStatus instance) {
  ...
  private java.util.ArrayList<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder> conditions;
  ...
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DaemonSetCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder(item);_visitables.get("conditions").add(index >= 0 ? index : _visitables.get("conditions").size(), builder);this.conditions.add(index >= 0 ? index : conditions.size(), builder); return (A)this;
  }
  public A setToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DaemonSetCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder>();}
    io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder(item);
  ...
  public A addToConditions(io.kubernetes.client.openapi.models.V1DaemonSetCondition... items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1DaemonSetCondition item : items) {io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeFromConditions(io.kubernetes.client.openapi.models.V1DaemonSetCondition... items) {
    for (io.kubernetes.client.openapi.models.V1DaemonSetCondition item : items) {io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder(item);_visitables.get("conditions").remove(builder);if (this.conditions != null) {this.conditions.remove(builder);}} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder> each = conditions.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1DaemonSetCondition buildCondition(java.lang.Integer index) {
  ...
  public io.kubernetes.client.openapi.models.V1DaemonSetCondition buildMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder item: conditions) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder item: conditions) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withConditions(java.util.List<io.kubernetes.client.openapi.models.V1DaemonSetCondition> conditions) {
    ...
    if (conditions != null) {this.conditions = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1DaemonSetCondition item : conditions){this.addToConditions(item);}} else { this.conditions = null;} return (A) this;
  }
  public A withConditions(io.kubernetes.client.openapi.models.V1DaemonSetCondition... conditions) {
    if (this.conditions != null) {this.conditions.clear();}
    if (conditions != null) {for (io.kubernetes.client.openapi.models.V1DaemonSetCondition item :conditions){ this.addToConditions(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1DaemonSetStatusFluent.ConditionsNested<A> addNewConditionLike(io.kubernetes.client.openapi.models.V1DaemonSetCondition item) {
    return new io.kubernetes.client.openapi.models.V1DaemonSetStatusFluentImpl.ConditionsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1DaemonSetStatusFluent.ConditionsNested<A> setNewConditionLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DaemonSetCondition item) {
    return new io.kubernetes.client.openapi.models.V1DaemonSetStatusFluentImpl.ConditionsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1DaemonSetStatusFluent.ConditionsNested<A> editCondition(java.lang.Integer index) {
  ...
  public class ConditionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1DaemonSetConditionFluentImpl<io.kubernetes.client.openapi.models.V1DaemonSetStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ConditionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1DaemonSetCondition item) {
      this.index = index;
      this.builder = new io.kubernetes.client.openapi.models.V1DaemonSetConditionBuilder(this, item);
    }
