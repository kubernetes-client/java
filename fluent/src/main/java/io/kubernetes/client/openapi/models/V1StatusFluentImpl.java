...
public class V1StatusFluentImpl<A extends io.kubernetes.client.openapi.models.V1StatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1StatusFluent<A> {
    ...
    public A withDetails(io.kubernetes.client.openapi.models.V1StatusDetails details) {
        ...
        if (details!=null){ this.details= new io.kubernetes.client.openapi.models.V1StatusDetailsBuilder(details); _visitables.get("details").add(this.details);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1StatusFluent.DetailsNested<A> editOrNewDetails() {
        return withNewDetailsLike(getDetails() != null ? getDetails(): new io.kubernetes.client.openapi.models.V1StatusDetailsBuilder().build());
    }
    ...
    public class DetailsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1StatusDetailsFluentImpl<io.kubernetes.client.openapi.models.V1StatusFluent.DetailsNested<N>> implements io.kubernetes.client.openapi.models.V1StatusFluent.DetailsNested<N>,io.kubernetes.client.fluent.Nested<N> {
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1StatusFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1StatusFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
