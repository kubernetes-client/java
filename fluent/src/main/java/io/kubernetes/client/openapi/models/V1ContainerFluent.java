...
public interface V1ContainerFluent<A extends V1ContainerFluent<A>> extends Fluent<A>{
  ...
  public interface EnvFromNested<N> extends Nested<N>,V1EnvFromSourceFluent<V1ContainerFluent.EnvFromNested<N>>{
    public N and();
    public N endEnvFrom();
    
  }
  public interface LifecycleNested<N> extends Nested<N>,V1LifecycleFluent<V1ContainerFluent.LifecycleNested<N>>{
    public N and();
    public N endLifecycle();
    
  }
  public interface LivenessProbeNested<N> extends Nested<N>,V1ProbeFluent<V1ContainerFluent.LivenessProbeNested<N>>{
    public N and();
    public N endLivenessProbe();
    
  }
  public interface PortsNested<N> extends Nested<N>,V1ContainerPortFluent<V1ContainerFluent.PortsNested<N>>{
    public N and();
    public N endPort();
  ...
  public interface SecurityContextNested<N> extends Nested<N>,V1SecurityContextFluent<V1ContainerFluent.SecurityContextNested<N>>{
    public N and();
    public N endSecurityContext();
    
  }
  public interface StartupProbeNested<N> extends Nested<N>,V1ProbeFluent<V1ContainerFluent.StartupProbeNested<N>>{
    public N and();
    public N endStartupProbe();
    
  }
  public interface VolumeDevicesNested<N> extends Nested<N>,V1VolumeDeviceFluent<V1ContainerFluent.VolumeDevicesNested<N>>{
    public N and();
    public N endVolumeDevice();
    
  }
  public interface VolumeMountsNested<N> extends Nested<N>,V1VolumeMountFluent<V1ContainerFluent.VolumeMountsNested<N>>{
    public N and();
