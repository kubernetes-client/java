...
public interface V1ContainerFluent<A extends V1ContainerFluent<A>> extends Fluent<A> {
  ...
  public interface EnvFromNested<N>
      extends Nested<N>, V1EnvFromSourceFluent<V1ContainerFluent.EnvFromNested<N>> {
    public N and();
  ...
  public interface LifecycleNested<N>
      extends Nested<N>, V1LifecycleFluent<V1ContainerFluent.LifecycleNested<N>> {
    public N and();
  ...
  public interface LivenessProbeNested<N>
      extends Nested<N>, V1ProbeFluent<V1ContainerFluent.LivenessProbeNested<N>> {
    public N and();
  ...
  public interface PortsNested<N>
      extends Nested<N>, V1ContainerPortFluent<V1ContainerFluent.PortsNested<N>> {
    public N and();
  ...
  public interface ReadinessProbeNested<N>
      extends Nested<N>, V1ProbeFluent<V1ContainerFluent.ReadinessProbeNested<N>> {
    public N and();
  ...
  public interface ResourcesNested<N>
      extends Nested<N>, V1ResourceRequirementsFluent<V1ContainerFluent.ResourcesNested<N>> {
    public N and();
  ...
  public interface StartupProbeNested<N>
      extends Nested<N>, V1ProbeFluent<V1ContainerFluent.StartupProbeNested<N>> {
    public N and();
  ...
  public interface VolumeDevicesNested<N>
      extends Nested<N>, V1VolumeDeviceFluent<V1ContainerFluent.VolumeDevicesNested<N>> {
    public N and();
