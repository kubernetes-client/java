...
public class V1DeviceRequestAllocationResultFluent<A extends io.kubernetes.client.openapi.models.V1DeviceRequestAllocationResultFluent<A>> extends BaseFluent<A>{
  public V1DeviceRequestAllocationResultFluent() {
  }
  
  public V1DeviceRequestAllocationResultFluent(V1DeviceRequestAllocationResult instance) {
  ...
  protected void copyInstance(V1DeviceRequestAllocationResult instance) {
    instance = instance != null ? instance : new V1DeviceRequestAllocationResult();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1DeviceRequestAllocationResultFluent that = (V1DeviceRequestAllocationResultFluent) o;
  ...
  public class TolerationsNested<N> extends V1DeviceTolerationFluent<TolerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1DeviceRequestAllocationResultFluent.this.setToTolerations(index, builder.build());
    }
