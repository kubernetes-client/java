...
public class V1beta2AllocatedDeviceStatusFluent<A extends io.kubernetes.client.openapi.models.V1beta2AllocatedDeviceStatusFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta2AllocatedDeviceStatusFluent(V1beta2AllocatedDeviceStatus instance) {
  ...
  public V1beta2NetworkDeviceData buildNetworkData() {
    return this.networkData != null ? this.networkData.build() : null;
  }
  
  public A withNetworkData(V1beta2NetworkDeviceData networkData) {
    this._visitables.remove("networkData");
    if (networkData != null) {
        this.networkData = new V1beta2NetworkDeviceDataBuilder(networkData);
  ...
  public NetworkDataNested<A> withNewNetworkDataLike(V1beta2NetworkDeviceData item) {
  ...
  public class NetworkDataNested<N> extends V1beta2NetworkDeviceDataFluent<NetworkDataNested<N>> implements Nested<N>{
    NetworkDataNested(V1beta2NetworkDeviceData item) {
      this.builder = new V1beta2NetworkDeviceDataBuilder(this, item);
    }
    V1beta2NetworkDeviceDataBuilder builder;
    
    public N and() {
      return (N) V1beta2AllocatedDeviceStatusFluent.this.withNetworkData(builder.build());
    }
