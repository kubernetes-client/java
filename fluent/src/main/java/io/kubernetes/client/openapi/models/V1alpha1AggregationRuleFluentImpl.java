...
public class V1alpha1AggregationRuleFluentImpl<A extends io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent<A> {
    ...
    public V1alpha1AggregationRuleFluentImpl(io.kubernetes.client.openapi.models.V1alpha1AggregationRule instance) {
    ...
    public io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent.ClusterRoleSelectorsNested<A> addNewClusterRoleSelector() {
        return new io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluentImpl.ClusterRoleSelectorsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent.ClusterRoleSelectorsNested<A> addNewClusterRoleSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
        return new io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluentImpl.ClusterRoleSelectorsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent.ClusterRoleSelectorsNested<A> setNewClusterRoleSelectorLike(int index,io.kubernetes.client.openapi.models.V1LabelSelector item) {
        return new io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluentImpl.ClusterRoleSelectorsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent.ClusterRoleSelectorsNested<A> editClusterRoleSelector(int index) {
    ...
    public class ClusterRoleSelectorsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LabelSelectorFluentImpl<io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent.ClusterRoleSelectorsNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1AggregationRuleFluent.ClusterRoleSelectorsNested<N>,io.kubernetes.client.fluent.Nested<N> {
