...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1LimitRange item) {
    ...
    V1LimitRangeBuilder builder = new V1LimitRangeBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1LimitRangeFluentImpl<V1LimitRangeListFluent.ItemsNested<N>> implements V1LimitRangeListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1LimitRangeListFluent.MetadataNested<N>> implements V1LimitRangeListFluent.MetadataNested<N>,Nested<N>{
