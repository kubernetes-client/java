...
public class V1LimitRangeListFluentImpl<A extends io.kubernetes.client.openapi.models.V1LimitRangeListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1LimitRangeListFluent<A>{
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1LimitRange> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1LimitRange item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1LimitRangeFluentImpl<io.kubernetes.client.openapi.models.V1LimitRangeListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1LimitRangeListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1LimitRange item) {
      this.index = index;
