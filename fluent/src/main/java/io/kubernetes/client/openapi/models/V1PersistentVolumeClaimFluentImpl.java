...
public class V1PersistentVolumeClaimFluentImpl<A extends V1PersistentVolumeClaimFluent<A>>
  ...
  public V1PersistentVolumeClaimFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(
        getStatus() != null ? getStatus() : new V1PersistentVolumeClaimStatusBuilder().build());
  }
  ...
  class MetadataNestedImpl<N>
      ...
      implements V1PersistentVolumeClaimFluent.MetadataNested<N>, Nested<N> {
  ...
  class SpecNestedImpl<N>
      ...
      implements V1PersistentVolumeClaimFluent.SpecNested<N>, Nested<N> {
  ...
  class StatusNestedImpl<N>
      ...
      implements V1PersistentVolumeClaimFluent.StatusNested<N>, Nested<N> {
