...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1PersistentVolumeClaimFluentImpl<A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent<A>{
  public V1PersistentVolumeClaimFluentImpl() {
  }
  public V1PersistentVolumeClaimFluentImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeClaim instance) {
  ...
  private io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder status;
  ...
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.MetadataNested<A> withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpec spec) {
    ...
    if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  public java.lang.Boolean hasSpec() {
    return this.spec != null;
  }
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<A> withNewSpec() {
    return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl.SpecNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpec item) {
    return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl.SpecNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpecBuilder().build());
  }
   ...
   */
  @java.lang.Deprecated
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatus getStatus() {
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatus status) {
    ...
    if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  public java.lang.Boolean hasStatus() {
    return this.status != null;
  }
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<A> withNewStatus() {
    return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl.StatusNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatus item) {
    return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl.StatusNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder().build());
  }
  ...
  public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpecFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
    SpecNestedImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpec item) {
      this.builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpecBuilder(this, item);
    }
    SpecNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpecBuilder(this);
    }
  ...
  public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusFluentImpl<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
    StatusNestedImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatus item) {
      this.builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder(this, item);
    }
    StatusNestedImpl() {
      this.builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder(this);
    }
    io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder builder;
    public N and() {
