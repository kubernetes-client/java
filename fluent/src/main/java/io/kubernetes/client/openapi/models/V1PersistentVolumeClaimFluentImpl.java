...
/** Generated */
public class V1PersistentVolumeClaimFluentImpl<
        A extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent<A>>
    extends io.kubernetes.client.fluent.BaseFluent<A>
    implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent<A> {
  public V1PersistentVolumeClaimFluentImpl() {}

  public V1PersistentVolumeClaimFluentImpl(
      io.kubernetes.client.openapi.models.V1PersistentVolumeClaim instance) {
  ...
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.MetadataNested<A>
      withNewMetadata() {
    return new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluentImpl
        .MetadataNestedImpl();
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatus status) {
    ...
    if (status != null) {
      this.status =
          new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder(status);
  ...
  public io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<A>
    ...
    return withNewStatusLike(
        getStatus() != null
            ? getStatus()
            : new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder()
                .build());
  }
  ...
  public class MetadataNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<
          io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.MetadataNested<N>>
      implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.MetadataNested<
              N>,
  ...
  public class SpecNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpecFluentImpl<
          io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<N>>
      implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
  ...
  public class StatusNestedImpl<N>
      extends io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusFluentImpl<
          io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<N>>
      implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<N>,
          io.kubernetes.client.fluent.Nested<N> {
    StatusNestedImpl(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatus item) {
      this.builder =
          new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder(this, item);
    }

    StatusNestedImpl() {
      this.builder =
          new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimStatusBuilder(this);
    }
