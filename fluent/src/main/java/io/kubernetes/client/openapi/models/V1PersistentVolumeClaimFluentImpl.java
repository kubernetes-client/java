...
public class V1PersistentVolumeClaimFluentImpl<A extends V1PersistentVolumeClaimFluent<A>>
    extends BaseFluent<A> implements V1PersistentVolumeClaimFluent<A> {
  ...
  class MetadataNestedImpl<N>
      extends V1ObjectMetaFluentImpl<V1PersistentVolumeClaimFluent.MetadataNested<N>>
  ...
  class SpecNestedImpl<N>
      extends V1PersistentVolumeClaimSpecFluentImpl<V1PersistentVolumeClaimFluent.SpecNested<N>>
  ...
  class StatusNestedImpl<N>
      extends V1PersistentVolumeClaimStatusFluentImpl<V1PersistentVolumeClaimFluent.StatusNested<N>>
