...
public interface V1TokenReviewFluent<A extends V1TokenReviewFluent<A>> extends Fluent<A> {
  ...
  public interface SpecNested<N>
      extends Nested<N>, V1TokenReviewSpecFluent<V1TokenReviewFluent.SpecNested<N>> {
    public N and();
  ...
  public interface StatusNested<N>
      extends Nested<N>, V1TokenReviewStatusFluent<V1TokenReviewFluent.StatusNested<N>> {
    public N and();
