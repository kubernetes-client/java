...
public class V1beta2ServiceAccountSubjectBuilder
    ...
    implements VisitableBuilder<V1beta2ServiceAccountSubject, V1beta2ServiceAccountSubjectBuilder> {
  ...
  public V1beta2ServiceAccountSubjectBuilder(
      V1beta2ServiceAccountSubjectFluent<?> fluent, Boolean validationEnabled) {
    this(fluent, new V1beta2ServiceAccountSubject(), validationEnabled);
  }

  public V1beta2ServiceAccountSubjectBuilder(
      V1beta2ServiceAccountSubjectFluent<?> fluent, V1beta2ServiceAccountSubject instance) {
  ...
  public V1beta2ServiceAccountSubjectBuilder(
      V1beta2ServiceAccountSubject instance, Boolean validationEnabled) {
    this.fluent = this;
