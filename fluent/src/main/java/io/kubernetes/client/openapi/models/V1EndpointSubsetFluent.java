...
public interface V1EndpointSubsetFluent<A extends io.kubernetes.client.openapi.models.V1EndpointSubsetFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface PortsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.CoreV1EndpointPortFluent<io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<N>>{
    public N and();
    public N endPort();
