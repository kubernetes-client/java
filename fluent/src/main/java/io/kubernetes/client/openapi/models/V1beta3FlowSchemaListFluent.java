...
public class V1beta3FlowSchemaListFluent<A extends V1beta3FlowSchemaListFluent<A>> extends BaseFluent<A>{
  public V1beta3FlowSchemaListFluent() {
  }
  
  public V1beta3FlowSchemaListFluent(V1beta3FlowSchemaList instance) {
  ...
  protected void copyInstance(V1beta3FlowSchemaList instance) {
    instance = (instance != null ? instance : new V1beta3FlowSchemaList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1beta3FlowSchema... items) {
    ...
    for (V1beta3FlowSchema item : items) {V1beta3FlowSchemaBuilder builder = new V1beta3FlowSchemaBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1beta3FlowSchema buildMatchingItem(Predicate<V1beta3FlowSchemaBuilder> predicate) {
      for (V1beta3FlowSchemaBuilder item : items) {
  ...
  public A withItems(List<V1beta3FlowSchema> items) {
    ...
    if (items != null) {
        ...
        for (V1beta3FlowSchema item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1beta3FlowSchema item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1beta3FlowSchema item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1beta3FlowSchemaBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1beta3FlowSchemaListFluent that = (V1beta3FlowSchemaListFluent) o;
  ...
  public class ItemsNested<N> extends V1beta3FlowSchemaFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1beta3FlowSchema item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1beta3FlowSchemaListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta3FlowSchemaListFluent.this.withMetadata(builder.build());
    }
