...
public class V1beta1DeviceAllocationConfigurationFluent<A extends V1beta1DeviceAllocationConfigurationFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta1DeviceAllocationConfigurationFluent(V1beta1DeviceAllocationConfiguration instance) {
  ...
  public class OpaqueNested<N> extends V1beta1OpaqueDeviceConfigurationFluent<OpaqueNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1beta1DeviceAllocationConfigurationFluent.this.withOpaque(builder.build());
    }
