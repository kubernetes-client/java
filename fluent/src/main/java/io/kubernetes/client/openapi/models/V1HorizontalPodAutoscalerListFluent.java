...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1HorizontalPodAutoscalerListFluent<A extends V1HorizontalPodAutoscalerListFluent<A>> extends Fluent<A>{
  ...
  public interface ItemsNested<N> extends Nested<N>,V1HorizontalPodAutoscalerFluent<V1HorizontalPodAutoscalerListFluent.ItemsNested<N>>{
    public N and();
    public N endItem();
    
  }
  public interface MetadataNested<N> extends Nested<N>,V1ListMetaFluent<V1HorizontalPodAutoscalerListFluent.MetadataNested<N>>{
    public N and();
