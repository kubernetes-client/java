...
public class V1HorizontalPodAutoscalerListFluent<A extends io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1HorizontalPodAutoscalerBuilder> predicate) {
    ...
    Iterator<V1HorizontalPodAutoscalerBuilder> each = items.iterator();
