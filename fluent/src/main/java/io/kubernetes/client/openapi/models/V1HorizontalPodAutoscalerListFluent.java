...
public class V1HorizontalPodAutoscalerListFluent<A extends V1HorizontalPodAutoscalerListFluent<A>> extends BaseFluent<A>{
  public V1HorizontalPodAutoscalerListFluent() {
  }
  
  public V1HorizontalPodAutoscalerListFluent(V1HorizontalPodAutoscalerList instance) {
  ...
  protected void copyInstance(V1HorizontalPodAutoscalerList instance) {
    instance = (instance != null ? instance : new V1HorizontalPodAutoscalerList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscaler... items) {
    ...
    for (V1HorizontalPodAutoscaler item : items) {V1HorizontalPodAutoscalerBuilder builder = new V1HorizontalPodAutoscalerBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1HorizontalPodAutoscaler buildMatchingItem(Predicate<V1HorizontalPodAutoscalerBuilder> predicate) {
      for (V1HorizontalPodAutoscalerBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1HorizontalPodAutoscaler item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1HorizontalPodAutoscaler item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1HorizontalPodAutoscalerBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1HorizontalPodAutoscalerListFluent that = (V1HorizontalPodAutoscalerListFluent) o;
  ...
  public class ItemsNested<N> extends V1HorizontalPodAutoscalerFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1HorizontalPodAutoscaler item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1HorizontalPodAutoscalerListFluent.this.withMetadata(builder.build());
    }
