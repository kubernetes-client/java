...
import java.lang.Object;
  ...
  */
  ...
  public V1IngressClassListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1IngressClassListFluentImpl.ItemsNestedImpl();
  }
  public V1IngressClassListFluentImpl.ItemsNested<A> addNewItemLike(V1IngressClass item) {
    return new V1IngressClassListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1IngressClassListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1IngressClass item) {
    return new V1IngressClassListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1IngressClassListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1IngressClassListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1IngressClassListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1IngressClassListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1IngressClassBuilder> predicate) {
    int index = -1;
  ...
  public V1IngressClassListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1IngressClassListFluentImpl.MetadataNestedImpl();
  }
  public V1IngressClassListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1IngressClassListFluentImpl.MetadataNestedImpl(item);
  }
  public V1IngressClassListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1IngressClassListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1IngressClassListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1IngressClassFluentImpl<V1IngressClassListFluentImpl.ItemsNested<N>> implements V1IngressClassListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1IngressClass item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1IngressClassListFluentImpl.MetadataNested<N>> implements V1IngressClassListFluentImpl.MetadataNested<N>,Nested<N>{
