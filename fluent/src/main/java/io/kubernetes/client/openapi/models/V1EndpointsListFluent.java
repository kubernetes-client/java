...
public class V1EndpointsListFluent<A extends io.kubernetes.client.openapi.models.V1EndpointsListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1EndpointsBuilder> predicate) {
    ...
    Iterator<V1EndpointsBuilder> each = items.iterator();
