...
public class V1EndpointsListFluent<A extends V1EndpointsListFluent<A>> extends BaseFluent<A>{
  public V1EndpointsListFluent() {
  }
  
  public V1EndpointsListFluent(V1EndpointsList instance) {
  ...
  protected void copyInstance(V1EndpointsList instance) {
  ...
  public A addToItems(io.kubernetes.client.openapi.models.V1Endpoints... items) {
    if (this.items == null) {this.items = new ArrayList<V1EndpointsBuilder>();}
    for (V1Endpoints item : items) {V1EndpointsBuilder builder = new V1EndpointsBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Endpoints... items) {
    ...
    for (V1Endpoints item : items) {V1EndpointsBuilder builder = new V1EndpointsBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<V1EndpointsBuilder> predicate) {
    ...
    final Iterator<V1EndpointsBuilder> each = items.iterator();
    final List visitables = _visitables.get("items");
    while (each.hasNext()) {
      V1EndpointsBuilder builder = each.next();
  ...
  public V1Endpoints buildMatchingItem(Predicate<V1EndpointsBuilder> predicate) {
      for (V1EndpointsBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1Endpoints item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1Endpoints item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1EndpointsBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1EndpointsListFluent that = (V1EndpointsListFluent) o;
  ...
  public class ItemsNested<N> extends V1EndpointsFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1Endpoints item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1EndpointsListFluent.this.withMetadata(builder.build());
    }
