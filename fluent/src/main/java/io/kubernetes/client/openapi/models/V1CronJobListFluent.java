...
public class V1CronJobListFluent<A extends V1CronJobListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1CronJob... items) {
    ...
    for (V1CronJob item : items) {V1CronJobBuilder builder = new V1CronJobBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
