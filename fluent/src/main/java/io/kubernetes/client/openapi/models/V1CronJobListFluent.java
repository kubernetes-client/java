...
public class V1CronJobListFluent<A extends io.kubernetes.client.openapi.models.V1CronJobListFluent<A>> extends BaseFluent<A>{
  public V1CronJobListFluent() {
  }
  
  public V1CronJobListFluent(V1CronJobList instance) {
  ...
  protected void copyInstance(V1CronJobList instance) {
    instance = instance != null ? instance : new V1CronJobList();
    if (instance != null) {
  ...
  public A addToItems(V1CronJob... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1CronJob item : items) {
        V1CronJobBuilder builder = new V1CronJobBuilder(item);
        _visitables.get("items").add(builder);
  ...
  public A removeFromItems(V1CronJob... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1CronJob item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1CronJobBuilder> predicate) {
    ...
    Iterator<V1CronJobBuilder> each = items.iterator();
  ...
  public V1CronJob buildMatchingItem(Predicate<V1CronJobBuilder> predicate) {
      for (V1CronJobBuilder item : items) {
  ...
  public A withItems(V1CronJob... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public ItemsNested<A> addNewItemLike(V1CronJob item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1CronJob item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1CronJobBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1CronJobListFluent that = (V1CronJobListFluent) o;
  ...
  public class ItemsNested<N> extends V1CronJobFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1CronJob item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1CronJobListFluent.this.withMetadata(builder.build());
    }
