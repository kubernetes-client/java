...
public class V1MutatingAdmissionPolicySpecFluent<A extends io.kubernetes.client.openapi.models.V1MutatingAdmissionPolicySpecFluent<A>> extends BaseFluent<A>{

  private String failurePolicy;
  private ArrayList<V1MatchConditionBuilder> matchConditions;
  private V1MatchResourcesBuilder matchConstraints;
  private ArrayList<V1MutationBuilder> mutations;
  private V1ParamKindBuilder paramKind;
  private String reinvocationPolicy;
  private ArrayList<V1VariableBuilder> variables;

  public V1MutatingAdmissionPolicySpecFluent() {
  }
  
  public V1MutatingAdmissionPolicySpecFluent(V1MutatingAdmissionPolicySpec instance) {
  ...
  public A addAllToMutations(Collection<V1Mutation> items) {
    if (this.mutations == null) {
      this.mutations = new ArrayList();
    }
    for (V1Mutation item : items) {
        V1MutationBuilder builder = new V1MutationBuilder(item);
  ...
  public MutationsNested<A> addNewMutationLike(V1Mutation item) {
  ...
  public A addToMutations(V1Mutation... items) {
    if (this.mutations == null) {
      this.mutations = new ArrayList();
    }
    for (V1Mutation item : items) {
  ...
  public A addToMutations(int index,V1Mutation item) {
    if (this.mutations == null) {
      this.mutations = new ArrayList();
    }
    V1MutationBuilder builder = new V1MutationBuilder(item);
  ...
  public V1Mutation buildFirstMutation() {
  ...
  public V1Mutation buildLastMutation() {
  ...
  public V1Mutation buildMatchingMutation(Predicate<V1MutationBuilder> predicate) {
      for (V1MutationBuilder item : mutations) {
        if (predicate.test(item)) {
          return item.build();
        }
      }
  ...
  public V1Mutation buildMutation(int index) {
    return this.mutations.get(index).build();
  }
  
  public List<V1Mutation> buildMutations() {
  ...
  protected void copyInstance(V1MutatingAdmissionPolicySpec instance) {
    instance = instance != null ? instance : new V1MutatingAdmissionPolicySpec();
    if (instance != null) {
  ...
  public MutationsNested<A> editMatchingMutation(Predicate<V1MutationBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1MutatingAdmissionPolicySpecFluent that = (V1MutatingAdmissionPolicySpecFluent) o;
  ...
  public boolean hasMatchingMutation(Predicate<V1MutationBuilder> predicate) {
      for (V1MutationBuilder item : mutations) {
        if (predicate.test(item)) {
          return true;
        }
  ...
  public A removeAllFromMutations(Collection<V1Mutation> items) {
    if (this.mutations == null) {
      return (A) this;
    }
    for (V1Mutation item : items) {
  ...
  public A removeFromMutations(V1Mutation... items) {
    if (this.mutations == null) {
      return (A) this;
    }
    for (V1Mutation item : items) {
  ...
  public A removeMatchingFromMutations(Predicate<V1MutationBuilder> predicate) {
    if (mutations == null) {
      return (A) this;
    }
    Iterator<V1MutationBuilder> each = mutations.iterator();
    List visitables = this._visitables.get("mutations");
    while (each.hasNext()) {
        V1MutationBuilder builder = each.next();
        if (predicate.test(builder)) {
            visitables.remove(builder);
            each.remove();
        }
  ...
  public MutationsNested<A> setNewMutationLike(int index,V1Mutation item) {
  ...
  public A setToMutations(int index,V1Mutation item) {
    if (this.mutations == null) {
      this.mutations = new ArrayList();
    }
    V1MutationBuilder builder = new V1MutationBuilder(item);
  ...
  public A withMutations(List<V1Mutation> mutations) {
    if (this.mutations != null) {
      this._visitables.get("mutations").clear();
    }
    if (mutations != null) {
        this.mutations = new ArrayList();
        for (V1Mutation item : mutations) {
  ...
  public A withMutations(V1Mutation... mutations) {
    if (this.mutations != null) {
  ...
  public class MatchConditionsNested<N> extends V1MatchConditionFluent<MatchConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1MutatingAdmissionPolicySpecFluent.this.setToMatchConditions(index, builder.build());
    }
  ...
  public class MatchConstraintsNested<N> extends V1MatchResourcesFluent<MatchConstraintsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1MutatingAdmissionPolicySpecFluent.this.withMatchConstraints(builder.build());
    }
  ...
  public class MutationsNested<N> extends V1MutationFluent<MutationsNested<N>> implements Nested<N>{
  
    V1MutationBuilder builder;
    int index;
  
    MutationsNested(int index,V1Mutation item) {
      this.index = index;
      this.builder = new V1MutationBuilder(this, item);
    }
  
    public N and() {
      return (N) V1MutatingAdmissionPolicySpecFluent.this.setToMutations(index, builder.build());
    }
  ...
  public class ParamKindNested<N> extends V1ParamKindFluent<ParamKindNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1MutatingAdmissionPolicySpecFluent.this.withParamKind(builder.build());
    }
  ...
  public class VariablesNested<N> extends V1VariableFluent<VariablesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1MutatingAdmissionPolicySpecFluent.this.setToVariables(index, builder.build());
    }
