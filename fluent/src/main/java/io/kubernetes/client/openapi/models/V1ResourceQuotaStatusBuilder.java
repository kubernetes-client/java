...
public class V1ResourceQuotaStatusBuilder extends io.kubernetes.client.openapi.models.V1ResourceQuotaStatusFluentImpl<io.kubernetes.client.openapi.models.V1ResourceQuotaStatusBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1ResourceQuotaStatus,io.kubernetes.client.openapi.models.V1ResourceQuotaStatusBuilder> {
    ...
    public V1ResourceQuotaStatusBuilder(io.kubernetes.client.openapi.models.V1ResourceQuotaStatusFluent<?> fluent) {
        this(fluent, true);
    }

    public V1ResourceQuotaStatusBuilder(io.kubernetes.client.openapi.models.V1ResourceQuotaStatusFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1ResourceQuotaStatus(), validationEnabled);
    }

    public V1ResourceQuotaStatusBuilder(io.kubernetes.client.openapi.models.V1ResourceQuotaStatusFluent<?> fluent,io.kubernetes.client.openapi.models.V1ResourceQuotaStatus instance) {
        this(fluent, instance, true);
    }

    public V1ResourceQuotaStatusBuilder(io.kubernetes.client.openapi.models.V1ResourceQuotaStatusFluent<?> fluent,io.kubernetes.client.openapi.models.V1ResourceQuotaStatus instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1ResourceQuotaStatusBuilder(io.kubernetes.client.openapi.models.V1ResourceQuotaStatus instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
