...
public class V1APIServiceListFluent<A extends V1APIServiceListFluent<A>> extends BaseFluent<A>{
  public V1APIServiceListFluent() {
  }
  
  public V1APIServiceListFluent(V1APIServiceList instance) {
  ...
  protected void copyInstance(V1APIServiceList instance) {
    instance = (instance != null ? instance : new V1APIServiceList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1APIService... items) {
    ...
    for (V1APIService item : items) {V1APIServiceBuilder builder = new V1APIServiceBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1APIService buildMatchingItem(Predicate<V1APIServiceBuilder> predicate) {
      for (V1APIServiceBuilder item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1APIService item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1APIService item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1APIServiceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1APIServiceListFluent that = (V1APIServiceListFluent) o;
  ...
  public class ItemsNested<N> extends V1APIServiceFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1APIService item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1APIServiceListFluent.this.setToItems(index,builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1APIServiceListFluent.this.withMetadata(builder.build());
    }
