...
public class V1APIServiceListFluent<A extends io.kubernetes.client.openapi.models.V1APIServiceListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1APIServiceBuilder> predicate) {
    ...
    Iterator<V1APIServiceBuilder> each = items.iterator();
