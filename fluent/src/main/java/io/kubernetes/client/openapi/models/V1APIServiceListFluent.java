...
public interface V1APIServiceListFluent<A extends io.kubernetes.client.openapi.models.V1APIServiceListFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1APIService item);
    public A setToItems(int index,io.kubernetes.client.openapi.models.V1APIService item);
    ...
    public io.kubernetes.client.openapi.models.V1APIService buildItem(int index);
    ...
    public io.kubernetes.client.openapi.models.V1APIServiceListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1APIService item);
    public io.kubernetes.client.openapi.models.V1APIServiceListFluent.ItemsNested<A> editItem(int index);
    ...
    public interface ItemsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1APIServiceFluent<io.kubernetes.client.openapi.models.V1APIServiceListFluent.ItemsNested<N>> {

            public N and();
            public N endItem();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ListMetaFluent<io.kubernetes.client.openapi.models.V1APIServiceListFluent.MetadataNested<N>> {
