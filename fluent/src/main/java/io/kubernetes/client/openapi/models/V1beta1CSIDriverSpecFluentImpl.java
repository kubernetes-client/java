...
public class V1beta1CSIDriverSpecFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluent<A> {
    ...
    private java.util.List<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder> tokenRequests;
    private java.util.List<java.lang.String> volumeLifecycleModes;

    public V1beta1CSIDriverSpecFluentImpl() {
    }

    public V1beta1CSIDriverSpecFluentImpl(io.kubernetes.client.openapi.models.V1beta1CSIDriverSpec instance) {
    ...
    public A addToTokenRequests(int index,io.kubernetes.client.openapi.models.V1beta1TokenRequest item) {
        if (this.tokenRequests == null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder(item);_visitables.get("tokenRequests").add(index >= 0 ? index : _visitables.get("tokenRequests").size(), builder);this.tokenRequests.add(index >= 0 ? index : tokenRequests.size(), builder); return (A)this;
    }

    public A setToTokenRequests(int index,io.kubernetes.client.openapi.models.V1beta1TokenRequest item) {
        if (this.tokenRequests == null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder(item);
    ...
    public A addToTokenRequests(io.kubernetes.client.openapi.models.V1beta1TokenRequest... items) {
        if (this.tokenRequests == null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder>();}
        for (io.kubernetes.client.openapi.models.V1beta1TokenRequest item : items) {io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder(item);_visitables.get("tokenRequests").add(builder);this.tokenRequests.add(builder);} return (A)this;
    }
    ...
    public A removeFromTokenRequests(io.kubernetes.client.openapi.models.V1beta1TokenRequest... items) {
        for (io.kubernetes.client.openapi.models.V1beta1TokenRequest item : items) {io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder builder = new io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder(item);_visitables.get("tokenRequests").remove(builder);if (this.tokenRequests != null) {this.tokenRequests.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromTokenRequests(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder> each = tokenRequests.iterator();
        final List visitables = _visitables.get("tokenRequests");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.V1beta1TokenRequest buildMatchingTokenRequest(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder item: tokenRequests) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingTokenRequest(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder item: tokenRequests) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withTokenRequests(java.util.List<io.kubernetes.client.openapi.models.V1beta1TokenRequest> tokenRequests) {
        ...
        if (tokenRequests != null) {this.tokenRequests = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder>(); for (io.kubernetes.client.openapi.models.V1beta1TokenRequest item : tokenRequests){this.addToTokenRequests(item);}} else { this.tokenRequests = null;} return (A) this;
    }
    ...
    public A withTokenRequests(io.kubernetes.client.openapi.models.V1beta1TokenRequest... tokenRequests) {
        ...
        if (tokenRequests != null) {for (io.kubernetes.client.openapi.models.V1beta1TokenRequest item :tokenRequests){ this.addToTokenRequests(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluent.TokenRequestsNested<A> addNewTokenRequest() {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluentImpl.TokenRequestsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluent.TokenRequestsNested<A> addNewTokenRequestLike(io.kubernetes.client.openapi.models.V1beta1TokenRequest item) {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluentImpl.TokenRequestsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluent.TokenRequestsNested<A> setNewTokenRequestLike(int index,io.kubernetes.client.openapi.models.V1beta1TokenRequest item) {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluentImpl.TokenRequestsNestedImpl(index, item);
    }
    ...
    public class TokenRequestsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1TokenRequestFluentImpl<io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluent.TokenRequestsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CSIDriverSpecFluent.TokenRequestsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            TokenRequestsNestedImpl(int index,io.kubernetes.client.openapi.models.V1beta1TokenRequest item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder(this, item);
                        
            }

            TokenRequestsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1TokenRequestBuilder(this);
                        
            }

            public N and() {
                return (N) V1beta1CSIDriverSpecFluentImpl.this.setToTokenRequests(index,builder.build());
            }
