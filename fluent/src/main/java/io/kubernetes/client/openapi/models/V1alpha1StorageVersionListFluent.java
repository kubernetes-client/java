...
public class V1alpha1StorageVersionListFluent<A extends io.kubernetes.client.openapi.models.V1alpha1StorageVersionListFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(V1alpha1StorageVersion... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1alpha1StorageVersion... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1alpha1StorageVersion item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1alpha1StorageVersionBuilder> predicate) {
    ...
    Iterator<V1alpha1StorageVersionBuilder> each = items.iterator();
  ...
  public A withItems(V1alpha1StorageVersion... items) {
    if (this.items != null) {
        this.items.clear();
