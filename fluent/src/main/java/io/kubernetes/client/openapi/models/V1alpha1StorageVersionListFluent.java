...
public class V1alpha1StorageVersionListFluent<A extends V1alpha1StorageVersionListFluent<A>> extends BaseFluent<A>{
  public V1alpha1StorageVersionListFluent() {
  }
  
  public V1alpha1StorageVersionListFluent(V1alpha1StorageVersionList instance) {
  ...
  protected void copyInstance(V1alpha1StorageVersionList instance) {
    instance = (instance != null ? instance : new V1alpha1StorageVersionList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1alpha1StorageVersion... items) {
    ...
    for (V1alpha1StorageVersion item : items) {V1alpha1StorageVersionBuilder builder = new V1alpha1StorageVersionBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public V1alpha1StorageVersion buildMatchingItem(Predicate<V1alpha1StorageVersionBuilder> predicate) {
      for (V1alpha1StorageVersionBuilder item : items) {
  ...
  public A withItems(List<V1alpha1StorageVersion> items) {
    ...
    if (items != null) {
        ...
        for (V1alpha1StorageVersion item : items) {
  ...
  public ItemsNested<A> addNewItemLike(V1alpha1StorageVersion item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1alpha1StorageVersion item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1alpha1StorageVersionBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1StorageVersionListFluent that = (V1alpha1StorageVersionListFluent) o;
  ...
  public class ItemsNested<N> extends V1alpha1StorageVersionFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1alpha1StorageVersion item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1StorageVersionListFluent.this.withMetadata(builder.build());
    }
