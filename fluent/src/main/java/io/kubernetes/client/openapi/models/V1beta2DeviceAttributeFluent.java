...
public class V1beta2DeviceAttributeFluent<A extends io.kubernetes.client.openapi.models.V1beta2DeviceAttributeFluent<A>> extends BaseFluent<A>{
  ...
  public V1beta2DeviceAttributeFluent(V1beta2DeviceAttribute instance) {
    this.copyInstance(instance);
  }

  protected void copyInstance(V1beta2DeviceAttribute instance) {
    instance = instance != null ? instance : new V1beta2DeviceAttribute();
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta2DeviceAttributeFluent that = (V1beta2DeviceAttributeFluent) o;
