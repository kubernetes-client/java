...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V2ContainerResourceMetricStatusFluentImpl<A extends io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent<A>{
  public V2ContainerResourceMetricStatusFluentImpl() {
  }
  public V2ContainerResourceMetricStatusFluentImpl(io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatus instance) {
  ...
  public io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent.CurrentNested<A> withNewCurrent() {
    return new io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluentImpl.CurrentNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent.CurrentNested<A> withNewCurrentLike(io.kubernetes.client.openapi.models.V2MetricValueStatus item) {
    return new io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluentImpl.CurrentNestedImpl(item);
  }
  public io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent.CurrentNested<A> editCurrent() {
    return withNewCurrentLike(getCurrent());
  }
  public io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent.CurrentNested<A> editOrNewCurrent() {
  ...
  public io.kubernetes.client.openapi.models.V2ContainerResourceMetricStatusFluent.CurrentNested<A> editOrNewCurrentLike(io.kubernetes.client.openapi.models.V2MetricValueStatus item) {
