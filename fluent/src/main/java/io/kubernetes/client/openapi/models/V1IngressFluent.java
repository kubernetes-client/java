...
public interface V1IngressFluent<A extends io.kubernetes.client.openapi.models.V1IngressFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V1IngressFluent.MetadataNested<N>> {

            public N and();
            public N endMetadata();    }


    public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1IngressSpecFluent<io.kubernetes.client.openapi.models.V1IngressFluent.SpecNested<N>> {

            public N and();
            public N endSpec();    }


    public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1IngressStatusFluent<io.kubernetes.client.openapi.models.V1IngressFluent.StatusNested<N>> {
