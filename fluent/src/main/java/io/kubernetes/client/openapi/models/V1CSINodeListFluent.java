...
public interface V1CSINodeListFluent<A extends io.kubernetes.client.openapi.models.V1CSINodeListFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1CSINode item);
    public A setToItems(int index,io.kubernetes.client.openapi.models.V1CSINode item);
    ...
    public io.kubernetes.client.openapi.models.V1CSINode buildItem(int index);
    ...
    public io.kubernetes.client.openapi.models.V1CSINodeListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1CSINode item);
    public io.kubernetes.client.openapi.models.V1CSINodeListFluent.ItemsNested<A> editItem(int index);
    ...
    public interface ItemsNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1CSINodeFluent<io.kubernetes.client.openapi.models.V1CSINodeListFluent.ItemsNested<N>> {

            public N and();
            public N endItem();    }


    public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ListMetaFluent<io.kubernetes.client.openapi.models.V1CSINodeListFluent.MetadataNested<N>> {
