...
import java.lang.Object;
  ...
  */
  ...
  public V1CertificateSigningRequestFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1CertificateSigningRequestFluentImpl.MetadataNestedImpl();
  }
  public V1CertificateSigningRequestFluentImpl.MetadataNested<A> withNewMetadataLike(V1ObjectMeta item) {
    return new V1CertificateSigningRequestFluentImpl.MetadataNestedImpl(item);
  }
  public V1CertificateSigningRequestFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1CertificateSigningRequestFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ObjectMetaBuilder().build());
  }
  public V1CertificateSigningRequestFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ObjectMeta item) {
  ...
  public V1CertificateSigningRequestFluentImpl.SpecNested<A> withNewSpec() {
    return new V1CertificateSigningRequestFluentImpl.SpecNestedImpl();
  }
  public V1CertificateSigningRequestFluentImpl.SpecNested<A> withNewSpecLike(V1CertificateSigningRequestSpec item) {
    return new V1CertificateSigningRequestFluentImpl.SpecNestedImpl(item);
  }
  public V1CertificateSigningRequestFluentImpl.SpecNested<A> editSpec() {
    return withNewSpecLike(getSpec());
  }
  public V1CertificateSigningRequestFluentImpl.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new V1CertificateSigningRequestSpecBuilder().build());
  }
  public V1CertificateSigningRequestFluentImpl.SpecNested<A> editOrNewSpecLike(V1CertificateSigningRequestSpec item) {
  ...
  public V1CertificateSigningRequestFluentImpl.StatusNested<A> withNewStatus() {
    return new V1CertificateSigningRequestFluentImpl.StatusNestedImpl();
  }
  public V1CertificateSigningRequestFluentImpl.StatusNested<A> withNewStatusLike(V1CertificateSigningRequestStatus item) {
    return new V1CertificateSigningRequestFluentImpl.StatusNestedImpl(item);
  }
  public V1CertificateSigningRequestFluentImpl.StatusNested<A> editStatus() {
    return withNewStatusLike(getStatus());
  }
  public V1CertificateSigningRequestFluentImpl.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(getStatus() != null ? getStatus(): new V1CertificateSigningRequestStatusBuilder().build());
  }
  public V1CertificateSigningRequestFluentImpl.StatusNested<A> editOrNewStatusLike(V1CertificateSigningRequestStatus item) {
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1CertificateSigningRequestFluentImpl.MetadataNested<N>> implements V1CertificateSigningRequestFluentImpl.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1CertificateSigningRequestSpecFluentImpl<V1CertificateSigningRequestFluentImpl.SpecNested<N>> implements V1CertificateSigningRequestFluentImpl.SpecNested<N>,Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1CertificateSigningRequestStatusFluentImpl<V1CertificateSigningRequestFluentImpl.StatusNested<N>> implements V1CertificateSigningRequestFluentImpl.StatusNested<N>,Nested<N>{
