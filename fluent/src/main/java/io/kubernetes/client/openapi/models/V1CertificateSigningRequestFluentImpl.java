...
public class V1CertificateSigningRequestFluentImpl<A extends io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent<A> {
    ...
    public V1CertificateSigningRequestFluentImpl(io.kubernetes.client.openapi.models.V1CertificateSigningRequest instance) {
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public A withSpec(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec spec) {
        ...
        if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.SpecNested<A> withNewSpec() {
        return new io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluentImpl.SpecNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.SpecNested<A> withNewSpecLike(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec item) {
        return new io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluentImpl.SpecNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecBuilder().build());
    }
    ...
    public A withStatus(io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatus status) {
        ...
        if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.StatusNested<A> withNewStatus() {
        return new io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluentImpl.StatusNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.StatusNested<A> withNewStatusLike(io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatus item) {
        return new io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluentImpl.StatusNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.StatusNested<A> editOrNewStatus() {
        return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatusBuilder().build());
    }
    ...
    public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecFluentImpl<io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecBuilder builder;

            SpecNestedImpl(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecBuilder(this, item);
                        
            }

            SpecNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpecBuilder(this);
    ...
    public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatusFluentImpl<io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatusBuilder builder;
            ...
            StatusNestedImpl(io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatus item) {
                this.builder = new io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatusBuilder(this, item);
                        
            }

            StatusNestedImpl() {
                this.builder = new io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatusBuilder(this);
