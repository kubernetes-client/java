...
public class V1beta1RuntimeClassStrategyOptionsBuilder extends io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsFluentImpl<io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsBuilder> implements io.kubernetes.client.fluent.VisitableBuilder<io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions,io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsBuilder> {
    ...
    public V1beta1RuntimeClassStrategyOptionsBuilder(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsFluent<?> fluent) {
        this(fluent, true);
    }

    public V1beta1RuntimeClassStrategyOptionsBuilder(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsFluent<?> fluent,java.lang.Boolean validationEnabled) {
        this(fluent, new V1beta1RuntimeClassStrategyOptions(), validationEnabled);
    }

    public V1beta1RuntimeClassStrategyOptionsBuilder(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsFluent<?> fluent,io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions instance) {
        this(fluent, instance, true);
    }

    public V1beta1RuntimeClassStrategyOptionsBuilder(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptionsFluent<?> fluent,io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions instance,java.lang.Boolean validationEnabled) {
        this.fluent = fluent; 
    ...
    public V1beta1RuntimeClassStrategyOptionsBuilder(io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions instance,java.lang.Boolean validationEnabled) {
        this.fluent = this; 
