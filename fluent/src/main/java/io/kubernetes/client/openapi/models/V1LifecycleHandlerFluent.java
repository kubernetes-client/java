...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1LifecycleHandlerFluent<A extends io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface ExecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ExecActionFluent<io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.ExecNested<N>>{
    public N and();
    public N endExec();
    
  }
  public interface HttpGetNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1HTTPGetActionFluent<io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.HttpGetNested<N>>{
    public N and();
    public N endHttpGet();
    
  }
  public interface TcpSocketNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1TCPSocketActionFluent<io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.TcpSocketNested<N>>{
    public N and();
