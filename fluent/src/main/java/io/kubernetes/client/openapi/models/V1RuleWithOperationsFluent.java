...
public class V1RuleWithOperationsFluent<A extends V1RuleWithOperationsFluent<A>> extends BaseFluent<A>{
  public V1RuleWithOperationsFluent() {
  }
  
  public V1RuleWithOperationsFluent(V1RuleWithOperations instance) {
  ...
  protected void copyInstance(V1RuleWithOperations instance) {
    instance = (instance != null ? instance : new V1RuleWithOperations());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1RuleWithOperationsFluent that = (V1RuleWithOperationsFluent) o;
