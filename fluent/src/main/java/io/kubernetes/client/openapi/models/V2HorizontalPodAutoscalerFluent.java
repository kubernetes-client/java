...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V2HorizontalPodAutoscalerFluent<A extends io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent<A>> extends io.kubernetes.client.fluent.Fluent<A>{
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1ObjectMetaFluent<io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent<io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatusFluent<io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
