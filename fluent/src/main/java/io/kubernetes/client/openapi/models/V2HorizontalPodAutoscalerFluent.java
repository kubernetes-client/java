...
public class V2HorizontalPodAutoscalerFluent<A extends io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent<A>> extends BaseFluent<A>{
  ...
  public SpecNested<A> editOrNewSpec() {
    return this.withNewSpecLike(Optional.ofNullable(this.buildSpec()).orElse(new V2HorizontalPodAutoscalerSpecBuilder().build()));
  }
  ...
  public StatusNested<A> editOrNewStatus() {
    return this.withNewStatusLike(Optional.ofNullable(this.buildStatus()).orElse(new V2HorizontalPodAutoscalerStatusBuilder().build()));
  }
