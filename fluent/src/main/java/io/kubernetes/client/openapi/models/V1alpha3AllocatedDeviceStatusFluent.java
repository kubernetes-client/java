...
public class V1alpha3AllocatedDeviceStatusFluent<A extends V1alpha3AllocatedDeviceStatusFluent<A>> extends BaseFluent<A>{
  public V1alpha3AllocatedDeviceStatusFluent() {
  }
  
  public V1alpha3AllocatedDeviceStatusFluent(V1alpha3AllocatedDeviceStatus instance) {
  ...
  private V1alpha3NetworkDeviceDataBuilder networkData;
  private String pool;
  
  protected void copyInstance(V1alpha3AllocatedDeviceStatus instance) {
    instance = (instance != null ? instance : new V1alpha3AllocatedDeviceStatus());
    if (instance != null) {
  ...
  public V1alpha3NetworkDeviceData buildNetworkData() {
    return this.networkData != null ? this.networkData.build() : null;
  }
  
  public A withNetworkData(V1alpha3NetworkDeviceData networkData) {
    this._visitables.remove("networkData");
    if (networkData != null) {
        this.networkData = new V1alpha3NetworkDeviceDataBuilder(networkData);
  ...
  public NetworkDataNested<A> withNewNetworkDataLike(V1alpha3NetworkDeviceData item) {
  ...
  public NetworkDataNested<A> editOrNewNetworkData() {
    return withNewNetworkDataLike(java.util.Optional.ofNullable(buildNetworkData()).orElse(new V1alpha3NetworkDeviceDataBuilder().build()));
  }
  
  public NetworkDataNested<A> editOrNewNetworkDataLike(V1alpha3NetworkDeviceData item) {
  ...
  public boolean equals(Object o) {
    ...
    V1alpha3AllocatedDeviceStatusFluent that = (V1alpha3AllocatedDeviceStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha3AllocatedDeviceStatusFluent.this.setToConditions(index,builder.build());
    }
  ...
  public class NetworkDataNested<N> extends V1alpha3NetworkDeviceDataFluent<NetworkDataNested<N>> implements Nested<N>{
    NetworkDataNested(V1alpha3NetworkDeviceData item) {
      this.builder = new V1alpha3NetworkDeviceDataBuilder(this, item);
    }
    V1alpha3NetworkDeviceDataBuilder builder;
    
    public N and() {
      return (N) V1alpha3AllocatedDeviceStatusFluent.this.withNetworkData(builder.build());
    }
