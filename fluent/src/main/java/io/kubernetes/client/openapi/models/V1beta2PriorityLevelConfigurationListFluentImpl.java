...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1beta2PriorityLevelConfiguration item) {
    ...
    V1beta2PriorityLevelConfigurationBuilder builder = new V1beta2PriorityLevelConfigurationBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1beta2PriorityLevelConfigurationFluentImpl<V1beta2PriorityLevelConfigurationListFluent.ItemsNested<N>> implements V1beta2PriorityLevelConfigurationListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta2PriorityLevelConfigurationListFluent.MetadataNested<N>> implements V1beta2PriorityLevelConfigurationListFluent.MetadataNested<N>,Nested<N>{
