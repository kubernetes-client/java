...
public class V1PriorityClassListFluent<A extends V1PriorityClassListFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(V1PriorityClassList instance) {
    instance = (instance != null ? instance : new V1PriorityClassList());
    if (instance != null) {
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1PriorityClass... items) {
    ...
    for (V1PriorityClass item : items) {V1PriorityClassBuilder builder = new V1PriorityClassBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
  ...
  public class ItemsNested<N> extends V1PriorityClassFluent<ItemsNested<N>> implements Nested<N>{
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1PriorityClassListFluent.this.withMetadata(builder.build());
    }
