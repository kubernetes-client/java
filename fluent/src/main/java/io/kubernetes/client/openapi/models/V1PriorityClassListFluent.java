...
public class V1PriorityClassListFluent<A extends io.kubernetes.client.openapi.models.V1PriorityClassListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<V1PriorityClassBuilder> predicate) {
    ...
    Iterator<V1PriorityClassBuilder> each = items.iterator();
