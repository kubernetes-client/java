...
public class V1NamespaceListFluent<A extends io.kubernetes.client.openapi.models.V1NamespaceListFluent<A>> extends BaseFluent<A>{
  ...
  public V1NamespaceListFluent() {
  }
  
  public V1NamespaceListFluent(V1NamespaceList instance) {
  ...
  public ItemsNested<A> addNewItemLike(V1Namespace item) {
    return new ItemsNested(-1, item);
  }
  
  public A addToItems(V1Namespace... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
    for (V1Namespace item : items) {
  ...
  public V1Namespace buildMatchingItem(Predicate<V1NamespaceBuilder> predicate) {
      for (V1NamespaceBuilder item : items) {
  ...
  protected void copyInstance(V1NamespaceList instance) {
    instance = instance != null ? instance : new V1NamespaceList();
    if (instance != null) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1NamespaceBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1NamespaceListFluent that = (V1NamespaceListFluent) o;
  ...
  public A removeFromItems(V1Namespace... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1Namespace item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1NamespaceBuilder> predicate) {
    ...
    Iterator<V1NamespaceBuilder> each = items.iterator();
  ...
  public ItemsNested<A> setNewItemLike(int index,V1Namespace item) {
  ...
  public A withItems(V1Namespace... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public class ItemsNested<N> extends V1NamespaceFluent<ItemsNested<N>> implements Nested<N>{
  
    V1NamespaceBuilder builder;
    int index;
  
    ItemsNested(int index,V1Namespace item) {
      this.index = index;
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1NamespaceListFluent.this.withMetadata(builder.build());
    }
