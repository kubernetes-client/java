...
public class V1NamespaceListFluent<A extends V1NamespaceListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Namespace... items) {
    ...
    for (V1Namespace item : items) {V1NamespaceBuilder builder = new V1NamespaceBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
