...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1beta1EndpointHintsFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent<A>{
  public V1beta1EndpointHintsFluentImpl() {
  }
  public V1beta1EndpointHintsFluentImpl(io.kubernetes.client.openapi.models.V1beta1EndpointHints instance) {
  ...
  public A setToForZones(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1ForZone item) {
    if (this.forZones == null) {this.forZones = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder>();}
    io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder builder = new io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder(item);
  ...
  public A addToForZones(io.kubernetes.client.openapi.models.V1beta1ForZone... items) {
    if (this.forZones == null) {this.forZones = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder>();}
    for (io.kubernetes.client.openapi.models.V1beta1ForZone item : items) {io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder builder = new io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder(item);_visitables.get("forZones").add(builder);this.forZones.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromForZones(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder> predicate) {
    ...
    final Iterator<io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder> each = forZones.iterator();
  ...
  public io.kubernetes.client.openapi.models.V1beta1ForZone buildMatchingForZone(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder item: forZones) { if(predicate.test(item)){ return item.build();} } return null;
  }
  public java.lang.Boolean hasMatchingForZone(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder> predicate) {
    for (io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder item: forZones) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withForZones(java.util.List<io.kubernetes.client.openapi.models.V1beta1ForZone> forZones) {
    ...
    if (forZones != null) {this.forZones = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1beta1ForZone item : forZones){this.addToForZones(item);}} else { this.forZones = null;} return (A) this;
  }
  public A withForZones(io.kubernetes.client.openapi.models.V1beta1ForZone... forZones) {
    ...
    if (forZones != null) {for (io.kubernetes.client.openapi.models.V1beta1ForZone item :forZones){ this.addToForZones(item);}} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent.ForZonesNested<A> addNewForZone() {
    return new io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluentImpl.ForZonesNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent.ForZonesNested<A> addNewForZoneLike(io.kubernetes.client.openapi.models.V1beta1ForZone item) {
    return new io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluentImpl.ForZonesNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent.ForZonesNested<A> setNewForZoneLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1ForZone item) {
    return new io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluentImpl.ForZonesNestedImpl(index, item);
  }
  ...
  public class ForZonesNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1ForZoneFluentImpl<io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent.ForZonesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent.ForZonesNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ForZonesNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1ForZone item) {
      this.index = index;
