...
public class V1beta1MatchResourcesFluent<A extends V1beta1MatchResourcesFluent<A>> extends BaseFluent<A>{
  ...
  public A addToExcludeResourceRules(int index,V1beta1NamedRuleWithOperations item) {
    if (this.excludeResourceRules == null) {this.excludeResourceRules = new ArrayList<V1beta1NamedRuleWithOperationsBuilder>();}
  ...
  public A addToExcludeResourceRules(io.kubernetes.client.openapi.models.V1beta1NamedRuleWithOperations... items) {
    if (this.excludeResourceRules == null) {this.excludeResourceRules = new ArrayList<V1beta1NamedRuleWithOperationsBuilder>();}
    for (V1beta1NamedRuleWithOperations item : items) {V1beta1NamedRuleWithOperationsBuilder builder = new V1beta1NamedRuleWithOperationsBuilder(item);_visitables.get("excludeResourceRules").add(builder);this.excludeResourceRules.add(builder);} return (A)this;
  }
  ...
  public A removeFromExcludeResourceRules(io.kubernetes.client.openapi.models.V1beta1NamedRuleWithOperations... items) {
    if (this.excludeResourceRules == null) return (A)this;
    for (V1beta1NamedRuleWithOperations item : items) {V1beta1NamedRuleWithOperationsBuilder builder = new V1beta1NamedRuleWithOperationsBuilder(item);_visitables.get("excludeResourceRules").remove(builder); this.excludeResourceRules.remove(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromExcludeResourceRules(Predicate<V1beta1NamedRuleWithOperationsBuilder> predicate) {
    ...
    final Iterator<V1beta1NamedRuleWithOperationsBuilder> each = excludeResourceRules.iterator();
  ...
  public A withExcludeResourceRules(io.kubernetes.client.openapi.models.V1beta1NamedRuleWithOperations... excludeResourceRules) {
    if (this.excludeResourceRules != null) {this.excludeResourceRules.clear(); _visitables.remove("excludeResourceRules"); }
    if (excludeResourceRules != null) {for (V1beta1NamedRuleWithOperations item :excludeResourceRules){ this.addToExcludeResourceRules(item);}} return (A) this;
  }
  ...
  public A addToResourceRules(int index,V1beta1NamedRuleWithOperations item) {
    if (this.resourceRules == null) {this.resourceRules = new ArrayList<V1beta1NamedRuleWithOperationsBuilder>();}
    V1beta1NamedRuleWithOperationsBuilder builder = new V1beta1NamedRuleWithOperationsBuilder(item);
  ...
  public A addToResourceRules(io.kubernetes.client.openapi.models.V1beta1NamedRuleWithOperations... items) {
    if (this.resourceRules == null) {this.resourceRules = new ArrayList<V1beta1NamedRuleWithOperationsBuilder>();}
    for (V1beta1NamedRuleWithOperations item : items) {V1beta1NamedRuleWithOperationsBuilder builder = new V1beta1NamedRuleWithOperationsBuilder(item);_visitables.get("resourceRules").add(builder);this.resourceRules.add(builder);} return (A)this;
  }
  ...
  public A removeFromResourceRules(io.kubernetes.client.openapi.models.V1beta1NamedRuleWithOperations... items) {
    if (this.resourceRules == null) return (A)this;
    for (V1beta1NamedRuleWithOperations item : items) {V1beta1NamedRuleWithOperationsBuilder builder = new V1beta1NamedRuleWithOperationsBuilder(item);_visitables.get("resourceRules").remove(builder); this.resourceRules.remove(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromResourceRules(Predicate<V1beta1NamedRuleWithOperationsBuilder> predicate) {
    ...
    final Iterator<V1beta1NamedRuleWithOperationsBuilder> each = resourceRules.iterator();
  ...
  public A withResourceRules(io.kubernetes.client.openapi.models.V1beta1NamedRuleWithOperations... resourceRules) {
    if (this.resourceRules != null) {this.resourceRules.clear(); _visitables.remove("resourceRules"); }
    if (resourceRules != null) {for (V1beta1NamedRuleWithOperations item :resourceRules){ this.addToResourceRules(item);}} return (A) this;
  }
