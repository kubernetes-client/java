...
import java.lang.Boolean;
  ...
  */
  ...
  public V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<A> addNewServerAddressByClientCIDR() {
    return new V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNestedImpl();
  }
  public V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<A> addNewServerAddressByClientCIDRLike(V1ServerAddressByClientCIDR item) {
    return new V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNestedImpl(-1, item);
  }
  public V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<A> setNewServerAddressByClientCIDRLike(int index,V1ServerAddressByClientCIDR item) {
    return new V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNestedImpl(index, item);
  }
  public V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<A> editServerAddressByClientCIDR(int index) {
  ...
  public V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<A> editFirstServerAddressByClientCIDR() {
  ...
  public V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<A> editLastServerAddressByClientCIDR() {
  ...
  public V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<A> editMatchingServerAddressByClientCIDR(Predicate<V1ServerAddressByClientCIDRBuilder> predicate) {
    int index = -1;
  ...
  class ServerAddressByClientCIDRsNestedImpl<N> extends V1ServerAddressByClientCIDRFluentImpl<V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<N>> implements V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNested<N>,Nested<N>{
