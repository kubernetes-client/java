...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1APIVersionsFluentImpl<A extends io.kubernetes.client.openapi.models.V1APIVersionsFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1APIVersionsFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V1APIVersionsFluent.ServerAddressByClientCIDRsNested<A> addNewServerAddressByClientCIDR() {
    return new io.kubernetes.client.openapi.models.V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1APIVersionsFluent.ServerAddressByClientCIDRsNested<A> addNewServerAddressByClientCIDRLike(io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDR item) {
    return new io.kubernetes.client.openapi.models.V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1APIVersionsFluent.ServerAddressByClientCIDRsNested<A> setNewServerAddressByClientCIDRLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDR item) {
    return new io.kubernetes.client.openapi.models.V1APIVersionsFluentImpl.ServerAddressByClientCIDRsNestedImpl(index, item);
  }
  ...
  public A addToVersions(java.lang.Integer index,java.lang.String item) {
    if (this.versions == null) {this.versions = new java.util.ArrayList<java.lang.String>();}
  ...
  public A addToVersions(java.lang.String... items) {
    if (this.versions == null) {this.versions = new java.util.ArrayList<java.lang.String>();}
    for (java.lang.String item : items) {this.versions.add(item);} return (A)this;
  }
  ...
  public A removeFromVersions(java.lang.String... items) {
    for (java.lang.String item : items) {if (this.versions!= null){ this.versions.remove(item);}} return (A)this;
  }
  ...
  public java.lang.String getMatchingVersion(java.util.function.Predicate<java.lang.String> predicate) {
    for (java.lang.String item: versions) { if(predicate.test(item)){ return item;} } return null;
  }
  public java.lang.Boolean hasMatchingVersion(java.util.function.Predicate<java.lang.String> predicate) {
    for (java.lang.String item: versions) { if(predicate.test(item)){ return true;} } return false;
  }
  public A withVersions(java.util.List<java.lang.String> versions) {
    if (versions != null) {this.versions = new java.util.ArrayList(); for (java.lang.String item : versions){this.addToVersions(item);}} else { this.versions = null;} return (A) this;
  }
  public A withVersions(java.lang.String... versions) {
    if (this.versions != null) {this.versions.clear();}
    if (versions != null) {for (java.lang.String item :versions){ this.addToVersions(item);}} return (A) this;
  }
