...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1LifecycleHandlerFluentImpl<A extends io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent<A>{
  ...
  public io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.ExecNested<A> withNewExecLike(io.kubernetes.client.openapi.models.V1ExecAction item) {
    return new io.kubernetes.client.openapi.models.V1LifecycleHandlerFluentImpl.ExecNestedImpl(item);
  }
  ...
  public io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.HttpGetNested<A> withNewHttpGet() {
  ...
  public io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.TcpSocketNested<A> withNewTcpSocket() {
  ...
  public class ExecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ExecActionFluentImpl<io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.ExecNested<N>> implements io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.ExecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class HttpGetNestedImpl<N> extends io.kubernetes.client.openapi.models.V1HTTPGetActionFluentImpl<io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.HttpGetNested<N>> implements io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.HttpGetNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class TcpSocketNestedImpl<N> extends io.kubernetes.client.openapi.models.V1TCPSocketActionFluentImpl<io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.TcpSocketNested<N>> implements io.kubernetes.client.openapi.models.V1LifecycleHandlerFluent.TcpSocketNested<N>,io.kubernetes.client.fluent.Nested<N>{
