...
public interface V1CephFSVolumeSourceFluent<A extends io.kubernetes.client.openapi.models.V1CephFSVolumeSourceFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
