...
public class V1EndpointsListFluentImpl<A extends io.kubernetes.client.openapi.models.V1EndpointsListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1EndpointsListFluent<A>{
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1Endpoints> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Endpoints item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
