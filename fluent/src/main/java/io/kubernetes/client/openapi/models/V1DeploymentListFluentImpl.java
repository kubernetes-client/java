...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,V1Deployment item) {
    ...
    V1DeploymentBuilder builder = new V1DeploymentBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
  }
  ...
  class ItemsNestedImpl<N> extends V1DeploymentFluentImpl<V1DeploymentListFluent.ItemsNested<N>> implements V1DeploymentListFluent.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(Integer index,V1Deployment item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1DeploymentListFluent.MetadataNested<N>> implements V1DeploymentListFluent.MetadataNested<N>,Nested<N>{
