...
public class V1DeploymentListFluentImpl<A extends V1DeploymentListFluent<A>> extends BaseFluent<A>
  ...
  public V1DeploymentListFluent.ItemsNested<A> editMatchingItem(
      Predicate<V1DeploymentBuilder> predicate) {
    int index = -1;
  ...
  class ItemsNestedImpl<N> extends V1DeploymentFluentImpl<V1DeploymentListFluent.ItemsNested<N>>
      implements V1DeploymentListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1DeploymentListFluent.MetadataNested<N>>
      implements V1DeploymentListFluent.MetadataNested<N>, Nested<N> {
