...
public class V1DeploymentListFluentImpl<A extends V1DeploymentListFluent<A>> extends BaseFluent<A>
  ...
  public A addToItems(Integer index, io.kubernetes.client.openapi.models.V1Deployment item) {
    if (this.items == null) {
      this.items =
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V1Deployment> items) {
    if (this.items == null) {
      this.items =
          new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DeploymentBuilder>();
    }
  ...
  public A removeMatchingFromItems(
      Predicate<io.kubernetes.client.openapi.models.V1DeploymentBuilder> predicate) {
   ...
   */
  @Deprecated
  public List<io.kubernetes.client.openapi.models.V1Deployment> getItems() {
