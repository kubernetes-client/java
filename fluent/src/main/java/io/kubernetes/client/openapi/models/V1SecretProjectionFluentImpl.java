...
import java.lang.Boolean;
  ...
  */
  ...
  public V1SecretProjectionFluentImpl.ItemsNested<A> addNewItem() {
    return new V1SecretProjectionFluentImpl.ItemsNestedImpl();
  }
  public V1SecretProjectionFluentImpl.ItemsNested<A> addNewItemLike(V1KeyToPath item) {
    return new V1SecretProjectionFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1SecretProjectionFluentImpl.ItemsNested<A> setNewItemLike(int index,V1KeyToPath item) {
    return new V1SecretProjectionFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1SecretProjectionFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1SecretProjectionFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1SecretProjectionFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1SecretProjectionFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1KeyToPathBuilder> predicate) {
    int index = -1;
  ...
  class ItemsNestedImpl<N> extends V1KeyToPathFluentImpl<V1SecretProjectionFluentImpl.ItemsNested<N>> implements V1SecretProjectionFluentImpl.ItemsNested<N>,Nested<N>{
