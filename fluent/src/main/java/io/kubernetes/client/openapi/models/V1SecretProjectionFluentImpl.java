...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1SecretProjectionFluentImpl<A extends io.kubernetes.client.openapi.models.V1SecretProjectionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1SecretProjectionFluent<A>{
  public V1SecretProjectionFluentImpl() {
  }
  public V1SecretProjectionFluentImpl(io.kubernetes.client.openapi.models.V1SecretProjection instance) {
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1KeyToPath> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1KeyToPath item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1SecretProjectionFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1KeyToPath item) {
    return new io.kubernetes.client.openapi.models.V1SecretProjectionFluentImpl.ItemsNestedImpl(-1, item);
  }
  public io.kubernetes.client.openapi.models.V1SecretProjectionFluent.ItemsNested<A> setNewItemLike(java.lang.Integer index,io.kubernetes.client.openapi.models.V1KeyToPath item) {
    return new io.kubernetes.client.openapi.models.V1SecretProjectionFluentImpl.ItemsNestedImpl(index, item);
  }
  public io.kubernetes.client.openapi.models.V1SecretProjectionFluent.ItemsNested<A> editItem(java.lang.Integer index) {
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1KeyToPathFluentImpl<io.kubernetes.client.openapi.models.V1SecretProjectionFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1SecretProjectionFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
