...
public class V1LeaseListFluent<A extends V1LeaseListFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromItems(io.kubernetes.client.openapi.models.V1Lease... items) {
    ...
    for (V1Lease item : items) {V1LeaseBuilder builder = new V1LeaseBuilder(item);_visitables.get("items").remove(builder); this.items.remove(builder);} return (A)this;
  }
