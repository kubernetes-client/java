...
public class V1LeaseListFluent<A extends io.kubernetes.client.openapi.models.V1LeaseListFluent<A>> extends BaseFluent<A>{
  public V1LeaseListFluent() {
  }
  
  public V1LeaseListFluent(V1LeaseList instance) {
  ...
  protected void copyInstance(V1LeaseList instance) {
    instance = instance != null ? instance : new V1LeaseList();
    if (instance != null) {
  ...
  public A addToItems(V1Lease... items) {
    if (this.items == null) {
      this.items = new ArrayList();
    }
  ...
  public A removeFromItems(V1Lease... items) {
    if (this.items == null) {
      return (A) this;
    }
    for (V1Lease item : items) {
  ...
  public A removeMatchingFromItems(Predicate<V1LeaseBuilder> predicate) {
    ...
    Iterator<V1LeaseBuilder> each = items.iterator();
  ...
  public A withItems(V1Lease... items) {
    if (this.items != null) {
        this.items.clear();
  ...
  public ItemsNested<A> addNewItemLike(V1Lease item) {
    return new ItemsNested(-1, item);
  }
  
  public ItemsNested<A> setNewItemLike(int index,V1Lease item) {
  ...
  public ItemsNested<A> editMatchingItem(Predicate<V1LeaseBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1LeaseListFluent that = (V1LeaseListFluent) o;
  ...
  public class ItemsNested<N> extends V1LeaseFluent<ItemsNested<N>> implements Nested<N>{
    ItemsNested(int index,V1Lease item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1LeaseListFluent.this.setToItems(index, builder.build());
    }
  ...
  public class MetadataNested<N> extends V1ListMetaFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1LeaseListFluent.this.withMetadata(builder.build());
    }
