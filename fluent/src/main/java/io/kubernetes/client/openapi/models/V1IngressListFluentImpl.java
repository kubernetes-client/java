...
import java.lang.Object;
  ...
  */
  ...
  public V1IngressListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1IngressListFluentImpl.ItemsNestedImpl();
  }
  public V1IngressListFluentImpl.ItemsNested<A> addNewItemLike(V1Ingress item) {
    return new V1IngressListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1IngressListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1Ingress item) {
    return new V1IngressListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1IngressListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1IngressListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1IngressListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1IngressListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1IngressBuilder> predicate) {
    int index = -1;
  ...
  public V1IngressListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1IngressListFluentImpl.MetadataNestedImpl();
  }
  public V1IngressListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1IngressListFluentImpl.MetadataNestedImpl(item);
  }
  public V1IngressListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1IngressListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1IngressListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1IngressFluentImpl<V1IngressListFluentImpl.ItemsNested<N>> implements V1IngressListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1Ingress item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1IngressListFluentImpl.MetadataNested<N>> implements V1IngressListFluentImpl.MetadataNested<N>,Nested<N>{
