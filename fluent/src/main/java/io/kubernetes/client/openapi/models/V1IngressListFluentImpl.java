...
public class V1IngressListFluentImpl<A extends V1IngressListFluent<A>> extends BaseFluent<A>
  ...
  public A addToItems(Integer index, V1Ingress item) {
    if (this.items == null) {
      this.items = new ArrayList<V1IngressBuilder>();
    }
  ...
  public V1IngressListFluent.ItemsNested<A> editMatchingItem(
      Predicate<V1IngressBuilder> predicate) {
    int index = -1;
  ...
  class ItemsNestedImpl<N> extends V1IngressFluentImpl<V1IngressListFluent.ItemsNested<N>>
      implements V1IngressListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1IngressListFluent.MetadataNested<N>>
      implements V1IngressListFluent.MetadataNested<N>, Nested<N> {
