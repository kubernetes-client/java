...
public class V1IngressListFluentImpl<A extends V1IngressListFluent<A>> extends BaseFluent<A>
    implements V1IngressListFluent<A> {
  ...
  public A addToItems(Integer index, io.kubernetes.client.openapi.models.V1Ingress item) {
    if (this.items == null) {
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V1Ingress> items) {
    if (this.items == null) {
      this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1IngressBuilder>();
    }
    for (io.kubernetes.client.openapi.models.V1Ingress item : items) {
  ...
  public A removeMatchingFromItems(
      Predicate<io.kubernetes.client.openapi.models.V1IngressBuilder> predicate) {
   ...
   */
  @Deprecated
  public List<io.kubernetes.client.openapi.models.V1Ingress> getItems() {
  ...
  class ItemsNestedImpl<N> extends V1IngressFluentImpl<V1IngressListFluent.ItemsNested<N>>
      implements io.kubernetes.client.openapi.models.V1IngressListFluent.ItemsNested<N>, Nested<N> {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1IngressListFluent.MetadataNested<N>>
