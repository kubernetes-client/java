...
public class V1IngressListFluentImpl<A extends io.kubernetes.client.openapi.models.V1IngressListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1IngressListFluent<A>{
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1Ingress> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1Ingress item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
