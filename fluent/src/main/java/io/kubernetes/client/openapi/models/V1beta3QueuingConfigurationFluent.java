...
public class V1beta3QueuingConfigurationFluent<A extends V1beta3QueuingConfigurationFluent<A>> extends BaseFluent<A>{
  public V1beta3QueuingConfigurationFluent() {
  }
  
  public V1beta3QueuingConfigurationFluent(V1beta3QueuingConfiguration instance) {
  ...
  protected void copyInstance(V1beta3QueuingConfiguration instance) {
    instance = (instance != null ? instance : new V1beta3QueuingConfiguration());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1beta3QueuingConfigurationFluent that = (V1beta3QueuingConfigurationFluent) o;
