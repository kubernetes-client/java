...
public interface V1alpha1VolumeAttachmentStatusFluent<A extends io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent<A>> extends io.kubernetes.client.fluent.Fluent<A> {
    ...
    public interface AttachErrorNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1alpha1VolumeErrorFluent<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.AttachErrorNested<N>> {

            public N and();
            public N endAttachError();    }


    public interface DetachErrorNested<N> extends io.kubernetes.client.fluent.Nested<N>,io.kubernetes.client.openapi.models.V1alpha1VolumeErrorFluent<io.kubernetes.client.openapi.models.V1alpha1VolumeAttachmentStatusFluent.DetachErrorNested<N>> {
