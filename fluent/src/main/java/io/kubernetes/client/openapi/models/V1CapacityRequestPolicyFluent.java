...
public class V1CapacityRequestPolicyFluent<A extends io.kubernetes.client.openapi.models.V1CapacityRequestPolicyFluent<A>> extends BaseFluent<A>{

  private Quantity _default;
  private V1CapacityRequestPolicyRangeBuilder validRange;
  private List<Quantity> validValues;

  public V1CapacityRequestPolicyFluent() {
  }
  
  public V1CapacityRequestPolicyFluent(V1CapacityRequestPolicy instance) {
  ...
  public V1CapacityRequestPolicyRange buildValidRange() {
    return this.validRange != null ? this.validRange.build() : null;
  }
  
  protected void copyInstance(V1CapacityRequestPolicy instance) {
    instance = instance != null ? instance : new V1CapacityRequestPolicy();
    if (instance != null) {
  ...
  public ValidRangeNested<A> editOrNewValidRange() {
    return this.withNewValidRangeLike(Optional.ofNullable(this.buildValidRange()).orElse(new V1CapacityRequestPolicyRangeBuilder().build()));
  }
  
  public ValidRangeNested<A> editOrNewValidRangeLike(V1CapacityRequestPolicyRange item) {
  ...
  public boolean equals(Object o) {
    ...
    V1CapacityRequestPolicyFluent that = (V1CapacityRequestPolicyFluent) o;
  ...
  public ValidRangeNested<A> withNewValidRangeLike(V1CapacityRequestPolicyRange item) {
    return new ValidRangeNested(item);
  }
  
  public A withValidRange(V1CapacityRequestPolicyRange validRange) {
    this._visitables.remove("validRange");
    if (validRange != null) {
        this.validRange = new V1CapacityRequestPolicyRangeBuilder(validRange);
  ...
  public class ValidRangeNested<N> extends V1CapacityRequestPolicyRangeFluent<ValidRangeNested<N>> implements Nested<N>{
  
    V1CapacityRequestPolicyRangeBuilder builder;
  
    ValidRangeNested(V1CapacityRequestPolicyRange item) {
      this.builder = new V1CapacityRequestPolicyRangeBuilder(this, item);
    }
  
    public N and() {
      return (N) V1CapacityRequestPolicyFluent.this.withValidRange(builder.build());
    }
