...
public class V1beta1EvictionFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1EvictionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1EvictionFluent<A> {
    ...
    public V1beta1EvictionFluentImpl(io.kubernetes.client.openapi.models.V1beta1Eviction instance) {
    ...
    public A withDeleteOptions(io.kubernetes.client.openapi.models.V1DeleteOptions deleteOptions) {
        ...
        if (deleteOptions!=null){ this.deleteOptions= new io.kubernetes.client.openapi.models.V1DeleteOptionsBuilder(deleteOptions); _visitables.get("deleteOptions").add(this.deleteOptions);} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1EvictionFluent.DeleteOptionsNested<A> withNewDeleteOptions() {
        return new io.kubernetes.client.openapi.models.V1beta1EvictionFluentImpl.DeleteOptionsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1EvictionFluent.DeleteOptionsNested<A> withNewDeleteOptionsLike(io.kubernetes.client.openapi.models.V1DeleteOptions item) {
        return new io.kubernetes.client.openapi.models.V1beta1EvictionFluentImpl.DeleteOptionsNestedImpl(item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1EvictionFluent.DeleteOptionsNested<A> editOrNewDeleteOptions() {
        return withNewDeleteOptionsLike(getDeleteOptions() != null ? getDeleteOptions(): new io.kubernetes.client.openapi.models.V1DeleteOptionsBuilder().build());
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1EvictionFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1EvictionFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1EvictionFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1EvictionFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public class DeleteOptionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1DeleteOptionsFluentImpl<io.kubernetes.client.openapi.models.V1beta1EvictionFluent.DeleteOptionsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EvictionFluent.DeleteOptionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1DeleteOptionsBuilder builder;
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1EvictionFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EvictionFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
