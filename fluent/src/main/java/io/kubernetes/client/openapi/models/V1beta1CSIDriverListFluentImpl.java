...
public class V1beta1CSIDriverListFluentImpl<A extends io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent<A> {

    private java.lang.String apiVersion;
    private java.util.List<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder> items;
    private java.lang.String kind;
    private io.kubernetes.client.openapi.models.V1ListMetaBuilder metadata;

    public V1beta1CSIDriverListFluentImpl() {
    }

    public V1beta1CSIDriverListFluentImpl(io.kubernetes.client.openapi.models.V1beta1CSIDriverList instance) {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1beta1CSIDriver item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
    }

    public A setToItems(int index,io.kubernetes.client.openapi.models.V1beta1CSIDriver item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder>();}
        io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder(item);
    ...
    public A addToItems(io.kubernetes.client.openapi.models.V1beta1CSIDriver... items) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder>();}
        for (io.kubernetes.client.openapi.models.V1beta1CSIDriver item : items) {io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
    }
    ...
    public A removeFromItems(io.kubernetes.client.openapi.models.V1beta1CSIDriver... items) {
        for (io.kubernetes.client.openapi.models.V1beta1CSIDriver item : items) {io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder builder = new io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder> each = items.iterator();
        final List visitables = _visitables.get("items");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriver buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1beta1CSIDriver> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder>(); for (io.kubernetes.client.openapi.models.V1beta1CSIDriver item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }

    public A withItems(io.kubernetes.client.openapi.models.V1beta1CSIDriver... items) {
        if (this.items != null) {this.items.clear();}
        if (items != null) {for (io.kubernetes.client.openapi.models.V1beta1CSIDriver item :items){ this.addToItems(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.ItemsNested<A> addNewItem() {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluentImpl.ItemsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1beta1CSIDriver item) {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluentImpl.ItemsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1beta1CSIDriver item) {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluentImpl.ItemsNestedImpl(index, item);
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
        return new io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1beta1CSIDriverListFluentImpl that = (V1beta1CSIDriverListFluentImpl) o;
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1beta1CSIDriverFluentImpl<io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder builder;
        private final int index;

            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1beta1CSIDriver item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder(this, item);
                        
            }

            ItemsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.V1beta1CSIDriverBuilder(this);
                        
            }

            public N and() {
                return (N) V1beta1CSIDriverListFluentImpl.this.setToItems(index,builder.build());
            }
    ...
    public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ListMetaFluentImpl<io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CSIDriverListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1ListMetaBuilder builder;
            ...
            public N and() {
                return (N) V1beta1CSIDriverListFluentImpl.this.withMetadata(builder.build());
            }
