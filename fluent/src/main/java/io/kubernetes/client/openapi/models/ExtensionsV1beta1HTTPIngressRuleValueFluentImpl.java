...
public class ExtensionsV1beta1HTTPIngressRuleValueFluentImpl<A extends io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluent<A> {

    private java.util.List<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder> paths;
    ...
    public A addToPaths(int index,io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item) {
        if (this.paths == null) {this.paths = new java.util.ArrayList<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder>();}
        io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder builder = new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder(item);_visitables.get("paths").add(index >= 0 ? index : _visitables.get("paths").size(), builder);this.paths.add(index >= 0 ? index : paths.size(), builder); return (A)this;
    }

    public A setToPaths(int index,io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item) {
        if (this.paths == null) {this.paths = new java.util.ArrayList<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder>();}
        io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder builder = new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder(item);
    ...
    public A removeFromPaths(io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath... items) {
        for (io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item : items) {io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder builder = new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder(item);_visitables.get("paths").remove(builder);if (this.paths != null) {this.paths.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromPaths(java.util.function.Predicate<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder> each = paths.iterator();
        final List visitables = _visitables.get("paths");
        while (each.hasNext()) {
          io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder builder = each.next();
    ...
    public io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath buildMatchingPath(java.util.function.Predicate<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder item: paths) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingPath(java.util.function.Predicate<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder item: paths) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withPaths(java.util.List<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath> paths) {
        ...
        if (paths != null) {this.paths = new java.util.ArrayList<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder>(); for (io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item : paths){this.addToPaths(item);}} else { this.paths = null;} return (A) this;
    }
    ...
    public A withPaths(io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath... paths) {
        ...
        if (paths != null) {for (io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item :paths){ this.addToPaths(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluent.PathsNested<A> addNewPath() {
        return new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluentImpl.PathsNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluent.PathsNested<A> addNewPathLike(io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item) {
        return new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluentImpl.PathsNestedImpl(-1, item);
    }
    ...
    public io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluent.PathsNested<A> setNewPathLike(int index,io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item) {
        return new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluentImpl.PathsNestedImpl(index, item);
    }
    ...
    public class PathsNestedImpl<N> extends io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathFluentImpl<io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluent.PathsNested<N>> implements io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressRuleValueFluent.PathsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder builder;
        private final int index;

            PathsNestedImpl(int index,io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPath item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder(this, item);
                        
            }

            PathsNestedImpl() {
                this.index = -1;
                this.builder = new io.kubernetes.client.openapi.models.ExtensionsV1beta1HTTPIngressPathBuilder(this);
