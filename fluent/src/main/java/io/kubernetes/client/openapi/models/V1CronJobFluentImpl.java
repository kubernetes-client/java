...
import java.lang.Object;
  ...
  */
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1CronJobFluent.MetadataNested<N>> implements V1CronJobFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1CronJobSpecFluentImpl<V1CronJobFluent.SpecNested<N>> implements V1CronJobFluent.SpecNested<N>,Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1CronJobStatusFluentImpl<V1CronJobFluent.StatusNested<N>> implements V1CronJobFluent.StatusNested<N>,Nested<N>{
