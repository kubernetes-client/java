...
import java.lang.Boolean;
  ...
  * Generated
  */
public class V1CronJobFluentImpl<A extends io.kubernetes.client.openapi.models.V1CronJobFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1CronJobFluent<A>{
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1CronJobSpec spec) {
    ...
    if (spec!=null){ this.spec= new io.kubernetes.client.openapi.models.V1CronJobSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1CronJobFluent.SpecNested<A> editOrNewSpec() {
    return withNewSpecLike(getSpec() != null ? getSpec(): new io.kubernetes.client.openapi.models.V1CronJobSpecBuilder().build());
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1CronJobStatus status) {
    ...
    if (status!=null){ this.status= new io.kubernetes.client.openapi.models.V1CronJobStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  public io.kubernetes.client.openapi.models.V1CronJobFluent.StatusNested<A> editOrNewStatus() {
    return withNewStatusLike(getStatus() != null ? getStatus(): new io.kubernetes.client.openapi.models.V1CronJobStatusBuilder().build());
  }
  ...
  public class MetadataNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ObjectMetaFluentImpl<io.kubernetes.client.openapi.models.V1CronJobFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class SpecNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CronJobSpecFluentImpl<io.kubernetes.client.openapi.models.V1CronJobFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  public class StatusNestedImpl<N> extends io.kubernetes.client.openapi.models.V1CronJobStatusFluentImpl<io.kubernetes.client.openapi.models.V1CronJobFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
