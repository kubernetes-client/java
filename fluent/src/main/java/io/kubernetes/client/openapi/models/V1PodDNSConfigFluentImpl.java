...
public class V1PodDNSConfigFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodDNSConfigFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodDNSConfigFluent<A>{
  ...
  public A withNameservers(java.util.List<java.lang.String> nameservers) {
    if (nameservers != null) {this.nameservers = new java.util.ArrayList(); for (java.lang.String item : nameservers){this.addToNameservers(item);}} else { this.nameservers = null;} return (A) this;
  }
  ...
  public class OptionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodDNSConfigOptionFluentImpl<io.kubernetes.client.openapi.models.V1PodDNSConfigFluent.OptionsNested<N>> implements io.kubernetes.client.openapi.models.V1PodDNSConfigFluent.OptionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    OptionsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1PodDNSConfigOption item) {
      this.index = index;
