...
public class V1PodDNSConfigFluentImpl<A extends io.kubernetes.client.openapi.models.V1PodDNSConfigFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1PodDNSConfigFluent<A> {
    ...
    public A addToOptions(int index,io.kubernetes.client.openapi.models.V1PodDNSConfigOption item) {
        ...
        io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder builder = new io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder(item);_visitables.get("options").add(index >= 0 ? index : _visitables.get("options").size(), builder);this.options.add(index >= 0 ? index : options.size(), builder); return (A)this;
    }

    public A setToOptions(int index,io.kubernetes.client.openapi.models.V1PodDNSConfigOption item) {
        if (this.options == null) {this.options = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder>();}
        io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder builder = new io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder(item);
    ...
    public A addToOptions(io.kubernetes.client.openapi.models.V1PodDNSConfigOption... items) {
        if (this.options == null) {this.options = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder>();}
        for (io.kubernetes.client.openapi.models.V1PodDNSConfigOption item : items) {io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder builder = new io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder(item);_visitables.get("options").add(builder);this.options.add(builder);} return (A)this;
    }
    ...
    public A removeMatchingFromOptions(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder> each = options.iterator();
    ...
    public A withOptions(java.util.List<io.kubernetes.client.openapi.models.V1PodDNSConfigOption> options) {
        ...
        if (options != null) {this.options = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder>(); for (io.kubernetes.client.openapi.models.V1PodDNSConfigOption item : options){this.addToOptions(item);}} else { this.options = null;} return (A) this;
    }
    ...
    public class OptionsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1PodDNSConfigOptionFluentImpl<io.kubernetes.client.openapi.models.V1PodDNSConfigFluent.OptionsNested<N>> implements io.kubernetes.client.openapi.models.V1PodDNSConfigFluent.OptionsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        private final io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder builder;
        private final int index;

            OptionsNestedImpl(int index,io.kubernetes.client.openapi.models.V1PodDNSConfigOption item) {
                this.index = index;
                this.builder = new io.kubernetes.client.openapi.models.V1PodDNSConfigOptionBuilder(this, item);
