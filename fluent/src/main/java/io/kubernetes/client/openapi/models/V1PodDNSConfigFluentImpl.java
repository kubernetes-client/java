...
public class V1PodDNSConfigFluentImpl<A extends V1PodDNSConfigFluent<A>> extends BaseFluent<A>
  ...
  public A addToNameservers(Integer index, java.lang.String item) {
  ...
  public A addToOptions(
    ...
    if (this.options == null) {
      this.options = new java.util.ArrayList<V1PodDNSConfigOptionBuilder>();
    }
  ...
  class OptionsNestedImpl<N>
      ...
      implements io.kubernetes.client.openapi.models.V1PodDNSConfigFluent.OptionsNested<N>,
          Nested<N> {
    OptionsNestedImpl(java.lang.Integer index, V1PodDNSConfigOption item) {
      this.index = index;
