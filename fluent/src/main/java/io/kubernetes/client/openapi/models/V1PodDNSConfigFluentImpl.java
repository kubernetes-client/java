...
import java.lang.Boolean;
  ...
  */
  ...
  public V1PodDNSConfigFluentImpl.OptionsNested<A> addNewOption() {
    return new V1PodDNSConfigFluentImpl.OptionsNestedImpl();
  }
  public V1PodDNSConfigFluentImpl.OptionsNested<A> addNewOptionLike(V1PodDNSConfigOption item) {
    return new V1PodDNSConfigFluentImpl.OptionsNestedImpl(-1, item);
  }
  public V1PodDNSConfigFluentImpl.OptionsNested<A> setNewOptionLike(int index,V1PodDNSConfigOption item) {
    return new V1PodDNSConfigFluentImpl.OptionsNestedImpl(index, item);
  }
  public V1PodDNSConfigFluentImpl.OptionsNested<A> editOption(int index) {
  ...
  public V1PodDNSConfigFluentImpl.OptionsNested<A> editFirstOption() {
  ...
  public V1PodDNSConfigFluentImpl.OptionsNested<A> editLastOption() {
    int index = options.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last options. The list is empty.");
    return setNewOptionLike(index, buildOption(index));
  }
  public V1PodDNSConfigFluentImpl.OptionsNested<A> editMatchingOption(Predicate<V1PodDNSConfigOptionBuilder> predicate) {
    int index = -1;
  ...
  class OptionsNestedImpl<N> extends V1PodDNSConfigOptionFluentImpl<V1PodDNSConfigFluentImpl.OptionsNested<N>> implements V1PodDNSConfigFluentImpl.OptionsNested<N>,Nested<N>{
