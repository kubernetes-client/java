...
public class V1ReplicationControllerConditionFluentImpl<
        A extends V1ReplicationControllerConditionFluent<A>>
    extends BaseFluent<A> implements V1ReplicationControllerConditionFluent<A> {
  public V1ReplicationControllerConditionFluentImpl() {}

  public V1ReplicationControllerConditionFluentImpl(V1ReplicationControllerCondition instance) {
  ...
  public boolean equals(Object o) {
    ...
    V1ReplicationControllerConditionFluentImpl that =
        (V1ReplicationControllerConditionFluentImpl) o;
