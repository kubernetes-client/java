...
public class V1ReplicationControllerConditionFluentImpl<A extends io.kubernetes.client.openapi.models.V1ReplicationControllerConditionFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ReplicationControllerConditionFluent<A> {
    ...
    public V1ReplicationControllerConditionFluentImpl(io.kubernetes.client.openapi.models.V1ReplicationControllerCondition instance) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V1ReplicationControllerConditionFluentImpl that = (V1ReplicationControllerConditionFluentImpl) o;
