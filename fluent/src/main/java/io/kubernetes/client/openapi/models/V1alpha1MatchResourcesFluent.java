...
public class V1alpha1MatchResourcesFluent<A extends V1alpha1MatchResourcesFluent<A>> extends BaseFluent<A>{
  ...
  public A removeFromExcludeResourceRules(io.kubernetes.client.openapi.models.V1alpha1NamedRuleWithOperations... items) {
    ...
    for (V1alpha1NamedRuleWithOperations item : items) {V1alpha1NamedRuleWithOperationsBuilder builder = new V1alpha1NamedRuleWithOperationsBuilder(item);_visitables.get("excludeResourceRules").remove(builder); this.excludeResourceRules.remove(builder);} return (A)this;
  }
  ...
  public A withObjectSelector(V1LabelSelector objectSelector) {
    this._visitables.remove(this.objectSelector);
  ...
  public A removeFromResourceRules(io.kubernetes.client.openapi.models.V1alpha1NamedRuleWithOperations... items) {
    ...
    for (V1alpha1NamedRuleWithOperations item : items) {V1alpha1NamedRuleWithOperationsBuilder builder = new V1alpha1NamedRuleWithOperationsBuilder(item);_visitables.get("resourceRules").remove(builder); this.resourceRules.remove(builder);} return (A)this;
  }
