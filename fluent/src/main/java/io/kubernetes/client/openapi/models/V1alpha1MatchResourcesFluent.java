...
public class V1alpha1MatchResourcesFluent<A extends io.kubernetes.client.openapi.models.V1alpha1MatchResourcesFluent<A>> extends BaseFluent<A>{
  public V1alpha1MatchResourcesFluent() {
  }
  
  public V1alpha1MatchResourcesFluent(V1alpha1MatchResources instance) {
  ...
  protected void copyInstance(V1alpha1MatchResources instance) {
  ...
  public A addToExcludeResourceRules(V1alpha1NamedRuleWithOperations... items) {
    if (this.excludeResourceRules == null) {
      this.excludeResourceRules = new ArrayList();
    }
    for (V1alpha1NamedRuleWithOperations item : items) {
        V1alpha1NamedRuleWithOperationsBuilder builder = new V1alpha1NamedRuleWithOperationsBuilder(item);
        _visitables.get("excludeResourceRules").add(builder);
  ...
  public A removeFromExcludeResourceRules(V1alpha1NamedRuleWithOperations... items) {
    if (this.excludeResourceRules == null) {
      return (A) this;
    }
    for (V1alpha1NamedRuleWithOperations item : items) {
  ...
  public A removeMatchingFromExcludeResourceRules(Predicate<V1alpha1NamedRuleWithOperationsBuilder> predicate) {
    ...
    Iterator<V1alpha1NamedRuleWithOperationsBuilder> each = excludeResourceRules.iterator();
  ...
  public V1alpha1NamedRuleWithOperations buildMatchingExcludeResourceRule(Predicate<V1alpha1NamedRuleWithOperationsBuilder> predicate) {
      for (V1alpha1NamedRuleWithOperationsBuilder item : excludeResourceRules) {
  ...
  public A withExcludeResourceRules(List<V1alpha1NamedRuleWithOperations> excludeResourceRules) {
    ...
    if (excludeResourceRules != null) {
        this.excludeResourceRules = new ArrayList();
        for (V1alpha1NamedRuleWithOperations item : excludeResourceRules) {
  ...
  public A withExcludeResourceRules(V1alpha1NamedRuleWithOperations... excludeResourceRules) {
    if (this.excludeResourceRules != null) {
  ...
  public ExcludeResourceRulesNested<A> addNewExcludeResourceRuleLike(V1alpha1NamedRuleWithOperations item) {
    return new ExcludeResourceRulesNested(-1, item);
  }
  
  public ExcludeResourceRulesNested<A> setNewExcludeResourceRuleLike(int index,V1alpha1NamedRuleWithOperations item) {
  ...
  public ExcludeResourceRulesNested<A> editMatchingExcludeResourceRule(Predicate<V1alpha1NamedRuleWithOperationsBuilder> predicate) {
    int index = -1;
  ...
  public A addToResourceRules(V1alpha1NamedRuleWithOperations... items) {
    if (this.resourceRules == null) {
      this.resourceRules = new ArrayList();
    }
    for (V1alpha1NamedRuleWithOperations item : items) {
  ...
  public A removeFromResourceRules(V1alpha1NamedRuleWithOperations... items) {
    if (this.resourceRules == null) {
      return (A) this;
    }
    for (V1alpha1NamedRuleWithOperations item : items) {
  ...
  public A removeMatchingFromResourceRules(Predicate<V1alpha1NamedRuleWithOperationsBuilder> predicate) {
    ...
    Iterator<V1alpha1NamedRuleWithOperationsBuilder> each = resourceRules.iterator();
  ...
  public V1alpha1NamedRuleWithOperations buildMatchingResourceRule(Predicate<V1alpha1NamedRuleWithOperationsBuilder> predicate) {
      for (V1alpha1NamedRuleWithOperationsBuilder item : resourceRules) {
        if (predicate.test(item)) {
          return item.build();
        }
      }
  ...
  public A withResourceRules(List<V1alpha1NamedRuleWithOperations> resourceRules) {
    ...
    if (resourceRules != null) {
        this.resourceRules = new ArrayList();
        for (V1alpha1NamedRuleWithOperations item : resourceRules) {
  ...
  public A withResourceRules(V1alpha1NamedRuleWithOperations... resourceRules) {
    if (this.resourceRules != null) {
  ...
  public ResourceRulesNested<A> addNewResourceRuleLike(V1alpha1NamedRuleWithOperations item) {
    return new ResourceRulesNested(-1, item);
  }
  
  public ResourceRulesNested<A> setNewResourceRuleLike(int index,V1alpha1NamedRuleWithOperations item) {
  ...
  public ResourceRulesNested<A> editMatchingResourceRule(Predicate<V1alpha1NamedRuleWithOperationsBuilder> predicate) {
    int index = -1;
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1MatchResourcesFluent that = (V1alpha1MatchResourcesFluent) o;
  ...
  public class ExcludeResourceRulesNested<N> extends V1alpha1NamedRuleWithOperationsFluent<ExcludeResourceRulesNested<N>> implements Nested<N>{
    ExcludeResourceRulesNested(int index,V1alpha1NamedRuleWithOperations item) {
      this.index = index;
    ...
    public N and() {
      return (N) V1alpha1MatchResourcesFluent.this.setToExcludeResourceRules(index, builder.build());
    }
  ...
  public class NamespaceSelectorNested<N> extends V1LabelSelectorFluent<NamespaceSelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1MatchResourcesFluent.this.withNamespaceSelector(builder.build());
    }
  ...
  public class ObjectSelectorNested<N> extends V1LabelSelectorFluent<ObjectSelectorNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1alpha1MatchResourcesFluent.this.withObjectSelector(builder.build());
    }
  ...
  public class ResourceRulesNested<N> extends V1alpha1NamedRuleWithOperationsFluent<ResourceRulesNested<N>> implements Nested<N>{
    ResourceRulesNested(int index,V1alpha1NamedRuleWithOperations item) {
      this.index = index;
      this.builder = new V1alpha1NamedRuleWithOperationsBuilder(this, item);
    }
    V1alpha1NamedRuleWithOperationsBuilder builder;
    ...
    public N and() {
      return (N) V1alpha1MatchResourcesFluent.this.setToResourceRules(index, builder.build());
    }
