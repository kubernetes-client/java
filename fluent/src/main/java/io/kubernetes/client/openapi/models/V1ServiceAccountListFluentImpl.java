...
public class V1ServiceAccountListFluentImpl<A extends io.kubernetes.client.openapi.models.V1ServiceAccountListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ServiceAccountListFluent<A>{
  ...
  public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1ServiceAccount> items) {
    ...
    if (items != null) {this.items = new java.util.ArrayList(); for (io.kubernetes.client.openapi.models.V1ServiceAccount item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
  }
  ...
  public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ServiceAccountFluentImpl<io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ItemsNestedImpl(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ServiceAccount item) {
      this.index = index;
