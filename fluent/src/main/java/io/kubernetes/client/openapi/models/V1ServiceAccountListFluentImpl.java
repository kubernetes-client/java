...
import java.lang.Object;
  ...
  */
  ...
  public V1ServiceAccountListFluentImpl.ItemsNested<A> addNewItem() {
    return new V1ServiceAccountListFluentImpl.ItemsNestedImpl();
  }
  public V1ServiceAccountListFluentImpl.ItemsNested<A> addNewItemLike(V1ServiceAccount item) {
    return new V1ServiceAccountListFluentImpl.ItemsNestedImpl(-1, item);
  }
  public V1ServiceAccountListFluentImpl.ItemsNested<A> setNewItemLike(int index,V1ServiceAccount item) {
    return new V1ServiceAccountListFluentImpl.ItemsNestedImpl(index, item);
  }
  public V1ServiceAccountListFluentImpl.ItemsNested<A> editItem(int index) {
    if (items.size() <= index) throw new RuntimeException("Can't edit items. Index exceeds size.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ServiceAccountListFluentImpl.ItemsNested<A> editFirstItem() {
    if (items.size() == 0) throw new RuntimeException("Can't edit first items. The list is empty.");
    return setNewItemLike(0, buildItem(0));
  }
  public V1ServiceAccountListFluentImpl.ItemsNested<A> editLastItem() {
    int index = items.size() - 1;
    if (index < 0) throw new RuntimeException("Can't edit last items. The list is empty.");
    return setNewItemLike(index, buildItem(index));
  }
  public V1ServiceAccountListFluentImpl.ItemsNested<A> editMatchingItem(Predicate<V1ServiceAccountBuilder> predicate) {
    int index = -1;
  ...
  public V1ServiceAccountListFluentImpl.MetadataNested<A> withNewMetadata() {
    return new V1ServiceAccountListFluentImpl.MetadataNestedImpl();
  }
  public V1ServiceAccountListFluentImpl.MetadataNested<A> withNewMetadataLike(V1ListMeta item) {
    return new V1ServiceAccountListFluentImpl.MetadataNestedImpl(item);
  }
  public V1ServiceAccountListFluentImpl.MetadataNested<A> editMetadata() {
    return withNewMetadataLike(getMetadata());
  }
  public V1ServiceAccountListFluentImpl.MetadataNested<A> editOrNewMetadata() {
    return withNewMetadataLike(getMetadata() != null ? getMetadata(): new V1ListMetaBuilder().build());
  }
  public V1ServiceAccountListFluentImpl.MetadataNested<A> editOrNewMetadataLike(V1ListMeta item) {
  ...
  class ItemsNestedImpl<N> extends V1ServiceAccountFluentImpl<V1ServiceAccountListFluentImpl.ItemsNested<N>> implements V1ServiceAccountListFluentImpl.ItemsNested<N>,Nested<N>{
    ItemsNestedImpl(int index,V1ServiceAccount item) {
      this.index = index;
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ServiceAccountListFluentImpl.MetadataNested<N>> implements V1ServiceAccountListFluentImpl.MetadataNested<N>,Nested<N>{
