...
public class V1ServiceAccountListFluentImpl<A extends io.kubernetes.client.openapi.models.V1ServiceAccountListFluent<A>> extends io.kubernetes.client.fluent.BaseFluent<A> implements io.kubernetes.client.openapi.models.V1ServiceAccountListFluent<A> {

    private java.lang.String apiVersion;
    private java.util.List<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder> items;
    ...
    public V1ServiceAccountListFluentImpl(io.kubernetes.client.openapi.models.V1ServiceAccountList instance) {
    ...
    public A addToItems(int index,io.kubernetes.client.openapi.models.V1ServiceAccount item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder>();}
        io.kubernetes.client.openapi.models.V1ServiceAccountBuilder builder = new io.kubernetes.client.openapi.models.V1ServiceAccountBuilder(item);_visitables.get("items").add(index >= 0 ? index : _visitables.get("items").size(), builder);this.items.add(index >= 0 ? index : items.size(), builder); return (A)this;
    }

    public A setToItems(int index,io.kubernetes.client.openapi.models.V1ServiceAccount item) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder>();}
        io.kubernetes.client.openapi.models.V1ServiceAccountBuilder builder = new io.kubernetes.client.openapi.models.V1ServiceAccountBuilder(item);
    ...
    public A addToItems(io.kubernetes.client.openapi.models.V1ServiceAccount... items) {
        if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder>();}
        for (io.kubernetes.client.openapi.models.V1ServiceAccount item : items) {io.kubernetes.client.openapi.models.V1ServiceAccountBuilder builder = new io.kubernetes.client.openapi.models.V1ServiceAccountBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
    }
    ...
    public A removeFromItems(io.kubernetes.client.openapi.models.V1ServiceAccount... items) {
        for (io.kubernetes.client.openapi.models.V1ServiceAccount item : items) {io.kubernetes.client.openapi.models.V1ServiceAccountBuilder builder = new io.kubernetes.client.openapi.models.V1ServiceAccountBuilder(item);_visitables.get("items").remove(builder);if (this.items != null) {this.items.remove(builder);}} return (A)this;
    }
    ...
    public A removeMatchingFromItems(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder> predicate) {
        ...
        final Iterator<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder> each = items.iterator();
    ...
    public io.kubernetes.client.openapi.models.V1ServiceAccount buildItem(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1ServiceAccount buildMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1ServiceAccountBuilder item: items) { if(predicate.test(item)){ return item.build();} } return null;
    }
    ...
    public java.lang.Boolean hasMatchingItem(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder> predicate) {
        for (io.kubernetes.client.openapi.models.V1ServiceAccountBuilder item: items) { if(predicate.test(item)){ return true;} } return false;
    }
    ...
    public A withItems(java.util.List<io.kubernetes.client.openapi.models.V1ServiceAccount> items) {
        ...
        if (items != null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ServiceAccountBuilder>(); for (io.kubernetes.client.openapi.models.V1ServiceAccount item : items){this.addToItems(item);}} else { this.items = null;} return (A) this;
    }

    public A withItems(io.kubernetes.client.openapi.models.V1ServiceAccount... items) {
        if (this.items != null) {this.items.clear();}
        if (items != null) {for (io.kubernetes.client.openapi.models.V1ServiceAccount item :items){ this.addToItems(item);}} return (A) this;
    }
    ...
    public io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1ServiceAccount item) {
        return new io.kubernetes.client.openapi.models.V1ServiceAccountListFluentImpl.ItemsNestedImpl(-1, item);
    }

    public io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.ItemsNested<A> setNewItemLike(int index,io.kubernetes.client.openapi.models.V1ServiceAccount item) {
        return new io.kubernetes.client.openapi.models.V1ServiceAccountListFluentImpl.ItemsNestedImpl(index, item);
    }

    public io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.ItemsNested<A> editItem(int index) {
    ...
    public io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.MetadataNested<A> withNewMetadata() {
        return new io.kubernetes.client.openapi.models.V1ServiceAccountListFluentImpl.MetadataNestedImpl();
    }
    ...
    public io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ListMeta item) {
        return new io.kubernetes.client.openapi.models.V1ServiceAccountListFluentImpl.MetadataNestedImpl(item);
    }
    ...
    public class ItemsNestedImpl<N> extends io.kubernetes.client.openapi.models.V1ServiceAccountFluentImpl<io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceAccountListFluent.ItemsNested<N>,io.kubernetes.client.fluent.Nested<N> {
        ...
        private final int index;
            ...
            ItemsNestedImpl(int index,io.kubernetes.client.openapi.models.V1ServiceAccount item) {
                this.index = index;
